...
- new/race/human/mark-of-handling
aliases:
...
When you make a Wisdom (Animal Handling) or Intelligence (Nature) check, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
