...
- ttrpg-cli/race/merfolk/zendikar-ula-creed
aliases:
...
You have proficiency with [navigator's tools](3-Mechanics/CLI/items/navigators-tools.md) and in the [Survival](3-Mechanics/CLI/rules/skills.md#Survival) skill.
