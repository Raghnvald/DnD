...
- ttrpg-cli/race/aven/hawk-headed
aliases:
- "Aven (Hawk-Headed)"
---
# Aven (Hawk-Headed)
*Source: Plane Shift: Amonkhet p. 16*  
![Tah-Crop Elite](3-Mechanics/CLI/races/img/aven.webp#right)
...
You have proficiency in the [Perception](3-Mechanics/CLI/rules/skills.md#Perception) skill. In addition, attacking at long range doesn't impose disadvantage on your ranged weapon attack rolls.

## Description

Following the example of Oketra, hawk-headed aven often focus on the techniques of long-range combat. Most prefer [javelins](3-Mechanics/CLI/items/javelin.md), but some are skilled with bows, [spears](3-Mechanics/CLI/items/spear.md), and [throwing axes](3-Mechanics/CLI/items/handaxe.md).
...
![Companion of the Trials](3-Mechanics/CLI/races/img/aven2.webp#center)