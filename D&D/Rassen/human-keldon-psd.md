...
![Garna, the Bloodflame](3-Mechanics/CLI/races/img/keldon.webp#right)
...
The people of Keld are human, but they are like no other humans anywhere. Nearly all adults stand over six feet tall, and heights above seven feet are not uncommon. They are massively muscled and have gray skin, ranging from an ashy gray-white to a deeper blue-gray. The typical [Human (Keldon)](3-Mechanics/CLI/races/human-keldon-psd.md)'s hairline points sharply down in the middle of the forehead and at either temple, but recedes elsewhere—sometimes dramatically. [Keldons](3-Mechanics/CLI/races/human-keldon-psd.md) are remarkably resistant to the cold of their homeland, baring skin even in near-freezing temperatures without discomfort.
