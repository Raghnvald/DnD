...
When you make a Charisma (Performance) or Dexterity (Stealth) check, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
