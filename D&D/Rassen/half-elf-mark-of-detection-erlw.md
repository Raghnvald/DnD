...
When you make an Intelligence (Investigation) or a Wisdom (Insight) check, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
