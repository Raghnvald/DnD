...
When you make an Arcana check or an ability check involving artisan's tools, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
