...
| 6 | Alarm horns declare that undead are attacking Malar's Throat. Mercenaries keep the monsters out of the city proper, but people are trapped in the temple of Tymora and besieged by `dice:2d6\|noform\|noparens\|avg` (`2d6`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie.md) and `dice:2d6\|noform\|noparens\|avg` (`2d6`) [skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton.md) led by a [ghoul](/3-Mechanics/CLI/bestiary/undead/ghoul.md). If the characters defeat the undead, the temple rewards them with 5 gallons of tej and a potion of healing. |
| 7 | Shouts of "Look out!" give a character a brief warning as a water barrel, building stone, or other heavy weight crashes down. The character must succeed on a DC 12 Dexterity saving throw or be struck, taking `dice:4d6\|noform\|noparens\|avg\|text(14)` (`4d6`) bludgeoning damage. Any character who succeeds on a DC 15 Wisdom (Perception) check spots a disguised [yuan-ti pureblood](/3-Mechanics/CLI/bestiary/humanoid/yuan-ti-pureblood.md) slinking away from the scene. |
