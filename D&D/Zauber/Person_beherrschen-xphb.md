...
**Classes**: [Bard](Liste-Zauber-Klassen-Barde.md); [Cleric (Order Domain)](list-spells-classes-order-domain-tce.md "subclass=TCE;class=XPHB"); [Cleric (Trickery Domain)](list-spells-classes-trickery-domain-xphb.md "subclass=XPHB;class=XPHB"); [Paladin (Oath of Conquest)](list-spells-classes-oath-of-conquest-xge.md "subclass=XGE;class=XPHB"); [Paladin (Oathbreaker)](list-spells-classes-oathbreaker-dmg.md "subclass=DMG;class=XPHB"); [Sorcerer](list-spells-classes-sorcerer.md); [Warlock (Archfey Patron)](list-spells-classes-archfey-patron-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
