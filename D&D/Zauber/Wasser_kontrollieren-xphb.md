...
**Classes**: [Bard](Liste-Zauber-Klassen-Barde.md); [Cleric (Tempest Domain)](list-spells-classes-tempest-domain.md "class=XPHB"); [Cleric](list-spells-classes-cleric.md); [Druid (Circle of the Sea)](list-spells-classes-circle-of-the-sea-xphb.md "subclass=XPHB;class=XPHB"); [Druid](list-spells-classes-druid.md); [Fighter (Eldritch Knight)](list-spells-classes-eldritch-knight-xphb.md "subclass=XPHB;class=XPHB"); [Rogue (Arcane Trickster)](list-spells-classes-arcane-trickster-xphb.md "subclass=XPHB;class=XPHB"); [Sorcerer (Divine Soul, Good)](list-spells-classes-divine-soul-xge.md "subclass=XGE;class=XPHB"); [Warlock (The Fathomless)](list-spells-classes-the-fathomless-tce.md "subclass=TCE;class=XPHB"); [Warlock (The Genie, Marid)](list-spells-classes-the-genie-tce.md "subclass=TCE;class=XPHB"); [Wizard](list-spells-classes-wizard.md)
