...
You call forth a spirit that embodies death. The spirit manifests in an unoccupied space you can see within range and uses the [reaper spirit](/3-Mechanics/CLI/bestiary/undead/reaper-spirit-bmt.md) stat block. The spirit disappears when it is reduced to 0 hit points or when the spell ends.
