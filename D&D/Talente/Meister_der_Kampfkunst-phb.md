...
- Du lernst zwei [[Listen/list-optfeaturetype-mv-b|Manöver]] deiner Wahl, die dem [[Kämpfer-phb-Kampfmeister-phb|Kampfmeister]]-Archetypen der Kämpferklasse zur Verfügung stehen. Wenn das Kampfmanöver, das du anwendest, vom Ziel einen Rettungswurf verlangt, um Effekten des Manövers zu widerstehen, ist der SG des Rettungswurfs gleich 8 + deinem Übungsbonus+ deinem Stärke- oder Geschicklichkeitsmodifikator (deine Wahl). 
