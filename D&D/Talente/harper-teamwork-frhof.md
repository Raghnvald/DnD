...
**Withering Wordplay.** When you take the Help action to assist an ally's attack roll against an enemy, that enemy also has <span title="Player's Handbook (2024)">Disadvantage</span> on the first saving throw it makes before the start of your next turn.
