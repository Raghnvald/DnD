...
This staff has 10 charges. While holding it, you can use an action to expend 1 or more of the staff's charges to cast one of the following spells from it, using your spell save DC: [banishment](/3-Mechanics/CLI/spells/banishment-xphb.md) (4 charges), [blink](/3-Mechanics/CLI/spells/blink-xphb.md) (3 charges), [misty step](/3-Mechanics/CLI/spells/misty-step-xphb.md) (2 charges), [passwall](/3-Mechanics/CLI/spells/passwall-xphb.md) (5 charges), or [teleport](/3-Mechanics/CLI/spells/teleport-xphb.md) (7 charges).
