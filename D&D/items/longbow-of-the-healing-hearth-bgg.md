...
The bow has 8 charges for the following properties, which you can use while wielding the bow. The bow regains `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) charges daily at dawn.
