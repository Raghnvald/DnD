...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-01-aberration.webp#center)
...
![](3-Mechanics/CLI/items/img/03-balance.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-03-beast.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-04-book.webp#center)
...
- **Treasure.** An art object depicting a bridge, or a magic item intended to help overcome obstacles (such as [Boots of Striding and Springing](3-Mechanics/CLI/items/boots-of-striding-and-springing.md)).  
...
- **Treasure.** An art object depicting walls, barriers. or a labyrinth; alternatively, a magic item that creates magical walls (such as a [Cube of Force](3-Mechanics/CLI/items/cube-of-force.md)).  
- **Situation.** Open conflict between two families or groups.  

![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-05-bridge.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-06-campfire.webp#center)
...
- **Treasure.** A geode, jewelry made from gems and precious metals, or a magic item that grants darkvision (such as [Goggles of Night](3-Mechanics/CLI/items/goggles-of-night.md)).  
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-07-cavern.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-08-celestial.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/12-comet.webp#center)
...
- **Creature or Trap.** A construct, particularly designed to be animated (like a golem) as opposed to an ordinary object (like a [broom](3-Mechanics/CLI/bestiary/construct/animated-broom-cm.md) or rug) that has been animated.  
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-10-construct.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-11-corpse.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-12-crossroads.webp#center)
...
- **Treasure.** A treasure that once held a being captive, such as an [Efreeti Bottle](3-Mechanics/CLI/items/efreeti-bottle.md) that has lost its magic or an empty [Iron Flask](3-Mechanics/CLI/items/iron-flask.md).  
- **Situation.** A situation that requires creative solutions, or an effort to free people or creatures from captivity.  

![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/17-donjon.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-14-door.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-15-dragon.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-16-elemental.webp#center)
...
![](3-Mechanics/CLI/items/img/22-euryale.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-18-expert.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/08-fates.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-20-fey.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-21-fiend.webp#center)
...
- **Treasure.** A treasure symbolizing or commemorating the end of a feud or war, or a magic item that can charm or calm creatures (such as a [Rod of Rulership](3-Mechanics/CLI/items/rod-of-rulership.md)).  
- **Situation.** Unjust persecution or prejudicial hatred.  

![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-22-flames.webp#center)
...
![](3-Mechanics/CLI/items/img/01-fool.webp#center)
...
![](3-Mechanics/CLI/items/img/05-gem.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-25-giant.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-26-humanoid.webp#center)
...
![](3-Mechanics/CLI/items/img/14-jester.webp#center)
...
![](3-Mechanics/CLI/items/img/02-key.webp#center)
...
![](3-Mechanics/CLI/items/img/09-knight.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-30-lance.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-31-mage.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-32-map.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-33-maze.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-34-mine.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-35-monstrosity.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/11-moon.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-37-ooze.webp#center)
...
- **Treasure.** An art object depicting a road or path, or a magic item that allows divination (such as a [Crystal Ball](3-Mechanics/CLI/items/crystal-ball.md) or a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-6th-level.md) of Find the Path).  
...
- **Treasure.** An abstract art object, or a magic item that foils divination (such as an [Amulet of Proof against Detection and Location](3-Mechanics/CLI/items/amulet-of-proof-against-detection-and-location.md)).  
- **Situation.** A series of distractions that deflect attention from an important goal.  

![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-38-path.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-39-pit.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-40-plant.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-41-priest.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-42-prisoner.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/04-puzzle.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-44-ring.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/06-rogue.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/16-ruin.webp#center)
...
![](3-Mechanics/CLI/items/img/07-sage.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-48-shield.webp#center)
...
- **Treasure.** An art object depicting ships or travel, or a magic item that facilitates travel (such as a [Folding Boat](3-Mechanics/CLI/items/folding-boat.md)).  
...
- **Treasure.** A treasure still in the hands of the person who made it, or a magic item (such as [Dimensional Shackles](3-Mechanics/CLI/items/dimensional-shackles.md)) that prevents magical movement.  
- **Situation.** A situation arising from someone's inability or unwillingness to travel.  

![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-49-ship.webp#center)
...
![](3-Mechanics/CLI/items/img/19-skull.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-51-staff.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-52-stairway.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/13-star.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-54-statue.webp#center)
...
![](3-Mechanics/CLI/items/img/10-sun.webp#center)
...
![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/21-talons.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-57-tavern.webp#center)
...
- **Treasure.** A valuable ritual object, such as a candelabra or sacrificial knife, or a magic item linked to worship or divine magic (such as a [Candle of Invocation](3-Mechanics/CLI/items/candle-of-invocation.md)).  
...
- **Treasure.** A treasure with superstitious meaning perhaps an amulet meant to ward off evil (such as a [Scarab of Protection](3-Mechanics/CLI/items/scarab-of-protection.md)).  
- **Situation.** A situation stemming from a superstitious fear of curses or bad luck.  

![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-58-temple.webp#center)
...
- **Treasure.** Treasure. An art object created as an act of resistance to tyranny, or a magic item that protects against restraint (such as a [Ring of Free Action](3-Mechanics/CLI/items/ring-of-free-action.md)).  
- **Situation.** A group of people rebelling against a ruler or an authority figure.  

![](3-Mechanics/CLI/books/the-deck-of-many-things-card-reference-guide/img/15-throne.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-60-tomb.webp#center)
...
- **Treasure.** An art object depicting an isolated place or a lonely person; alternatively, [Daern's Instant Fortress](3-Mechanics/CLI/items/daerns-instant-fortress.md) or a similar magic item.  
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-61-tower.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-62-tree.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-63-undead.webp#center)
...
- **Treasure.** An art object that reflects its creator's despair or sadness, or a [Sphere of Annihilation](3-Mechanics/CLI/items/sphere-of-annihilation.md).  
...
![](3-Mechanics/CLI/items/img/18-void.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-65-warrior.webp#center)
...
![](3-Mechanics/CLI/decks/img/deck-of-many-more-things-66-well.webp#center)