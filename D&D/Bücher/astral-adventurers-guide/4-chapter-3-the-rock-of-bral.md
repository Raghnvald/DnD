...
linter-yaml-title-alias: "Chapter 3: The Rock of Bral"
tags:
  - Quelle/5e/aag
aliases:
...
![There's only one rule on the Rock of Bral: leave your vendettas at the docks](3-Mechanics/CLI/books/astral-adventurers-guide/img/067-03-001-rock-of-bral-splash.webp#center)
...
![Elmandar's Star Charts is run by a retired elf adventurer who once served as the spelljammer aboard a space galleon called the Eclipse (shown here as a model)](3-Mechanics/CLI/books/astral-adventurers-guide/img/068-03-002-elmandar-star-charts.webp#center)

#### The Donjon

The Donjon is a walled fortification near the shore of Lake Bral where some offenders and malefactors against the crown are held. In addition to its role as an auxiliary barracks for the Royal Guard, the Donjon is where those judged too dangerous to serve sentences working the fields on the underside are imprisoned. The Warden of the Donjon is a [plasmoid boss](3-Mechanics/CLI/bestiary/ooze/plasmoid-boss-bam.md) (see "Boo's Astral Menagerie") named Ux.

#### The Edge

One of the largest and busiest taverns in Bral is the Edge, an establishment that's popular among space travelers visiting the Rock. A chatty, philosophical [thri-kreen mystic](3-Mechanics/CLI/bestiary/monstrosity/thri-kreen-mystic-bam.md) (see "Boo's Astral Menagerie") named Vikka tends bar.
...
![Large Luigi, the proprietor of the Happy Beholder, is delighted to meet new patrons](3-Mechanics/CLI/books/astral-adventurers-guide/img/069-03-003-large-luigi-splash.webp#center)
