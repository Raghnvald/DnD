...
[Flabbergast](3-Mechanics/CLI/bestiary/npc/flabbergast-ai.md)'s familiar, Mister Snibbly, uses the cat stat block.
...
![Phoenix Anvil, Oak Truestrike, Brahma Lutier, And Pendragon Beestinger](3-Mechanics/CLI/books/acquisitions-incorporated/img/108-appendix-a-10.webp#center)
...
[Prophetess](3-Mechanics/CLI/bestiary/npc/prophetess-dran-ai.md) uses the priest stat block with the following changes:
