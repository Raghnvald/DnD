...
![Sigil and the Outlands with Gate-Towns](3-Mechanics/CLI/books/sigil-and-the-outlands/img/000-00-001-planescape-setting.webp#center)
...
> 
> [Mimirs](3-Mechanics/CLI/items/mimir-sato.md)—magical, skull-shaped, fact-collecting devices—will accompany you through this product. These magic items are detailed in "chapter 1" of this book, and they offer details about remarkable realms and candid snippets from residents of the planes. The various [mimir](3-Mechanics/CLI/items/mimir-sato.md) images that appear in these books denote recorded quotes that include widely agreed-upon facts and the personal—though perhaps inaccurate—opinions of the attributed planar travelers. Use these insights to inform your understanding of the planes or as quotes to share via [mimirs](3-Mechanics/CLI/items/mimir-sato.md) in your game.
^002
...
![Angels, devils, and all manner of planar creatures relax in the Smoldering Corpse Bar in Sigil](3-Mechanics/CLI/books/sigil-and-the-outlands/img/001-00-002-planar-tavern.webp#center)
