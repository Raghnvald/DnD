...
- **Extradimensional Space.** Extradimensional spaces, demiplanes, and pocket dimensions—such as those created by a [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md) or the [rope trick](3-Mechanics/CLI/spells/rope-trick-xphb.md) spell—function within Sigil, but those spaces follow all these restrictions as if they were part of the city.  
- **Planar Travel.** Effects that allow interplanar travel, such as [astral projection](3-Mechanics/CLI/spells/astral-projection-xphb.md) or [plane shift](3-Mechanics/CLI/spells/plane-shift-xphb.md), fail if used to try to enter or leave Sigil, with one exception (see the "Teleportation Circles" section below).  
- **Summoning.** Spells, magic items, and effects that summon creatures or objects from other planes, such as a [ring of djinni summoning](3-Mechanics/CLI/items/ring-of-djinni-summoning-xdmg.md), instead summon targets from within Sigil if possible or otherwise fail. Effects that summon a specific target from outside Sigil, as with a [Leomund's secret chest](3-Mechanics/CLI/spells/leomunds-secret-chest-xphb.md) spell, fail automatically.  
...
A dizzying array of coinage flows through Sigil. It doesn't matter where a coin was minted—if it's made of precious metal and the weight is right, the money is usually good. However, some traders are particular about the currencies they accept. An [efreeti](3-Mechanics/CLI/bestiary/elemental/efreeti-xmm.md) merchant selling instruments from the City of Brass might accept only rainbow sapphires from the Elemental Plane of Earth. Perhaps a [night hag](3-Mechanics/CLI/bestiary/fiend/night-hag-xmm.md) hawking rare spell components refuses all currency but fresh [larvae](3-Mechanics/CLI/bestiary/fiend/larva-xmm.md) from Hades, while a [bone devil](3-Mechanics/CLI/bestiary/fiend/bone-devil-xmm.md) might siphon years off the buyer's life as payment for a diabolical blade.
...
A typical sedan chair ride costs 1 sp per passenger and can carry two Medium or smaller creatures to a destination in Sigil, but there are some places they simply won't go—like "Undersigil" or unsafe parts of the "Hive Ward". Heavier chairs that ferry larger customers or groups exist, carried by brawny creatures such as [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) or [umber hulks](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk-xmm.md). These deluxe chairs cost more, a minimum of 1 gp per passenger, and those who carry them might be willing to travel to dangerous areas of the city for an extra fee.
...
![Citizens of Sigil make their voices heard in the Hall of Speakers, a magnificent public forum in the Clerks' Ward](3-Mechanics/CLI/books/sigil-and-the-outlands/img/010-02-002-hall-of-speakers.webp#center)
...
Portals are usually invisible when they're inactive (including to [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spells), but they can be detected by the [true seeing](3-Mechanics/CLI/spells/true-seeing-xphb.md) or [warp sense](3-Mechanics/CLI/spells/warp-sense-sato.md) spell (see "chapter 1" of this book for a description of the latter). When a portal activates, it typically becomes outlined in light with its destination visible beyond.
...
![Portal Quirks](3-Mechanics/CLI/tables/portal-quirks-sato.md)
...
![Planar Portals](3-Mechanics/CLI/tables/planar-portals-sato.md)

![An orc wizard uses the gate seal spell to close a portal to the howling darkness of Pandemonium in Sigil](3-Mechanics/CLI/books/sigil-and-the-outlands/img/011-02-003-seal-gate.webp#center)
...
![The eternal Lady of Pain drifts through the City of Doors, extinguishing any who question her will](3-Mechanics/CLI/books/sigil-and-the-outlands/img/012-02-004-lady-of-pain.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/013-02-005-athar.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/015-02-007-doomguard.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/017-02-009-fraternity-of-order.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/018-02-010-hands-of-havoc.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/019-02-011-harmonium.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/020-02-012-heralds-of-dust.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/021-02-013-mercykillers.webp#center)

Factol Alisohn Nilesia (lawful evil, tiefling [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)), a young and cunning leader raised in Sigil's penitentiary, was born to head the Mercykillers. She's a strict warden, using divination magic to track down fugitives and deploy agents to retrieve them. Somehow, she finds time to personally sign off on every punishment in the Cage. Mercykillers whisper that justice never sleeps, and neither does Nilesia.
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/022-02-014-minds-eye.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/023-02-015-society-of-sensation.webp#center)
...
![](3-Mechanics/CLI/books/sigil-and-the-outlands/img/024-02-016-transcendent-order.webp#center)
...
![Sigil Gazetteer; Sigil Wards](3-Mechanics/CLI/tables/sigil-gazetteer-sigil-wards-sato.md)
...
> ![Sigil Clerks' Ward Encounters](3-Mechanics/CLI/tables/sigil-clerks-ward-encounters-sato.md)

![Creatures from every plane converge in Sigil, the crossroads of the multiverse](3-Mechanics/CLI/books/sigil-and-the-outlands/img/025-02-017-sigil-crossroads.webp#center)
...
![Map 2.1: Elloweth Theater in the Civic Festhall](3-Mechanics/CLI/books/sigil-and-the-outlands/img/026-map-2-01-elloweth-theater.webp#center)
...
The most popular offerings in the Civic Festhall are the Sensoriums, semiprivate rooms where creatures can record and relive one another's sensory experiences through [sensory stones](3-Mechanics/CLI/items/sensory-stone-sato.md) (see "chapter 1" of this book). For a price of 10 gp, a client can feel the thrill of a researcher's epiphany, the weight of a widow's grief, or the warm bite of a flaky pastry. Memories and longer, more complex sensations tend to cost more, but the lure of nostalgia draws repeat customers.

The Society of Sensation pays well for sensations not contained in its extensive collection. Sensates reward adventurers for delivering [sensory stones](3-Mechanics/CLI/items/sensory-stone-sato.md) that contain coveted yet dangerous experiences, such as the thrill of stealing a coin from a sleeping dragon's hoard. Rumors say the sensates also keep a collection of [sensory stones](3-Mechanics/CLI/items/sensory-stone-sato.md) containing unspeakable insights and experiences disruptive to multiversal peace. Sensates sequester these and other restricted sensations in a demiplanar sanctum accessible only to trusted members.

![Intricately carved fountains and crystal pools decorate the grounds leading to the opulent Civic Festhall](3-Mechanics/CLI/books/sigil-and-the-outlands/img/027-02-019-civic-feasthall.webp#center)

#### Greengage

Sensates quench their thirst at the Greengage, a humble cider shop across the street from the Civic Festhall that's popular among gnomes, halflings, and anyone else who can tolerate its four-foot ceilings. To stay in business, the establishment's owner, a chipper [sprite](3-Mechanics/CLI/bestiary/fey/sprite-xmm.md) named Clea Appleblossom, updates its menu daily. Clea sends adventurers to gather supplies from the "Market Ward" or, for especially rare ingredients, the Outer Planes.
...
![Dapper giants stand guard outside the Hall of Records, headquarters of the Fated](3-Mechanics/CLI/books/sigil-and-the-outlands/img/028-02-018-hall-of-records.webp#center)
...
The onion-shaped cabs of Tea Street Transit shuttle customers throughout the Clerks' Ward. The proprietor is Kyl Silkfoot (lawful neutral, elf [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md)), a crotchety elf with a raspy voice, easily spotted by the nauseating cloud of smoke that issues from his tarweed cigars. Kyl's cabs are always clean and comfortable. Fantastic mounts—such as [displacer beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md), [unicorns](3-Mechanics/CLI/bestiary/celestial/unicorn-xmm.md), and bizarre [ponies](3-Mechanics/CLI/bestiary/beast/pony-xmm.md) warped by the magic of the Outer Planes—pull the bulbous carriages.
...
> ![Sigil Hive Ward Encounters](3-Mechanics/CLI/tables/sigil-hive-ward-encounters-sato.md)
...
Raucous, booze-fueled brawls take place in the back room of the Bottle and Jug, one of the Hive's most infamous drinkeries. This mass of steel, barbed wire, and black granite is owned by Beatrice Bazlan, a flightless [erinyes](3-Mechanics/CLI/bestiary/fiend/erinyes-xmm.md) who won the joint but lost her wings in a high-stakes match against its previous owner and his two trolls. Beatrice is tough as nails and loves a good laugh at someone else's expense. Anyone's welcome in her taproom.

A portal to a massive pit-fighting arena rests at the back of the Bottle and Jug, disguised as the door to an always-out-of-order lavatory for big and tall creatures. Gabel, a retired [pit fiend](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md) judge, guards the entrance, but most entrants respectfully call him "Your Honor." On the other side of the door lies a bloodstained amphitheater where spectators place bets and combatants test their mettle. The current heavyweight champion is a bloodthirsty [cyclops](3-Mechanics/CLI/bestiary/giant/cyclops-sentry-xmm.md) named Akra.
...
![Fell](3-Mechanics/CLI/books/sigil-and-the-outlands/img/029-02-021-fell.webp#center)
...
The dabus's tattoos are tinged with magic. Most effects are minor—a temporary glow or shifting pattern—but some designs function as [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) that burn away once used, singeing hair, fur, or scales in the process. As a devotee of Aoskar and longtime resident of Sigil, Fell knows the locations of hundreds of portals throughout the City of Doors and their keys.
...
![Map 2.2: Hall of Vigils in the Mortuary](3-Mechanics/CLI/books/sigil-and-the-outlands/img/031-map-2-02-hall-of-vigils.webp#center)
...
The Mortuary's uninviting halls echo with the moans of the Undead. [Skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) and [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) perform menial tasks, such as cleaning or guard duty, while more intelligent Undead—such as [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md), [vampires](3-Mechanics/CLI/bestiary/undead/vampire-xmm.md), and [death knights](3-Mechanics/CLI/bestiary/undead/death-knight-xmm.md)—serve the Heralds of Dust in high-ranking positions under their factol, the dreaded lich Skall.
...
![Crematory smoke wafts from the Mortuary's gloomy domes at all hours—evidence of the Dusters' tireless work of processing Sigil's dead](3-Mechanics/CLI/books/sigil-and-the-outlands/img/032-02-022-mortuary-domes.webp#center)
...
> ![Sigil Lady's Ward Encounters](3-Mechanics/CLI/tables/sigil-ladys-ward-encounters-sato.md)
...
![Sigil citizens prepare for trial on the steps of the High Courts, where the law is sacred](3-Mechanics/CLI/books/sigil-and-the-outlands/img/033-02-023-high-court.webp#center)
...
The Armory sells every weapon, shield, and armor in the "Player's Handbook" at normal cost. At the DM's discretion, the Armory might have other armaments available for sale, such as [+1 weapons](3-Mechanics/CLI/items/1-weapon-xdmg.md) for 300 gp apiece.

#### Barracks

![Factol Sarin of the Harmonium](3-Mechanics/CLI/books/sigil-and-the-outlands/img/034-02-024-factol-sarin.webp#center)
...
Recently, Heart's Fire has become the subject of gossip throughout the Temple District. The temple's former high priest, a [deva](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md) named Ephemera, was called away on a divine errand. Before departing, the angel appointed a controversial replacement to guide the fane in their stead: Mihr, a lawful good [horned devil](3-Mechanics/CLI/bestiary/fiend/horned-devil-xmm.md) who turned their back on the Nine Hells long ago. Kind and merciful, the new high priest hopes the congregation will see their redeemed nature, but some of the temple's clergy refuse to accept Mihr as the true high priest.
...
While cheap advocates linger on the courthouse steps hoping to find work, their arguments are brittle. Brilliant barristers demand high retainers, but they're worth every coin when the alternative is a visit from the Mercykillers. One talented attorney is "Sly" Nye (chaotic neutral, tiefling [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), who claims to have never lost a case. Sly has been known to waive their astronomical fee for adventurers who help gather evidence relevant to other cases. Of course, the accused are always free to represent themselves.
...
**Dadras**, a [planetar](3-Mechanics/CLI/bestiary/celestial/planetar-xmm.md) with a powdered wig and a fiery temper. The angel detests lies.

**Factol Hashkar**, leader of the Fraternity of Order.

**Madam Rule**, a scornful [pit fiend](3-Mechanics/CLI/bestiary/fiend/pit-fiend-xmm.md) known for her harsh interjections and screeching metal gavel.

![Kolyarut](3-Mechanics/CLI/books/sigil-and-the-outlands/img/035-02-025-kolyarut.webp#center)
...
![Map 2.3: Spire of the Grixitt in the Prison](3-Mechanics/CLI/books/sigil-and-the-outlands/img/036-map-2-03-spire-of-grixitt.webp#center)
...
Particularly dangerous criminals never leave their cells, which are suspended in high-security units that hang from the Prison's exterior like inverted buttresses. Map 2.3 depicts a section of the Prison that houses one such criminal, the infamous portal saboteur known as the Grixitt (neutral, human [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)).
...
![Prison Inmates](3-Mechanics/CLI/tables/prison-inmates-sato.md)
...
**Allarind the Thin**, a sadistic [adult blue dracolich](3-Mechanics/CLI/bestiary/undead/dracolich-xmm.md) who died in the Prison long ago.

**Buel**, a stoic warden archon (see "Morte's Planar Parade") who has thwarted countless jailbreaks.

**Gazzengar**, a calculating, neutral [mind flayer](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) who isn't afraid to crack a few skulls to keep inmates in line.

**Olmulloz**, a pasty shator demodand (see "Morte's Planar Parade") accompanied by a pack of rabid [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md).

![Looming over the Lady's Ward, the Prison is a grim reminder of the consequences of crime in the City of Doors](3-Mechanics/CLI/books/sigil-and-the-outlands/img/037-02-026-prison.webp#center)
...
> ![Sigil Lower Ward Encounters](3-Mechanics/CLI/tables/sigil-lower-ward-encounters-sato.md)
...
![Home of the Athar, the Shattered Temple stands as a reminder that the power of gods isn't so permanent](3-Mechanics/CLI/books/sigil-and-the-outlands/img/038-02-027-shattered-temple.webp#center)
...
Along the banks of the Ditch (detailed below), a fire-gutted building conceals a gaping hole into the ground with a single ladder leading down into darkness. Here lies the Bones of the Night, a cavern complex home to the Master of Bones: Lothar the Old (neutral, human [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md)). From the catacombs of "Undersigil" (detailed later in this chapter), Lothar gathers a macabre collection of skulls from various creatures, organizing them into a library of sorts. Ossuaries riddle the walls of his bizarre exhibit, their ledges richly decorated with grave goods paid to the departed.

The Master of Bones uses necromancy to commune with the skulls in his collection and draw on their shared knowledge. For a fee, Lothar can cast the [speak with dead](3-Mechanics/CLI/spells/speak-with-dead-xphb.md) spell on any of his skulls, asking questions on the clients' behalf. He also trades and purchases new skulls. His prices range from 1 gp for a person who knew a single valuable story to upward of 10,000 gp for the skull of a factol or the high priest of a dead god.

The library is well guarded. Lothar is a capable combatant in his own right and can animate a host of skulls in his collection as [flameskulls](3-Mechanics/CLI/bestiary/undead/flameskull-xmm.md). To combat larger threats, the Master of Bones relies on a ghoul-shaped [stone golem](3-Mechanics/CLI/bestiary/construct/stone-golem-xmm.md) that answers to his command.
...
![Map 2.4: Mithral Tower in the Great Foundry](3-Mechanics/CLI/books/sigil-and-the-outlands/img/039-map-2-04-mithral-tower.webp#center)
...
![The light of the Great Foundry's forges pierces the industrial smog that suffocates the Lower Ward](3-Mechanics/CLI/books/sigil-and-the-outlands/img/040-02-028-great-foundry.webp#center)
...
A [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spell over the front door of the Parted Veil welcomes visitors with short inspirational messages. Once inside, customers are greeted by a wondrous sight—the walls, ceilings, and floors are made of books. Shoppers tread across the spines of volumes underfoot as they peruse titles above and below. With no shelves or clear system of organization, the shop is a labyrinth of knowledge that only Kesto can navigate, but the shopkeep is always happy to help a customer find what they're after.

Kesto is a venerable gnome with round spectacles and a wiry, unkempt beard. A proud member of the Athar, the open-minded Kesto aims to empower his customers through knowledge. He is accompanied by the gaunt-faced Sir Cleave, a friendly, lawful good [bodak](3-Mechanics/CLI/bestiary/undead/bodak-mpmm.md) (see "Mordenkainen Presents: Monsters of the Multiverse"; replace with a lawful good [revenant](3-Mechanics/CLI/bestiary/undead/revenant-xmm.md) if you don't have that book). Sir Cleave eagerly assists customers, regardless of how uncomfortable it makes them.

##### Spells for Sale

Kesto maintains a vast collection of scrolls and spellbooks. He allows wizards to copy spells from them at the cost listed in the Spells for Sale table. Spells marked with an asterisk (*) appear in "chapter 1" of this book. He can have any of these scribed as a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) for twice the listed cost for this service.

![Spells for Sale](3-Mechanics/CLI/tables/spells-for-sale-sato.md)
...
The Ubiquitous Wayfarer is a reputable three-story tavern whose taproom contains over two dozen portals to other parts of Sigil and beyond. The tavern sits in the Lower Ward, but some folks believe it's in whatever ward they happen to live in. The Wayfarer is popular among planar explorers and adventurers who use its portals to get around the city. It offers a quick path across the city if one knows the right portals, though its proprietor, a gray-haired bartender named Riaen Blackhome (lawful neutral, human [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)), takes exception to people using her place as a shortcut without stopping for a drink.
...
![Planar travelers store their hoards within the Bank of Abbathor, a worlds-spanning financial institution](3-Mechanics/CLI/books/sigil-and-the-outlands/img/041-02-029-bank-of-abbathor.webp#center)
...
> ![Sigil Market Ward Encounters](3-Mechanics/CLI/tables/sigil-market-ward-encounters-sato.md)
...
![Laril Zazzkos](3-Mechanics/CLI/books/sigil-and-the-outlands/img/042-02-030-laril-zazzkos.webp#center)
...
![Shopping in the Bazaar; Bazaar Shops](3-Mechanics/CLI/tables/shopping-in-the-bazaar-bazaar-shops-sato.md)
...
![Map 2.5: Grounds of the Great Gymnasium](3-Mechanics/CLI/books/sigil-and-the-outlands/img/043-map-2-05-great-gymnasium.webp#center)
...
![With countless competition fields and luxurious spas, the Great Gymnasium promotes self-improvement in body and mind](3-Mechanics/CLI/books/sigil-and-the-outlands/img/044-02-031-great-gymnasium.webp#center)
...
> ![Sigil Undersigil Encounters](3-Mechanics/CLI/tables/sigil-undersigil-encounters-sato.md)
...
A decrepit monarch, the Silent King, presides over the Dead Nations and their undead populace, but his throne is also his prison. The Silent King's throne bestows a mantle of authority on its occupant, but it demands a grim toll. Only the living can sit on the mirthless, high-backed chair, and only death can free them from its numbing grip. [Ghouls](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md), [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md), and [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) pledge fealty to the Silent King and enforce his will in the Realm Below. They are bound to serve their ruler until either he's killed or he wastes into oblivion—leaving his seat available for its next ruler.
...
[Kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md), [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md), and other aquatic folk live in the Drowned Nations, as do land dwellers who navigate the sewers by boat. Denizens of the Plane of Water don't take kindly to Sigil polluting their home. Grat the Glass-Jawed, a [sahuagin baron](3-Mechanics/CLI/bestiary/fiend/sahuagin-baron-xmm.md) whose gums are jammed with sharpened gems, periodically surfaces to skewer Undersigil's residents from the back of his mutated shark, Ripper (a [hunter shark](3-Mechanics/CLI/bestiary/beast/hunter-shark-xmm.md) with a walking speed of 30 feet). Others, like the [aboleth](3-Mechanics/CLI/bestiary/aberration/aboleth-xmm.md) Abadoom, carve out lairs in the pungent meres. Ancient and unknowing, Abadoom harbors some of Sigil's darkest secrets.
...
![Dead factions cling to life in Nowhere, a depressing refuge beneath the streets of Sigil](3-Mechanics/CLI/books/sigil-and-the-outlands/img/045-02-032-nowhere.webp#center)
...
![Sigil Adventure Hooks](3-Mechanics/CLI/tables/sigil-adventure-hooks-sato.md)

![Not all planar wanderers travel to Sigil intentionally](3-Mechanics/CLI/books/sigil-and-the-outlands/img/046-02-033-planar-wanderers.webp#center)

### Faction Missions

Use the plots on the Faction Missions table to help deepen the characters' ties with any faction in Sigil.

![Faction Missions](3-Mechanics/CLI/tables/faction-missions-sato.md)
...
![Sigil Calamities](3-Mechanics/CLI/tables/sigil-calamities-sato.md)
...
> ![Sigil General Encounters](3-Mechanics/CLI/tables/sigil-general-encounters-sato.md)