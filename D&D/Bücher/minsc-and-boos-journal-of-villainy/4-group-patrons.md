...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/013.webp#center)
...
[History](3-Mechanics/CLI/rules/skills.md#History) can help an adventuring band avoid repeating the mistakes of their predecessors... like waltzing into the den of a demilich.
...
![Random Quests From the Adventurer's Guild](3-Mechanics/CLI/tables/random-quests-from-the-adventurers-guild-mabjov.md)
...
![Henchmen Rates and Risk-taking DCs](3-Mechanics/CLI/tables/henchmen-rates-and-risk-taking-dcs-mabjov.md)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/014.webp#center)

## Candlekeep

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/015.webp#center)
...
![Random Quests From Candlekeep](3-Mechanics/CLI/tables/random-quests-from-candlekeep-mabjov.md)

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/016.webp#center)
...
Candlekeep has the largest library of magical knowledge in all of Faerûn. This includes books and scrolls describing the secrets of how to build magic items. In order to find the appropriate recipe, you must have an Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) bonus equal to or higher than what is listed. Most recipes have prerequisite material components, often requiring you to hunt down a specific kind of monster. To craft the item, you must spend gold equal to the material cost. Some items require the aid of a powerful assistant to craft. You only need the assistant for a single day. You can either use Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception), [Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation), [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) or charm magic to get their assistance.

![Adventurer's Guild Arcane Secrets](3-Mechanics/CLI/tables/adventurers-guild-arcane-secrets-mabjov.md)

- [Valygar Corthala](3-Mechanics/CLI/bestiary/npc/valygar-mabjov.md)  
- [Xan Moonblade](3-Mechanics/CLI/bestiary/npc/xan-moonblade-mabjov.md)  

## Church of Sune

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/018.webp#center)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/017.webp#center)
...
The ugliness of [Baalzebul](3-Mechanics/CLI/bestiary/npc/baalzebul-mabjov.md) is especially abhorrent to Sune. She hates that the archdevil was formerly Triel, one of the most beautiful angels to be found on Mount Celestia. The Church of Sune also despises [Ssendam](3-Mechanics/CLI/bestiary/npc/ssendam-lord-of-madness-mabjov.md), as the slaad lord's insanity and ugliness is a danger to the structure of the civilized world.
...
![Random Quests from The Church of Sune](3-Mechanics/CLI/tables/random-quests-from-the-church-of-sune-mabjov.md)
...
![Religious Relics from the Church of Sune](3-Mechanics/CLI/tables/religious-relics-from-the-church-of-sune-mabjov.md)

![Religious Relics; Required Religious Service](3-Mechanics/CLI/tables/religious-relics-required-religious-service-mabjov.md)

- [Naes Inuus](3-Mechanics/CLI/bestiary/npc/naes-inuus-mabjov.md)  
- [Tiberius Inuus](3-Mechanics/CLI/bestiary/npc/tiberius-inuus-mabjov.md)  

## Emerald Enclave

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/019.webp#center)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/020.webp#center)
...
- **Classes.** Barbarians, Clerics ([Nature](3-Mechanics/CLI/rules/skills.md#Nature) Domain), Druids, Monks, Paladins (Oath of the Ancients), Rangers  
...
[Cryonax](3-Mechanics/CLI/bestiary/npc/cryonax-mabjov.md) is an arch foe of the Emerald Enclave as he is an elemental prince of evil. The Emerald Enclave also despises Ssendam, for she threatens to corrupt the natural world with her filth.

### Emerald Enclave Quests

The Emerald Enclave is focused on combating threats to the natural world.

![Random Quests from the Emerald Enclave](3-Mechanics/CLI/tables/random-quests-from-the-emerald-enclave-mabjov.md)
...
Each member of your party gains proficiency in the [Survival](3-Mechanics/CLI/rules/skills.md#Survival) skill, if the character doesn't already have it.
...
![Emerald Enclave Secret Trails](3-Mechanics/CLI/tables/emerald-enclave-secret-trails-mabjov.md)

- [Kivan the Grim](3-Mechanics/CLI/bestiary/npc/kivan-mabjov.md)  
- [Faldorn the Hierophant](3-Mechanics/CLI/bestiary/npc/faldorn-mabjov.md)  

## Flaming Fist

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/021.webp#center)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/022.webp#center)
...
![Random Quests from The Flaming Fist](3-Mechanics/CLI/tables/random-quests-from-the-flaming-fist-mabjov.md)
...
![Flaming Fist Ranks](3-Mechanics/CLI/tables/flaming-fist-ranks-mabjov.md)
...
![Flaming Fist Salaries](3-Mechanics/CLI/tables/flaming-fist-salaries-mabjov.md)
...
![Flaming Fist Land Grants](3-Mechanics/CLI/tables/flaming-fist-land-grants-mabjov.md)
...
- [Nauk the Bag Man](3-Mechanics/CLI/bestiary/npc/nauk-mabjov.md)  
- [Borivik Windheim](3-Mechanics/CLI/bestiary/npc/borivik-windheim-mabjov.md)  

## Harpers

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/023.webp#center)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/024.webp#center)

### Harper Enemies

[Baalzebul](3-Mechanics/CLI/bestiary/npc/baalzebul-mabjov.md), [Mephistopheles](3-Mechanics/CLI/bestiary/npc/mephistopheles-mabjov.md) and other infernal lords are always viewed by the Harpers as a threat to Faerûn. This is because of the penchant for archdevils to corrupt those in power.

Anyone who were to come into possession of the iron flask that contains [Pazuzu](3-Mechanics/CLI/bestiary/npc/pazuzu-mabjov.md) would also be considered a great threat. Finally, the Zhentarim have always been a rival of the Harpers.

### Harper Quests

The Harpers are focused on undermining tyrants and evil organizations across all of Faerûn.

![Random Quests from the Harpers](3-Mechanics/CLI/tables/random-quests-from-the-harpers-mabjov.md)
...
![Items Acquired via Harper Fences](3-Mechanics/CLI/tables/items-acquired-via-harper-fences-mabjov.md)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/025.webp#center)
...
![Random Quests from the Knights of Bahamut](3-Mechanics/CLI/tables/random-quests-from-the-knights-of-bahamut-mabjov.md)

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/026.webp#center)
...
![Dragon Eggs from Suldil](3-Mechanics/CLI/tables/dragon-eggs-from-suldil-mabjov.md)
...
- **Bronze.** The egg must be exposed to the sky for 12 hours a day or suffused with electricity once a day. The [shocking grasp](3-Mechanics/CLI/spells/shocking-grasp.md) spell also works.  
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/027.webp#center)

This order was founded by the undead siblings, Jon and [Bodhi Irenicus](3-Mechanics/CLI/bestiary/npc/bodhi-irenicus-mabjov.md), and named after the elven house that they were born into. Its primary mission is to seek out magical secrets that will help Jon and Bodhi escape from their prison realm in the Shadowfell. They do this by searching the tombs of dead spellcasters and sages. Members of the Order of Icarus are sent to kill rival necromancers, liches and vampiric spellcasters. Members even kidnap powerful wizards and clerics (who worship gods of the Death domain).
...
You speak directly for [Jon Irenicus](3-Mechanics/CLI/bestiary/npc/jon-irenicus-mabjov.md). You may use the [sending](3-Mechanics/CLI/spells/sending.md) spell to communicate with him once per day.

- **Classes.** Artificers, Sorcerers, Warlocks, Wizards  

#### Infiltrator

You are a devotee of [Bodhi Irenicus](3-Mechanics/CLI/bestiary/npc/bodhi-irenicus-mabjov.md).
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/028.webp#center)

### Icarus Quests

Your missions revolve around finding magical secrets that will help Jon and Bodhi escape from their dread domain.

![Icarus Quests; Random Quests from the Order of Irenicus](3-Mechanics/CLI/tables/icarus-quests-random-quests-from-the-order-of-irenicus-mabjov.md)

### Icarus Perks

#### Magical Scrolls and Books

[Jon Irenicus](3-Mechanics/CLI/bestiary/npc/jon-irenicus-mabjov.md) has access to many magical scrolls and books.

![Magical Scrolls and Books; Scrolls and Books](3-Mechanics/CLI/tables/magical-scrolls-and-books-scrolls-and-books-mabjov.md)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/030.webp#center)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/029.webp#center)

### Raven Circle Quests

The Raven Circle are focused on collecting memories from those associated with loss and tragedy.

![Random Quests from the Raven Circle](3-Mechanics/CLI/tables/random-quests-from-the-raven-circle-mabjov.md)
...
The Raven Queen collects memories just like a raven collects trinkets. The Raven Queen only seeks the memories of powerful or influential entities, specifically those who have suffered great loss or tragedy. If you can give her the memories from these kinds of people, the Raven Queen will reward you. Collecting memories requires you to obtain an item that is precious to the person whose memories you wish to steal. You must then say a prayer to the Raven Queen with the item in hand and the owner in sight within 100 ft. This infuses the item with all of the target's memories of loss, shame and tragedy. When you give this item to one of your contacts ([Lothar](3-Mechanics/CLI/bestiary/npc/lothar-mabjov.md) or [Viktor](3-Mechanics/CLI/bestiary/npc/viktor-mabjov.md)) everyone in your group gains a devotion token that is either a feather, a gold coin or a gem (so long as the target associated with the item is still alive/undead). Each member of your group can only have one of each token at any given time and cannot give them to anyone else. The tokens you gain are as follows:

![Collect Memories; Devotion Tokens](3-Mechanics/CLI/tables/collect-memories-devotion-tokens-mabjov.md)
...
![Weapons of the Raven Queen; Raven Queen Sentient Weapon Bonuses](3-Mechanics/CLI/tables/weapons-of-the-raven-queen-raven-queen-sentient-weapon-bonuses-mabjov.md)
...
![Sentient Weapon Powers](3-Mechanics/CLI/tables/sentient-weapon-powers-mabjov.md)

- [Lothar of the Raven](3-Mechanics/CLI/bestiary/npc/lothar-mabjov.md)  
- [Viktor Kuhn](3-Mechanics/CLI/bestiary/npc/viktor-mabjov.md)  

## Shadow Thieves

![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/031.webp#center)
...
![](3-Mechanics/CLI/books/minsc-and-boos-journal-of-villainy/img/032.webp#center)

### Shadow Thieves Quests

Many of the quests that you engage in are criminal in nature.

![Random Quests from the Shadow Thieves](3-Mechanics/CLI/tables/random-quests-from-the-shadow-thieves-mabjov.md)
...
![Heist Targets; Heist Details](3-Mechanics/CLI/tables/heist-targets-heist-details-mabjov.md)

- [Montaron and the Laughing Skull](3-Mechanics/CLI/bestiary/npc/montaron-and-the-laughing-skull-mabjov.md)  
- [Imoen the Godspawn](3-Mechanics/CLI/bestiary/npc/imoen-mabjov.md)