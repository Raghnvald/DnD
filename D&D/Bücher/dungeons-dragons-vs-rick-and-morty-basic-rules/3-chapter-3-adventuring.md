...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/088-c3-01.webp#center)
...
> D&D RULES, DAWG!
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/089-ram-head-smile3.webp#center)
> 
> Let's keep going! 
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/090-c3-02.webp#center)
...
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/091-ram-head-ehlol.webp#center)
> 
...
When you make a long jump, you cover a number of feet up to your Strength score if you move at least 10 feet on foot immediately before the jump. When you make a standing long jump, you can leap only half that distance. Either way, each foot you clear on the jump costs a foot of movement. In some circumstances, your DM might allow you to make a Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to jump farther than you normally can.
...
While climbing or swimming, each foot of movement costs 1 extra foot (2 extra feet in difficult terrain), unless a creature has a climbing or swimming speed. At the DM's option, climbing a slippery surface or one with few handholds requires a successful Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. Similarly, gaining any distance in rough water might require a successful Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check.

> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/092-ram-head-smile1.webp#center)
> 
...
> RESTING!?
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/093-c3-03.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/094-ram-head-hmph.webp#center)
> 
> &nbsp;...
> 
> I changed my mind.
...
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/095-ram-head-rick-lol2.webp#center)
> 
> that'll teach 'em.
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/096-c3-04.webp#center)
> 
...
![Rewards](3-Mechanics/CLI/tables/rewards-rmr.md)

> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/097-ram-head-daze.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/098-c3-05.webp#center)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/099-ram-head-rick-eh.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/100-ram-head-stern-flip.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/101-c3-06.webp#center)
> 
...
![Light Armor](3-Mechanics/CLI/tables/light-armor-rmr.md)
...
![Medium Armor](3-Mechanics/CLI/tables/medium-armor-rmr.md)

**Hide** is a crude armor made from thick furs and pelts. A **chain shirt** is made from interlocking metal rings and commonly worn under clothing. **Scale mail** consists of a leather coat and leggings covered with overlapping scales of metal. You have disadvantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks while wearing scale mail. A **breastplate** is a fitted metal chest piece worn with supple leather.

### Heavy Armor

Heavy armor offers the best protection, and it requires extensive training to master. The fighter and the cleric are proficient with it. When you wear heavy armor, you don't apply your Dexterity modifier to your Armor Class. You also have disadvantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks.

![Heavy Armor](3-Mechanics/CLI/tables/heavy-armor-rmr.md)
...
![Shields](3-Mechanics/CLI/tables/shields-rmr.md)

> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/102-ram-head-hmph.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/103-c3-07.webp#center)
> 
...
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/104-c3-08.webp#center)
> 
> Sounds cool, right?
> 
> WRONG!
...
![Simple Melee Weapons](3-Mechanics/CLI/tables/simple-melee-weapons-rmr.md)

### Simple Ranged Weapons

![Simple Ranged Weapons](3-Mechanics/CLI/tables/simple-ranged-weapons-rmr.md)

### Martial Melee Weapons

![Martial Melee Weapons](3-Mechanics/CLI/tables/martial-melee-weapons-rmr.md)

### Martial Ranged Weapons

![Martial Ranged Weapons](3-Mechanics/CLI/tables/martial-ranged-weapons-rmr.md)

### Marital Emotional Weapons

![Marital Emotional Weapons](3-Mechanics/CLI/tables/marital-emotional-weapons-rmr.md)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/105-c3-09.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/106-c3-12.webp#center)

This section describes items that have special rules.

> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/107-c3-11.webp#center)
> 
...
![Adventuring Gear](3-Mechanics/CLI/tables/adventuring-gear-rmr.md)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/108-c3-10a.webp#center)
> 
> LOOK AT THIS, MORTY!
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/109-ram-head-hmph-flip.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/110-c3-10.webp#center)
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/111-c3-13.webp#center)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/112-c3-14.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/113-c3-15.webp#center)
...
![Mounts and Other Animals](3-Mechanics/CLI/tables/mounts-and-other-animals-rmr.md)

### Tack and Harness

![Tack and Harness](3-Mechanics/CLI/tables/tack-and-harness-rmr.md)

### Food, Drink, and Lodging

![Food, Drink, and Lodging](3-Mechanics/CLI/tables/food-drink-and-lodging-rmr.md)

![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/114-c3-16.webp#center)

![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/115-c3-17.webp#center)