...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/116-c4-01.webp#center)

> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/117-ram-head-dafuq.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/118-ram-head-smile2.webp#center)
> 
...
Every spell in this set has a level from 0 to 3. A spell's level is a general indicator of how powerful it is, with the lowly (but still impressive) [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md) at 1st level and the devastating [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) at 3rd. (Spells of higher levels, up to 9th, exist in the world but aren't included in this set.) Cantrips—simple but powerful spells that characters can cast almost by rote—are level 0. The higher a spell's level, the higher level a spellcaster must be to use that spell.
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/119-ram-head-stern-flip.webp#center)
> 
> PREPARED SPELLS?!
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/120-c4-02.webp#center)
> 
...
When a spellcaster casts a spell using a slot that is a higher level than the spell, the spell assumes the higher level for that casting. For instance, if a wizard casts [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md) using a 2nd-level slot, that [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md) is 2nd level. The spell effectively expands to fill the slot.

Some spells, such as [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md) and [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md), have more powerful effects when cast at a higher level, as detailed in the spell's description.
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/121-ram-head-yas.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/122-ram-head-rick-lol3.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/123-c4-03.webp#center)
...
The target of a spell must be within the spell's range. For a spell like [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), the target is a creature. For a spell like [fireball](3-Mechanics/CLI/spells/fireball-xphb.md), the target is the point in space where the ball of fire erupts.

Most spells have ranges expressed in feet. Some spells can target only a creature (including you) that you touch.

Other spells, such as the [shield](3-Mechanics/CLI/spells/shield-xphb.md) spell, affect only you. These spells have a range of self.
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/124-ram-head-rick-lol.webp#center)
> 
> a hot protip here:
> 
...
Most spells require the chanting of mystic words. The words themselves aren't the source of the spell's power; rather, the particular combination of sounds, with specific pitch and resonance, sets the threads of magic in motion. Thus, a character who is gagged or in an area of silence, such as one created by the [silence](3-Mechanics/CLI/spells/silence-xphb.md) spell, can't cast a spell with a verbal component.
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/125-c4-04.webp#center)
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/126-c4-05.webp#center)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/127-ram-head-daze.webp#center)
> 
...
- **Being incapacitated or killed.** You lose concentration on a spell if you are [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) (as explained in "appendix A") or if you die.  
...
Spells such as [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md) and [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) cover an area, allowing them to affect multiple creatures at once.
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/128-ram-head-ehlol.webp#center)
> 
...
Most spells that require attack rolls involve ranged attacks. Remember that you have disadvantage on a ranged attack roll if you are within 5 feet of a hostile creature that can see you and that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) (see "chapter 2").
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/129-c4-07.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/130-c4-06.webp#center)
> 
> 50+ SPELLS
> 
...
Some of the spells cause **conditions**, including [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed), [deafened](3-Mechanics/CLI/rules/conditions.md#Deafened), [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened), [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible), [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed), [prone](3-Mechanics/CLI/rules/conditions.md#Prone), [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained), and [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious). Consult "appendix A" to learn a condition's effects in the game.
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/131-c4-08.webp#center)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/132-ram-head-ehlol.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/133-c4-09.webp#center)
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/134-c4-10.webp#center)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/135-ram-head-rick-madconfused.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/136-ram-head-rick-lol2.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/138-ram-head-dafuq.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/137-c4-11.webp#center)
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/139-c4-12.webp#center)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/140-ram-head-sarcasm.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/141-ram-head-smile2.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/142-ram-head-rick-smile-flip.webp#center)
> 
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/143-ram-head-meh.webp#center)
> 
...
A cleric who takes 10 minutes to [concentrate](3-Mechanics/CLI/rules/conditions.md#Concentration) on how much they love their god so *you* can get punched harder. That's pretty metal.
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/144-ram-head-smile3.webp#center)
> 
...
![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/145-c4-13-rick-hooray.webp#center)
...
> [!note] 
> 
> ![](3-Mechanics/CLI/books/dungeons-dragons-vs-rick-and-morty-basic-rules/img/146-ram-head-meh.webp#center)
> 
