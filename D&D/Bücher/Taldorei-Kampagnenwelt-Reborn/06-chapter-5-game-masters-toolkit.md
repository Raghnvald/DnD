...
The game statistics of a "Vestige of Divergence" don't change when it resizes unless the item is a weapon. When a Large or larger creature makes an attack with such a weapon, the weapon deals one additional damage die for each size category its wielder is larger than Medium. For example, if [Fenthras](/3-Mechanics/CLI/items/fenthras-tdcsr.md) is used by a Large fey, attacks made using the longbow deal `dice:2d8|noform|noparens|avg` (`2d8`) piercing damage. If [Pyremaul](/3-Mechanics/CLI/items/pyremaul-tdcsr.md) is used by a Huge giant, attacks made using the maul deal `dice:4d6|noform|noparens|avg` (`4d6`) bludgeoning damage.
...
[Accelerated Rests](/3-Mechanics/CLI/variant-rules/accelerated-rests-tdcsr.md)

[Rapid Quaffing](/3-Mechanics/CLI/variant-rules/rapid-quaffing-tdcsr.md)

[Alternative Resurrection Rules: Harrowing Return](/3-Mechanics/CLI/variant-rules/alternative-resurrection-rules-harrowing-return-tdcsr.md)

[Alternative Resurrection Rules: Fading Spirits](/3-Mechanics/CLI/variant-rules/alternative-resurrection-rules-fading-spirits-tdcsr.md)

[Alternative Resurrection Rules: Taxing Return](/3-Mechanics/CLI/variant-rules/alternative-resurrection-rules-taxing-return-tdcsr.md)
