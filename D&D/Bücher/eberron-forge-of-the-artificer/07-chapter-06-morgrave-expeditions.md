...
![An Armorer Explorer ventures into an ancient ruin in Xen'drik in search of magical secrets](3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/060-06-001-an-armorer-explorer-exploring-ancient-ruins.webp#center)
...
![Two Emerald Claw Knights join their commander in a hunt for powerful magic](3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/061-06-002-emerald-claw-knights.webp#center)
...
Agents of the Order of the Emerald Claw are soldiers whose obedience to the order and their superiors is absolute. They include the scouts, spies, and warriors described in the "Monster Manual", in addition to the stat blocks presented here, and they are often accompanied by Undead troops such as Skeletons, Zombies, and [Karrnathi Undead Soldiers](3-Mechanics/CLI/bestiary/undead/karrnathi-undead-soldier-erlw.md) (which appear in "Eberron: Rising from the Last War"). Their leaders include [Bone Knights](3-Mechanics/CLI/bestiary/humanoid/bone-knight-erlw.md) (also in [Eberron: Rising from the Last War](3-Mechanics/CLI/bestiary/humanoid/bone-knight-erlw.md)).
...
To sustain the overlords, the Lords of Dust encourage activities that strengthen these lords' influence. For example, because the overlord [Rak Tulkhesh](3-Mechanics/CLI/bestiary/npc/rak-tulkhesh-erlw.md) embodies war, his minions work to cause strife across the world. And [Sul Khatesh](3-Mechanics/CLI/bestiary/npc/sul-khatesh-erlw.md) feeds on the fear evoked by the sinister magic of warlocks and evil wizards, so her minions entice cruel folk to enter into pacts with the Queen of Shadows.
...
Professor Sendor Reddick (Medium Death Cultist) is a taxidermist as well as a noted scholar of animal biology. As curator of the Valdain Museum of Natural History, Reddick pays handsomely for well-preserved specimens of unusual creatures, though he prefers to stuff them himself. Many whisper that the young-seeming elf dabbles in necromancy, and some speculate that he might be connected to the Order of the Emerald Claw. In fact, he is devoted to [Sul Khatesh](3-Mechanics/CLI/bestiary/npc/sul-khatesh-erlw.md) and serves the Lords of Dust.
...
![Elemental airships aid archaeological expeditions to distant lands](3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/064-06-005-elemental-airships.webp#center)
...
![Vulkoori and Umbragen drow battle in a cavern filled with mysteries](3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/065-06-006-drow-battle.webp#center)
