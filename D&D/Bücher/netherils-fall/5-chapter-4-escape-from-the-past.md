...
![The cosmos-shaking magic of Karsus's Folly drives a caldron magen into a violent frenzy](3-Mechanics/CLI/books/netherils-fall/img/017-04-001-magen-frenzy.webp#center)
...
![Phaerimm attacks on Conch were brutal and unanticipated, leading to a constant state of fear and chaos in the city](3-Mechanics/CLI/books/netherils-fall/img/018-04-002-phaerimm-attack.webp#center)
...
> [!gallery]
> ![Map 04.01: Tyvern's Workshop](3-Mechanics/CLI/books/netherils-fall/img/019-map-04-01-tyverns-workshop.webp#gallery)
> ![Player Version](3-Mechanics/CLI/books/netherils-fall/img/020-map-04-01-tyverns-workshop-player.webp#gallery)

This adventure consists of the following encounters and takes place on Map: Tyvern's Workshop. Squares with rubble or flames in them are <span title="Player's Handbook (2024)">Difficult Terrain</span>.
...
The characters notice two conical shapes near the fire. These are [Phaerimm Scouts](3-Mechanics/CLI/bestiary/aberration/phaerimm-scout-nf.md). When a character stands, one scout telepathically tells each character, "I can taste the magic here! You shall die!" The scouts fight the characters to the death.

Once the scouts are defeated, the characters find three Potions of Healing in the remnants of smashed belongings on the floor. They also find an [Arcane Battery](3-Mechanics/CLI/items/arcane-battery-nf.md), a [Hat of Vortexes](3-Mechanics/CLI/items/hat-of-vortexes-nf.md), a [Mask of Changed Appearance](3-Mechanics/CLI/items/mask-of-changed-appearance-nf.md), and a [Mythallar Bracelet](3-Mechanics/CLI/items/mythallar-bracelet-nf.md).
...
After a few minutes, the characters notice an enormous, ominous shadow approaching overhead. This is a [Phaerimm Elder](3-Mechanics/CLI/bestiary/aberration/phaerimm-elder-nf.md). If any creature remains upstairs in the workshop after 1 minute has passed, the elder fights them, likely destroying them. If the characters flee downstairs, with or without Tyvern, the elder ignores them.
...
> [!gallery]
> ![Map 04.02: Conch Alleyways](3-Mechanics/CLI/books/netherils-fall/img/021-map-04-02-conch-alleyways.webp#gallery)
> ![Player Version](3-Mechanics/CLI/books/netherils-fall/img/022-map-04-02-conch-alleyways-player.webp#gallery)
...
![Map 04.03: Karsus's Sanctum](3-Mechanics/CLI/books/netherils-fall/img/023-map-04-03-karsuss-sanctum.webp#center)
...
A frantic human named Youmi (Medium, Chaotic Good Mage Apprentice) shouts for help from near the southeastern balcony. She gestures wildly for the characters to help her stop one [Terran Magen](3-Mechanics/CLI/bestiary/construct/terran-magen-nf.md) and two [Caldron Magen](3-Mechanics/CLI/bestiary/construct/caldron-magen-nf.md) ("see appendix b" for both) from destroying four terrified Flumphs, which are backed into the balcony's corner. The magen are driven berserk by Karsus's fluctuating magic and have just started combat with the flumphs. If the characters fight them, the magen turn their attention to the characters and fight to the death. Otherwise, the magen kill the flumphs before fighting the characters.

If the flumphs survive, Youmi becomes <span title="Player's Handbook (2024)">Friendly</span>. She explains that Karsus is attempting to cast a spell to replace the god of magic and admits she's sickened by the archmage's hubris and recklessness. As an Influence action, a character can try to convince Youmi to join their group to help them navigate the city, doing so with a successful DC 16 Charisma (Persuasion) check.
...
Clockwise from the westernmost pedestal, the pedestals hold Boots of Speed, a Ring of Regeneration, a [Fork of Eddy Summoning](3-Mechanics/CLI/items/fork-of-eddy-summoning-nf.md) ("see appendix a"), and a [Mythallar Cloak](3-Mechanics/CLI/items/mythallar-cloak-nf.md) ("see appendix a"). If the characters want to keep the items, Youmi doesn't stop them.

##### Uncontrolled Magic

After the characters take a magic item from a pedestal, or after they've finished talking with Youmi, four [Eldritch Eddies](3-Mechanics/CLI/bestiary/construct/eldritch-eddy-nf.md) appear near them in places of your choosing. These eddies appear only once.
