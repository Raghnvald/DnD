...
![The rampant magical experimentation in Netheril often caused strange environmental effects](3-Mechanics/CLI/books/netherils-fall/img/009-02-001-magical-experimentation.webp#center)
...
In a low gravity zone, creatures quadruple the distance they can leap with a <span title="Player's Handbook (2024)">High Jump</span> or a <span title="Player's Handbook (2024)">Long Jump</span>, and the damage creatures take from falling is halved (round down).
...
- [Arcane Effluence](3-Mechanics/CLI/traps-hazards/arcane-effluence-nf.md)  
- [Glittermoss](3-Mechanics/CLI/traps-hazards/glittermoss-nf.md)  
- [Shadowbark](3-Mechanics/CLI/traps-hazards/shadowbark-nf.md)  
- [Wildstorm](3-Mechanics/CLI/traps-hazards/wildstorm-nf.md)  
- [Witchbriars](3-Mechanics/CLI/traps-hazards/witchbriars-nf.md)