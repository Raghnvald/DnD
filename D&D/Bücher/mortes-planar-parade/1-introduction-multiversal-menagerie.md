...
![Creatures from every corner of the multiverse crowd Sigil's busy streets](3-Mechanics/CLI/books/mortes-planar-parade/img/000-00-001-sigil-busy.webp#center)
...
![Sunflies influenced by various Outer Planes inhabit every corner of the Outlands](3-Mechanics/CLI/books/mortes-planar-parade/img/001-00-002-sunfly-side.webp#center)

![Meeting Magic Item Prerequisites; Stat Blocks by Challenge Rating](3-Mechanics/CLI/tables/meeting-magic-item-prerequisites-stat-blocks-by-challenge-rating-mpp.md)
...
> 
> **Soul Shape.** A dead petitioner can be returned to life only by the [true resurrection](3-Mechanics/CLI/spells/true-resurrection.md) spell or the [wish](3-Mechanics/CLI/spells/wish.md) spell. If affected by these spells, a petitioner chooses whether to return in its original mortal form or as a petitioner.
^005
...
![Planar Alignment; Outer Plane Alignments](3-Mechanics/CLI/tables/planar-alignment-outer-plane-alignments-mpp.md)
...
> 
> **Poison Tolerant.** The creature has advantage on saving throws it makes to avoid or end the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) condition on itself.
> 
...
> [!note] 
> 
> **Battle Lust.** Whenever the creature reduces another creature to 0 hit points with a melee attack on its turn, it gains 10 "temporary hit points", and it can take a bonus action to move up to its speed without provoking [opportunity attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack).
> 
...
> 
> **Pack Tactics.** The creature has advantage on an attack roll against a target if at least one of the creature's allies is within 5 feet of the target and the ally doesn't have the [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) condition.
^011

![A Beastlands-influenced explorer picnics with her animal friends in an idyllic glade](3-Mechanics/CLI/books/mortes-planar-parade/img/002-00-003-picnic.webp#center)
...
> 
> **Unshakable Resolve.** An invisible, magical aura of confidence and hope surrounds the creature. When another creature that has the [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) condition starts its turn within 5 feet of the creature, the [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) condition affecting it is suppressed for 1 minute. When this suppression ends, the condition resumes if its duration hasn't expired.
^01a

### The Beastlands

Creatures influenced by the Beastlands gain wilder or more animalistic features, such as larger eyes, thicker fur, or more prominent canine teeth. Beasts influenced by the Beastlands are often affected per the [awaken](3-Mechanics/CLI/spells/awaken.md) spell—though normal Beasts also typically range through these areas in large numbers. A creature influenced by the Beastlands also gains one or more of following traits of your choice:
...
> 
> **Tracker's Eye.** The creature can see [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) creatures and objects as if they were visible.
> 
...
> [!note] 
> 
> **Hardy Body.** The creature no longer needs food or water, and the creature can have no more than 4 levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).
> 
...
![A unicorn influenced by Gehenna charges through a pustuled forest](3-Mechanics/CLI/books/mortes-planar-parade/img/003-00-004-gehenna-unicorn.webp#center)
...
> [!note] 
> 
> **Chaotic Magic.** The creature can cast the [thaumaturgy](3-Mechanics/CLI/spells/thaumaturgy.md) cantrip, choosing a magical effect at random. Charisma is the spellcasting ability for this spell.
> 
...
> - **5–6.** Disrupted Gravity. Each creature within 20 feet of the creature must succeed on a DC 15 Constitution saving throw or rise vertically, up to 20 feet, and remain magically suspended there for 1 minute. While suspended in this way, a creature has the [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) condition.  
> 
> **Hidden Slaad.** When the creature dies, a [slaad tadpole](3-Mechanics/CLI/bestiary/aberration/slaad-tadpole.md) bursts from the creature's chest.
^039

![A night hag sells larvae fresh from the Lower Planes](3-Mechanics/CLI/books/mortes-planar-parade/img/004-00-005-hag-larvae.webp#center)
...
> 
> **Structural Repair (1/Day).** After being in continuous physical contact with a nonmagical object for 1 minute, the creature can magically repair the object as though it had cast a [mending](3-Mechanics/CLI/spells/mending.md) spell on it.
^03e
...
![A gleaming wyvern imbued with the radiance of Mount Celestia navigates a crystalline cave](3-Mechanics/CLI/books/mortes-planar-parade/img/005-00-006-gleaming-wyvern.webp#center)
...
> 
> **Viper Nest.** When the creature dies, its body disgorges a [swarm of poisonous snakes](3-Mechanics/CLI/bestiary/beast/swarm-of-poisonous-snakes.md) in the same space.
^046
...
> 
> **Ysgardian Stand (2/Day).** If the creature has the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition at the start of its turn, it can, at that time, end the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition on itself and stand up without expending any movement. The creature can't use this trait while it has the [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) condition.
^04e
...
![Outlands Aberrations](3-Mechanics/CLI/tables/outlands-aberrations-mpp.md)
...
![Outlands Beasts](3-Mechanics/CLI/tables/outlands-beasts-mpp.md)
...
![Outlands Celestials](3-Mechanics/CLI/tables/outlands-celestials-mpp.md)
...
![Outlands Constructs](3-Mechanics/CLI/tables/outlands-constructs-mpp.md)

![Mechanical dinosaurs roam an orderly realm influenced by the lawful energies of Mechanus](3-Mechanics/CLI/books/mortes-planar-parade/img/006-00-007-mechanus-dinosaurs.webp#center)
...
![Outlands Dragons](3-Mechanics/CLI/tables/outlands-dragons-mpp.md)
...
![Outlands Elementals](3-Mechanics/CLI/tables/outlands-elementals-mpp.md)
...
![Outlands Fey](3-Mechanics/CLI/tables/outlands-fey-mpp.md)
...
![Outlands Fiends](3-Mechanics/CLI/tables/outlands-fiends-mpp.md)
...
![Outlands Giants](3-Mechanics/CLI/tables/outlands-giants-mpp.md)

### Humanoids

Humanoids from across the planes travel the Outlands and number among the most common inhabitants of the gate-towns.

![Outlands Humanoids](3-Mechanics/CLI/tables/outlands-humanoids-mpp.md)
...
![Outlands Monstrosities](3-Mechanics/CLI/tables/outlands-monstrosities-mpp.md)

### Oozes

Oozes often appear in swampy or subterranean reaches of the Outlands or in regions influenced by the Lower Planes.

![Outlands Oozes](3-Mechanics/CLI/tables/outlands-oozes-mpp.md)

![In a landscape warped by Limbo's pure chaos, an animal-headed ettin fights a massive, many-eyed ooze](3-Mechanics/CLI/books/mortes-planar-parade/img/007-00-008-limbo-madness.webp#center)
...
![Outlands Plants](3-Mechanics/CLI/tables/outlands-plants-mpp.md)
...
![Outlands Undead](3-Mechanics/CLI/tables/outlands-undead-mpp.md)
...
> [!embed-table]- Chaotic Planar Encounters
> ![Chaotic Planar Encounters](3-Mechanics/CLI/tables/chaotic-planar-encounters-mpp.md)

> [!embed-table]- Evil Planar Encounters
> ![Evil Planar Encounters](3-Mechanics/CLI/tables/evil-planar-encounters-mpp.md)

> [!embed-table]- Good Planar Encounters
> ![Good Planar Encounters](3-Mechanics/CLI/tables/good-planar-encounters-mpp.md)

> [!embed-table]- Lawful Planar Encounters
> ![Lawful Planar Encounters](3-Mechanics/CLI/tables/lawful-planar-encounters-mpp.md)

> [!embed-table]- Neutral Planar Encounters
> ![Neutral Planar Encounters](3-Mechanics/CLI/tables/neutral-planar-encounters-mpp.md)

![](3-Mechanics/CLI/books/mortes-planar-parade/img/008-00-017-morte-meet-dragon.webp#center)
