...
The "Dungeon Master's Guide" presents a variant rule called [Side Initiative](3-Mechanics/CLI/rules/variant-rules/initiative-variants.md), which is ideal for ship-to-ship engagements, since it saves you the trouble of tracking initiative for individual creatures aboard each ship.
