...
Most crew members on pirate ships are bandits. Officers are bandit captains and could include a [pirate captain](3-Mechanics/CLI/bestiary/humanoid/pirate-captain-gos.md) (see appendix C) and a [pirate bosun](3-Mechanics/CLI/bestiary/humanoid/pirate-bosun-gos.md) (see appendix C). Many pirate ships carry extra bandits and at least one [pirate deck wizard](3-Mechanics/CLI/bestiary/humanoid/pirate-deck-wizard-gos.md) (see appendix C) as passengers.
