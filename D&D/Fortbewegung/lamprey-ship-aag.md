...
Lamprey ships are antiquated, being among the oldest spelljamming ships still in use. [Psurlons](3-Mechanics/CLI/bestiary/aberration/psurlon-bam.md) (see "Boo's Astral Menagerie") are particularly fond of them.
...
```ad-statblock
title: Lamprey Ship
![](3-Mechanics/CLI/vehicles/token/lamprey-ship-aag.webp#token)
