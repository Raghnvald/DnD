...
Wenn du deine Aktion, Bonusaktion oder Reaktion verwen dest, um mit einem Netz anzugreifen, kannst du nur diesen einen Angriff ausführen, gleichgültig wie viele Angriffe dir zur Verfügung stehen.
...
A character can attempt to harvest poison from a venomous creature that is dead or has the [Incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated) condition. The effort takes `1d6` minutes, after which the character makes a DC 20 Intelligence ([Nature](/3-Mechanics/CLI/skills.md#Nature)) check using a [Poisoner's Kit](/3-Mechanics/CLI/items/poisoners-kit-xphb.md). On a successful check, the character harvests enough poison for a single dose, and no additional poison can be harvested from that creature. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.