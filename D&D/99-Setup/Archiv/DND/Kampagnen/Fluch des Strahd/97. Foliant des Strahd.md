---
Bezeichnung: Der Foliant von Strahd
Status: WIP
linter-yaml-title-alias: Der Foliant von Strahd
tags:
  - Quelle/5e/cos
aliases:
...
**_Schatz._** Die eingestimmte Kreatur kann nun einmal pro Abenddämmerung den Zauber [[Illusionsschrift-old]] als Ritualzauber wirken. Wenn man die Kurzschrift, mit der dieser Zauber in das Buch geschrieben wurde, mit dem Text aus diesem Kapitel und den Kritzeleien an den Rändern des Tagebuchs kombiniert, beginnt sich ein Muster in den wirbelnden, geheimnisvollen Symbolen auf den folgenden Seiten abzuzeichnen.
...
- [Rahadin](D&D/04%20-%20Kampagnen/00.%20NPCs/Rahadin.md) (ohne seine Fähigkeit „Tödlicher Chor“)
...
**_Schatz:_** Die eingestimmte Kreatur kann nun einmal pro Dämmerung den Zauber „[Magierrüstung-old](Magierrüstung-old.md)“ als Ritual wirken.
...
Durch das Ritual wird der Baum zu einer Quelle dunkler Energie, aus der Strahd das **Herz der Trauer** gewinnt. Dieses pulsierende, rubinrote Herz wird in den Mauern von Schloss Ravenloft installiert und verleiht ihm beinahe Unverwundbarkeit.
...
Die eingestimmte Kreatur kann nun einmal pro Dämmerung den Zauber „[[Weihen]]“ als Ritual wirken.
...
### Entscheidungsoptionen für die Gruppe
...
Die eingestimmte Kreatur kann nun einmal pro Dämmerung den Zauber „[[Magisches_Gefäß-old]]“ als Ritual wirken.

---

## Kapitel 9 – **„Der Vormarsch der Morgendämmerung“**

### Kerngeschichte

Fünf Jahre nach dem Tod von Gabriel Andral erhebt **Sorina Markovia** den **Vormarsch der Morgendämmerung**, einen organisierten Widerstand aus Bauern, Jägern, Priestern und einigen abtrünnigen Abenteurern. Ziel ist es, Strahds Herrschaft zu brechen, indem sie die **Zugbrücke von Schloss Ravenloft** halten und die feindlichen Truppen zurückschlagen.
...
- **[[Fliegen-phb]]** (um seine Truppen schnell zu bewegen)
- **[[Todeskreis]]** (um die vorderste Front zu dezimieren)
- **[[Verrücktmachende Finsternis]]** (um das Schlachtfeld in undurchdringliche Dunkelheit zu tauchen)
...
Die eingestimmte Kreatur kann nun einmal pro Dämmerung den Zauber „[[Besseres_Reittier_finden]]“ als Ritual wirken. Wenn der Zauber auf diese Art gewirkt wird, erscheint stattdessen ein [[D&D/05 - Wikipedia/Bestiarium/M-N/Nachtmahr|Nachtmahr]].
...
5. **Orator‑Haus** (höchste Stufe, nur für den Orator zugänglich)

Leo hat das Kloster infiltriert, **verschlossen** und **magisch verstärkt** (Eisen‑ und Silbertüren, laufendes Wasser, antimagische Felder). Er trägt den **Ring of Winter**, ein dunkles Artefakt, das seine Lebensdauer verlängert und die Umgebung auf eisige Temperaturen senkt.

### Wichtigste Begegnungen

- **Akolythen‑Wächter** – friedliche Mönche, die jedoch misstrauisch reagieren, wenn die Gruppe unerlaubt eindringt.
- **Scribe Anya Alexeev** – schläft in der Bibliothek, bewacht einen Schlüssel zu den inneren Bereichen.
- **Leo Dilisnya** – findet sich im **Auditorium** (nur mit dem Schlüssel aus Anyas Schreibtisch) und ist bereit, mit der Gruppe zu verhandeln, zu erpressen oder zu kämpfen.

### Handlungsmöglichkeiten

1. **Schlüsselbeschaffung** – Durch **Investigation‑Checks** (DC 16) kann die Gruppe den Schlüssel in Anyas Schublade finden.
2. **Umgehung der Antimagie** – Ein **Arcana‑Check** (DC 18) oder das Nutzen von **Dispel Magic** kann das Feld temporär deaktivieren, sodass die Gruppe das Orator‑Haus betreten kann.
3. **Verhandlung mit Leo** – Er bietet 1 000 gp und den **Schlüssel zu seinem Zimmer** an, wenn die Helden ihn vor Strahd schützen.
4. **Kampf** – Sollte er sich weigern, muss die Gruppe gegen ihn und eventuell aktivierte **Iron Golem**‑Wächter kämpfen (DC 25 Stärke zum Zerstören).

### Belohnung

Die eingestimmte Kreatur kann nun einmal pro Dämmerung den Zauber „[[Zutritt verwehren]]“ als Ritual wirken.

---

## Kapitel 11 – **„Die finale Morgendämmerung“**

### Kerngeschichte

Strahd richtet seine Wut nun gegen die **Dämmerelfen**. Diese haben sich gegen Patrina gewandt und diese hingerichtet. Die Helden begleiten Strahd zu einem abgelegenen Lager, wo die Elfen von einem **Forcecage‑Ritual** durch Strahd eingesperrt werden.

Es sind etwas über ein Dutzend Elfen eingesperrt, darunter auch Kasimir Velikov, Patrinas Bruder, und der Leichnam von Patrina Velikovna.

### Schlüsselmomente

1. **Stealth‑Versuch** – Die Helden können versuchen, unbemerkt zu den gefangenen Elfen zu schleichen (Geschicklichkeit (Heimlichkeit) , DC 22).
2. **Persuasion/Deception** – Ein erfolgreicher Check (DC 18) ermöglicht es, die Elfen zu überzeugen, dass die Gruppe ihnen helfen will.
3. **Konfrontation mit Strahd** – Wenn die Helden offen angreifen, reagiert Strahd mit **Maddening Darkness**, **Circle of Death** und **Fireball** (falls nicht durch das Antimagiefeld blockiert).

### Konsequenzen

- Fast alle Dämmerungselfen, sterben. Einzig Kasimir kann entkommen. 
- Der Leichnam von Patrina wird in die Gruften von Schloss Ravenloft gebracht.

### Belohnung

Die eingestimmte Kreatur kann nun einmal pro Dämmerung den Zauber „[[Energiekäfig]]“ als Ritual wirken.

---

## Kapitel 12 – **„Eine Seele kehrt zurück“**

### Kerngeschichte

Der Fokus liegt auf **Marina Ulrich** (auch Ireena/Tatyana genannt), einer jungen Frau, die von Strahd in das Dorf **Berez** gelockt wird. Strahd besucht sie jede Nacht, verführt sie, trinkt ihr Blut und versucht, sie in einen Vampir zu verwandeln.

Der Verlauf über drei Nächte:

1. **Nacht 1 – Wiedersehen** – Strahd erscheint als liebender Geliebter, spricht von Tatyana und küsst Marina. Er beißt sie, doch sie überlebt die erste Begegnung.
2. **Nacht 2 – Versprechen** – Strahd vertieft die Bindung, beißt erneut, das Blut fließt stärker, Marina ist schwer krank, doch Strahd verspricht ihr Ewigkeit.
3. **Nacht 3 – Finale** – Marina liegt bereits am Rande des Todes, ein Pfahl steckt in ihrem Herzen. Strahd versucht, sie endgültig zu verwandeln, doch ein Blitz zerreißt ihn, und Marina löst sich in Nebel auf.

Parallel dazu arbeitet **Priester Grigor** heimlich daran, alle Leichen im Dorf zu verbrennen, um eine mögliche Ausbreitung des Vampirismus zu verhindern. Er sammelt geheime Vorräte (heiliges Wasser, Pfähle, Knoblauch) und plant, Marina zu töten, falls sie vollständig verwandelt wird.

### Optionen für die Spieler

- **Heilung/Schutz** – Mit **Heal**, **Protection from Evil and Good**, **Holy Water** oder einem **Stake** können sie versuchen, Marina zu retten.
- **Aufdeckung von Grigors Plänen** – Ein **Investigation‑Check** (DC 15) enthüllt seine geheimen Vorräte; die Gruppe kann ihn konfrontieren oder seine Aktionen sabotieren.
- **Konfrontation mit Strahd** – Während der dritten Nacht kann die Gruppe Strahd direkt angreifen; ein erfolgreicher **Attack Roll** (mit Vorteil durch Überraschung) kann ihn zurückwerfen, bevor er den finalen Biss ausführt.

### Belohnung

Falls Marina gerettet wird, erhalten die Helden ein **Silberkristall‑Amulett**, das **einmal pro Dämmerung** den Ritualzauber **Tsunami** (8. Stufe) wirken lässt – ein mächtiger Flutzauber, der große Flächen von Feinden hinwegspült.

---

## Epilog – **„Ein Herrscher ruht“**

### Inhalt

Nachdem die Ereignisse abgeschlossen sind, kehren die Helden in die Gegenwart zurück. Das Buch, das sie gelesen haben, **schreibt sich selbst weiter**, als würde ein unsichtbarer Chronist die Geschichte in Echtzeit festhalten.

Ein geisterhafter Monolog von Strahd erklingt: er spricht von seiner ewigen Einsamkeit, von verlorener Liebe, von endlosen Wiederholungen des gleichen Schmerzes. Er fragt sich, ob er jemals Frieden finden kann – **Schlaf**, **Ruhe**, **Vergessen**.

Der Text endet mit einer offenen Frage, die dem DM Raum lässt, zukünftige Handlungsstränge zu spinnen:

- Wird das **Herz der Trauer** endgültig zerstört?
- Können die Helden den **Ring of Winter** endgültig neutralisieren?
- Gibt es noch weitere **verborgene Fanes**, die gereinigt werden müssen?

### Nutzung für die Kampagne

- **Nachbesprechung**: Lass die Spieler über ihre Entscheidungen reflektieren – welche moralischen Grauzonen haben sie betreten?
- **Hook für neue Abenteuer**: Das wiederkehrende Schreiben des Buches kann als Hinweis dienen, dass ein **Zeit‑ oder Schicksalsmechanismus** aktiv ist. Vielleicht gibt es ein weiteres Artefakt, das das Buch komplett schließen kann.
- **Belohnungen integrieren**: Die im Verlauf erworbenen Artefakte (Ceremony‑Amulett, Hallow‑Kristall, Magic Jar‑Medaille, Forbiddance‑Medaillon, Forcecage‑Fragment, Tsunami‑Amulett) können jetzt im Spiel eingesetzt werden – plane Situationen, in denen die Gruppe diese einmal‑pro‑Dämmerung‑Zauber sinnvoll einsetzen kann.

---

### Gesamtüberblick – Wie du das Material im Spiel einsetzen kannst

|Kapitel|Hauptziel der Gruppe|Größte Gefahr|Schlüssel‑Artefakt|
|---|---|---|---|
|7|Gulthias‑Baum zerstören / Ritual stoppen|Strahds Untote & Magie|Amulett → **Ceremony**|
|8|Herz des Alten Gottes verhindern|Baba Lysaga & Morgantha|Kristall → **Hallow**|
|9|Zugbrücke halten / Strahd unterstützen|Circle of Death, Maddening Darkness|Amulett → **Magic Jar**|
|10|Leo Dilisnya finden & Ring of Winter sichern|Antimagie, Iron Golem|Medaillon → **Forbiddance**|
|11|Elfen retten / Forcecage‑Ritual sabotieren|Strahd + Forcecage|Fragment → **Forcecage**|
|12|Marina retten & Grigor stoppen|Strahds Vampirbiss, Grigors Pläne|Amulett → **Tsunami**|
|Epilog|Reflektion & Ausblick|Strahds ewige Qual|–|

Nutze diese Tabelle, um den Spielfluss zu planen, die Spannung zu steigern und den Spielern klare, aber flexible Ziele zu geben. Viel Erfolg beim Leiten deiner Kampagne – möge der Nebel von Barovia eure Geschichte stets spannend umhüllen!