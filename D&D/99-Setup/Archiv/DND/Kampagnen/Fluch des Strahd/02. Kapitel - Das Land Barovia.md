---
Bezeichnung: "Kapitel 2: Das Land Barovia"
linter-yaml-title-alias: "Kapitel 2: Das Land Barovia"
tags:
  - Quelle/5e/cos
aliases:
...
**_[[Alarm-phb]]:_** Anstatt eines geistigen Klingelns hört der Wirker einen Schrei, wenn der Alarm ausgelöst wird.
...
**_[[Magierhand-old]]:_** Die beschworene Hand ist skelettiert.
**_[[Nebelwolke]]:_** Dunstige, harmlose Klauen formen sich im Nebel.
**_[Rarys telepatisches Band](Rarys_Telepathisches_Band-old.md):_** Charaktere, die durch den Zauber verbunden sind, können das Gefühl nicht abschütteln, dass etwas Widerwärtiges sie telepathisch belautscht.
**_[Reittier_finden-old](Reittier_finden-old.md):_** Das beschworene Reittier ist untot - kein himmlisches Wesen, Feenwesen oder Unhold - und ist immun gegen Merkmale, die Untote vertreiben.
**_[[Schutzgeist]]:_** Die Geister erscheinen als phantomartige, skelettierte Krieger.
**_[[Steinwand-old]]:_** Eine durch Zauber erschaffene Wand hat grässliche Gesichter in sie hineingeschlagen, als ob gequälte Geister irgendwie im Stein gefangen wären.
...
**_[Weg finden](Weg%20finden.md):_** Der Geist eines Kindes erscheint und führt den Wirker zum gewünschten Ort. Der Geist kann nicht verletzt werden und spricht nicht.
...
$\quad$ Der Fluch wird als Vergeltung für eine Ungerechtigkeit oder eine Beleidigung ausgesprochen. Dem Ziel muss ein Weisheitsrettungswurf gelingen, um dem Fluch zu entgehen. Der SG des Rettungswurf ist 8 + der Übungsbonus des Vistana + der Charismamodifikator des Vistana. Der Fluch hält an, bis er mit dem Zauber [Fluch_brechen-old](Fluch_brechen-old.md), [Vollständige Genesung](Vollständige%20Genesung.md) oder ähnlicher Magie beendet wird. Er endet nicht, wenn das Ziel stirbt. Wenn ein verfluchtes Ziel ins Leben zurückgerufen wird, bleibt der Fluch bestehen.
...
### Böser Blick
Als Aktion kann ein Vistana eine sichtbare Kreatur innerhalb von 3m um sich herum auswählen. Diese magische Fähigkeit, die die Vistani den „Bösen Blick" nennen, dupliziert Dauer und Effekt der Zauber [Tierfreundschaft](Tierfreundschaft.md), [Person_bezaubern-old](Person_bezaubern-old.md) oder [Person_festhalten-old](Person_festhalten-old.md) (nach Wahl des Vistana), benötigt aber keine körperlichen oder materiellen Komponenten. Der SG des Zauberrettungswurfs ist 8 + der Übungsbonus des Wirkers + der Charismamodifikator des Wirkers. Wenn dem Ziel der Rettungswurf gelingt, ist der Vistana bis zum Ende des nächsten Zuges des Vistanas blind.
...
| W12 + W8 | Begegnung                                                                                                                         |
| -------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 2        | `dice: 3d6` barovianische **[Gemeine](D&D/05%20-%20Wikipedia/Bestiarium/G-H/Gemeiner.md)**                                                                                     |
...
| 12       | `dice: 1d6` **[Schreckenswölfe](Schreckenswolf-mm.md)**                                                                                     |
...
| 17       | 1 **[Druiden](Druiden.md)** mit `dice: 2d6` **[Zweigplagen](D&D/05%20-%20Wikipedia/Bestiarium/Y-Z/Zweigplage.md)**                                                                |
| 18       | `dice: 2d4` **[Nadelplagen](D&D/05%20-%20Wikipedia/Bestiarium/M-N/Nadelplage.md)**                                                                                            |
| 19       | `dice: 1d6` **[Vogelscheuchen](Vogelscheuche-mm.md)**                                                                                      |
| 20       | 1 **[Wiedergänger-old](Wiedergänger-old.md)**                                                                                             |
...
| 10       | `dice: 1d6` **[Schreckenswölfe](Schreckenswolf-mm.md)                         |
...
| 13       | 1 **[Druiden](Druiden.md)*** mit `dice: 2d6`**[Zweigplagen](D&D/05%20-%20Wikipedia/Bestiarium/Y-Z/Zweigplage.md)** |
| 14       | `dice: 2d4` **[Nadelplagen](D&D/05%20-%20Wikipedia/Bestiarium/M-N/Nadelplage.md)**                               |
| 15       | `dice: 1d6` **[Werwölfe](Werwolf%20(Legacy).md)** in Wolfsgestalt                     |
| 16       | `dice: 3d6` **[Zombies](Zombie%20(Legacy).md)                                         |
| 17       | `dice: 1d6` **[Vogelscheuchen](Vogelscheuche-mm.md)**                         |
| 18       | `dice: 1d8` **Strahdzombies** (siehe Anhang D)                             |
| 19       | 1 **[Irrlicht](D&D/05%20-%20Wikipedia/Bestiarium/I-J/Irrlicht.md)**                                              |
| 20       | 1 **[Wiedergänger-old](Wiedergänger-old.md)**                                      |
...
Das Licht ist ein [Irrlicht](D&D/05%20-%20Wikipedia/Bestiarium/I-J/Irrlicht.md), das die Charaktere in den verfallenen Turm lockt und unsichtbar wird, in der Hoffnung, die Charaktere in ihr Verderben im Inneren zu locken.
...
$\quad$ Wenn die Charaktere die Truhe berühren, brechen `dice: 3d6` [Zombies](Zombie%20(Legacy).md) aus dem Erdboden hervor und greifen an. Sobald die Zombies auftauchen, wird das [Irrlicht](D&D/05%20-%20Wikipedia/Bestiarium/I-J/Irrlicht.md) sichtbar und stürzt sich ebenfalls ins Getümmel.
...
`1-2` - Der Leichnam gehörte zu einem [Wolf](D&D/05%20-%20Wikipedia/Bestiarium/W-X/Wolf.md), der durch [Speere](Speer-old.md) und [Armbrustbolzen-phb](Armbrustbolzen-phb.md) getötet wurde.
...
Die Wälder wimmeln von [Nadelplagen](D&D/05%20-%20Wikipedia/Bestiarium/M-N/Nadelplage.md), die den bösen [Druiden](Druiden.md) von Barovia dienen. Wenn die Charaktere sich leise bewegen und keine Lichtquellen benutzen, können sie versuchen, sich vor diesen Plagen zu verstecken.

#### Schreckenswölfe
> [!readaloud] 
> Ein knurrender Wolf von der Größe eines Grizzlybären tritt aus dem Nebel hervor.

Der Bereich ist durch den Nebel leicht verschleiert. Wenn mehr als ein [Schreckenswolf-mm](Schreckenswolf-mm.md) anwesend ist, lassen die anderen nicht lange auf sich warten und können als dunkle Schemen im Nebel ausgemacht werden. Die [Schreckenswölfe](Schreckenswolf-mm.md) in Barovia sind grausame, übergroße [Wölfe](D&D/05%20-%20Wikipedia/Bestiarium/W-X/Wolf.md) und Strahds loyale Diener. Sie können nicht [[Anhang PH-A#Bezaubert|bezaubert]] oder [[Anhang PH-A#Verängstigt|verängstigt]] werden.
...
Wenn mehr als eine [Vogelscheuche-mm](Vogelscheuche-mm.md) anwesend ist, lassen die anderen nicht lange auf sich warten. Wenn keiner der Charaktere einen passiven Wert in <font color="green">**Weisheit** (Wahrnehmung)</font> von 11 oder höher hat, überraschen die [Vogelscheuchen](Vogelscheuche-mm.md) die Gruppe.
$\quad$ [Baba Lysaga](Baba%20Lysaga.md) (siehe Kapitel 10, Bereich U3) hat diese [Vogelscheuchen](Vogelscheuche-mm.md) erschaffen, um [Raben](Bestien/Rabe.md) und [Werraben](Werrabe%20(Legacy).md) zu jagen und zu töten. Die [Vogelscheuchen](Vogelscheuche-mm.md) sind mit bösen Geistern erfüllt und ergötzen sich daran, jeden zu ermorden, dem sie begegnen.
...
Aus der Entfernung sieht der [Wiedergänger-old](Wiedergänger-old.md) wie ein [Zombie (Legacy)](Zombie%20(Legacy).md) aus und kann auch vielleicht mit einem solchen verwechselt werden. Ein Charakter innerhalb von 10 Meter um den [Wiedergänger-old](Wiedergänger-old.md), dem ein Wurf auf <font color="green">**Weisheit** (Motiv erkennen)</font> gegen <font color="greenyellow">SG 10</font> gelingt, kann die Intelligenz und den Hass in seinen eingefallenen Augen sehen. Der Wiedergänger ist in einen zerrissenen [Kettenpanzer](Kettenpanzer.md) gekleidet, der den gleichen Schutz bietet wie eine [Lederrüstung](Lederrüstung.md).
$\quad$ Der [Wiedergänger-old](Wiedergänger-old.md) war ein Ritter des Ordens des Silberdrachen, der bei der Verteidigung des Tals gegen Strahds Armeen vor mehr als vierhundert Jahren ausgelöscht wurde. Der Wiedergänger erinnert sich nicht länger an seinen Namen und durchstreift das Land auf der Suche nach Strahds Wölfen und anderen Schergen und erschlägt sie, sowie er sie sieht. Wenn ihn die Charaktere angreifen, nimmt er an, dass sie mit Strahd unter einer Decke stecken und bekämpft sie bis zu seiner Vernichtung.
$\quad$ Als eine Aktion kann der [Wiedergänger-old](Wiedergänger-old.md) zweimal mit seinem [Langschwert-old](Langschwert-old.md) angreifen, er führt die Waffe mit beiden Händen und verursacht bei jedem Treffer `15` (`dice: 2d10 + 4)` Hiebschaden.
$\quad$ Wenn die Charaktere sich selbst als Feinde Strahds vorstellen, drängt der [Wiedergänger-old](Wiedergänger-old.md) sie, nach Argynvostholt zu reisen (Kapitel 7) und [Wladimir Horngaard](Wladimir%20Horngaard.md), den Anführer des Ordens des Silberdrachen, zu überzeugen, ihnen zu helfen. Der [Wiedergänger-old](Wiedergänger-old.md) täte nichts lieber, als Strahd zu töten, wird sich aber nicht zur Burg Ravenloft vorwagen, bevor er den Befehl dazu von Wladimir erhält. Wenn die Charaktere den [Wiedergänger-old](Wiedergänger-old.md) bitten, sie nach Argynvostholt zu führen, tut er das und vermeidet dabei Kontakt mit barovianischen Siedlungen.

#### Wölfe
>[!readaloud]
>Dieses Land ist die Heimat vieler Wölfe, und ihr Geheul ist im Moment näher als euch lieb ist.

Charaktere haben ein paar Minuten Zeit um sich zu stählen, bevor diese [Wölfe](D&D/05%20-%20Wikipedia/Bestiarium/W-X/Wolf.md) angreifen. Sie befolgen den Willen Strahds und können nicht [[Anhang PH-A#Bezaubert|bezaubert]] oder [[Anhang PH-A#Verängstigt|verängstigt]] werden.
