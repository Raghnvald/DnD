...
`1-2` - Der Leichnam gehörte zu einem [Wolf](D&D/05%20-%20Wikipedia/Bestiarium/W-X/Wolf.md), der durch [Speere](Speer.md) und [Armbrustbolzen-phb](Armbrustbolzen-phb.md) getötet wurde.
...
$\quad$ Als eine Aktion kann der [Wiedergänger-old](Wiedergänger-old.md) zweimal mit seinem [Langschwert](Langschwert.md) angreifen, er führt die Waffe mit beiden Händen und verursacht bei jedem Treffer `15` (`dice: 2d10 + 4)` Hiebschaden.
