...
##### X5a: Kopf der Statue
Neferon der [Arcanaloth](D&D/05%20-%20Wikipedia/Bestiarium/A-B/Arcanaloth.md) hat seinen Schlupfwinkel im hohlen Kopf der Statue, innerhalb eines Feldes magischer Dunkelheit, das den Innenraum des Kopfes ausfüllt und das menschenähnliche Gesicht der Statue verbirgt. Die Dunkelheit kann [gebannt](Magie_bannen.md) werden <font color="yellow">(SG 17)</font>.
...
Die bizarren Spiegelungen der Charaktere sind Illusionen, die dazu gedacht sind, sie vom Erkunden des Tempels abzuhalten. Die Illusionen können [gebannt](Magie_bannen.md) werden <font color="yellow">(SG 15)</font>.
...
$\quad$Der Tisch ist real, aber die Fackeln, das Festessen und die Stühle sind Illusionen, hervorgerufen durch einen Zauber [Vorbestimmte Illusion](Vorbestimmtes-Trugbild.md), der ausgelöst wird, wenn die Tür zum Raum geöffnet wird. Die Illusion kann [gebannt](Magie_bannen.md) werden (<font color="yellow">SG 17</font>).
...
#### X38: Schätze
Eine Durchsuchung des Raums bringt eine hölzerne Schriftrollenröhre zum Vorschein, die eine intakte [Zauberschriftrolle](Zauberschriftrolle-Zaubergrad-4.md) mit [Feuerwand](Feuerwand.md) enthält.
...
### X40: Versiegelte Schatzkammer
Die Bernsteintüren im Süden sind mit einem Zauber [Arkanes_Schloss-phb](Arkanes_Schloss-phb.md) versiegelt. Das Passwort, um den Zauber zu unterdrücken, lautet „Dhaviton". Ein Charakter kann die Tür mit einem gelungenen Wurf auf  <font color="red">**Stärke**</font> gegen <font color="red">SG 25</font> aufdrücken. Die Türen (RK `15`, `60` Trefferpunkte) können auch eingeschlagen werden. Wenn die Trefferpunkte der Türen auf `0` reduziert wurden, wird ein Zauber [Mächtige_Unsichtbarkeit](Mächtige_Unsichtbarkeit.md) auf den [Bernsteingolem](Steingolem.md) in diesem Raum gewirkt. Der Zauber hält 1 Minute lang an.
