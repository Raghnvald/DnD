...
> <thead>
> <tr><th colspan='4'></th><th colspan='9'>Zauberplätze pro Stufe</th></tr>
> <tr class="class-progression"><th class"level">Stufe</th><th class"pb">ÜB</th><th class"feature">Merkmale</th><th class="value">Zaubertricks</th><th class="spellSlot">1</th><th class="spellSlot">2</th><th class="spellSlot">3</th><th class="spellSlot">4</th><th class="spellSlot">5</th><th class="spellSlot">6</th><th class="spellSlot">7</th><th class="spellSlot">8</th><th class="spellSlot">9</th></tr>
> </thead><tbody>
> <tr class="class-progression"><td class"level">1</td><td class"pb">+2</td><td class"feature"><a href='#Druidisch (Stufe 1)' class='internal-link'>Druidisch</a>, <a href='#Zauberwirken (Stufe 1)' class='internal-link'>Zauberwirken</a></td><td class="value">2</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">2</td><td class"pb">+2</td><td class"feature"><a href='#Tiergestalt (Stufe 2)' class='internal-link'>Tiergestalt</a>, <a href='#Wild Companion (Level 2)' class='internal-link'>Wild Companion (TCE)</a>, <a href='#Druidenzirkel (Stufe 2)' class='internal-link'>Druidenzirkel</a></td><td class="value">2</td><td class="spellSlot">3</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">3</td><td class"pb">+2</td><td class"feature"></td><td class="value">2</td><td class="spellSlot">4</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">4</td><td class"pb">+2</td><td class"feature"><a href='#Verbesserung: Tiergestalt (Stufe 4)' class='internal-link'>Verbesserung: Tiergestalt</a>, <a href='#Attributswerterhöhung (Stufe 4)' class='internal-link'>Attributswerterhöhung</a>, <a href='#Cantrip Versatility (Level 4)' class='internal-link'>Cantrip Versatility (TCE)</a></td><td class="value">3</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">5</td><td class"pb">+3</td><td class"feature"></td><td class="value">3</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">6</td><td class"pb">+3</td><td class"feature"><a href='#Merkmal: Druidenzirkel (Stufe 6)' class='internal-link'>Merkmal: Druidenzirkel</a></td><td class="value">3</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">7</td><td class"pb">+3</td><td class"feature"></td><td class="value">3</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">8</td><td class"pb">+3</td><td class"feature"><a href='#Verbesserung: Tiergestalt (Stufe 8)' class='internal-link'>Verbesserung: Tiergestalt</a>, <a href='#Attributswerterhöhung (Stufe 8)' class='internal-link'>Attributswerterhöhung</a></td><td class="value">3</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">9</td><td class"pb">+4</td><td class"feature"></td><td class="value">3</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">10</td><td class"pb">+4</td><td class"feature"><a href='#Merkmal: Druidenzirkel (Stufe 10)' class='internal-link'>Merkmal: Druidenzirkel</a></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">11</td><td class"pb">+4</td><td class"feature"></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">12</td><td class"pb">+4</td><td class"feature"><a href='#Attributswerterhöhung (Stufe 12)' class='internal-link'>Attributswerterhöhung</a></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">13</td><td class"pb">+5</td><td class"feature"></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">14</td><td class"pb">+5</td><td class"feature"><a href='#Merkmal: Druidenzirkel (Stufe 14)' class='internal-link'>Merkmal: Druidenzirkel</a></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">15</td><td class"pb">+5</td><td class"feature"></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">16</td><td class"pb">+5</td><td class"feature"><a href='#Attributswerterhöhung (Stufe 16)' class='internal-link'>Attributswerterhöhung</a></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">⏤</td></tr>
> <tr class="class-progression"><td class"level">17</td><td class"pb">+6</td><td class"feature"></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">1</td></tr>
> <tr class="class-progression"><td class"level">18</td><td class"pb">+6</td><td class"feature"><a href='#Zeitloser Körper (Stufe 18)' class='internal-link'>Zeitloser Körper</a>, <a href='#In Tiergestalt zaubern (Stufe 18)' class='internal-link'>In Tiergestalt zaubern</a></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">1</td></tr>
> <tr class="class-progression"><td class"level">19</td><td class"pb">+6</td><td class"feature"><a href='#Attributswerterhöhung (Stufe 19)' class='internal-link'>Attributswerterhöhung</a></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">1</td><td class="spellSlot">1</td></tr>
> <tr class="class-progression"><td class"level">20</td><td class"pb">+6</td><td class"feature"><a href='#Erzdruide (Stufe 20)' class='internal-link'>Erzdruide</a></td><td class="value">4</td><td class="spellSlot">4</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">3</td><td class="spellSlot">2</td><td class="spellSlot">2</td><td class="spellSlot">1</td><td class="spellSlot">1</td></tr>
> </tbody></table>
...
- **Trefferpunkte auf höheren Stufen:** 1W8 (oder 5) + dein Konstitutionsmodifikator pro Stufe als Druide über die 1. Stufe hinaus
...
- _(a)_ ein Holz[[Gegenstände/Schild-phb|Schild]] oder _(b)_ eine beliebige einfache Waffe
- _(a)_ ein [[Krummsäbel-phb|Krummsäbel]] oder _(b)_ eine beliebige einfache Nahkampfwaffe
- eine [[Lederrüstung-phb|Lederrüstung]], eine [[Entdeckerausrüstung-phb|Entdeckerausrüstung]] und ein [[0-Druidischer-Fokus-phb|druidischer Fokus]]
...
Auf Stufe 1 kennst du zwei beliebige Zaubertricks aus der Zau berliste des Druiden. Weitere deiner Wahl lernst du auf höheren Stufen, so wie es in der Spalte für bekannte Zaubertricks in der Aufstiegstabelle des Druiden angegeben ist.

#### Vorbereiten und Wirken von Zaubern

Du musst Zaubersprüche vorbereiten, um sie wirken zu können. Wähle dazu eine Anzahl von Druidenzaubern, die deiner Stufe als Druide + deinem Weisheitsmodifikator entspricht (mindes tens 1), und notiere sie in einer Liste. Du kannst nur Sprüche aussuchen, für deren Grad du auch Zauberplätze besitzt.
...
Die Aufstiegstabelle des Druiden gibt an, wie viele Zauberplätze pro Grad dir auf jeder Stufe zur Verfügung stehen. Um einen Spruch aus deiner Liste vorbereiteter Zauber zu wirken, musst du einen Zauberpiatz des gleichen oder eines höheren Grades verbrauchen. Alle verbrauchten Zauberplätze stehen dir nach einer langen Rast wieder zur Verfügung. Hast du beispielsweise den Zauber [[Wunden_heilen-phb|Wunden heilen]] des 1. Grades vorbereitet, kannst du sowohl einen Zauberplatz des 1. Grades als auch einen des 2. Grades verwenden, um [[Wunden_heilen-phb|Wunden heilen]] zu wirken.
...
Immer wenn sich ein Zauber auf das zum Zauberwirken nöti ge Attribut bezieht, verwendest du Weisheit. Wird der Schwie rigkeitsgrad für einen Rettungswurf gegen deine Druidenzauber bestimmt, ziehst du deinen Weisheitsmodifikator hinzu. Bei Angriffen mit deinen Druidenzaubern findet ebenfalls der Weis heitsmodifikator Anwendung.

<span class='abilityDc'>**SG für Rettungswürfe**: 8 + dein Übungsbonus + dein Weisheitsmodifikator</span>

<span class='abilityAttackMod'>**Modifikator für Zauberangriffe**: dein Übungsbonus + dein Weisheitsmodifikator</span>
...
Du kannst einen [[0-Druidischer-Fokus-phb|druidischen Fokus]] als Zauberfokus für deine Druidenzauber verwenden.

### Tiergestalt (Stufe 2)

Ab der 2. Stufe kannst du deine Aktion nutzen, um auf magi sche Weise die Gestalt jedes Tieres anzunehmen, das du schon einmal gesehen hast. Du kannst diese Fähigkeit zweimal ein setzen, ohne rasten zu müssen. Nach einer kurzen oder langen Rast erhältst du alle verbrauchten Anwendungen zurück. Deine Stufe als Druide bestimmt die Art der Tiere, in die du dich verwandeln kannst, vergleiche dazu die Tabelle zur Tiergestalt unten. Beispielsweise kannst du dich auf der 2. Stufe in ein Tier mit einem Herausforderungsgrad (HG) von 1 4 oder niedriger verwandeln, das weder eine Flug noch eine Schwimmbewe gungsrate aufweist.
...
### Verbesserung: Tiergestalt (Stufe 4)

Auf Stufe 4 verbessert sich deine Tiergestalt wie in der Tabelle „Tiergestalt” angegeben.
...
### Merkmal: Druidenzirkel (Stufe 6)

Auf der 6. Stufe erhältst du ein Merkmal deines Druidenzirkels.

### Verbesserung: Tiergestalt (Stufe 8)

Auf Stufe 8 verbessert sich deine Tiergestalt wie in der Tabelle „Tiergestalt” angegeben.
...
### Merkmal: Druidenzirkel (Stufe 10)

Auf der 10. Stufe erhältst du ein Merkmal deines Druidenzirkels.
...
### Merkmal: Druidenzirkel (Stufe 14)

Auf der 14. Stufe erhältst du ein Merkmal deines Druidenzirkels.
...
### In Tiergestalt zaubern (Stufe 18)
