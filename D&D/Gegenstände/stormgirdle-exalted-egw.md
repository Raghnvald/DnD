...
cssclasses:
  - json5e-item
Bezeichnung: Stormgirdle (Exalted)
tags:
...
aliases:
  - Stormgirdle (Exalted)
linter-yaml-title-alias: Stormgirdle (Exalted)
---
# Stormgirdle (Exalted)
...
- You can cast the [control weather](/3-Mechanics/CLI/spells/control-weather-xphb.md) spell from the girdle. This property can't be used again until the next dawn.  
