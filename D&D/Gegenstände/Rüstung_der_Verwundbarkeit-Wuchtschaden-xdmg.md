...
While wearing this armor, you have [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md) to Bludgeoning damage.

## Curse

This armor is cursed, a fact that is revealed only when the [Identify](/3-Mechanics/CLI/spells/identify-xphb.md) spell is cast on the armor or you attune to it. Attuning to the armor curses you until you are targeted by a [Remove Curse](/3-Mechanics/CLI/spells/remove-curse-xphb.md) spell or similar magic; removing the armor fails to end the curse. While cursed, you have [Vulnerability](/3-Mechanics/CLI/variant-rules/vulnerability-xphb.md) to Piercing and Slashing damage.
