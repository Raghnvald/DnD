...
Additionally, while in contact with the skysail, you can use an action to cast the [fly](/3-Mechanics/CLI/spells/fly-xphb.md) spell on yourself, with a duration of 1 minute and requiring no [concentration](/3-Mechanics/CLI/conditions.md#Concentration).
