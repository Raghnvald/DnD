...
You gain a +1 bonus to attack and damage rolls made with this magic weapon. It is sized for a giant, weighs 325 pounds, and deals `dice:3d12|noform|noparens|avg` (`3d12`) slashing damage on a hit, plus an extra `dice:2d12|noform|noparens|avg` (`2d12`) slashing damage if the target is human.
