...
The chest regains `dice:1d20|noform|noparens|avg` (`1d20`) expended charges daily at dawn. If the item's last charge is expended, roll a `dice:d20|noform|noparens|avg` (`d20`). On a 1, the chest loses its magic (becoming an ordinary chest), and its gemstones turn to dust.
