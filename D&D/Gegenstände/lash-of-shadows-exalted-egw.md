...
- **Damage**: 1d4 slashing
- **Properties**: [Finesse](/3-Mechanics/CLI/item-properties.md#Finesse), [Reach](/3-Mechanics/CLI/item-properties.md#Reach), [Vestige of Divergence](/3-Mechanics/CLI/item-properties.md#Vestige%20of%20Divergence)
- **Weight**: 3.0 lbs.
...
The Lash of Shadows is a sentient chaotic evil weapon with an Intelligence of 18, a Wisdom of 16, and a Charisma of 20. It has hearing and [darkvision](/3-Mechanics/CLI/senses.md#Darkvision) out to a range of 120 feet.

The weapon communicates telepathically with its wielder and can speak, read, and understand Abyssal, Common, and Draconic.

## Personality

A mad [marilith](/3-Mechanics/CLI/bestiary/fiend/marilith-xmm.md) named Sizlifeth lives within the Lash of Shadows. The weapon has a short temper and experiences only extreme emotions. It is most happy when dealing harm.
...
-     - **Dead Eyes.** A creature that fails the saving throw against this poison is [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) for 1 hour. While [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) in this way, the creature is [blinded](/3-Mechanics/CLI/conditions.md#Blinded).    
...
- The weapon gains a new poison option called Ghoul's Blood. A creature that fails the saving throw against this poison is [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) for 1 minute. While [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) in this way, the creature is [paralyzed](/3-Mechanics/CLI/conditions.md#Paralyzed). The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
