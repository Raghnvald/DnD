...
If you're holding the orb when you take necrotic damage, you can use your reaction to reduce the damage by `dice:1d4|noform|noparens|avg` (`1d4`) (to a minimum of 0).
