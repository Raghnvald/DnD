...
- [Opportunity attacks](/3-Mechanics/CLI/actions.md#Opportunity%20Attack) against you are made with disadvantage.  
- Whenever you move within 5 feet of a hostile creature, it must succeed on a DC 15 Dexterity saving throw or take `dice:3d8|noform|noparens|avg` (`3d8`) lightning damage. A creature can't be damaged in this way more than once per turn.  
