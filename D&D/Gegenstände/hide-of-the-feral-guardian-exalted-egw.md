...
- As an action, you can use the armor to cast [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md) on yourself, transforming into a [giant owl](/3-Mechanics/CLI/bestiary/celestial/giant-owl-xmm.md) while retaining your Intelligence, Wisdom, and Charisma scores. This property can't be used again until the next dawn.  
...
- When you cast the [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md) spell using this armor, you can transform into a [cave bear](/3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md).  
...
- When you cast the [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md) spell using this armor, you can transform into a [guardian wolf](/3-Mechanics/CLI/bestiary/monstrosity/guardian-wolf-egw.md).  
