...
- When a creature within 5 feet of you hits you with a melee attack, you can use your reaction to create a burst of radiance from the sword, dealing `dice:1d8|noform|noparens|avg` (`1d8`) radiant damage to the attacker.  
...
- The burst of radiance you can create as a reaction when hit with a melee attack deals `dice:1d12|noform|noparens|avg` (`1d12`) radiant damage, and you can immediately teleport to an unoccupied space you can see within 15 feet of you as part of the same reaction.  
