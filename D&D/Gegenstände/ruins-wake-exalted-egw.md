...
- **Range**: 20/60
- **Properties**: [Thrown](/3-Mechanics/CLI/item-properties.md#Thrown), [Versatile](/3-Mechanics/CLI/item-properties.md#Versatile), [Vestige of Divergence](/3-Mechanics/CLI/item-properties.md#Vestige%20of%20Divergence)
- **Weight**: 3.0 lbs.
...
Ruin's Wake is a sentient chaotic evil weapon with an Intelligence of 20, a Wisdom of 16, and a Charisma of 22. It has hearing and [darkvision](/3-Mechanics/CLI/senses.md#Darkvision) out to a range of 120 feet.

The weapon communicates telepathically with its wielder and can speak, read, and understand Abyssal, Common, and Orc.

## Personality

A slaughter-loving [balor](/3-Mechanics/CLI/bestiary/fiend/balor-xmm.md) named Yarrowish lives within Ruin's Wake. The weapon desires only to draw blood and pushes its wielder to solve problems with violence.
...
- You gain a +1 bonus to attack and damage rolls made with this magic weapon, and it deals an extra `dice:1d8|noform|noparens|avg` (`1d8`) piercing damage to any target it hits. Immediately after you make a ranged attack with this weapon, it flies back to your hand.  
