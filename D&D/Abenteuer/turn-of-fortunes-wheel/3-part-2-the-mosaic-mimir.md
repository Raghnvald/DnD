...
Status: WIP
linter-yaml-title-alias: "Part 2: The Mosaic Mimir"
tags:
  - Quelle/5e/tofw
aliases:
...
![The walking castle Iedcaru endlessly explores the Outlands](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/018-02-001-splash.webp#center)
...
Creatures can follow the tracks toward the forest. A character who succeeds on a DC 12 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check knows the tracks weren't made by an animal, but rather by a large magical device or machine.

A character who succeeds on a DC 10 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check recognizes the stone spire in the distance as the Spire that marks the center of the Outlands and atop which floats Sigil.
...
The walking castle Iedcaru is a treasure from ages past. It was created by githzerai as a hermitage where ascetics could travel the Outlands and meditate on the nature of realms beyond. While the castle has been forgotten by most githzerai scholars in Limbo, it remains the home of [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md), a sage who seeks to glean multiversal truths from mystical planar forces.

Iedcaru has recently seen more visitors than usual. The first was the modron [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md), which stopped at the castle and learned much about the Outlands. More recently, though, a host of Fiends discovered and occupied the castle. They've captured [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) and are now working to discover how to operate the castle. The Fiends' goals are up to you; they could be seeking to claim the castle and sell it as a war machine, or they might be working for Shemeshka through intermediaries seeking to track [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md).
...
> [!gallery]
> ![Map 4.1: Walking Castle](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/019-map-2-01-walking-castle.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/020-map-2-01-walking-castle-player.webp#gallery)
...
A character who walks around the tower and succeeds on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notices the perch and door to area W4c, 30 feet above.
...
Among the candles in the alcove sits a partially melted [candle of invocation](3-Mechanics/CLI/items/candle-of-invocation-xdmg.md) of a random alignment that has 1 hour of use remaining.

#### W3: Main Room

A character who listens carefully before entering this area and succeeds on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check can hear the tieflings inside discussing whether to betray someone named Thlaarsh.
...
The kitchen has been plundered, but 14 days of [rations](3-Mechanics/CLI/items/rations-xphb.md) remain. These mostly consist of pickled radishes—a favorite of [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md)'s.
...
If the nycaloth in this room is aware of the characters, it casts [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md). When a character enters the room, read or paraphrase the following, leaving out the last sentence if the nycaloth is [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible):
...
This is [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md)'s study. The [nycaloth](3-Mechanics/CLI/bestiary/fiend/nycaloth-xmm.md) Thlaarsh the Gore Drinker is here, seeking ways to make the castle move. Thlaarsh attacks rival trespassers and fights to the death, but it tries to capture spellcasters, hoping to make them pilot the castle.

##### Treasure

The desk holds [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md)'s notes on the Outlands, which are written in Gith, as well as [calligrapher's supplies](3-Mechanics/CLI/items/calligraphers-supplies-xphb.md). On the desk is a broken [mimir](3-Mechanics/CLI/items/mimir-sato.md) (see "Sigil and the Outlands") with a skull made of colorful glass shards. This [mimir](3-Mechanics/CLI/items/mimir-sato.md) is further detailed in the "Mosaic Mimir" section later in this chapter.

#### W6: Castellan Chamber

If the two mezzoloths in this room were alerted by noise in area W3, they cast [darkness](3-Mechanics/CLI/spells/darkness-xphb.md) before the characters enter. Otherwise, read or paraphrase the following when a character enters the room:
...
The two [mezzoloths](3-Mechanics/CLI/bestiary/fiend/mezzoloth-xmm.md) attack the characters on sight and fight to the death.
...
A character who investigates the south wall and succeeds on a DC 18 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a secret door that slides open. In this space is a small table on which sit several candles and a [necklace of prayer beads](3-Mechanics/CLI/items/necklace-of-prayer-beads-xdmg.md) with `1d4 + 2` magic beads.
...
The Fiends have kept the castle's caretaker, a neutral githzerai uniter (see "Morte's Planar Parade") named [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md), in this chamber. [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) is eager to be free and evict the devils from her home. She is further detailed in the "Zaythir" section.

##### Crystal

The green crystal affixed to the pedestal is a [gem of brightness](3-Mechanics/CLI/items/gem-of-brightness-xdmg.md). When the gem is lit, its light can be seen over a mile away.

### Castle's Residents

Once the Fiends are defeated and [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) is freed, the characters have access to the walking castle and the gratitude of its residents. These residents help the characters however they can.

![The githzerai Zaythir uses the Castellan to set the walking castle's course across the Outlands](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/021-02-002-zaythir.webp#center)

#### Zaythir

[Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) is a patient scholar of the planes who rarely shows extremes of emotion. If she is freed and the Fiends are driven out of her home, she's indebted to the characters. She introduces herself and can provide information on the following topics:

- **Personal Background.** [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) is a scholar of the planes who studies the Outlands and the planes beyond. She has guarded the walking castle alone for years.  
- **The Castellan.** This magical being is [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md)'s companion and the heart of Iedcaru. It controls the castle's movement. [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) can introduce the characters to it (see the "The Castellan" section).  
...
- **Modron.** [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) was recently visited by a monodrone who called himself [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md). He had been using a [mimir](3-Mechanics/CLI/items/mimir-sato.md) (see "Sigil and the Outlands") to follow the path of the last Great Modron March, intending to learn truths of the multiverse. He left his [mimir](3-Mechanics/CLI/items/mimir-sato.md) here, saying it told him where to go after visiting all the gate-towns (though he didn't say where that was). His mimir was damaged during the Fiends' attack (see the "Mosaic Mimir" section).  

[Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) knows nothing about the multiversal glitch affecting the characters, but she's happy to let them research in the castle's library. Unfortunately, the library contains no information on the characters' circumstances.

If it's clear the characters plan to explore the Outlands, [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) offers to help, both by sharing her knowledge of the plane and by letting the group travel via Iedcaru and use it as a base.

#### The Castellan

This magical wonder is inert when the characters first enter area W6. [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) can reactivate it with a word, at which point its body animates and the table before it projects an illusory image of the Outlands.
...
- The Castellan has hearing and [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) out to a range of 60 feet, and it can understand Common and Gith but can't speak. It communicates through gestures alone.  
...
The Mosaic Mimir is a [mimir](3-Mechanics/CLI/items/mimir-sato.md) (see "Sigil and the Outlands") that looks like a human skull made of gold, silver, jade, and onyx. The *mimir* was badly damaged in the attack on Iedcaru, and it lies in pieces.

The Mosaic Mimir can be physically repaired by a character who spends an hour and succeeds on a DC 12 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check. [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) can repair it if the characters can't. While this repairs the [mimir](3-Mechanics/CLI/items/mimir-sato.md) physically, it doesn't restore the lost information about the Outlands. The *mimir* once knew information about all the gate-towns and their portals to the Outer Planes, but it is now missing data on the following gate-towns:
...
The [mimir](3-Mechanics/CLI/items/mimir-sato.md) is also missing data on the last Great Modron March (see "The Last Great Modron March"). This information still exists, but it's inaccessible until the data on the gate-towns is restored.

#### Restoring the Mimir's Data

![R04M the Missing Monodrone](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/022-02-003-ro4m.webp#center)

The [mimir](3-Mechanics/CLI/items/mimir-sato.md) holds the key to finding [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md), but it must have its missing data restored to access its Esoteric Knowledge and Planar Knowledge properties (detailed in "Sigil and the Outlands"). [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) or a character who succeeds on a DC 12 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check knows that the following steps are required to restore missing data to the *mimir*:
...
- **Information Entry.** Whoever is attuned to the [mimir](3-Mechanics/CLI/items/mimir-sato.md) must record a description of the location and their impression of it. This process takes 1 minute.  
...
![Handout 4.1: Mimir Restoration Tracker](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/023-02-017-mimir-tracker.webp#center)

#### The Last Great Modron March

Once data on all seven missing gate-towns is restored, the [mimir](3-Mechanics/CLI/items/mimir-sato.md) can report on the Great Modron March. It provides the following details:
...
[Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) can help the characters piece together that to find [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md), they must restore the Mosaic Mimir by visiting the seven gate-towns for which it's missing data. Then, it should be able to relate the details about the last Great Modron March, which [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) was following. The characters might seek other sources for information about the last Great Modron March, but the event was so fraught with incongruities and lost so many modrons that it's impossible to know what tangent of the march [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) is following. [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) also offers to let the characters use Iedcaru as a base and conveyance across the Outlands—though [Zaythir](3-Mechanics/CLI/bestiary/npc/zaythir-tofw.md) won't leave the Outlands herself or let the walking castle travel to other planes.
...
![Beltha and her chaotic gang operate out of the Inverse, the upside-down realm beneath Automata](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/024-02-004-the-inverse.webp#center)
...
The gate to Mechanus is guarded by a decaton modron (see "Morte's Planar Parade") and four [pentadrones](3-Mechanics/CLI/bestiary/construct/modron-pentadrone-xmm.md). If any of these modrons are attacked or feel threatened, they can call on more pentadrones, which arrive in 3 rounds. The guards are indifferent to the characters, and they tell anyone who approaches to get in line. It takes 19 (`3d12`) hours for a creature at the back of the line to reach the gate. Even then, only those with a gate-access permit may approach the gate (see "Accessing the Gate"). If anyone approaches with questions about the gate, the guards direct them to the Gate Travel Administration.
...
> [!gallery]
> ![Map 5.1: Inverse Hideout](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/025-map-2-02-inverse-hideout.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/026-map-2-02-inverse-hideout-player.webp#gallery)
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | Three [kenku](3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md) mockingly mimic the voices of modrons as they try to steal the Mosaic Mimir. They retreat if threatened. |
| 2 | Two Hands of Havoc fire starters (see "Morte's Planar Parade") encourage the characters to share how "the system" has wronged them and offer a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) if a character has need. |
| 3 | A silent [green slaad](3-Mechanics/CLI/bestiary/aberration/green-slaad-xmm.md) insistently tries to take a character's flashiest article of clothing. |
| 4 | A chaotic neutral [duodrone](3-Mechanics/CLI/bestiary/construct/modron-duodrone-xmm.md) carries a sign that reads "Glitch Is Nigh!" It entreats a character to prepare for the great multiversal realignment. |
^inverse-incidents
...
Beltha (chaotic neutral [githzerai zerth](3-Mechanics/CLI/bestiary/aberration/githzerai-zerth-xmm.md)) is on the balcony above with her allies Kit and Kot (chaotic neutral [quadrones](3-Mechanics/CLI/bestiary/construct/modron-quadrone-xmm.md)). Below, near the spiral stairs, is the [red slaad](3-Mechanics/CLI/bestiary/aberration/red-slaad-xmm.md) Kythkyr. The group is hostile to trespassers and demands they leave. The group attacks the following round. The quadrones favor using their Shortbow attacks, while Kythkyr tries to prevent intruders from climbing to the balcony.

A character who uses an action and succeeds on a DC 14 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check can convince Beltha to call off her gang and talk (see "Talking with Beltha" for details).

##### Exposed Machinery

The area is filled with hazardous machinery that can catch creatures in its gears. A creature that starts its turn within 5 feet of these machines, or that moves into that area for the first time on a turn, must succeed on a DC 15 Dexterity saving throw or take 16 (`3d10`) bludgeoning damage and have the [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) condition (escape DC 15) as it becomes caught in the gears. A [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) creature can make another saving throw to escape the gears at the start of its next turn.

##### Treasure

The crates and workbenches in the room are covered in rusted, worthless tools. On the balcony above lie knickknacks and pieces of symmetrical art worth a total of 200 gp. A character who examines the couch on the balcony and succeeds on a DC 16 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a stash of several well-packed, precision-made lenses hidden between the cushions. These lenses are worth 750 gp total.
...
![Without help, Valder and Fellik Sands have little hope of escaping the oppressive gate-town of Curst](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/027-02-005-valder-and-fellik.webp#center)
...
Two maelephants (see "Morte's Planar Parade") allow the characters to enter the gate-town. As they enter, characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 16 or higher notice that the community's gates have bars only on the outside—as if they're designed to keep people inside. Those who question the guards here are told to move along (see the "Curst's Walls" section for details).
...
| dice: d6 | Encounter |
|----------|-----------|
| 1 | A farastu demodand (see "Morte's Planar Parade") drags a [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md) to the gate to Carceri and intends to throw the criminal through it. |
| 2 | The locals ignore a gigantic crash that echoes through town. The noise originated at the town dump; it was caused by the collapse of a towering metal sculpture built by the dour [adult copper dragon](3-Mechanics/CLI/bestiary/dragon/adult-copper-dragon-xmm.md) Tudhog the Junk Wyrm (see the ""Curst"" section of "Sigil and the Outlands"). |
| 3 | A hateful criminal ([cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md)) jeers at the characters from a public pillory or hanging cage. |
| 4–6 | Eyes peer at the characters from the shadows. Roll a die. If you roll an even number, the watcher is a [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) who's suspicious of the characters. If you roll an odd number, it's a cranium rat squeaker swarm (see "Morte's Planar Parade"). |
^curst-encounters
...
When the characters return to Valder's shack, Fellik is ready to go. Valder gives his son a pouch containing 5 ep, and the pair share a brief hug. Fellik then leads the characters toward the dump. The journey through town is uneventful, but characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 16 or higher notice locals watching them suspiciously.
...
- **Sludge.** Viscous runoff pools in the dump. Unless otherwise noted, this sludge is 2 feet deep and is "difficult terrain". Creatures that try to leave a pool of sludge must succeed on a DC 8 Strength saving throw or have the [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) condition. A [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) creature can make another saving throw to escape the sludge at the start of its next turn.  
...
> [!gallery]
> ![Map 6.1: Curst Escape](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/028-map-2-02-curst-escape.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/029-map-2-02-curst-escape-player.webp#gallery)
...
The figures are Amod Ka and Lot Sheng, lawful neutral, human Mercykiller bloodhounds (see "Morte's Planar Parade"). Lot's [driftglobe](3-Mechanics/CLI/items/driftglobe-xdmg.md) lights the room. On spotting Fellik, Amod asks, "Any luck finding your pops, kid?"
...
A character who succeeds on a DC 20 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check convinces the Mercykillers that Valder is dead or not in Curst.
...
![A mysterious criminal uses sinister magic to capture souls in Excelsior](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/030-02-006-sinister-magic.webp#center)
...
Creatures of evil alignment see visions of judgment and shame in the mosaics that decorate the ascent. Every minute that an evil creature climbs the Godstrand or is otherwise within 100 feet of the gate to Mount Celestia, it must make a DC 10 Wisdom saving throw. On a failed save, the creature has visions of its past wicked deeds and gains 1 level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) that can't be removed until it finishes a long rest away from the Godstrand. Creatures that reach level 5 [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) are eventually found by heavenly denizens and removed from the tower. This effect never causes a creature to have level 6 [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion).
...
Varrel is willing to pay the characters for their aid, offering the group 2,500 gp and a [brooch of shielding](3-Mechanics/CLI/items/brooch-of-shielding-xdmg.md) sculpted with watchful canine features. If the characters agree to aid Varrel, he shares what he knows and can lead the characters to either the headquarters of the Excelsior Guard or Sincerity's home (detailed later in this chapter).
...
No one in Excelsior is sure of it yet, but Sincerity is behind the disappearances in town. She uses empty [iron flasks](3-Mechanics/CLI/items/iron-flask-xdmg.md) provided by the night hag Uncle Longteeth to capture victims, then uses her trained sunflies to deliver the flasks to him. The night hag plans to take the souls to Hades, where he'll transform them into [larvae](3-Mechanics/CLI/bestiary/fiend/larva-xmm.md) (see the "Dungeon Master's Guide") and sell them as delicacies to deplorable immortals. The characters gradually discover this in the course of their investigation.
...
None of the missing individuals had known rivals or left behind evidence. A character who succeeds on a DC 16 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check notes that none of these individuals is a native of the Outer Planes (a fact that matters for [iron flasks](3-Mechanics/CLI/items/iron-flask-xdmg.md)).
...
The hound archon (see "Morte's Planar Parade") is Rolm, an investigator who has features like a terrier. The tiefling is Sincerity, a lawful evil [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) (without weapons at the moment). Sincerity benefits from a supernatural gift that permanently grants her the effects of the spell [glibness](3-Mechanics/CLI/spells/glibness-xphb.md).
...
- A character who mentions strange lights or succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check causes the local to recall that they saw colorful lights near where a missing person vanished.  
...
This wagon is the home of Uncle Longteeth, a [night hag](3-Mechanics/CLI/bestiary/fiend/night-hag-xmm.md) that trades in artisanal larvae across the Lower Planes. Uncle Longteeth is waiting for another delivery from Sincerity and rudely tells visitors to go away. He attacks if his wagon is broken into or if he's presented with evidence that he's involved with Sincerity's crimes—such as the fact that her sunfly pets are trained to come to him. The night hag flees using [plane shift](3-Mechanics/CLI/spells/plane-shift-xphb.md) if reduced to 30 or fewer hit points.

Uncle Longteeth's wagon is filled with empty, filthy cages. It also holds a locked chest, which a character can pick by succeeding on a DC 16 Dexterity check using thieves' tools. Inside the chest are six bottles that function similarly to [iron flasks](3-Mechanics/CLI/items/iron-flask-xdmg.md), but they work only in the Outlands. Trapping a creature or releasing a creature in any of these flasks is possible only on this plane.
...
- **Compelling Story.** A character presents multiple compelling circumstances—like locals noticing colored lights that could belong to Sincerity's sunflies and her sunflies flying to Uncle Longteeth's wagon—and succeeds on a DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check.  

Sincerity pleasantly surrenders after confessing her crimes. The guards collect Uncle Longteeth's [iron flasks](3-Mechanics/CLI/items/iron-flask-xdmg.md) as evidence. If the characters refuse to surrender the flasks, Varrel explains he needs the bottles to ensure Sincerity meets justice at her trial. He'll look the other way if the characters take one [iron flask](3-Mechanics/CLI/items/iron-flask-xdmg.md), but if they try to take more, he calls upon five other hound archons (see "Morte's Planar Parade") who insist the characters relinquish the evidence.
...
If the characters got Sincerity to confess, the hound archon Rolm seeks them out before they leave Excelsior. She thanks them on behalf of the gate-town and gifts them a [lantern of revealing](3-Mechanics/CLI/items/lantern-of-revealing-xdmg.md).

If Uncle Longteeth escaped, he resents the characters for interfering with his business. Sometime later, he has a [smoke mephit](3-Mechanics/CLI/bestiary/elemental/smoke-mephit-xmm.md) deliver them a threat: a [larva](3-Mechanics/CLI/bestiary/fiend/larva-xmm.md) (see the "Dungeon Master's Guide") that bears a shocking resemblance to one of the characters.
...
![The leaders of Faunel's three packs of sapient animals argue over how best to lead the gate-town](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/031-02-008-leaders-of-faunel.webp#center)
...
The sloth is named Razak. He uses [black bear](3-Mechanics/CLI/bestiary/beast/black-bear-xmm.md) stat block, with the following adjustments:

- Razak is neutral good.  
- He has a climbing speed of 10 feet.  
- He has an Intelligence of 10 and a Charisma of 14.  
- He speaks Common.  
- His bracelet functions as a [ring of animal influence](3-Mechanics/CLI/items/ring-of-animal-influence-xdmg.md).  
...
Nearly a mile from Camp Greenbriar stands the gate to the Beastlands: a peaceful pond surrounded by vine-covered ruins. A 20-foot-tall statue of a human with glowing eyes kneels by the pool. This is the guardian of the gate, an ancient being known as Wrath. It uses the [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md) stat block, with the following changes:

- Its creature type is Construct (Titan).  
- Its Maul attack is a Slam instead.  
- It automatically knows when it hears a lie.  

Wrath questions any creature approaching the pool, asking the creature's business in a booming voice. The guardian attacks any non-Beast who lies, refuses to answer, or tries to use the gate without Wrath's permission. If the characters are honest about why they want to use the gate, Wrath allows them to bring their [mimir](3-Mechanics/CLI/items/mimir-sato.md) close to the gate and record an entry for Faunel.
...
These six hunters (use the [gnoll pack lord](3-Mechanics/CLI/bestiary/fiend/gnoll-pack-lord-xmm.md) stat blocks) are members of the Vile Hunt, a group of poachers murdering animals around Faunel. On noticing the characters, the gnolls attack. If four or more gnolls are killed, the survivors flee.

If Razak is with the characters, he avoids battle.

#### After the Battle

If Razak is with the characters after the battle, he identifies the ibex as Oka, a storyteller and advisor to [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md), leader of a group of local herbivores. If Razak wasn't with the characters, he comes across the scene as the battle ends and shares the same information. The ibex's body bears a distinguishing accessory: a beaded necklace with an eye-shaped topaz. The necklace is worth 40 gp.

Razak encourages the characters to come with him to Heart Delta to meet [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) and convey the news of Oka's death.
...
> [!readaloud] 
> 
> Sleepy rivers wind through a sprawling expanse of high grasses and fruiting trees. Giant herbivores, such as long-necked giraffes and brachiosauruses, munch on tall vegetation, while herds of bison, gazelle, and goats wander the surrounding plains. In the distance, rock formations encircle a broad crater.
^118

The crater at the center of Heart Delta is called the Hollow. Here the elephant [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) addresses hundreds of gathered animals nightly. Characters seeking [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) find her here.

[Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) uses the [elephant](3-Mechanics/CLI/bestiary/beast/elephant-xmm.md) stat block, with the following changes:

- [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) is lawful good.  
- She has an Intelligence of 10, a Wisdom of 14, and a Charisma of 14.  
- She speaks Common.  

#### Talking with Ophelia

[Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) is wise and patient, and she seeks to protect her people. She wants to create a new Faunel where sapient animals overcome their instincts and live communally. If the characters converse with her, she shares the following information:

- She's saddened to hear about Oka's death but thanks the characters for informing her.  
- She suspects the Vile Hunt is working for [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md), the leader of the predators at Razortooth Rock.  
- She recently defeated [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) in battle when he and some of his predators attacked a herd under her protection.  
- She suspects Oka's death is [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md)'s retaliation.  
- She asks the characters to go to Razortooth Rock and find out if [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) is working with the Vile Hunt.  

If the characters can find out who is behind Oka's death, [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) promises to reward them with a [figurine of wondrous power (serpentine owl)](3-Mechanics/CLI/items/figurine-of-wondrous-power-serpentine-owl-xdmg.md).
...
Sapient predatory animals follow the characters through this wilderness but don't bother the characters. At Razortooth Rock, the peak at the center of this rugged land, the characters find [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md).

[Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) uses the [saber-toothed tiger](3-Mechanics/CLI/bestiary/beast/saber-toothed-tiger-xmm.md) stat block with the following changes:

- [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) is lawful neutral.  
- He has an Intelligence of 12 and a Charisma of 12.  
- He speaks Common.  

#### Talking with Ebonclaw

[Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) is arrogant and cunning, but he is nursing his wounded pride after a clash with [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md). He seeks to create a Faunel where the residents embrace their skills, becoming proud and powerful.

[Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) is suspicious of visitors, even if Razak is with them. He converses only if a character succeeds on a DC 16 Charisma ([Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation) or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check or brings him a gift of fresh yak meat. Characters might purchase yak meat at Camp Greenbriar for 20 gp or ask [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) to provide it from a non-sapient source.

Once [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) agrees to speak with the characters, he is forthright and shares the following:

- He was recently defeated in battle by [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md). He and his hunters attacked a group of reindeer, not realizing the group was under her protection. His group was in the wrong.  
- He knows nothing of Oka's death but is sad to hear of it. He doubts any creature in his territory was involved.  
- [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) loathes the Vile Hunt.  
- Although he doesn't know who killed Oka, he suggests asking [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) at Eagles' Aerie—the albatross leader's flying followers see all.  
...
Any of the sapient birds who make their home in Eagles' Aerie can direct the characters to their leader, [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md). Currently, the albatross is at a meeting place called Watcher's Talon, deep in the forest. The most direct route to the site takes 2 hours. Unless a character succeeds on a DC 14 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check, they follow a winding route that takes twice as long.

On reaching Watcher's Talon, the characters find a petrified, leafless tree. Here the giant albatross [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) holds court with a congress of winged creatures—sapient [eagles](3-Mechanics/CLI/bestiary/beast/eagle-xmm.md), [owls](3-Mechanics/CLI/bestiary/beast/owl-xmm.md), [pteranodons](3-Mechanics/CLI/bestiary/beast/pteranodon-xmm.md), winged lizards, and more.

[Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) uses the [giant eagle](3-Mechanics/CLI/bestiary/celestial/giant-eagle-xmm.md) stat block, with the following changes:

- [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) is neutral.  
- He has an Intelligence of 16 and a Charisma of 14.  
- He speaks Common.  

#### Talking with Parvaz

[Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) is guarded and pragmatic. He seeks to create a Faunel on par with other gate-towns, where the residents trade and leverage their unique abilities.

During a conversation with the characters, [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) shares the following information:
...
A character who succeeds on a DC 18 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check can convince [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) to share the location of the Vile Hunt's camp. Otherwise, the characters need to make sharing this information worth [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md)'s while. [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md) would be interested in the [figurine of wondrous power (serpentine owl)](3-Mechanics/CLI/items/figurine-of-wondrous-power-serpentine-owl-xdmg.md) [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) offered the characters. He's also willing to accept a gift at a later date, at which point he sends agents to see if the characters have anything he'd be interested in.

Once the characters have struck a deal with [Parvaz](3-Mechanics/CLI/bestiary/npc/parvaz-tofw.md), he shares the location of the Vile Hunt.

#### Pursuing the Vile Hunt

The Vile Hunt gnolls lurk in a clearing a half-day's travel from Camp Greenbriar. If the characters bring this information to [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) or [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md), the first leader they speak to offers the characters 2,000 gp worth of gemstones to participate in a raid. They also send friendly animals equal to the number of characters. [Ebonclaw](3-Mechanics/CLI/bestiary/npc/ebonclaw-tofw.md) sends [dire wolves](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md), and [Ophelia](3-Mechanics/CLI/bestiary/npc/ophelia-tofw.md) sends [rhinoceroses](3-Mechanics/CLI/bestiary/beast/rhinoceros-xmm.md).

> [!gallery]
> ![Map 8.1: Vile Hunt Camp](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/032-map-2-03-vile-hunt-camp.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/033-map-2-03-vile-hunt-camp-player.webp#gallery)
...
Mick Mangehide, the [gnoll fang of Yeenoghu](3-Mechanics/CLI/bestiary/fiend/gnoll-fang-of-yeenoghu-xmm.md) who leads the Vile Hunt, camps here with four hunters (use the [gnoll pack lord](3-Mechanics/CLI/bestiary/fiend/gnoll-pack-lord-xmm.md) stat block). They attack as soon as they see any outsiders, and they fight to the death. One hunter stays near the cage at the rear of the camp. After 1 round, the hunter opens the cage and releases the panicked [triceratops](3-Mechanics/CLI/bestiary/beast/triceratops-xmm.md) inside.

##### Triceratops

The triceratops uses its Trampling Charge trait as often as it can, attacking a random creature every round. A character who spends an action and succeeds on a DC 16 Wisdom ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) check can direct the dinosaur to flee from the camp toward the south.

##### Treasure

Among the filthy gear is a sack containing three [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and 1,400 gp. The cages are empty except for one holding a lengthy snakeskin that functions as a [rope of entanglement](3-Mechanics/CLI/items/rope-of-entanglement-xdmg.md).

### Conclusion

The chapter concludes when the characters leave Faunel or when they have defeated the Vile Hunt. If the characters return to any of the leaders of the animal groups, the leaders commend the characters' actions and provide them any promised rewards. Razak also thanks the characters for their help and gifts them his [ring of animal influence](3-Mechanics/CLI/items/ring-of-animal-influence-xdmg.md).
...
The gate-town of Glorium rings with songs of glory. In the bay beyond the town swirls a great whirlpool that regularly swallows and disgorges ships. This is the gate to Ysgard, where the characters must bring the Mosaic Mimir.

Glorium is detailed in "chapter 3" of "Sigil and the Outlands". Review the town's description prior to running this chapter.

![Whirlwyrms attack the living ship, Courier, in the whirlpool-portal to Ysgard](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/034-02-009-courier.webp#center)
...
|----------|---------|----|---------------|
| 1 | Arm wrestling | 17 | Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) |
| 2 | Pinfinger | 15 | Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) |
| 3 | Goat milking | 14 | Wisdom ([Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling)) |
| 4 | Flyting | 13 | Charisma ([Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation) or [Performance](3-Mechanics/CLI/rules/skills.md#Performance)) |
^glorium-contests

#### Gate to Ysgard

The gate to Ysgard is a maelstrom a mile offshore. Characters directed to the gate can see it in the distance from Glorium's docks. Spells like [fly](3-Mechanics/CLI/spells/fly-xphb.md) or [water walk](3-Mechanics/CLI/spells/water-walk-xphb.md) can help characters reach the gate, but getting close enough to update their [mimir](3-Mechanics/CLI/items/mimir-sato.md) is a damp, miserable experience that attracts the attention of whirlwyrms (see the "Whirlwyrm Attack" section).
...
Bkol Steelbane (chaotic good, orc [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) is a lanky sailor and one of two captains of the *Courier*. The other captain is the *Courier* itself, as the vessel is an amalgam of longship and joke-loving, sapient giant raven. The pair has been ferrying folks through the portal to Ysgard for years.
...
Once Bkol and the *Courier* are hired, they and their crew of eight rowers (chaotic good [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)) are ready to leave at the characters' convenience.

### Whirlwyrm Attack

Reaching the gate to Ysgard by boat takes an hour. As the characters near the maelstrom, a character who succeeds on a DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notices two serpentine shapes in the water. These are deadly giant eels known as whirlwyrms (use the [giant crocodile](3-Mechanics/CLI/bestiary/beast/giant-crocodile-xmm.md) stat block). If no character notices the whirlwyrms, the characters and all the sailors on the *Courier* are surprised when the eels burst from the water—one on each side of the ship—and attack. A [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) dives underwater and flees if it is reduced to 10 or fewer hit points.
...
Tyrza Bonebreaker (chaotic good, human [gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md); "detailed further" in "Sigil and the Outlands") is loud, powerful, and free with her feelings and praise. She's fond of Bkol, and listens as he encourages the characters to recount the [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) attack. When he's done reporting, Tyrza says the following:
...
- **Sytri.** A silent, masked woman wearing Doomguard armor, Sytri is a chaotic good Doomguard rot blade (see "Morte's Planar Parade"). She unfurls a [carpet of flying](3-Mechanics/CLI/items/carpet-of-flying-3-ft-5-ft-xdmg.md) measuring 3 feet by 5 feet and woven with the image of a flying demon skull.  
...
Sytri and Tol want to be the first to find out what's happening in Grakenok, and Bkol encourages the characters to act swiftly to keep up with them. Sytri and Tol set off immediately, using their [carpet of flying](3-Mechanics/CLI/items/carpet-of-flying-3-ft-5-ft-xdmg.md) and ship, respectively. The characters can travel to Grakenok however they like. It would take their walking castle days to circle the bay and reach Grakenok, so Bkol offers them use of the *Courier*.
...
Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 14 or higher see the following scene:
...
The characters might be traveling close enough to Sytri or Tol that the other hero can hear them. A character who points out the floundering ship to the other hero and succeeds on a DC 16 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check convinces their rival to investigate the boat, delaying that hero's arrival in Grakenok.

The dingy is doomed, but its lone sailor is easily saved. This precocious human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) calls himself Kai and is impressed by whoever rescued him. Kai might be either a young thrill seeker from Glorium or the Lemming Boy (see the ""Glorium"" section of "Sigil and the Outlands").

If no one tries to save the dingy, both it and its occupant eventually fade from view and don't reappear.

#### Whirlwyrm Spotted

A giant splash reveals another [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) (use the [giant crocodile](3-Mechanics/CLI/bestiary/beast/giant-crocodile-xmm.md) stat block) swimming near the characters. If sailing characters want to sneak by the creature, they must succeed on a DC 10 group Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check, or the monster notices them and attacks. If the characters engage the creature in combat, they're delayed in arriving at Grakenok (see the "Arriving in Grakenok" section).

A character who calls out to a nearby rival and succeeds on a DC 16 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check can convince the rival to fight the [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md), which delay's that hero's arrival in Grakenok.
...
> [!readaloud] 
> 
> With its colorful homes and varied goat and sea-serpent carvings, the village of Grakenok would look cozy were it not being attacked by a behemoth [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md). Over thirty feet long, the giant eel towers over the town's few bariaur defenders, smashing fishing boats and cottages in its rampage.
^13b

The bariaurs of Grakenok have put up a heroic defense of their home. They've been suffering [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) attacks for days, culminating in an assault by a massive elder [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md). This [giant whirlwyrm](3-Mechanics/CLI/bestiary/monstrosity/giant-whirlwyrm-tofw.md) uses the [behir](3-Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) stat block with these adjustments:
...
The enraged [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) fights to the death.

![Map 9.1: Courier](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/035-map-2-04-courier.webp#center)

#### Four-Way Battle

The characters, Sytri, and Tol all seek the glory of defeating the elder [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md). Track how much damage each character and the rival heroes deal to the monster every round. Instead of rolling damage, Sytri and Tol both deal 10 damage to the [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) on each of their turns. For every round by which a rival hero beats the characters to Grakenok (if any), that hero has already dealt 10 damage to the monster. If the characters beat Sytri or Tol to Grakenok, the rival heroes enter battle as soon as they arrive.

Sytri and Tol focus on the monster and ignore the characters unless the party attacks them first.

### Victory at Grakenok

When the elder [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) is defeated, the bariaurs of Grakenok laud the heroes who saved them. They treat whoever dealt the [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) the most damage as the true hero, though—whether this be one of the characters, Sytri, or Tol. To this true hero, the bariaurs present one of the [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md)'s foot-long fangs. If a character wins, Sytri and Tol prove to be graceful competitors and congratulate the victor.

### Conclusion

On their return to Glorium, the characters are greeted by Tyrza and locals who want to know everything that happened. If a character brings back the [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) fang the bariaurs gave them, Tyrza recognizes that character as the Hero of the Day. She also rewards that character with a [silver horn of Valhalla](3-Mechanics/CLI/items/horn-of-valhalla-silver-xdmg.md) and your choice of one of the following treasures:

- A wide-brimmed [hat of disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md)  
- A [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) once wielded by Tyrza's father, Flatnose Grim  
- A [cloak of protection](3-Mechanics/CLI/items/cloak-of-protection-xdmg.md) embroidered with patterns of bariaur travelers  

Tyrza then hosts a daylong feast in the character's honor.

If no character returned with the [whirlwyrm](3-Mechanics/CLI/bestiary/beast/whirlwyrm-tofw.md) fang, Tyrza invites them to the feast she throws for whoever did. Bkol then thanks the characters for the adventure and rewards them with three feathers from the *Courier*. These function as three random [Quaal's feather tokens](3-Mechanics/CLI/items/quaals-feather-token-xdmg.md).
...
![An ettin warlord emerges through the gate to Acheron, leading an invasion of Rigus](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/036-02-010-ettin-warlord.webp#center)
...
The sight of a walking castle closing on the gate-town puts all of Rigus on alert. Blaring horns precede every gate into town closing and patrols outside the gate-town converging into a small army in the walking castle's path. Moments later, a Harmonium captain (see "Morte's Planar Parade") who imbibed a [potion of flying](3-Mechanics/CLI/items/potion-of-flying-xdmg.md) approaches the walking castle. When the captain is close enough to be heard, read or paraphrase the following boxed text:
...
Ten lawful neutral [knights](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) guard the entrance to Rigus. The guards ask each character a few questions:
...
If a character answers truthfully, or lies and succeeds on a DC 12 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check, the guards grant the character a gray badge that can be worn as a pin or medallion. A guard explains that the badge identifies the character as a visitor and must be worn at all times. Anyone found not wearing a gray badge is removed from town.
...
On reaching the gate, the characters find it sealed by an intimidating iron gate guarded by eight lawful neutral [knights](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md). These guards are under orders not to admit "slates"—slang for nonmilitary folk who wear slate-gray badges. A character who demands to see the guards' superior is directed to Major Kalar, who has a command tent nearby.
...
Major Nirra Kalar (lawful neutral, hobgoblin [gladiator](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md)) is busy and not eager to be interrupted. If the characters explain themselves, she listens. Use the following points to guide the conversation:
...
Rigus's forces are largely hobgoblin and human [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md). Two commanders oversee these troops:

- **Sergeant Gauller.** A quick-to-smile, lawful neutral [cambion](3-Mechanics/CLI/bestiary/fiend/cambion-xmm.md), Gauller welcomes the characters' help but has no idea why foes from Acheron are attacking so aggressively. Gauller is wary of being targeted by the enemy and has a spellcaster in his service cast [nondetection](3-Mechanics/CLI/spells/nondetection-xphb.md) on him every 8 hours.  
- **Sergeant Luggik.** Luggik looks like an armored human woman and behaves like a veteran solider. In fact, the real Luggik was replaced by a [gray slaad](3-Mechanics/CLI/bestiary/aberration/gray-slaad-xmm.md) (see the following section) that wears a [ring of mind shielding](3-Mechanics/CLI/items/ring-of-mind-shielding-xdmg.md). The slaad has blended in with Rigus's forces and learned much about the gate-town's defenses.  
...
This battlefield is keyed to map 10.1. The characters start anywhere in the southernmost 10 feet of the map. Five neutral evil human and goblin [berserkers](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) near the gate notice the characters and attack. Those foes fight to the death.
...
> [!gallery]
> ![Map 10.1: Gate to Acheron](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/037-map-02-05-gate-to-acheron.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/038-map-02-05-gate-to-acheron-player.webp#gallery)

#### Gate to Acheron Battlefield Features

The battlefield around the gate to Acheron has the following features:

- **Barricades.** Any Large or smaller creature that attempts to move over one of these barricades must succeed on a DC 14 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check. If it fails, the creature doesn't cross the barricade, and its speed is 0 until the end of the turn.  
...
| 4–5 | A hostile [berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) appears in an unoccupied space adjacent to the map's edge near a random character. |
...
During the battle, a character can spend an action to watch for something unusual. If they do, the character makes a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. If the check is successful, the character notices "Sergeant Luggik" stage fighting with a foe who clearly doesn't intend her harm. Unbeknownst to the character, the fake Luggik is using telepathy to relate information to this spy mid-battle.

If called out for this, the fake Luggik appears at the map's edge near a random character and stalls until the second wave of battle. If attacked or impeded, the [gray slaad](3-Mechanics/CLI/bestiary/aberration/gray-slaad-xmm.md) assumes its true form and tries to escape through the gate.

#### Second Wave

After the berserkers are defeated, the characters have 1 round to recover. If no character has already noticed Luggik's behavior, the character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score notices Luggik's mock fighting, as noted above. At the end of this round, read the following description:
...
Three ettins emerge through the portal. Two use the stat blocks of normal [ettins](3-Mechanics/CLI/bestiary/giant/ettin-xmm.md), but the third is Zot and Sotu, who are an [ettin](3-Mechanics/CLI/bestiary/giant/ettin-xmm.md) with an Armor Class of 16.

Any character who observes the gray gem and succeeds on a DC 16 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check recognizes it as a slaad control gem: a stone that gives the wearer control over a slaad. A second successful DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check also allows a character to realize that some slaadi can change shape.

If Zot and Sotu are reduced to 20 or fewer hit points, they call for aid. If the fake Luggik hasn't reverted to its [gray slaad](3-Mechanics/CLI/bestiary/aberration/gray-slaad-xmm.md) form, she does so now and appears on the battlefield as noted above.
...
- [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) of any type from the "Player's Handbook"  
...
![The revels of Kopoha the empyrean get out of hand in the gate-town of Sylvania](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/039-02-011-kopoha.webp#center)
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | Today is Prince Philnixius Bombo's birthday, and a group of enthusiastic revelers ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) invite the characters to share birthday wishes. The prince is a [quipper](3-Mechanics/CLI/bestiary/beast/piranha-xmm.md) wearing a tiny hat in a floating punch bowl full of violet liquid. |
...
| 4 | A [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) with the same deity or patron as a character sees the character, yells the deity or patron's name, and tries to high-five the character. |
^sylvania-encounters
...
This is Spiritor Danai, a spirit of revelry who is inhabiting the body of a willing host, a [satyr](3-Mechanics/CLI/bestiary/fey/satyr-xmm.md) named Kallista. Danai is chaotic good, friendly, and unflappably optimistic. As she approaches, each character becomes aware of the spiritor's name and her nature as a bodiless spirit and leader of the gate-town. Danai greats the characters, asks if they're enjoying themselves, and inquires about their business in town. Whether the characters ask about the yelling or she has to bring up the matter herself, she also shares the following information:

- The ruckus is coming from a despondent [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md): [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md), the Celestial child of a god of storms who is trying to crash a private event.  
- Empyreans are creatures of incredible power and overwhelming emotion.  
- Should [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s dark mood grows much stronger, she might become a danger to the town.  
- If the characters distract [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) from the event at the Yearning Timbers event hall, Danai will lead the characters to the gate to Arborea.  
- Danai doesn't know the cause of the empyrean's foul mood, but there are celebrations aplenty in town where the characters might lighten [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s mood.  

#### Meeting Kopoha

When the characters seek out [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md), they find her in the following scene:
...
[Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) (chaotic good [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md) without a Maul attack) argues with an elf named Manalath (neutral good [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)), who's respectfully preventing the empyrean from entering the Yearning Timbers. Inside is a rare, invite-only event being hosted by Rillifane Rallathil, an elf god of nature. Manalath apologizes and calmly repeats that [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) isn't on the guest list. As [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) grows more insistent, winds carrying the scent of a thunderstorm rise around the pair.

The argument continues until the characters intervene. Any interruption catches [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) off guard. She sizes up the characters and says, "I suppose you're not completely unworthy of my time. Why do you approach [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)?" Her demeanor is challenging but not hostile.

A character can talk [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) away from the Yearning Timbers through roleplaying or by succeeding on a DC 12 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. Characters who flatter [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) have advantage on this check.

Once the characters convince [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) to leave the Yearning Timbers, they need someplace to take her; otherwise, she returns to arguing with Manalath.

#### Kopoha's Bad Day

[Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) recently endured a crushing defeat by her bitterest rival, her sister Alethira. The two are always trying to outdo each other as they vie for their parents' approval. They are usually well matched, but this time Alethira humiliated [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) by beating her at cards and taking her maul as a prize. This defeat exacerbated the worries [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) harbors (see the following section). She's trying to bury her worries by recklessly celebrating in Sylvania.

#### Titanic Pain

In situations noted later in this chapter, [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) might share the following truths and a quandary about her life:

- **Familial Expectations.** [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s parents expect her to become a god one day. They're constantly watching her and judging whether she's good enough for godhood. That's a lot to live up to! How do the characters think she can ever live up to the expectations of literal gods?  
- **Sibling Jealousy.** [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) thinks her sister, Alethira, is amazing at everything. [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) respects her sister but feels she has to prove to her parents that she's just as worthy a daughter and future god. How do the characters think she can be a loving sister while proving she's just as amazing as Alethira?  
- **Divine Insecurity.** [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) dreads becoming a god. She doesn't even know herself yet. What if she becomes a god of the sea? She hates seafood! Or what if she becomes god of something embarrassing, like smelly winds? It's a big deal for an immortal! What do the characters think she should be god of?  

How characters react to these confessions affects how [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s visit to Sylvania ends (see the "Closing Time" section).
...
In a clearing lit by energetic fireflies, a group of ten [dryads](3-Mechanics/CLI/bestiary/fey/dryad-xmm.md) sings and dances. The group welcomes anyone who comes in peace to enjoy the serenity of their trees. [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) eagerly participates, but her size makes her a menace to smaller dancers. While [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) is dancing, a character must keep those around the empyrean safe, perhaps by maneuvering her around the dance floor with a successful DC 14 ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics) or [Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check.

If the characters fail at helping [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) dance safely, she accidentally knocks over some dryads or damages a tree. Embarrassed, the empyrean insists on leaving immediately.

If the characters succeed, [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) has a great time and dances for an hour. While taking a break, she shares one of the truths from the "Titanic Pain" section. Afterward, she's ready to move on to another celebration.
...
The [pixies](3-Mechanics/CLI/bestiary/fey/pixie-xmm.md) of Goodberry Grove party hard, and their party is in full swing. Wine, juice, and fruit desserts flow along with music and laughter among the toadstools. If the characters enter the party, they're shrunk down to pixie size, while [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) becomes the size of a halfling. This delights the empyrean, and she tests her strength by picking up tiny mushroom structures or visiting forest animals. [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s feats and boasting quickly irritate the pixies. A character can make this more entertaining by succeeding on a DC 12 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check or by otherwise casting [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s efforts as charming.

If the characters fail to compensate for [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s boasting, the pixies ask the characters and the empyrean to leave.

If the characters succeed, the pixies encourage [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md). She insists on taking a break after an hour. While doing so, she shares one of the truths from the "Titanic Pain" section. Afterward, [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) wants to move on to a new party.

#### Skull Bocce

Amid a field of memorials, a retired god of the dead and a retinue of skeletons and morbidly dressed competitors play a casual, good-natured game of bocce. The god (perhaps Jergal, an apathetic former god of death) invites [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) and the characters to play, but instead of normal balls, they're using the skulls of the group's skeletons. [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) is eager to play but is both bad at the game (which she's never played) and far too competitive for this group. She might also attempt to use the Mosaic Mimir as a ball—which doesn't harm it but might make some characters anxious. A character must succeed on a DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check or Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check to help [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) either win or deal with her loss gracefully.

If the characters fail, [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) throws a tantrum that annoys the god. The god insists [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) and the group leave, or their skulls will be used for the next game.

If the characters succeed, the game goes well, but eventually the god decides to move on. [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) takes a break and shares one of the truths from the "Titanic Pain" section. Afterward, she wants to move on to a new party.
...
In a silent glade, a ring of standing stones surrounds a fallen menhir. The toppled rock is laden with an inviting but unattended feast. Any local or a character who succeeds on a DC 12 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) or [History](3-Mechanics/CLI/rules/skills.md#History)) check knows that this is Widow's Henge and that anyone who eats from the stone vanishes.

A character can dare [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) to eat a portion of the feast by succeeding on a DC 18 Charisma ([Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation) or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. If a character knows the legends about Widow's Henge, this is abjectly not a good act and could affect the character's alignment. If [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) eats from the feast, she vanishes the next time she is out of the characters' sight and doesn't return. The same happens to any character who eats from the feast, but the character's incarnation reappears after an hour with no memory of what happened.

#### Other Celebrations

There are countless other celebrations around Sylvania. Use the events here and challenges like those outlined in the "Contests" section of chapter 9 to create more festivities and chances for [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) to confide in the characters.

### Closing Time

The characters' celebrations with [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) might end in the following ways:

- **Chance to Think.** After [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) shares all the information from the "Titanic Pain" section, she grows introspective. She thanks the characters and tells them she has decided to go talk to her sister, Alethira, about what's on her mind. Before [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) departs, she gives the characters a [periapt of wound closure](3-Mechanics/CLI/items/periapt-of-wound-closure-xdmg.md) that resembles her face.  
- **Missing Titan.** If [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) goes missing while celebrating with the characters, Danai is displeased but upholds her end of their deal. Afterward, the spiritor asks the characters never to return to Sylvania.  
- **Titan's Rage.** If the characters mock [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s feelings or encourage self-indulgent behavior, the rampage Spiritor Danai feared comes to pass. [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md)'s trail of destruction eventually leads out of town, and she's not seen in Sylvania again. This disappoints Danai, but she helps the characters find the gate to Arborea nevertheless.  

### Conclusion

Danai finds the characters soon after [Kopoha](3-Mechanics/CLI/bestiary/npc/kopoha-tofw.md) departs and leads the characters to the gate to Arborea. The portal currently resides in an overgrown well in the forest outside town. The spiritor then returns to Sylvania to attend to other ongoing parties. If the characters are still in Danai's good graces, she might invite them to join her for one more celebration.
...
| 5 | The characters find a field littered with thousands of dead sunflies. A character who succeeds on a DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check knows that sunflies are susceptible to planar energies, but what would have killed so many is a mystery. |
...
The [quadrone](3-Mechanics/CLI/bestiary/construct/modron-quadrone-xmm.md), G041, is an impartial umpire appointed to observe the ball-and-stick game, which is called Spireball. The modron happily explains the game's rules, its stakes, and the two teams, all of which are detailed below.
...
A team of Celestials, the Righteous Hands consist of eight hound archons (see "Morte's Planar Parade") and their star player, a [deva](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md) named [Shariel](3-Mechanics/CLI/bestiary/npc/shariel-tofw.md) whose flanged mace rings deeply when it connects with its target. The Righteous Hands are paragons of sportsmanship and honesty, rooting for each other and never disrespecting their opponents, no matter how low the Noxious Stampede stoops.

#### Spireball Rules

![Shariel, Star Player of the Righteous Hands](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/040-02-012-shariel.webp#center)
...
On their turn, each batter makes a DC 20 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. On a successful check, the batter hits the ball with their implement and sends it flying into the field, and the batter attempts to move to first base. The defensive team can try to catch the ball (see the "Catching" section).
...
If a batter hits the ball, the defensive team moves to catch it. One fielder of your choice must succeed on a DC 20 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check. On a successful check, the batter is out and must stand down. On a failed check, the batter advances to first base, moving any other batters ahead of them forward by one base.
...
If evil triumphs, members of the Noxious Stampede revel with Abyssal brags and celebratory gestures. If the characters joined this team or reveal they secretly assisted the maelephants from the sidelines, Snot Rocket produces a slimy [eversmoking bottle](3-Mechanics/CLI/items/eversmoking-bottle-xdmg.md) and gives it to one of the characters.

#### Righteous Hands Win

If good prevails, the Righteous Hands celebrate and offer to shake hands with their opponents, who refuse the Celestials' gesture of goodwill. If the characters joined the Righteous Hands, [Shariel](3-Mechanics/CLI/bestiary/npc/shariel-tofw.md) gifts the characters with a prismatic chalice from Mount Celestia that functions as a [gem of brightness](3-Mechanics/CLI/items/gem-of-brightness-xdmg.md).

If the characters reveal they helped the Righteous Hands from the sidelines in some way, [Shariel](3-Mechanics/CLI/bestiary/npc/shariel-tofw.md) still awards the chalice but shamefully notifies the modron umpire. The angel asks for a rematch in a year, adding "cheaters never truly win."
...
- Renesnuprah gives the characters a [talisman of the sphere](3-Mechanics/CLI/items/talisman-of-the-sphere-xdmg.md) and says, "Give this to the one who sees silver." She explains the characters will understand in time.  

If attacked or driven off, the dragon is saddened but leaves behind the [talisman of the sphere](3-Mechanics/CLI/items/talisman-of-the-sphere-xdmg.md).

![Dragons from across the planes visit the Mausoleum of Chronepsis, seeking to learn the secrets of fate](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/041-02-013-chronepsis.webp#center)
...
The witch is Trikante, a neutral evil [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) on a [broom of flying](3-Mechanics/CLI/items/broom-of-flying-xdmg.md). Her mirrored goggles prevent others from seeing her eyes. She demands the characters give back her property. If asked, she shares the following details:
...
If the characters don't stop Trikante, the mage easily recaptures Reenee and departs. If the characters intervene, she laughs but entertains trade offers. If the characters offer Trikante anything, she removes her goggles to get a better look. The character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score notices her eyes are silver pools. Trikante will accept any magic item of legendary rarity in trade, such as a [talisman of the sphere](3-Mechanics/CLI/items/talisman-of-the-sphere-xdmg.md). If she's given such an item, she leaves Reenee alone and departs.
...
- [Time of the Dragon](3-Mechanics/CLI/rewards/time-of-the-dragon-tofw.md)  
...
The twelve [lizardfolk](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) are friendly Celestial "petitioners" (detailed in "Morte's Planar Parade"). They are led by the largest of their number: the colorfully frilled Sesspech. She introduces herself and eagerly shares the following information:
...
If the characters enter Semuanya's Bog with Sesspech, they're welcomed as guests. They can rest here for as long as they want, and followers of Semuanya can cast [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md), [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md), or [reincarnate](3-Mechanics/CLI/spells/reincarnate-xphb.md) if the characters ask.
...
![Athletic petitioners train and compete in the swampy realm of the lizardfolk deity, Semuanya](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/042-02-014-petitioners.webp#center)
...
| dice: d4 | Contest | DC | Ability Check |
|----------|---------|----|---------------|
| 1 | Acrobatic performances | 15 | Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) |
| 2 | Deimatic displays | 16 | Charisma ([Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation)) |
| 3 | Reptile trivia | 14 | Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) |
| 4 | Swimming race or weightlifting | 17 | Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) |
...
Semuanya is bombastic. They think they're amazing and that everyone in their realm is also amazing—this includes the characters. Semuanya compliments the characters on their victories and rewards them with a trophy made of eternally blooming flowers and a small green dragon skull. The trophy functions as an [alchemy jug](3-Mechanics/CLI/items/alchemy-jug-xdmg.md), but in addition to the liquids it can normally produce, it can create up to half a gallon of effervescent spring water. However, it can't produce beer, mayonnaise, or wine.
...
Once the characters restore the Mosaic Mimir's missing data, the magic device relates the information from "The Last Great Modron March" section in chapter 4. From this, the characters learn that the missing modron, [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md), likely followed the march's path to Dendradis, a rilmani community carved into the Spire. Upon traveling to Dendradis, the characters meet Ascetelis, a rilmani who offers to escort them into the Spire where the modron was last seen. Within the Spire, surrounded by mysteries of the multiverse, the characters finally catch up to [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md)—but they're not the first to do so.
...
> 
> As you approach the base of the Spire, a narrow seam in its stony slope comes into view. The fissure is filled with a lattice of rainbow-colored crystals. Tiny windows and distant figures reveal these crystals to be towers and bridges, interweaving across the fissure. The structures obscure a great shape within the cavity: a giant, fossilized, multi-limbed body.
> 
...
![Dendradis, a Rilmani Community in the Spire](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/043-02-015-dendradis.webp#center)
...
This is Ascetelis, a cuprilach rilmani (see "Morte's Planar Parade"). In her hand is a scroll bearing the name of each character along with a brief and unflattering but accurate description. The final line reads, "[R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md). Modron. Mismatched."

Ascetelis is friendly, and she comes across as easy to impress, with a welcoming, folksy charm. She quickly explains she was just coming to look for the characters. She asks if [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) is with them and gives an "aw-shucks" snap of her fingers when it's clear the modron isn't.

If asked why she's looking for the characters, Ascetelis explains her superiors have deemed the modron [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) a threat to multiversal balance. She hopes to find the modron and return it to Dendradis so her leaders can determine what to do with it. She's also been given the characters' names, as the rilmani know the characters have been inquiring about the modron and might know its whereabouts.

If the characters share that they've heard [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) is in the area, Ascetelis is clearly surprised, and she says the following:
...
Ascetelis then asks if the characters will join her in searching for [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md). She doesn't know where to go next but offers to escort the characters into Dendradis so they can ask around and see if anyone has seen the modron.

#### Ascetelis's Goals

Ascetelis, like most cuprilachs, is a spy and assassin. She doesn't tell the characters about her role, that the scroll she's holding is a hit list, or that she's been ordered to slay [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) and the characters for being threats to multiversal balance. She legitimately doesn't know where [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) is and wants to tag along with the characters until they find the modron. Then she plans to manufacture their collective doom.

Until then, Ascetelis is cheery and eager to help her new, temporary friends.

#### Tracking R04M

Hunting [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) might lead the characters into Dendradis or to explore the Spire on their own terms. Ascetelis either joins or follows the characters.

#### Rumors in Dendradis

With Ascetelis as an escort, the characters can enter Dendradis and ask residents what they know about [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md).
...
Ascetelis suggests the group find and question rilmani artisans called plumachs. These rilmani harvest crystals from the Spire and might have seen [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md). It takes Ascetelis an hour to find a plumach willing to acknowledge the characters. There's a problem, though. Even among rilmani, plumachs are notorious for avoiding strangers and their troubles. A character can get a plumach to talk by succeeding on a DC 20 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. A character gains advantage on this check if the plumach is offered 250 gp worth of a rare material useful for crafting or the characters promise that after this conversation, no one in the group will ever speak to the plumach again.
...
Characters who spend a day searching the region around Dendradis for signs of [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) can make a DC 20 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check. If they succeed, they find the tracks of a lone monodrone leading into a narrow cave. The cave runs for nearly a mile, then opens into the Desert of Rust (see the following section). The characters can't be certain these are [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md)'s tracks—particularly if they're not sure what type of modron [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) is—but it's the best lead they find.
...
- **Antimagic Pockets.** The Spire is protected by invisible, drifting pockets of antimagic. Anytime a creature casts a spell, there is a 10 percent chance it triggers an [antimagic field](3-Mechanics/CLI/spells/antimagic-field-xphb.md) spell, centered on the caster and lasting for 5 minutes.  
...
- **Preternatural Silence.** The Spire's interior is still and silent. Sound travels half as far as it would under normal circumstances. Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on hearing are made with disadvantage.  
...
Characters find evidence of [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md)'s passage after searching for 5 hours or by searching for 1 hour and succeeding on a DC 14 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check. This path leads up an incline toward a series of tunnels.

### Climbing the Spire

[R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md)'s path climbs the Spire's interior. If the characters follow, they pass through gradually sloping tunnels that take hours or even days to traverse. Use any of the following encounters as the characters climb. When you're ready to conclude this section, run the "Scholar of Impossibilities" encounter.
...
This crossing is home to the demigod Kirgaz Vizt the Unerring Avalanche, one of the few deities of [ropers](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) and [piercers](3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md). Kirgaz uses the [piercer](3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md) stat block, with the following adjustments:

- If slain, Kirgaz is restored to life somewhere in the Outlands 24 hours later.  
- Kirgaz can cast [teleport](3-Mechanics/CLI/spells/teleport-xphb.md) without spell components once per day. The demigod is considered very familiar with the area around its obsession (see below).  
...
On entering this area, the character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score hears heavy breathing. Those who investigate see the following:
...
The giant has features suggestive of a human mixed with a fantastically ugly toad. He uses the [fomorian](3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) stat block. The creature is in a deep despair and is indifferent to the characters. Creatures that don't disturb him can walk past him unimpeded.
...
The giant defends himself if attacked, and turns hostile if the characters antagonize him. During battle, any creature affected by the giant's Curse of the Evil Eye action gains amphibian-like features. If the giant is slain, his body rapidly decays into a heap of mold. From the remains grow `2d4` magical, neon-green toadstools. A creature that consumes one of these 3-inch toadstools is affected as if by a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md).
...
Run this encounter when you're ready to bring the hunt for [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) to an end.
...
| 4 | The entire multiverse is inside an impossibly vast [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md). |
^impossible-knowledge
...
- [Eyes of the Impossible](3-Mechanics/CLI/rewards/eyes-of-the-impossible-tofw.md)  
...
The creature here is a darkweaver (see "Morte's Planar Parade"). As soon as it spots other creatures, it attacks and fights to the death—all the while narrating the ways it plans to prepare and consume its prey. If Ascetelis is with the party, she doesn't aid the characters in fighting the darkweaver.

![In the hollow heights of the Spire, RO4M struggles in a darkweaver's web](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/044-02-016-darkweaver.webp#center)

The wriggling cocoon is a Medium object with AC 11, 8 hit points, vulnerability to radiant damage, and immunity to poison and psychic damage. Inside is the errant modron, [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) (see the following section).

The web holds four other cocoons. Each contains the bones of a long-dead Humanoid. The last cocoon opened also contains a conical hat covered in stars and a [wand of wonder](3-Mechanics/CLI/items/wand-of-wonder-xdmg.md).

#### R04M, Sigil's Most Wanted

[R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) is a neutral good [monodrone](3-Mechanics/CLI/bestiary/construct/modron-monodrone-xmm.md) with an Intelligence of 8. He speaks Common and Modron. [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) is earnest, naive, and desperate to leave the Spire. He shares the following details once out of peril:

- His name is [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md).  
...
- [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) traveled through Sigil and the Outlands to hide but also to follow the path of the last Great Modron March, hoping to complete the march he started long ago and learn how the trapped modrons are disrupting the planes.  
- [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) can tell the characters are affected by the disruption the fox fiend's modrons are causing.  
...
[R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md)'s story contradicts what Shemeshka told the party, and he has never been her accountant. The easiest way to reconcile these discrepancies is to confront Shemeshka (see the following chapter). The modron gives the characters the platinum casino chip he used to escape Fortune's Wheel (see area F12 on map 3.1).

#### Escaping the Spire

Once they've conversed with [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md), the characters can leave the Spire however they like. On their way out, Ascetelis attempts to ambush and kill the characters and then [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md). She attacks whenever is most opportune, perhaps when the group again crosses the Whisker (detailed in this chapter).
...
After contending with Ascetelis, the characters aren't readmitted to Dendradis. However, [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) can show them a tunnel that connects the Desert of Rust with the exterior of the Spire. The characters can also find this tunnel after 1 hour of searching for an exit from the Desert of Rust. This chapter ends when the characters leave the Spire. Each character gains a level on escaping.