...
The man introduces himself as [Mr. Honeycutt](3-Mechanics/CLI/bestiary/npc/mr-honeycutt-nrh-tcmc.md), the Magister of the Lorekeeper Society. He asks Yellow if they have some time to talk about a matter of great importance, stating that all the colors of Harmony are at stake. If Yellow agrees, read or paraphrase the following:
...
On the journey through Darkwood, Yellow has a chance to spot some healing herbs that, if collected and brewed into a tea, can act as a [potion of healing](3-Mechanics/CLI/items/potion-of-healing.md). To find enough herbs to make a single dose of the tea, Yellow must first succeed on a DC 12 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check to find the herbs and then make a successful DC 12 Intelligence ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check to brew them into a medicine. There are only enough herbs for one potion.
...
![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-a-web-of-lies/img/012.webp#center)
...
With a successful DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check, Yellow can identify that there is conjuration magic at work.
...
Once the bees are dealt with, Yellow can climb down the well or use the rope and bucket to lower themselves down. Yellow must succeed on a DC 12 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check or fall into the honey-sweetened water. If Yellow is covered with the honeyed water, the bees follow Yellow for the rest of the adventure, giving them disadvantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks.
...
For every 10 feet Yellow travels through the webs, have them make a DC 13 Dexterity check. On a failure, they touch a web which sends a vibration and alerts [Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md) (see area T2). [Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md) either waits in ambush or comes down into the tunnel to investigate. On a success, Yellow has surprise.
...
This is the lair of [Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md), an awakened giant wolf spider. [Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md) is greedy and scheming and has developed a taste for honey. She wants all the honey she can get—but she's eaten so much of the delicious honey that there's no more within the beehive room and she has become too fat to escape through the small tunnel.

[Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md) guards her lair, and if she finds out that there's something Yellow wants—like the chest—she demands that they bring honey to her. [Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md) is not very smart, so she can be tricked with a successful DC 13 Intelligence ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check. [Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md) is also not above going back on a deal and demanding more honey if she feels like she can intimidate Yellow into getting more. Reward your player for good roleplaying here.

#### Getting Honey

Honey can be found around the temple ruins, but obtaining it can be tricky. Yellow must succeed on a DC 15 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check to get some honey without getting attacked by bees (use the [swarm of insects](3-Mechanics/CLI/bestiary/beast/swarm-of-insects.md) stat block). If your player comes up with a clever plan for getting the honey, then allow them to roll with advantage or automatically succeed. Good roleplaying is always rewarded!

Getting the Saffron Gem Once [Szikzith](3-Mechanics/CLI/bestiary/npc/szikzith-nrh-awol.md) is dealt with, Yellow must cut through the webs to uncover a locked chest that's beautifully decorated with bee and flower motifs. There's a riddle written on the lid of the chest: "I'm a comb but not for hair."
...
Mr. Honeycutt also hands Yellow a long wooden box, thanking him for "going above and beyond in service to the city of Harmony." Inside the box is a mace of disruption.
...
![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-a-web-of-lies/img/sheet011.webp#center)

![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-a-web-of-lies/img/sheet012.webp#center)