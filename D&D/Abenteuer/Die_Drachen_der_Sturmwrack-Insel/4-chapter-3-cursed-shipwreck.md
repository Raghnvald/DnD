...
When the characters arrive at the shipwreck, the harpy is out looking for another ship to lure onto the rocks. It returns after the characters have spent some time aboard, as described in "Harpy's Return" later in this chapter.
...
Two small drawers in the desk hold a pouch containing 50 gp, a set of cartographer's tools, and a dagger. The compass set in the desktop can easily be pried free; it is worth 25 gp.
...
A sack full of 200 gp rests in a small compartment beneath the raised floorboard.
...
| 6 | A [spell scroll](3-Mechanics/CLI/items/spell-scroll.md) of command, sealed in a leather case |
^crate-contents
...
After the characters find the captain's chest, when they come up from the hold to the lower deck, they hear a heavy thump on the deck above them as the harpy lands on the main deck. See "Harpy's Return" below.
