...
linter-yaml-title-alias: "Chapter 7: Expedition to the Barrier Peaks"
tags:
  - Quelle/5e/qftis
aliases:
...
![Aphelion 3000, an evil supercomputer, commands a fleet of cold-hearted robots on a crashed spaceship](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/113-07-001-ch7-barrier-peaks.webp#center)

## Background

![A door to the Barrier Peaks](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/114-07-002-barrier-peaks-door.webp#center)
...
![](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/115-07-003-expedition-to-the-barrier-peaks-original.webp#center)
...
One crew member remains. A lone scientist lies in a cryogenic sleep below the ship's garden, but the [froghemoth elder](3-Mechanics/CLI/bestiary/monstrosity/froghemoth-elder-qftis.md) that dwells within has destroyed every robot Aphelion deployed to finish her off. Unwilling to sacrifice its remaining automatons to the creature, the supercomputer has reached an impasse.
...
- **Robots and Androids.** Aphelion can perceive through the senses of any normal functioning [combat](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) or [worker robot](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) that's within 1 mile of the spaceship. It can also change these robots' attitudes toward a creature of its choice to friendly, indifferent, or hostile. Aphelion doesn't control [androids](3-Mechanics/CLI/bestiary/construct/android-qftis.md) aboard the ship, which act of their own volition.  

![Aphelion's gladsome visage appears on the screen of a computer terminal](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/116-07-004-computer-terminal.webp#center)
...
> ![Spaceship Trinket](3-Mechanics/CLI/items/spaceship-trinket-qftis.md)
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | `2d10` [vegepygmy scavengers](3-Mechanics/CLI/bestiary/plant/vegepygmy-scavenger-qftis.md) and `1d4` [vegepygmy thorny hunters](3-Mechanics/CLI/bestiary/plant/vegepygmy-thorny-hunter-qftis.md) |
| 2 | `1d6` [intellect devourers](3-Mechanics/CLI/bestiary/aberration/intellect-devourer.md) |
| 3 | Two [combat robots](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) on patrol |
| 4 | A helpful [worker robot](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) offers to carry the characters' equipment. |
| 5 | Two malfunctioning [worker robots](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) construct a pile of space helmets. The robots attack any who disturb their hoard. |
| 6 | A short-circuiting [android](3-Mechanics/CLI/bestiary/construct/android-qftis.md) attempts to repair itself, leading to ever-worsening glitches in function. |
| 7 | A malfunctioning [combat robot](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) begs to be destroyed by a worthy combatant. |
| 8 | A defective [worker robot](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) serves expired food to the corpse of a long-dead passenger. |
| 9 | A [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker.md) with a moan like a klaxon |
| 10 | A [roper](3-Mechanics/CLI/bestiary/monstrosity/roper.md) with a metallic sheen |
^random-spaceship-encounters
...
| 5 | Parts of a dismembered [combat robot](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) clutter a workbench in this workshop. |
...
| 9 | One spaceship trinket lies in a corner. Roll on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md) to determine the trinket. |
...
> [!gallery]
> ![Map 7.1: Spaceship Level 1](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/117-map-7-01-spaceship-level-1-map.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/118-map-7-01-spaceship-level-1-map-player.webp#gallery)
...
A [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker.md) lurks above, waiting to ambush the characters. The creature strikes at an opportune moment.

##### Artificial Assistance

At the start of the third round of combat, a [combat robot](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) appears in the eastern hallway, sirens blaring. If the cloaker is still alive, the robot quickly moves to slay it. If the characters defeat the cloaker before this, the robot arrives just as they do so.

The robot was sent by Aphelion to aid the party. After the cloaker has been dispatched, the robot politely offers to escort the characters to its superior. If they accept, the robot guides them north through the medical clinic (area S23) to the computer room (area S30). Aphelion bypasses the key card requirements of any card-locked doors along the way. If the combat robot was destroyed, Aphelion sends a friendly [worker robot](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) to accomplish the same task.
...
A character who searches the bones and succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a violet key card.
...
A wrecked repair robot lies on its side in this hallway. A casualty of the mutiny initiated by Aphelion, the robot was slain by a crew member armed with a laser pistol. A character who inspects the robot and succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check deduces the holes in its frame were created by a series of intensely hot beams. A cursory examination of the robot reveals something glinting within its chest compartment.

##### Tools

The hand tools scattered around the robot make up a complete set of [tinker's tools](3-Mechanics/CLI/items/tinkers-tools.md) formerly used by the robot to repair areas of the ship. The tools can be used to pry open the robot's chest plate and access the contents of its torso.

##### Treasure

Inside the robot's chest compartment are five gems worth 50 gp each. Safely retrieving the gems without getting electrocuted by exposed wiring requires a successful DC 16 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check. On a failed check, a character takes 14 (`4d6`) lightning damage and doesn't retrieve the gems.
...
The corpse conceals a patch of yellow mold. If touched, the corpse slumps forward, causing the mold to eject its spores. A character who examines the corpse and succeeds on a DC 18 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notices the mold, recognizing its danger with a subsequent successful DC 15 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check.

##### S4c: Northwest Dining Room

Ten [vegepygmy scavengers](3-Mechanics/CLI/bestiary/plant/vegepygmy-scavenger-qftis.md) rummage through this room and the adjacent kitchen (area S5) for morsels. These vegepygmies belong to the north vegepygmy colony (see area S16) and are hostile toward all entrants. When they detect the characters, the vegepygmies hiss at them territorially. If the characters don't heed their warnings, the vegepygmies attack.
...
Malfunctioning [worker bots](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) stripped these kitchens of everything not bolted down. Only empty counter space, unused food trays, and the equipment built into each room's design remain.
...
|-----------|-------------------|
| 1 | Spoiled meal in a compartmented plastic tray; a creature that eats the food must succeed on a DC 15 Constitution saving throw or have the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) condition for 1 hour |
...
| 6 | Live [concussion grenade](3-Mechanics/CLI/items/concussion-grenade-qftis.md) that explodes on delivery |
^vending-machine-options
...
Three [combat robots](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) operate in this area. The robots are indifferent toward characters who are assisting Aphelion or who present a red key card and succeed on a DC 15 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check to command the robots to stand down. Otherwise, the robots warn the characters to leave at once or be destroyed.

##### Arsenal

Stacked on a metal workbench are three cases of grenades. Their contents are as follows:

- `1d6 + 2` [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md)  
- `1d6 + 2` [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md)  
...
An indifferent [worker robot](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) is fixing four mangled [combat robots](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) in this area. Recently recovered from the lake on the ship's garden level, the combat robots are crumpled, rusty, and dripping wet, having succumbed to the [froghemoth](3-Mechanics/CLI/bestiary/monstrosity/froghemoth-elder-qftis.md) that dwells there. The robots are in varying stages of repair.

##### Spare Parts

Spare components fill bins near the repair area. A character who searches the bins and succeeds on a DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds `1d4` energy cells and three spaceship trinkets (roll thrice on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md)).
...
This malfunctioning [android](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (aerialist design) was damaged during the ship's robotic uprising. When a character comes within 20 feet of the android, it springs up and attacks, exulting about how it fooled them and "wasn't really damaged at all," despite the pipe in its head.

##### Treasure

The android carries a [paralysis pistol](3-Mechanics/CLI/items/paralysis-pistol-qftis.md) with 4 charges remaining.

![A worker robot roams the wreckage of an abandoned dining room](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/119-07-005-abandoned-dining-room.webp#center)
...
Two [gray slaadi](3-Mechanics/CLI/bestiary/aberration/gray-slaad.md) use the supplies in this art room to create an abstract mural. The slaadi pause intermittently to criticize each other's work in muttered croaks. They are hostile toward intruders.
...
Two [healer's kits](3-Mechanics/CLI/items/healers-kit.md) are mounted on the walls of this room. The cabinets contain three vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-vial.md) and expired medications in little orange bottles. The medications have lost their potency and have no effect if taken.
...
This web-covered room is the nest of eight [phase spiders](3-Mechanics/CLI/bestiary/monstrosity/phase-spider.md). When the characters enter, the spiders are away, hunting on the Ethereal Plane. The spiders return 1 minute later and attack any creatures in their nest.

Stuck to the ceiling are `1d6 + 2` cocoons containing the desiccated remains of dead crew, passengers, and pets. A character who searches a cocoon and succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds one spaceship trinket. Roll on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md) to determine the trinket. On a failed check, the character mistakenly punctures an egg sac, causing a hostile [swarm of insects (spiders)](3-Mechanics/CLI/bestiary/beast/swarm-of-spiders.md) to burst forth from the cocoon.

Additionally, a blue key card is caught in the webs. A character who inspects the webs and succeeds on a DC 14 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check spots the card.
...
| dice: d4 | Description |
|----------|-------------|
| 1 | Two [worker robots](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) attempt to corner a three-eyed [giant toad](3-Mechanics/CLI/bestiary/beast/giant-toad.md) in this room. All three creatures ignore the effects of radiation. If the characters capture or slay the toad, the robots reward the characters with two spaceship trinkets (roll twice on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md)). |
| 2 | Two [blue slaadi](3-Mechanics/CLI/bestiary/aberration/blue-slaad.md) take turns drinking radioactive gunk oozing from a busted pipe that juts from the wall. The slaadi attack the characters on sight and ignore the effects of radiation. |
...
Among the fake weapons attached to the game machines is one real, fully loaded laser rifle. A character who inspects the machines or plays the game and succeeds on a DC 16 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check spots the real weapon among the toys.

#### S15: Fungal Corridor

Bioluminescent fungi carpet the floor of this damp, dimly lit corridor, which reeks of mold. The vegepygmies cultivate the fungi as both a food source and a warning system. At each end of this corridor grows a 10-foot-wide fungal cluster containing four [shriekers](3-Mechanics/CLI/bestiary/plant/shrieker.md). Other fungi grow in a humus layer spread along the length of the passage.
...
Four [vegepygmy scavengers](3-Mechanics/CLI/bestiary/plant/vegepygmy-scavenger-qftis.md) live in each of these repurposed passenger quarters, for a total of twenty-eight vegepygmies. If combat breaks out in any of these spaces, the vegepygmies call out to their fellows in adjacent rooms for aid.
...
A [vegepygmy moldmaker](3-Mechanics/CLI/bestiary/plant/vegepygmy-moldmaker-qftis.md) and five [vegepygmy scavengers](3-Mechanics/CLI/bestiary/plant/vegepygmy-scavenger-qftis.md) reside in this spacious former lounge. These vegepygmies don't heed calls for aid elsewhere, staying to protect their leader.

The vegepygmies keep a stockpile of technology scavenged from the ship hidden behind the grill of a small air duct in this room. The cache includes two [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md), a moldy laser pistol, and a red key card. The pistol can fire 15 shots before its energy cell is drained.

#### S17: Will-o'-Wisps (Violet)

Three [will-o'-wisps](3-Mechanics/CLI/bestiary/undead/will-o-wisp.md) haunt these two abandoned rooms and roam the corridor outside. When they detect a creature, the will-o'-wisps attempt to lure it to the nearest irradiated room (see area S13), where they attack. The will-o'-wisps ignore the effects of radiation.

##### Treasure

The will-o'-wisps have amassed a small pile of shiny junk—chrome fittings, reflectors, eating utensils, and the like. Mixed in with the collection are two gems worth 450 gp and 125 gp respectively and one spaceship trinket. Roll on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md) to determine the trinket.
...
East of the office is a locked storage closet secured with a five-digit code. A character who searches the room and succeeds on a DC 16 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) finds the code (07734) scrawled under a paperweight on the commander's desk. Inside the closet is a fully charged [needler pistol](3-Mechanics/CLI/items/needler-pistol-qftis.md) and `1d4` [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md). An unlocked safe on the closet floor contains twenty plastic-encased diamonds worth 100 gp each.
...
Another skeleton is here, sprawled on the floor near a bed. The skeleton clutches a [robot controller](3-Mechanics/CLI/items/robot-controller-qftis.md).

#### S21: Junk Pile

A small pile of junk is heaped near this intersection.

Amid the debris is a fully charged [needler pistol](3-Mechanics/CLI/items/needler-pistol-qftis.md). There's nothing else of interest.
...
This spacious, moldy apartment houses the southern vegepygmy colony's leader, Griss, a withered-looking [vegepygmy moldmaker](3-Mechanics/CLI/bestiary/plant/vegepygmy-moldmaker-qftis.md) who speaks Common and Vegepygmy. Griss is grave and unsmiling, with a head topped by a wide-brimmed fungal cap. The elder is attended by four [vegepygmy scavengers](3-Mechanics/CLI/bestiary/plant/vegepygmy-scavenger-qftis.md) and four [vegepygmy thorny hunters](3-Mechanics/CLI/bestiary/plant/vegepygmy-thorny-hunter-qftis.md). These vegepygmies remain here to protect their leader even if neighboring vegepygmies call for aid.
...
Disturbing any of the desks causes an alarm to sound in this area. A [combat robot](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) from area S26 arrives to investigate in 1 minute.

##### S23a: Exam Rooms

The two rooms to the south are both exam rooms. Each contains an exam table, a couple of chairs, and a workspace for medical professionals. A [healer's kit](3-Mechanics/CLI/items/healers-kit.md) is mounted on the wall inside each room.

##### Treasure

A character who conducts a thorough search of this area and succeeds on a DC 17 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a yellow key card in one of the desks. The exam rooms contain one spaceship trinket each. Roll twice on the [Spaceship Trinkets](3-Mechanics/CLI/items/spaceship-trinket-qftis.md) to determine the trinkets.
...
An [android](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (medic design) is still at work in this biochemistry lab, vainly attempting to find a cure for the mold that claimed the ship's Humanoid population a century or so ago. The android is indifferent toward the characters and deeply focused on its work.

If a character presents a yellow key card and succeeds on a DC 15 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check, the android regards the characters as fellow researchers and lets them take anything in the room. On the counter are two vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-vial.md) and a canister of healing spray (an aerosolized jar of Keoghtom's Ointment).
...
If the characters attack the android or otherwise interfere with its work, the android broadcasts a loud alarm, drawing two [combat robots](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) from area S26 to its location in 1 minute. The android defends itself until security arrives.
...
A platinum key is hidden in a microfilm cabinet behind the officer's skeleton. A character who searches the cabinet and succeeds on a DC 22 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds it.

#### S26: Security HQ (Red)

![A suit of powered armor stands in a metal alcove](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/120-07-006-powered-armor.webp#center)
...
A card-locked metal chest in the corner of the main room contains two [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md), two [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md), and a fully charged [needler pistol](3-Mechanics/CLI/items/needler-pistol-qftis.md). The chest requires a red key card to open.
...
The alcove is the chief's personal locker. It is card-locked and requires a red key card to open. Inside are a pristine officer's uniform decorated with three glass medals and a suit of [powered armor](3-Mechanics/CLI/items/powered-armor-qftis.md) with a depleted energy cell.
...
- Ten [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md)  
- Ten [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md)  
- Ten smoke grenades  
...
- Four laser pistols  
- Two laser rifles  
- A [needler pistol](3-Mechanics/CLI/items/needler-pistol-qftis.md)  
- A [paralysis pistol](3-Mechanics/CLI/items/paralysis-pistol-qftis.md)  

##### Powered Armor

A fully charged suit of [powered armor](3-Mechanics/CLI/items/powered-armor-qftis.md) stands in an alcove near the back wall.

#### S29: Storage (Red)

This emergency storage area contains dehydrated provisions sufficient to equal one hundred days of rations. There are also three healing syringes—injectable Potions of Healing (greater)—four vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-vial.md), and three restorative ampules. If consumed by a creature as an action, each ampule reduces the creature's [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) level by 1.
...
- **Android Audit.** Aphelion wants to gauge the mechanical integrity of the [androids](3-Mechanics/CLI/bestiary/construct/android-qftis.md) aboard the ship. Find and interact with three androids on this level.  
...
- **Two Tasks.** A friendly [worker robot](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) delivers a fully charged [antigravity belt](3-Mechanics/CLI/items/antigravity-belt-qftis.md) to the characters, courtesy of Aphelion.  
- **Three Tasks.** A [combat robot](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) delivers a fully charged suit of [powered armor](3-Mechanics/CLI/items/powered-armor-qftis.md) to the characters. If the characters already removed the suit of powered armor from the armory (area S28), the robot instead gifts them one energy cell per character.  
...
- **Android Audit.** Aphelion asks the characters to find and interact with three [androids](3-Mechanics/CLI/bestiary/construct/android-qftis.md) on this floor. This time, each of the androids must reside in a different room. Aphelion suggests the characters begin their search with the athletic facilities to the north.  
...
> [!gallery]
> ![Map 7.2: Spaceship Level 2](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/121-map-7-02-spaceship-level-2-map.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/122-map-7-02-spaceship-level-2-map-player.webp#gallery)
...
Metal alcoves in each of these simple workrooms contain one [combat robot](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) and three [worker robots](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) programmed to haul, manage, and protect cargo in the adjacent cargo holds (see area S33). The robots are inactive and indifferent toward entrants unless disturbed, at which point they activate and attack.
...
Two [fomorians](3-Mechanics/CLI/bestiary/giant/fomorian.md) rummage through the containers for food. Mutated by radiation on the ship, the giants are riddled with hideous boils that throb with a pale-green glow. The ravenous fomorians attack the characters on sight.
...
A [githyanki knight](3-Mechanics/CLI/bestiary/humanoid/githyanki-knight.md) and five [githyanki warriors](3-Mechanics/CLI/bestiary/humanoid/githyanki-warrior.md) search this cargo hold for [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer.md). The githyanki are initially indifferent toward the characters and know nothing of the ship's history. One of them carries a violet key card.
...
Ten [gas spores](3-Mechanics/CLI/bestiary/plant/gas-spore.md) grow here. They are hostile toward all entrants.
...
A character who aims a viewer at the lake (area S59) and succeeds on a DC 18 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check glimpses the shadow of a massive amphibian lurking beneath the surface of the water.
...
![A mind flayer in a spacesuit](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/123-07-007-space-mind-flayer.webp#center)
...
Two [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer.md) dwell here. The illithids discovered the ship weeks ago and have been studying its technology ever since, intent on using it to conquer other worlds. Four [intellect devourers](3-Mechanics/CLI/bestiary/aberration/intellect-devourer.md) loyal to the mind flayers hide under the first row of seats in the audience. The intellect devourers fiercely defend their creators, who attack intruders on sight.
...
The technology on the mind flayers' workstation includes two [sleep grenades](3-Mechanics/CLI/items/sleep-grenade-qftis.md), a red key card, and a laser pistol. The pistol can fire 5 more shots before its energy cell is drained.
...
Apart from its inhabitants, this lounge is identical to the those on the ship's first level (see area S8). When the characters enter, four [worker robots](3-Mechanics/CLI/bestiary/construct/worker-robot-qftis.md) approach them and attempt to seat the characters and take their dinner orders, regardless of the current time of day. The malfunctioning robots are initially indifferent toward the characters.
...
If the characters refuse to eat the food, one of the robots scoops up a chunk of it and makes realistic propulsion sounds, saying "Here comes the spaceship!" to entice a character to take a bite. If the characters consume any of the food, or if they pretend to and succeed on a DC 16 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check, the robots leave satisfied. Repeated refusals offend the robots, causing them to go haywire and attack.

##### Treasure

The robots cleaned and heaped the bones of previous diners in a pile in the southeast corner of the room. Amid the remains are a blue key card, a red key card, and a [needler pistol](3-Mechanics/CLI/items/needler-pistol-qftis.md) with 0 charges remaining, as well as three gem-encrusted bracelets worth 600 gp each.
...
Four [shriekers](3-Mechanics/CLI/bestiary/plant/shrieker.md) thrive in the shade of this fungal bush. The fomorians in the east cargo hold (area S33b) investigate any shrieking here, breaking down the cargo doors in the process.
...
Three conical, carnivorous plants with rocklike bark and grasping vines occupy this stretch of the walkway. The creatures use the [roper](3-Mechanics/CLI/bestiary/monstrosity/roper.md) stat block but are Plants instead of Monstrosities. They are hostile toward all non-Plant creatures.
...
![Three malfunctioning physical training androids prepare to mete out hard-earned lessons in the ring](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/124-07-008-training-androids.webp#center)
...
This gymnasium was used for athletic competitions and sparring matches. Three [androids](3-Mechanics/CLI/bestiary/construct/android-qftis.md) work here. Despite their friendly demeanors, the malfunctioning Constructs are hostile toward the characters.
...
- **Boxing Android.** This [android](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (sentry design) is programmed to train boxers and wrestlers. It doesn't pull its punches and leaves opponents with bruises, dislocated limbs, and fractured bones—the android has even been known to bite. When it scores a hit, a trip gong rings in its chest.  
- **Fencing Android.** This [android](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (duelist design) is a fencing instructor that channels its Force Strikes through a rusty epee. The android exclaims "on guard!" at the start of each of its turns.  
- **Martial Arts Android.** This [android](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (aerialist design) is a master of martial arts and never uses its hands. It delivers its Force Strikes as swift kicks.  

Each android believes its discipline is supreme. If a character suggests an android's discipline is inferior to those of its cohorts and succeeds on a DC 16 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check, that android turns on its fellow machines.
...
Two malfunctioning [androids](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (aerialist design) lift weights in this exercise room. When the androids notice the characters, they cease their workout and hurl dumbbells at the characters. When an android throws a dumbbell, it makes a Force Strike attack but deals bludgeoning damage instead of force damage on a hit.
...
The supplies in this room includes a canister of healing spray (an aerosolized jar of Keoghtom's Ointment), ten [healer's kits](3-Mechanics/CLI/items/healers-kit.md), three vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-vial.md), and a yellow key card on a Humanoid skeleton.

#### S43: Whirlpools

Three 5-foot-diameter pools swirl with fetid brine in this muggy room. Passengers relaxed in these former mineral baths, which are now contaminated. Three [grells](3-Mechanics/CLI/bestiary/aberration/grell.md) hide here, each slurping from its own pool, waiting to ambush creatures that pass by.
...
An [aboleth](3-Mechanics/CLI/bestiary/aberration/aboleth.md) lurks at the deep end of the pool. During the chaos of the outbreak and the events that followed, the aboleth escaped a laboratory tank in another part of the ship and made this area its lair.
...
Four [androids](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (aerialist design) boogie in this trendy disco. The malfunctioning androids have been dancing here for nearly a century. Friction has frayed their outfits at the seams.
...
One of the dancing androids wears an [antigravity belt](3-Mechanics/CLI/items/antigravity-belt-qftis.md) as a fancy accessory; the belt has 0 charges remaining.
...
A debonair [android](3-Mechanics/CLI/bestiary/construct/android-qftis.md) (diplomat design) is trapped in this cocktail lounge. While pinned by the wreckage, it has the [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) and [prone](3-Mechanics/CLI/rules/conditions.md#Prone) conditions and can't move. When a character comes within 30 feet of the android, it calls out to them for help. The android introduces itself as a bartending unit named Oakley. The android wears a bow tie and has a suave, shell-form hairdo integrated into its headpiece. Oakley is initially indifferent toward the characters but becomes friendly if freed.

##### Freeing the Android

As an action, a character can make a DC 20 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to try to lift the wreckage off the android, doing so on a successful check. If freed, the android calmly stands up, thanks its rescuer, and moseys over to the bar.
...
- **Wildlife.** The garden teems with Small and Tiny Beasts from other worlds: four-winged birds, three-eyed frogs, and nubby-horned rats. These creatures are harmless and use the stat blocks of familiar, earthly counterparts such as [hawks](3-Mechanics/CLI/bestiary/beast/hawk.md), [frogs](3-Mechanics/CLI/bestiary/beast/frog.md), and [rats](3-Mechanics/CLI/bestiary/beast/rat.md). Animal calls, screeches, and whistles pervade this level's natural chambers.  

**Random Garden Encounters**

| dice: d8 | Encounter |
|----------|-----------|
| 1 | Two [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (dew drinker) |
| 2 | Two [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (snapper saw) |
| 3 | Two [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (purple blossom) |
| 4 | `1d4` [barkburrs](3-Mechanics/CLI/bestiary/plant/barkburr-qftis.md) |
| 5 | A [swarm of gibberlings](3-Mechanics/CLI/bestiary/fiend/swarm-of-gibberlings-qftis.md) |
| 6 | A carnivorous plant sapling (use the [awakened shrub](3-Mechanics/CLI/bestiary/plant/awakened-shrub.md) stat block) |
| 7 | A six-eyed [giant toad](3-Mechanics/CLI/bestiary/beast/giant-toad.md) |
| 8 | `1d4` bunnyoids (use the [weasel](3-Mechanics/CLI/bestiary/beast/weasel.md) stat block) |
^random-garden-encounters
...
Aphelion is right about the drop tubes—they were damaged in the crash and can't be used to access the level below. The only way down is via the spiral staircase in area S60, which is guarded by the [froghemoth](3-Mechanics/CLI/bestiary/monstrosity/froghemoth-elder-qftis.md) in the lake (area S59).
...
> [!gallery]
> ![Map 7.3: Spaceship Level 3](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/125-map-7-03-spaceship-level-3-map.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/126-map-7-03-spaceship-level-3-map-player.webp#gallery)
...
If the characters remain in this room for 10 minutes or longer, three [umber hulks](3-Mechanics/CLI/bestiary/monstrosity/umber-hulk.md) burrow up from a hole beneath one of the containers and attack.
...
This former menagerie has since become the home of a family of [aurumvoraxes](3-Mechanics/CLI/bestiary/monstrosity/aurumvorax-jttrc.md)—fearsome, eight-legged mustelids that subsist on a diet of precious ores. The [den leader](3-Mechanics/CLI/bestiary/monstrosity/aurumvorax-den-leader-jttrc.md) is currently away, leaving its playful offspring here while it hunts.

The baby aurumvoraxes use the [badger](3-Mechanics/CLI/bestiary/beast/badger.md) stat block. They are indifferent toward the characters but defend themselves if necessary.
...
Twenty gas bats—bloated, chiropteran plants propelled by embarrassing-sounding emissions—float above this futuristic taproom, where androids and crew once shared drinks together. Each bat uses the [gas spore](3-Mechanics/CLI/bestiary/plant/gas-spore.md) stat block, but its size is Tiny.
...
This jungle-like exhibit is similar in arrangement to area S49 but originally housed flora instead of fauna. Six [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (two of each variety) blend in with the strange and vibrant plants throughout the area. The horrid plants are hostile toward the characters.
...
| 4 | Heavy Rain. The garden is "lightly obscured", and creatures have disadvantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks. Open flames are extinguished. |
^garden-weather-effects
...
Two deadly, bipedal lizards captured from another world dwell here. They have short horns, mottled hides, and spiny frills. The lizards use the [tyrannosaurus rex](3-Mechanics/CLI/bestiary/beast/tyrannosaurus-rex.md) stat block, but their size is Large.

The lizards [hide](3-Mechanics/CLI/rules/actions.md#Hide) in the tall grass near the southern entrance, watching for prey to ambush. A character who scans the room and succeeds on a DC 16 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notices the reptiles. When the characters get close, the lizards stomp out of hiding to devour them.

##### Treasure

The lizards' nest is in the largest pen. It contains three unhatched eggs, numerous bones, a green key card, a [robot controller](3-Mechanics/CLI/items/robot-controller-qftis.md), and a gold medallion worth 200 gp.
...
Three [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (purple blossoms) lie in ambush near the paths.

##### S56b: Scintillating Fish

A school of twenty scintillating fish with gemlike scales inhabits this streamlet and its pool. The fish use the [swarm of quippers](3-Mechanics/CLI/bestiary/beast/swarm-of-quippers.md) stat block but shed dim light in a 10-foot radius. The fish are indifferent toward the characters unless disturbed, at which point they retreat downstream toward the swamp (area S58).

##### S56c: Snapper Saws

Three [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (snapper saws) [hide](3-Mechanics/CLI/rules/actions.md#Hide) near the paths.

##### S56d: Shambling Mounds

Four [shambling mounds](3-Mechanics/CLI/bestiary/plant/shambling-mound.md) lurk among the thick growth near the path to catch the unwary. After dispatching the mounds, a character who surveys the area and succeeds on a DC 14 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check finds a narrow path to the creatures' den nearby. A heap of rotting vegetation within contains two energy cells, a Humanoid skeleton with a jeweled ring worth 1,000 gp, and dozens of finger-sized maggots.

##### S56e: Squealer

This area is the territory of a squealer—a porcine-headed predator unleashed during the crash. The squealer uses the [nalfeshnee](3-Mechanics/CLI/bestiary/fiend/nalfeshnee.md) stat block, but it's a Monstrosity and has a 30-foot climbing speed instead of a flying speed. The creature [hides](3-Mechanics/CLI/rules/actions.md#Hide) in the treetops, mimicking the cries of distressed Beasts to attract prey. A character who hears the sounds recognizes them as imitations with a successful DC 15 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check.

The squealer's lair is an artificial burrow close by. Inside is a red key card, a [concussion grenade](3-Mechanics/CLI/items/concussion-grenade-qftis.md), and four gems worth 100 gp each.

##### S56f: Dew Drinkers

Three [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (dew drinkers) hide near the path.
...
This area is similar to area S56 but has fewer predators due to the presence of the [froghemoth](3-Mechanics/CLI/bestiary/monstrosity/froghemoth-elder-qftis.md) (see area S59). It consists of three foliage-lush regions with a swamp to the southeast (area S58).
...
Five [thri-kreen](3-Mechanics/CLI/bestiary/humanoid/thri-kreen.md) and their leader, a [psionic thri-kreen](3-Mechanics/CLI/bestiary/humanoid/thri-kreen.md) (a variant thri-kreen), hide in the canopies near this snaking pathway. The character with the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score notices the thri-kreen, who are initially indifferent toward the party.

If the characters parley with the thri-kreen, the insectile warriors ask them to destroy the [shambling mounds](3-Mechanics/CLI/bestiary/plant/shambling-mound.md) in area S56d in exchange for two [concussion grenades](3-Mechanics/CLI/items/concussion-grenade-qftis.md) the thri-kreen have accumulated. The thri-kreen cryptically warn the characters they'll need the explosives to cross the lake. If the characters decline, the thri-kreen disappear into the foliage without another word.
...
Near the streamlet are two [horrid plants](3-Mechanics/CLI/bestiary/plant/horrid-plant-qftis.md) (snapper saws) that use their tendrils to reel passersby into their bladelike leaves.
...
Eight giant leeches (use the [giant constrictor snake](3-Mechanics/CLI/bestiary/beast/giant-constrictor-snake.md) stat block) dwell in the swamp. Each leech has two eyestalks and a translucent underbelly that reveals a mingling of blood-engorged sacs, peristaltic organs, and smooth muscle tissue. The parasites flatten their bodies to hide beneath the water's edge and ambush passersby. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 16 or higher notice the leeches.

#### S59: Lake

![A froghemoth elder—a giant, amphibious predator from another world—blocks the path forward](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/127-07-009-froghemoth.webp#center)
...
A [froghemoth elder](3-Mechanics/CLI/bestiary/monstrosity/froghemoth-elder-qftis.md) hides in the lake. Originally a specimen loosed from captivity, the creature has existed on this level for decades and has grown to massive proportions. The garden is this apex predator's lair.
...
If the [froghemoth](3-Mechanics/CLI/bestiary/monstrosity/froghemoth-elder-qftis.md) in area S59 is still alive when the characters enter this chamber, it whips at the windows with its tentacles and long, prehensile tongue to get at the tender morsels within.
...
> [!gallery]
> ![Map 7.4: Spaceship Level 4](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/129-map-7-04-spaceship-level-4-map.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/130-map-7-04-spaceship-level-4-map-player.webp#gallery)
...
Aphelion is stalling. When the conversation flags or if the characters interrupt the monologue with combat, four [combat robots](3-Mechanics/CLI/bestiary/construct/combat-robot-qftis.md) pour out through the stairway access door from which the characters emerged and attack. The robots were previously unable to reach this level but followed the characters after they encountered the [froghemoth](3-Mechanics/CLI/bestiary/monstrosity/froghemoth-elder-qftis.md).
...
A cobwebbed Humanoid skeleton in a regal uniform is sprawled on the cold floor here. These are the jumbled bones of the ship's commander, whose laser pistol and platinum key card are nearby. The pistol can fire 10 shots before its energy cell is drained.
...
A herd of ten [intellect devourers](3-Mechanics/CLI/bestiary/aberration/intellect-devourer.md) roams this area, preying on creatures that happen on this entrance to the ship. When the characters inspect the breach, the aberrations emerge from air ducts in the surrounding machinery and attack.
...
![An intellect devourer stalks a group of explorers on the service deck](3-Mechanics/CLI/adventures/quests-from-the-infinite-staircase/img/131-07-011-intellect-devourer.webp#center)