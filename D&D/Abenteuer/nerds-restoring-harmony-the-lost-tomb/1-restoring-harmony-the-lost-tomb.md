...
A dapper gentleman in a suit with horn-rimmed glasses is waiting for Purple at the statue. The man motions for Purple to come and sit on a bench. The man is [Mr. Honeycutt](3-Mechanics/CLI/bestiary/npc/mr-honeycutt-nrh-tcmc.md), the Magister of the Lorekeeper Society. He begs for Purple's understanding for complete secrecy as he unrolls a spell scroll of [silence](3-Mechanics/CLI/spells/silence.md) and casts the spell. Mr. Honeycutt previously imbibed a potion of [telepathy](3-Mechanics/CLI/spells/telepathy.md), and he then speaks the following in Purple's head:
...
The piece of amber is an ancient key that unlocks a secret door in Herald's Crypt—a famous tomb underneath the academy. This [amber runestone](3-Mechanics/CLI/items/amber-runestone-nrh-tlt.md) is also a magic item that Purple can attune to by spending a short rest focused on only on the item while in physical contact with it. See the end of the adventure for its game statistics.

### Deciphering the Runes

During their studies, Purple has come across several tomes that had such runes. With two successful DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) checks, Purple can find the books within Prism Academy's library. If Purple asks for help from the librarian, they make the checks with advantage. With two failures, Purple still finds the books but manages to make noise or otherwise incur the librarian's disapproving look.
...
- Convince Headmaster Gustava (Lawful good, human, [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage.md)) to allow Purple to open the Flower Door and enter the crypt. Purple must make a successful DC 17 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) or—with a more wizardly argument—a successful DC 17 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check to convince the headmaster.  
- Sneak in using the [amber runestone](3-Mechanics/CLI/items/amber-runestone-nrh-tlt.md). If Purple attunes to the stone, they can shine sunlight on the Flower Door. Doing this reveals a series of glowing numerals, 1–50, that are in the center of each of the flowers on the door. Pressing the numerals in the sequence written on the stone (12, 2, 6, 9, 24, and 36) opens the magic lock. An incorrect sequence sets off an alarm that summons Headmaster Gustava, who appears instantly.  
...
![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-the-lost-tomb/img/010.webp#center)
...
Purple notices a perfect square of what looks like dirt on the door. It can't be cleaned by hand, only with a [prestidigitation](3-Mechanics/CLI/spells/prestidigitation.md) spell.

When the dirt is cleaned off, it reveals a small button. Again, the button can't be pushed except by a [mage hand](3-Mechanics/CLI/spells/mage-hand.md) spell.

When the button is pushed, it turns into a cog that begins turning. It can only be stopped by targeting it with the [ray of frost](3-Mechanics/CLI/spells/ray-of-frost.md) spell.
...
Each crypt is sealed with a glyph of warding, and only Headmaster Gustava knows the passwords that deactivate the glyphs. To detect the wards, Purple must succeed on a DC 17 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check or cast detect magic.
...
This tomb has the bas-relief of a plump wizard surrounded by farm animals and magical creatures. The words "She was [Nature](3-Mechanics/CLI/rules/skills.md#Nature)'s mystery and magic made flesh" are inscribed on the tomb.
...
The gem is indeed the Violet Gem that Mr. Honeycutt wants. If Purple follows the riddle correctly (see "Deciphering the Runes," above), they need to speak the name "Zimandius" or "Zimandius Prism" three times and then swaps the Violet Gem with the [amber runestone](3-Mechanics/CLI/items/amber-runestone-nrh-tlt.md).
...
- [Amber Runestone](3-Mechanics/CLI/items/amber-runestone-nrh-tlt.md)  
- Rust Bag of Tricks  
- Necklace of Fireballs  

![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-the-lost-tomb/img/sheet009.webp#center)

![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-the-lost-tomb/img/sheet010.webp#center)