...
If the death knight's soul knows that intruders are onboard, it animates a team of [minotaur skeletons](3-Mechanics/CLI/bestiary/undead/minotaur-skeleton-xmm.md) to defend the deck. There is one skeleton present for every member of the party, including sidekicks. The skeletons hide underneath the bones until intruders draw near, and then arise to attack them with surprise. If combat ensues here, Gol Badwind arrives from area D12 to investigate after two rounds.

##### Skeleton Crew

Once per day when the dreadnaught needs to move, the death knight can animate a rowing crew of fifty [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) from the bones piled here. This occurs at the end of the quest if the players stop Tarbin Tul's singing (see area D17).
...
Badwind carries an [alchemy jug](3-Mechanics/CLI/items/alchemy-jug-xdmg.md) at his belt, which he swigs from while doing his rounds.
...
The hammocks are enchanted to attack anyone who enters without the death knight's permission. Each hammock has the statistics of a [rug of smothering](3-Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md) except that it looks like a hammock when using its False Appearance feature. One hammock animates for every member of the party, including sidekicks.
...
The door to this compartment is boarded over with heavy planks of wood. Ularan Mortus was known for constructing obedient servants from the stitched-together bodies of former enemies. After the anchorites discovered that the golems in here were immune to lightning damage, they sealed them inside this chamber and boarded up the door. There is one [flesh golem](3-Mechanics/CLI/bestiary/construct/flesh-golem-xmm.md) inside the compartment for every two members of the party, including sidekicks (rounded down). The golems attack anyone who enters.

##### Treasure

An apothecary's bag inside the surgery contains three [potions of greater healing](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md).
...
When the bard Tarbin Tul (see area D17) becomes too exhausted to perform, the anchorites lock him in this cold cell to recuperate. The door is magically locked with an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell and can only be opened by casting either [knock](3-Mechanics/CLI/spells/knock-xphb.md) or [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md). Unlocking the door alerts the death knight's soul to the presence of intruders inside the vessel.
...
One of the racks contains a magical [+2 mace](3-Mechanics/CLI/items/2-weapon-xdmg.md) called [Bonecounter](3-Mechanics/CLI/items/bonecounter-sdw.md). Whenever this weapon is used to destroy an undead creature, a single silver piece appears in the wielder's pocket.
