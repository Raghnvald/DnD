...
The severed heads of six humans on spears line the south wall of this cavern. The bodies of these humans are thrown at the back of the cave, covering a patch of floor where the [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) spell was cast. If the bodies are moved, the glyph is triggered, and it erupts with magical thunder in a 20-foot-radius sphere centered on it. Each creature in the area must make a DC 14 Dexterity saving throw, taking 22 (`5d8`) thunder damage on a failed saving throw, or half as much damage on a successful one. The glyph disappears after it is triggered.
...
At the center of the chamber a 10-foot-deep pool is filled with seawater and a swarm of hungry baby sharks that use the statistics of a [swarm of quippers](3-Mechanics/CLI/bestiary/beast/swarm-of-piranhas-xmm.md).
...
A sahuagin blademaster (see appendix A) trains a group of [sahuagin](3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) to fight on the bottom level of this chamber. There are two sahuagin for every member of the party, not including sidekicks.
