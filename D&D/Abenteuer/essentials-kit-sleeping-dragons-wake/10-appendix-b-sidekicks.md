...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 10th | 49 (`11d8`) | **Empowered Spells.** Choose one "school of magic". Whenever the spellcaster casts a spell of that school by expending a spell slot, the spellcaster can add its spellcasting ability modifier to the spell's damage roll or healing roll, if any. Spellcasting. The spellcaster learns another cantrip: [spare the dying](3-Mechanics/CLI/spells/spare-the-dying-xphb.md) (healer) or [shocking grasp](3-Mechanics/CLI/spells/shocking-grasp-xphb.md) (mage). The caster also gains one 5th‐level spell slot and learns one new 5th‐level spell: [mass cure wounds](3-Mechanics/CLI/spells/mass-cure-wounds-xphb.md) (healer) or [hold monster](3-Mechanics/CLI/spells/hold-monster-xphb.md) (mage). |
| 11th | 54 (`12d8`) | **Spellcasting.** The spellcaster gains one 6th‐level spell slot and learns one new 6th‐level spell: [heal](3-Mechanics/CLI/spells/heal-xphb.md) (healer) or [chain lightning](3-Mechanics/CLI/spells/chain-lightning-xphb.md) (mage). |
^level-hit-points-new-features
