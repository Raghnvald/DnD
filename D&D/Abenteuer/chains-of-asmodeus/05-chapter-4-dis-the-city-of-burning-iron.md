...
![At the center of the Agora of Floating Knives sits Orishada's Palace.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/080-0.webp#center)

Named for its ruler, the Iron Lord [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md), Dis is the second layer of the Nine Hells and largely dominated by the city of the same name which is ringed by jagged mountains. Within the city, characters may find some of the items they're searching for.
...
| 3 | The characters notice an imp crouching on the rooftops, presumably spying on them. |
...
| 5 | A lone barbed devil approaches and demands 100 gp as tax for traveling across [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md)'s realm. If he is attacked, he calls upon a pair of [war devils](3-Mechanics/CLI/bestiary/fiend/war-devil-coa.md) (see appendix B) circling hundreds of feet above to protect him. |
...
When the characters arrive in the city have [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) provide information about the city and its different areas (see "Key Locations in the City of Dis" for a description). The players need to make their way to the Agora of Floating Knives, the trade district in the City of Dis. If the players decide to venture into any of the other areas of the city, you can use the information provided in this section to guide them on a short excursion. However, the conditions of these locales may quickly deter them from venturing there too long.

### Koh Tam and Tiax

At the Agora, give the players plenty of time to explore. [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) or [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) can provide them with directions to the different areas of the Agora and its market stalls. If [Tiax](3-Mechanics/CLI/bestiary/npc/tiax-coa.md) is accompanying the characters into the Agora, roll on the Troubles with Tiax table in chapter 1 to see if their outing with the gnome is eventful.

At this point, [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) reminds the characters that his barge is able to Plane Shift to a layer of the Nine Hells above the current one, at any time. It requires a full action for him to activate the ability.
...
| Objective | Location |
|-----------|----------|
| [Instrument of the Bards (Ollamh Harp)](3-Mechanics/CLI/items/instrument-of-the-bards-ollamh-harp.md) | The Agora of Floating Knives: Barges of Theater |
| [Cloak of Invisibility](3-Mechanics/CLI/items/cloak-of-invisibility.md) | The Agora of Floating Knives: The Market of Killers |
...
| [Iron Horn of Valhalla](3-Mechanics/CLI/items/horn-of-valhalla-iron.md) | Orishada's Palace: Aelvette |
| [Wrought-Iron Tower](3-Mechanics/CLI/items/wrought-iron-tower-coa.md) | Orishada's Palace: The Floating Duke |
^objectives-in-dis
...
> [!gallery]
> ![Dis, the Second Hell](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/083-0-dm.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/083-0.webp#gallery)

Outside the city proper, the layer is a mountainous crag land rich in ore deposits. [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) ordered the construction of the Iron Road, a pathway made of iron and cobblestone, to navigate the mountains and extract the minerals located within. Since its construction, the mountains are mined, and ore transported back to Dis for refinement.
...
[Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) remains the ruler of Dis and an ally of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md), and he intends for it to stay that way. Fortification of [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md)'s layer continues unabated at his behest, in preparation for some future war. Assuming inhabitants follow the rules of the realm, they're given relative freedom to go about their business.

### The City of Dis

![The Iron Tower of Dispater Looms over the City of Dis.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/082-0.webp#center)
...
Extraplanar travelers often stop in the city before moving on, due to its reputation as a hub for trade and commerce within the layers. Many bazaars and shops are set up offering strange wares from different planes, and [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) encourages any on the plane to establish contracts whenever possible. These contracts usually involve souls and the greater devils, who make homes in the massive iron towers scattered throughout the town. Beneath the city lies a labyrinthian structure of dungeons, said to contain mortals from the Material Plane. Vents in certain areas of the city allow bloodcurdling screams to float up from below.

### Leaving Dis

Unlike leaving Avernus, traveling deeper into the Nine Hells from Dis is quite difficult. The only two known passages are the Styx and a staircase, both of which descend to Minauros. Though the location of the staircase isn't publicly known, everyone assumes it to be located within [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md)'s Iron Tower, making it difficult to find without connections. The Styx is especially dangerous, as the drop from Dis to Minauros consists of steep inclines, rapids, and waterfalls. It takes a seasoned captain or a large amount of luck to navigate the passage, leaving nascent souls or mortals without means of traveling deeper.
...
Though several iron towers decorate the city, none are as large as the Iron Tower, [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md)'s fortress and palace. It is visible from anywhere in the city, and through enchantment magic always appears to be very close. [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) maintains complete control over the tower—including the capability to shift its form and interiors to match his desires—and the tower can only be entered if he permits. If [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) has no interest in meeting you, even reaching the tower requires tremendous effort and immense willpower.
...
Unless the characters have business inside of the tower (and [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) allows them entry) the characters can't enter.

### The Garden of Delights

Devils from all layers are known to travel to Dis solely for the Garden, where all manner of luxuries and pleasures can be enjoyed. The Garden provides the income needed to improve [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md)'s city and armies, and it keeps his citizens happy. The Garden also serves as a distraction for the denizens of the Nine Hells from the tortures of everyday existence in this bleak place. However, the characters are mortal beings and the illusions found inside overwhelm their minds. If they explore the Garden of Delights, they become enchanted by its beauty and may forget themselves. For considerable time they're unable to remember their mission and wander the Garden aimlessly.
...
| Item | Cost |
|------|------|
| [Condensed Order](3-Mechanics/CLI/items/condensed-order-coa.md) | 50 gp |
| Dream bottle | 50 gp |
| [Dust of Sneezing and Choking](3-Mechanics/CLI/items/dust-of-sneezing-and-choking.md) | 250 gp |
| [Oil of Sharpness](3-Mechanics/CLI/items/oil-of-sharpness.md) | 2,500 gp |
| [Oil of Slipperiness](3-Mechanics/CLI/items/oil-of-slipperiness.md) | 250 gp |
| [Potion of Fire Breath](3-Mechanics/CLI/items/potion-of-fire-breath.md) | 250 gp |
| [Potion of Mind Reading](3-Mechanics/CLI/items/potion-of-mind-reading.md) | 750 gp |
^items-for-sale

> [!gallery]
> ![The Agora of Floating Knives](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/086-0-dm.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/086-0.webp#gallery)
...
There is also a thriving trade market. These items are readily available for anyone who succeeds on a DC 15 Intelligence (Arcana) check. However, the buyer is only interested in trading for a magic item with [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) as an additional cost.

**Magic Items Trade Cost**

| Magic Item | Trade In |
|------------|----------|
| [Mirror of Life Trapping](3-Mechanics/CLI/items/mirror-of-life-trapping.md) | Rare or very rare wondrous item, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Dagger of Venom](3-Mechanics/CLI/items/dagger-of-venom.md) | Uncommon or rare weapon, plus 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Crystal Ball](3-Mechanics/CLI/items/crystal-ball.md) | Rare or very rare wondrous item, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Efreeti Bottle](3-Mechanics/CLI/items/efreeti-bottle.md) | Rare or very rare wondrous item, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Ring of Shooting Stars](3-Mechanics/CLI/items/ring-of-shooting-stars.md) | Rare or very rare ring, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Robe of Stars](3-Mechanics/CLI/items/robe-of-stars.md) | Rare or very rare magic cloak or robe, plus 3 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Staff of Fire](3-Mechanics/CLI/items/staff-of-fire.md) | Rare or very rare magic rod or staff, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Staff of Frost](3-Mechanics/CLI/items/staff-of-frost.md) | Rare or very rare magic rod or staff, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Spellguard Shield](3-Mechanics/CLI/items/spellguard-shield.md) | Rare or very rare shield, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Nine Lives Stealer](3-Mechanics/CLI/items/nine-lives-stealer.md) | Rare or very rare weapon, plus 2 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
^magic-items-trade-cost
...
- **Test of Skill.** The character must either best a horned devil in a complicated game of knot tying or compete against an erinyes to see who can calm an enraged [hellcat](3-Mechanics/CLI/bestiary/fiend/hellcat-bezekira-coa.md) (see appendix B). Tying the knot requires a successful DC 18 Dexterity (Sleight of Hand) check whereas taming the creature requires a successful DC 15 Wisdom (Animal Handling) check. If the character fails the check, they can try to make a DC 16 Charisma (Deception) check. If successful they bluff their way into getting a second (and final) chance on the original check.  
- **Test of Wits.** The character challenges an amnizu (see Monsters of the Multiverse) to a dice game popular in the Nine Hells. The character must make a successful DC 15 Intelligence check to win the match.  
...
One of the shops in the Outer Agora is run by the enigmatic and ruthless neogi (see Monsters of the Multiverse). These spider-like monsters are planar travelers that trade in magic items and prisoners. Their shop usually only stays in the same place for `1d6` weeks. Each visit to the shop brings the chance of danger, for sometimes the neogi aren't looking to sell items, but are more interested in acquiring new victims. A new shopper must make a DC 20 Charisma (Persuasion) check. If they succeed, the items on sale are real. If they fail, then the items are illusory and the neogi have prepared an ambush. A neogi master leads the ambush, with an additional neogi (see Monsters of the Multiverse) and an umber hulk for each shopper. More powerful customers might mean the neogi bring an additional `1d6` gray renders (see Monsters of the Multiverse). The Illusory Items table lists items that they sell, along with what the items really are if the neogi have decided to ambush the shoppers.

**Illusory Items**

| Magic Item | If Illusory | Cost |
|------------|-------------|------|
| [Apparatus of Kwalish](3-Mechanics/CLI/items/apparatus-of-kwalish.md) | A hook horror charmed by the neogi | 100,000 gp |
| [Brazier of Commanding Fire Elementals](3-Mechanics/CLI/items/brazier-of-commanding-fire-elementals.md) | An xorn restrained by [Dimensional Shackles](3-Mechanics/CLI/items/dimensional-shackles.md) | 10,000 gp |
| [Cape of the Mountebank](3-Mechanics/CLI/items/cape-of-the-mountebank.md) | A rotting nonmagical cloak | 5,000 gp |
| [Carpet of Flying](3-Mechanics/CLI/items/carpet-of-flying.md) | A cheap carpet | 20,000 gp |
| [Cloak of Arachnida](3-Mechanics/CLI/items/cloak-of-arachnida.md) | A cloaker that is the pet of one of the neogi | 15,000 gp |
| [Deck of Illusions](3-Mechanics/CLI/items/deck-of-illusions.md) | A set of playing cards with depraved images | 400 gp |
| [Demon Armor](3-Mechanics/CLI/items/demon-armor.md) | Hezrou restrained by [Iron Bands of Binding](3-Mechanics/CLI/items/iron-bands-of-bilarro.md) | 40,000 gp |
| [Dwarven Plate](3-Mechanics/CLI/items/dwarven-plate.md) | A shield guardian whose control amulet is worn by the neogi master | 35,000 gp |
| [Figurine of Wondrous Power (golden lions)](3-Mechanics/CLI/items/figurine-of-wondrous-power-golden-lions.md) | Same as above except a pair of [hellcats](3-Mechanics/CLI/bestiary/fiend/hellcat-bezekira-coa.md) (see appendix B) | 11,500 gp |
| [Figurine of Wondrous Power (marble elephant)](3-Mechanics/CLI/items/figurine-of-wondrous-power-marble-elephant.md) | Same as above except a single [maelephant nomad](3-Mechanics/CLI/bestiary/fiend/maelephant-nomad-coa.md) (see appendix B) | 11,000 gp |
| [Figurine of Wondrous Power (onyx dog)](3-Mechanics/CLI/items/figurine-of-wondrous-power-onyx-dog.md) | [Displacer fiend](3-Mechanics/CLI/bestiary/fiend/displacer-fiend-coa.md) (see appendix B) under permanent Reduce spell and held by an adamantine leash | 11,000 gp |
| [Helm of Brilliance](3-Mechanics/CLI/items/helm-of-brilliance.md) | Intellect devourer | 25,000 gp |
| [Mace of Terror](3-Mechanics/CLI/items/mace-of-terror.md) | A flameskull attached to an [Immovable Rod](3-Mechanics/CLI/items/immovable-rod.md) | 9,000 gp |
| [Sword of Life Stealing](3-Mechanics/CLI/items/sword-of-life-stealing.md) | A rusty nonmagical sword | 12,000 gp |
| [Wings of Flying](3-Mechanics/CLI/items/wings-of-flying.md) | Muzzled harpy in a cage | 11,000 gp |
^illusory-items
...
Gazrak (chaotic evil, tiefling archmage) sells all manner of grotesque musical instruments, but he also owns an [Instrument of the Bards (Ollamh Harp)](3-Mechanics/CLI/items/instrument-of-the-bards-ollamh-harp.md). He is fond of the harp but also greedy. He suggests an outrageous price at first—30 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md). A successful DC 17 Charisma (Persuasion) check can either lower the price to 20 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) or allow the characters to pay 100,000 gp instead of using [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md). Giving him a rare or very rare magic item as part of the exchange reduces the price by half.
...
To obtain the cloak the characters must hire the assassin (neutral evil, lizardfolk assassin) who wears it, and then kill them for it. When they threaten the assassin he mocks them because he is protected by a powerful archdevil.
...
| Gladiator | 250 gp | 3 |
| Assassin | 500 gp | 5 |
| Undead drow mage* who summons a bone devil instead of a shadow demon | 750 gp | 6 |
| Undead assassin* | 1,000 gp | 7 |
| Undead githyanki knight* on a young shadow dragon (red) | 1,500 gp | 8 |
| The yat-ja slayer (lizardfolk assassin with a [Cloak of Invisibility](3-Mechanics/CLI/items/cloak-of-invisibility.md)) | 5,000 gp | 9 |
| Saint of killers (fallen planetar with no wings or fly speed, dressed in dark leather) | 20,000 gp | 12 |
^assassins-for-hire
...
Aelvette is in possession of the [Iron Horn of Valhalla](3-Mechanics/CLI/items/horn-of-valhalla-iron.md), a character searching for it has to steal it from her. When the characters enter Aelvette's chambers read the following:
...
![The most perverse delicacies are prepared in Aelvette's kitchens.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/093-0.webp#center)
...
The chefs working the kitchen are three flesh golems directed by a horned devil. Any violence in the kitchens brings down the wrath of all the chefs and their overseer.
...
Corteso is always protected by a half-dozen mind flayers and their intellect devourer pets. If asked where he obtains his memories, the characters are told their suppliers are many, but recently high-quality memories have been obtained from a location known as the Ineffable Trove, located in Minauros.
...
> [!readaloud] 
> 
> Orishada is a great, broad devil wearing clothes of metallic finery, richly bedecked in both mundane and exotic jewelry. "I hope you're not here to waste my time. My direct superior is [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) himself, lord of both city and layer, and he will be gracing me with his presence in a few hours. I see only very select buyers, which my majordomo assures me you are. I must assume you're here for the specific class of ware that I am known for: dispensations."
^16a

If his guests have no idea what he is talking about, Orishada—an amnizu (see Monsters of the Multiverse)—won't immediately order their deaths. He assumes it is part of some negotiation tactic. He summons one of his imps to explain what a dispensation is:
...
> 
> All the devils at this location defend either [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) (see appendix A) or Orishada if the characters attack either. It is unlikely characters can survive an outright onslaught and they may need some guidance to behave as cleverly as the devils themselves do in the Nine Hells. Dealing with just Orishada on his own is significantly easier.
^insurmountable-odds

##### Deathstalkers—Obtaining the Wrought-Iron Tower

[Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) is due to visit Orishada in a few hours. While extremely difficult, a particularly ingenious group of characters might be able to steal [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md)'s Wrought-Iron Tower (this is the staff that is his signet) through deception (though illusions won't work) or by simply snatching it and running for their lives. However, they can also learn from Orishada, who is a braggart, that [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md) must leave his Wrought-Iron Tower with Orishada before he goes to an audience with [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). He can't bring his symbol of power when he goes before his master, and he doesn't trust to leave it with someone at his abode; thus, he often leaves it in Orishada's care.
