...
You'll need a handful of Treasure token cards (found in Ixalan booster packs) and a number of cards detailing treasures from the Ixalan set. See "Appendix D: Hidden Plunder" at the end of this adventure for the card list, then shuffle those non-token cards to make an item deck.
