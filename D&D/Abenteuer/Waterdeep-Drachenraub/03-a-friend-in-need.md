...
If the characters don't interfere in the brawl, Yagra knocks Krentz out cold but is then beaten unconscious by his companions. [Durnan](/3-Mechanics/CLI/bestiary/npc/durnan-wdh.md), the proprietor of the Yawning Portal, points toward the door. "Out!" he snarls, and the Xanathar Guild members flee carrying Krentz's unconscious form.
...
The gnome sells an assortment of trinkets. As the characters search the shelves, roll on the Trinkets table in chapter 5 of the "Player's Handbook" to determine what catches their eye. Xoblob sells any trinket for `dice:1d6|noform|noparens|avg` (`1d6`) gp.
...
Each goblin carries `dice:1d6|noform|noparens|avg` (`1d6`) cp in a small pouch.
...
In a satchel, [Grum'shar](/3-Mechanics/CLI/bestiary/npc/grumshar-wdh.md) carries his spellbook, which contains the following spells: burning hands, disguise self, false life, shield, unseen servant, and witch bolt.
