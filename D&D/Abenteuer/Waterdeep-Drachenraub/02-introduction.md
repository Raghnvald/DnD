...
- If the adventurers are accosted and overwhelmed, one or more Harpers come to their rescue. A Harper rescue team usually consists of a [bard](/3-Mechanics/CLI/bestiary/humanoid/bard-vgm.md) (see appendix B) or a [mage](/3-Mechanics/CLI/bestiary/humanoid/mage.md), plus `dice:1d4+3|noform|noparens|avg` (`1d4 + 3`) [spies](/3-Mechanics/CLI/bestiary/humanoid/spy.md) or [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md).  
