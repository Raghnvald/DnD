...
- json5e-note
tags:
- ttrpg-cli/compendium/src/5e/tftyp-dit
aliases:
- "Dead in Thay"
---
# Dead in Thay
...
However, groups of heroes recently assaulted Bloodgate Keep and its master, the lich [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md). With the help of a renegade Red Wizard named [Mennek Ariz](3-Mechanics/CLI/bestiary/npc/mennek-ariz-tftyp.md), this assault was successful. Bloodgate Keep fell, and Szass Tam's plans of invasion were crushed.
...
Magic secures the dungeon. No spell or trait allows anyone to evade the dungeon's security. For instance, a wizard might use a [dimension door](3-Mechanics/CLI/spells/dimension-door-xphb.md) spell to teleport from one part of a zone to another, but no spell permits teleportation out of the zone in which the spell was cast. Similarly, a wizard might cast a [passwall](3-Mechanics/CLI/spells/passwall-xphb.md) spell to burrow from one area to another. If the tunnel would pass from one zone to another, circumventing security, then the tunnel ends halfway between the origin point and the possible exit point. In any case, the caster knows why the spell didn't work as intended. Further, an incorporeal or ethereal creature can't pass between zones.

A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell can't penetrate the structure of the Doomvault to sense the dimensional barriers.
...
Once the characters learn that they need to disrupt the gates, anyone who understands the nature of the gates knows how to perform the disruption. As an action, a character who has the glyph key attuned to a black gate's zone can disrupt the gate. To do so, the character must touch the edge of the gate's energy field and succeed on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check. A [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell cast on the gate up to 1 minute beforehand grants advantage on this check. On a failure, the character performing the check takes 7 (`2d6`) force damage.
...
Abjuration magic keeps the dungeon dry and at a comfortable temperature. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals this magic as a faint aura on all the Doomvault's surfaces.
...
Szass Tam devised the ritual that enables the creation of [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md). The lich has since altered the process to make it possible for a Red Wizard to take control of a dread warrior. The effect creates a psychic link between the dread warrior and a Red Wizard, who can, for a time, experience the world through the dread warrior's senses, speak with its mouth, and cast spells through it. A powerful wizard can control more than one dread warrior at a time.

When a party in the Doomvault encounters a dread warrior that isn't in the company of a Red Wizard or [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md), a special interaction may occur. If the dread warrior survives until end of the third round (or for more than 20 seconds), [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) (see area 10) becomes aware of the group's presence. Var's attention raises the overall alert level by 1. In addition, [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) takes control of the dread warrior by the start of its next turn. Instead of allowing the warrior to attack, Var uses the warrior's actions to cast his spells through it.

When Var becomes aware of the group through a dread warrior, the warrior's eyes glow with pale light. If someone casts [counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md) or [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) on the dread warrior during this time, and successfully dispels a 5th-level spell, Var's connection is suppressed for 1 minute. Preemptively casting [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) on a dread warrior can have the same effect.
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | 1 [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md), 4 [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md), and `2d4` prisoners ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 2–3 | 1 [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 4 | 1 [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and `2d4` [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) or [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
^encounter
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `2d4` [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) |
| 2 | 1 [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) and `2d6` [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
| 3 | `2d4` [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) |
| 4 | 1 [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) |
^encounter
...
| dice: 2d4 | Encounter |
|-----------|-----------|
| 2 | 1 [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md), `2d4` [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md), and `2d4` prisoners ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 3–4 | 1 [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md), `1d3` [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md), and `2d4` [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) |
| 5–6 | 1 Red Wizard [evoker](3-Mechanics/CLI/bestiary/humanoid/evoker-wizard-mpmm.md), 1 [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md), and `1d4` [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) |
| 7–8 | 1 [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and `1d4` [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) |
^2-encounter
...
Unless the dungeon is on high alert (level 6 or higher), a [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) and `2d4` [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) accompany a monster in any sector or individual encounter entry marked with an asterisk.

**Abyssal Prisons***

| dice: d4 | Encounter |
|----------|-----------|
| 1 | 1 [reduced-threat hezrou](3-Mechanics/CLI/bestiary/fiend/reduced-threat-hezrou-tftyp.md) |
| 2 | `2d8` [manes](3-Mechanics/CLI/bestiary/fiend/manes-xmm.md) |
| 3 | `1d4` [quasits](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md) |
| 4 | 1 [reduced-threat vrock](3-Mechanics/CLI/bestiary/fiend/reduced-threat-vrock-tftyp.md) |
^abyssal-prisons
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `2d6` [giant centipedes](3-Mechanics/CLI/bestiary/beast/giant-centipede-xmm.md) |
| 2 | `1d4` [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) |
| 3 | Thayan patrol (roll on Thayan Patrol table) |
| 4 | 1 [shambling mound](3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md)* |
^blood-pens
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `1d4` [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | 1 [gibbering mouther](3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) |
| 2 | 1 [grell](3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) |
| 3 | `1d4` [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) |
| 4 | 1 [otyugh](3-Mechanics/CLI/bestiary/aberration/otyugh-xmm.md) |
^far-realm-cysts
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `1d2` [hook horrors](3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) |
| 2 | `1d4` [cockatrices](3-Mechanics/CLI/bestiary/monstrosity/cockatrice-xmm.md) |
| 3 | 1 [displacer beast](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) |
| 4 | 1 [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) |
^forests-of-slaughter
...
| 3–4 | `1d4` [gray oozes](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) |
^ooze-grottos
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | `2d4` [giant crabs](3-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md)* |
| 2 | `2d4` [kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) |
| 3 | `1d2` [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md)* (in water globes) |
| 4 | 1 [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md)* |
^predator-pools
...
| dice: d4 | Encounter |
|----------|-----------|
| 1 | 1 [reduced-threat flesh golem](3-Mechanics/CLI/bestiary/construct/reduced-threat-flesh-golem-tftyp.md) |
| 2 | 1 [flesh golem](3-Mechanics/CLI/bestiary/construct/flesh-golem-xmm.md) |
| 3 | 1 [reduced-threat clay golem](3-Mechanics/CLI/bestiary/construct/reduced-threat-clay-golem-tftyp.md) |
| 4 | 1 [clay golem](3-Mechanics/CLI/bestiary/construct/clay-golem-xmm.md) |
^golem-laboratories
...
| dice: 2d4 | Potion |
|-----------|--------|
| 2 | [Flying](3-Mechanics/CLI/items/potion-of-flying-xdmg.md) |
| 3–4 | [Climbing](3-Mechanics/CLI/items/potion-of-climbing-xdmg.md) |
| 5–7 | [Healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md)(1–3), [Greater Healing](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md) (4–5), [Superior Healing](3-Mechanics/CLI/items/potion-of-superior-healing-xdmg.md) (6) |
| 8 | [Invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md) |
^2-potion

##### Red Wizards

Each Red Wizard encountered in the adventure carries `4d10` gp. A Red Wizard also carries `1d4`–2 (minimum 0) [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md), each containing a random arcane spell of 1st or 2nd level, most often [darkvision](3-Mechanics/CLI/spells/darkvision-xphb.md), [daylight](3-Mechanics/CLI/spells/daylight-xphb.md), [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [identify](3-Mechanics/CLI/spells/identify-xphb.md), [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md), or [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md). Twenty-five percent of Red Wizards (determine randomly using a `d4`) instead have one 3rd-level [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md), either of [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) or [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md).
...
|-----------|------|
| 2–6 | None |
| 7 | [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) (usually a battleaxe or a javelin) |
| 8 | [+1 chain mail](3-Mechanics/CLI/items/1-armor-xdmg.md) |
^2-item
...
- [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md)'s quarters lie in the Doomvault. Although the lich was defeated, he might have already rematerialized thanks to the power of his phylactery. Protected by his dread warriors, he is a deadly threat.  
- Syranna provides information on dread warriors and how [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) uses them.  
...
- Thayans have taken two adventurers, [Shalendra Floshin](3-Mechanics/CLI/bestiary/npc/shalendra-floshin-tftyp.md) and [Kelson Darktreader](3-Mechanics/CLI/bestiary/npc/kelson-darktreader-tftyp.md), prisoner. They are likely dead or within the Doomvault.  
...
A [vampire spawn](3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) keeps watch here, along with a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and four [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md). A [quasit](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md) perches invisibly on a chandelier.
...
Issem, a pale human [vampire](3-Mechanics/CLI/bestiary/undead/vampire-xmm.md) in lavish clothes, is normally in this area, watching battles.
...
In the pit, a [reduced-threat vrock](3-Mechanics/CLI/bestiary/fiend/reduced-threat-vrock-tftyp.md) (see "Reduced-Threat Monsters" above) is fighting ten prisoners, nine of whom are human [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md). The tenth is a gold elf [knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) named [Shalendra Floshin](3-Mechanics/CLI/bestiary/npc/shalendra-floshin-tftyp.md). Half the humans each deal 1 slashing damage to the vrock each round, and Shalendra deals 10 damage to the vrock every round. The demon focuses on one target each round (roll randomly). If the characters join the battle, the vrock attacks them.
...
Inside the sarcophagus are six [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) (three of [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), two of [comprehend languages](3-Mechanics/CLI/spells/comprehend-languages-xphb.md), and one of [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md)). Also inside is a bottle of ink and an ink pen with fifteen sheets of parchment.
...
[Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) reconfigured this zone for his use.
...
These steel double doors are locked. [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) (area 10) has a key in his possession.
...
The trap activates 3 rounds after a creature enters the room. ([Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md)'s steel key disables the trap for 1 minute when it is used to open the door to area 5.) At the start of the fourth round, and every 2 rounds thereafter, one circle (chosen randomly) glows white. At the end of the same round, lightning discharges through the room from the steel orb in the ceiling. When the lightning discharges, any creature in the room must make a DC 10 Dexterity saving throw. On a failed save, a creature takes 7 (`2d6`) lightning damage.

A character who touches the steel orb and succeeds on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check can suppress the orb's magic, disabling the trap for `1d4` rounds. A [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell cast on the orb suppresses the magic for 1 hour. In both cases, the character doesn't know how long the suppression might last. The circles continue to glow at random.
...
Pencheska, a [succubus](3-Mechanics/CLI/bestiary/fiend/succubus-xmm.md), resides here with four [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md), who are in her thrall. Pencheska is an unwilling servant of [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md).
...
Pencheska isn't pleased with her situation and won't directly oppose the characters unless they attack her. She is willing to provide a piece of lore about the Phylactery Vault in the hope that the characters might destroy [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) for good, freeing her to escape the Doomvault.
...
[Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) oversees this zone, in which the Thayans have tapped Abyssal power.
...
One [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md), two [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md), and six [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) patrol the area.
...
> [!note] 
> 
> **Circle A**. One [reduced-threat hezrou](3-Mechanics/CLI/bestiary/fiend/reduced-threat-hezrou-tftyp.md) (see "Reduced-Threat Monsters" above)
> 
> **Circle B**. Four [quasits](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md)
> 
> **Circle C**. One [reduced-threat vrock](3-Mechanics/CLI/bestiary/fiend/reduced-threat-vrock-tftyp.md) (see "Reduced-Threat Monsters" above)
> 
> **Circle D**. Ten [manes](3-Mechanics/CLI/bestiary/fiend/manes-xmm.md)
^0cb
...
If examined with a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell, the area displays an aura of necromancy.
...
Here resides the lich [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) with his guards, four [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md). Having lost the Bloodgate, Var is confined to this area because of his fear of Szass Tam, while he awaits his master's final judgment.

The lich attacks immediately. His guards emerge from various positions to screen him from direct attack. [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) can cast any of his spells from one of the dread warriors.
...
Devious and arrogant, [Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) thinks all other creatures are beneath him. He berates the characters at every opportunity, and he drives his underlings to cruelty.
...
[Tarul Var](3-Mechanics/CLI/bestiary/npc/tarul-var-tftyp.md) carries a glyph key attuned to this zone and to the Temples of Anguish (in the Temples of Extraction sector). He also has an ornate steel key (worth 5 gp) that opens the locked doors on the east wall of area 4.
...
A [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and seven [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) are tormenting a [prone](3-Mechanics/CLI/rules/conditions.md#Prone), [reduced-threat glabrezu](3-Mechanics/CLI/bestiary/fiend/reduced-threat-glabrezu-tftyp.md) (see "Reduced-Threat Monsters" above) that is shackled and chained to the floor in four places. The undead attack interlopers, using pikes as weapons (`1d10` piercing damage). The undead have magic weapons (see "Treasure" below).
...
The skeletons' pikes are enchanted with [magic weapon](3-Mechanics/CLI/spells/magic-weapon-xphb.md) (+1) for 1 more hour. The wight wields a [+1 pike](3-Mechanics/CLI/items/1-weapon-xdmg.md).
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell cast on this area reveals that magic permeates the entire room, focused most strongly at the open mouth of each pit.
...
One Red Wizard [conjurer](3-Mechanics/CLI/bestiary/humanoid/conjurer-wizard-mpmm.md) oversees one [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) and one [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md). The conjurer knows the pass phrase for the maze of undoing (area 15) and might provide it to the characters in exchange for mercy, knowing that freed demons will attack their "rescuers."

##### Cells

Cells that confine demons hold the following creatures:

**Cell A**. One [hezrou](3-Mechanics/CLI/bestiary/fiend/hezrou-xmm.md)

**Cell B**. Eight [quasits](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md)

**Cell C**. Two [vrocks](3-Mechanics/CLI/bestiary/fiend/vrock-xmm.md)
...
When the characters arrive, a [glabrezu](3-Mechanics/CLI/bestiary/fiend/glabrezu-xmm.md) is trapped in the maze. The demon has learned how to navigate the maze, even though it can't escape the area. Place the demon on the ceiling above a random teleportation trigger point in the maze (roll a `d20`). Once the demon notices the characters, it moves toward characters it can see and in its rage and madness attacks any creatures it manages to reach.
...
Two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) are feeding the vermin scraps and pig excrement from buckets. Six [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) guard the apprentices. All the Thayans attack as soon as they notice intruders. Each round of combat, the Thayans direct one [giant spider](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) and one [giant centipede](3-Mechanics/CLI/bestiary/beast/giant-centipede-xmm.md) to join the fight.
...
Six [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) and eight [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) are resting here, watched over by a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md). Half the warriors and apprentices are asleep in the eastern side of the chamber. When the other creatures notice the characters, they attack. The sleeping Thayans awaken and join the fight over the course of 2 or 3 rounds.
...
Three [deathlock wights](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) oversee six [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md). They attack intruders.

##### Aura

A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals a transmutation aura on the whole area, which is a simple magical effect to control the pigs' odor.

##### Bridges

A series of unsteady plank bridges runs 10 feet above the floor, lashed to the pillars and to the slabs of rock that block the eastern stairs. Any creature that falls [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) while on a bridge has a 50 percent chance to fall into the pigpen.

##### Enchanted Pillars

A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that each pillar radiates an aura of enchantment magic. Any humanoid that touches a pillar must succeed on a DC 13 Wisdom saving throw or fall [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) for 1 minute. (The Thayans marked the pillars as a reminder for themselves.) A [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell suppresses the magic of the pillars for 1 minute.
...
One pig is much smaller than the others, and looks especially malnourished. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals that the creature radiates transmutation magic. The pig is in fact a lightfoot halfling named [Drevin](3-Mechanics/CLI/bestiary/npc/drevin-tftyp.md). He was a minstrel (use the [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) statistics) who ran afoul of a Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md). If freed of the [true polymorph](3-Mechanics/CLI/spells/true-polymorph-xphb.md) spell he is under, [Drevin](3-Mechanics/CLI/bestiary/npc/drevin-tftyp.md) accompanies the characters until he is permitted to escape the Doomvault, at which point he departs amid promises to write great ballads about the characters' exploits.
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals a faint aura of transmutation magic on the whole area, which is a simple magical effect to control the odor of the butchery.

##### Creatures

Twelve [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) are here, with a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) and a [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) overseeing them. Eight work to the east, stacking butchered pigs along the wall. To the west, four more work at a sluice that carries offal to the black gate, where it disappears (transported to area 41). Occasionally they toss some of the foul slop toward an [otyugh](3-Mechanics/CLI/bestiary/aberration/otyugh-xmm.md) chained to the floor.
...
A Red Wizard [enchanter](3-Mechanics/CLI/bestiary/humanoid/enchanter-wizard-mpmm.md), one [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md), and six [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) oversee the eggs. If combat breaks out, the wizard sends the undead forward as a screen and uses targeted spells that won't harm the eggs.
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals a transmutation aura on the whole area, which is a simple magical effect to control the odor of the hatchlings and their food.

##### Creatures

A Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) oversees two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) in caring for the imprisoned hatchlings, while four [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) stand guard. They attack intruders. In a desperate battle, the Red Wizard might take the time to release hatchlings to add to the characters' opposition.
...
**Cage A**. One [remorhaz](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-remorhaz-tftyp.md)

**Cage B**. Two [basilisks](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-basilisk-tftyp.md)

**Cage C**. Five [darkmantles](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-darkmantle-tftyp.md)

**Cage D**. Five [ettercaps](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-ettercap-tftyp.md)

**Cage E**. Two [carrion crawlers](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-carrion-crawler-tftyp.md)

**Cage F**. One [behir](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-behir-tftyp.md) (no Constrict or Swallow traits)

**Cage G**. Two [hook horrors](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-hook-horror-tftyp.md)

**Cage H**. One [wyvern](3-Mechanics/CLI/bestiary/dragon/reduced-threat-wyvern-tftyp.md)
...
Seven [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) and two [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) are focused on the doors to areas 22 and 24. Those who appear by way of the black gate can gain surprise if they attack immediately.
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell cast on this area reveals an aura of transmutation magic around each hole, hinting at the presence of a magical effect.
...
Twelve unarmed humanoid [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) wander the area, harvesting plant material in large baskets. As they tear off growths, a crackling sound accompanies an increase in the glow of a nearby pillar, and the harvested plant starts to rapidly regrow.

The skeletons ignore intruders unless they are attacked or damaged, in which case they all attack trespassers in the room.

Two [shambling mounds](3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md) hide in the groves, ignoring the skeletons. These creatures are trained to disregard anyone who remains within 15 feet of any doorway, where the baskets are stored on the shelves. They wait to ambush any non-undead creature that ventures any farther into the room.
...
Thuria, a Red Wizard [enchanter](3-Mechanics/CLI/bestiary/humanoid/enchanter-wizard-mpmm.md), lives here and oversees the Blood Pens. Two [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) and eight robed [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) guard him, and a [black dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/black-dragon-wyrmling-xmm.md) is his personal pet. When the characters first arrive, the dragon has just killed a commoner.
...
Thuria wears a gold circlet set with rubies (worth 1,000 gp) and a gold cuff (100 gp). He carries a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [fly](3-Mechanics/CLI/spells/fly-xphb.md) and a [potion of healing (greater](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md)).

One dread warrior has a [+1 longsword](3-Mechanics/CLI/items/1-weapon-xdmg.md), and each has a gold cuff that matches Thuria's.

In Thuria's "desk" are mundane records of important functions in the Blood Pens. Also within are [oil of etherealness](3-Mechanics/CLI/items/oil-of-etherealness-xdmg.md) and a [potion of poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md) disguised as a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md). A bundle of entwined branches opens like a coffer to reveal 100 pp and a diamond (worth 1,000 gp).
...
Divine Sense and [detect evil and good](3-Mechanics/CLI/spells/detect-evil-and-good-xphb.md) reveal that this zone is thoroughly desecrated.
...
When the characters first enter this area, the eight four-armed gargoyles are true statues. After a door other than a secret door is opened in this area, four [four-armed gargoyles](3-Mechanics/CLI/bestiary/elemental/four-armed-gargoyle-tftyp.md) (as normal [gargoyles](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) with 63 hit points and one extra claw attack, for a total of three attacks, with Multiattack) animate and attack. Another four-armed gargoyle animates whenever another such door is opened. This process continues for as long as any gargoyles remain in the alcoves. The gargoyles don't leave the room.
...
Shadows swirling around a pillar coalesce into a [wraith](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) after a door other than a secret door is opened in this area. Another wraith emerges from another pillar each round thereafter, until eight undead have appeared. The undead don't leave the room.
...
The vapor swirling around two of the pillars coalesces into a pair of [vampiric mists](3-Mechanics/CLI/bestiary/undead/vampiric-mist-mtf.md) after a door other than a secret door is opened in this area. Another vampiric mist appears whenever another such door is opened. This process continues until eight of the creatures have manifested.
...
Four [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) chained to the pillars are in an advanced state of entrancement. They can be treated as [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious). If they are slain, a gong sounds in the chamber, alerting the inhabitants of the cells.
...
Any commotion in the area, or the sounding of the gong, alerts those in the cells. The Red Wizard emerges 1 round later, and the [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) comes out during the following round. The residents of the other cells take `1d4 + 1` rounds to respond (roll separately for each).

The occupants of the cells are as follows:

**Cell A**. A Red Wizard [illusionist](3-Mechanics/CLI/bestiary/humanoid/illusionist-wizard-mpmm.md) dwells in this fine chamber with one [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md). The wizard is half asleep. Both have glyph keys attuned to the zone, as well as keys to the C cells. In combat, the apprentice uses an action to open the occupied C cell if able to do so without significant risk.

**Cell B**. Two [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) sleep in each of four small rooms. The B cells marked with an asterisk are empty.

**Cell C**. The doors to these two cells are locked. Four [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) are held in one of them when it's not their turn to be shackled to the silver pillars. The other C cell is empty.
...
[Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md), a Red Wizard [evoker](3-Mechanics/CLI/bestiary/humanoid/evoker-wizard-mpmm.md), directs the brutal combat training here. Six [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) engage a [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) and seven [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md). [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) orders the whole lot to attack intruders. Because they have been engaged in combat, each creature aside from [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) starts with current hit points equal to half its hit point maximum.

[Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) initially stays back in combat, using lower-level spells and trying to assess the characters' motivations. His allegiance to Szass Tam has been flagging. He leans toward supporting the Thayan rebels, but he has not formally joined their ranks. He worries that some of his peers who are loyal to Szass Tam might suspect him.

Aware of Szass Tam's cunning, [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) first assumes the characters are testing his allegiance. Around the second round of combat, or if reduced to half his hit points or fewer, [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) directly asks the characters their purpose and admits a willingness to join the rebels. The characters can sway him with convincing talk and proof that they have overcome other parts of the dungeon. If the characters earn his trust, [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) turns against Szass Tam, having become convinced that the regent's plots will be the undoing of Thay.

He then turns on the Thayans here, whom he knows won't stand down, and helps the characters fight. Afterward, [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) provides two pieces of lore and the attunements on his glyph key, as well as his physical keys. He goes to the gatehouse through the black gate in area 29.

##### Treasure

Among the weapons here are a [+1 battleaxe](3-Mechanics/CLI/items/1-weapon-xdmg.md), a [+1 greatsword](3-Mechanics/CLI/items/1-weapon-xdmg.md), and a [+1 shortbow](3-Mechanics/CLI/items/1-weapon-xdmg.md). A heavily scarred suit of plate armor here is [armor of vulnerability](3-Mechanics/CLI/items/armor-of-vulnerability-xdmg.md) (your choice of type). In addition, [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) wears a [ring of protection](3-Mechanics/CLI/items/ring-of-protection-xdmg.md).

##### Keys

[Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) carries a glyph key attuned to this zone, the Hall of Necromancy, and the Temples of Despair. He also carries a key that safely opens all the doors in the Temples of Despair, as well as a key to open the C cells in area 29.

##### Development

If [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) joins the rebels, he provides information that decreases the Doomvault's alert level by 1.
...
If [Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) and Kelson are here (see "Creatures" below), anyone who listens at the doors can hear screaming coming from the other side.
...
[Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md), a Red Wizard [necromancer](3-Mechanics/CLI/bestiary/humanoid/necromancer-wizard-mpmm.md), is drawing the soul from [Kelson Darktreader](3-Mechanics/CLI/bestiary/npc/kelson-darktreader-tftyp.md), a male half-elf lying on a stone table farthest from the door the characters use to enter. Kelson is [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) and stable at 0 hit points. [Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md)'s magic is drawing forth from his body a wispy shape that resembles him, and this shape screams in an echoing voice. Strands of energy flow from the shape into the table and from there into other forms in the room.

A [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) on a nearby table is a Red Wizard in the process of being raised as undead. Also nearby, two [wights](3-Mechanics/CLI/bestiary/undead/reduced-threat-wight-tftyp.md) (see "Reduced-Threat Monsters" above) are being raised as warrior undead. These wights are only partially animated, so they respond only to [Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) when she orders an attack. One of them tries to throw an urn at a character each round (`+4` to hit, range 10 feet/20 feet; one creature). A hit deals 3 (`1d6`) bludgeoning damage, and the target must make saving throws as noted in the "Urns" section. [Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) stays for a round or two to assess the party's capabilities and then moves to area 32 or uses the black gate in the room.

As a faithful servant of Szass Tam, [Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) follows the lich lord's philosophy that no magic is too dangerous and no experiment too dark if it promises power. Lawful evil, [Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) is as opportunistic as she is wicked.
...
If she is allowed to do so, [Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) flees the Doomvault.

##### Aura

A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of necromancy on the whole area, signifying the magic that helps in the creation of undead. Divine Sense and [detect evil and good](3-Mechanics/CLI/spells/detect-evil-and-good-xphb.md) reveal that this area is desecrated.

##### Stone Tables

These 3-foot-high carved slabs channel the energy of life and undeath. They aid in rituals and spells to create undead.

With the proper knowledge, a creature can use the stone tables to transform a soul-bound character back into a normal creature. Doing so requires the aid of a Red Wizard or explicit written instruction, such as the scroll in [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md)'s room in area 32. The ritual takes 20 minutes and requires a spellcaster to make a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check. The spellcaster must also expend a 3rd-level spell slot. On a successful check, the soul-bound creature returns to normal with all of its Hit Dice expended. On a failed check, the spell slot is expended but the creature remains soul bound.
...
Despite his ordeal, [Kelson Darktreader](3-Mechanics/CLI/bestiary/npc/kelson-darktreader-tftyp.md) can be restored to health through normal means, although he is in no condition to help. He thanks the characters for saving him and offers two pieces of lore. He asks for a glyph key and goes to the gatehouse to recuperate.

##### Treasure

[Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) carries a [+1 dagger](3-Mechanics/CLI/items/1-weapon-xdmg.md), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [darkvision](3-Mechanics/CLI/spells/darkvision-xphb.md), and a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md).

##### Glyph Key

[Phaia](3-Mechanics/CLI/bestiary/npc/phaia-tftyp.md) has a glyph key attuned to this zone and the Temples of Oppression (in the Temples of Extraction sector).
...
Three [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) kneel on the lower tier of the monument. The Thayans attack intruders.
...
**Cell A**. [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) (see area 30) uses these quarters, which contain a fine bed, a footlocker, and a desk. Searching the area uncovers one written piece of lore, as well as a [tome of the stilled tongue](3-Mechanics/CLI/items/tome-of-the-stilled-tongue-xdmg.md) and six [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) (two each of [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [identify](3-Mechanics/CLI/spells/identify-xphb.md), and [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md)). [Lahnis](3-Mechanics/CLI/bestiary/npc/lahnis-tftyp.md) also has a scroll describing the ritual used to turn soul-bound undead back into non-undead creatures in area 31.

**Cell B**. One Red Wizard [evoker](3-Mechanics/CLI/bestiary/humanoid/evoker-wizard-mpmm.md) sleeps here.

**Cell C**. One [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) sleeps here.
...
One [Thayan warrior](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md), five [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md), and five [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) attack intruders on sight.

##### Glyph Key

The [Thayan warrior](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) has a glyph key attuned to this zone.
...
Resting in this chamber are a [Thayan warrior](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) and a Dread Legion squad made up of five [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) and five [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md). A [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) is on post here to keep the other legionnaires in line.
...
The [Thayan warrior](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) has a glyph key attuned to every zone in this sector. The troll has a glyph key attuned to this zone.
...
One [reduced-threat aboleth](3-Mechanics/CLI/bestiary/aberration/reduced-threat-aboleth-tftyp.md) (see "Reduced-Threat Monsters" above) dwells deep in the pool. Within this room, the aboleth can use the water globes (see "Water Globes" below) to move around.
...
The shimmering light here has affected two [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md), two [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md), and six [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md). They attack if the trap's effect on them ends.
...
A [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell suppresses the light's effect for 10 minutes. Any spell that overwhelms or blocks the light also suppresses it in the spell's area for the duration of the spell.
...
[Thaxalia](3-Mechanics/CLI/bestiary/aberration/reduced-threat-beholder-tftyp.md), a beholder, has been summoned and imprisoned here.
...
Eight [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) and two [ogre zombies](3-Mechanics/CLI/bestiary/undead/ogre-zombie-xmm.md) attack any intruders. Any combat warns [Thaxalia](3-Mechanics/CLI/bestiary/aberration/reduced-threat-beholder-tftyp.md) (area 39) of the approach of intruders.
...
[Thaxalia](3-Mechanics/CLI/bestiary/aberration/reduced-threat-beholder-tftyp.md), a reduced-threat [beholder](3-Mechanics/CLI/bestiary/aberration/beholder-xmm.md) (see "Reduced-Threat Monsters" above) crippled by Thayan magic, floats near the ceiling, trying to remain unnoticed while intruders enter. Thaxalia's central eye and two of its eyestalks have been maimed by the Red Wizards, rendering those eye rays (death ray and disintegration) powerless. If it has warning or is reduced to 50 hit points or fewer, it withdraws to area 40, leaving its spawn to deal with the threat.
...
Fearing Thaxalia's ability to wreak havoc if it escapes this zone, the Red Wizards cursed the beholder with the inability to use glyph keys. Thaxalia doesn't know the solution, but a [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) spell can eliminate the prohibition. The beholder then takes a glyph key from the wight in area 40 and asks the characters to provide it with more attunements. If refused, it becomes hostile and uses its powers to compel the characters to give it more attunements.
...
If [Thaxalia](3-Mechanics/CLI/bestiary/aberration/reduced-threat-beholder-tftyp.md) left area 39, the beholder is in this location. It has been picking off Thayan patrols here. Amid the slime are five bodies: two of wights and three of Thayan warriors.
...
Viewed with [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), the area has an aura of necromancy. When non-undead creatures regain hit points in this zone, they regain only half as many.
...
Twenty unarmed [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) stand here, waiting to cart refuse that arrives from other areas through the black gate. They attack only if attacked.
...
Four [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) climb and wander on the top two steps, while two [gibbering mouthers](3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) lurk on the third. One [grell](3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) starts out flying above area 45. Six prisoners hide among the ledges, trying to avoid the aberrant monsters.
...
The top of the altar slab shows the shadowy outlines of a dozen weapons, pendants, and other objects. An [identify](3-Mechanics/CLI/spells/identify-xphb.md) spell reveals that the altar imparts additional power into magic items placed on its surface. The caster must succeed on a DC 20 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check to further discern that when an item is empowered, the altar also draws in the life force of creatures near it.
...
When a magic item is transformed, randomly select one character within 50 feet of the altar. That person's soul is drawn into the item, and he or she drops into a deathlike coma, requiring a successful DC 15 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check to realize that the victim is still alive. An [identify](3-Mechanics/CLI/spells/identify-xphb.md) spell can be used to discern the whereabouts of the soul and how to cure the condition, temporarily or permanently.

Placing the transformed magic item in the victim's hand temporarily ends the coma. Thereafter, the character must continue to hold the object in hand or fall into a coma again. If the character breaks contact with the object for 1 hour, or if the object is destroyed, the character dies. [Remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md), [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md), or equivalent magic breaks the bond, returning the soul to its rightful place.
...
Eight [cockatrices](3-Mechanics/CLI/bestiary/monstrosity/cockatrice-xmm.md) roost on the ledges. They make no attempt to hide, and they attack as soon as they realize the characters have no food for them.
...
Two adult [gorgons](3-Mechanics/CLI/bestiary/construct/gorgon-xmm.md) attack intruders on sight, pursuing those who flee into area 46. Any hook horrors there attack only if the intruders slay or drive off the gorgons.
...
A [helmed horror](3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md) and a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) guard this area. The wight has orders to confront anyone who comes through the gate without pig carcasses or other items to feed to the zone's monsters. If such interlopers can't provide credible reasons for their presence, the wight orders the helmed horror to attack.
...
The pool's magic grants non-undead creatures that drink from it the benefits of finishing a short rest. A creature can drink from the pool safely only once per tenday. The second time the creature drinks in a tenday, its hit point maximum is halved for one tenday ([remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) negates this effect). The third time the creature drinks in a tenday, it suffers the effects of a [harm](3-Mechanics/CLI/spells/harm-xphb.md) spell (save DC 15).
...
Two adult [displacer beasts](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) dwell here with three [reduced-threat displacer beasts](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-displacer-beast-tftyp.md) (see "Reduced-Threat Monsters" above). Each creature sits atop a different bone mound, and they all attack when it becomes clear that the characters have not brought food.
...
The four adult [perytons](3-Mechanics/CLI/bestiary/monstrosity/peryton-xmm.md) and four [reduced-threat perytons](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-peryton-tftyp.md) (see "Reduced-Threat Monsters" above) that roost here have grown tired of their pork diet. If the characters don't appear to be Thayans, or if they fail to offer food within a few moments, the perytons attack.
...
A [behir](3-Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) spends its days sleeping and eating in this chamber. The creature is asleep or otherwise preoccupied when the characters come here. It doesn't attack unless provoked.
...
The pool's magic grants creatures that drink from it the benefits of a [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md) or a [lesser restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spell (creature's choice). A creature can drink from the pool safely only once per tenday. The second time the creature drinks in a tenday, its hit point maximum is halved for one tenday ([remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) negates this effect). The third time the creature drinks in a tenday, it suffers the effects of a [harm](3-Mechanics/CLI/spells/harm-xphb.md) spell (save DC 15).
...
Six [chokers](3-Mechanics/CLI/bestiary/aberration/choker-mtf.md) live here, two lurking in each of the two treed areas near the pool and two on the walls near the pool. They wait and watch, attacking when the characters move within reach, which their handlers rarely do. The chokers in the trees try to pull victims into the treed areas.
...
Two adult [owlbears](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md) and three [reduced-threat owlbear](3-Mechanics/CLI/bestiary/monstrosity/reduced-threat-owlbear-tftyp.md) young (see "Reduced-Threat Monsters" above) lurk among the trees here. They wait long enough to see if food is being handed out, and they attack if none seems forthcoming. The young are hidden, and they join the fight from the flanks after their parents attack.
...
Three [sentient ochre jellies](3-Mechanics/CLI/bestiary/ooze/sentient-ochre-jelly-tftyp.md) and a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) guard this area. The wight confronts anyone who enters but stands down if the characters look like Thayans and give a credible reason for being here. Otherwise, the creatures attack.
...
Two [deathlock wights](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) with buckets and stone boots move among dozens of skeletons. They pour steaming ooze over the bones. Two [sentient ochre jellies](3-Mechanics/CLI/bestiary/ooze/sentient-ochre-jelly-tftyp.md) and two [sentient gray oozes](3-Mechanics/CLI/bestiary/ooze/sentient-gray-ooze-tftyp.md) are pooled near the benches.
...
Two [deathlock wights](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) and four [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) move among the vats, using *ooze prods* to poke the mixtures. They challenge any intruders. If the undead become distracted, oozes might attack (see "Vat System" below).
...
| dice: d6 | Ooze |
|----------|------|
| 1–2 | [Black pudding](3-Mechanics/CLI/bestiary/ooze/reduced-threat-black-pudding-tftyp.md) |
| 3 | [Gray ooze](3-Mechanics/CLI/bestiary/ooze/reduced-threat-gray-ooze-tftyp.md) |
| 4–6 | [Ochre jelly](3-Mechanics/CLI/bestiary/ooze/reduced-threat-ochre-jelly-tftyp.md) |
^ooze
...
Sarkalla's table and shelves contain two pieces of lore, four [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) (two each of [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) and [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md)), a [potion of greater healing](3-Mechanics/CLI/items/potion-of-greater-healing-xdmg.md), a [potion of heroism](3-Mechanics/CLI/items/potion-of-heroism-xdmg.md), and six valuable tomes on underground exploration and natural history (worth 120 gp each).
...
The cavern is occupied by [White Maw](3-Mechanics/CLI/bestiary/npc/white-maw-tftyp.md), a gray ooze so enormous that it covers the entire floor and much of the walls. Unlike the other sentient oozes, this one is quite intelligent (Intelligence 12) and has the ability to communicate telepathically to creatures within 50 feet of it.

As soon as the last character enters, solid white "stone" closes over each exit as [White Maw](3-Mechanics/CLI/bestiary/npc/white-maw-tftyp.md) seals the characters within itself. The ooze is insane and displays multiple personalities of the creatures that were sacrificed to imbue it with sentience. Although it might communicate briefly with the characters, eventually madness takes hold and it attacks, slamming the characters with pseudopods that manifest from the floor or walls. The characters attack it by targeting the floor or walls of the cavern.

When [White Maw](3-Mechanics/CLI/bestiary/npc/white-maw-tftyp.md) drops to 0 hit points, cracks shoot through the smooth white stone, which collapses to white dust, exposing the exits and dropping the characters 1 foot to the actual floor of dark stone.
...
A Red Wizard known only as the [Ooze Master](3-Mechanics/CLI/bestiary/undead/ooze-master-tftyp.md) has melded with the pillar of red ooze. He uses his powers to make sure the red pillar consumes those who come here.

The Ooze Master is the result of a failed experiment to blend a Red Wizard with ooze. When the characters arrive, the Ooze Master assumes they are [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) come to join him "in immortality." He greets them and honors their "great sacrifice." The Ooze Master knows if [White Maw](3-Mechanics/CLI/bestiary/npc/white-maw-tftyp.md) has been killed (though not who did it), and vows to use the characters' power, once it is consumed, to seek out and punish those responsible. He also speaks of "the great transformation," when all Red Wizards will be joined with oozes.
...
The [Ooze Master](3-Mechanics/CLI/bestiary/undead/ooze-master-tftyp.md) is a sort of lich. If destroyed, he remains in the red pillar but doesn't regain consciousness. His [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) form whispers as if dreaming. The Ooze Master dies only if the Phylactery Vault is disabled at the end of the adventure.
...
An [elder black pudding](3-Mechanics/CLI/bestiary/ooze/elder-black-pudding-tftyp.md) (Huge size; 130 hit points) lurks on the ceiling here, reflected in the pool. Unless a character looks up and sees the ooze, it quickly slides down the pillar and attacks with surprise.
...
One Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) oversees two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) and six [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) here. Four skeletons drag pig carcasses toward the arch and heave them through, while blades scythe across the opening and reduce each body to a heap of blood, flesh, and bone that collects on the far side. Two skeletons then pick up shovels and collect the gore in buckets, making the flesh easier to transport.
...
One Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) oversees two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) in this cavern. They walk a circuit around the pools, carefully jabbing down into them with the *ooze prods* they carry.
...
One Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) and two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) are focused on the black pool with their *ooze prods*. When the Thayans turn away to deal with the characters, a Medium [reduced-threat black pudding](3-Mechanics/CLI/bestiary/ooze/reduced-threat-black-pudding-tftyp.md) (see "Reduced-Threat Monsters" above) emerges from the ooze pool at the start of the second round. Another such pudding emerges at the start of the fourth round, and another at the start of the sixth round. The Thayans try to keep the characters between themselves and the pool, since the oozes see all other creatures as prey.

##### Ooze Pool

Filled with [reduced-threat black puddings](3-Mechanics/CLI/bestiary/ooze/reduced-threat-black-pudding-tftyp.md), the pool is 2 feet deep and difficult terrain. Transmutation magic on the pool keeps most of the puddings in a torpid state so that they react only to stimulation from a nearby source. A creature that enters the pool for the first time on a turn, or starts its turn there, takes 13 (`3d8`) acid damage. In addition, every time a creature moves 5 feet in the pool, the creature is subject to an opportunity attack from a black pudding.
...
One Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) and two [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) watch from near the eastern wall as four [Thayan warriors](3-Mechanics/CLI/bestiary/humanoid/thayan-warrior-tftyp.md) battle a [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md). Two of the four warriors have been engulfed, and all are at half hit points (as is the ooze). If the wizard notices the characters aren't Thayan, he orders the others to attack them instead. The cube views everyone in the area as a foe.
...
One Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) and two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) use *ooze prods* to keep three Medium [ochre jellies](3-Mechanics/CLI/bestiary/ooze/reduced-threat-ochre-jelly-tftyp.md) (see "Reduced-Threat Monsters" above) in the pit and fighting. When the Thayans start combat with the characters, each of the three oozes emerges from the pit `1d4` rounds later (roll for each). The oozes see all other creatures as prey.

##### Jelly Pit

Filled with young, [reduced-threat ochre jellies](3-Mechanics/CLI/bestiary/ooze/reduced-threat-ochre-jelly-tftyp.md), living and dead, the pit is 3 feet deep and difficult terrain. Transmutation magic on the pit keeps most of the jellies in a torpid state so they react only to stimulation from a nearby source. A creature that enters the pool for the first time on a turn, or starts its turn there, takes 9 (`2d8`) acid damage. In addition, every time a creature moves 5 feet in the pit, the creature is subject to an opportunity attack from an ochre jelly.
...
A [malformed kraken](3-Mechanics/CLI/bestiary/monstrosity/malformed-kraken-tftyp.md) is held in this saltwater pool. Although it responds to specific orders from Red Wizards, it attacks anyone in the room who looks over the edge of the pool.
...
One [reduced-threat dragon turtle](3-Mechanics/CLI/bestiary/dragon/reduced-threat-dragon-turtle-tftyp.md) (see "Reduced-Threat Monsters" above)—it has no tail attack—recently taken from Lake Thaylambar, has been chained here while the insidious mind control magic of the pools takes effect. Not yet under the sway of Thay, it grows agitated when any creature enters this chamber, and it's likely to attack.
...
Ihanvas, the [spirit naga](3-Mechanics/CLI/bestiary/fiend/spirit-naga-xmm.md) overseer of this zone, is eating a prisoner. The naga attacks any intruders. Ten [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) also linger in the pools here. Ihanvas's Charisma, combined with the magic water, has turned them into the naga's willing devotees. They defend their master in any battle.
...
Hidden at the bottom of the pools' connecting tunnel, Ihanvas's treasure includes 200 pp, five tourmaline jewels (100 gp each), [+1 plate](3-Mechanics/CLI/items/1-armor-xdmg.md) and a sealed ivory case that holds seven [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) (two each of [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [identify](3-Mechanics/CLI/spells/identify-xphb.md), and [lesser restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md), and one of [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md)).
...
Two [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md), a male and a larger female, lurk in the pool. These trolls are of an aquatic variety known as [scrags](3-Mechanics/CLI/bestiary/giant/scrag-tftyp.md). In addition to the statistics of a normal troll, each has a swim speed of 30 feet and can breathe underwater.
...
Four [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) entertain themselves by decorating their lair and chewing bones.
...
Blue glowing water in this zone is spawning essence, the transmutation magic of which causes spawn to grow quickly and strengthens their predatory nature. A creature that drinks spawning essence gains the benefit of finishing a short rest. A humanoid can safely gain this benefit only once per tenday. If a creature drinks again within that time, it gains no benefit and must succeed on a DC 15 Wisdom saving throw or suffer the effects of a [confusion](3-Mechanics/CLI/spells/confusion-xphb.md) spell for 1 minute. The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a successful save.
...
Five [kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) are on guard. Another four are sleeping on the bottom of the pool. All of them are loyal to Thay and expect to be asked to escort those who pass through this area. They attack anyone who makes no such request.
...
A [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md), two [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md), and four [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) guard this area. They attack anyone who isn't escorted by kuo-toa or the sea hag, pursuing such interlopers to any area of the zone.
...
Two male [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) dwell in the south pool. A [sea hag](3-Mechanics/CLI/bestiary/fey/sea-hag-xmm.md) named Tanjus luxuriates under the surface of the north pool with her pets, six [giant crabs](3-Mechanics/CLI/bestiary/beast/giant-crab-xmm.md). She oversees the spawning pools in this zone and yearns to overthrow Ihanvas (area 76) for control of the Predator Pools and their monsters.
...
Tanjus has a black pearl (500 gp), a golden gorget set with aquamarines (1,000 gp), and a [staff of charming](3-Mechanics/CLI/items/staff-of-charming-xdmg.md).

A character who succeeds on a DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check while searching the debris discovers five [potions of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md) and two [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [water walk](3-Mechanics/CLI/spells/water-walk-xphb.md).
...
Six [sahuagin](3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) swim along the surface around the edge of the pool, while a [sahuagin baron](3-Mechanics/CLI/bestiary/fiend/sahuagin-baron-xmm.md) and two [hunter sharks](3-Mechanics/CLI/bestiary/beast/hunter-shark-xmm.md) swim deeper down.
...
The baron wears [+1 leather armor](3-Mechanics/CLI/items/1-armor-xdmg.md) (shark skin and chitin) and a crown-like helm of ivory, coral, leather, and gold (worth 500 gp).

At the bottom of the pool is a stone coffer that contains a stash of 100 pp and eight large pearls (100 gp). It also has a crystal phial that contains a [potion of diminution](3-Mechanics/CLI/items/potion-of-diminution-xdmg.md).
...
Four [sahuagin](3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) stand and chant along with a [sahuagin priestess](3-Mechanics/CLI/bestiary/fiend/sahuagin-priest-xmm.md) on the altar pillar. Another five sahuagin and two [hunter sharks](3-Mechanics/CLI/bestiary/beast/hunter-shark-xmm.md) dwell in the pool. A [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) is bound on the altar.

The chanting that precedes the sacrifice takes 3 rounds to complete. If the characters deal at least 20 damage to the priestess in that time, she breaks off the ritual to lead a counterattack. Otherwise, the prisoner is slain and thrown to the sharks. Any sahuagin on the altar then gains the effects of the [aid](3-Mechanics/CLI/spells/aid-xphb.md) and [bless](3-Mechanics/CLI/spells/bless-xphb.md) spells.
...
The priestess carries a [dagger of venom](3-Mechanics/CLI/items/dagger-of-venom-xdmg.md) and wears a headdress of ivory, coral, leather, and gold (worth 500 gp).
...
A [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) keeps watch with seven [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md). They do little but confront creatures moving toward or appearing from either magic gate. The characters can enter and leave this area from the east without fighting, even with the prisoners in tow.

Part of the deal the Red Wizards struck with the sahuagin involves providing prisoners for dark rites and horrid meals. The magic of the black shrine keeps ten [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) standing around it in a catatonic state.
...
Two [reduced-threat helmed horrors](3-Mechanics/CLI/bestiary/construct/reduced-threat-helmed-horror-tftyp.md) and a [reduced-threat flesh golem](3-Mechanics/CLI/bestiary/construct/reduced-threat-flesh-golem-tftyp.md) (see "Reduced-Threat Monsters" above) stand inactive here in front of pillars. The golem hopes to draw on the pillars' lightning effect to become fully empowered. They come to life if attacked or when the teleportation magic of the pillars is triggered.
...
A Red Wizard [necromancer](3-Mechanics/CLI/bestiary/humanoid/necromancer-wizard-mpmm.md) and two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) are in this area, moving among the tables working or selecting parts. Four [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) keep watch from the corners, while a [ghoul](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) mops gore from the floors. Golems in this area can't be activated and are no threat.
...
A [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) commands eight [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) who guard this chamber while some members of their squad recover in the cages. One [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) and two wights rest in the cages.
...
If the 800-pound stone block holding these doors open is removed, they magically slam shut. It takes a successful DC 25 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to force the doors open. A [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell disrupts the magic briefly, lowering the check DC to 15 for 1 minute.
...
A Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) works here with a dwarf cleric of Grumbar, a deity associated with caverns and earth. The dwarf assists in the creation of clay golems, which require divine spellcasting. The dwarf [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md), whose name is [Gorvan Ironheart](3-Mechanics/CLI/bestiary/npc/gorvan-ironheart-tftyp.md), was recruited by the Red Wizards and offered a substantial sum of money for assistance in crafting the golems. If he is questioned, he lies, claiming to be a prisoner of the Red Wizards. If the characters spare him, he accompanies the party until he sees an opportunity to escape.

Also present is a [reduced-threat clay golem](3-Mechanics/CLI/bestiary/construct/reduced-threat-clay-golem-tftyp.md) (see "Reduced-Threat Monsters" above). The wizard or the cleric can activate the golem by using an action and succeeding on a DC 15 Intelligence check.
...
In the entryways, arcane glyphs on the wall can be used to control the pillars. When someone touches the glyphs, the pillars flicker. It takes a successful DC 10 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check to understand exactly how the glyphs function. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell shows that the abjuration aura of the glyphs is connected to the evocation magic of the pillars, thereby revealing the function of the glyphs without a check.
...
A [clay golem](3-Mechanics/CLI/bestiary/construct/clay-golem-xmm.md) in this area activates the first time a character fails a saving throw against the pillars, deactivates them, or subdues them.
...
| 6 | Charisma | Gain the Stench trait of a [troglodyte](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) |
^skull-ability-secondary-effect
...
When any non-undead creature enters this area (which the Thayans avoid), a [four-armed gargoyle](3-Mechanics/CLI/bestiary/elemental/four-armed-gargoyle-tftyp.md) (as a normal [gargoyle](3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) with 63 hit points and one extra claw attack, for a total of three attacks, with Multiattack) emerges from a random pillar and attacks. At the start of each round thereafter, another random pillar transforms until all six gargoyles have emerged.
...
Anyone who succeeds on a DC 15 Intelligence ([Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check recognizes the statue as that of a [deva](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md).

The last gargoyle to appear uses its initial action to touch the statue, which ends the curse that holds the creature in stasis. This deva's name is [Lumalia](3-Mechanics/CLI/bestiary/npc/lumalia-tftyp.md). After she is freed, the walls shed bright light instead of dim. The deva shrieks, unable to act until her turn, at which point she attacks the nearest creatures. (The gargoyles avoid her.)
...
[Lumalia](3-Mechanics/CLI/bestiary/npc/lumalia-tftyp.md) decides that her first task will be to inflict justice upon the Thayans. She is immortal, but her anger and regret over the time she has lost during her imprisonment seems very humanlike. In the thick of combat, she can become lost in her thirst for vengeance on the current owners of the Doomvault. [Lumalia](3-Mechanics/CLI/bestiary/npc/lumalia-tftyp.md) was lawful good when she was imprisoned, but she is now chaotic good.

##### Dungeon State

The magic of the Doomvault resonates within [Lumalia](3-Mechanics/CLI/bestiary/npc/lumalia-tftyp.md). She needs no glyph key to move through the magic gates in the dungeon, although she can't take others with her. If she is freed, her resonance creates feedback in the gate system, making it harder to find intruders in the dungeon, and the Doomvault's alert level decreases by 1.
...
One [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) operates the pulley system to haul stone out of the pit while a second giant cuts stone away from the pit walls. Both are occupied with their noisy work.
...
A Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) and two [Thayan apprentices](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) are distracted by their work here shaping a [reduced-threat stone golem](3-Mechanics/CLI/bestiary/construct/reduced-threat-stone-golem-tftyp.md) (see "Reduced-Threat Monsters" above), but they do notice if anyone is hurled into the room. These apprentices are armed with light hammers instead of daggers. The wizard can activate the golem by succeeding on a DC 15 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check made as an action.
...
An [efreeti](3-Mechanics/CLI/bestiary/elemental/efreeti-xmm.md) is bound to the smoke at the center of the room. It can't leave this area or use its powers against anyone outside the room.

##### Binding Smoke

The smoke tendrils form chains that have no solidity, but their abjuration magic holds the efreeti in this area. While it is bound in this smoke, the creature is susceptible to the [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md) spell and has disadvantage on the saving throw. If it isn't [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed), the efreeti orders anyone present to grant it freedom and attacks if its demand isn't met.

The efreeti has no means to break the binding smoke. It knows, however, that the feat can be accomplished with spells, such as [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) (save DC 17), [gust of wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md), [knock](3-Mechanics/CLI/spells/knock-xphb.md), or any spell that can push the efreeti out of the area of the pool. The smoke dissipates if the efreeti is slain.
...
Two unbroken funeral urns stand in each corner. Glyphs in the Primordial language on the urns suggest that they are binding vessels for efreet, and [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) reveals that they have an aura of abjuration. The wax-seal stopper of an urn is broken easily, and an urn can be broken like any clay vessel of the sort. When an urn is opened or broken, the act releases a gas that causes any creature within 10 feet of the urn to gain resistance to fire damage for 1 hour. Each urn is 1 foot tall and weighs 5 pounds.
...
A Red Wizard [necromancer](3-Mechanics/CLI/bestiary/humanoid/necromancer-wizard-mpmm.md) works here, guarded by a [helmed horror](3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md). They are immune to the Dark Mist, and the Red Wizard has the Venomous Touch trait (see below).
...
The Chosen of Zehir is a male [yuan-ti malison (type 3)](3-Mechanics/CLI/bestiary/monstrosity/yuan-ti-malison-type-3-xmm.md) named [Oussa](3-Mechanics/CLI/bestiary/npc/oussa-tftyp.md). Zehir is the serpentine god of poison, darkness, and murder. He is worshiped primarily by yuan-ti. If [Oussa](3-Mechanics/CLI/bestiary/npc/oussa-tftyp.md) is rescued and then realizes that the characters aren't Zehir's faithful sent to help him, he uses his unholy power to instantly assume snake form and attacks the party.
...
A Red Wizard [enchanter](3-Mechanics/CLI/bestiary/humanoid/enchanter-wizard-mpmm.md) and a [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) work here, guarded by two [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md).

The Red Wizard here is [Mennek Ariz](3-Mechanics/CLI/bestiary/npc/mennek-ariz-tftyp.md), the rebel wizard who helped assault the Bloodgate. He was captured during the assault and brainwashed. A character who succeeds on a DC 15 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check can discern that he isn't acting of his own volition. Only magic, such as [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) or [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md), can break the effect. If he is freed of the brainwashing, Mennek can reveal two pieces of lore.
...
The Chosen of Ilmater is a lawful good male human named [Kieren](3-Mechanics/CLI/bestiary/npc/kieren-tftyp.md). Ilmater, also known as the Crying God, is the god of suffering, martyrdom, and perseverance. He offers succor and calming words to those who are in pain, oppressed, or in great need.

##### Treasure

Mennek carries a [wand of binding](3-Mechanics/CLI/items/wand-of-binding-xdmg.md).
...
A [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) keeps watch here. One [wraith](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) and four [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) circle around the shrine, streaks of crimson trailing from their spectral forms.
...
A Red Wizard [transmuter](3-Mechanics/CLI/bestiary/humanoid/transmuter-wizard-mpmm.md) works here, with a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) leading two [sentient gray oozes](3-Mechanics/CLI/bestiary/ooze/sentient-gray-ooze-tftyp.md) and two [sentient ochre jellies](3-Mechanics/CLI/bestiary/ooze/sentient-ochre-jelly-tftyp.md) to guard her. Sentient oozes are the same as normal versions of such monsters, except that they have Intelligence 5, can understand basic communication in Common, and are no longer immune to being [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed). Myrra, the Red Wizard, is especially cruel and likely to toy with the characters even when she is losing.
...
The Chosen of Ghaunadaur is a sickly and chaotic evil male drow named [Therzt](3-Mechanics/CLI/bestiary/npc/therzt-tftyp.md). Ghaunadaur is a strange god worshiped primarily by male drow that seek power outside the confines of a society dominated by females. Ghaunadaur is a malignant and unknowable deity that desires living sacrifice and destruction due to monstrous causes, particularly oozes.

If he is freed, [Therzt](3-Mechanics/CLI/bestiary/npc/therzt-tftyp.md) babbles about the weakness he demonstrated in being captured and declares that he must die. As an action, [Therzt](3-Mechanics/CLI/bestiary/npc/therzt-tftyp.md) casts [Melf's acid arrow](3-Mechanics/CLI/spells/melfs-acid-arrow-xphb.md) on himself while screaming his devotion to Ghaunadaur. The acid consumes him utterly as unholy energy pulses out to touch the walls, producing two [gray oozes](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) at the center point of each wall. The oozes treat all creatures remaining here as prey.
...
Six [shadows](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) lurk here.
...
The Chosen of Ibrandul is a chaotic evil female drow named [Ashdra](3-Mechanics/CLI/bestiary/npc/ashdra-tftyp.md). Ibrandul is a god of darkness and underground places once primarily worshiped by humans in southern lands such as Calimshan. He was worshiped as a comforter and protector of those who travel and work in darkness.
...
A Red Wizard [evoker](3-Mechanics/CLI/bestiary/humanoid/evoker-wizard-mpmm.md) has command over two [dread warriors](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) here. A [shadow](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) lurks at each pillar on the shrine of binding, for a total of four.
...
This shrine contains a Chosen of Bhaal named [Torlin Silvershield](3-Mechanics/CLI/bestiary/npc/torlin-silvershield-tftyp.md), who was formerly a duke of Baldur's Gate. He has become a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md). The creature hisses an oath to Bhaal and attacks characters who free it.
...
A Red Wizard [necromancer](3-Mechanics/CLI/bestiary/humanoid/necromancer-wizard-mpmm.md) and a [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md) work here, guarded by a [dread warrior](3-Mechanics/CLI/bestiary/undead/dread-warrior-tftyp.md) and four [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md). Thutai, the Red Wizard, is the overseer of this sector. He cares little for his underlings, including them in area effects if it means harming more characters. If the fight goes badly, he uses the black gate to flee.
...
The Chosen of Yurtrus is a neutral evil male orc named [Bandagh](3-Mechanics/CLI/bestiary/npc/bandagh-tftyp.md). Yurtrus is the orc deity of disease, decay, rot, and death. Orcs fear Yurtrus, and his priests have protected status in the tribe even though they are often weak or infirm in some way. [Bandagh](3-Mechanics/CLI/bestiary/npc/bandagh-tftyp.md) is pockmarked from years of disease, and is in no condition to pick a fight if he is freed.

##### Treasure

Thutai wears [bracers of defense](3-Mechanics/CLI/items/bracers-of-defense-xdmg.md) and has [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) and [speak with dead](3-Mechanics/CLI/spells/speak-with-dead-xphb.md).
...
A [wraith](3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) and three [will-o'-wisps](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) guard this chamber. The wisps start out [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible).
...
A neutral good female wood elf [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) named [Eira](3-Mechanics/CLI/bestiary/npc/eira-tftyp.md) is the Chosen of Rillifane Rallathil, the elven god of the woodlands and of the harmony of nature. He is seen as a calm and steady deity, quite unlike his more mercurial fellow elven deities.

As part of the experiments in this sector, [Eira](3-Mechanics/CLI/bestiary/npc/eira-tftyp.md) has been infused with the essence of a Chosen of Talona who was sacrificed. The binding process has left [Eira](3-Mechanics/CLI/bestiary/npc/eira-tftyp.md) at half her hit points but otherwise in good shape. She begs to accompany the characters in the fight against the Red Wizards.

If [Eira](3-Mechanics/CLI/bestiary/npc/eira-tftyp.md) joins the party, when she enters combat, the Talona side surfaces and contests for control. She argues out loud with herself, and half the time she acts evilly and without concern for her saviors. While talking to herself, she reveals what happened to her as well as one piece of lore. If [Eira](3-Mechanics/CLI/bestiary/npc/eira-tftyp.md) drops to 0 hit points, she disintegrates, her body turning to ash.
...
A Red Wizard [evoker](3-Mechanics/CLI/bestiary/humanoid/evoker-wizard-mpmm.md) and a [Thayan apprentice](3-Mechanics/CLI/bestiary/humanoid/thayan-apprentice-tftyp.md) work here, with three trained [yetis](3-Mechanics/CLI/bestiary/monstrosity/yeti-xmm.md) as bodyguards. Aduna, the Red Wizard, and her apprentice prefer to stand near the braziers.
...
The Chosen of Auril is a chaotic evil female human named [Hedrun Arnsfirth](3-Mechanics/CLI/bestiary/npc/hedrun-arnsfirth-tftyp.md). Auril is a callous and cold-hearted bringer of winter. Most humans propitiate Auril with offerings or prayers when the first frosts come and curse her name during blizzards.

Hedrun is now a [deathlock wight](3-Mechanics/CLI/bestiary/undead/deathlock-wight-mtf.md). If freed, she screams an oath to Auril and attacks the characters.

##### Treasure

Aduna wears a [robe of summer](3-Mechanics/CLI/items/robe-of-summer-tftyp.md).
...
The double doors to these tetrahedral pyramids are locked (requiring a successful DC 17 Dexterity check to pick the lock or a successful DC 20 Strength check to burst it). If either of the two doors on a sepulcher is opened, each door on that sepulcher transforms into a [four-armed gargoyle](3-Mechanics/CLI/bestiary/elemental/four-armed-gargoyle-tftyp.md) (as a normal gargoyle with 63 hit points and one extra claw attack, for a total of three attacks, with Multiattack) and attacks.
...
Kazit Gul, a [demilich](3-Mechanics/CLI/bestiary/undead/demilich-xmm.md), has entered the vault and immediately attacks the characters. If the demilich is destroyed, read:
...
With the Phylactery Vault destroyed, Syranna is true to her word and uses [teleport](3-Mechanics/CLI/spells/teleport-xphb.md) to send the characters (as well as any NPCs they saved from the Doomvault) to a location of their choice. She invites any characters who proved useful, particularly those with arcane talents, to remain in Thay under her leadership. She promises them power and influence if they throw in support for her.
