...
- [Ship Stat Blocks](/3-Mechanics/CLI/variant-rules/ship-stat-blocks-gos.md)  
- [Officers and Crew](/3-Mechanics/CLI/variant-rules/officers-and-crew-gos.md)  
- [Superior Ship Upgrades](/3-Mechanics/CLI/variant-rules/superior-ship-upgrades-gos.md)  
- [Ships in Combat](/3-Mechanics/CLI/variant-rules/ships-in-combat-gos.md)  
- [Travel at Sea](/3-Mechanics/CLI/variant-rules/travel-at-sea-gos.md)  
- [Ocean Environs](/3-Mechanics/CLI/variant-rules/ocean-environs-gos.md)  
- [Encounters at Sea](/3-Mechanics/CLI/variant-rules/encounters-at-sea-gos.md)  
- [Random Ships](/3-Mechanics/CLI/variant-rules/random-ships-gos.md)  
- [Mysterious Islands](/3-Mechanics/CLI/variant-rules/mysterious-islands-gos.md)  
...
Each nest holds `dice:1d4-1|noform|noparens|avg` (`1d4-1`) blood hawk eggs. Blood hawks make excellent hunting animals. Nobles are willing to pay 25 gp per intact egg.
...
The reef teems with `10d10 × 10` fish of various species and `dice:5d10|noform|noparens|avg` (`5d10`) [crabs](/3-Mechanics/CLI/bestiary/beast/crab.md). Each fish has the statistics of a [quipper](/3-Mechanics/CLI/bestiary/beast/quipper.md), but it doesn't have the Blood Frenzy feature and can't make attacks.
...
The anemone's tentacles deliver a poisonous sting. A creature that touches the anemone must make a DC 12 Constitution saving throw, taking `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) poison damage on a failed save, or half as much damage on a successful one.
...
When the characters first arrive at the cove, Elkahraal, a [marid](/3-Mechanics/CLI/bestiary/elemental/marid.md), casts invisibility and tongues. Elkahraal has a [water elemental](/3-Mechanics/CLI/bestiary/elemental/water-elemental.md) servant that forms the shape of an aboleth above the surface of the water, and the genie speaks to the characters as if he is the ghost of Ogrorlo, saying, "Find my remains and my pearls in one hour or I will destroy Saltmarsh!"
...
**Barnacles**. The outside of the *Marshal* is covered in all manner of sharp barnacles. A creature that is pushed against the outside of the ship by magic like the thunderwave spell, or by a shove attack, or that falls prone onto a barnacle-covered surface takes `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) slashing damage.
...
The day before the *Marshal* sank, Clergol of the Viola, a bard and a follower of St. Cuthbert, cast the awaken spell on a crab he named Barnacle Bess. Bess has the statistics of a [giant crab](/3-Mechanics/CLI/bestiary/beast/giant-crab.md), with the following changes:
...
If a creature touches or attacks the door while it is locked, the door produces a spectral tendril that makes an attack against the creature with a +7 bonus. If the tendril hits, it deals `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) psychic damage.
...
A crumbling mosaic depicts a kraken devouring an entire planet on the ceiling of this chamber. A creature that touches the walls, floor, or ceiling of this chamber must succeed on a DC 12 Dexterity saving throw or take `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) damage from falling debris.
...
Over several days recently, [mud mephits](/3-Mechanics/CLI/bestiary/elemental/mud-mephit.md) have appeared in Saltmarsh to steal food, pull pranks, and annoy people. Wellgar Brinehanded (see location 26 in Saltmarsh) tracked the mephits back to Warthalkeel's ruins. He offers the characters 100 gp to find and close the portal that the mephits are coming through. If the characters take the job, Wellgar gives each a potion of water breathing before they go to the ruins.

##### Elemental Portal

The 2-foot-diameter portal is located on the sea floor just outside area W7. Every `dice:1d6|noform|noparens|avg` (`1d6`) hours, a [mud mephit](/3-Mechanics/CLI/bestiary/elemental/mud-mephit.md) emerges from the portal and swims for the surface. If the green conch shell is destroyed, the portal closes.
...
Calduran Bravewater, a [deep scion](/3-Mechanics/CLI/bestiary/humanoid/deep-scion-vgm.md) (see appendix C), approaches the characters posing as a rich noble and asks for their help in diving into the ruins of Warthalkeel to find lost treasure. He offers to give the characters whatever it takes to persuade them to go to the ruins (since he has no intention of paying).

##### Society of Tentacles

Two [kraken priests](/3-Mechanics/CLI/bestiary/humanoid/kraken-priest-vgm.md) (see appendix C) and a [deep scion](/3-Mechanics/CLI/bestiary/humanoid/deep-scion-vgm.md) (see appendix C) desecrate area W6f of the House of Procan while another four [kraken priests](/3-Mechanics/CLI/bestiary/humanoid/kraken-priest-vgm.md), including Elagoth Rinecot, hold hands in a circle and chant to perform the ritual in area W7h of the Temple of Vaalastroth. The cultists attack the characters with the intention of subduing them.
...
Brinecane Ulganoth has transformed himself into a [storm giant quintessent](/3-Mechanics/CLI/bestiary/giant/storm-giant-quintessent-vgm.md) (see appendix C), and the ruins of Warthalkeel are his lair. The giant spends his days in area W7h making music with his harp—the calm in the eye of the storm.
