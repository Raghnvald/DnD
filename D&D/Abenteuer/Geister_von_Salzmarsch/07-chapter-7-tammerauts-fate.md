...
The sobbing woman is actually a [harpy matriarch](/3-Mechanics/CLI/bestiary/monstrosity/harpy-matriarch-gos.md) (see appendix C), which has used its magic to disguise itself as a middle-aged human female. The eight [harpies](/3-Mechanics/CLI/bestiary/monstrosity/harpy.md) that serve the matriarch circle above. Any character who makes a successful DC 17 Wisdom (Insight) check sees through her ruse and realizes she is not human.
...
The four casks hold a rotgut vintage of Tallos's assassin-berry wine. Anyone who drinks this concoction must succeed on a DC 14 Constitution saving throw or become poisoned for `dice:1d4|noform|noparens|avg` (`1d4`) hours. The saving throw to overcome the wine's nauseating effects can be repeated every 15 minutes.
...
Both Barret and Morley have contracted the disease called bluerot from the drowned ones (see appendix C). Barret is very ill and has lost 4 points of Constitution and Charisma from the disease. Unless he is cured, one hour after the characters discover him, Barret must succeed on a DC 12 Constitution saving throw or take `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) necrotic damage. A failed save likely kills him.
