...
Public unarmed brawling, pickpocketing, and other crimes that cause up to 50 gp in property damages are classified as petty crimes. The accused pays a fine of `dice:2d6|noform|noparens|avg` (`2d6`) gp, or one day of hard labor per gold piece owed.

##### Minor Crime

Armed assault, defined as any nonfatal attack made with a weapon, along with any other assault or property crimes that cause more than 50 gp in damages, but less than 250 gp, are minor crimes. The perpetrator must pay a fine of 100 gp and serve `dice:1d4|noform|noparens|avg` (`1d4`) years in prison or at forced labor.

##### Major Crime

Crimes more severe than those outlined above, including murder, are major crimes. The criminal faces `dice:2d10|noform|noparens|avg` (`2d10`) years of imprisonment, though serious cases earn the death penalty. In most instances, these crimes are dealt with in Seaton, the provincial capital located east of Saltmarsh.
...
At any given time, `dice:2d4|noform|noparens|avg` (`2d4`) [guards](/3-Mechanics/CLI/bestiary/humanoid/guard.md), led by a [veteran](/3-Mechanics/CLI/bestiary/humanoid/veteran.md), keep watch here.
...
Those who seek an audience with Manistrad can find her here when she's not working at the mine. She sometimes has need for adventurers to help keep the mining operation secure. Roll a `dice:d6|noform|noparens|avg` (`d6`) and consult the table below to determine the nature of an available task.
...
This 60-foot-tall tower was the first defensive building of Saltmarsh, and it still serves as an armory and lookout as well as the official base of the town guard. Eliander spends most of his time here in his duties as commander of the guard. He sometimes has need for adventurers, and at such times he posts jobs on a board hanging by the tower's entrance. Roll a `dice:d6|noform|noparens|avg` (`d6`) and consult the table below to determine the nature of an available task.
...
[Captain Xendros](/3-Mechanics/CLI/bestiary/npc/captain-xendros-gos.md) of the Faithful Quartermasters of Iuz has magic items for sale and can also broker the sale of magic items. Any such item comes with a mild curse, however. Anyone attuned to the item can be targeted by a detect thoughts spell cast by Xendros, with no limit on range; any saving throws triggered by the spell automatically fail; and the target has no knowledge of the casting. This curse can be detected by casting an identify spell on the item and succeeding on a DC 25 Intelligence (Arcana) check. The check can be attempted once per casting.
...
For each week of mercenary work, you earn the coin needed to sustain a modest lifestyle and an extra `dice:2d10|noform|noparens|avg` (`2d10`) gp. Additionally, roll a `dice:d20|noform|noparens|avg` (`d20`) at the end of each week. On a 19 or higher, you earn a bonus of `dice:3d20|noform|noparens|avg` (`3d20`) gp due to the unexpectedly dangerous nature of your most recent assignment.
...
The roads around Saltmarsh are heavily patrolled, part of the crown's effort to make its influence felt in the region. Travel along these thoroughfares is usually safe, with most encounters involving merchant caravans, guard patrols, and fellow travelers. Small farms and manors cluster near the roads, relying on passing guard patrols for their safety. Where these settlements grow more widely spaced, bandit raids become more likely. Travelers on the road meet `dice:1d4|noform|noparens|avg` (`1d4`) caravans per day and have a 5 percent chance of being the target of an ambush by `dice:2d4|noform|noparens|avg` (`2d4`) [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit.md) led by a [bandit captain](/3-Mechanics/CLI/bestiary/humanoid/bandit-captain.md). In addition, each day on the road a party passes `dice:1d3|noform|noparens|avg` (`1d3`) small villages or manors. There is a 25 percent chance that any such location is inhabited by halflings. Otherwise, the location is a human enclave.
...
|-----------|--------------|----------------|---------------|
| 1–3 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [goblins](/3-Mechanics/CLI/bestiary/humanoid/goblin.md) | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton.md) | `dice:4d6\|noform\|noparens\|avg` (`4d6`) [skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton.md) |
| 4–5 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) elf [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md) | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie.md) | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie.md) |
| 6–7 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit.md) | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [hobgoblins](/3-Mechanics/CLI/bestiary/humanoid/hobgoblin.md) | `dice:3d4\|noform\|noparens\|avg` (`3d4`) [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul.md) |
| 8–9 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [jackalweres](/3-Mechanics/CLI/bestiary/humanoid/jackalwere.md) | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [bugbears](/3-Mechanics/CLI/bestiary/humanoid/bugbear.md) | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [specters](/3-Mechanics/CLI/bestiary/undead/specter.md) |
| 10 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [stirges](/3-Mechanics/CLI/bestiary/beast/stirge.md) | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul.md) | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [wights](/3-Mechanics/CLI/bestiary/undead/wight.md) |
| 11 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [vine blights](/3-Mechanics/CLI/bestiary/plant/vine-blight.md) | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [specters](/3-Mechanics/CLI/bestiary/undead/specter.md) | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn.md) |
| 12 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [hobgoblins](/3-Mechanics/CLI/bestiary/humanoid/hobgoblin.md) | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [green hags](/3-Mechanics/CLI/bestiary/fey/green-hag.md) | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [wraiths](/3-Mechanics/CLI/bestiary/undead/wraith.md) |
| 13 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf.md) | 1 [banshee](/3-Mechanics/CLI/bestiary/undead/banshee.md) | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [mummies](/3-Mechanics/CLI/bestiary/undead/mummy.md) |
| 14 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [green hags](/3-Mechanics/CLI/bestiary/fey/green-hag.md) | 1 [night hag](/3-Mechanics/CLI/bestiary/fiend/night-hag.md) | `dice:2d4+2\|noform\|noparens\|avg` (`2d4 + 2`) [shadows](/3-Mechanics/CLI/bestiary/undead/shadow.md) |
| 15 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [treants](/3-Mechanics/CLI/bestiary/plant/treant.md) | 1 [lamia](/3-Mechanics/CLI/bestiary/monstrosity/lamia.md) | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [vampires](/3-Mechanics/CLI/bestiary/undead/vampire.md) |
| 16 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [kobolds](/3-Mechanics/CLI/bestiary/humanoid/kobold.md) | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [wraiths](/3-Mechanics/CLI/bestiary/undead/wraith.md) | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [night hags](/3-Mechanics/CLI/bestiary/fiend/night-hag.md) |
| 17 | 1 [unicorn](/3-Mechanics/CLI/bestiary/celestial/unicorn.md) | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [gorgons](/3-Mechanics/CLI/bestiary/monstrosity/gorgon.md) | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [shambling mounds](/3-Mechanics/CLI/bestiary/plant/shambling-mound.md) |
| 18 | 1 [troll](/3-Mechanics/CLI/bestiary/giant/troll.md) | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [mummies](/3-Mechanics/CLI/bestiary/undead/mummy.md) | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [oni](/3-Mechanics/CLI/bestiary/giant/oni.md) |
| 19 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [hobgoblins](/3-Mechanics/CLI/bestiary/humanoid/hobgoblin.md) | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [shadows](/3-Mechanics/CLI/bestiary/undead/shadow.md) | 1 [adult green dragon](/3-Mechanics/CLI/bestiary/dragon/adult-green-dragon.md) |
| 20 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [ogres](/3-Mechanics/CLI/bestiary/giant/ogre.md) | 1 [vampire](/3-Mechanics/CLI/bestiary/undead/vampire.md) | 1 [death knight](/3-Mechanics/CLI/bestiary/undead/death-knight.md) |
^dreadwood-random-encounters
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | A human [zombie](/3-Mechanics/CLI/bestiary/undead/zombie.md) is chained to a wooden stake driven into the ground. The remains of many other zombies lie nearby. A successful DC 10 Intelligence (Investigation) or Wisdom (Survival) check reveals evidence that the zombie is being used as target practice. |
...
The Drowned Forest Random Encounters table provides ideas for the sorts of encounters that can take place here. Check for an encounter once per day by rolling a `dice:d20|noform|noparens|avg` (`d20`) (if the characters do not already attract monsters by stumbling across shriekers). On an 18 or higher, the characters have an encounter at some point during the day or night (equal chance of each); roll a `dice:d20|noform|noparens|avg` (`d20`) again and consult the table.
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1–3 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [awakened trees](/3-Mechanics/CLI/bestiary/plant/awakened-tree.md) |
| 4–5 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie.md) |
| 6–7 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [shambling mounds](/3-Mechanics/CLI/bestiary/plant/shambling-mound.md) |
| 8–9 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [myconid adults](/3-Mechanics/CLI/bestiary/plant/myconid-adult.md) and 1 [myconid sovereign](/3-Mechanics/CLI/bestiary/plant/myconid-sovereign.md) |
| 10 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [stirges](/3-Mechanics/CLI/bestiary/beast/stirge.md) |
| 11 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [trolls](/3-Mechanics/CLI/bestiary/giant/troll.md) |
| 12 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [gnolls](/3-Mechanics/CLI/bestiary/humanoid/gnoll.md) and 1 [gnoll pack lord](/3-Mechanics/CLI/bestiary/humanoid/gnoll-pack-lord.md) |
...
| 15 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [manes](/3-Mechanics/CLI/bestiary/fiend/manes.md) |
| 16 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [dretches](/3-Mechanics/CLI/bestiary/fiend/dretch.md) |
| 17 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [bullywugs](/3-Mechanics/CLI/bestiary/humanoid/bullywug.md) |
| 18 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [vine blights](/3-Mechanics/CLI/bestiary/plant/vine-blight.md) |
| 19 | `dice:2d8\|noform\|noparens\|avg` (`2d8`) [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight.md) |
| 20 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight.md) |
^drowned-forest-random-encounters
...
The Hool Marshes Random Encounters table provides ideas for the sort of encounters that can take place here. Check for an encounter once per day by rolling a `dice:d20|noform|noparens|avg` (`d20`). On an 18 or higher, the characters have an encounter at some point during the day or night (equal chance of each); roll a `dice:d20|noform|noparens|avg` (`d20`) again and consult the table.
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `dice:2d10\|noform\|noparens\|avg` (`2d10`) [bullywugs](/3-Mechanics/CLI/bestiary/humanoid/bullywug.md) |
| 4–5 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit.md) |
| 6–7 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [vine blights](/3-Mechanics/CLI/bestiary/plant/vine-blight.md) with `dice:1d6\|noform\|noparens\|avg` (`1d6`) [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight.md) |
| 8–9 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [poisonous snakes](/3-Mechanics/CLI/bestiary/beast/poisonous-snake.md) |
| 10 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [rats](/3-Mechanics/CLI/bestiary/beast/rat.md) |
| 11 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [giant toads](/3-Mechanics/CLI/bestiary/beast/giant-toad.md) |
| 12 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [crocodiles](/3-Mechanics/CLI/bestiary/beast/crocodile.md) |
| 13 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [kobolds](/3-Mechanics/CLI/bestiary/humanoid/kobold.md) |
| 14 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [lizardfolk](/3-Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
...
| 17 | 1 [green hag](/3-Mechanics/CLI/bestiary/fey/green-hag.md) and `dice:1d3\|noform\|noparens\|avg` (`1d3`) [will-o'-wisps](/3-Mechanics/CLI/bestiary/undead/will-o-wisp.md) |
| 18 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [trolls](/3-Mechanics/CLI/bestiary/giant/troll.md) |
| 19 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ochre jellies](/3-Mechanics/CLI/bestiary/ooze/ochre-jelly.md) |
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit.md) |
| 4 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [gray oozes](/3-Mechanics/CLI/bestiary/ooze/gray-ooze.md) |
| 5 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [ogres](/3-Mechanics/CLI/bestiary/giant/ogre.md) |
| 6–7 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [crocodiles](/3-Mechanics/CLI/bestiary/beast/crocodile.md) |
| 8–10 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [bullywugs](/3-Mechanics/CLI/bestiary/humanoid/bullywug.md) |
...
| 14–15 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [lizardfolk](/3-Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
| 16 | 1 [shambling mound](/3-Mechanics/CLI/bestiary/plant/shambling-mound.md) |
| 17–19 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [ochre jellies](/3-Mechanics/CLI/bestiary/ooze/ochre-jelly.md) |
| 20 | 1 [young black dragon](/3-Mechanics/CLI/bestiary/dragon/young-black-dragon.md) |
^dunwater-river-random-encounters
...
This galleon belonged to the mage Mordenkainen, who dispatched it to a distant shore in search of treasure. The ship sank in a mysterious and especially ferocious storm. A convincingly crab-like apparatus of Kwalish being transported in its hold remains at the sea bottom, but a [marilith](/3-Mechanics/CLI/bestiary/fiend/marilith.md) bound to guard it remains and attempts to slay anyone other than Mordenkainen who lays a hand on it. The ship sits approximately 100 feet below the waves.

#### Random Encounters

The Coast Random Encounters table and the Azure Sea Random Encounters table provide ideas for the sort of encounters that can take place along the seashore or on the surface of the water. Check for an encounter once per day by rolling a `dice:d20|noform|noparens|avg` (`d20`). On an 18 or higher, the characters have an encounter at some point during the day or night (equal chance of each); roll a `dice:d20|noform|noparens|avg` (`d20`) again and consult the appropriate table.
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [blood hawks](/3-Mechanics/CLI/bestiary/beast/blood-hawk.md) |
| 4 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [stirges](/3-Mechanics/CLI/bestiary/beast/stirge.md) |
| 5 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [giant crabs](/3-Mechanics/CLI/bestiary/beast/giant-crab.md) |
| 6–7 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [perytons](/3-Mechanics/CLI/bestiary/monstrosity/peryton.md) |
| 8–10 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [giant lizards](/3-Mechanics/CLI/bestiary/beast/giant-lizard.md) |
| 11–12 | `dice:2d8\|noform\|noparens\|avg` (`2d8`) [giant rats](/3-Mechanics/CLI/bestiary/beast/giant-rat.md) |
| 13 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md) |
| 14–15 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [lizardfolk](/3-Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
| 16 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [merrow](/3-Mechanics/CLI/bestiary/monstrosity/merrow.md) |
| 17–19 | 1 [cyclops](/3-Mechanics/CLI/bestiary/giant/cyclops.md) |
| 20 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [chuuls](/3-Mechanics/CLI/bestiary/aberration/chuul.md) |
^coast-random-encounters
...
| dice: d20 | Result |
|-----------|--------|
| 1–2 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [giant octopi](/3-Mechanics/CLI/bestiary/beast/giant-octopus.md) |
| 3–4 | 1 [plesiosaurus](/3-Mechanics/CLI/bestiary/beast/plesiosaurus.md) |
| 5–6 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [perytons](/3-Mechanics/CLI/bestiary/monstrosity/peryton.md) |
| 7 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [water elementals](/3-Mechanics/CLI/bestiary/elemental/water-elemental.md) |
| 8–10 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [reef sharks](/3-Mechanics/CLI/bestiary/beast/reef-shark.md) |
| 11–12 | `dice:2d8\|noform\|noparens\|avg` (`2d8`) [sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md) |
| 13 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4+1`) [merrow](/3-Mechanics/CLI/bestiary/monstrosity/merrow.md) |
| 14–15 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [pteranodons](/3-Mechanics/CLI/bestiary/beast/pteranodon.md) |
...
The Salted Glade is captained by Mithina Greyheart (NE half-elf female [druid](/3-Mechanics/CLI/bestiary/humanoid/druid.md)), whose grove was destroyed by a massive tidal wave nearly twenty years ago. Mithina's heart sank with her grove, and her mind turned to vengeance. She has since turned to piracy to fund her search for a legendary island known as Procan's Bloom, where she hopes to chastise the god Ehlonna for the destruction of her home. Aiding her is the corrupted [dryad](/3-Mechanics/CLI/bestiary/fey/dryad.md) Filios, who dwells in a shriveled oak growing from the ship's center.
...
If you revere a different deity, you own a small building in Saltmarsh and have been charged by the elders of your faith with establishing a shrine here. You live in the building and have a staff of `dice:1d4|noform|noparens|avg` (`1d4`) locals who have already been recruited to your faith. Your Shelter of the Faithful feature applies to a temple located in Seaton, the provincial capital east of Saltmarsh.
...
The folk of Saltmarsh care little for nobles and their titles. Although the king technically rules the land, the south has long been left to its own devices. Are you a local noble turning to a life of adventure, or did you come here in search of fame and fortune? Regardless of your origin, your Position of Privilege feature allows you to request an audience with any official in town, including members of the town council. They typically take `dice:1d6+1|noform|noparens|avg` (`1d6 + 1`) days to fulfill such a request. The table below includes suggestions for how you came to arrive in Saltmarsh.
