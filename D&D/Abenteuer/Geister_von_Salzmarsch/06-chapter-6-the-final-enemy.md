...
For every 10 minutes the characters spend traveling the corridors on level 2, roll a `dice:d12|noform|noparens|avg` (`d12`). On a 12, the characters come upon a guard patrol.
...
Two **[sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md) [champions](/3-Mechanics/CLI/bestiary/humanoid/champion-mpmm.md)** (see appendix C) and two [sahuagin priestesses](/3-Mechanics/CLI/bestiary/humanoid/sahuagin-priestess.md) occupy this room. Their revelry grants them disadvantage on Perception checks to detect the characters as they approach the chamber.
...
When the trap is triggered, a short blade thrusts from the coffer, stabbing any creature next to the coffer's lock. The creature must make a successful DC 14 Dexterity saving throw or take `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) piercing damage.
...
Non-sahuagin humanoid creatures who can hear the chanting of the priestesses must make a DC 14 Wisdom saving throw. On a failed save, a creature is frightened for `dice:1d4|noform|noparens|avg` (`1d4`) rounds.
...
Combat in the throne room attracts the attention of a wandering patrol, which arrives in `dice:1d6+1|noform|noparens|avg` (`1d6 + 1`) rounds. A direct attack is likely to wipe out a party that tries to kill the entire royal group; the characters' mission was designed as a reconnaissance effort for good reason.
...
| Area | Defenders |
|------|-----------|
| 1–4 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md) |
| 5–11 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md) and 1 [sahuagin champion](/3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md)* |
| 12–18 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md), 2 [sahuagin champions](/3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md)*, and 1 [sahuagin coral smasher](/3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md)* |
^sahuagin-defenders
