...
![](3-Mechanics/CLI/adventures/red-dragons-tale-a-lego-adventure/img/dragon.webp#center)
...
Nothing the Player Characters say can quench Cinderhowl's rage. The dragon is convinced Ervan hired them to steal her egg. As an action, a character can try to redirect Cinderhowl's rage toward Ervan, doing so with a successful DC 20 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception) or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. Use whichever skill seems most appropriate.
...
[Ervan Soulfallen](3-Mechanics/CLI/bestiary/npc/ervan-soulfallen-lrdt.md) (see the "Nonplayer Characters" section at the end of the adventure for his stat block) targets Cinderhowl with his Spell Scroll of [Hold Monster](3-Mechanics/CLI/spells/hold-monster.md). If Cinderhowl fails her saving throw, she has the [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) condition for the spell's duration and falls to the ground, giving Ervan time to snatch the egg and run. If Cinderhowl succeeds on the saving throw, she laughs at Ervan's "puny magic." Either way, the scroll turns to dust after Ervan casts the spell from it.
