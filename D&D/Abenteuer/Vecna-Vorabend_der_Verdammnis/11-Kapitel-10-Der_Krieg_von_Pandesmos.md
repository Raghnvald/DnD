...
If the characters are careless or fail to fool Lolth's forces, they might face a squad of `dice:1d4|noform|noparens|avg` (`1d4`) [driders](/3-Mechanics/CLI/bestiary/monstrosity/drider.md), `dice:1d6|noform|noparens|avg` (`1d6`) [giant spiders](/3-Mechanics/CLI/bestiary/beast/giant-spider.md), and `dice:1d4|noform|noparens|avg` (`1d4`) [assassins](/3-Mechanics/CLI/bestiary/humanoid/assassin.md). Characters who defeat the squad can try again to infiltrate the tower.
...
The exterior door has an invisible glyph inscribed on it. Each time a creature other than a Fiend opens the door, the glyph glows for a split second, and the creature must make a DC 18 Wisdom saving throw, taking `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) psychic damage on a failed save or half as much damage on a successful one. Casting Dispel Magic on the door removes the glyph, allowing the door to be opened safely.
...
A platinum scroll tube worth 2,500 gp is hidden in webbing in the southwest corner of the room, near the ceiling. It contains two Spell Scrolls of Glyph of Warding. Characters who search the room and succeed on a DC 15 Wisdom (Perception) check find the scroll tube.
...
A human corpse bears a platinum medallion of Lolth's symbol with dazzling diamonds at the end of each spider's foot (worth 3,000 gp). A drider corpse wears a bandolier woven of solidified shadow worth 30,000 gp. The bandolier holds two Potions of Healing (supreme) and a Spell Scroll of Seeming.
