...
![Adventurers navigate around one of the more fearsome exhibits in the Varkenbluff Museum of Natural History](3-Mechanics/CLI/adventures/keys-from-the-golden-vault/img/004-01-001-ch1-splash.webp#center)
...
For bringing the Murkmire Stone back to Dr. Dannell, she offers her bag of holding plus 20 gp per character. If a character succeeds on a DC 13 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check, Dr. Dannell increases her offer to 30 gp per character.
...
![The Murkmire Stone is the primary treasure on display during the Varkenbluff Museum's opening gala](3-Mechanics/CLI/adventures/keys-from-the-golden-vault/img/008-01-005-murkmire-stone-display.webp#center)
...
Tucked between supply boxes in the northwest corner is a vial containing a potion of vitality.
...
A character who studies the exhibit and succeeds on a DC 10 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check realizes the items on display include two flawless weapons: a +1 dagger and a +1 handaxe. The weapons are inside a glass case with a jammed lock, so the characters must break or cut through the glass to access the weapons. Breaking the glass attracts the guards patrolling this area.
