...
Bezeichnung: Axeholm
Status: WIP
linter-yaml-title-alias: Axeholm
tags:
  - Quelle/5e/dip
aliases:
  - Axeholm
...
Entering the fortress is the characters' first challenge. The portcullis in area A1 is too heavy to lift, and its bars are too narrowly spaced for even Small characters to squeeze through. However, a Small character can squeeze through an arrow slit into area A2 or A3, then attempt to raise the portcullis using the winches there. The winches are rusty and require a successful DC 15 Strength (Athletics) check to turn. Each successful check allows the portcullis to be raised 5 feet.
