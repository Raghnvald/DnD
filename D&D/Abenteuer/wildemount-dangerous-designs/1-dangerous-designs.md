...
![](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/110-05-03.webp#center)
...
> [!gallery]
> ![Map 5.4: Lower Hupperdook](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/111-5-4-lower-hupperdook.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/111-5-4-lower-hupperdook-player.webp#gallery)
...
The elf asks the characters their business, and introduces herself as [Yinra Emberwind](3-Mechanics/CLI/bestiary/npc/yinra-emberwind-egw.md) (see her stat block later in the adventure), a bounty hunter who heard the commotion from the Idleworks Shelf. She brags about having already finished her work here, and wishes the characters good luck in finding Sken before she does. The characters can attempt to barter for the paper Yinra recovered, which she relinquishes for 50 gp in coins or other treasure. A character who wants to steal the paper from Yinra while she's engaged in conversation must succeed on a DC 18 Dexterity (Sleight of Hand) check. On a failure, Yinra grabs the would-be thief's hand and laughs at them before leaving.
...
![Handout A: Burned Letter Fragment](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/113-05-04.webp#center)
...
If the characters are particularly interested in the functionality of the broken automaton, Cleff offers to repair it. Doing so takes a few hours and costs 15 gp for materials, whereupon the characters are the owners of a [vox seeker](3-Mechanics/CLI/items/vox-seeker-egw.md) (see "chapter 6").
...
Sleese offers a pouch of [blasting powder](3-Mechanics/CLI/items/blasting-powder-egw.md) (see the "Alchemical Items" sidebar later in the adventure) as a gift if the characters agree to check in on Nima Cinnarid. He can direct them to her house at area H6.

### H6. Nima Cinnarid's House

> [!gallery]
> ![Map 5.6: Nima Cinnarid's House](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/114-5-6-nima-cinnarids-house.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/114-5-6-nima-cinnarids-house-player.webp#gallery)
...
The interior of Nima Cinnarid's house is dark except for a guttering candle on the back table, shedding dim light in a 5-foot radius. Four [kobold underlings](3-Mechanics/CLI/bestiary/humanoid/kobold-underling-egw.md) lie in wait in the shadows. Any character with a passive Wisdom (Perception) score of 16 or higher, or who succeeds on a DC 16 Wisdom (Perception) check, sees the kobolds hiding and ready to spring. When any character moves more than 10 feet into the house, the kobolds attack. Anyone who was not aware of the hidden kobolds is surprised.

When the kobolds are defeated, the characters have 2 rounds to loot or investigate the corpses of any slain kobolds. After that time, the kobolds' bodies explode as in area H1. See the "Exploding Kobolds" section in that area, the kobold underling stat block (earlier in the adventure), and the "Alchemical Items" sidebar for information on removing and keeping the [explosive seeds](3-Mechanics/CLI/items/explosive-seed-egw.md) the kobolds carry.
...
Characters who sift through the wreckage find a pouch of [blasting powder](3-Mechanics/CLI/items/blasting-powder-egw.md) (see the "Alchemical Items" sidebar).

![Handout B: Nima's Note](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/115-05-05.webp#center)
...
| 8 | Two [kobold underlings](3-Mechanics/CLI/bestiary/humanoid/kobold-underling-egw.md) (see their stat block earlier in this adventure) on patrol accost the characters. |
^encounter
...
> [!gallery]
> ![Map 5.7: Silver Falls Cavern](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/116-5-7-silver-falls-cavern.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/116-5-7-silver-falls-cavern-player.webp#gallery)
...
Nima throws an [explosive seed](3-Mechanics/CLI/items/explosive-seed-egw.md) (see the "Alchemical Items" sidebar earlier in this adventure) at whichever enemies are closest, then throws another seed on each of her turns until she runs out of seeds. She has a total of four explosive seeds.
...
After defeating Sken, the characters can claim her [ring of obscuring](3-Mechanics/CLI/items/ring-of-obscuring-egw.md) (see "chapter 6"). The workbench Nima was working at holds `1d4 + 1` [explosive seeds](3-Mechanics/CLI/items/explosive-seed-egw.md) (see the earlier "Alchemical Items" sidebar).
...
> [!gallery]
> ![Map 5.8: Stahlmast's Lair](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/117-5-8-stahlmasts-lair.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/wildemount-dangerous-designs/img/117-5-8-stahlmasts-lair-player.webp#gallery)
...
- The Master is planning to make many tiny metal crabs ([vox seekers](3-Mechanics/CLI/bestiary/construct/vox-seeker-egw.md), as described in "chapter 6").  
...
> 
> The characters' confiscated equipment is in a chest in the armory (area L2), and a confident [kobold underling](3-Mechanics/CLI/bestiary/humanoid/kobold-underling-egw.md) guards their cells. You can then set up a scenario in which the characters find a way to escape and recover their equipment.
^all-is-not-lost
...
A [kobold underling](3-Mechanics/CLI/bestiary/humanoid/kobold-underling-egw.md) (see the stat block earlier in this adventure) sits at one of the tables as the characters approach this area, cleaning a pile of soiled tools and weapons with a rag as it curses under its breath in Draconic. If it receives any warning that intruders are coming (including hearing the characters fighting or talking in area L1), it might make a brief stand against them—or it might flee before they arrive, leaving its work behind.
...
If the characters were captured and thrown into the prison cells in area L7, their weapons hang on the walls here and their other equipment is in the chest beneath the table. [Yinra Emberwind's](3-Mechanics/CLI/bestiary/npc/yinra-emberwind-egw.md) equipment is also stored there (see area L7).
...
The three [kobold underlings](3-Mechanics/CLI/bestiary/humanoid/kobold-underling-egw.md) (see the stat block presented earlier in this adventure) playing cards are engrossed in their game. If the characters observe the game unnoticed, it quickly becomes apparent that the kobolds aren't following any consistent rules. The kobolds attack as soon as intruders are spotted.
...
Most of the notes here read like mad scrawls mixed with engineering designs. Sketches of the layout of Hupperdook and the mountaintop are seen, as well as what looks like the designs for [explosive seeds](3-Mechanics/CLI/items/explosive-seed-egw.md) (see the "Alchemical Items" sidebar earlier in this adventure) and a diagram of how the seeds can be surgically implanted into creatures. Another note details the process by which sharks are to be placed into the waterfall lake in Silver Falls Grove. One strange design shows what appears to be some kind of clockwork-powered armor.

#### Vox Seeker

Clinging to the underside of the table is a [vox seeker](3-Mechanics/CLI/items/vox-seeker-egw.md) (see "chapter 6"). There is a 25 percent chance that the automaton is wound up when discovered, allowing it to attack for up to 5 minutes.
...
The bounty hunter [Yinra Emberwind](3-Mechanics/CLI/bestiary/npc/yinra-emberwind-egw.md) is currently locked in the east cell, stripped of her equipment. (See her stat block earlier in this adventure, but she is AC 13 without armor.) A [kobold underling](3-Mechanics/CLI/bestiary/humanoid/kobold-underling-egw.md) (see its stat block earlier in the adventure) sits in the chair when the characters first arrive, watching the prisoner. The kobold carries keys that open both cells, or the locks on the cells can be picked with a successful DC 18 Dexterity check using thieves' tools.
...
When the characters first arrive here, four kobolds are being trained by Ishel—a drow ambassador from the Kryn Dynasty. [Ishel](3-Mechanics/CLI/bestiary/npc/ishel-egw.md) uses the drow stat block but has 24 hit points, which raises his challenge rating to 1/2 (100 XP). He carries keys to the chest in area L10 and to the secret door in area L19.
...
[Ishel](3-Mechanics/CLI/bestiary/npc/ishel-egw.md) (see area L9) is quartered in this area. Any character who looks beneath the bed discovers a long, locked iron chest there. Ishel carries the key, or the lock can be picked with a successful DC 15 Dexterity check using thieves' tools.
...
The chest holds 5 pp, 113 gp, 15 sp, and 10 cp, as well as a dark steel [+1 shortsword](3-Mechanics/CLI/items/1-weapon.md).
...
Characters who search the room thoroughly find a [potion of healing](3-Mechanics/CLI/items/potion-of-healing.md).
...
The sleeping [kobold underling](3-Mechanics/CLI/bestiary/humanoid/kobold-underling-egw.md) (see its stat block earlier in the adventure) has its chest wrapped with bloodstained bandages. If the sore and scared kobold is woken up, characters have advantage on Charisma checks to question it (see "Stahlmast's Minions" at the beginning of this section). In addition to any other information you want to reveal, the kobold complains about the pain in its chest. (Stahlmast recently implanted an [explosive seed](3-Mechanics/CLI/items/explosive-seed-egw.md) inside the kobold.)
...
A search of the room reveals a small box under one of the tables that holds `1d4` [explosive seeds](3-Mechanics/CLI/items/explosive-seed-egw.md) (see the "Alchemical Items" sidebar earlier in this adventure).
...
A locked chest is hidden beneath the bed, and can be opened with thieves' tools and a successful DC 16 Dexterity check. The chest holds 170 gp, 65 sp, and two [potions of healing](3-Mechanics/CLI/items/potion-of-healing.md). It also contains a letter written in Undercommon, which promises that more support and minions will soon be sent through the tunnel. The letter thanks Stahlmast for his soon-to-be fruitful alliance with Den Hythenos of the Kryn Dynasty. Turning the letter over to Watchmaster Bram Gulchswattle earns the characters an additional reward (see "Concluding the Adventure" at the end of this adventure).

### L19. Clockwork Forge

Huron Stahlmast (a lawful evil human cultist wearing [goggles of night](3-Mechanics/CLI/items/goggles-of-night.md)) awaits the characters in this elaborate workshop. If the drow ambassador from area L9 or Roguun from area L14 escaped earlier encounters with the characters, he has joined Stahlmast here for the final fight.
...
If Stahlmast is killed or subdued, the characters can claim his [goggles of night](3-Mechanics/CLI/items/goggles-of-night.md). Any investigation of the Stahlmaster shows that it is beyond repair. However, with one hour's work, the characters can strip 350 gp of gold and silver clockwork components from it.
