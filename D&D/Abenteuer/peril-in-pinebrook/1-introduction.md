...
![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/001-0000.webp#center)
...
![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/0000.webp#center)
...
Disadvantage means that instead of rolling the `d20` once to make the [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) check to climb, Shalefire's player rolls the `d20` twice and uses the lower roll. They then add the normal modifier (+6 for Shalefire's [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) skill) to get a final result.

### Hit Points

Every creature in D&D has a number of "hit points." This number reflects the damage a creature can take before it falls [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) or is defeated. When a character or creature is damaged by an attack roll or a hazard in the game, the amount of damage dealt is subtracted from the character's or creature's hit points.

If a creature reaches 0 hit points, they are defeated. The players can decide if this means a creature is dead or [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) or if they run away.

When a character reaches 0 hit points, they are [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious). In this adventure, a character at 0 hit points remains [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) until they regain hit points through healing or until the end of the encounter, when they regain 1 hit point automatically. The adventure details ways to regain hit points.
...
![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/0002.webp#center)
...
![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/0004.webp#center)
...
![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/001-0049.webp#center)
...
> 
> You're going to make a [Perception](3-Mechanics/CLI/rules/skills.md#Perception) check to see if you can hear what Captain Kole hears. "[Perception](3-Mechanics/CLI/rules/skills.md#Perception)" is listed on your character sheet under "Skills." Each of you should roll a 20-sided die and add the number next to your [Perception](3-Mechanics/CLI/rules/skills.md#Perception) skill on your character sheet. Then tell me the total of your [Perception](3-Mechanics/CLI/rules/skills.md#Perception) check.
^022

## Perception Checks

A player rolls a `d20` and adds the modifier written next to the [Perception](3-Mechanics/CLI/rules/skills.md#Perception) skill on their character sheet to make a [Perception](3-Mechanics/CLI/rules/skills.md#Perception) check. The Difficulty Class to succeed on this check is 10 (written as DC 10), so if anyone gets a [Perception](3-Mechanics/CLI/rules/skills.md#Perception) check of 10 or higher, you explain that they hear a noise coming from the thorny forest underbrush.

If no character succeeds on the [Perception](3-Mechanics/CLI/rules/skills.md#Perception) check, Captain Kole points in the direction of the sound. Continue reading:
...
- **Information the Characters Might Know.** Players might learn information based on their characters' skills. For instance, Shalefire or Gallantine could ask if this is a baby silver dragon. As the DM, you can have their players make a DC 10 check with an appropriate skill to see if they know the answer to that question. Shalefire could use the [Animal Handling](3-Mechanics/CLI/rules/skills.md#Animal%20Handling) skill, while Gallantine could use the [Nature](3-Mechanics/CLI/rules/skills.md#Nature) skill. If they succeed on the check (`d20` + skill modifier is 10 or higher), you can tell them "Yes! This is a newborn silver dragon." You might add that they often eat meat and other food as well.  
...
After Captain Kole leaves, the characters should attempt to find food for the dragon. You may want to point out that all the characters have rations listed on their character sheets under "Other Equipment." Alternatively, Shalefire can make a DC 10 [Survival](3-Mechanics/CLI/rules/skills.md#Survival) check or Gallantine can make a DC 10 [Nature](3-Mechanics/CLI/rules/skills.md#Nature) check to find berries and nuts the dragon can eat. Remind players how to make `d20` rolls if needed.
...
> 
> Rather than having a monster attack one character until they fall [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious), have the monster attack a different character each turn. This tactic keeps more characters in the fight longer.
> 
...
Ask the players to make either a DC 10 [History](3-Mechanics/CLI/rules/skills.md#History) or [Religion](3-Mechanics/CLI/rules/skills.md#Religion) check for their characters. Although Evandon is the only character who has a bonus to their [Religion](3-Mechanics/CLI/rules/skills.md#Religion) skill and Gallantine is the only character with a bonus to their [History](3-Mechanics/CLI/rules/skills.md#History) skill, the other characters can still attempt a [History](3-Mechanics/CLI/rules/skills.md#History) or [Religion](3-Mechanics/CLI/rules/skills.md#Religion) check. The players just don't add anything to the `d20` roll when they do.
...
Ask the players to make a DC 10 [Arcana](3-Mechanics/CLI/rules/skills.md#Arcana), [History](3-Mechanics/CLI/rules/skills.md#History), or [Religion](3-Mechanics/CLI/rules/skills.md#Religion) check. If a character succeeds on the check, tell them that the figure in the ice represents Bahamut, the god of the metallic-colored dragons (brass, bronze, copper, gold, and silver).
...
Before starting to slide, the characters can try to quickly figure out which slide is safest. Ask the players to make a DC 10 [Investigation](3-Mechanics/CLI/rules/skills.md#Investigation) or [Perception](3-Mechanics/CLI/rules/skills.md#Perception) check to determine the best choice. If a character succeeds on this check, they choose the best slide to reach the bottom safely. The character doesn't take any damage, but you can describe the wild ride they experience as they slide toward the cavern floor.

##### Changing Slides

A character who fails the check jumps onto a slide and quickly reaches dangerous sections of razor-sharp ice shards, long drops, ice walls, and other hazards. The character must succeed on a DC 15 [Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics) or [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) check to jump to a safer slide to avoid taking damage. A character who doesn't have [Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics) or [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) on their character sheet can still make checks with those skills, but they don't add any modifier to the `d20` roll.
...
![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/001-0103.webp#center)
...
> [!note] DM Tip
> 
> A character that reaches 0 hit points falls [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) and remains [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) until they regain hit points through healing. At the end of the encounter, any [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) player characters regain 1 hit point automatically.
^dm-tip
...
![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/0006.webp#center)
...
> - Ask the characters to make [Nature](3-Mechanics/CLI/rules/skills.md#Nature) checks, then tell the character with the highest check that they know a dragon this powerful could defeat all the characters easily.  
...
> [!gallery]
> ![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/0007.webp#gallery)
> ![](3-Mechanics/CLI/adventures/peril-in-pinebrook/img/0010.webp#gallery)