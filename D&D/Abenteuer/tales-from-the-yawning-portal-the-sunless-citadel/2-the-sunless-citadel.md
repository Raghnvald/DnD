...
- json5e-note
tags:
- ttrpg-cli/compendium/src/5e/tftyp-tsc
aliases:
- "The Sunless Citadel"
---
# The Sunless Citadel
...
- **4. Hidden Grove..** Eventually, the characters discover the lower level of the citadel and the Twilight Grove that lies within. There, they learn the truth about the enchanted fruit, and they must confront [Belak the Outcast](3-Mechanics/CLI/bestiary/npc/belak-the-outcast-tftyp.md) and the Gulthias Tree.  
...
The center of government in Oakhurst includes the office of Mayor Vurnor Leng, a male human [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md).

### General Store

The village's main source for supplies and merchandise is the general store, owned and operated by Kerowyn Hucrele, a female human [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md).

### Shrine

Advice, information, and healing are among the services dispensed at the village's shrine. It is maintained by Dem "Corkie" Nackle, a female gnome [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) of Pelor.

### Jail

Next to the village hall is a stout building where miscreants serve their sentences. Oakhurst's constable is Felosial, a female half-elf [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md). She commands a force of sixteen [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) and four [scouts](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md) who keep the village safe.

### Blacksmith

Repairing and forging arms and armor is the job of the village smithy, Rurik Lutgehr, a male dwarf [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md).

### Ol' Boar Inn

Garon, a male human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), is the owner and barkeep of the Ol' Boar Inn. He serves food and drink, and the place has a few rooms that visitors can rent.
...
- The missing adventurers include a fighter (Talgen Hucrele), a wizard ([Sharwyn Hucrele](3-Mechanics/CLI/bestiary/npc/sharwyn-hucrele-tftyp.md)), a paladin of Pelor ([Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md)), and a ranger (Karakas). [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md) was not a local, and he had a magic sword called [Shatterspike](3-Mechanics/CLI/items/shatterspike-tftyp.md).  
...
If the characters are anywhere between Oakhurst and the Sunless Citadel at night, four [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) attack the party. The blights attack stealthily from out of nearby foliage.
...
> 
> Though the kobolds (areas 13–24) and the goblins (areas 31–41) claim the Sunless Citadel as their property, they've never visited all its chambers. They avoid entering the most secluded parts of the grove level. In the past, they feared that the hidden grove was haunted. With the arrival of [Belak the Outcast](3-Mechanics/CLI/bestiary/npc/belak-the-outcast-tftyp.md) twelve years ago, that belief is vindicated. He orders the goblins to distribute the midsummer fruit each year, and the goblins obey him out of fear.
> 
...
Drawn by the occasional animal that accidentally falls into the ravine, three [giant rats](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) lurk in the rubble. They try to hide if they become aware of the characters, and they ambush the first character who arrives on the ledge without being quiet about it.
...
Each time a creature falls into a cavity, the noise is 10 percent likely to draw `1d4` [giant rats](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) from the dozens that infest the rubble field. Attracted rats move carefully and stealthily through the rubble to attack.
...
The pit contains two goblin skeletons, one goblin that has been dead for about a day, and one live [giant rat](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md). The rat, which slipped into the pit to feed on the fresh goblin but was caught when the trap reset, attacks creatures inside the pit or climbs out to attack those nearby.

#### Treasure

The goblin corpse has a [scimitar](3-Mechanics/CLI/items/scimitar-xphb.md) and a [shield](3-Mechanics/CLI/items/shield-xphb.md), as well as 23 sp and 4 gp in a belt pouch.
...
The skeletons date back to the time before the citadel plunged into the earth. That calamity killed all three archers, at the same time instilling in them the curse of undeath. If anyone enters this chamber, the three [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) animate, pinpoints of red fire sparkling in their eye sockets as they rise.

#### Treasure

Each skeleton has twenty arrows, `2d10` sp, `1d10` gp, and one [+1 arrow](3-Mechanics/CLI/items/1-ammunition-xdmg.md) in a special socket on the quiver. Because the skeletons are mindless, they don't use the magical arrows.
...
The door that is carved to look like a dragon has a mechanical lock as well as an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell cast on it. The Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to defeat the arcane lock is DC 30, and the Dexterity check to bypass the magical lock using thieves' tools is DC 25. Casting a [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell on the door suppresses the magical lock for 10 minutes, lowering the DCs by 10 during that time. The mechanical lock remains intact if the magical lock is bypassed, requiring another [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or the use of the key. The key, which bypasses the magical lock as well as the mechanical one, is in area 21.

#### Creature

One [giant rat](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) hides in the rubble. The rat attacks anyone who moves to within 5 feet of the edge of the rubble or anyone left alone in this area.
...
If a creature moves within 5 feet of the dragon statue, a [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spell causes the dragon to utter a riddle in Common (to viewers, it seems as though the stone jaws are actually moving). The dragon's riddle is as follows:
...
A [quasit](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md) named [Jot](3-Mechanics/CLI/bestiary/npc/jot-tftyp.md) was bound in the southwestern alcove an age ago to guard the contents of the sarcophagus in area 12. It was in suspended animation until a few decades ago, and it now waits on the other side of the arch just out of sight in area 12. [Jot](3-Mechanics/CLI/bestiary/npc/jot-tftyp.md) is alerted by any light source the characters have, so it can prepare for them. (If the characters have no light source and are stealthy, [Jot](3-Mechanics/CLI/bestiary/npc/jot-tftyp.md) might not become aware of them.) The quasit darts out of its hiding place and attacks the first creature that climbs out of the pit on the western side.

#### Development

[Jot](3-Mechanics/CLI/bestiary/npc/jot-tftyp.md) doesn't fight to the death. If it takes any damage, or if more than one character attacks it, [Jot](3-Mechanics/CLI/bestiary/npc/jot-tftyp.md) laughs and says, "You broke the binding. My watch over the [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) is over!" It uses its next action to become [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible). It then turns into a bat and flies along the 10-foot-high ceiling across the pit.

If [Jot](3-Mechanics/CLI/bestiary/npc/jot-tftyp.md) escapes, the characters might see it again. It knows that death on the Material Plane means a return to the Abyss, so it prefers to harass the characters while they are otherwise engaged, laughing and mocking as it does so.
...
If the southern wall is cleared of dust, the runes are revealed to be a message in Draconic. Someone who can read the language understands it as "A [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) entombed alive for transgressions of the Law still retains the honor of his position."
...
The greenish fire is a [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spell.
...
Inside, a [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) lies imprisoned, kept alive by virtue of a [sequester](3-Mechanics/CLI/spells/sequester-xphb.md) spell that is dispelled with a flash of green light when the sarcophagus is opened. If the characters look inside, read:
...
This [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) delved into magic that the dragon cult deemed profane—he permanently transformed himself from an elf into a troll. For this crime, the cult entombed him alive, though the honor of his station remained. The [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) attacks his rescuers, his mind all but transformed to that of a troll over the ages of his burial. He had a name, but he has forgotten it, although he has not forgotten how to speak Elvish and Draconic.

#### Creature

In his current state, the [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) is slower and weaker than a normal troll. Use [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) statistics, but the [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) starts with 30 hit points, regenerates only 5 hit points per round (up to normal for a troll), and can't use Multiattack. If he is defeated in this state, the [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) is worth 450 XP.

#### Development

The [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) won't pursue fleeing characters. Instead, he continues to repose in his tomb until hunger finally draws him forth to hunt five days later. By that time, he uses the normal troll statistics, retaining his additional languages.

#### Treasure

The [dragonpriest](3-Mechanics/CLI/bestiary/npc/dragonpriest-tftyp.md) has an ornate ceremonial dagger (worth 125 gp), two silver rings (15 gp each), and a silver amulet (15 gp). Scattered across the bottom of the sarcophagus are 220 sp, 50 gp, and four [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md): [command](3-Mechanics/CLI/spells/command-xphb.md), [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md) (2nd level), [inflict wounds](3-Mechanics/CLI/spells/inflict-wounds-xphb.md) (2nd level), and [guiding bolt](3-Mechanics/CLI/spells/guiding-bolt-xphb.md) (2nd level).
...
> | dice: d20 | Encounter |
> |-----------|-----------|
> | 1 | `1d6` [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) |
> | 2 | `1d6` [giant rats](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) |
> | 3 | `1d4` [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) |
> | 4 | `1d2` [hobgoblins](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) |
> | 5 | `1d4` [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) |
> | 6 | `1d6` [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) |
> | 7–20 | No encounter |
> ^encounter
^random-encounters
...
If the keg is breached, the [ice mephit](3-Mechanics/CLI/bestiary/elemental/ice-mephit-xmm.md) and the [steam mephit](3-Mechanics/CLI/bestiary/elemental/steam-mephit-xmm.md) confined within it are released. The creatures attack anyone who has disturbed the keg.
...
Until recently, the kobolds confined a [white dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/white-dragon-wyrmling-xmm.md) in the cage and placed it under heavy guard. Those guards were not strong enough to stand against a sortie by goblins that stole the wyrmling a week ago.

![](3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-the-sunless-citadel/img/003-totyp-01-04.webp#center)

#### Creature

Meepo, the [kobold](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) who was his tribe's Keeper of Dragons, is now the sole occupant of the chamber. He is heartsick at the loss of the wyrmling and spends much of his time nowadays in nightmare-ridden sleep in his bedroll. With the loss of his charge, Meepo's status is in the gutter. He doesn't react to anything short of loud noise or direct prodding.

If he is disturbed, Meepo is frightened but willing to talk. He is weepy. His numerous obvious scars are souvenirs of his job as Keeper of Dragons. If he is asked about the cage or queried in any way that mentions a dragon, he says, "The clan's dragon... we lost it. The wretched goblins stole [Calcryx](3-Mechanics/CLI/bestiary/npc/calcryx-tftyp.md), our dragon!"

To all other questions, Meepo responds by saying, "Meepo don't know, but [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) does. Meepo take you to meet [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md), our leader, if you make nice. You get safe passage, if you promise to make nice. Maybe if you promise to rescue dragon, [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) make nice to you, answer questions."
...
The room serves as a barracks and guard post for the kobold tribe's warriors. Three [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) stand guard inside, unless they have already come forth to reinforce other kobolds.

If the characters try to talk and the interaction is successful, the kobolds direct the characters to head toward "[Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) on her dragon throne," giving them simple directions to area 21 and warning them to avoid rousing the ire of [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md)'s elite guards.
...
The rats are used as food for the dragon wyrmling that was once stabled in area 15. Since the abduction of the dragon, the kobolds have neglected the rats, and in the meantime the rodents have chewed away the fastenings of the barrier. One round after someone opens the door, the rats knock the barrier over and rush out, attacking as a [swarm of rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) for 1 round, after which they disperse into the dungeon.
...
Four [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) are chained here, taken prisoner during the course of several skirmishes. Every so often, the kobolds remove a goblin from the room and ransom it back to the goblins (for a price of `2d10` sp). Those who can't be ransomed are bound for the kobold cook pot. The goblins whine and cower pathetically if any characters enter the room. A character who succeeds on a DC 15 Dexterity check using thieves' tools can open the lock on the chains, or the chains can be broken (Strength DC 20) or sundered (AC 15, 60 hit points).
...
An elite squad of three [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) (each with 7 hit points) patrols the hall, considering the duty an honor. The guards pay particular attention to the door that leads to area 24, which is along the route traditionally used by goblin raiders. These kobolds react to the character's presence in the same way as the ordinary ones described in area 16. If the characters head for area 21 without causing hostilities, these guards follow the characters into [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md)'s presence.

#### Development

If combat erupts here, the result is likely to be deadly for the party. Any kobolds remaining in the areas nearby enter the room as reinforcements. [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) and her two guards arrive from area 21 at the start of the second round of combat. At the start of the fifth round, the kobolds in the area 16 to the southwest of this room come on the scene. At the start of the eighth round, the kobolds from area 23 enter the fray. (Kobolds that leave their original area and are slain here should be noted for possible future reference.)
...
Twenty-four kobolds occupy the room, but only three [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) are capable warriors that challenge unescorted intruders. Seven other kobolds are [commoners](3-Mechanics/CLI/bestiary/humanoid/kobold-commoner-tftyp.md), but with 3 hit points each, and a −1 reduction to hit and damage compared to the "Monster Manual" statistics. The other tribe members here are too young, too old, or too cowardly to defend themselves; they flee if combat breaks out and are worth no XP. Even the kobolds capable of fighting run away if they are outmatched.

The kobolds here answer all questions with a quick "[Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) knows."
...
Normally sitting on the throne is the kobolds' leader, [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) (see appendix B). Two elite [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) (7 hit points each) guard her. Those who come to [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md)'s chamber can talk to her; she is hostile only if she knows that the characters have slain other kobolds. Characters who antagonize her while talking earn the leader's ire and a savage attack.

[Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) can speak to the following questions:

![](3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-the-sunless-citadel/img/004-totyp-01-05.webp#center)

> [!note] 
> 
> *Why are kobolds in this place?* "Kobolds are heir to dragons. As the mightiest among my people, I have led a brave few to this ancient holy site, where dragons were worshiped long ago." [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) knows nothing else about the history of the fortress, except the name of the dragon that was once revered here, which is Ashardalon.
> 
...
> 
> *What about the stolen wyrmling dragon?* "The goblins stole our dragon! If you return [Calcryx](3-Mechanics/CLI/bestiary/npc/calcryx-tftyp.md) to us, I shall grant you a reward. Meepo can accompany you if you desire."
^098

If the characters decide to go looking for the dragon, the kobolds direct them toward the passage that connects area 15 and area 25, which is the "back way" into goblin territory. [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) and her followers know nothing useful about the goblin lair. If the characters take Meepo with them, he can serve as their guide to that location. If Meepo goes along and is slain, the kobolds count it as a small loss as long as the dragon is rescued.

Possible rewards include the key in the carved dragon's mouth, or any two of the items on the altar. [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) is also willing to sell the key for 50 gp.

#### Development

If hostilities break out, reinforcements arrive in the manner described in area 19.

If the characters return [Calcryx](3-Mechanics/CLI/bestiary/npc/calcryx-tftyp.md), [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) can be convinced to aid them in an assault on the remaining goblins. You determine the nature of the aid.

#### Treasure

The key clenched in the mouth of the carved dragon opens the door to area 7. [Yusdrayl](3-Mechanics/CLI/bestiary/npc/yusdrayl-tftyp.md) has keys to area 18 and the chains there, a key to the doors in area 24, and a key that once fit the cage in area 15. She also has 35 gp.

The items assembled on the altar include a [Quaal's feather token (tree)](3-Mechanics/CLI/items/quaals-feather-token-tree-xdmg.md), three [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) ([mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md), [spider climb](3-Mechanics/CLI/spells/spider-climb-xphb.md), and [knock](3-Mechanics/CLI/spells/knock-xphb.md)), and a small flask that contains three doses of [elixir of health](3-Mechanics/CLI/items/elixir-of-health-xdmg.md).
...
If they have not come forth as reinforcements, three [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) camp here, serving as hunters and guardians of the tunnel. They react as described in area 16.
...
The locked door opens only when someone targets it with a [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or an effect that turns undead. If someone does so, the door glows ghostly blue and swings open silently.
...
Five [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) emerge en masse from the sarcophagi to attack those who disturb the altar or open any sarcophagus. These creatures pursue characters who flee.

#### Treasure

The candle has a [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spell cast on it. In the flask is a [potion of fire resistance](3-Mechanics/CLI/items/potion-of-fire-resistance-xdmg.md). The whistle, made of crystal, has the name [Night Caller](3-Mechanics/CLI/items/night-caller-tftyp.md) inscribed on it in Dwarvish. See appendix A for a description of this item. A secret compartment in the shrine, requiring a successful DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check to find, holds a coffer containing six peridot jewels carved in a likeness of a dragon (worth 10 gp each).
...
The two southernmost cells and the one to the northeast contain abandoned giant rat nests. One [giant rat](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) lives in each of the other cells. Any noise or light in the area attracts all three creatures.
...
The dry fountain on the northern wall looks remarkably like the one described in area 26. Under the scrutiny of a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell, the fountain emits a faint aura of evocation. A successful DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check reveals suspicious metallic tubes in the carved dragon's mouth, as well as a small, rusted iron canister. A character who makes a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notices a mostly worn-away inscription in Draconic on the front of the basin. It reads, "Let there be death."
...
Three [giant rats](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) occupy the area, along with a monstrously swollen female diseased giant rat (Medium [6 feet long], 16 hit points, `+5` to hit, challenge rating 1/4 [50 XP]) that the goblins call [Guthash](3-Mechanics/CLI/bestiary/npc/guthash-tftyp.md) (Bloated One). The giant rats that hunt in the Sunless Citadel all descend from her. These creatures attack and attempt to eat all trespassers.

#### Treasure

Poking through the refuse over a period of 10 minutes uncovers 312 sp, 68 gp, and 3 gems (worth 25 gp each). On and around the ranger's corpse are several items: [studded leather armor](3-Mechanics/CLI/items/studded-leather-armor-xphb.md), five [daggers](3-Mechanics/CLI/items/dagger-xphb.md), a [longbow](3-Mechanics/CLI/items/longbow-xphb.md), a [backpack](3-Mechanics/CLI/items/backpack-xphb.md) (containing a [water skin](3-Mechanics/CLI/items/waterskin-xphb.md), one day's [rations](3-Mechanics/CLI/items/rations-xphb.md), a [bedroll](3-Mechanics/CLI/items/bedroll-xphb.md), a [tinderbox](3-Mechanics/CLI/items/tinderbox-xphb.md), and three [torches](3-Mechanics/CLI/items/torch-xphb.md)), a [quiver](3-Mechanics/CLI/items/quiver-xphb.md) with six arrows, a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), and a pouch that holds 17 gp. A gold ring (worth 10 gp) on Karakas's finger is engraved (in Common) with his name.
...
Two [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) in area 32 pop up over the wall if they are alerted to the characters' presence. The creatures use ranged attacks as the characters move through the hall.

#### Treasure

About two hundred [caltrops](3-Mechanics/CLI/items/caltrops-xphb.md) are strewn on the floor.
...
Two [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) are stationed behind the rough, 3-foot-high wall. They are hostile to intruders, but unwilling to die facing a superior force. If captured, these goblins know the same information that [Erky Timbers](3-Mechanics/CLI/bestiary/npc/erky-timbers-tftyp.md) in area 34 does.
...
The three [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) assigned to watch the room spend some of their time shooting at the hair-and-fur-filled burlap dummies that look vaguely like humans and elves. The rest of the time they drink too much goblin wine.
...
> 
> *What about the lost human adventurers?* "The goblins caught three of them over a month ago, and they were captives with me in here for a while. They said their names were Talgen, Sharwyn, and [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md). The goblins kept them in here only about a week before they removed them. Belak wanted them, and that's the last I've heard about that."
^0d3

#### Development

If the characters fail to suggest it, [Erky Timbers](3-Mechanics/CLI/bestiary/npc/erky-timbers-tftyp.md) asks to join the party as a temporary member. The gnome serves as a loyal friend. Currently, though, he has no gear. Those who free Erky gain XP as if they defeated him in combat.
...
Three [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md), who proudly call themselves bandits, are in the room when the characters enter. In better times, two or more bandit groups would hunt the Old Road together, preying on travelers. Now, the bandits content themselves with an occasional hunt in the wilds of the Underdark (see area 43), as well as preying on the kobolds.
...
[Calcryx](3-Mechanics/CLI/bestiary/npc/calcryx-tftyp.md), the [white dragon wyrmling](3-Mechanics/CLI/bestiary/dragon/white-dragon-wyrmling-xmm.md), is initially out of view, resting behind a broken table. The goblins used the iron chain to bind her, but she broke free and rampaged through the room, destroying the floor displays. Balsag, the bugbear responsible for capturing the dragon, hasn't returned to bring her under control, and the other goblins fear to enter.
...
Thirty-four goblins are at home when the characters arrive, but only four of the [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) are warriors. Ten of the other goblins are [commoners](3-Mechanics/CLI/bestiary/humanoid/goblin-commoner-tftyp.md), but with 3 hit points each and a −1 reduction to hit and damage compared to the "Monster Manual" statistics. The other twenty creatures are noncombatants, too feeble or too fearful to defend themselves; they try to flee through the northernmost or the eastern exit. This stampede should dominate the first moments of battle, and even the goblins capable of fighting refuse to stick around just to lose their lives. Noncombatants are worth no XP.

These goblinoids know the same information, in cruder form, that Erky in area 34 knows.

#### Development

An attack on the goblins brings reinforcements from area 36 and warns the goblin chief in area 41 that something is amiss. [Grenl](3-Mechanics/CLI/bestiary/npc/grenl-tftyp.md), the goblin shaman in area 41, might emerge to protect the tribe.
...
The chief of the Durbuluk tribe is [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md), a [hobgoblin](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md). He wears splint armor (AC 19) and has 18 hit points, a +4 bonus to hit, a +1 bonus to damage, and Strength 15 (+2). These changes raise his challenge rating to 1 (200 XP). When not in combat, [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) sits on the throne, and three other [hobgoblins](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) stand nearby or lounge on stone benches.

The shaman [Grenl](3-Mechanics/CLI/bestiary/npc/grenl-tftyp.md) advises the chief. She is a [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) with 10 (`3d6`) hit points, a Wisdom of 13 (+1), and the following trait:

##### Spellcasting

[Grenl](3-Mechanics/CLI/bestiary/npc/grenl-tftyp.md) is a 1st-level spellcaster. Her spellcasting ability is Wisdom (spell save DC 11, `+3` to hit with spell attacks). She has the following cleric spells prepared:

Cantrips (at will): [poison spray](3-Mechanics/CLI/spells/poison-spray-xphb.md), [thaumaturgy](3-Mechanics/CLI/spells/thaumaturgy-xphb.md)

1st level (2 slots): [bane](3-Mechanics/CLI/spells/bane-xphb.md), [inflict wounds](3-Mechanics/CLI/spells/inflict-wounds-xphb.md)

A [twig blight](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md), a gift from [Belak the Outcast](3-Mechanics/CLI/bestiary/npc/belak-the-outcast-tftyp.md) and a pet of [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md)'s, is in the stone pot, and goblins from area 40 occasionally enter the chamber to see to the needs of the tribe's elite that languish here.

#### Development

[Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) has a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and two vials of [antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md). [Grenl](3-Mechanics/CLI/bestiary/npc/grenl-tftyp.md) has a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [faerie fire](3-Mechanics/CLI/spells/faerie-fire-xphb.md) and another of [expeditious retreat](3-Mechanics/CLI/spells/expeditious-retreat-xphb.md).
...
[Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) can't surrender for fear of losing face. He won't give up if the opposition includes kobolds. Otherwise, he might call for parley if doing so allows him to avoid death. But he must still look strong while negotiating, so he's unwilling to capitulate in an arrangement that makes him look weak.

Because [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) and his hobgoblins usurped control of the Durbuluk tribe, [Grenl](3-Mechanics/CLI/bestiary/npc/grenl-tftyp.md) hates them. She also wants to protect her tribe, so she is willing to negotiate a truce if [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) falls. [Grenl](3-Mechanics/CLI/bestiary/npc/grenl-tftyp.md) also hates and envies Belak, and she wants him gone from the citadel so she can control the Gulthias Tree.

If captured and interrogated, the goblinoids here know what Erky in area 34 knows, with the following addition: Belak wanted all the living human prisoners sent down to him, but in a fit of anger, [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) slew Talgen. Thus, [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) sent only Sharwyn and [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md) down to the Twilight Grove.
...
In addition to the valuables mentioned in the "Development" section, [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md) wears Talgen's gold signet ring (worth 20 gp) and [splint armor](3-Mechanics/CLI/items/splint-armor-xphb.md), which is identifiable by the Hucrele family crest worked into the chest pieces. The chief also has the key to his iron chest. [Grenl](3-Mechanics/CLI/bestiary/npc/grenl-tftyp.md) has keys to areas 34 and 37. One of the other hobgoblins wears silver earrings set with moonstones (20 gp each), and another wears a matching necklace (50 gp).

Inside [Durnn](3-Mechanics/CLI/bestiary/npc/durnn-tftyp.md)'s iron chest are 231 gp and two onyx gems (30 gp each).
...
Two robed [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) (AC 12) serve Belak by tending a fungus garden, using shovels and a rusted wheelbarrow to turn the soil and spread compost. In addition, two mature [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) are rooted in the garden. The twig blights ambush intruders that aren't goblinoids, and the skeletons attack (with shovels, `1d6` bludgeoning damage) anything that the twig blights target.
...
Balsag the [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) and his two [giant rat](3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) "hounds," named Grip and Fang, reside in a natural stone chamber when they're not hunting (25 percent chance of being absent when characters arrive). The bugbear wears a crown of antlers on his head to enhance his frightening appearance. Balsag considers all non-Durbuluk creatures to be potential prey, so he attacks any he meets, roaring in Goblin, "Get ready to meet the cook pot!"
...
In the glowing hall rests a [fire snake](3-Mechanics/CLI/bestiary/elemental/salamander-fire-snake-xmm.md). Belak used magic to call the creature forth and hopes to train it to be a loyal servant before it matures.
...
One pile of herbs and supplies in the main chamber contains the ingredients of a [healer's kit](3-Mechanics/CLI/items/healers-kit-xphb.md). An assortment of tools and herbs can be salvaged to make up a [herbalism kit](3-Mechanics/CLI/items/herbalism-kit-xphb.md) and a set of [alchemist's supplies](3-Mechanics/CLI/items/alchemists-supplies-xphb.md).

#### Northwest Chamber

Snores are audible from the room to the northwest, which is a rough barracks. Sixteen small pallets of matted fur cover the floor. Two pallets currently hold a sleeping [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) and two [goblin commoners](3-Mechanics/CLI/bestiary/humanoid/goblin-commoner-tftyp.md) (like those in area 40).

#### Southwest Chamber

The goblins use a crude mashing, straining, and casking facility to create goblin wine, which they and Belak are quite fond of. Two [goblin commoners](3-Mechanics/CLI/bestiary/humanoid/goblin-commoner-tftyp.md) currently stand barefoot in the mashing-tun, squashing roots and fungi into pulp. A dirty straining bin stands nearby, as well as ten 2-gallon casks of the end product.

#### North Central Chamber

Two [goblin commoners](3-Mechanics/CLI/bestiary/humanoid/goblin-commoner-tftyp.md) currently repair dirty goblin armor with cord, iron needles, leather patches, and other crude implements of tailoring.

#### South Central Chamber

One [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) and two [goblin commoners](3-Mechanics/CLI/bestiary/humanoid/goblin-commoner-tftyp.md) monitor the health of a diseased giant rat, which is strapped spread-eagled onto a wooden bench. The rat suffers from horrible tumors that look woody and fruit-like. Its tumors stem from an elixir Belak created to infuse twig blight traits into giant rats.
...
Extra weapon stores include five battered [scimitars](3-Mechanics/CLI/items/scimitar-xphb.md), six [shortbows](3-Mechanics/CLI/items/shortbow-xphb.md), and forty [arrows](3-Mechanics/CLI/items/arrows-20-xphb.md).
...
A [bugbear gardener](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) roams both galleries, tending the grasses for Belak. She is armed with a sickle-bladed glaive; she has a reach of 10 feet and deals `2d10 + 2` slashing damage with it.

#### Treasure

The bugbear carries a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
A [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) and three [goblin commoners](3-Mechanics/CLI/bestiary/humanoid/goblin-commoner-tftyp.md) gather fungus for use in area 47.

#### Southeast Arboretum

Several growths in the chamber are scorched and dead. Fungus shrouds holes similar to those found in area 45, and a [fire snake](3-Mechanics/CLI/bestiary/elemental/salamander-fire-snake-xmm.md) lurks inside one of these openings. It emerges if anyone pokes into or closely examines the holes. If the snake comes out, a character who reaches into the snake's burrow can recover two sapphires (worth 50 gp each).

#### Northeast Arboretum

Three [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md)—AC 12, 3 (`1d6`) bludgeoning damage with shovels or rakes—are at work, clearing scorched plants. One [twig blight](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md), which is hostile to the adventurers, is with them. The skeletons attack anything the twig blight attacks.
...
Viewed in white light, the circular tile is red. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell can reveal that the tile and statue give off an aura of transmutation. The runes on the tile's inner edge read, in Draconic, "Let the sorcerous power illuminate my spirit." If anyone speaks this sentence aloud while standing on the tile, a puff of spectral flame harmlessly envelops the speaker, granting the target advantage on Charisma checks for 24 hours. Once the tile is activated, it is dormant for 24 hours.

#### Creature

A [shadow](3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) hides in the gloom behind the dragon statue. It attacks only those who spot it or who attempt to investigate the circular tile or claim the treasure. The creature doesn't pursue those who flee.

#### Treasure

A loose stone is in the wall behind the statue, requiring a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check to find. Inside are 34 gp and two [flasks of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md).
...
Rooting around in the wreckage, separate successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks uncover a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [scorching ray](3-Mechanics/CLI/spells/scorching-ray-xphb.md), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Melf's acid arrow](3-Mechanics/CLI/spells/melfs-acid-arrow-xphb.md), and a tome of dragon lore bound in dragon scale and written in Draconic (worth 150 gp).
...
In his study, Belak stores seasonal records of growth, precipitation, harvests, and similar notes for the surrounding lands for the last dozen years. One interesting tome titled (in Draconic) *Treasures of the Fire Lords* has a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) spell with an explosive runes effect on it. The glyph is on the second page, and it's triggered when someone opens to that page. Otherwise, the book is blank.
...
Separate successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks uncover a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [entangle](3-Mechanics/CLI/spells/entangle-xphb.md), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [protection from poison](3-Mechanics/CLI/spells/protection-from-poison-xphb.md), and a tome on druidic theories on the cycle of life and death (worth 150 gp). Cubbyholes in the desk hold 365 gp and four agate gems (20 gp each).
...
Four [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) sort the specimens for Belak. They are hostile to intruders. If things go badly for them, they cry out in Goblin, saying, "Aid us, Protector of the Twilight Grove!"

#### Development

Sometimes the twig blights in area 55 attack the goblins out of sheer malice. Thus, a call from the goblins doesn't bring all the forces of the cavern down on the characters. But if the goblins do call, four [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) arrive from area 55 and attack.
...
[Belak the Outcast](3-Mechanics/CLI/bestiary/npc/belak-the-outcast-tftyp.md) spends much of his time studying the Gulthias Tree, but he is well aware when the characters are approaching. He is a human [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md), and he has the following spells prepared:

Cantrips (at will): [druidcraft](3-Mechanics/CLI/spells/druidcraft-xphb.md), [poison spray](3-Mechanics/CLI/spells/poison-spray-xphb.md), [shillelagh](3-Mechanics/CLI/spells/shillelagh-xphb.md)

1st level (4 slots): [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md), [entangle](3-Mechanics/CLI/spells/entangle-xphb.md), [faerie fire](3-Mechanics/CLI/spells/faerie-fire-xphb.md), [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md)

2nd level (3 slots): [barkskin](3-Mechanics/CLI/spells/barkskin-xphb.md), [flaming sphere](3-Mechanics/CLI/spells/flaming-sphere-xphb.md)

Standing with [Belak](3-Mechanics/CLI/bestiary/npc/belak-the-outcast-tftyp.md) are [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md) and [Sharwyn Hucrele](3-Mechanics/CLI/bestiary/npc/sharwyn-hucrele-tftyp.md) (both described in appendix B). Belak's [giant frog](3-Mechanics/CLI/bestiary/beast/giant-frog-xmm.md), Kulket, lurks stealthily in the branches of the Gulthias Tree. A character who has a passive Perception score of 15 or higher or succeeds on a DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check spots the frog. If combat breaks out, the frog jumps down and joins the fight in the second round. Three [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) are here, too.

#### Interaction

When the characters arrive, [Belak](3-Mechanics/CLI/bestiary/npc/belak-the-outcast-tftyp.md) says loudly, "Hold a moment, you know not what you do!" If the characters engage him in conversation, he can share the following information:
...
While this interaction proceeds, [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md), the three twig blights, and Belak's frog position themselves between the characters and Belak (Sharwyn stands next to Belak).

#### Combat

If a fight breaks out (which will happen unless the characters actually submit to Belak), the [twig blights](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md), the [frog](3-Mechanics/CLI/bestiary/beast/giant-frog-xmm.md), and [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md) attack the characters physically. [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md) uses [Shatterspike](3-Mechanics/CLI/items/shatterspike-tftyp.md) (see appendix A) to destroy his foe's weapon, if possible.

[Belak](3-Mechanics/CLI/bestiary/npc/belak-the-outcast-tftyp.md) casts [barkskin](3-Mechanics/CLI/spells/barkskin-xphb.md) on himself, possibly before melee occurs. He also makes early use of his [wand of entangle](3-Mechanics/CLI/items/wand-of-entangle-tftyp.md) (see appendix A), attempting to hold the transgressors in place. If Braford looks like he needs healing, Belak casts healing spells on him, as well. [Sharwyn](3-Mechanics/CLI/bestiary/npc/sharwyn-hucrele-tftyp.md) uses her repertoire of spells to best advantage, resorting to her dagger only in desperation.
...
A successful DC 15 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check or Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) or [Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check allows a character to deduce that destroying the tree might have an effect on [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md), Sharwyn, and the twig blights. If anyone attacks the Gulthias Tree, Belak and the twig blights try to kill the aggressor. If the Gulthias Tree dies, Belak loses his influence over the twig blights, Sharwyn, and [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md). These monsters turn on Belak before targeting the characters again.
...
Belak has a key (to area 53), three [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), two doses of [antitoxin](3-Mechanics/CLI/items/antitoxin-xphb.md), and his [wand of entangle](3-Mechanics/CLI/items/wand-of-entangle-tftyp.md). Sharwyn wears her gold Hucrele signet ring (worth 20 gp).
...
In addition, if the characters return the Hucrele signet rings to the family matriarch, they receive the promised monetary award. If they bring back the remains of Sharwyn and [Sir Braford](3-Mechanics/CLI/bestiary/npc/sir-braford-tftyp.md), the matriarch begins funeral arrangements and invites the characters to attend. If they accept, they can begin to establish a long-term relationship with the Hucrele family, which can prove useful in later adventures.