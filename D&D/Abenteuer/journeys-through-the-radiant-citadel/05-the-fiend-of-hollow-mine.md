...
![Ghouls drag a fresh victim into the depths of Hollow Mine](3-Mechanics/CLI/adventures/journeys-through-the-radiant-citadel/img/029-04-001-ghouls.webp#center)
...
The characters approach Milpazul at the same time as a group of bounty hunters searching for the outlaw [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md). The man on horseback is the group's lookout; when he sees the characters, he assumes they're either a rival band of bounty hunters or [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md)'s bandit allies. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 12 or higher notice a trail of dust rising from the opposite side of the village, suggesting a group entering the community.

### Ambush at the Archway

As the characters reach the archway entrance to the village, the character who has the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score is the first to notice something is wrong:
...
Seven bounty hunters (use the [scout](3-Mechanics/CLI/bestiary/humanoid/scout.md) stat block) shoot from behind the waist-high wall, which grants them half cover against anyone attacking from the other side. They draw shortswords if the characters close for melee. If three of the bounty hunters fall, the survivors quickly retreat to their nearby [riding horses](3-Mechanics/CLI/bestiary/beast/riding-horse.md) and flee the village.
...
A character who examines a villager with sereno and succeeds on a DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) or Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check determines that sereno is not a disease but a curse.

#### Sereno

Sereno is a deadly magical affliction that inflicts a supernatural chill on its victims and eventually kills them. A creature cursed with sereno is [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned), can't regain hit points, and must make a DC 13 Constitution saving throw at the end of every hour, gaining 1 level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) on a failed save. The creature automatically succeeds on this saving throw if it is in sunlight. Sereno can be undone by magic that ends poison or disease, like [lesser restoration](3-Mechanics/CLI/spells/lesser-restoration.md), but only while the victim is in direct sunlight.
...
The dwarves are revolutionaries ([veterans](3-Mechanics/CLI/bestiary/humanoid/veteran.md)) who hang out in the tavern to protect [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md). They won't engage the characters unless [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md) or Rufina is threatened.
...
As conversation dies down, [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md) emerges from a door leading to the cellar and approaches the characters. She is wrapped in a rebozo and suffers from sereno with 3 levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). If the characters threaten to take her for the bounty, the dwarf [veterans](3-Mechanics/CLI/bestiary/humanoid/veteran.md) rush to protect her, and Rufina warns the characters that not just the villagers, but the folk of the entire region, will turn against them if they proceed.

![Paloma](3-Mechanics/CLI/adventures/journeys-through-the-radiant-citadel/img/030-04-002-paloma.webp#center)

#### Paloma

[Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md) (chaotic good, gnome [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin.md)) leads a band of revolutionaries in the borderlands around San Citlán. She was falsely accused of rustling, defended herself from the unjust arrest, and was charged with attempted murder as a result. She fled to the Indigo Desert and joined an outlaw band, quickly climbing the ranks to become the leader. While traveling across the region, [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md) saw many injustices. She has recently allied with local revolutionaries opposing exploitation and corruption in the region, and she is already considered one of the revolutionaries' leaders.
...
- **Wailing Wind.** The structure of the mine and the elevation difference between its shafts funnels a strong wind through the tunnels. Gusts of air hiss and howl, imposing disadvantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks that rely on hearing.  
...
The stone of the mine entrance cavern is crumbling badly, but a character who has the Stonecunning trait or who succeeds on a DC 16 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check can tell the cavern is in no immediate danger of collapsing. See the "Cave-In!" section for details on how that might change.

##### Elevator

The elevator is rusted in place, and the shaft it once traversed is depicted as shaded spaces on map 4.1. A character who examines it and succeeds on a DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check recognizes that the elevator will collapse under any significant weight. If 100 pounds or more is placed on the elevator platform, it collapses. Any creature standing on the platform at the time drops 100 feet into area H5, taking 35 (`10d6`) bludgeoning damage from the fall.
...
A makeshift wooden door blocks the entrance to this chamber. Candlelight shines through the cracks. A character who listens at the door and succeeds on a DC 13 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check hears growling beyond it.

##### Passwall Trap

A 5th-level [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding.md) holding a [passwall](3-Mechanics/CLI/spells/passwall.md) spell is inscribed on the floor in front of the door. Characters can spot the glyph with a successful DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check. If someone opens the door while standing on the glyph, the glyph triggers and casts its spell on the floor around it, opening a pit into area H3. Each creature standing in the shaded spaces in front of the door on map 4.1 falls 30 feet into area H3 and takes 10 (`3d6`) bludgeoning damage. The glyph's effects can be avoided by opening the door from a distance, which prevents the spell from being triggered.
...
This chamber is the workspace of Teocín, a [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cult-fanatic.md) dedicated to Pazuzu. As soon as the characters enter, Teocín releases the two [ghouls](3-Mechanics/CLI/bestiary/undead/ghoul.md) on the tables and joins them as they attack.
...
Teocín uses this chamber to dispose of her failed experiments. Two [ochre jellies](3-Mechanics/CLI/bestiary/ooze/ochre-jelly.md) feed on the remains and are dissolving meals deep under piles of bones. They emerge, oozing up through the bones, as soon as they sense movement.
...
The bookshelves hold a mix of fiction, histories, and more. A character who scans the shelves and succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check finds a spell scroll of [lesser restoration](3-Mechanics/CLI/spells/lesser-restoration.md) and a book containing rituals for the [alarm](3-Mechanics/CLI/spells/alarm.md), [find familiar](3-Mechanics/CLI/spells/find-familiar.md), and [illusory script](3-Mechanics/CLI/spells/illusory-script.md) spells.
...
The symbols scrawled across the walls are in Abyssal and represent omens and prophecies sent by Pazuzu to Itzmin. A character who understands Abyssal or succeeds on a DC 13 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) or [Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check gleans that an innocent creature is being twisted into an envoy of Pazuzu and is spreading corruption through the region.
...
If a character approaches within 10 feet of the altar, the two [skeletons](3-Mechanics/CLI/bestiary/undead/dinosaur-skeleton-jttrc.md) animate and attack. They both use the [allosaurus](3-Mechanics/CLI/bestiary/beast/allosaurus.md) stat block, with these changes:

- They are Undead.  
- They are vulnerable to bludgeoning damage, immune to poison damage, and immune to [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) and the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) condition.  
...
The feathers here are unnatural, and any character who has proficiency in the [Religion](3-Mechanics/CLI/rules/skills.md#Religion) skill can tell they are from a fiendish creature. The claw marks match the marks in area H4. A character who can automatically sense direction or who succeeds on a DC 12 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check knows the tunnel leads south toward San Citlán.
...
A character who succeeds on a DC 14 Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History) or [Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check knows the costumes represent La Catrina, patron spirit of the city; Don Roque, a long-dead politician who became the satirical face of the government; and Los Diablitos, comical renditions of fiends from local fables.

![The living and the dead celebrate the Night of the Remembered in San Citlán](3-Mechanics/CLI/adventures/journeys-through-the-radiant-citadel/img/034-04-004-night-of-the-remembered.webp#center)
...
- A character who has a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 12 or higher notices folk on the street pointing at the sky. If asked, the people say an owl has been flying over the district during daylight—a strange portent on the Night of the Remembered. The characters can determine the owl's course by succeeding on a DC 14 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception) or [Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check, which leads them to Doña Rosa's feather-littered vecindad.  
- A character can show the locket containing Doña Rosa's portrait to passersby. If they do so and succeed on a DC 14 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check, a character finds a local or recognizes the picture and provides directions to Doña Rosa's home.  
- If the characters kept [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md)'s cityscape drawings, they can use it to find the vecindad with a successful DC 14 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check.  

As the characters near the vecindad, folk on the street can direct the party toward the old manor house if the characters show them [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md)'s sketches. If the characters found the half-locket in area H4 of Hollow Mine, they can use a [locate object](3-Mechanics/CLI/spells/locate-object.md) spell to find the other half of the locket once they are within 1,000 feet of the vecindad.
...
If the characters describe the creature they're looking for, Doña Rosa (neutral good, human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner.md)) invites them into her home and tells them there is much they don't know about this fiend. Use the following information to guide the conversation:
...
If the characters don't agree (or if they insist on killing the fiend), Doña Rosa orders them to leave. Learning more from her requires effective roleplaying to win her over, as well as a successful DC 13 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check.
...
A deceased ancestor or loved one provides you with guidance, granting you insight via a "charm" (a type of supernatural gift detailed in the "Dungeon Master's Guide"). You can cast [speak with dead](3-Mechanics/CLI/spells/speak-with-dead.md) during a long rest to contact the spirit of a friend or family member without that spirit's corpse. The spirit's answers to your questions manifest as whispers only you can hear. The charm does not function if the spirit you try to contact is Undead or was the target of [speak with dead](3-Mechanics/CLI/spells/speak-with-dead.md) within the last 10 days. Once you use this charm, it vanishes from you.
...
If Itzmin died or was captured in Hollow, one of his [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cult-fanatic.md) protégés meets [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) in the warehouse and takes Itzmin's place in the following chase. The characters might recognize the protégé from [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md)'s drawings, or Doña Rosa can identify them as one of Itzmin's people.
...
During the chase, a participant can freely use the [Dash](3-Mechanics/CLI/rules/actions.md#Dash) action a number of times equal to 3 + its Constitution modifier. Each additional [Dash](3-Mechanics/CLI/rules/actions.md#Dash) action it takes requires the creature to succeed on a DC 10 Constitution check at the end of its turn or gain 1 level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion). A participant drops out of the chase if its [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) reaches level 5, since its speed becomes 0. A creature can remove the levels of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) it gained during the chase by finishing a short or long rest.

#### Spells and Attacks

A chase participant can make attacks and cast spells against other creatures within range. Apply the normal rules for cover, terrain, and so on to these actions. Chase participants can't normally make [opportunity attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack) against each other, since they are all assumed to be moving in the same direction at the same time.
...
|-----------|--------------|
| 1 | A 20-foot-tall, papier-mâché skeleton puppet walks across the street. Make a DC 10 Dexterity saving throw to avoid being stepped on. On a failed check, you take 5 (`2d4`) bludgeoning damage and fall [prone](3-Mechanics/CLI/rules/conditions.md#Prone). |
| 2 | Fireworks go off nearby. Make a DC 10 Constitution saving throw. On a failed save, you are [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) by smoke until the end of your turn. While [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded), your speed is halved. |
| 3 | Centaur acrobats are performing in your path. Make a DC 15 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check. On a success, they lift you from the waist and speed you forward 30 feet. On a failed check, you fall [prone](3-Mechanics/CLI/rules/conditions.md#Prone). |
| 4 | Peaceful spectral dancers fill the street. Make a DC 15 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check to flow with their movements. On a failed check, they impede your sight and count as 10 feet of "difficult terrain". |
| 5 | A religious procession blocks your way. Make a DC 10 Intelligence ([Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check to recognize their customs and move respectfully among them. On a success, a thankful cleric casts [bless](3-Mechanics/CLI/spells/bless.md) on you. On a failed check, they cast [bane](3-Mechanics/CLI/spells/bane.md) instead (save DC 14). |
| 6–10 | No complication |
^parade-chase-complications

#### Ending the Chase

The chase ends when either side gives up the chase, when Itzmin escapes, or when the pursuers are close enough to catch Itzmin. If neither side gives up the chase, Itzmin makes a Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check at the end of each round, after every participant in the chase has taken its turn. The chase's crowded surroundings give Itzmin advantage on this check. If the lead pursuer has proficiency in [Survival](3-Mechanics/CLI/rules/skills.md#Survival), Itzmin loses advantage. The check's result is compared to the passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) scores of the pursuers.

If Itzmin is never out of the lead pursuer's sight, the check fails automatically. Otherwise, if the result of Itzmin's check is greater than the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score, he escapes. If not, the chase continues for another round.

If the characters catch Itzmin, he tells them where [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) is in exchange for his release. Should Itzmin escape, the character who has the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score sees a spotted owl ([Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) in his owl form) overhead, watching Itzmin. They can follow the owl to the metalworks.
...
A character who has a passive Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) score of 13 or higher can tell that the tlacatecolo's control of [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) is not absolute and deduces that magic might disrupt that control. If [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) is targeted by a [lesser restoration](3-Mechanics/CLI/spells/lesser-restoration.md) or [remove curse](3-Mechanics/CLI/spells/remove-curse.md) spell, the tlacatecolo is forced to leave his body for 5 minutes. During this time, the [tlacatecolo](3-Mechanics/CLI/bestiary/fiend/tlacatecolo-jttrc.md) becomes a separate entity that continues fighting. [Serapio](3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) uses the [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner.md) stat block and keeps out of battle.
...
| dice: d4 | Adventure |
|----------|-----------|
| 1 | A revolutionary asks the characters to rid a mine connected to Los Gavilanes of [ankhegs](3-Mechanics/CLI/bestiary/monstrosity/ankheg.md) so it can be used to smuggle information out of the city. |
| 2 | Intrigued by Marfil Ironworks' signature magical bodyguards ([helmed horrors](3-Mechanics/CLI/bestiary/construct/helmed-horror.md)), a wizard named Montesco hires the characters to capture one. |
| 3 | A spectral olvidado named Don Edelmiro hires the characters for protection after a band of criminal [thugs](3-Mechanics/CLI/bestiary/humanoid/thug.md) raid his estate. He's convinced his descendants are behind the attack. |
| 4 | A street child named Anita approaches the characters for help. Her friends were taken by a [banshee](3-Mechanics/CLI/bestiary/undead/banshee.md) that wanders the streets near the Calaveras River at night. |
