...
![Castle Djaynai monitors the arrival of travelers to the fog-shrouded port of Djaynai](3-Mechanics/CLI/adventures/journeys-through-the-radiant-citadel/img/112-12-001-castle-djaynai.webp#center)
...
Characters who succeed on a DC 16 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) or [History](3-Mechanics/CLI/rules/skills.md#History)) check recognize that the sigils represent the Blackmist Way and the Blackthrone Arts: two local traditions lost during the Passage of Vultures. Any local in the common room or resident of Djaynai who sees a copy of the symbols can identify them and share the basics about these lost traditions–as described in the "Background" section of the adventure.
...
[Atiba-Pa](3-Mechanics/CLI/bestiary/npc/atiba-pa-jttrc.md) (lawful good, human [priest](3-Mechanics/CLI/bestiary/humanoid/priest.md)) is a former Lightsea Lancer and Djaynai's current regent. He is known not only for his falcon-eyed shrewdness but also for his compassion and kindness.
...
Characters who succeed on a DC 14 Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History) or [Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check know the Night Revelers are local philosopher-hedonists who embrace new ideals and oppose the People's Stewards. [Atiba-Pa](3-Mechanics/CLI/bestiary/npc/atiba-pa-jttrc.md) can also share this information. He clearly views the group as misguided and encourages the characters to avoid contact with them.

#### Making Preparations

To help with the characters' journey to Janya, [Atiba-Pa](3-Mechanics/CLI/bestiary/npc/atiba-pa-jttrc.md) is having a sailboat called the *Beden-Moon*, crewed by Lightsea Lancers, prepared to sail at dawn. He also provides each character with a necklace of black cowrie shells. The necklaces are magic items that provide the same benefits as a cloak of the manta ray, except each is activated or deactivated as a bonus action. The necklaces are historic relics of Djaynai, and [Atiba-Pa](3-Mechanics/CLI/bestiary/npc/atiba-pa-jttrc.md) expects to get them back when the characters complete their mission.
...
Mysterious and bright, with a unique mind that rapidly jumps from one subject to the next, [Djeneba](3-Mechanics/CLI/bestiary/npc/djeneba-jttrc.md) (chaotic neutral, human [mage](3-Mechanics/CLI/bestiary/humanoid/mage.md)) is the charismatic voice of the Night Revelers—and a person whose true identity is a mystery to all but the most devoted members of that anarchic group. [Djeneba](3-Mechanics/CLI/bestiary/npc/djeneba-jttrc.md), who speaks with a honeyed tongue that makes others feel understood and embraced, has convinced an increasing number of Djaynaians to embrace the ways of the Night Revelers.
...
As the characters approach, the cheerful Lancer introduces himself as Gurau (neutral good, human [veteran](3-Mechanics/CLI/bestiary/humanoid/veteran.md)). He is friendly and explains that the two have been informed of the characters' mission and are eager to help. His brooding companion, Kisaroua (neutral good, human [veteran](3-Mechanics/CLI/bestiary/humanoid/veteran.md)), encourages the characters to board swiftly so they can embark. Kisaroua is initially sour, but her mood lightens toward characters who help prepare the ship, which requires a successful DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check.
...
After the party descends approximately 3,000 feet, the character who has the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score spots something unexpected:
...
The name *Girscamen* is plainly emblazoned on the ghost ship's hull. As the ship comes alongside the characters, the first mate (use the [wraith](3-Mechanics/CLI/bestiary/undead/wraith.md) stat block) is joined by four crew members who are little more than eerie light and drifting skulls (they use the [flameskull](3-Mechanics/CLI/bestiary/undead/flameskull.md) stat block). At first, it appears they are searching for something—they're hunting for the haints that escaped them, Derek and Violette. Once they see the characters, however, the hostile Undead snarl challenges and attack.
...
![The shadows of aquatic residents flit beneath the iridescent magic that protects the undersea city of Janya](3-Mechanics/CLI/adventures/journeys-through-the-radiant-citadel/img/117-12-004-undersea-janya.webp#center)
...
[Nightsea Chil-liren](3-Mechanics/CLI/bestiary/humanoid/nightsea-chil-liren-jttrc.md) use the [merfolk](3-Mechanics/CLI/bestiary/humanoid/merfolk.md) stat block with the following changes:
...
[Brother Broumane](3-Mechanics/CLI/bestiary/npc/brother-broumane-jttrc.md) tells the characters the location of the Girscamen's wreck if they swear to return any lore they find to him so he can destroy it. When the party returns, a character can fool [Brother Broumane](3-Mechanics/CLI/bestiary/npc/brother-broumane-jttrc.md) by claiming they found nothing and succeeding on a DC 18 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check. If the characters return and give him something that looks like an ancient relic but isn't the lost Djaynaian lore, they can convince him it was all they found with a successful DC 14 Charisma ([Deception](3-Mechanics/CLI/rules/skills.md#Deception)) check.
...
Characters within 10 feet of the *Girscamen* feel a harmless supernatural chill—an effect of the unquiet spirits haunting the ship. If characters succeed on a DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) or [Religion](3-Mechanics/CLI/rules/skills.md#Religion)) check, they can tell restless spirits dwell nearby.
...
This hostile [wraith](3-Mechanics/CLI/bestiary/undead/wraith.md) wears armor similar to that of the wraiths the characters battled previously. It fights to the death.

##### Ancient Art

A character who succeeds on a DC 14 Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History)) check can tell the carved walls and throne are ancient and were perhaps made by the very first Janyans as a way to preserve sacred knowledge in a secure place. A [detect magic](3-Mechanics/CLI/spells/detect-magic.md) spell reveals an aura of abjuration magic around the throne.

##### Lurking Aboleth

In the shadows of the southwest alcove lurks the [aboleth](3-Mechanics/CLI/bestiary/aberration/aboleth.md) Ylch. It doesn't interfere with the wraith's attack and won't initially threaten the characters. Once it is revealed, it telepathically invites the characters to talk. Use the following information to guide the conversation.
...
Inspired by teachings in the Blackmist Way and Blackthrone Arts that ease the distinction between body and soul, this charm allows you to cast the [gaseous form](3-Mechanics/CLI/spells/gaseous-form.md) spell as an action, with no spell components required. Once used three times, the charm goes away.
...
Traditional music in both realms functions to spiritually transfigure listeners. It emphasizes low tones and syncopated rhythms, utilizing stringed instruments such as the [lute](3-Mechanics/CLI/items/lute.md)-like guembri, akoting, and xalam; the musical bow known as the berimbau; and the sonorous atabaque [drum](3-Mechanics/CLI/items/drum.md).
...
| dice: d6 | Adventure |
|----------|-----------|
| 1 | The People's Stewards hope to raise the regent [Atiba-Pa](3-Mechanics/CLI/bestiary/npc/atiba-pa-jttrc.md)'s stormy mood by having the characters recover his famed magical cutlass, stolen by seafaring [assassins](3-Mechanics/CLI/bestiary/humanoid/assassin.md). |
| 2 | A Lightsea Lancer seeks the characters' aid in stopping twin [sahuagin barons](3-Mechanics/CLI/bestiary/humanoid/sahuagin-baron.md) and their band from raiding kelp farms between Djaynai and Janya. |
| 3 | Night Revelers invite the characters to join their seaside festivities, but they unknowingly disturb a coven of [sea hags](3-Mechanics/CLI/bestiary/fey/sea-hag.md). |
| 4 | [Lizardfolk](3-Mechanics/CLI/bestiary/humanoid/lizardfolk.md) marauders raid farms in lands adjacent to Djaynai, and the Lightsea Lancers seek adventurers to help repel them. |
...
| 6 | While visiting Janya, the characters encounter a shipwreck laden with treasure—and [ghosts](3-Mechanics/CLI/bestiary/undead/ghost.md). The spirits wish to be put to rest, but the [adult bronze dragon](3-Mechanics/CLI/bestiary/dragon/adult-bronze-dragon.md) that sank the ship considers them part of its hoard. |
^djaynai-and-janya-adventures
