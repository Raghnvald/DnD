...
![Prince of Vice, Azra Nir, leads Zinda's annual March of Vice festivities—unaware he's just one target of a killer](3-Mechanics/CLI/adventures/journeys-through-the-radiant-citadel/img/041-05-001-march-of-vice-festivities.webp#center)
...
As the characters make their way from the River of Gold to the Court of Flowers, they pass a shadowed alley. Glancing down it, the character who has the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score sees a still figure surrounded by spilled gold coins and slumped against the wall, head tilted to stare at them.

Characters who investigate find a dead dwarf wearing lavish robes. Nearby are 20 gp fallen from an open pouch the dwarf wears. His body shows no wounds, but a character who makes a successful DC 12 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check finds signs of poison. If the check succeeds by 5 or more, the character confirms that the dwarf was killed by burnt othur fumes ("a poison detailed" in the "Dungeon Master's Guide"). The dwarf has been dead for 5 minutes and thus is beyond the help of a [revivify](3-Mechanics/CLI/spells/revivify.md) spell.
...
Before the characters conclude their investigation of the body and the alley, three [veterans](3-Mechanics/CLI/bestiary/humanoid/veteran.md) wearing gold filigreed armor shout for the characters to stay where they are, attacking if the characters flee. These veterans were hired by Madame [Samira Arah](3-Mechanics/CLI/bestiary/npc/samira-arah-jttrc.md), the newest member of the Kings of Coin, to protect the dwarf, but they lost sight of him during the celebrations.
...
The characters see the herbalist who works the stall coughing as he attacks a man on the ground. Characters who have a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 14 or higher also notice a dissipating pink cloud around the figures.
...
The merchant uses the [veteran](3-Mechanics/CLI/bestiary/humanoid/veteran.md) stat block, except his only weapon is a makeshift club—treat it as a longsword that deals bludgeoning damage. He initially focuses his attack on the fallen man but randomly attacks any creature within reach. The merchant has been affected by a poison made by Kala called [biza's breath](3-Mechanics/CLI/items/bizas-breath-jttrc.md) (see the sidebar). A character who succeeds on a DC 14 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check notices that the man's glassy eyes and puppet-like movement suggest he has been drugged in some way. A [protection from poison](3-Mechanics/CLI/spells/protection-from-poison.md) spell or similar magic ends the effect on the merchant.

##### Victim

The man the merchant is attacking is named Arel Avim. He uses the [noble](3-Mechanics/CLI/bestiary/humanoid/noble.md) stat block, has 0 hit points, and is dying.
...
Characters who survey the crowd and succeed on a DC 14 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check note several armed figures focusing more on the tavern patrons than their drinks. These are guards of the Silent Verse assigned by Samira to watch over Nargis and Zenia.
...
[Myx Nargis Ruba](3-Mechanics/CLI/bestiary/npc/myx-nargis-ruba-jttrc.md) (neutral evil, orc [noble](3-Mechanics/CLI/bestiary/humanoid/noble.md)) is one of Zenia's parents and also a King of Coin. Nargis is overseer of the Tavern Keepers Trade and spends much of their time at the Thornapple, the centerpiece of their family's fortune.
...
Two Silent Verse [guards](3-Mechanics/CLI/bestiary/humanoid/guard.md) sit at a table near the stage with Zenia, but they depart to allow the characters to sit if they see Samira's token. The tables near hers are packed with revelers, but the din of conversation makes it easy to talk without being heard.

Zenia greets the characters warmly. She is a gray-skinned orc [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner.md) with her hair braided in elegant loops. She has an easygoing demeanor but is clearly nervous. Zenia is thrilled to meet adventurers and asks about the characters' work and travels. She admits to considering the adventuring life herself but knows that Nargis would never allow it.
...
A character who succeeds on a DC 14 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check suspects Zenia might have been [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) but shook off the effects. Characters who specifically ask about a woman matching Kala's description and who succeed on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check cause Zenia to recall that the figure who bumped into her matches that description. Zenia doesn't know who the woman is, though, and can't name her.
...
> 
> "That's [Diva Luma](3-Mechanics/CLI/bestiary/npc/diva-luma-jttrc.md) and the Elucidarium Divas!" Zenia says, nodding to the dark-skinned woman leading the group, whose outfit is all sequins and bright feathers.
> 
> The divas wave and proceed to the stage. There, [Diva Luma](3-Mechanics/CLI/bestiary/npc/diva-luma-jttrc.md) pulls a small silk bag from her belt and hurls its contents upward, standing amid a rain of colorful glitter as the performance begins.
> 
> A moment later, the [diva](3-Mechanics/CLI/bestiary/humanoid/diva-jttrc.md)'s expression changes. [Diva Luma](3-Mechanics/CLI/bestiary/npc/diva-luma-jttrc.md) grins cruelly, slips off her heeled shoes, and leaps toward Zenia.
^189

![Divas attack the crowd at the Thornapple during their March of Vice performance](3-Mechanics/CLI/adventures/journeys-through-the-radiant-citadel/img/045-05-005-divas-attack.webp#center)

Kala has been lurking near the Thornapple, looking for opportunities to strike at Zenia. She found her opportunity with [Diva Luma](3-Mechanics/CLI/bestiary/npc/diva-luma-jttrc.md), tainting the [diva](3-Mechanics/CLI/bestiary/humanoid/diva-jttrc.md)'s glitter—a feature of the [diva](3-Mechanics/CLI/bestiary/humanoid/diva-jttrc.md)'s performances—with rage-inducing [biza's breath](3-Mechanics/CLI/items/bizas-breath-jttrc.md).

[Diva Luma](3-Mechanics/CLI/bestiary/npc/diva-luma-jttrc.md) uses the [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin.md) stat block, but her only weapon is her wicked, high-heeled shoe, which functions as a Shortsword attack without poison. The other two divas use the [scout](3-Mechanics/CLI/bestiary/humanoid/scout.md) stat block and attack only with broken bottles that function the same as their Shortsword attack. As the divas are all under the effects of biza's breath, they each randomly make one melee attack against Zenia or a character on their turns. All three divas fail their saving throws to resist the poison affecting them for three rounds. On the fourth round, they overcome the effects of biza's breath and groggily stop attacking.

In the aftermath of the battle, characters who inspect the stage, the divas, or their glitter and succeed on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check see the glitter left a film of pink ash on the divas and the floor around them. A character who examines the pink ash and succeeds on a DC 14 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check suspects this is some manner of poison.
...
When the effects of the poison end, [Diva Luma](3-Mechanics/CLI/bestiary/npc/diva-luma-jttrc.md) and her fellow entertainers apologize profusely, explaining they weren't in control of their bodies. If asked about what happened to them prior to going on stage, the performers recall that just before they entered the tavern, a datura introduced herself and offered [Diva Luma](3-Mechanics/CLI/bestiary/npc/diva-luma-jttrc.md) a fine sachet of glitter as thanks for many inspiring performances. The entertainers confirm that the woman was wearing green pantaloons and a yellow tunic if asked. If a character succeeds on a DC 14 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check, they get Luma or one of the other performers to recall that the datura boldly and purposefully introduced herself as [Kala Mabarin](3-Mechanics/CLI/bestiary/npc/kala-mabarin-jttrc.md).
...
The parade is a splendid affair, and the streets are flooded with revelers. Nearby, locals call out to the man in the carriage—calling him the "Prince of Vice"—to attract his attention. A character who asks a bystander about the significance of the Prince of Vice, or who succeeds on a DC 14 Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History)) check, learns the details from the "March of Vice" section at the end of this adventure. Revelers can also point out that the Prince of Vice is [Azra Nir](3-Mechanics/CLI/bestiary/npc/azra-nir-jttrc.md), the son of Grand Messer Amos Nir, the eldest member of the Kings of Coin.
...
As bystanders flee the area, the character who has the highest passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score spots a figure in green and yellow throwing something toward the cart. An instant later, a cloud of pink ashes bursts from a sachet, striking the two guards.
...
Azra uses the [acolyte](3-Mechanics/CLI/bestiary/humanoid/acolyte.md) stat block and is [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised) during the first round of combat. He seeks only to escape the chaos.

##### Guards

The two [guards](3-Mechanics/CLI/bestiary/humanoid/guard.md) are affected by the poison [biza's breath](3-Mechanics/CLI/items/bizas-breath-jttrc.md) (detailed in a sidebar earlier in this adventure). They automatically fail their saving throws to end the poison's effect. The guards make one melee attack against a randomly determined creature within reach each round for 1 minute before the poison's effect ends.

##### Kala

Kala uses the [druid](3-Mechanics/CLI/bestiary/humanoid/druid.md) stat block and has already cast [barkskin](3-Mechanics/CLI/spells/barkskin.md), giving her AC 16. She keeps her distance from the poisoned guards as she tries to kill [Azra Nir](3-Mechanics/CLI/bestiary/npc/azra-nir-jttrc.md) using [produce flame](3-Mechanics/CLI/spells/produce-flame.md) and [thunderwave](3-Mechanics/CLI/spells/thunderwave.md). She has three more doses of [biza's breath](3-Mechanics/CLI/items/bizas-breath-jttrc.md), but they are prepared for use in combat.

##### Negotiating with Kala

A character can use an action to explain what they learned from Nargis about how Kala's mother was wronged and attempt a DC 16 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. On a success, Kala stops attacking for 1 round. If a character succeeds on this check a second time, Kala stops attacking and agrees to discuss bringing her mother's murderers to justice without further bloodshed.
...
The biza uses the [wraith](3-Mechanics/CLI/bestiary/undead/wraith.md) stat block but does not have Sunlight Sensitivity.

As the biza attacks, it calls out and curses the names Amos Nir, Nargis Ruba, and the others listed in the "Kings of Coin" section later in this adventure. [Samira Arah](3-Mechanics/CLI/bestiary/npc/samira-arah-jttrc.md) is omitted and spared the biza's ire, as she's only recently joined the council. Characters who've heard these names or who succeed on a DC 12 Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History)) check recognize them. The biza goes on to accuse the Kings of Coin of killing it, revealing that it is the spirit of Proud Edun—a fact Kala never learned.
...
| dice: d6 | Adventure |
|----------|-----------|
| 1 | Madame Nasana Lar hosted an exquisite banquet for her rival Elucidarium divas, then the guests transformed into [zombies](3-Mechanics/CLI/bestiary/undead/zombie.md). [Diva](3-Mechanics/CLI/bestiary/humanoid/diva-jttrc.md) Lar needs help clearing her home and her name—supposedly having had nothing to do with her guests' fates. |
| 2 | Myx Janisa Davi, an [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage.md) of a school called the Arcane Coterie, has chosen their apprentice: a youngster in the city's laborer district. The apprentice has disappeared, and Janisa seeks assistance locating them. |
| 3 | The notorious giant caiman called Tikoloshe ([giant crocodile](3-Mechanics/CLI/bestiary/beast/giant-crocodile.md)) has wrecked many ships bound for Zinda. The Kings of Coin hire the characters to slay the deadly—and perhaps possessed—beast. |
| 4 | The lover of one of the Kings of Coin is revealed as a member of the Bloodletters. The paramour now needs help escaping the city ahead of Silent Verse [assassins](3-Mechanics/CLI/bestiary/humanoid/assassin.md). |
| 5 | Locals are disappearing while swimming in forested pools near Zinda. Evidence suggests they have been kidnapped by a cabal of [sea hags](3-Mechanics/CLI/bestiary/fey/sea-hag.md). |
| 6 | A massive silk cotton tree with a fiendish aura attracts a host of [banshees](3-Mechanics/CLI/bestiary/undead/banshee.md). A datura seeks help in appeasing these mournful spirits. |
^zinda-adventures
