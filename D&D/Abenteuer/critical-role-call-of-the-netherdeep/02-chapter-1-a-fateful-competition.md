...
![Two goblin children run through the streets of Jigow with a delicious meat pie](3-Mechanics/CLI/adventures/critical-role-call-of-the-netherdeep/img/008-01-001-intro-splash.webp#center)
...
[Agathe Silverspoon](3-Mechanics/CLI/bestiary/npc/agathe-silverspoon-crcotn.md) is a chaotic good orc who moves from counter to counter, deftly slicing a variety of cooked and spiced meats, then folding them into piecrusts that she places into the oven behind her.
...
- **Male Drow.** <span title='Constitution'>+0</span>  
- **Female Halfling.** <span title='Constitution'>+2</span>  
- **Irvan Wastewalker.** <span title='Constitution'>+1</span> on checks, <span title='Constitution'>`+3`</span> on saving throws  
...
![Agathe Silverspoon makes the best meat pies in Jigow](3-Mechanics/CLI/adventures/critical-role-call-of-the-netherdeep/img/011-01-002-agathe-silverspoon.webp#center)
...
- **Maggie Keeneyes.** <span title='Strength'>+4</span>  
- **Maryl Bronzefang.** <span title='Strength'>+4</span>  
- **Female Drow.** <span title='Strength'>+3</span>  
...
Athletics Athletics (`+3`), Sleight of Hand Sleight of Hand (`+0`)

##### Drow Team

Athletics Athletics (`+0`), Sleight of Hand Sleight of Hand (`+2`)
...
A [young horizonback tortoise](3-Mechanics/CLI/bestiary/beast/young-horizonback-tortoise-crcotn.md) uses the ankylosaurus stat block, with these changes:
...
A character who explores this cave discovers a vial containing a [potion of healing](3-Mechanics/CLI/items/potion-of-healing.md) and a soggy but usable [spell scroll](3-Mechanics/CLI/items/spell-scroll.md) of thunderwave.
...
![A giant octopus waits to ambush prey in the depths of the Emerald Grotto](3-Mechanics/CLI/adventures/critical-role-call-of-the-netherdeep/img/016-01-005-giant-octopus.webp#center)
...
![A spectral figure not seen in ages sets the adventurers on a quest that could change the fate of the world](3-Mechanics/CLI/adventures/critical-role-call-of-the-netherdeep/img/017-01-006-spectral-figure.webp#center)
