...
- json5e-note
tags:
- ttrpg-cli/compendium/src/5e/tftyp-atg
aliases:
- "Against the Giants"
---
# Against the Giants
...
> 
> The preferred habitats of [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md), [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md), and [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) exist in virtually every D&D setting, so it's not too difficult to find locations for the strongholds and the events in *Against the Giants*.
> 
...
- Two hot-headed [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) heading for the weapons room (area 13) from the great hall (area 11), intending to fight an impromptu duel  
- The [cloud giant](3-Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md) from the great hall (area 11) heading for the front gate (area 1)  
- The [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) from the great hall (area 11) heading for the front gate (area 1)  

#### Eastern Section

If the characters are in areas 2 through 10, choose from the following possibilities:

- [Grutha](3-Mechanics/CLI/bestiary/npc/grutha-tftyp.md), the chief's wife, coming from the great hall (area 11) to get her pet cave bear from her room (see area 7)  
- A [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) with four [dire wolves](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) from the open yard (area 22) going to the barracks (area 4)  
- [Chief Nosnra](3-Mechanics/CLI/bestiary/npc/chief-nosnra-tftyp.md) (see area 11) and two [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) going to get some trophies from the chief's hall (area 6) to show off in the great hall  
- `1d4 + 1` young hill giants (use the [orc](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) statistics) from the dormitory (area 3) heading through the open yard (area 22) to raid the pantry (area 18A)  

#### Western Section

If the characters are in areas 12 through 21, choose from the following possibilities:

- `2d6` orc slaves ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) rushing to get shields (from area 12 or 13) to use as platters  
- Two [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) from the great hall (area 11) going to sleep off a drunk (in area 15 or 16)  
- Three [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) from the great hall (area 11) going to get one of the guards from the entryway (area 1)  
- A [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) from the great hall (area 11) taking a stroll to clear his head  

#### Yard and Barracks Rooms

If the characters are in areas 22 through 25, they might encounter a [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) from the great hall (area 11) heading for bed.
...
Under the furs on the bed is a sleeping [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md). It requires successful DC 8 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks for characters to enter this room without waking her, as well as when the characters do anything else that might make enough noise to rouse her. Any loud noise wakes her immediately.
...
Here twelve young hill giants (use the [orc](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) statistics) are rollicking; beefy smacks, and shouts, laughter can easily be heard through the corridor outside. All these youngsters have weapons and will readily attack any intruders they spot. Noise coming from here, even shrieks and swords clashing, will be regarded by others as the kids simply having fun.

### 4. Barracks

Two soundly sleeping, loudly snoring [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) occupy two of the ten beds in the barracks. Typical giant clothing hangs from the walls, and a couple of torches smolder in wall-mounted cressets. A wooden chest stands near the western wall.
...
Three hill giant servants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics) are in this room, along with the usual furnishings. Only the nasty old matron, a normal [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md), is inclined to fight, but she dominates the others and orders them to attack if necessary. If the matron is slain, the three others cease hostilities and cooperate with the characters by describing [Chief Nosnra](3-Mechanics/CLI/bestiary/npc/chief-nosnra-tftyp.md)'s sanctum (areas 8, 9, and 10) and telling how to get there safely—if they are allowed to have the matron's hoard.

#### Treasure

The matron's valuables are stashed in a locked iron chest under the matron's bed. The matron carries the key to the chest; it can also be unlocked by a character who succeeds on a DC 15 Dexterity check using thieves' tools. The chest holds 800 gp, three platinum bracelets (worth 1,000 gp each), and four potions: [healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), [superior healing](3-Mechanics/CLI/items/potion-of-superior-healing-xdmg.md), [poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md), and [mind control](3-Mechanics/CLI/items/potion-of-mind-control-tftyp.md) (hill giant) (see appendix A). The maids can be persuaded to part with the potions.
...
One of the shields on the wall is a [+1 shield](3-Mechanics/CLI/items/1-shield-xdmg.md). The brass jar on the mantel of the fireplace might catch the characters' eye, but it has no value. The skull on the mantel is also valueless, but inside it is a large gem worth 500 gp—one of the kids was playing with this bauble and stuck it inside the skull, where it has lain forgotten ever since.

### 7. Chamber of the Chief's Wife

[Grutha](3-Mechanics/CLI/bestiary/npc/grutha-tftyp.md), the chief's wife, is at feast in the great hall (area 11), while her pet cave bear (use the [cave bear](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) variant with the [polar bear](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) statistics) stays in her room. The creature acts as a guard and immediately attacks any intruder, for it can smell the person at the door. The bear makes no noise until it attacks.
...
A [javelin of lightning](3-Mechanics/CLI/items/javelin-of-lightning-xdmg.md) is wrapped in an old rag, which is stuffed under a cloak thrown into a far corner and shielded from sight by three [spears](3-Mechanics/CLI/items/spear-xphb.md) and a [club](3-Mechanics/CLI/items/club-xphb.md) leaned against the wall in front of it. One of the capes, made of a giant otter pelt, is worth 400 gp.
...
- [Chief Nosnra](3-Mechanics/CLI/bestiary/npc/chief-nosnra-tftyp.md) fights as a [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) with no immunities. He has AC 17 from splint armor. The chief is seated at the head table.  
- Nosnra's wife, [Grutha](3-Mechanics/CLI/bestiary/npc/grutha-tftyp.md), is a [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md). She sits beside the chief.  
- The chief's cave bear (use the [cave bear](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) variant with the [polar bear](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) statistics) is licking up spills under the head table at Nosnra's feet.  
- The [subchief](3-Mechanics/CLI/bestiary/giant/hill-giant-subchief-tftyp.md), also seated at the head table, is a hill giant that fights as a [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md), without Stone Camouflage. His AC is from splint armor.  
- A [cloud giant](3-Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md) ambassador stands near the firepit.  
- A [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) visitor is seated at the head table.  
- Seven [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md), including the [sergeant](3-Mechanics/CLI/bestiary/giant/hill-giant-sergeant-tftyp.md) from area 25 (who has AC 16 from chain mail and 115 hit points), six hill giant servants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics), and eight [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) are scattered around the room.  
...
Each giant wears one to four pieces of jewelry worth 250 gp each. Ogres each wear one or two pieces worth 100 gp each. The subchief, decked out for the occasion, has four pieces. Nosnra and [Grutha](3-Mechanics/CLI/bestiary/npc/grutha-tftyp.md) also wear four pieces of jewelry each, worth 1,000 gp per item. The bear has a jewel-studded collar with six rubies, worth a total of 250 gp.
...
Behind the seventh shield that the characters check is a [+1 warhammer](3-Mechanics/CLI/items/1-weapon-xdmg.md). Another hammer is out of sight in a corner and only seen on close inspection of the room. Under the scrutiny of a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell, it radiates an aura of illusion magic due to a [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spell placed on it. If picked up by a dwarf it barks out, "Here's a kiss for you, runt!"
...
Twenty-nine orc slaves ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) work about the place, but they run away from conflict. Five hill giant servants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics) and six young ogre servants (use the [orc](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) statistics) also run, but they call loudly for help as they flee.
...
A large common room in the extreme north end of the stronghold has various cots, tables, chairs, stools, and the like. It is cluttered with old clothing and junk. Six hill giant servants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics) are here, and a few are flirting with a handsome male [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md). The giant enters combat to show off for his admirers. He will not call for help unless his current hit points drop to less than half of his hit point maximum. On the round when this happens, he begins to shout. Some of the servants aid him if he starts to cry out, but others prefer to avoid direct conflict, perhaps taking the opportunity to hurt or disadvantage a character from the blind side.

The giant warrior is [the keeper](3-Mechanics/CLI/bestiary/npc/the-keeper-tftyp.md) of the wolves in area 22. His whip is hanging beside the door in the southeast corner of this room; this whip need only be shown to the wolves to make them whimper, cower, and fall back.

### 20. Orc Slave Quarters

This hall is a messy and smelly place filled with pallets and junk. The two orc slaves ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) currently in this place are too injured to work (since giants' kicks break bones). All the other slaves are elsewhere, helping with the feast.
...
The hill giants employ ogres as scouts, messengers, servants, and the like, for the ogres are trusty flunkies as well as hard workers and fighters. In addition to those in the great hall (area 11) and the youngsters at work in the kitchen (area 17), five more [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) are in their quarters playing at knucklebones and drinking beer. Ogres are a rowdy lot; hence, noise from this place attracts no attention. Scattered on the floor of the room are nearly a dozen heaps of skins on which the ogres sleep, and a locked iron chest is tucked into one corner.

#### Treasure

Hidden inside one of the heaps of skins is a leather sack containing a [potion of storm giant strength](3-Mechanics/CLI/items/potion-of-storm-giant-strength-xdmg.md) and a [potion of invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md). There are ten such heaps, and the sack is hidden in the seventh one that the characters search.
...
Fourteen [dire wolves](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) run free here, and they immediately attack any humanoid that enters their area. If they see the whip from area 19, however, they cower and whimper, allowing the intruders to pass unchallenged.

### 23. Guard Room

A huge horn rests upon the small table in the center of the room; blowing it calls the dire wolves. Eight stools and two benches line the walls, and a sheaf of eighteen [spears](3-Mechanics/CLI/items/spear-xphb.md) is leaning against the wall by the door. A line of seven giant-sized shields and four clubs stands along the south wall. The guards that would normally be stationed here have gone to the celebration in the great hall.
...
This room's contents are similar to those in area 24 (see above), except for the partially enclosed area to the northwest. This alcove belongs to the [sergeant](3-Mechanics/CLI/bestiary/giant/hill-giant-sergeant-tftyp.md) of the guards, who is now away feasting. There are three chests in the space, all filled with clothing and equipment for the troops and herself. Giant-sized boots are gathered in a sack that hangs from the wall.
...
- Four [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) seeking some orcs  
- [The Keeper](3-Mechanics/CLI/bestiary/npc/the-keeper-tftyp.md) (see area 2), out inspecting, accompanied by an [ape](3-Mechanics/CLI/bestiary/beast/ape-xmm.md) (one of his pets)  
- Twelve rebel [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) out raiding for food, two armed with heavy crossbows and poisoned bolts  
...
- `1d4` young [giant lizards](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) from area 21  
- `1d3` [carrion crawlers](3-Mechanics/CLI/bestiary/monstrosity/carrion-crawler-xmm.md) coming from area 22 by way of the sinkholes  
...
Residing here is [the Keeper](3-Mechanics/CLI/bestiary/npc/the-keeper-tftyp.md), a ghastly hill giant (use the [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) statistics, without Stone Camouflage) that is hunchbacked and twisted, and has only one good eye. He is thoroughly wicked, strong, and remorseless. In his lair, he is never without his two pet [apes](3-Mechanics/CLI/bestiary/beast/ape-xmm.md) (which have 30 hit points each). One is on guard to the north of the door, the other resting on a platform built above the door.

[The Keeper](3-Mechanics/CLI/bestiary/npc/the-keeper-tftyp.md) wears a thick chain mail shirt (accounting for his AC), and he fights with a giant-sized [+1 battleaxe](3-Mechanics/CLI/items/1-weapon-xdmg.md) that gives him a +10 bonus to hit. He has a reach of 15 feet with the weapon, which deals 20 (`3d8 + 7`) slashing damage on a hit.

#### Treasure

Beneath a loose stone in the floor is a hole that contains 1,250 gp, three 250 gp gems, two 100 gp gems, and a large earthenware jug that holds four [potions of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md).

### 3. Cell Block

In the outer guard room are two [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md), initially located in the eastern end of the area. If not engaged immediately, they will raise an alarm by striking a large brass gong that hangs near the door. If they are prevented from doing so and are faced by an obviously superior enemy, the bugbears feign surrender and direct the characters' attention to the fourth cell (see below), where—so they say—treasure is to be had. Then, when the characters are occupied fighting the monsters that await within that cell, the bugbears will strike the alarm and flee. In addition to the alarm gong, the guard room contains a table, two stools, torches, and a ring of keys that open four of the five cell doors.

The cells, from left to right, have the following occupants:

#### First Cell

A human merchant ([noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), taken prisoner some time ago and now quite insane from mistreatment, is in the cell nearest the door.

#### Second Cell

A second human prisoner, an engineer ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), is kept alive to help with the excavation of new areas of the dungeon. He cannot aid his rescuers, but he will repay them with service.

#### Third Cell

An elf [knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) is chained to the wall. He is wounded from torture (currently down to 14 hit points). He gladly takes up arms to aid his rescuers and is willing to serve his rescuers for one year without pay in gratitude for his freedom.
...
This room holds eight [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md), alert and ready for trouble. They carry `2d4` gp each.
...
This room holds twenty-four unarmed orc slaves (six [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), eighteen orc [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)).

#### 10. Barracks

This room holds thirty unarmed orc slaves (seven [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), twenty-three orc [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)).

#### 11. Barracks

This room holds twenty-five unarmed orc slaves (five [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), twenty orc [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)).
...
Three enclosures to the west of the bugbear complex are used to house orc slaves that have proved themselves to be troublesome; as such, this area is under heavy scrutiny. A [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) guard, watching for trouble, is stationed at each position marked W on the map.
...
This chamber holds forty-eight unarmed orc slaves (thirteen [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), thirty-five orc [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)).

#### 13. Barracks

This chamber holds twenty-four unarmed orc slaves (five [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), nineteen orc [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)).

#### 14. Barracks

This chamber holds sixteen unarmed orc slaves (ten [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), six orc [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). If released, they are particularly eager to attack their captors. They know of a haven for orc refugees somewhere to the south but not the exact location of the rebel headquarters.
...
Huddled next to the northwest and southwest walls, two [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) are dozing.
...
The armorer and the smith, two [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md), are occupied in the eastern section of the room when the characters enter. If any of the armor and weapons in the northern section are touched, they collapse with a clatter that warns the armorer and the smith of trouble. The giants immediately shout and come out fighting.

Also in the room, near the forge and bellows in the southwest corner, are five dwarves chained to the floor and forced to labor making weapons. Four of them are dwarf [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) intent only on escaping if they are released, but the fifth is a [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) who volunteers to stay with the characters as long as he receives a share of treasure equal to that of a character and a chance to fight giants.
...
In their excavations, the ancient builders of the stronghold stumbled upon an enormous expanse of natural caves and caverns. The southern part of this network is now inhabited by seventy-eight escaped orc slaves, including two [orogs](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md), twenty-six [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), and fifty orc [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md), for whom the place is a sanctuary.
...
A tribe of troglodytes dwells in the central portion of the cavern complex. The group includes twenty-three adult [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) and fourteen young (use the [kobold](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) statistics). Trapped as they are between the orcs in area 19 and the lizards at area 21, they are trying to make do until they can escape.
...
A mated pair of exceptionally old and large subterranean lizards have chosen this spot to raise their young. The adults use the statistics for [giant crocodiles](3-Mechanics/CLI/bestiary/beast/giant-crocodile-xmm.md), except that they have a climbing speed of 30 feet, no swimming speed, and [darkvision](3-Mechanics/CLI/rules/senses.md#Darkvision) out to a range of 60 feet. Their four young use the statistics for [giant lizards](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md).
...
Two [carrion crawlers](3-Mechanics/CLI/bestiary/monstrosity/carrion-crawler-xmm.md) are in the northeast finger of the cavern when the characters first enter. Every 10 minutes, there is a 30 percent chance that `1d3` more of these monsters appear from either the northern or southern sinkhole.
...
This wine is a gift to [Chief Nosnra](3-Mechanics/CLI/bestiary/npc/chief-nosnra-tftyp.md), in return for his good services, from the creatures that are masterminding the attacks by the giants, although at best the characters can only guess at this fact. Due to its potency and quality, it has a market value of 500 gp per cask if characters can transport it safely out of the dungeon and back to civilization.
...
- The third chest holds loose coins (a total of 2,400 ep) and an unlabeled potion (actually a [potion of poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md)).  
...
The illusion conceals the following items, which are hung upon the wall: a quiver of eleven [+1 arrows](3-Mechanics/CLI/items/1-ammunition-xdmg.md), a [+2 spear](3-Mechanics/CLI/items/2-weapon-xdmg.md), and a [flame tongue shortsword](3-Mechanics/CLI/items/flame-tongue-xdmg.md). A character attuned to this sword can use an action to mentally command it to detect gems and jewels. Someone who does so learns the kind and number of such objects within 60 feet of the sword.
...
[Fireball](3-Mechanics/CLI/spells/fireball-xphb.md) spells or other fire effects used in these icy areas will make the footing within the area of effect very slippery. A creature hit by an attack or that moves more than half its speed over slippery ice must succeed on a DC 10 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check or fall [prone](3-Mechanics/CLI/rules/conditions.md#Prone). For 5 minutes after such magical fire is used, the area will also be filled with fog that renders the area heavily obscured.
...
- `1d4 + 1` [yetis](3-Mechanics/CLI/bestiary/monstrosity/yeti-xmm.md)  
- One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md)  
- `1d4 + 1` [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md)  
- `1d6 + 1` [winter wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md)  
...
One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) keeps watch here at all times to prevent any unauthorized use of the long passage that leads south. If combat goes against the giant, he flees through this passage to give a warning of intruders to the guards at areas 9 and 10.
...
One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) waits here on standby guard. On the floor of the cave are a pile of sleeping skins and two bags. The guard has an ample supply of rocks and ice blocks at hand for hurling at opponents.
...
This bone-strewn cave is the den of two adult [winter wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md) and their three half-grown pups (use the [dire wolf](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) statistics). If the young are harmed, the parents fight recklessly, risking opportunity attacks and ganging up to kill quickly.
...
- A dwarf and a [+1 battleaxe](3-Mechanics/CLI/items/1-weapon-xdmg.md)  
- An elf with a long case at its feet (containing a [staff of frost](3-Mechanics/CLI/items/staff-of-frost-xdmg.md))  
- A human wearing a jeweled belt (worth 1,000 gp)  
- A human with a tube in its hand that contains a [scroll of protection](3-Mechanics/CLI/items/scroll-of-protection-xdmg.md) (elementals)  
- A dwarf that has a spilled pouch of gems at its feet (thirty-seven in all, worth 10 gp each)  
- A human wearing a [ring of resistance (fire)](3-Mechanics/CLI/items/ring-of-fire-resistance-xdmg.md)  
- A half-elf grasping a sack with a burst seam showing silvery coins (471 sp)  
- A human wearing gleaming armor that is actually [armor of vulnerability](3-Mechanics/CLI/items/armor-of-vulnerability-xdmg.md) (DM's choice)  
...
If the characters move any of the boxes and barrels around, the third container moved will reveal a hole filled with 600 gp, four 250 gp gems, and a silver tube (worth 50 gp) that holds a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) bearing a 3rd-level [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md) spell.
...
The hides cover four sleeping [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md), who are awaiting an audience with the jarl. Any noise will awaken them, and they will give the alarm to their fellows in area 8 as well as attempting to give the party the slip and warn the giants too.
...
Ogre mercenaries that serve [Jarl Grugnur](3-Mechanics/CLI/bestiary/npc/jarl-grugnur-tftyp.md) dwell here. There are currently six [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) here. All fight fiercely when ordered to do so, or when they come upon intruders. Also in the place are five chests, twelve sacks, and three barrels, as well as many piles of the usual skins and hides used for beds.
...
Hidden under the tenth pile of skins are two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and an armband made of gold fabric with a clasp fashioned from ivory and amber sculpted in the form of a bear. The armband is worth 500 gp, and it serves as a token of free passage.
...
One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) keeps a sharp lookout here. The giant has its greataxe plus a boulder ready at hand, with plenty of additional boulders piled near the entrances (guard positions 1 and 4).

#### 10. Southeast Chamber

One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) is stationed here. If alerted, the guard moves into area 9 and joins the fray.
...
This place has many bones and skulls littering it and serves as the lair of five [giant ice toads](3-Mechanics/CLI/bestiary/monstrosity/giant-ice-toad-tftyp.md) (see appendix B). These creatures feed on the leavings in area 11. The toads rest on small ledges from 8 to 12 feet above the cave floor, and they will hop down and savagely attack anything that touches it.
...
This place is the home of six [yetis](3-Mechanics/CLI/bestiary/monstrosity/yeti-xmm.md) that act as scouts for the frost giants. The [yeti leader](3-Mechanics/CLI/bestiary/monstrosity/yeti-leader-tftyp.md) at the location marked A has a [frost brand greatsword](3-Mechanics/CLI/items/frost-brand-xdmg.md). It fights with this weapon instead of its claws, dealing 11 (`2d6 + 4`) slashing damage plus 3 (`1d6`) cold damage on a hit, and carving great chunks out of those held fast by his Chilling Gaze.

#### Treasure

The [yeti leader](3-Mechanics/CLI/bestiary/monstrosity/yeti-leader-tftyp.md) has a hoard of eleven ivory tusks, each weighing 2 pounds and worth 200 gp, buried under a mound of snow.
...
This is the den of two large snow leopards (use the [tiger](3-Mechanics/CLI/bestiary/beast/tiger-xmm.md) statistics), which serve as pets of the yetis in area 13. These creatures lair on a ledge above the floor of the cave, and they try to take intruders by surprise.
...
One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) resides in the northeast cavern.

#### 17. Upper Sleeping Area

The northwest cave holds one [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md).

#### 18. Middle Sleeping Area

Two [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) occupy the largest of these caverns. At the back of this cave is a clear spring of water about 2 feet deep, at the bottom of which are two hundred seventy-eight clear rock crystals worth 10 gp each.

#### 19. Lower Sleeping Area

One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) is in the southernmost chamber.
...
Two [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) rest here. One giant watches down each passage while the other sleeps on a heap of skins. Each has a weapon and four rocks to hurl.
...
Two [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) and their three hill giant servants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics) are camped here awaiting a summons from the jarl. The cave has five heaps of hides and five giant-sized bags.

#### Treasure

The fourth bag searched contains a gold-inlayed skull with a report from [Chief Nosnra](3-Mechanics/CLI/bestiary/npc/chief-nosnra-tftyp.md) to [Jarl Grugnur](3-Mechanics/CLI/bestiary/npc/jarl-grugnur-tftyp.md) on a piece of parchment rolled up inside it. This document serves as a token of free passage to the hall of the fire giants. The biggest hill giant knows that they are bound south to [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md)'s realm after seeing the jarl, intending to take a message to the fire giant king.

In addition, each hill giant wears a fur cloak worth 1,000 gp.

### 25. Visitors' Cave

Two [stone giants](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) have come to the rift to pay their respects to the jarl and to see how well the frost giants are doing in their war on humankind. They will report their observations to other stone giants if they get the opportunity. They fight only if attacked. Each has a stone greatclub and three rocks handy.
...
This location is warmed somewhat by volcanic activity and lit by dim reddish light. In it are a [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) messenger and his [fire giant servant](3-Mechanics/CLI/bestiary/giant/fire-giant-servant-tftyp.md) (as a [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) with fire immunity) who have delivered their message and are about to depart for their own land. There are two piles of furs and skins in the place, a rude table, a bench, three stools, a large brazier, and two sacks.

#### Treasure

One giant's sack contains 1,500 gp and the other 500 gp, in addition to the usual contents. In a padded bag at his belt, the messenger carries a symbol of the jarl's fealty to [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md): a solid silver statue of a bear, rampant, with topaz eyes (worth 1,500 gp).

### 27. Winter Wolf Pack

Along the western side of the rift floor is the lair of a pack of five [winter wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md). The wolves are encouraged to roam the place by the frost giants.

### 28. Snow-Covered Dome of Ice

This hollowed-out ice formation has been created by the creature that lairs inside—a [remorhaz](3-Mechanics/CLI/bestiary/monstrosity/remorhaz-xmm.md) that has recently moved into the rift. A number of charred skeletons are strewn around its icy den.

### 29. White Puddings

The two spots marked with numbers along the east edge of the rift floor are the locations of a pair of Huge white puddings. A white pudding uses the statistics for a [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md), and its coloration gives it perfect camouflage in these icy conditions. While a white pudding remains motionless, it is indistinguishable from a mound of snow.
...
Light in this area comes from torches and from cressets that are actually cages for [giant fire beetles](3-Mechanics/CLI/bestiary/beast/giant-fire-beetle-xmm.md) (the latter mostly in the part inhabited by the jarl).
...
- One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md), a guard making the rounds  
- `1d4 + 1` [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) on an errand for the jarl  
- One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) and two [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) servants out for a walk  
- If the giants know intruders are about, one [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) and three [winter wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md) search for those intruders.  
...
The noise of moving the boulder that closes the place off from the rest of the complex awakens a mated pair of [young white dragons](3-Mechanics/CLI/bestiary/dragon/young-white-dragon-xmm.md) that are kept here, along with a great pile of treasure. If they have enough warning, both the dragons hide and wait to see who enters.
...
- Twenty-four various weapons (a [+2 dagger](3-Mechanics/CLI/items/2-weapon-xdmg.md) among them)  
- Nine [shields](3-Mechanics/CLI/items/shield-xphb.md)  
- Eight suits of armor (including a silvered set of [+2 chain mail](3-Mechanics/CLI/items/2-armor-xdmg.md))  
- Twenty-seven urns of small value  
- Sixty-one bottles and flasks, valueless except for one that holds a [potion of poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md), another that is a [potion of resistance (fire)](3-Mechanics/CLI/items/potion-of-fire-resistance-xdmg.md), and two more that hold [potions of diminution](3-Mechanics/CLI/items/potion-of-diminution-xdmg.md) and [growth](3-Mechanics/CLI/items/potion-of-growth-xdmg.md) respectively  
...
Six [giant ice toads](3-Mechanics/CLI/bestiary/monstrosity/giant-ice-toad-tftyp.md) (see appendix B) lair in the northern extreme of this chamber. They are very hungry and seek to kill and devour any creatures that enter the cavern, forcing themselves to wait only long enough for intruders to be distracted by the glint of gold and lure of bone in the center of the main cavern.

### 5. Entrance Cavern

Hidden by a camouflaged boulder from prying eyes, this chamber is the actual entrance to the jarl's complex. It is always guarded by a [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) equipped with a weapons and throwing stones, plus a giant's bag. If a conflict erupts, the giant tries to sound a great iron horn suspended from the ceiling on iron chains in the center of the cavern. The giant has to use an action to blow the horn.

### 6. Emissaries' Cavern

An [oni](3-Mechanics/CLI/bestiary/fiend/oni-xmm.md) and its four [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) servants are staying here. They have had an audience with the jarl, and after a special wassail to be held on the morrow they will depart for home with a treaty scroll. This scroll is signed (with a special mark) by the jarl and offers the Lord of the Oni 25,000 gp worth of gems, plus whatever loot the lord's minions garner, if they will join the war on humankind.

#### Treasure

The oni wears a [necklace of fireballs](3-Mechanics/CLI/items/necklace-of-fireballs-xdmg.md) with five beads remaining that it will not hesitate to use. The oni also bears a pouch containing six 500 gp gems (gifts from the jarl).
...
The box has properties similar to those of a [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md)—although the container is but 10 inches long by 6 inches wide and 4 inches deep, it holds 3 cubic feet of material or 60 pounds, whichever is the lesser. At present the box contains 500 gp, a [potion of mind control](3-Mechanics/CLI/items/potion-of-mind-control-tftyp.md) (frost giant) (see appendix A), and a [potion of cloud giant strength](3-Mechanics/CLI/items/potion-of-cloud-giant-strength-xdmg.md).

### 7. Guest Cavern

A torch-lit place adorned with tapestries, this comfortable chamber has skins and hides covering the floor and a bed heaped with soft pelts. Furnishings include a chest, a bag, a table, two chairs, and a small cabinet. The [cloud giant](3-Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md) who is the current guest has just agreed to join the jarl as his chief henchman.
...
Torches light the place dimly. A female [storm giant](3-Mechanics/CLI/bestiary/giant/storm-giant-xmm.md) is chained on the north wall with huge manacles at her wrists and ankles. A fur rug in the middle of the place bears a table and two chairs. Upon the table are heaps of food on six golden platters and in three silver bowls. Two huge flagons of ivory set with gems have been filled with fine wine; the scents from the food and the wine fill the chamber.
...
Eight [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) dwell here. Each has its own pile of hides and rags for sleeping, a wooden box for goods, a peg to hang outer garments, and a bag. The ogres serve the jarl willingly and fight fiercely.
...
A [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) guard is alert inside this oblong cavern at all times. He has a greataxe and one throwing rock. He shouts to alert the guards to the south if intruders enter the area.
...
The ledges marked A and B are more than 30 feet above the floor and hidden in dark shadow. Each of the ledges holds a watchful [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) with a supply of six rocks to throw.

### 12. Audience Alcove and Throne Dais

A stone outcrop partially encloses an area in the south of the jarl's cavern. A enormous ivory and bone throne, decorated with skulls, silver, and gems, rests near the south wall of this alcove. Hung behind it, spread out against the rough wall, is a white dragon hide. Before the throne on the floor is the skin of a [huge polar bear](3-Mechanics/CLI/bestiary/beast/huge-polar-bear-tftyp.md). Three ivory stools are off to one side of the throne; these are the seats of the jarl's lieutenants.
...
One [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) guard stationed in the far southern end of this chamber looks east and west at varying times. He has two rocks. If an intruder is seen, he will sound a large gong on the north wall (possibly with a thrown rock).

### 14. Kitchen

Two fire giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to fire damage) and four [ogres](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) labor in the kitchen, roasting a horse over the natural firepit and otherwise readying the jarl's food. Various foodstuffs, furniture, and utensils are scattered about in all the nooks that lead away from the firepit. Amid heaps of foodstuffs to the north are four human captives ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) in a cage, being saved for a feast. They can warn the characters about what lies in areas 15, 16, and 17.
...
Currently one [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md), two frost giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to cold damage), and three young frost giants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics, plus immunity to cold damage) call this place home. If the frost giant is killed, the others weepily surrender, not fighting thereafter unless they are attacked.
...
The jarl's hunting pack—four huge [polar bears](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) with 65 hit points each—lairs here.
...
This large cave is occupied by two [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) and three frost giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to cold damage) along with three young frost giants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics, plus immunity to cold damage).

#### 19. East Chamber

This slightly smaller area holds one [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md), one [frost giant servant](3-Mechanics/CLI/bestiary/giant/frost-giant-servant-tftyp.md), and two young frost giants.

### 20. Jarl's Antecavern and Trophy Hall

[Jarl Grugnur](3-Mechanics/CLI/bestiary/npc/jarl-grugnur-tftyp.md) receives visitors in a chamber on the southern edge of the lower level. The eastern half of the cavern is a private audience hall, with pelts and skins on the walls and floor, a table, and four chairs. Some worthless scrolls are on the table, and on the walls of this area hang two normal shields, a heavy crossbow, two normal two-handed swords, and a pair of huge ivory tusks of no value. A few worthless furs and tapestries hang on the short sections of wall to the north. Both halves of the hall are illuminated by caged fire beetles. To the east a set of well-worn steps, each about 3 feet high, lead up to an exit screened by thick, leathery hides.
...
- Three [shields](3-Mechanics/CLI/items/shield-xphb.md)  
- A [light crossbow](3-Mechanics/CLI/items/light-crossbow-xphb.md) and fourteen bolts  
- A [greataxe](3-Mechanics/CLI/items/greataxe-xphb.md), two [spears](3-Mechanics/CLI/items/spear-xphb.md), and a [flail](3-Mechanics/CLI/items/flail-xphb.md)  
- A huge iron mace  
- A suit of [splint armor](3-Mechanics/CLI/items/splint-armor-xphb.md) sized for a dwarf  
- A suit of [plate armor](3-Mechanics/CLI/items/plate-armor-xphb.md) sized for a human  

Other items of interest, because of their magical nature or unusual appearance, are as follows:

- A [+1 shield](3-Mechanics/CLI/items/1-shield-xdmg.md) that is trapped (see below)  
- The skull of a dwarf wearing an iron crown (no value)  
- Eleven [+1 bolts](3-Mechanics/CLI/items/1-ammunition-xdmg.md)  
- Two walrus tusks that are trapped (see below), one of which is an ivory-covered bronze [horn of Valhalla](3-Mechanics/CLI/items/horn-of-valhalla-xdmg.md)  
- A white dragon skull that has an aura of abjuration magic about it  
- A suit of [+1 plate armor](3-Mechanics/CLI/items/1-armor-xdmg.md) sized for an elf  
...
[Jarl Grugnur](3-Mechanics/CLI/bestiary/npc/jarl-grugnur-tftyp.md) (use the [cloud giant](3-Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md) statistics, plus immunity to cold damage but without Keen Smell and Innate Spellcasting) sits at the table in his chain mail jack with his [arrow-catching shield](3-Mechanics/CLI/items/arrow-catching-shield-xdmg.md) nearby (AC 18, or AC 20 against ranged attacks, with his shield; AC 16 without it). At his hip is his [+2 longsword](3-Mechanics/CLI/items/2-weapon-xdmg.md). The jarl has a +14 bonus to hit with the weapon and deals 23 (`3d8 + 10`) slashing damage on a hit. In his hand is a platinum drinking horn set with eight gems.

Across the table is [Estia](3-Mechanics/CLI/bestiary/npc/estia-tftyp.md), his lady (use the [cloud giant](3-Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md) statistics, altered as for Grugnur), a fierce beauty with a cloak of saber-tooth tiger hide about her and an iron [+2 morningstar](3-Mechanics/CLI/items/2-weapon-xdmg.md) at her hip. On the table in front of her is a gold flagon set with eight gems (1,200 gp).

Two [winter wolves](3-Mechanics/CLI/bestiary/monstrosity/winter-wolf-xmm.md) are crouched under the table.
...
- The fourth trunk has a thick layer of old socks, underneath which are eight potions ([speed](3-Mechanics/CLI/items/potion-of-speed-xdmg.md), [superior healing](3-Mechanics/CLI/items/potion-of-superior-healing-xdmg.md), [storm giant strength](3-Mechanics/CLI/items/potion-of-storm-giant-strength-xdmg.md), [poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md), [oil of slipperiness](3-Mechanics/CLI/items/oil-of-slipperiness-xdmg.md), [healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), and a [philter of love](3-Mechanics/CLI/items/philter-of-love-xdmg.md)).  
...
- Number 4 holds a [scroll of protection](3-Mechanics/CLI/items/scroll-of-protection-xdmg.md) (fiends).  
- Number 5 contains a scroll of gibberish with an *explosive runes* [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) on it (spell save DC 15).  
- Number 6 has two [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md), one of [delayed blast fireball](3-Mechanics/CLI/spells/delayed-blast-fireball-xphb.md) and one of [finger of death](3-Mechanics/CLI/spells/finger-of-death-xphb.md).  
...
The alcove to the northwest just inside the tunnel has a thick iron bar protruding from the wall about 10 feet off the ground. To a casting of [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), the bar has a strong aura of conjuration. Noticing the bar without specifically looking up for it requires a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception) check). If the bar is pushed downward, that act transports whatever or whoever is standing on the floor of the alcove to a spot some 50 feet distant from the entrance to Snurre's hall (the Hall of the Fire Giant King).

An apparently empty ledge high in the southwest wall is the resting place of an iron box that is invisible, has no magical aura, and is locked (requiring a successful DC 20 Dexterity check to open). Those who investigate the ledge can find the box only if they blunder into it or they are able to see invisible objects. The chest becomes visible when opened. It has a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) (save DC 17) inside the lid. The glyph triggers if the chest is opened without its key. If triggered, the glyph casts [cloudkill](3-Mechanics/CLI/spells/cloudkill-xphb.md) (spell save DC 17) centered on itself. The box's contents are meant to be taken to the fire giants' stronghold and given as gifts to the powers behind the uprising.

#### Treasure

In the iron box are a [pearl of power](3-Mechanics/CLI/items/pearl-of-power-xdmg.md), a set of [Nolzur's marvelous pigments](3-Mechanics/CLI/items/nolzurs-marvelous-pigments-xdmg.md), and a [wand of paralysis](3-Mechanics/CLI/items/wand-of-paralysis-xdmg.md).
...
> [!gallery]
> ![Map 6.5: Hall of the Fire Giant King—Entrance Level](3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-against-the-giants/img/012-atg05.webp#gallery)
...
- One [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) guard  
- One [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) with 12 [gnoll](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) workers  
- Four young fire giants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics, plus immunity to fire damage) with two [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md)  
- One [cloud giant](3-Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md), one [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md), or one [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md), a visitor looking around  
...
The tapestry that covers the opening to this guard post is of loose weave, allowing the [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) guard in the dark recess to clearly see whoever enters the corridor. If intruders are spotted, he sounds his great bronze horn to warn the hall (see area 2). The giant has four rocks for throwing.
...
[King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md) is a [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) with the following changes, which increase his challenge rating to 11 (7,200 XP):
...
Two [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) guard the king at all times; their positions are indicated by the circled numbers 1 and 2. Each giant has a carved stone to throw. Crouching at positions 3 and 4 are a pair of [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md), the king's constant companions.
...
If the lid of the strongbox is opened by anyone but Frupy, a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) inside is triggered, producing a [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) spell centered on the chest (save DC 15). The strongbox itself holds nothing of value, but it has a trick panel in the side, which requires a successful DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check to find.

The panel, if opened, allows access to a jade box (worth 500 gp). This box has a false bottom, found with another successful DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check, that contains [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of two random 7th-level spells of a particular class (DM's choice).
...
The drawers in the chest hold worthless personal articles, except for the fifth drawer from the bottom, where under some underthings Queen Frupy has concealed three potions: [resistance (fire)](3-Mechanics/CLI/items/potion-of-fire-resistance-xdmg.md), [mind control (mammal)](3-Mechanics/CLI/items/potion-of-mind-control-tftyp.md), and [mind control (fire giant)](3-Mechanics/CLI/items/potion-of-mind-control-tftyp.md), the latter of which she plans to use on the king (see appendix A for the latter two potions).

Finally, Frupy wears six pieces of gem-set jewelry worth 500 gp each.

### 6. Chamber of the King's Guards

Beyond the doors that lead north, along the east and west walls of the short hallway, are a total of twelve throwing rocks lined up ready for use. Two [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md), off-duty guards, relax in the adjoining chamber. Each has a carved throwing rock and a greatsword nearby.
...
The great iron doors to this place bear the blazon of the flaming skull also found in the throne room. The doors open into an outer hall where six [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) roam.
...
The containers in the room hold the personal gear of [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md), consisting of clothing, footwear, and bits of armor. Arrayed on the table are several small items including pieces of carved ivory, animal teeth, bits of wood, and stones. Together these items, the king believes, can be made to serve as a divination device.
...
**Trunk 8** is unlocked. When it is opened, it initially appears empty because all of its contents are invisible. The chest holds six pieces of jewelry worth 250 gp each as well as nine [poisonous snakes](3-Mechanics/CLI/bestiary/beast/venomous-snake-xmm.md).
...
A [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) is always at the ready inside the entrance to this storage area. If summoned or attacked, the guard fetches the chimera from area 11. The guard has three throwing rocks at hand. Torches provide light, and a bench offers a place to sit down.
...
Hidden in the far southwestern corner under the spears are a [+1 longbow](3-Mechanics/CLI/items/1-weapon-xdmg.md) and a quiver of twenty [+1 arrows](3-Mechanics/CLI/items/1-ammunition-xdmg.md).
...
One of the giant-sized shields is actually a [shield of missile attraction](3-Mechanics/CLI/items/shield-of-missile-attraction-xdmg.md).

### 11. Chimera Pen

The fire giants keep a [chimera](3-Mechanics/CLI/bestiary/monstrosity/chimera-xmm.md) here. This creature attacks intruders on sight, since it hates everyone except fire giants.
...
Eight [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) servants/bodyguards are lounging in this area, awaiting orders. They obey only the commands of [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md), Queen Frupy, or the Advisor—who is is a grossly fat but very strong and quite fast renegade mountain dwarf named [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md) (see area 12A).
...
The door to this study appears to be locked from the outside, suggesting that the place is vacant ([Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md) is very clever). He can see through the door by means of a peephole, and if he sees intruders who are battling the gnolls and winning he will yell for them to help him, claiming to be a victim and a prisoner of the giants.

In fact, at first sight, this chamber appears to be a cell rather than a truly comfortable study. [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md) is at work in the room, poring over several scrolls atop his plain wooden desk, searching for solutions for the problems besetting his King. The dwarf has been Snurre's advisor for twenty-five years, having spent five years as a slave before that. A case against the north wall contains various maps, scrolls, and papers, all written in Giant or Dwarvish.

If he finds himself at a disadvantage, [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md) (use the [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) statistics, with 16 Strength and Charisma and the ability to make three melee attacks using Multiattack) tells the characters that the giants have held him—a prince of his people—captive for ten years, trying to trick information out of him or to subvert his loyalty to dwarfdom when torture failed. He further claims that several humans in black robes aid the giants in their questioning. Finally, he asks to be allowed his armor and weapons in order to gain sweet revenge upon Snurre, and he claims to know exactly where the king will be.

While in his study, [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md) has only a studded leather jacket and a long knife (the equivalent of a shortsword, coated with one dose of the poison noted in the assassin statistics). If worst comes to worst, he bolts for room 12B and bars the door once he is inside.

#### Treasure

[Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md) uses a plain wooden box as a footstool. It seemingly holds only old clothes of his—but beneath a false bottom, which requires a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check to find, some gems are hidden: two worth 500 gp each, eight worth 100 gp each, twenty-three worth 50 gp each, forty-one worth 10 gp each, and eighteen worth 5 gp each.

### 12B. Obmi's Bedchamber

In a larger chamber adjacent to his study, the renegade dwarf has a soft bed, a small stand, a table and chair, a cabinet, two iron chests, and an arming rack. His [dwarven plate](3-Mechanics/CLI/items/dwarven-plate-xdmg.md) and [+1 shield](3-Mechanics/CLI/items/1-shield-xdmg.md) (AC 20, or AC 23 with his shield) are laid on the rack near the door, and his [+1 battleaxe](3-Mechanics/CLI/items/1-weapon-xdmg.md) and [+1 warhammer](3-Mechanics/CLI/items/1-weapon-xdmg.md) (each deals `1d8 + 4` damage in [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md)'s hands) hang on the wall above. Underneath the armor are his [gauntlets of ogre power](3-Mechanics/CLI/items/gauntlets-of-ogre-power-xdmg.md) (giving him an additional +1 to attack and damage rolls with melee weapons). His [ring of invisibility](3-Mechanics/CLI/items/ring-of-invisibility-xdmg.md) is on a small stand near his bed.

Upon entering the room [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md) will palm the ring, don the armor, put on the gauntlets, thong the axe to his belt, heft the hammer, and grab the shield. At the first good opportunity he will attack the party and raise a cry for help, but he will do so only when he knows help will be able to come. He knows a bit about the drow, and he will bargain with that information, or anything else, to save his life. If offered no quarter, he will fight to the very end.

#### Treasure

In addition to [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md)'s magical gear, both of the iron chests contain valuables. One chest holds 900 gp. The other holds 100 pp and a bejeweled silver ewer and silver bowl (each item worth 500 gp).
...
Each of the batons is a token of free passage whose runes read, in Giant, "Official Business on Behalf of [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md) the Fearsome." Any individuals or groups that display one of these items are safe from attacks by the giants or the giants' allies as long as they take no aggressive action.
...
A [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) stands guard at all times outside the doors to the council chambers.
...
The place is typically occupied by busy workers: a [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) matron, two fire giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to fire damage), and seven [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) thralls. The servants and the gnolls fight only under the direction of the matron, fleeing or surrendering if she falls.
...
The doors to this room are closed on the outside by a great bar, because [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md) does not fully trust his guest, a [rakshasa](3-Mechanics/CLI/bestiary/fiend/rakshasa-xmm.md), that resides herein. Naturally, most adventurers will assume a creature thus imprisoned might become a trusted associate—an attitude the rakshasa will encourage by taking some benign form (such as that of a fellow adventurer, a kindred soul, who has been deprived of equipment) to gain the characters' confidence before it attacks.
...
The rakshasa carries 50 gp and two gems (worth 100 gp each). The disguised chest holds a jeweled scepter worth 1,000 gp, three potions ([superior healing](3-Mechanics/CLI/items/potion-of-superior-healing-xdmg.md), [mind reading](3-Mechanics/CLI/items/potion-of-mind-reading-xdmg.md), and [invulnerability](3-Mechanics/CLI/items/potion-of-invulnerability-xdmg.md)), and five [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) ([zone of truth](3-Mechanics/CLI/spells/zone-of-truth-xphb.md), [true seeing](3-Mechanics/CLI/spells/true-seeing-xphb.md), [darkness](3-Mechanics/CLI/spells/darkness-xphb.md), [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md) cast at 4th level, and [symbol](3-Mechanics/CLI/spells/symbol-xphb.md)).

### 18. Barracks

Currently two [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) and two fire giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to fire damage) are housed here. They typically lounge around sharpening weapons and telling lies about their amatory prowess.
...
Three fire giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to fire damage) care for six young fire giants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics, plus immunity to fire damage) in this vast chamber. All have weapons (kids' toys for the youngsters) and will fight with enthusiasm.
...
Four [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) scuffle and play just inside the doors. They are part of the pack at area 22 and will flee thereto by the safest route if threatened.

### 22. Kennel Chamber

Four [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) are here. If those in area 21 are attacked and yelp for assistance, these beasts split into pairs and station themselves in the north and south ends of the open area, from where they spring to the aid of the others. The hell hounds love their handler at area 23 and come to his rescue if he whistles.
...
The javelin leaning against the wall is actually a [javelin of lightning](3-Mechanics/CLI/items/javelin-of-lightning-xdmg.md).

One of the six cloaks on the bench is a [hell hound cloak](3-Mechanics/CLI/items/hell-hound-cloak-tftyp.md) (see appendix A). Wrapped inside this cursed cloak is a [sword of vengeance](3-Mechanics/CLI/items/sword-of-vengeance-xdmg.md). There are three other hell hound hides in the chamber (those of beloved departed pets), all quite normal.

### 24. Guardpost

A [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) is on duty here at all times with four throwing rocks nearby. An iron cylinder hanging near the north wall is a gong to be sounded if intruders are seen.

### 25. Barracks

Two [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) warriors and two fire giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to fire damage) are lounging among the cots, chests, and other furniture that fill this place. Several pegs here and there hold cloaks, capes, shields, and four giants' bags. There are only worthless giant-sized items in the chests and other containers.

One warrior has a greatsword, and the other one fights with a human-sized [+2 greataxe](3-Mechanics/CLI/items/2-weapon-xdmg.md). The weapon gives the giant a +13 bonus to hit and deals 22 (`3d8 + 9`) slashing damage. The room also has twenty-one throwing rocks, which all the giants will use if the opportunity presents itself.
...
- One [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) and one [fire giant servant](3-Mechanics/CLI/bestiary/giant/fire-giant-servant-tftyp.md) (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to fire damage)  
- One [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) escorting one [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md), one [stone giant](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md), or one [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md)  
- One [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) with ten [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md)  
- One [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) with five [wererats](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md)  
...
The doors to the north open into a room that houses two [stone giants](3-Mechanics/CLI/bestiary/giant/stone-giant-xmm.md) who have been working for [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md) as engineers. The room, lit by torches, contains four cots, a large table, other furnishings, and pegs that hold clothing and two giants' bags. Eleven throwing rocks are scattered on the floor. A haunch of meat rests on the table along with mugs and platters of tin.
...
This room, illuminated by four torches set in wall cressets, has been cleaned out to serve as quarters for four [hill giants](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md). If they survived or escaped the assault on the steading, [Chief Nosnra](3-Mechanics/CLI/bestiary/npc/chief-nosnra-tftyp.md) and his wife are among the occupants.
...
If Nosnra and [Grutha](3-Mechanics/CLI/bestiary/npc/grutha-tftyp.md) are present, the place has two cots, two heaps of skins, a trunk, a chain, a table, and two chests.
...
In this large area are housed a [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) warrior, three fire giant servants (use the [hill giant](3-Mechanics/CLI/bestiary/giant/hill-giant-xmm.md) statistics, plus immunity to fire damage), and four young fire giants (use the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) statistics, plus immunity to fire damage). All are armed with various weapons, even the young, and there are twenty throwing rocks in the chamber.
...
A knotty-limbed, burly [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md), [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md)'s weaponsmith, is working here. He uses the molten lava to heat the items he works. With him are two [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) that serve as his assistants. Currently in his forge, in various stages of completion, are three giant-sized swords, some pieces of armor, and several axe and spear heads.

#### Treasure

The weaponsmith has in his possession a special [+2 mace](3-Mechanics/CLI/items/2-weapon-xdmg.md), made of strange black metal, that he is doing some repair work on. If he is attacked and the fight goes against him, there is a 33 percent chance per round that he uses his action to toss the mace into the lava and destroy it, rather than let it fall into the hands of his enemies.
...
Two [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md), the King's Torturer and the Royal Headsman, are crouched in the center of the room, playing knucklebones on the floor with stakes of jewelry gems scattered in front of them. The headsman has his gigantic [+2 greataxe](3-Mechanics/CLI/items/2-weapon-xdmg.md) at hand—a weapon that can be employed only by a creature at least as strong and massive as he is. He has a +13 bonus to hit with the weapon, and it deals 28 (`3d12 + 9`) slashing damage on a hit. His friend the torturer has a greatsword nearby.
...
The female elf in this cell is destined for sacrifice in the Temple. She is a [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md), and she promises that if she is rescued, she will send her rescuers a reward of 1,000 gp, twenty [+1 arrows](3-Mechanics/CLI/items/1-ammunition-xdmg.md), an [arrow of giant slaying](3-Mechanics/CLI/items/ammunition-of-slaying-xdmg.md), a [cloak of elvenkind](3-Mechanics/CLI/items/cloak-of-elvenkind-xdmg.md), and a pair of [boots of elvenkind](3-Mechanics/CLI/items/boots-of-elvenkind-xdmg.md). The reward will come to the characters a month or two after she is able to leave the stronghold and return home.

#### Cell 2C

Eight male elf [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) are awaiting sacrifice in the Temple. They have no treasure, but they promise to sing their rescuers' praises.

#### Cell 3C

A merchant is being held for ransom. He is a human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) whose goods have all been seized by the giants, and thus he can pay his rescuers only with eternal gratitude.
...
Two noble [centaurs](3-Mechanics/CLI/bestiary/fey/centaur-trooper-xmm.md) imprisoned here are bound for torture and execution. They offer help to any who free them.
...
Three [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) being punished for insubordination were thrown in here. One is already dead from the aftereffects of torture; the other two will serve any rescuer who can tolerate their habits.
...
In this cell sits a [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) that is used for torture practice from time to time. It is mindless and enraged, so it will attack instantly if given a chance. Otherwise, it remains motionless.

#### Cell 10C

Seven [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) caught stealing gold await their fate in this cell. They run away as fast as possible.
...
A female human [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) is chained to the wall. She cheerfully admits to being a thief who was caught trying to find the king's treasure room ("Know where it is?") and volunteers to aid the party faithfully in exchange for a chance to escape. Thereafter, if the opportunity presents itself, she will heist as much in gems and magic as she can and then slip away—but until then she will help the characters to the best of her ability (both to better her own chances of staying alive in this awful place and to win their trust). During this time she will be casing the characters to learn what they carry.

#### Cell 13C

The king's chief lieutenant, a [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) named Boldo, hangs in chains as punishment for failing to be properly deferential to Snurre. He will do anything to get back into Snurre's favor. Thus, he will happily lie to the party and tell them he is here because he tried to prevent Snurre from taking his current hostile course. If freed, he tells the characters, he can get several other fire giants to aid them in overthrowing the king and restoring the peace. In fact, Boldo will betray the party at his earliest opportunity. He is quite bright, and he will not be rash.

#### Cell 14C

Chained in the cell next to the guardroom is an [empyrean](3-Mechanics/CLI/bestiary/miscellaneous/empyrean-xmm.md) (of chaotic good alignment). It has been drugged and is effectively [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious). A character who succeeds on a DC 15 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check can identify the effects of exposure to a virulent form of [oil of taggit](3-Mechanics/CLI/items/oil-of-taggit-xdmg.md) (see ""Sample Poisons"" in chapter 8 of the "Dungeon Master's Guide"). Magic, such as [protection from poison](3-Mechanics/CLI/spells/protection-from-poison-xphb.md) or [lesser restoration](3-Mechanics/CLI/spells/lesser-restoration-xphb.md), can remove the poison from the empyrean's system. Otherwise, he recovers naturally in 12 hours. If awakened, he helps any party destroy the inhabitants of this place, although he would not mind seeing evil characters in the party die also.

#### Guardroom (G)

One [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) guard and three [wererats](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) in human form (appearing as female humans in tattered clothing) are conversing here by torchlight. The giant has two rocks nearby. In the room are a table, a chair, a stool, a bench, three kegs on the floor, and a small, covered jar on the table. The first keg holds small beer, the second one water, and the third one mead. The jar contains [oil of taggit](3-Mechanics/CLI/items/oil-of-taggit-xdmg.md); anyone who opens the jar is exposed to the poison and has disadvantage on the saving throw. On the walls are pegs holding a giant's bag, a cape, a shield, keys to the cells, and a shirt.
...
This place, pitch dark, is the lair of seven [wererats](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md). If the encounter is going badly for them, survivors flee down the northeast passageway to area 15 on the third level (map 6.7) and warn the drow.

Aside from stolen cloaks piled here and there like nests, the chief features in this secret room are three heavy iron chests. All are locked, and each key is on a different wererat. The chests are also trapped with poison needles (see "[Sample Traps](3-Mechanics/CLI/traps-hazards/poisoned-needle-xdmg.md)" in chapter 5 of the "Dungeon Master's Guide"). The poison on these needles is [oil of taggit](3-Mechanics/CLI/items/oil-of-taggit-xdmg.md) (see ""Sample Poisons"" in chapter 8 of the "Dungeon Master's Guide").
...
The second chest contains a [potion of poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md), 800 gp (loose), and a cursed [scroll of protection](3-Mechanics/CLI/items/scroll-of-protection-xdmg.md) (lycanthropes). Someone who reads the scroll must succeed on a DC 15 Wisdom saving throw or become afflicted with wererat lycanthropy.

The third chest is empty, but a permanent [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md) spell covers writing on the inside of the lid. If the invisibility is dispelled, the information tells where a stone in the wall along the stairs down can be removed to reveal a [ring of shooting stars](3-Mechanics/CLI/items/ring-of-shooting-stars-xdmg.md), a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of seven cleric spells (DM's choice), and a metal case holding six potions ([healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), [diminution](3-Mechanics/CLI/items/potion-of-diminution-xdmg.md), plus four more of the DM's choice).

A secret compartment in the lid of the box that contains the potions holds [pipes of the sewers](3-Mechanics/CLI/items/pipes-of-the-sewers-xdmg.md). A character who succeeds on a DC 20 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check while examining the box finds the compartment.
...
The large pillar to the east on the first tier is made of malachite and is covered with graven signs and sigils. A casting of [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) reveals that the glyphs radiate an aura of conjuration magic. If the correct pair of glyphs are touched, the creature touching them will be transported to area 18 on the third level (see map 6.7). You should devise the twenty-four glyphs upon this pillar and select which two are the trigger mechanism.
...
The entrance to this chamber is protected by a wall of tentacles (not depicted on the map). It appears as rough brown-purple stone. This magic wall is like two [ropers](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) combined into one creature, giving it two bite attacks and eight tendrils that it can employ every round (though the tendrils have a range of only 20 feet). The wall has resistance to bludgeoning, piercing, and slashing damage from nonmagical weapons. A casting of [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) deals the wall 50 damage, and [disintegrate](3-Mechanics/CLI/spells/disintegrate-xphb.md) deals it 100 damage.

Drow can freely pass through the wall. If any other creature touches it, the wall attacks and emits a hissing and champing noise to alert the occupants of the chamber beyond it. If its current hit points drop to half its hit point maximum or lower, the wall casts [darkness](3-Mechanics/CLI/spells/darkness-xphb.md) on itself (affecting only the outside of the wall, not its inner surface).
...
The antechamber is the quarters of a [drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) and a [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) who assist their priestess, Eclavdra. Each has a [tentacle rod](3-Mechanics/CLI/items/tentacle-rod-xdmg.md) in addition to its usual gear and weaponry.
...
The jasper basins and ewers are worth 300 gp per set. The first coffer examined holds a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [word of recall](3-Mechanics/CLI/spells/word-of-recall-xphb.md) and three bars of adamantine, each weighing 5 pounds and worth 500 gp each. The second coffer contains 100 cp, 100 sp, 10 ep, 20 gp, and 10 pp, each type of coin in its own black leather pouch, as well as a pouch of ten gems (worth 50 gp each).

#### Inner Chamber

The inner room, lavishly furnished and decorated, is the sanctuary of Eclavdra, the [drow priestess of Lolth](3-Mechanics/CLI/bestiary/humanoid/fiend-cultist-xmm.md) who has fomented all the trouble with the giants. Like her assistants, she also carries a [tentacle rod](3-Mechanics/CLI/items/tentacle-rod-xdmg.md) in addition to her other equipment.
...
A coffer on the low chest between the divans has a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) on the inside of the lid, so if anyone other than Eclavdra opens it, the glyph casts [insect plague](3-Mechanics/CLI/spells/insect-plague-xphb.md) (spell save DC 14). The container holds three [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) ([gate](3-Mechanics/CLI/spells/gate-xphb.md), [divine word](3-Mechanics/CLI/spells/divine-word-xphb.md), and [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md)).

A coffer near her bed contains six potions: [poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md), [mind control (fire giant)](3-Mechanics/CLI/items/potion-of-mind-control-tftyp.md) (see appendix A), [growth](3-Mechanics/CLI/items/potion-of-growth-xdmg.md), [heroism](3-Mechanics/CLI/items/potion-of-heroism-xdmg.md), and two [philters of love](3-Mechanics/CLI/items/philter-of-love-xdmg.md).
...
If [Jarl Grugnur](3-Mechanics/CLI/bestiary/npc/jarl-grugnur-tftyp.md) and his lady, [Estia](3-Mechanics/CLI/bestiary/npc/estia-tftyp.md), survived the assault on the glacial rift, they will be sequestered in this chamber, accompanied by a [frost giant](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md) that serves as a door guard. If the jarl and his lady are not present, the room contains two [frost giants](3-Mechanics/CLI/bestiary/giant/frost-giant-xmm.md), recently arrived messengers.
...
Two [cloud giants](3-Mechanics/CLI/bestiary/giant/cloud-giant-xmm.md), a noble and his traveling companion, have come to hear from [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md) why his warfare will profit them and make them more powerful. The giants have two [lions](3-Mechanics/CLI/bestiary/beast/lion-xmm.md) serving as watch-animals at the door. The noble has a chain mail coat (AC 16), and both have their great morningstars and throwing rocks nearby.
...
Sixteen unarmed [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) dwell here. Each has nothing but a heap of straw and a hide coverlet. Although these creatures are slaves of the giants, they identify with their masters' cause and will never help humans for any reason—in fact, they will gladly take up arms to fight intruders if given the chance.

### 17. Thrall Pen

Ten unarmed [gnolls](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) dwell here. They will behave in all respects like their kin in area 16.
...
- Two wandering [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md)  
- A [fire giant](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) patrolling with two [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md)  
- One [drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) and three [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) that use stealth to remain undetected and avoid confrontation  
...
This cavern is fairly colorful, having many reddish, pale yellow, and shining blue-gray rock formations that glisten in the light of torches or lanterns. Three [ropers](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) dwell here and conceal themselves among the natural stalagmite formations. They wait until prey approaches the center of the area before attacking.
...
This small offshoot of the larger cavern that runs north and south is filled with luminous plant growth and contains twelve hungry [giant fire beetles](3-Mechanics/CLI/bestiary/beast/giant-fire-beetle-xmm.md). Some will be on the ceiling and drop upon any creatures entering their lair. These creatures served as a source of gifts for the frost giants in the past. They have no treasure.
...
Four [hell hounds](3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) are on guard here, immediately giving voice if they detect any intruders.

### 5. Cavern

Two [fire giants](3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) are stationed here as a reserve on Snurre's order (acting on instructions from the drow, of course). One rests in the northeast end while the other keeps watch, patrolling between the spots marked G. Each has several rocks nearby for throwing. They have a typical giant's bag apiece, and the room also has piles of hides for bedding, a hamper or two, and some personal gear.

In a crisis situation, this is where [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md), Queen Frupy, [Obmi](3-Mechanics/CLI/bestiary/npc/obmi-tftyp.md), and other important fire giants and guests will retreat to, along with whatever valuables they can salvage.

### 6. Great Vaulted Cavern

In the middle of this place is a permanent illusion of a huge red dragon dozing atop a mound of treasure (appearing like area 7, below). What is actually in that spot is a [gorgon](3-Mechanics/CLI/bestiary/construct/gorgon-xmm.md) that obeys drow and has been instructed to ignore the presence of such creatures as hell hounds and fire giants and trolls. If any other kind of creature speaks to it from a distance in Common or Draconic, it has been instructed to stand quietly but then to breathe upon intruders as soon as they are within range. The illusion disappears once the gorgon attacks.

### 7. Treasure Trove Cave

This room is actually an extradimensional space, ten times larger than shown on the map. Anyone entering will notice first the enormous pile of treasure that fills the central part of the area and second the [adult red dragon](3-Mechanics/CLI/bestiary/dragon/adult-red-dragon-xmm.md) sleeping upon it.
...
- Seven [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of wizard spells (DM's choice) in a crystal casket worth 500 gp  
- A [dragon slayer](3-Mechanics/CLI/items/dragon-slayer-xdmg.md) (DM's choice of sword type) in a jeweled scabbard worth 500 gp  
- A [brazier of commanding fire elementals](3-Mechanics/CLI/items/brazier-of-commanding-fire-elementals-xdmg.md)  
- Four [potions of fire resistance (fire)](3-Mechanics/CLI/items/potion-of-fire-resistance-xdmg.md) in a coffer  
- Eight jars of rare unguents and perfumes worth 100 gp each  
- A suit of [+2 armor](3-Mechanics/CLI/items/2-armor-xdmg.md), sized for a human (DM's choice of armor type)  
...
This is a drow guardroom, currently housing three [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) and six [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md). All are clothed in black capes, shod with soft boots of black hide, and wear hoods over their helmets. Two sentries are on duty at all times near the entrance. The room holds only bedrolls and some miscellaneous gear.
...
Twelve [piercers](3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md) make their home in a cul de sac, where they patiently await unwary prey. The floor of the place is strewn with shattered skulls and bones.
...
This small place has excellent acoustics, and the drops of water falling into the pool along the southern portion of the wall make a faint, pleasant musical sound that can be heard for 120 feet in silence (or from 60 feet away in normal conditions). The pool's edge is lined by a huge patch of [gray ooze](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md), and another lies along a ledge 11 feet high in the southeast of the place.

### Stinking Caverns (Areas 11-13)

The large spaces along the southern side of this level are inhabited by troll servants of [King Snurre](3-Mechanics/CLI/bestiary/npc/king-snurre-tftyp.md). The stink that comes from these creatures, their nests, and the offal and remnants of rotted meat they leave about is noticeable from as far away as the head of the corridor that leads southwest from near area 9.
...
Three [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) lounge herein, each with the typical messy mound of sticks and bones and other noisome things.

#### 12. Troll Central

Two [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md). This room, and its inhabitants, are much the same as those in area 11.

#### 13. Troll Heaven

Four [trolls](3-Mechanics/CLI/bestiary/giant/troll-xmm.md), including a dominant one that is particularly large (120 hit points), reside here. Conditions are similar to those in areas 11 and 12, except even more noisome.

### 14. Narrow Cavern

The corridor leading north from the troll dens is striated with layers of blue and green and greenish-blue deposits and streaks. Patches of green slime (see "[Dungeon Hazards](3-Mechanics/CLI/traps-hazards/green-slime-xdmg.md)" in chapter 5 of the "Dungeon Master's Guide") grow on the roof of the passage and in the pool of water at its end. The slime on the ceiling covers an area about 40 feet wide just south of the pool. The pool holds thirty-six agates (worth 10 gp each), which sparkle in the presence of any light-source. Any creature that reaches in to get these stones is 50 percent likely to blunder into the slime in the pool, which blends in with the greenish rock.

### 15. Gray Cavern

This dark-walled place is the drow strong point, and a [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) watches each of the six routes that meet at this cavern. Four more drow are stationed in the chamber itself, for a total of ten.

In addition, the eastern alcove serves as a field headquarters for two [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) (the female is in command) and a [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md). Near this alcove, a narrow passage leads east and then south, ending at a set of rough-hewn stairs that ascend to the second level, emerging near area 8 on map 6.6.
...
There are nine female drow in the place. Five are normal [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md), and three others are [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md). These eight guards protect [Nedylene](3-Mechanics/CLI/bestiary/npc/nedylene-tftyp.md), a [drow priestess of Lolth](3-Mechanics/CLI/bestiary/humanoid/fiend-cultist-xmm.md) who is opposed to anything Eclavdra attempts. She is here to check up on her rival, and she will be suspicious of any creature entering her current abode. On the other hand, she will not be averse to seeing her rival's plans go wrong, so negotiation is a possibility.

[Nedylene](3-Mechanics/CLI/bestiary/npc/nedylene-tftyp.md) wields a [+2 whip](3-Mechanics/CLI/items/2-weapon-xdmg.md) and carries a [staff of swarming insects](3-Mechanics/CLI/items/staff-of-swarming-insects-xdmg.md) in addition to her other gear.

### 17. Jeweled Cavern

If light strikes the walls of this cavern, mineral deposits make the place glitter and sparkle as if it were sown with jewels. This breathtakingly beautiful place is the current lair of two [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) who have decided to see what is going on with their friendly enemies, the drow. They plan to observe events, and the dark elves ignore them.

#### Treasure

Each mind flayer carries 250 gp (bribe money), and they have a [tome of clear thought](3-Mechanics/CLI/items/tome-of-clear-thought-xdmg.md) in a black metal box that can be opened only by a creature that has Intelligence 18 or higher.

### 18. Small Cavern

The cave at the end of the passage to the northeast is another drow guardroom, with occupants and contents identical to area 8: three [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) and six [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md), two of which are on duty at all times near the entrance.
...
Amid this vaporous inferno in the area to the southeast are two [salamanders](3-Mechanics/CLI/bestiary/elemental/salamander-xmm.md) enjoying a change of clime. The flames and smoke render the area lightly obscured. The salamanders are totally indifferent with respect to whom they attack, although they know and respect the drow.
...
Currently in this place (at the least) are six [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) and four [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md), one of which is a female commander who has 110 hit points. The commander has a [+2 shortsword](3-Mechanics/CLI/items/2-weapon-xdmg.md), a [+1 hand crossbow](3-Mechanics/CLI/items/1-weapon-xdmg.md), and three magic bolts, as follows:

- A *bolt of holding*, which casts [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md) on a target hit with the bolt, as well as up to two other targets within 30 feet of that target  
- A *bolt of blinding*, which casts [blindness/deafness](3-Mechanics/CLI/spells/blindness-deafness-xphb.md) to blind on a target hit with the bolt, as well as up to two other targets within 30 feet of that target  
- A *bolt of vapors*, which casts [stinking cloud](3-Mechanics/CLI/spells/stinking-cloud-xphb.md) centered on the point it hits  
...
The commander has a small coffer that contains two [potions of speed](3-Mechanics/CLI/items/potion-of-speed-xdmg.md) and two [potions of superior healing](3-Mechanics/CLI/items/potion-of-superior-healing-xdmg.md). These will be used by the drow if necessary (and if she is able to dispense them).
