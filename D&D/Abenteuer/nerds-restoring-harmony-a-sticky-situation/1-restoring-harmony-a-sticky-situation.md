...
Begin play in the sparring room of the Critical Strike Combat School where Orange is exercising and practicing various skills with the sword. In the training room, Orange has access to one energy drink which acts as a [potion of healing](3-Mechanics/CLI/items/potion-of-healing.md).
...
If Orange defeats the goons, [Mr. Honeycutt](3-Mechanics/CLI/bestiary/npc/mr-honeycutt-nrh-tcmc.md) arrives just after, hoping to warn Orange of the impending fight.
...
If Orange agrees to help, Mr. Honeycutt offers a reward of 20 gp for the return of the gem. He also gives Orange a necklace of fireballs with one bead remaining. As he gives the item to Orange, Mr. Honeycutt says, "I hope you never have to use this."
...
![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-a-sticky-situation/img/006.webp#center)
...
The staircase leads down to a corridor that ends in a rotting wood door which can be easily opened or broken down. However, lurking on the ceiling of this corridor is a [gray ooze](3-Mechanics/CLI/bestiary/ooze/gray-ooze.md).
...
If Orange listens at the door to this tomb before opening it, they hear tapping or clacking sounds. Opening the door reveals two [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton.md) repeatedly bumping into each other. When the door opens, they attack.
...
Orange has discovered a [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube.md) that's behaving oddly!

##### Encounter Adjustments

The gelatinous cube is weakened from its attempts to digest the Peach Gem and a magic sword, both of which it has engulfed. When Orange discovers the [gelatinous cube](3-Mechanics/CLI/bestiary/ooze/gelatinous-cube.md), it only has 40 hit points remaining and it doesn't have its Transparent trait.

##### Defeating the Cube

Even in its weakened stat, a gelatinous cube is no easy task. Hopefully, Orange uses the last bead of the necklace of fireballs to finish off the cube. If that doesn't work, have [Mr. Honeycutt](3-Mechanics/CLI/bestiary/npc/mr-honeycutt-nrh-tcmc.md) arrive with four [guards](3-Mechanics/CLI/bestiary/humanoid/guard.md) to help Orange defeat the cube. Have the cube attack the guards first before attacking Mr. Honeycutt or Orange.

##### Monster Tactics

The gelatinous cube is a floor-to-ceiling blob. Due to its digestive issues, this one is a sickly green. Regardless, its pseudopods sweep out in search of more things to digest, slow-moving like a street sweeper. If it senses a living creature, it moves toward them at full speed and uses its Engulf action as soon as it can.
...
|----------|----------|
| 1 | +1 greatsword |
| 2 | [Potion of healing](3-Mechanics/CLI/items/potion-of-healing.md) |
...
When the gelatinous cube is reduced to 24 hit points or fewer, it spits out the +1 greatsword, the [potion of healing](3-Mechanics/CLI/items/potion-of-healing.md), and the glowing orange gem (the Peach Gem), and makes its retreat by dashing away.
...
![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-a-sticky-situation/img/sheet005.webp#center)

![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-a-sticky-situation/img/sheet006.webp#center)