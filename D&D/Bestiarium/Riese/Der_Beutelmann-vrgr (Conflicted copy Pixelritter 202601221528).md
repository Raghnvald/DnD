...
Der Beutelmann ist eine Legende über einen Abenteurer, der dem Untergang entkommen wollte, indem er seine Abenteurergruppe im Stich ließ und sich in einem Nimmervollen Beutel versteckte. Doch als er aus dem Beutel steigen wollte, verlief er sich in den extradimensionalen Lagerräumen, die immer zahlreicher wurden. Die merkwürdigen Kräfte dieser magischen Zwischenwelt verwandelten den Abenteurer im Lauf der Zeit in eine monströse Kreatur.Jetzt kommt der Beutelmann jede Nacht aus einem zufälligen Nimmervollen Beutel. Wenn er sein Zuhause nicht findet, zerrt er jemanden mit sich in den Beutel und hinterlässt einen Gegenstand aus seinem verborgenen Königreich verlorener Objekte. Manche sagen, dass man nicht zu laut in der Nähe eines offenen Nimmervollen Beutels sprechen und auch nicht dreimal „Folge meiner Stimme" in einem magischen Lagerraum sagen soll, weil der Beutelmann einen sonst holen kommt. 

Jeder Charakter könnte die Geschichte vom Beutelmann kennen. Was der Beutelmann ist und wie du ihn als Legende einsetzen willst, ist deine Entscheidung. Gibt es den Beutelmann wirklich? Oder ist er nur ein Märchen? Wenn ein Objekt über Nacht verschwindet oder jemand etwas in seinem Nimmervollen Beutel findet, das ihm nicht gehört - war das der Beutelmann? Ist der Beutelmann ein Monster, das sich an Abenteurern vergreift, oder sogar der Dunkle Fürst einer verborgenen Domäne? Die Möglichkeiten für Horrorabenteuer sind zahllos, und nichts ist sicher - erst recht nicht die Ausrüstung der Abenteurer. 
...
"cr": "5"
"traits":
  - "desc": "The Bagman has advantage on Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception))\
  ...
  - "desc": "The Bagman regains 10 hit points at the start of its turn. If the Bagman\
    ...
    "name": "Regeneration"
  - "desc": "The Bagman has advantage on attack rolls against any creature [grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
      \ by it."
    "name": "Grappler"
  ...
  - "desc": "If a creature tries to read the Bagman's thoughts, that creature must\
      \ succeed on a DC 8 Intelligence saving throw or be [stunned](/3-Mechanics/CLI/conditions.md#Stunned)\
