...
"actions":
  ...
  - "desc": "Willifort magically reads the surface thoughts of one creature within\
      ...
      \ as Willifort's concentration isn't broken (as if concentrating on a spell).\
      \ While reading the target's mind, Willifort has advantage on Wisdom (Insight)\
      \ and Charisma (Deception, Intimidation, and Persuasion) checks against the\
      \ target."
    "name": "Read Thoughts"
"source":
  - "WDH"
