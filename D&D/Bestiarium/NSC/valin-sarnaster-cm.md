...
"traits":
  - "desc": "Valin Sarnaster is a 10th-level spellcaster. Her spellcasting ability\
      ...
      \ (3 slots):** clairvoyance, dispel magic\n\n**4th level (3 slots):** divination,\
...
"actions":
  ...
  - "desc": "Valin targets one creature she can see within 60 feet of her. If the\
      ...
      \ this magic or become frightened until the end of Valin's next turn. If the\
...
"regional_effects":
  - "desc": "Valin's tomb is warped in any of the following ways by the creature's\
      ...
      \ other than Valin have a 25 percent chance to provide misleading results, as\
      \ determined by the DM. If a divination spell already has a chance to fail or\
      \ become unreliable when cast multiple times, that chance increases by 25 percent.\
      \  \n- A creature that takes treasure from the lair is cursed until the treasure\
      \ is returned. The cursed target has disadvantage on all saving throws. The\
      \ curse lasts until removed by a remove curse spell or other magic.  \n\nIf\
      \ Valin is destroyed, these regional effects end immediately."
    "name": ""
...
"legendary_actions":
  ...
  - "desc": "Blinding dust and sand swirls magically around Valin. Each creature within\
      \ 5 feet of Valin must succeed on a DC 16 Constitution saving throw or be blinded\
  ...
  - "desc": "Valin utters a blasphemous word. Each non-undead creature within 10 feet\
      ...
      \ saving throw or be stunned until the end of Valin's next turn."
  ...
  - "desc": "Valin magically transforms into a whirlwind of sand, moves up to 60 feet,\
      ...
      \ all damage, and it can't be grappled, petrified, knocked prone, restrained,\
      \ or stunned. Equipment worn or carried by Valin remain in her possession."
