...
"traits":
  - "desc": "Sharwyn is a 1st-level spellcaster. Her spellcasting ability is Intelligence\
      ...
      \ spells prepared:\n\n**Cantrips (at will):** light, prestidigitation, ray of\
      \ frost\n\n**1st level (2 slots):** color spray, magic missile, shield, sleep"
    "name": "Spellcasting"
  - "desc": "Sharwyn's AC can't be lower than 16."
    "name": "Barkskin"
  - "desc": "Sharwyn has a spellbook that contains the spells listed in her Spellcasting\
      \ trait, plus detect magic and silent image."
...
"source":
  - "TftYP"
"image": "/3-Mechanics/CLI/bestiary/npc/token/sharwyn-hucrele-tftyp.webp"
```
^statblock