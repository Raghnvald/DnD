...
"traits":
  ...
  - "desc": "Grog wears a [belt of dwarvenkind](/3-Mechanics/CLI/items/belt-of-dwarvenkind-xdmg.md).\
      ...
      \ weapon), a [dwarven thrower](/3-Mechanics/CLI/items/dwarven-thrower-xdmg.md),\
  ...
  - "desc": "When Grog damages a creature that is concentrating on a spell, that creature\
      \ has disadvantage on the saving throw to maintain its [concentration](/3-Mechanics/CLI/conditions.md#Concentration).\
...
"actions":
  - "desc": "Grog makes two attacks (three when raging) with his [Bloodaxe](/3-Mechanics/CLI/items/bloodaxe-egw.md),\
      \ [dwarven thrower](/3-Mechanics/CLI/items/dwarven-thrower-xdmg.md), or [Titanstone\
...
"bonus_actions":
  - "desc": "Grog enters a rage that lasts until he falls [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious)\
      ...
      \ and slashing damage  \n- He can't be [charmed](/3-Mechanics/CLI/conditions.md#Charmed)\
      \ or [frightened](/3-Mechanics/CLI/conditions.md#Frightened)  \n- He can make\
      \ an additional melee weapon attack (included in the Multiattack action)  \n\
      \nWhen Grog's rage ends, he gains one level of [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion)."
