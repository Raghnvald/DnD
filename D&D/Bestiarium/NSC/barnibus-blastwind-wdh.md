...
"traits":
  - "desc": "Barnibus is a 7th-level spellcaster. His spellcasting ability is Intelligence\
      ...
      \ message\n\n**1st level (4 slots):** comprehend languages, identify, detect\
      \ magic, mage armor, shield\n\n**2nd level (3 slots):** detect thoughts, suggestion\n\
      \n**3rd level (3 slots):** clairvoyance, sending\n\n**4th level (1 slots):**\
      \ locate creature, Otiluke's resilient sphere"
    "name": "Spellcasting"
  - "desc": "Barnibus carries a wand of magic detection. (spell included in spell\
      \ list below but does not use a slot when cast from the wand)"
