...
One night while the others slept, Nass stole a [professor orb](/3-Mechanics/CLI/items/professor-skant-idrotf.md) (see appendix D) from one of her fellow wizards, Vellynne Harpell. Two of Vellynne's kobold companions witnessed the theft, and Nass killed them with Melf's acid arrow spells before fleeing with the orb.
...
"actions":
  ...
  - "desc": "Each non-undead creature within 60 feet of the ghost that can see it\
      ...
      \ the frightened condition on itself on a success. If the target's saving throw\
      ...
      \ by a greater restoration spell, but only if it is cast within 24 hours."
