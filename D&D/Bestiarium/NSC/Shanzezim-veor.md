...
traits:
  - name: Amphibisch
    desc: Shanzezim kann Luft und Wasser atmen.
  - name: Elementarer Untergang
    desc: Wenn Shanzezim stirbt, löst sich sein Körper in eine Explosion aus Wasser und Schaum auf. Es bleibt nur die Ausrüstung zurück, die Shanzezim getragen oder in der Hand gehalten hat.
  - name: Angeborenes Zauberwirken
    desc: |-
      Das Attribut zum Wirken angeborener Zauber für Shanzezim ist Charisma (Zauberrettungswurf-SG 16, +8 zum Treffen mit Zauberangriffen). Er kann angeboren die folgenden Zauber wirken, wobei keine Materialkomponenten nötig sind:
...
actions:
  - name: Mehrfachangriff
    desc: Shanzezim führt zwei Dreizack-Angriffe aus.
  - name: Dreizack
