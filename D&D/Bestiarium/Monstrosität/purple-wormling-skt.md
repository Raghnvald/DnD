...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 7 (1d8\
      ...
      \ other effects outside the wormling, and it takes 3 (1d6) acid damage at the\
      \ start of each of the wormling's turns.\n\nIf the wormling takes 10 damage\
      \ or more on a single turn from a creature inside it, the wormling must succeed\
      \ on a DC 21 Constitution saving throw at the end of that turn or regurgitate\
      \ all swallowed creatures, which fall prone in a space within 10 feet of the\
      \ wormling. If the wormling dies, a swallowed creature is no longer restrained\
