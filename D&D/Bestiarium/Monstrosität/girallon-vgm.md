...
"traits":
  - "desc": "As a bonus action, the girallon can move up to its speed toward a hostile\
    ...
    "name": "Aggressive"
  - "desc": "The girallon has advantage on Wisdom (Perception) checks that rely on\
      \ smell."
    "name": "Keen Smell"
"actions":
  - "desc": "The girallon makes five attacks: one with its bite and four with its\
      \ claws."
    "name": "Multiattack"
...
"source":
  - "VGM"
  - "ToA"
"image": "/3-Mechanics/CLI/bestiary/monstrosity/token/girallon-vgm.webp"
```
^statblock
