...
Most serpentfolk have little love for the [Cloaked Serpent](/3-Mechanics/CLI/deities/exandria-the-cloaked-serpent-tdcsr.md), though they pay him homage as the deity of poisons, assassins, and darkness. For the Vos'skyriss serpentfolk, worship is a means to an end. Their legends say that the devout will be granted the ability to devour nightmares, enabling them to gorge themselves on dreams of fear and terror until they grow so large that they can turn on their god and swallow the [Cloaked Serpent](/3-Mechanics/CLI/deities/exandria-the-cloaked-serpent-tdcsr.md) himself. Once begun, this feast is unending—they will devour the remaining gods one by one, and finally, the entirety of the multiverse.
...
"cr": "3"
"traits":
  - "desc": "The serpentfolk's innate spellcasting ability is Charisma (spell save\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 7\
      \ (1d8 + 3) bludgeoning damage, and the target is [grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
      \ (escape DC 13). Until this [grapple](/3-Mechanics/CLI/variant-rules/unarmed-strike-xphb.md)\
      \ ends, the creature is [restrained](/3-Mechanics/CLI/conditions.md#Restrained),\
