...
"actions":
  - "desc": "*Melee Weapon Attack:* +3 to hit, reach 0 ft., one target in the swarm's\
      ...
      \ points by a swarm of centipedes is stable but [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned)\
      \ for 1 hour, even after regaining hit points, and [paralyzed](/3-Mechanics/CLI/conditions.md#Paralyzed)\
