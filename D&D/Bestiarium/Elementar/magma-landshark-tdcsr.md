...
"actions":
  - "desc": "*Melee Weapon Attack:* +11 to hit, reach 5 ft., one target. *Hit:* 45\
      ...
      \ be swallowed by the landshark. A swallowed creature is [blinded](/3-Mechanics/CLI/conditions.md#Blinded)\
      ...
      \ it, the landshark must succeed on a DC 23 Constitution saving throw at the\
  ...
  - "desc": "If the landshark jumps at least 15 feet as part of its movement, it can\
      ...
      \ or Dexterity saving throw (target's choice) or be knocked [prone](/3-Mechanics/CLI/conditions.md#Prone)\
      \ and take 27 (6d6 + 6) bludgeoning damage plus 21 (6d6) fire damage. On a successful\
      \ save, the creature takes only half the damage, isn't knocked [prone](/3-Mechanics/CLI/conditions.md#Prone),\
      ...
      \ instead falls [prone](/3-Mechanics/CLI/conditions.md#Prone) in the landshark's\
      \ space."
    "name": "Deadly Leap"
