...
> [!statblock] Marid
> ![[token/marid.webp|right|100]]
> *Großer Elementar, Chaotisch Neutral*
> 
> - **Rüstungsklasse** 17 (natürliche Rüstung )
> - **Trefferpunkte** 229 (`17d10 + 136`)
> - **Bewegungsrate** 9 Meter, fliegen 18 Meter, schwimmen 27 Meter
> 
> |STR|GES|KON|INT|WEI|CHA|
> |:---:|:---:|:---:|:---:|:---:|:---:|
> | 22 (+6)|12 (+1)|26 (+8)|18 (+4)|17 (+3)|18 (+4)|
> 
> - **Rettungswürfe** GES +5, WEI +7, CHA +8
> - **Fertigkeiten** -
> - **Sinne** [[Sinne-phb#Blindsicht|Blindsicht]] 9 m, [[Sinne-phb#Dunkelsicht|Dunkelsicht]] 36 m, passive Wahrnehmung 13
> - **Schadensresistenzen** Blitz, Kälte, Säure
> - **Schadensimmunitäten** -
...
> ## Merkmale
> 
> ***Amphibisch*** Der Marid kann Luft und Wasser atmen.
> 
> ***Elementarer Untergang:*** Wenn der Marid stirbt, löst sich sein Körper in eine Explosion aus Wasser und Schaum auf. Es bleibt nur die Ausrüstung zurück, die der Marid getragen oder in der Hand gehalten hat.
> 
> ***Angeborenes Zauberwirken:*** Das Attribut zum Wirken angeborener Zauber für den Marid ist Charisma (Zauberrettungswurf-SG 16, +8 zum Treffen mit Zauberangriffen). Er kann angeboren die folgenden Zauber wirken, wobei keine Materialkomponenten nötig sind:
> 
> **Willentlich:** [[Gutes_und_Böses_entdecken-phb|Gutes und Böses entdecken]], [[Magie_entdecken-phb|Magie entdecken]], [[Nahrung_und_Wasser_reinigen-phb|Nahrung und Wasser reinigen]], [[Nebelwolke-phb|Nebelwolke]], [[Wasser_erschaffen_oder_zerstören-phb|Wasser erschaffen oder zerstören]]
> 
>  **jeweils 3/Tag:** [[Auf_Wasser_gehen-phb|Auf Wasser gehen]], [[Wasser_atmen-phb|Wasser atmen]], [[Zungen-phb|Zungen]]
>  
>   **jeweils 1/Tag:** [[Ebenenwechsel-phb|Ebenenwechsel]], [[Elementar_beschwören-phb|Elementar beschwören]] (nur [[Wasserelementar-mm|Wasserelementar]]), [[Gasförmige_Gestalt-phb|Gasförmige Gestalt]], [[Wasser_kontrollieren-phb|Wasser kontrollieren]], [[Unsichtbarkeit-phb|Unsichtbarkeit]]
> 
> ## Aktionen
> 
> ***Mehrfachangriff:*** Der Marid führt zwei Dreizack-Angriffe aus.
> 
> ***Dreizack.*** *Nahkampf- oder Fernkampf-Waffenangriff:* +10 zum Treffen, Reichweite 1,5 m, ein Ziel. *Treffer:* 13 (`2d6 + 6`) Stichschaden, oder 15 (`2d8 + 6`) Stichschaden, wenn die Waffe mit beiden Händen für einen Nahkampfangriff verwendet wird"
> 
> ***Wasserstrahl.*** Der Marid schießt auf magische Weise Wasser in einer Linie von 18 m Länge und 1,5 m Breite. Jede Kreatur in der Linie muss einen `Geschicklichkeits-Rettungswurf` gegen `SG 16` ablegen. Bei einem Fehlschlag erleidet sie 21 (`6d6`) Wuchtschaden, und wenn sie riesig oder kleiner ist, wird sie bis zu 6 m vom Marid weggeschoben und erleidet den Zustand [[Zustände-phb#Liegend|liegend]]. Bei einem Erfolg erleidet das Ziel den halben Wuchtschaden, wird aber weder geschoben noch erleidet es den Zustand [[Zustände-phb#Liegend|liegend]].
^statblock
