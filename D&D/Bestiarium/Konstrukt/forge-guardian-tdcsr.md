...
Just as "dwarves" created the earliest golems, the [All-Hammer](/3-Mechanics/CLI/deities/exandria-the-all-hammer-tdcsr.md) fashioned forge guardians to guard the divine furnaces and hearths that designed the first "dwarves". Shaped from extravagant marble and fused with adamantine, crafted with impeccable detail and care, these rare and massive constructs exemplify the highest form of artistry that every Exandrian blacksmith, forgemaster, and artisan spends a life-time hoping to achieve.

### Divine Spark

A faceless, tireless being of immense strength, a forge golem is gifted life by a single shard from the [All-Hammer's](/3-Mechanics/CLI/deities/exandria-the-all-hammer-tdcsr.md) own divine spark, lovingly kept safe inside a ring of arcane flame and ancient sigils. The [All-Hammer's](/3-Mechanics/CLI/deities/exandria-the-all-hammer-tdcsr.md) divinity is akin to a volcano inside the golem, turning the construct's blood into lava. Fire no longer harms the construct, but instead heals it.
...
Forge golems also serve as opponents for any wishing to engage in the [All-Hammer's](/3-Mechanics/CLI/deities/exandria-the-all-hammer-tdcsr.md) trial of worthiness. A golem's attacks blind prospective heroes, who must then earn back their vision by risking a deadly counterattack.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +18 to hit, reach 15 ft., one target. *Hit:* 36\
      ...
      \ saving throw or be [blinded](/3-Mechanics/CLI/conditions.md#Blinded) until\
  ...
  - "desc": "*Melee Weapon Attack:* +18 to hit, reach 10 ft., one target. *Hit:* 23\
      ...
      \ from the guardian and knocked [prone](/3-Mechanics/CLI/conditions.md#Prone)."
    "name": "Kick"
  - "desc": "The guardian makes a Runeblade attack against every creature within 15\
      ...
      \ guardian and knocked [prone](/3-Mechanics/CLI/conditions.md#Prone)."
...
"legendary_actions":
  ...
  - "desc": "The guardian makes one Kick attack."
    "name": "Kick"
  - "desc": "The guardian moves up to 50 feet without triggering [opportunity attacks](/3-Mechanics/CLI/actions.md#Opportunity%20Attack),\
      ...
      \ the creature takes 23 (2d12 + 10) bludgeoning damage and is knocked [prone](/3-Mechanics/CLI/conditions.md#Prone).\
      \ On a success, the creature takes half as much damage and isn't knocked [prone](/3-Mechanics/CLI/conditions.md#Prone).\
