...
"senses": "[darkvision](/3-Mechanics/CLI/senses.md#Darkvision) 360 ft., passive Perception\
  \ 26"
...
"traits":
  ...
  - "desc": "The adranach can cast [invisibility](/3-Mechanics/CLI/spells/invisibility-xphb.md)\
      \ on itself at will. While it is [invisible](/3-Mechanics/CLI/conditions.md#Invisible),\
...
"legendary_actions":
  ...
  - "desc": "A burst of astral energy flares from the adranach's body. Each creature\
      ...
      \ save, a creature takes 27 (5d10) force damage and is [blinded](/3-Mechanics/CLI/conditions.md#Blinded)\
      \ until the end of its next turn. On a successful save, the creature takes half\
      \ as much damage and is not [blinded](/3-Mechanics/CLI/conditions.md#Blinded).\
      \ The adranach then turns [invisible](/3-Mechanics/CLI/conditions.md#Invisible)\
