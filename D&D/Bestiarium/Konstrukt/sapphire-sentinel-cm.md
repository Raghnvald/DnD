...
"actions":
  ...
  - "desc": "The sapphire has 3 charges. As an action, the golem can expend 1 charge\
      \ to cast dispel magic (as a 9th-level spell) from the sapphire using Constitution\
      \ as its spellcasting ability. The sapphire ceases to glow if all its charges\
      \ are expended, but it regains 1d3 expended charges daily at dawn and glows\
      \ again once it has 1 or more charges."
    "name": "Sapphire"
"source":
  - "CM"
