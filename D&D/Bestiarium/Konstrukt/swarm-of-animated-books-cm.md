...
Bezeichnung: Swarm of Animated Books
Status: WIP
linter-yaml-title-alias: Swarm of Animated Books
tags:
...
"traits":
  - "desc": "If the swarm is motionless at the start of combat, it has advantage on\
      ...
      \ or act, that creature must succeed on a DC 15 Wisdom (Perception) check to\
      \ discern that the swarm is animate."
    "name": "False Objects"
