...
aliases:
  - Ooze Master
linter-yaml-title-alias: Ooze Master
---
# Schlickmeister
*Source: Tales from the Yawning Portal p. 241*  

```statblock
"name": "Schlickmeister (TftYP)"
"size": "Huge"
"type": "undead"
...
"traits":
  - "desc": "The Ooze Master is a 9th-level spellcaster. Its spellcasting ability\
      ...
      \ friends, mage hand, poison spray\n\n**1st level (4 slots):** charm person,\
      \ detect magic, magic missile, ray of sickness\n\n**2nd level (3 slots):** detect\
      \ thoughts, Melf's acid arrow, suggestion\n\n**3rd level (3 slots):** fear,\
      \ slow, stinking cloud\n\n**4th level (3 slots):** confusion, Evard's black\
...
"reactions":
  - "desc": "If a creature the Ooze Master can see makes an attack roll against it\
      ...
      \ 24 hours. Creatures that can't be charmed are immune to this effect."
