...
The soul of a creature that becomes a bodak is so damaged that it is unfit for most forms of magical resurrection. Only a wish spell or similar magic can return a bodak to its former life.
...
"cr": "6"
"traits":
  - "desc": "The bodak can activate or deactivate this feature as a bonus action.\
      \ While active, the aura deals 5 necrotic damage to any creature that ends its\
  ...
  - "desc": "When a creature that can see the bodak's eyes starts its turn within\
      ...
      \ saving throw if the bodak isn't incapacitated and can see the creature. If\
      \ the saving throw fails by 5 or more, the creature is reduced to 0 hit points,\
      \ unless it is immune to the frightened condition. Otherwise, a creature takes\
...
"source":
  - "VGM"
  - "ToA"
"image": "/3-Mechanics/CLI/bestiary/undead/token/bodak-vgm.webp"
```
^statblock
