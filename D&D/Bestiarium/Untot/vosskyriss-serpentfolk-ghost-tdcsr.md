...
"actions":
  ...
  - "desc": "The ghost emits an uncanny, rasping hiss. Each non-undead creature within\
      ...
      \ throw or be [frightened](/3-Mechanics/CLI/conditions.md#Frightened) for 1\
      \ minute. A [frightened](/3-Mechanics/CLI/conditions.md#Frightened) target can\
      \ repeat the saving throw at the end of each of its turns, ending the condition\
      \ on itself on a success. If a target's saving throw is successful or the effect\
      \ ends for it, the target is immune to this ghost's Terrifying Hiss for the\
      \ next 24 hours."
