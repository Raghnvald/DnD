...
- **Glacial Gloom.** The area within 1 mile of the lair is [Lightly Obscured](D&D/Regelvarianten/lightly-obscured-xphb.md) by chilly fog. Whenever a creature other than the dragon or one of its allies finishes a [Long Rest](long-rest-xphb.md) in that area, that creature must succeed on a DC 15 Constitution saving throw or have its [Speed](speed-xphb.md) reduced by 10 feet for 1 hour.  
