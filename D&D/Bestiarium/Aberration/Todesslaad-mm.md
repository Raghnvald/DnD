...
> [!statblock] Todesslaad
> ![[token/death-slaad.webp|right|100]]
> *Mittelgroße Aberration (Gestaltwandler), Chaotisch Böse*
> 
> - **Rüstungsklasse** 18 (natürliche Rüstung)
> - **Trefferpunkte** 170 (`20d8 + 80`)
...
> 
> - **Rettungswürfe** ⏤
> - **Fertigkeiten** [[Fertigkeiten-phb#Arkane Kunde|Arkane Kunde]] +6, [[Fertigkeiten-phb#Wahrnehmung|Wahrnehmung]] +8
> - **Schadensresistenzen** Blitz, Feuer, Kälte, Säure, Schall
> - **Schadensimmunitäten** ⏤
> - **Zustandsimmunitäten** ⏤
> - **Sinne** [[Sinne-phb#Blindsicht|Blindsicht]] 18 Meter, [[Sinne-phb#Dunkelsicht|Dunkelsicht]] 18 Meter, passive Wahrnehmung 18
> - **Sprachen** Slaad, Telepathie 18 Meter
> - **Herausforderungsgrad** 10 (5.900 EP)
> - **Übungsbonus** +3
> 
> ## Merkmale
> 
> ***Gestaltwandler.*** Der Slaad kann eine Aktion verwenden, um sich in einen kleinen oder mittelgroßen Humanoiden zu verwandeln oder wieder seine wahre Gestalt anzunehmen. Seine Spielwerte sind abgesehen von der Größe in jeder Gestalt identisch. Jegliche Ausrüstung, die er trägt oder in der Hand hält, wird nicht verwandelt. Wenn er stirbt, nimmt er wieder seine wahre Gestalt an.
> 
> ***Angeborenes Zauberwirken.*** Das Attribut zum Wirken angeborener Zauber für den Slaad ist Charisma (Zauberrettungswurf-SG 15, +7 zum Treffen mit Zauberangriffen). Der Slaad kann von Natur aus die folgenden Zauberwirken, wobei er keine Materialkomponenten benötigt.
> 
> - **Beliebig oft:** [[Gedanken_wahrnehmen-phb|Gedanken wahrnehmen]], [[Mächtiges_Trugbild-phb|Mächtiges Trugbild]], [[Magie_entdecken-phb|Magie entdecken]], [[Magierhand-phb|Magierhand]], [[Unsichtbarkeit-phb|Unsichtbarkeit]] (nur selbst)
> - **jeweils 2/Tag:** [[Feuerball-phb|Feuerball]], [[Fliegen-phb|Fliegen]], [[Furcht-phb|Furcht]], [[Zungen-phb|Zungen]]
> - **jeweils 1/Tag:** [[Ebenenwechsel-phb|Ebenenwechsel]], [[Todeswolke-phb|Todeswolke]]
> 
> 
> ***Magieresistenz.*** Der Slaad hat einen Vorteil auf Rettungswürfe gegen Zauber und andere magische Effekte.
> 
> ***Magische Waffen.*** Die Waffenangriffe des Slaad sind magisch.
> 
> ***Regeneration.*** Der Slaad erhält zu Beginn seines Zugs 10 Trefferpunkte zurück, wenn er mindestens 1 Trefferpunkt besitzt.
> 
> ## Aktionen
> 
> ***Mehrfachangriff.*** Der Slaad führt drei Angriffe durch: einen mit seinem Biss und zwei mit seinen Klauen oder seinem Zweihandschwert
> 
> ***Biss (nur Slaad-Gestalt).*** *Nahkampf-Waffenangriff:* +9 zum Treffen, Reichweite 1,5 Meter, ein Ziel. *Treffer:* 9 (`1d8 + 5`) Stichschaden plus 7 (`2d6`) nekrotischer Schaden.
> 
> ***Klauen (nur Slaad-Gestalt).*** *Nahkampf-Waffenangriff:* +9 zum Treffen, Reichweite 1,5 Meter, ein Ziel. *Treffer:* 10 (`1d10 + 5`) Hiebschaden plus 7 (`2d6`) nekrotischer Schaden.
> 
> ***Zweihandschwert.*** *Nahkampf-Waffenangriff:* +9 zum Treffen, Reichweite 1,5 Meter, ein Ziel. *Treffer:* 12 (`2d6 + 5`) Hiebschaden plus 7 (`2d6`) nekrotischer Schaden.
^statblock