...
> ![[token/nalfeshnee.webp|right|100]]
> *Großer Unhold (Dämon), Chaotisch Böse*
> 
> - **Rüstungsklasse** 18 (natürliche Rüstung)
> - **Trefferpunkte** 184 (`16d10 + 96`)
> - **Bewegungsrate** 6 Meter, fliegen 9 Meter
> 
...
> - **Sinne**  [[Sinne-phb#Wahre Sicht|Wahre Sicht]] 36 m, passive Wahrnehmung 11 
...
> 
> ***Biss.*** *Nahkampf-Waffenangriff:* +10 zum Treffen, Reichweite 1,5 Meter, ein Ziel. *Treffer:* 32 (`5d10 + 5`) Stichschaden.
> 
> ***Klauen.*** *Nahkampf-Waffenangriff:* +10 zum Treffen, Reichweite 1,5 Meter, ein Ziel. *Treffer:* 15 (`3d6 + 5`) Hiebschaden.
> 
> ***Grauensnimbus (Aufladung 5-6).*** Der Nalfeshnee gibt auf magische Weise ein flimmerndes, vielfarbiges Licht ab. Alle nicht untoten Kreaturen innerhalb von 4,5 m um den Nalfeshnee, die ihn sehen können, müssen einen `Weisheits-Rettungswurf` gegen `SG 15` schaffen, um nicht für l Minute verängstigt zu werden. Die Kreatur kann den Rettungswurf am Ende eines jeden ihrer Züge wiederholen und den Effekt bei einem Erfolg beenden. Wenn der Rettungswurferfolgreich ist oder der Effekt endet, dann ist die Kreatur für die nächsten 24Stunden gegen den Grauensnimbus des Nalfeshnee immun. 
> 
> ***Teleportieren.*** Der Nalfeshnee teleportiert sich magisch zusammen mit der Ausrüstung, die sie trägt oder in der Hand hält, bis zu 36 m in einen nicht besetzten Bereich, den sie sehen kann. 
^statblock
