...
Bezeichnung: Incubus
linter-yaml-title-alias: Incubus
tags:
...
The succubus or incubus resorts to charming a victim magically only when necessary, usually as a form of self-defense. A [charmed](/3-Mechanics/CLI/conditions.md#Charmed) creature isn't responsible for its actions, so forcing it to behave against its will won't bring the fiend closer to the ultimate prize: the victim's soul.
...
"traits":
  - "desc": "The fiend ignores the range restriction on its telepathy when communicating\
      \ with a creature it has [charmed](/3-Mechanics/CLI/conditions.md#Charmed).\
...
"actions":
  ...
  - "desc": "One humanoid the fiend can see within 30 feet of it must succeed on a\
      \ DC 15 Wisdom saving throw or be magically [charmed](/3-Mechanics/CLI/conditions.md#Charmed)\
      ...
      \ the next 24 hours.\n\nThe fiend can have only one target [charmed](/3-Mechanics/CLI/conditions.md#Charmed)\
      \ at a time. If it charms another, the effect on the previous target ends."
    "name": "Charm"
  - "desc": "The fiend kisses a creature [charmed](/3-Mechanics/CLI/conditions.md#Charmed)\
