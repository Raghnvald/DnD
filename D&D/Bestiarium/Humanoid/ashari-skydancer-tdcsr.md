...
"traits":
  - "desc": "The skydancer is a 3rd-level spellcaster. Its spellcasting ability is\
      ...
      \ slots):** [entangle](/3-Mechanics/CLI/spells/entangle-xphb.md), [fog cloud](/3-Mechanics/CLI/spells/fog-cloud-xphb.md),\
  ...
  - "desc": "If the skydancer is subjected to an effect that allows it to make a Dexterity\
    ...
    "name": "Evasion"
  - "desc": "The skydancer doesn't provoke an [opportunity attack](/3-Mechanics/CLI/actions.md#Opportunity%20Attack)\
