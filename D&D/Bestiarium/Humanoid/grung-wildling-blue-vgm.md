...
Bezeichnung: Grung Wildling (Blue)
Status: WIP
linter-yaml-title-alias: Grung Wildling (Blue)
tags:
  - Monster/Größe/Klein
...
aliases:
  - Grung Wildling (Blue)
---
# [Grung Wildling (Blue)](3-Mechanics\CLI\bestiary\humanoid/grung-wildling-blue-vgm.md)
*Source: Volo's Guide to Monsters p. 157, Tomb of Annihilation*  

```statblock
"name": "Grung Wildling (Blue) (VGM)"
"size": "Small"
"type": "humanoid"
"subtype": "grung"
...
"traits":
  - "desc": "The grung is a 9th-level spellcaster. Its spellcasting ability is Wisdom\
      \ (spell save DC 12, +4 to hit with spell attacks). It knows the following ranger\
