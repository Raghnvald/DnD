...
"cr": "1"
"traits":
  - "desc": "The firenewt is a 3rd-level spellcaster. Its spellcasting ability is\
      ...
      \ warlock spells:\n\n**Cantrips (at will):** fire bolt, guidance, light, mage\
      \ hand, prestidigitation\n\n**1st-2nd level (2 slots):** burning hands, flaming\
      \ sphere, hellish rebuke, scorching ray"
    "name": "Spellcasting"
  - "desc": "The firenewt's innate spellcasting ability is Charisma. It can innately\
      \ cast mage armor (self only) at will, requiring no material components.\n"
...
"source":
  - "VGM"
  - "ToA"
"image": "/3-Mechanics/CLI/bestiary/humanoid/token/firenewt-warlock-of-imix-vgm.webp"
```
^statblock
