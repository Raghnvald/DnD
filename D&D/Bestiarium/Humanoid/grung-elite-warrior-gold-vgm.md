...
Bezeichnung: Grung Elite Warrior (Gold)
Status: WIP
linter-yaml-title-alias: Grung Elite Warrior (Gold)
tags:
  - Monster/Größe/Klein
...
---
# [Grung Elite Warrior (Gold)](3-Mechanics\CLI\bestiary\humanoid/grung-elite-warrior-gold-vgm.md)
*Source: Volo's Guide to Monsters p. 157, Tomb of Annihilation*  

```statblock
"name": "Grung Elite Warrior (Gold) (VGM)"
"size": "Small"
"type": "humanoid"
"subtype": "grung"
...
"traits":
  ...
  - "desc": "Any creature that grapples the grung or otherwise comes into direct contact\
      ...
      \ ending the effect on itself on a success. The poisoned creature is charmed\
      \ and can speak Grung."
    "name": "Poisonous Skin"
