...
Vex'ahlia was one of the first members of Vox Machina when those adventurers initially met in "Stilben", along with her twin brother, [Vax'ildan](/3-Mechanics/CLI/bestiary/celestial/champion-of-ravens-tdcsr.md). Today, she is one of the most influential people in Tal'Dorei. She sits on the "Tal'Dorei Council" as Master of Commerce and is "Whitestone's" "Grand Mistress of the Grey Hunt", a champion of the [Dawnfather](/3-Mechanics/CLI/deities/exandria-the-dawnfather-tdcsr.md), and a hero beloved by all who know the legend of Vox Machina. Her charm and skill with a bow are legendary, and she is equally dedicated to changing the world as she is to raising her five children in "Whitestone".
...
"traits":
  - "desc": "Vex is a 13th-level spellcaster. Her spell-casting ability is Wisdom\
      ...
      \ (1 slots):** [freedom of movement](/3-Mechanics/CLI/spells/freedom-of-movement-xphb.md),\
  ...
  - "desc": "If Vex is subjected to an effect that allows her to make a Dexterity\
    ...
    "name": "Evasion"
  - "desc": "Vex has advantage on saving throws against being [charmed](/3-Mechanics/CLI/conditions.md#Charmed),\
  ...
  - "desc": "Vex deals an extra 14 (4d6) damage when she hits a target with a weapon\
      ...
      \ 5 feet of an ally of Vex that isn't [incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated)\
  ...
  - "desc": "[Trinket](/3-Mechanics/CLI/bestiary/npc/trinket-tdcsr.md) moves and acts\
      \ on Vex's turn, and Vex can use a bonus action to command him to take the [Dash](/3-Mechanics/CLI/actions.md#Dash),\
      \ [Dodge](/3-Mechanics/CLI/actions.md#Dodge), [Disengage](/3-Mechanics/CLI/actions.md#Disengage),\
      \ or [Attack](/3-Mechanics/CLI/actions.md#Attack) action. She can also command\
      \ him to [Attack](/3-Mechanics/CLI/actions.md#Attack) as part of her Multiattack\
...
"actions":
  ...
  - "desc": "The attack deals an extra 18 (4d8) piercing damage, and the target must\
      \ succeed on a DC 17 Strength saving throw or be [restrained](/3-Mechanics/CLI/conditions.md#Restrained).\
      \ The target can repeat the saving throw at the end of each of its turns, ending\
      \ the effect on itself on a success."
    "name": "Bramble Shot (2/Short Rest)"
"bonus_actions":
  - "desc": "Vex takes the [Dash](/3-Mechanics/CLI/actions.md#Dash), [Disengage](/3-Mechanics/CLI/actions.md#Disengage),\
  ...
  - "desc": "Vex casts [hunter's mark](/3-Mechanics/CLI/spells/hunters-mark-xphb.md)\
      ...
      \ on Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) and Wisdom\
      \ ([Survival](/3-Mechanics/CLI/skills.md#Survival)) checks made to find it."
    "name": "Hunter's Mark"
"reactions":
