...
Bezeichnung: Grung Elite Warrior (Purple)
Status: WIP
linter-yaml-title-alias: Grung Elite Warrior (Purple)
tags:
  - Monster/Größe/Klein
...
---
# [Grung Elite Warrior (Purple)](3-Mechanics\CLI\bestiary\humanoid/grung-elite-warrior-purple-vgm.md)
*Source: Volo's Guide to Monsters p. 157, Tomb of Annihilation*  

```statblock
"name": "Grung Elite Warrior (Purple) (VGM)"
"size": "Small"
"type": "humanoid"
"subtype": "grung"
...
"traits":
  ...
  - "desc": "Any creature that grapples the grung or otherwise comes into direct contact\
      ...
      \ ending the effect on itself on a success. The poisoned creature feels a desperate\
