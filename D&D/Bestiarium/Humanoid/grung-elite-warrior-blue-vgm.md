...
Bezeichnung: Grung Elite Warrior (Blue)
linter-yaml-title-alias: Grung Elite Warrior (Blue)
tags:
  - Monster/Größe/Klein
...
---
# [Grung Elite Warrior (Blue)](3-Mechanics\CLI\bestiary\humanoid/grung-elite-warrior-blue-vgm.md)
*Source: Volo's Guide to Monsters p. 157, Tomb of Annihilation*  

```statblock
"name": "Grung Elite Warrior (Blue) (VGM)"
"size": "Small"
"type": "humanoid"
"subtype": "grung"
...
"traits":
  ...
  - "desc": "Any creature that grapples the grung or otherwise comes into direct contact\
      ...
      \ become poisoned for 1 minute. A poisoned creature no longer in direct contact\
      \ with the grung can repeat the saving throw at the end of each of its turns,\
      \ ending the effect on itself on a success. The poisoned creature must shout\
      \ loudly or otherwise make a loud noise at the start and end of its turn."
    "name": "Poisonous Skin"
...
"actions":
  ...
  - "desc": "The grung makes a chirring noise to which grungs are immune. Each humanoid\
      ...
      \ on a DC 12 Wisdom saving throw or be stunned until the end of the grung's\
      \ next turn."
