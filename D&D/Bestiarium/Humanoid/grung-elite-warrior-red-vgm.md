...
---
# [Grung Elite Warrior (Red)](3-Mechanics\CLI\bestiary\humanoid/grung-elite-warrior-red-vgm.md)
*Source: Volo's Guide to Monsters p. 157, Tomb of Annihilation*  

```statblock
"name": "Grung Elite Warrior (Red) (VGM)"
"size": "Small"
"type": "humanoid"
"subtype": "grung"
...
"traits":
  ...
  - "desc": "Any creature that grapples the grung or otherwise comes into direct contact\
      ...
      \ ending the effect on itself on a success. The poisoned creature must use its\
      \ action to eat if food is within reach."
    "name": "Poisonous Skin"
