...
Bezeichnung: Uthgardt Shaman (Black Raven)
linter-yaml-title-alias: Uthgardt Shaman (Black Raven)
tags:
...
"actions":
  ...
  - "desc": "The shaman casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ dead, spirit guardians, animal messenger (raven only), polymorph (self only;\
      \ into a raven only)"
