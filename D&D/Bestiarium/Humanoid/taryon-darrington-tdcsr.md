...
"traits":
  - "desc": "Tary is a 15th-level spellcaster. His spellcasting ability is Intelligence\
      ...
      \ of frost](/3-Mechanics/CLI/spells/ray-of-frost-xphb.md) (3d8)\n\n**1st level\
      \ (4 slots):** [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md),\
      \ [heroism](/3-Mechanics/CLI/spells/heroism-xphb.md), [identify](/3-Mechanics/CLI/spells/identify-xphb.md),\
      \ [shield](/3-Mechanics/CLI/spells/shield-xphb.md)\n\n**2nd level (3 slots):**\
      \ [alter self](/3-Mechanics/CLI/spells/alter-self-xphb.md), [branding smite](/3-Mechanics/CLI/spells/shining-smite-xphb.md),\
      \ [see invisibility](/3-Mechanics/CLI/spells/see-invisibility-xphb.md), [warding\
      \ bond](/3-Mechanics/CLI/spells/warding-bond-xphb.md)\n\n**3rd level (3 slots):**\
  ...
  - "desc": "Tary's experimental concoctions have granted him resistance to acid and\
      \ poison damage, and immunity to the [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned)\
      \ condition."
    "name": "Alchemical Defense"
  - "desc": "[Doty](/3-Mechanics/CLI/bestiary/npc/doty-x-tdcsr.md) moves and acts\
      \ on Tary's turn, and Tary can use a bonus action to command him to use the\
      \ [Dash](/3-Mechanics/CLI/actions.md#Dash), [Dodge](/3-Mechanics/CLI/actions.md#Dodge),\
      \ [Disengage](/3-Mechanics/CLI/actions.md#Disengage), or [Attack](/3-Mechanics/CLI/actions.md#Attack)\
      \ action. He can also command him to [Attack](/3-Mechanics/CLI/actions.md#Attack)\
      \ as part of his Multitask action (see below). Doty can take only one action\
      \ on each of Tary's turns."
    "name": "Doty"
  - "desc": "Tary has advantage on Constitution saving throws made to maintain [concentration](/3-Mechanics/CLI/conditions.md#Concentration)\
      \ on spells."
    "name": "Focused"
  - "desc": "Tary wears a [helm of brilliance](/3-Mechanics/CLI/items/helm-of-brilliance-xdmg.md),\
      ...
      \ and a [ring of the ram](/3-Mechanics/CLI/items/ring-of-the-ram-xdmg.md). He\
      \ carries a [rod of mercurial form](/3-Mechanics/CLI/items/rod-of-mercurial-form-tdcsr.md),\
      \ as well as a [bag of holding](/3-Mechanics/CLI/items/bag-of-holding-xdmg.md),\
      \ 1d4 + 4 [beads of force](/3-Mechanics/CLI/items/bead-of-force-xdmg.md), a\
      \ [broom of flying](/3-Mechanics/CLI/items/broom-of-flying-xdmg.md), and a [chime\
      \ of opening](/3-Mechanics/CLI/items/chime-of-opening-xdmg.md)."
    "name": "Special Equipment"
  - "desc": "Tary has an additional 30 hit points."
    "name": "Toughness"
"actions":
  - "desc": "Tary makes two weapon attacks or casts a spell with a casting time of\
      \ 1 action, and can also command [Doty](/3-Mechanics/CLI/bestiary/npc/doty-x-tdcsr.md)\
...
"reactions":
  - "desc": "When Tary or another creature he can see within 30 feet of him makes\
      \ an ability check or a saving throw, he can use his reaction to add +4 to the\
      \ roll."
