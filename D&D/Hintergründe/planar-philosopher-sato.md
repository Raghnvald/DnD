...
![](3-Mechanics/CLI/backgrounds/img/planar-philosopher.webp#right)

***Prerequisites*** Planescape Campaign

- **Skill Proficiencies.** [Arcana](3-Mechanics/CLI/rules/skills.md#Arcana), the skill associated with your faction (see the Sigil Faction Affinities table) or one skill of your choice  
- **Languages.** Two of your choice  
- **Equipment.** A portal key (such as a bag of golden tea leaves or the tooth of a planar beast), a manifesto of your guiding philosophy, a set of common clothes in your faction's style, and a [pouch](3-Mechanics/CLI/items/pouch-xphb.md) containing 10 gp worth of coins from different worlds and planes  

**Sigil Faction Affinities**

| Faction | Skill |
|---------|-------|
| Athar | [Religion](3-Mechanics/CLI/rules/skills.md#Religion) |
| Bleak Cabal | [Insight](3-Mechanics/CLI/rules/skills.md#Insight) |
| Doomguard | [Nature](3-Mechanics/CLI/rules/skills.md#Nature) |
| Fated | [Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation) |
| Fraternity of Order | [History](3-Mechanics/CLI/rules/skills.md#History) |
| Hands of Havoc | [Stealth](3-Mechanics/CLI/rules/skills.md#Stealth) |
| Harmonium | [Perception](3-Mechanics/CLI/rules/skills.md#Perception) |
| Heralds of Dust | [Medicine](3-Mechanics/CLI/rules/skills.md#Medicine) |
| Mercykillers | [Survival](3-Mechanics/CLI/rules/skills.md#Survival) |
| Mind's Eye | [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion) |
| Society of Sensation | [Performance](3-Mechanics/CLI/rules/skills.md#Performance) |
| Transcendent Order | [Athletics](3-Mechanics/CLI/rules/skills.md#Athletics) |
^sigil-faction-affinities
...
You gain the [Scion of the Outer Planes](3-Mechanics/CLI/feats/scion-of-the-outer-planes-sato.md) feat. In addition, members of your organization provide you free, modest lodging and food at any of their holdings or the homes of other faction members.
...
When you make your character, you can roll once on the [Planar Philosopher Trinkets](3-Mechanics/CLI/items/planar-philosopher-trinket-sato.md) table, instead of on the [Trinkets](3-Mechanics/CLI/items/trinket-xphb.md) table in the Player's Handbook, for your starting trinket.