...
![Samut, Voice of Dissent](3-Mechanics/CLI/backgrounds/img/dissenter.webp#right)
...
- **Equipment.** A simple puzzle box, a scroll containing the basic teachings of the five gods, a gaming set, a set of [common clothes](3-Mechanics/CLI/items/common-clothes.md), and a belt [pouch](3-Mechanics/CLI/items/pouch.md) containing 15 gp. If you have completed any trials before the start of the campaign, you also have any cartouches you have earned  
...
If you are a hand-to-hand specialist, consider the [barbarian](3-Mechanics/CLI/classes/barbarian.md), [fighter](3-Mechanics/CLI/classes/fighter.md), [monk](3-Mechanics/CLI/classes/monk.md), [paladin](3-Mechanics/CLI/classes/paladin.md), or [rogue](3-Mechanics/CLI/classes/rogue.md) classes. As a long-range combat specialist, you might be a [fighter](3-Mechanics/CLI/classes/fighter.md), a [ranger](3-Mechanics/CLI/classes/ranger.md), or a [rogue](3-Mechanics/CLI/classes/rogue.md). If you are a spellcasting specialist, you might be a [bard](3-Mechanics/CLI/classes/bard.md), [sorcerer](3-Mechanics/CLI/classes/sorcerer.md), or [wizard](3-Mechanics/CLI/classes/wizard.md). And beyond this initial choice, you might consider multiclassing or using feats to round out your skills in all three areas.
...
> [!gallery]
![Unwavering Initiate](3-Mechanics/CLI/backgrounds/img/initiate.webp)
![Gust Walker](3-Mechanics/CLI/backgrounds/img/initiate2.webp)