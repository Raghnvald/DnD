...
- **Equipment.** Your inheritance, a set of [traveler's clothes](/3-Mechanics/CLI/items/travelers-clothes-xphb.md), the tool you choose for this background's tool proficiency (gaming set or musical instrument), and a [pouch](/3-Mechanics/CLI/items/pouch-xphb.md) containing 15 gp  
