...
| 2 | A [noble](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md) seeks help as an undead ancestor tries to prevent the [noble](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)'s marriage to an "unsuitable" partner. |
