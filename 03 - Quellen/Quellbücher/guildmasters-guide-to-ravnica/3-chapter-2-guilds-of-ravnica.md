...
Not every researcher chooses to advance through the ranks of management to become a supervisor. As an independent researcher, you can use the resources of your laboratory to conduct any kind of experiment. Assisting you in your research are `2d6` competent attendants (use the [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner.md) stat block in the "Monster Manual", and give them proficiency in the Arcana skill).
