...
![Naga Oracle](3-Mechanics/CLI/races/img/naga.webp#right)
...
If you hit with your constrict attack, you deal bludgeoning damage equal to `1d6` + your Strength modifier, and the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 8 + your proficiency bonus + your Strength modifier). Until this grapple ends, the target is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained), and you can't constrict another target.

### Poison Immunity

You are immune to poison damage and can't be [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned).

### Poison Affinity

You gain proficiency with the [poisoner's kit](3-Mechanics/CLI/items/poisoners-kit.md).
