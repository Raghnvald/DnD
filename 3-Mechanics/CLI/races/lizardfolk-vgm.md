...
As part of a short rest, you can harvest bone and hide from a slain beast, construct, dragon, monstrosity, or plant creature of size small or larger to create one of the following items: a [shield](3-Mechanics/CLI/items/shield-xphb.md), a [club](3-Mechanics/CLI/items/club-xphb.md), a [javelin](3-Mechanics/CLI/items/javelin-xphb.md), or `1d4` [darts](3-Mechanics/CLI/items/dart-xphb.md) or [blowgun needles](3-Mechanics/CLI/items/needle-xphb.md). To use this trait, you need a blade, such as a [dagger](3-Mechanics/CLI/items/dagger-xphb.md), or appropriate artisan's tools, such as [leatherworker's tools](3-Mechanics/CLI/items/leatherworkers-tools-xphb.md).
