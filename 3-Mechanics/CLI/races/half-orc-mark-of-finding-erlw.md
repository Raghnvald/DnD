...
- new/race/half-orc/mark-of-finding
aliases:
...
When you make a Wisdom (Perception) or Wisdom (Survival) check, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
