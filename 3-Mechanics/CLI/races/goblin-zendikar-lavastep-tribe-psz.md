...
- ttrpg-cli/race/goblin/zendikar-lavastep-tribe
aliases:
...
You have advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide in rocky or subterranean environments.
