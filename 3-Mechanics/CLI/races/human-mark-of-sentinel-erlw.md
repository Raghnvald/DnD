...
- new/race/human/mark-of-sentinel
aliases:
...
When you make a Wisdom (Insight) or Wisdom (Perception) check, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
