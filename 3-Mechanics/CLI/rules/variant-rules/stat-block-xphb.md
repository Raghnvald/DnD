...
A stat block contains the game statistics of a [monster](3-Mechanics/CLI/rules/variant-rules/monster-xphb.md). Each stat block includes the following information presented after the [monster's](3-Mechanics/CLI/rules/variant-rules/monster-xphb.md) name.
