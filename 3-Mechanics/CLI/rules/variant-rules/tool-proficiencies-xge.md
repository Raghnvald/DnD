...
Proficiency with [alchemist's supplies](3-Mechanics/CLI/items/alchemists-supplies-xphb.md) allows you to unlock more information on [Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) checks involving potions and similar materials.
...
Proficiency with [brewer's supplies](3-Mechanics/CLI/items/brewers-supplies-xphb.md) gives you additional insight on Intelligence ([History](3-Mechanics/CLI/rules/skills.md#History)) checks concerning events that involve alcohol as a significant element.
...
A [forgery kit](3-Mechanics/CLI/items/forgery-kit-xphb.md) can be used in conjunction with the [Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) skill to determine if a magic item is real or fake.
...
As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](3-Mechanics/CLI/items/forgery-kit-xphb.md) determines the DC for someone else's Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check to spot the fake.
...
Proficiency with [jeweler's tools](3-Mechanics/CLI/items/jewelers-tools-xphb.md) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](3-Mechanics/CLI/rules/skills.md#Arcana) checks related to gems or gem-encrusted items.
