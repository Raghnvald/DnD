...
**Classes**: [Artificer (Armorer)](/3-Mechanics/CLI/lists/list-spells-classes-armorer-tce.md "subclass=TCE;class=TCE"); [Bard](/3-Mechanics/CLI/lists/list-spells-classes-bard.md); [Cleric (Moon Domain)](/3-Mechanics/CLI/lists/list-spells-classes-moon-domain-tdcsr.md "subclass=TDCSR;class=XPHB"); [Wizard](/3-Mechanics/CLI/lists/list-spells-classes-wizard.md)
