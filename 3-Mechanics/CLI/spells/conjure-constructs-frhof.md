...
- **Orderly Ward.** The target gains <span title="Player's Handbook (2024)">Temporary Hit Points</span> equal to `1d6` plus your spellcasting ability modifier.  

When you move on your turn, you can also move the spirits up to 30 feet to an unoccupied space you can see.

**Using a Higher-Level Spell Slot.** The damage and <span title="Player's Handbook (2024)">Temporary Hit Points</span> both increase by `1d6` for each spell slot level above 3.
