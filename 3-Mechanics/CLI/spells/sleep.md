...
This spell sends creatures into a magical slumber. Roll `dice:5d8|noform|noparens|avg` (`5d8`); the total is how many hit points of creatures this spell can affect. Creatures within 20 feet of a point you choose within range are affected in ascending order of their current hit points (ignoring [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious) creatures).
