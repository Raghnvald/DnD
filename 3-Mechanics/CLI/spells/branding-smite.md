...
The next time you hit a creature with a weapon attack before this spell ends, the weapon gleams with astral radiance as you strike. The attack deals an extra `dice:2d6|noform|noparens|avg` (`2d6`) radiant damage to the target, which becomes visible if it's [invisible](/3-Mechanics/CLI/conditions.md#Invisible), and the target sheds dim light in a 5-foot radius and can't become [invisible](/3-Mechanics/CLI/conditions.md#Invisible) until the spell ends.
