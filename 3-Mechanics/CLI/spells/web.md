...
Each creature that starts its turn in the webs or that enters them during its turn must make a Dexterity saving throw. On a failed save, the creature is [restrained](/3-Mechanics/CLI/conditions.md#Restrained) as long as it remains in the webs or until it breaks free.

A creature [restrained](/3-Mechanics/CLI/conditions.md#Restrained) by the webs can use its action to make a Strength check against your spell save DC. If it succeeds, it is no longer [restrained](/3-Mechanics/CLI/conditions.md#Restrained).
