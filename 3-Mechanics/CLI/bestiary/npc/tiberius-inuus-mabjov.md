...
"cr": "9"
"traits":
  - "desc": "Tiberius Inuus has advantage on saving throws against being [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)."
    "name": "Brave"
"actions":
...
"source":
  - "MaBJoV"
"image": "3-Mechanics/CLI/bestiary/npc/token/tiberius-inuus-mabjov.webp"
```
^statblock