...
- "Anagwendol"
---
# [Anagwendol](3-Mechanics/CLI/bestiary/npc/anagwendol-coa.md)
...
"actions":
  - "desc": "Anagwendol makes two attacks using her Defending Greatsword, Longbow,\
      \ or a combination of the two."
    "name": "Multiattack"
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:*\
      \ 19 (4d6 + 5) slashing damage plus 22 (5d8) radiant damage."
  ...
  - "desc": "*Ranged Weapon Attack:* +9 to hit, range 150/600 ft., one target. *Hit:*\
    ...
    "name": "Longbow"
  - "desc": "Anagwendol touches another creature. The target magically regains 30\
      \ (6d8 + 3) hit points and is freed from any curse, disease, poison, blindness,\
      \ or deafness."
    "name": "Healing Touch (2/Day)"
"bonus_actions":
  - "desc": "Anagwendol can forgo attacking with her Defending Greatsword on this\
      \ turn and gain a +3 to her armor class. She can still attack with her Longbow."
    "name": "Defensive Sword-work"
"source":
  - "CoA"
"image": "3-Mechanics/CLI/bestiary/npc/token/anagwendol-coa.webp"
```
^statblock