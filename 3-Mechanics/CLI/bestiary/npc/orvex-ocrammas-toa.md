...
- "Orvex Ocrammas"
---
# [Orvex Ocrammas](3-Mechanics/CLI/bestiary/npc/orvex-ocrammas-toa.md)
...
"cr": "1"
"traits":
  - "desc": "On each of its turns, Orvex can use a bonus action to take the [Dash](3-Mechanics/CLI/rules/actions.md#Dash),\
  ...
  - "desc": "Orvex deals an extra 7 (2d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Orvex that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
