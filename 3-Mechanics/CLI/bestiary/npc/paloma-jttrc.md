...
- "Paloma"
---
# [Paloma](3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md)
...
"traits":
  - "desc": "During its first turn, Paloma has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Paloma scores against a [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Paloma deals an extra 14 (4d6) damage when it hits a target with a\
      ...
      \ within 5 feet of an ally of Paloma that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
