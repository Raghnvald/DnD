...
"actions":
  ...
  - "desc": "Galsariad causes a rippling wave of magical gravity to fill a 20-foot-radius\
      ...
      \ the sphere's center, and is knocked prone. On a successful save, the creature\
  ...
  - "desc": "Galsariad casts one of the following spells, using Intelligence as the\
      \ spellcasting ability (spell save DC 15):\n\n**At will:** mage armor, mage\
      \ hand\n\n**1/day each:** longstrider, scrying (as an action), slow"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Galsariad targets himself or one willing creature that he can see within\
      ...
      \ within 5 feet of the target takes 7 (2d6) force damage. In addition, the\
