...
---
# [Aribeth de Tylmarande](3-Mechanics/CLI/bestiary/npc/aribeth-de-tylmarande-mabjov.md)
...
"traits":
  ...
  - "desc": "Aribeth is accompanied by a [nightmare](3-Mechanics/CLI/bestiary/fiend/nightmare.md).\
  ...
  - "desc": "Aribeth regains 20 hit points at the start of her turn. If Aribeth takes\
    ...
    "name": "Regeneration"
  - "desc": "Three [shadows](3-Mechanics/CLI/bestiary/undead/shadow.md) hide within\
      \ the saddle of Aribeth's nightmare. These shadows only come out if there is\
      \ a creature within 30 feet that is at 0 hit points. When that happens, a shadow\
      \ emerges and attacks the creature in order to make it fail a death saving throw.\
      \ It continues to do so until the creature is dead."
    "name": "Shadows"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 7\
      ...
      \ short of a [wish](3-Mechanics/CLI/spells/wish.md) spell."
    "name": "Void"
  ...
  - "desc": "Aribeth casts one of the following spells, using Charisma as the spellcasting\
      ...
      \ [command](3-Mechanics/CLI/spells/command.md), [magic weapon](3-Mechanics/CLI/spells/magic-weapon.md),\
      \ [searing smite](3-Mechanics/CLI/spells/searing-smite.md), [shield of faith](3-Mechanics/CLI/spells/shield-of-faith.md)\n\
...
"source":
  - "MaBJoV"
"image": "3-Mechanics/CLI/bestiary/npc/token/aribeth-de-tylmarande-mabjov.webp"
```
^statblock