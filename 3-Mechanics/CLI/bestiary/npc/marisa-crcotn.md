...
- "Marisa"
---
# [Marisa](3-Mechanics/CLI/bestiary/npc/marisa-crcotn.md)
...
"actions":
  ...
  - "desc": "One humanoid that Marisa can see within 5 feet of it must succeed on\
      \ a DC 13 Charisma saving throw or be possessed by Marisa; Marisa then disappears,\
      \ and the target is incapacitated and loses control of its body. Marisa now\
      \ controls the body but doesn't deprive the target of awareness. Marisa can't\
      ...
      \ Marisa ends it as a bonus action, or Marisa is turned or forced out by an\
      \ effect like the dispel evil and good spell. When the possession ends, Marisa\
