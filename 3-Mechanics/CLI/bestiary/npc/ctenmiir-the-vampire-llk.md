...
---
# [Ctenmiir the Vampire](3-Mechanics/CLI/bestiary/npc/ctenmiir-the-vampire-llk.md)
...
"traits":
  - "desc": "Ctenmiir is imprisoned within a magical iron coffin mounted atop animated\
      \ golem legs. Ctenmiir's coffin has a speed of 30 feet and a climbing speed\
      \ of 10 feet, and protects the vampire from sunlight even as it prevents him\
      \ from escaping his servitude."
    "name": "Coffin Imprisonment"
  - "desc": "If Ctenmiir isn't in sunlight or running water, it can use its action\
      \ to polymorph into a Tiny bat or a Medium cloud of mist, or back into its true\
      \ form.\n\nWhile in bat form, Ctenmiir can't speak, its walking speed is 5 feet,\
      ...
      \ form, Ctenmiir can't take any actions, speak, or manipulate objects. It is\
  ...
  - "desc": "When it drops to 0 hit points outside its resting place, Ctenmiir transforms\
    ...
    "name": "Misty Escape"
  - "desc": "Ctenmiir regains 20 hit points at the start of its turn if it has at\
      \ least 1 hit point and isn't in sunlight or running water. If Ctenmiir takes\
      \ radiant damage or damage from [holy water](3-Mechanics/CLI/items/holy-water-flask.md),\
      \ this trait doesn't function at the start of Ctenmiir's next turn."
    "name": "Regeneration"
  - "desc": "Ctenmiir can climb difficult surfaces, including upside down on ceilings,\
      \ without needing to make an ability check."
    "name": "Spider Climb"
  - "desc": "Ctenmiir has the following flaws:\n\n- **Forbiddance.** Ctenmiir can't\
      \ enter a residence without an invitation from one of the occupants.  \n- **Harmed\
      \ by Running Water.** Ctenmiir takes 20 acid damage if it ends its turn in running\
      \ water.  \n- **Stake to the Heart.** If a piercing weapon made of wood is driven\
      \ into Ctenmiir's heart while Ctenmiir is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ in its resting place, Ctenmiir is [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed)\
      \ until the stake is removed.  \n- **Sunlight Hypersensitivity.** Ctenmiir takes\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one creature. *Hit:*\
      \ 8 (1d8 + 4) bludgeoning damage. Instead of dealing damage, Ctenmiir can\
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one willing creature,\
      ...
      \ and Ctenmiir regains hit points equal to that amount. The reduction lasts\
  ...
  - "desc": "Ctenmiir targets one humanoid it can see within 30 feet of it. If the\
      \ target can see Ctenmiir, the target must succeed on a DC 17 Wisdom saving\
      \ throw against this magic or be [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
      \ by Ctenmiir. The [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) target\
      \ regards Ctenmiir as a trusted friend to be heeded and protected. Although\
      \ the target isn't under Ctenmiir's control, it takes Ctenmiir's requests or\
      \ actions in the most favorable way it can, and it is a willing target for Ctenmiir's\
      ...
      \ on a success. Otherwise, the effect lasts 24 hours or until Ctenmiir is destroyed,\
  ...
  - "desc": "Ctenmiir magically calls 2d4 swarms of [bats](3-Mechanics/CLI/bestiary/beast/swarm-of-bats.md)\
      ...
      \ the sun isn't up. While outdoors, Ctenmiir can call 3d6 [wolves](3-Mechanics/CLI/bestiary/beast/wolf.md)\
      \ instead. The called creatures arrive in 1d4 rounds, acting as allies of\
      \ Ctenmiir and obeying its spoken commands. The beasts remain for 1 hour, until\
      \ Ctenmiir dies, or until Ctenmiir dismisses them as a bonus action."
    "name": "Children of the Night (1/Day)"
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, Ctenmiir can expend a use to take one of the following actions. Ctenmiir\
