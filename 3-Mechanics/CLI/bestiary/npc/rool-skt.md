...
"traits":
  - "desc": "During its first turn, Rool has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Rool scores against a [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Rool deals an extra 14 (4d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Rool that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
