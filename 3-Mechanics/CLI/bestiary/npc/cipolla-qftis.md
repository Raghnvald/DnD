...
- "Cipolla"
---
# [Cipolla](3-Mechanics/CLI/bestiary/npc/cipolla-qftis.md)
...
"cr": "1"
"actions":
  - "desc": "Cipolla makes two Arcane Burst attacks and can use Starry Radiance if\
      \ available."
    "name": "Multiattack"
  ...
  - "desc": "Dazzling light bursts from Cipolla's fingertips in a 15-foot cone. Each\
      ...
      \ until the end of Cipolla's next turn."
    "name": "Starry Radiance (Recharge 5-6)"
  - "desc": "Cipolla casts one of the following spells, using Intelligence as the\
...
"source":
  - "QftIS"
"image": "3-Mechanics/CLI/bestiary/npc/token/cipolla-qftis.webp"
```
^statblock