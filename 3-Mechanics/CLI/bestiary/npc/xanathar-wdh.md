...
- "Xanathar"
---
# [Xanathar](3-Mechanics/CLI/bestiary/npc/xanathar-wdh.md)
...
"cr": "13"
"traits":
  - "desc": "Xanathar wears a [ring of invisibility](3-Mechanics/CLI/items/ring-of-invisibility-xdmg.md),\
      \ a [ring of mind shielding](3-Mechanics/CLI/items/ring-of-mind-shielding-xdmg.md),\
      \ and a [ring of resistance (force)](3-Mechanics/CLI/items/ring-of-force-resistance-xdmg.md)."
  ...
  - "desc": "Xanathar's central eye creates an area of antimagic, as in the [antimagic\
      ...
      \ cone. At the start of each of its turns, Xanathar decides which way the cone\
      \ faces and whether the cone is active. The area works against Xanathar's own\
      \ eye rays."
    "name": "Antimagic Cone"
"actions":
