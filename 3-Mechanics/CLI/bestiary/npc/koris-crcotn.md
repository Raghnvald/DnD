...
- "Koris"
---
# [Koris](3-Mechanics/CLI/bestiary/npc/koris-crcotn.md)
...
"traits":
  - "desc": "During its first turn, Koris has advantage on attack rolls against any\
    ...
    "name": "Assassinate"
  - "desc": "If Koris is subjected to an effect that allows it to make a Dexterity\
      \ saving throw to take only half damage, Koris instead takes no damage if it\
  ...
  - "desc": "Koris deals an extra 14 (4d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Koris that isn't incapacitated and Koris doesn't have\
