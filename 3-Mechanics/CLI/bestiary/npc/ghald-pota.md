...
- "Ghald"
---
# [Ghald](3-Mechanics/CLI/bestiary/npc/ghald-pota.md)
...
"traits":
  - "desc": "During its first turn, Ghald has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Ghald scores against a [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Ghald deals an extra 14 (4d6) damage when he hits a target with a weapon\
      ...
      \ 5 feet of an ally of Ghald's that isn't [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
