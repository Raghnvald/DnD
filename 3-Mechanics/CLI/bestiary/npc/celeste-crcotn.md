...
- "Celeste"
---
# [Celeste](3-Mechanics/CLI/bestiary/npc/celeste-crcotn.md)
...
"traits":
  - "desc": "Celeste can see 60 feet into the Ethereal Plane when it is on the Material\
    ...
    "name": "Ethereal Sight"
  - "desc": "Celeste can move through other creatures and objects as if they were\
...
"actions":
  ...
  - "desc": "One humanoid that Celeste can see within 5 feet of it must succeed on\
      \ a DC 13 Charisma saving throw or be possessed by Celeste; Celeste then disappears,\
      \ and the target is incapacitated and loses control of its body. Celeste now\
      \ controls the body but doesn't deprive the target of awareness. Celeste can't\
      \ be targeted by any attack, spell, or other effect, except ones that turn undead,\
      \ and it retains its alignment, Intelligence, Wisdom, Charisma, and immunity\
      ...
      \ Celeste ends it as a bonus action, or Celeste is turned or forced out by an\
      \ effect like the dispel evil and good spell. When the possession ends, Celeste\
      \ reappears in an unoccupied space within 5 feet of the body. The target is\
      \ immune to this ghost's Possession for 24 hours after succeeding on the saving\
