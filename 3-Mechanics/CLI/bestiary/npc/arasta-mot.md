...
"actions":
  ...
  - "desc": "Arasta unleashes her hair in the form of webbing that fills a 30-foot\
      ...
      \ the creature is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
      ...
      \ [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by the web. This\
      \ webbing is immune to all damage except magical fire. A 5-foot cube of the\
      \ web is destroyed if it takes at least 20 fire damage from a spell or other\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Arasta can take a lair\
      ...
      \ Each creature [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
