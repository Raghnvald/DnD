...
- "Shalfey"
---
# [Shalfey](3-Mechanics/CLI/bestiary/npc/shalfey-qftis.md)
*Source: Quests from the Infinite Staircase p. 68*  
...
"cr": "1"
"actions":
  - "desc": "Shalfey makes two Arcane Burst attacks and can use Starry Radiance if\
      \ available."
    "name": "Multiattack"
  ...
  - "desc": "Dazzling light bursts from Shalfey's fingertips in a 15-foot cone. Each\
      ...
      \ until the end of Shalfey's next turn."
    "name": "Starry Radiance (Recharge 5-6)"
  - "desc": "Shalfey casts one of the following spells, using Intelligence as the\
...
"source":
  - "QftIS"
"image": "3-Mechanics/CLI/bestiary/npc/token/shalfey-qftis.webp"
```
^statblock