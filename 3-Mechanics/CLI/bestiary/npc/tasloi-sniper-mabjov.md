...
"skillsaves":
  - "name": "[Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)"
    "desc": "+8"
"gear":
  - "[blowgun](3-Mechanics/CLI/items/blowgun.md)"
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +6 to hit, range 25/100 ft., one target. *Hit:*\
      ...
      \ on a DC 10 Constitution saving throw or have the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned)\
...
"source":
  - "MaBJoV"
"image": "3-Mechanics/CLI/bestiary/npc/token/tasloi-sniper-mabjov.webp"
```
^statblock