...
"traits":
  - "desc": "If the satyr performs for at least 1 minute, it chooses up to four humanoids\
      ...
      \ While [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) in this way,\
      \ the target idolizes the satyr and will take part in the satyr's revels. The\
      \ [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) condition ends for\
      \ the creature after 1 hour, if it takes any damage, if the satyr attacks the\
      \ target, or if the target witnesses the satyr attacking or damaging any of\
      \ the target's allies."
