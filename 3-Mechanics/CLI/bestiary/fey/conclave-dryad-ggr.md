...
"traits":
  - "desc": "The dryad's innate spellcasting ability is Charisma (spell save DC 17).\
      ...
      **3/day each:** [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md),\
      ...
      \ [moonbeam](/3-Mechanics/CLI/spells/moonbeam-xphb.md), [grasping vine](/3-Mechanics/CLI/spells/grasping-vine-xphb.md),\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ on a DC 17 Dexterity saving throw or become [restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
      \ by twisting vines for 1 minute. A target [restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
      \ in this way can use an action to make a DC 17 Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics))\
  ...
  - "desc": "The dryad magically summons a mount, which appears in an unoccupied space\
      ...
      \ stat block of an [elk](/3-Mechanics/CLI/bestiary/beast/elk-xmm.md) (see the\
  ...
  - "desc": "The dryad targets one magic item it can see within 120 feet of it. If\
      ...
      \ 10 minutes, until the dryad is [incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated)\
