...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:*\
      ...
      \ body is destroyed. The wight can have no more than twelve [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md)\
      \ under its control at one time."
    "name": "Life Drain"
"source":
  - "MTF"
  - "TftYP"
"image": "3-Mechanics/CLI/bestiary/undead/token/deathlock-wight-mtf.webp"
```
^statblock