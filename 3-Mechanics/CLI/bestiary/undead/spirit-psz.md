...
- "Spirit"
---
# [Spirit](3-Mechanics/CLI/bestiary/undead/spirit-psz.md)
...
"cr": "4"
"traits":
  - "desc": "The spirit can see 60 feet into the Ethereal Plane when it is on the\
...
"actions":
  ...
  - "desc": "The spirit enters the Ethereal Plane from the Material Plane, or vice\
      ...
      \ plane."
    "name": "Etherealness"
  - "desc": "Each non-undead creature within 60 feet of the spirit that can see it\
      ...
      \ ends for it, the target is immune to this spirit's Horrifying Visage for the\
  ...
  - "desc": "One humanoid that the spirit can see within 5 feet of it must succeed\
      \ on a DC 13 Charisma saving throw or be possessed by the spirit; the spirit\
      ...
      \ the body drops to 0 hit points, the spirit ends it as a bonus action, or the\
      \ spirit is turned or forced out by an effect like the [dispel evil and good](3-Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
  - "PSZ"
"image": "3-Mechanics/CLI/bestiary/undead/token/spirit-psz.webp"
```
^statblock