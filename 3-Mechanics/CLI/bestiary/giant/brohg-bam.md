...
"actions":
  ...
  - "desc": "The b'rohg uses all four of its hands to target one Large or smaller\
      ...
      \ DC 16 Dexterity saving throw or be grappled (escape DC 16). Until this grapple\
      \ ends, the b'rohg can't make Fist attacks or Rock attacks, and the target takes\
      \ 49 (8d10 + 5) bludgeoning damage at the start of each of its turns. A creature\
