...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ this grapple ends. The herald can have only one creature grappled this way\
      \ at a time."
    "name": "Tentacles"
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 10 ft., one target. *Hit:*\
  ...
  - "desc": "The herald unleashes a blast of psionic energy into the minds of up to\
      ...
      \ on a success.\n\nIf a creature is reduced to 0 hit points by this psychic\
      \ damage, it dies and its head explodes if it has one."
