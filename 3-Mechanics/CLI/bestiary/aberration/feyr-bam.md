...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one creature. *Hit:*\
      ...
      \ that can see it must succeed on a DC 13 Wisdom saving throw or be frightened\
      \ of the feyr until the end of the feyr's next turn."
    "name": "Frightful Bite"
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 10 ft., one creature. *Hit:*\
      \ 17 (4d6 + 3) psychic damage, and the target is grappled (escape DC 13).\
      \ Until this grapple ends, the feyr can't use this tentacle against other targets.\
  ...
  - "desc": "The feyr targets one unconscious creature it can see within 10 feet of\
      ...
      \ (5d10) psychic damage, and the feyr gains temporary hit points equal to\
      \ the damage dealt."
