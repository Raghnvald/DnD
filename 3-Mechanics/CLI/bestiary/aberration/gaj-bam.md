...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:*\
      \ 10 (2d6 + 3) slashing damage, and the target is grappled (escape DC 11).\
      \ Until the grapple ends, the target takes 10 (2d6 + 3) slashing damage at\
      \ the start of each of the gaj's turns. While it is grappling a creature, the\
      \ gaj can't use its mandibles to attack other creatures."
    "name": "Mandibles"
  ...
  - "desc": "The gaj magically targets one creature it can see within 60 feet of itself.\
      \ The target must succeed on a DC 12 Wisdom saving throw or be paralyzed for\
