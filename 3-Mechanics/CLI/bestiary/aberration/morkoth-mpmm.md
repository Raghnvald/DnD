...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 15 ft., one target. *Hit:*\
      \ 15 (3d8 + 2) bludgeoning damage, and the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
  ...
  - "desc": "The morkoth projects a 30-foot cone of magical energy. Each creature\
      ...
      \ using its actions to [Dash](3-Mechanics/CLI/rules/actions.md#Dash) until it\
      \ is within 5 feet of the morkoth. A [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
