...
- "Halog"
---
# [Halog](3-Mechanics/CLI/bestiary/aberration/halog-coa.md)
...
"traits":
  ...
  - "desc": "The halog gains advantage on attacks targeting creatures adjacent to\
      \ one or more of the halog's conscious allies."
    "name": "Pack Tactics"
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 12\
    ...
    "name": "Bite"
"reactions":
  - "desc": "After taking damage, the halog is now invulnerable to the damage type\
      \ of the damage it just took, and any future damage of that type instead heals\
      \ the halog by the damage amount. These benefits last until the halog uses this\
      \ reaction again."
    "name": "Adaptive Hide"
"source":
  - "CoA"
"image": "3-Mechanics/CLI/bestiary/aberration/token/halog-coa.webp"
```
^statblock