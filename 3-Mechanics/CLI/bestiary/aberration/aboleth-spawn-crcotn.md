...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one creature. *Hit:*\
      \ The target is grappled (escape DC 14) and takes 9 (2d8) psychic damage at\
      \ the start of each of its turns until the grapple ends. The spawn has four\
...
"source":
  - "CRCotN"
"image": "3-Mechanics/CLI/bestiary/aberration/token/aboleth-spawn-crcotn.webp"
```
^statblock