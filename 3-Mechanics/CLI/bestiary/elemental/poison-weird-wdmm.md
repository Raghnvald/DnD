...
"traits":
  ...
  - "desc": "The weird dies if forced to leave the basin of toxic brew it inhabits,\
      \ or if a [purify food and drink](3-Mechanics/CLI/spells/purify-food-and-drink-xphb.md)\
      \ spell is cast on the brew."
    "name": "Brew Bound"
  - "desc": "A creature takes 10 (3d6) poison damage at the start of each of its\
      \ turns while [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) by a\
      \ poison weird."
    "name": "Poisonous Body"
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ and pulled 5 feet toward the poison weird. Until this grapple ends, the target\
