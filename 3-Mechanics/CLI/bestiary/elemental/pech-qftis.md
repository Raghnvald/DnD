...
"actions":
  ...
  - "desc": "The pech casts [Stone Shape](3-Mechanics/CLI/spells/stone-shape.md),\
  ...
  - "desc": "The pech works with three or more pechs to cast spells, requiring no\
      ...
      \ [Wall of Stone](3-Mechanics/CLI/spells/wall-of-stone.md). If at least seven\
      \ other pechs are within 30 feet of it, it can cast [Greater Restoration](3-Mechanics/CLI/spells/greater-restoration.md).\
...
"source":
  - "QftIS"
"image": "3-Mechanics/CLI/bestiary/elemental/token/pech-qftis.webp"
```
^statblock