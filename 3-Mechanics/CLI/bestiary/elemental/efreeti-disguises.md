...
"traits":
  - "desc": "The efreeti's innate spellcasting ability is Charisma (spell save DC\
      ...
      \n**3/day each:** enlarge/reduce, tongues, true polymorph (mightier genies only;\
      \ see Disguises)\n\n**1/day each:** conjure elemental ([fire elemental](/3-Mechanics/CLI/bestiary/elemental/fire-elemental.md)\
