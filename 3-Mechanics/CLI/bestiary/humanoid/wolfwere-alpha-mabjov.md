...
- "Wolfwere Alpha"
---
# [Wolfwere Alpha](3-Mechanics/CLI/bestiary/humanoid/wolfwere-alpha-mabjov.md)
...
While in their humanoid forms, wolfweres have the ability to sing a song that induces a lethargy in their prey that is similar to a [slow](3-Mechanics/CLI/spells/slow.md) spell. Many wolfweres play stringed instruments and pose as bards to avoid arousing suspicion while they work their charms.
...
"cr": "6"
"traits":
  - "desc": "The wolfwere has advantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "The wolfwere plays a magical melody on an instrument. Every Humanoid\
      ...
      \ 16 Wisdom saving throw or be slowed for 10 minutes, as if the [slow](3-Mechanics/CLI/spells/slow.md)\
...
"source":
  - "MaBJoV"
"image": "3-Mechanics/CLI/bestiary/humanoid/token/wolfwere-alpha-mabjov.webp"
```
^statblock