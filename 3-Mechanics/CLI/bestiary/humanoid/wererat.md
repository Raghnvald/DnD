...
"damage_immunities": "bludgeoning, piercing, slashing from nonmagical attacks that\
  \ aren't silvered"
"senses": "[darkvision](/3-Mechanics/CLI/senses.md#Darkvision) 60 ft. (rat form only),\
...
"traits":
  - "desc": "The wererat can use its action to polymorph into a rat-humanoid hybrid\
    ...
    "name": "Shapechanger"
  - "desc": "The wererat has advantage on Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception))\
