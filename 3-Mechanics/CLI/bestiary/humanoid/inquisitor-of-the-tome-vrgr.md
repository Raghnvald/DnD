...
"actions":
  ...
  - "desc": "Each creature in a 20-foot-radius sphere centered on a point the inquisitor\
      ...
      \ throw or take 31 (6d8 + 4) force damage and be knocked [prone](/3-Mechanics/CLI/conditions.md#Prone)\
  ...
  - "desc": "The inquisitor casts one of the following spells, requiring no components\
      ...
      **At will:** [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md), [dispel\
      ...
      \ resilient sphere](/3-Mechanics/CLI/spells/otilukes-resilient-sphere-xphb.md),\
