...
"traits":
  - "desc": "The archmage is an 18th-level spellcaster. Its spellcasting ability is\
      ...
      \ shocking grasp\n\n**1st level (4 slots):** detect magic, find familiar (one\
      \ of the creatures described in the spell or some other Tiny monster, such as\
      \ a crawling claw, [imp](/3-Mechanics/CLI/bestiary/fiend/imp.md), [pseudodragon](/3-Mechanics/CLI/bestiary/dragon/pseudodragon.md),\
      \ or [quasit](/3-Mechanics/CLI/bestiary/fiend/quasit.md)), identify, mage armor*,\
