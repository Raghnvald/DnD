...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 20 ft., one target. *Hit:*\
      \ 11 (2d6 + 4) slashing damage. If the target is a creature, it is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one Medium or smaller\
      ...
      \ it has total cover against attacks and effects originating outside the pod.\
      \ The enveloped target must also immediately succeed on a DC 16 Constitution\
