...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 15 ft., one target. *Hit:*\
    ...
    "name": "Branch"
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 15 ft., one creature not grappled\
      \ by the blight. *Hit:* The target is grappled (escape DC 15). Until the grapple\
      \ ends, the target takes 9 (1d6 + 6) bludgeoning damage at the start of each\
      \ of its turns. The root has AC 15 and can be severed by dealing 6 slashing\
      \ damage or more to it at once. Cutting the root doesn't hurt the blight, but\
      \ ends the grapple."
    "name": "Grasping Root"
"bonus_actions":
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one creature grappled\
