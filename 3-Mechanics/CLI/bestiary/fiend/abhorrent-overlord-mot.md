...
"actions":
  ...
  - "desc": "The abhorrent overlord conjures a swarm of spectral crows and harpies\
      ...
      \ [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) (as if\
      \ [concentrating](3-Mechanics/CLI/rules/conditions.md#Concentration) on a spell),\
      \ and its area is lightly obscured and difficult terrain.\n\nAny creature that\
      \ moves into the area for the first time on a turn or starts its turn there\
      \ must make a DC 15 Constitution saving throw. A creature takes 16 (3d10)\
      \ slashing damage plus 16 (3d10) psychic damage on a failed save, or half\
