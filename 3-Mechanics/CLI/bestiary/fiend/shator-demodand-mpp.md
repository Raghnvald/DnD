...
- "Shator Demodand"
---
# [Shator Demodand](3-Mechanics/CLI/bestiary/fiend/shator-demodand-mpp.md)
...
"traits":
  ...
  - "desc": "The shator can cast the [imprisonment](3-Mechanics/CLI/spells/imprisonment.md)\
  ...
  - "desc": "The shator can perform a 1-minute ritual that turns all willing farastus\
      ...
      \ the [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) condition despite\
      \ any immunity to that condition, it has immunity to all damage, and any curse\
      \ affecting it is suspended."
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 5 ft., one target. *Hit:*\
      ...
      \ the [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed) condition until\
      \ the start of the shator's next turn."
    "name": "Bite"
  ...
  - "desc": "The shator exhales a spray of slime in a line 100 feet long and 5 feet\
      ...
      \ On a failed save, a creature takes 40 (9d8) acid damage and has the [paralyzed](3-Mechanics/CLI/rules/conditions.md#Paralyzed)\
  ...
  - "desc": "The shator casts one of the following spells, requiring no material components\
      ...
      \ to hit with spell attacks):\n\n**At will:** [invisibility](3-Mechanics/CLI/spells/invisibility.md)\
      \ (self only), [suggestion](3-Mechanics/CLI/spells/suggestion.md)\n\n**1/day\
      \ each:** [dispel magic](3-Mechanics/CLI/spells/dispel-magic.md), [plane shift](3-Mechanics/CLI/spells/plane-shift.md)\
      \ (to Carceri only), [scrying](3-Mechanics/CLI/spells/scrying.md) (as an action)"
    "name": "Spellcasting"
"source":
  - "MPP"
"image": "3-Mechanics/CLI/bestiary/fiend/token/shator-demodand-mpp.webp"
```
^statblock