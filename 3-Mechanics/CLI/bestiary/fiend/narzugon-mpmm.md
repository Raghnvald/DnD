...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ kills a creature with a soul, the soul rises from the River Styx as a [lemure](3-Mechanics/CLI/bestiary/fiend/lemure.md)\
      \ in Avernus in 1d4 hours. If the creature isn't revived before then, only\
      \ a [wish](3-Mechanics/CLI/spells/wish.md) spell or killing the lemure and casting\
