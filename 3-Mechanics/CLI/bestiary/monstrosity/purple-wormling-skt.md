...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 7\
      ...
      \ cover against attacks and other effects outside the wormling, and it takes\
      \ 3 (1d6) acid damage at the start of each of the wormling's turns.\n\nIf\
      \ the wormling takes 10 damage or more on a single turn from a creature inside\
