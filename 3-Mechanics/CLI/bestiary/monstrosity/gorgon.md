...
"traits":
  - "desc": "If the gorgon moves at least 20 feet straight toward a creature and then\
      ...
      \ DC 16 Strength saving throw or be knocked [prone](/3-Mechanics/CLI/conditions.md#Prone).\
      \ If the target is [prone](/3-Mechanics/CLI/conditions.md#Prone), the gorgon\
...
"actions":
  ...
  - "desc": "The gorgon exhales petrifying gas in a 30-foot cone. Each creature in\
      ...
      \ a target begins to turn to stone and is [restrained](/3-Mechanics/CLI/conditions.md#Restrained).\
      \ The [restrained](/3-Mechanics/CLI/conditions.md#Restrained) target must repeat\
      \ the saving throw at the end of its next turn. On a success, the effect ends\
      \ on the target. On a failure, the target is [petrified](/3-Mechanics/CLI/conditions.md#Petrified)\
