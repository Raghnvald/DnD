...
"traits":
  ...
  - "desc": "The wurm creates earth tremors as it moves overland or underground. Any\
      ...
      \ damage and fall [prone](/3-Mechanics/CLI/conditions.md#Prone). Any structure\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 10 ft., one target. *Hit:* 24\
      ...
      \ against attacks and other effects outside the wurm, and takes 17 (5d6) acid\
      \ damage at the start of each of the wurm's turns. If the wurm takes 30 damage\
      \ or more on a single turn from a creature inside it, the wurm must succeed\
