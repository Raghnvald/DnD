...
"cr": "1/2"
"traits":
  - "desc": "The darkmantle can't use its blindsight while [deafened](/3-Mechanics/CLI/conditions.md#Deafened)."
    "name": "Echolocation"
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ roll, it attaches by engulfing the target's head, and the target is also [blinded](/3-Mechanics/CLI/conditions.md#Blinded)\
  ...
  - "desc": "A 15-foot radius of magical darkness extends out from the darkmantle,\
      ...
      \ darkmantle maintains [concentration](/3-Mechanics/CLI/conditions.md#Concentration),\
      \ up to 10 minutes (as if [concentrating](/3-Mechanics/CLI/conditions.md#Concentration)\
