...
"traits":
  ...
  - "desc": "The tortoise can carry up to 20,000 pounds of weight atop its shell,\
      ...
      \ creatures can move underneath the tortoise while it's not prone.\n\nAny creature\
      \ under the tortoise when it falls prone is grappled (escape DC 18). Until the\
      \ grapple ends, the creature is prone and restrained."
    "name": "Massive Frame"
"actions":
