...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +11 to hit, reach 20 ft., one target. *Hit:*\
      \ 14 (2d6 + 7) bludgeoning damage, and the target is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
  ...
  - "desc": "One Medium or smaller object held or creature [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
      ...
      \ knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone). If a thrown target\
      \ strikes a solid surface, the target takes 3 (1d6) bludgeoning damage for\
      \ every 10 feet it was thrown. If the target is thrown at another creature,\
