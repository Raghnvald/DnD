...
"actions":
  - "desc": "*Melee Weapon Attack:* +11 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ is a creature, it is grappled (escape DC 17). Until this grapple ends, the\
      \ target is restrained, and the centipede can't bite another target."
    "name": "Bite"
  - "desc": "The centipede makes one bite attack against a Medium or smaller creature\
      ...
      \ and is swallowed, and the grapple ends. While swallowed, the creature is blinded\
      \ and restrained, it has total cover against attacks and other effects outside\
      \ the centipede, and it takes 21 (6d6) acid damage at the start of each of\
      \ the centipede's turns.\n\nIf the centipede takes 30 damage or more on a single\
      \ turn from a creature inside it, the centipede must succeed on a DC 15 Constitution\
      \ saving throw at the end of that turn or regurgitate all swallowed creatures,\
      \ which fall prone in a space within 10 feet of the centipede. If the centipede\
