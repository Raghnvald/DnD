...
A nimblewright doesn't require air, food, drink, or sleep. Damage it takes can be repaired with [mending](3-Mechanics/CLI/spells/mending-xphb.md) spells, but a nimblewright reduced to 0 hit points is permanently destroyed.
...
"traits":
  ...
  - "desc": "As long as it has at least 1 hit point remaining, the nimblewright regains\
      \ 1 hit point when a [mending](3-Mechanics/CLI/spells/mending-xphb.md) spell\
      \ is cast on it."
    "name": "Repairable"
