...
"actions":
  - "desc": "The hellfire engine moves up to its speed in a straight line. During\
      ...
      \ in the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) creature's space,\
  ...
  - "desc": "The hellfire engine uses one of the following options (choose one or\
      ...
      \ Styx as a [lemure](3-Mechanics/CLI/bestiary/fiend/lemure.md) in Avernus in\
      \ 1d4 hours. If the creature isn't revived before then, only a [wish](3-Mechanics/CLI/spells/wish.md)\
      \ spell or killing the [lemure](3-Mechanics/CLI/bestiary/fiend/lemure.md) and\
