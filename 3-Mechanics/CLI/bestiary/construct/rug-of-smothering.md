...
"cr": "2"
"traits":
  - "desc": "The rug is [incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated)\
  ...
  - "desc": "While it is grappling a creature, the rug takes only half the damage\
      \ dealt to it, and the creature [grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one Medium or smaller\
      \ creature. *Hit:* The creature is [grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
      \ (escape DC 13). Until this grapple ends, the target is [restrained](/3-Mechanics/CLI/conditions.md#Restrained),\
      \ [blinded](/3-Mechanics/CLI/conditions.md#Blinded), and at risk of suffocating,\
