...
- "Android Medic"
---
# [Android Medic](3-Mechanics/CLI/bestiary/construct/android-medic-qftis.md)
...
"actions":
  ...
  - "desc": "The android casts one of the following spells, requiring no material\
      ...
      \ spell), [Identify](3-Mechanics/CLI/spells/identify.md)"
    "name": "Spellcasting"
"source":
  - "QftIS"
"image": "3-Mechanics/CLI/bestiary/construct/token/android-medic-qftis.webp"
```
^statblock