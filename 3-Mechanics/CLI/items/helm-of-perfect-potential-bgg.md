...
While wearing the helm, you have advantage on Charisma ([Deception](/3-Mechanics/CLI/skills.md#Deception)) and Wisdom ([Insight](/3-Mechanics/CLI/skills.md#Insight)) checks.
...
The helm has 6 charges and regains `dice:1d6|noform|noparens|avg` (`1d6`) charges each dawn. As an action while wearing the helm, you can expend 1 or more of its charges to cast one of the following spells (save DC 20): [elemental weapon](/3-Mechanics/CLI/spells/elemental-weapon-xphb.md) (1 charge), [call lightning](/3-Mechanics/CLI/spells/call-lightning-xphb.md) (2 charges), [wall of fire](/3-Mechanics/CLI/spells/wall-of-fire-xphb.md) (3 charges), [conjure elemental](/3-Mechanics/CLI/spells/conjure-elemental-xphb.md) (4 charges), [tsunami](/3-Mechanics/CLI/spells/tsunami-xphb.md) (5 charges).
