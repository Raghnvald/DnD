...
---
# Hide of the Feral Guardian (Exalted)
*Light armor (studded leather armor), legendary (requires attunement)*  
...
- When you cast the polymorph spell using this armor, you can transform into a [guardian wolf](3-Mechanics/CLI/bestiary/monstrosity/guardian-wolf-egw.md).  
