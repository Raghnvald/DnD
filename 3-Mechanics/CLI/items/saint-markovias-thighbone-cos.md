...
Saint Markovia's thighbone has the properties of a [mace of disruption](3-Mechanics/CLI/items/mace-of-disruption.md). If it scores one or more hits against a vampire or a vampire spawn in the course of a single battle, the thighbone crumbles into dust once the battle concludes.
