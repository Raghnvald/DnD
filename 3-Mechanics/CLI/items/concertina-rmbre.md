...
Any creatures touching the floor must succeed on a DC 20 Dexterity saving throw or be [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by the ice. As an action, a [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) creature can attempt to free itself or another creature within its reach from the ice, doing so with a successful DC 20 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. A character freed from the ice is no longer [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by it. The ice melts in an hour.
