...
Additionally, you can use an action to draw forth from the documancy satchel a [spell scroll](3-Mechanics/CLI/items/spell-scroll.md) of comprehend languages. The scroll vanishes when used, or ten minutes after it appears. This property of the bag can't be used again until the next dawn.
