...
Whenever you roll a [Hit Point Die](3-Mechanics/CLI/rules/variant-rules/hit-point-dice-xphb.md) to regain [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md), double the number of [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) it restores.
