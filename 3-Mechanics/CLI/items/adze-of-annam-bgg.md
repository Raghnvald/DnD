...
---
# Adze of Annam
*Weapon ([greataxe](/3-Mechanics/CLI/items/greataxe-xphb.md)), artifact (requires attunement)*  
...
When a creature attunes to the adze, the artifact magically adjusts its size so that creature can wield it as a greataxe. The adze is a magic weapon that grants a +3 bonus to attack and damage rolls made with it. On a hit, the adze deals an additional `dice:3d12|noform|noparens|avg` (`3d12`) force damage. It also deals double damage to objects and structures.

## Divine Mattock

As an action, you can call upon the might of the All-Father and use the adze to cast [move earth](/3-Mechanics/CLI/spells/move-earth-xphb.md) or [fabricate](/3-Mechanics/CLI/spells/fabricate-xphb.md). Once this property is used, it can't be used again until the next dawn.
