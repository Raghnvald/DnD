...
| 8 | Beyond the Rock of Bral (silver mind flayer tooth) | 2 [mind flayers](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) | You gain telepathy out to 120 feet as described in the Monster Manual, and you can cast the [detect thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md) spell at will, requiring no components. You also have disadvantage on Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) and Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks from constant whispers of memories and nearby minds. |
...
| 13 | Three Bridges to the Sky (lapis lazuli oni fang) | 3 [oni](3-Mechanics/CLI/bestiary/fiend/oni-xmm.md) | You gain a flying speed of 30 feet, and you can use the tooth to cast the [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell at will. While you are attuned to fewer than 3 magic items, you gain 1 level of [exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) that can't be removed until you are attuned to three or more magic items. |
