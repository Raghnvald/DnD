...
![](3-Mechanics/CLI/items/img/tome-of-the-dragon.webp#right)
...
When the ritual is complete, the tome explodes with violet light, dealing (`12d6`) Necrotic damage to you and each assistant. If this damage reduces a creature to 0 <span title="Player's Handbook (2024)">Hit Points</span>, the creature is killed and immediately reanimates as a Zombie under the DM's control.
