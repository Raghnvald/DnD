...
| dice: d12 | Encounter |
|-----------|-----------|
| 1 | 1 frost giant (attitude: `1d8 + 1`) leading 1 [titanothere](3-Mechanics/CLI/bestiary/beast/titanothere-bgg.md) (attitude: `1d10`) loaded with fur and timber |
...
| 4 | 2 frost giants (attitude: `1d6 + 2`) burying a body that rises as 1 [frostmourn](3-Mechanics/CLI/bestiary/undead/frostmourn-bgg.md) (attitude: `1d4 + 1`) in the process |
...
| 11 | 1 ogre bolt launcher and `1d4 + 2` ogres (attitude for all: `1d6`) bringing spoils from a raid to their frost giant leader |
