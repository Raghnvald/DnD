...
| 7 | 1 week after first obtaining the item, the new owner loses `4d4` from their hit point maximum until a [greater restoration](3-Mechanics/CLI/spells/greater-restoration.md) spell is cast upon the item |
...
| 10 | The item begins to stink after `1d4` weeks, giving disadvantage to anyone within 10 ft. making Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks involving smell. |
^random-curses