...
| 2 | 1 cult fanatic and `2d6` cultists of Evil Water (all with swimming speeds of 30 feet and the ability to breathe water), with `1d2` chuuls (attitude for all: `1d4 +1`) |
...
| 6 | 1 marid singing as it lounges with 1 water elemental (attitude for both: `1d10`) |
