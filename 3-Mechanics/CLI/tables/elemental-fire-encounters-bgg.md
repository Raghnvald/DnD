...
| 4 | 1 efreeti and its `1d4` dwarf minions (thugs; attitude for all: `1d4 + 1`) demanding tribute |
...
| 10 | 1 flameskull (attitude: `1d8 + 2`) searching for a lost spellbook from its living days |
