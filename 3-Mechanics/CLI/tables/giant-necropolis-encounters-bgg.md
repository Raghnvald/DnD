...
| 3 | 1 [barrowghast](3-Mechanics/CLI/bestiary/undead/barrowghast-bgg.md) and 2 zombies (attitude for all: `1d4 + 1`) prowling for living creatures to slay |
...
| 5 | `1d4` shadows (attitude: `1d8`) playing out the last moments of their lives as a shadow puppet show on a wall |
