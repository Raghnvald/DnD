...
| dice: d8 | Behavior |
|----------|----------|
| 1 | The giant has a pet (a [panther](/3-Mechanics/CLI/bestiary/beast/panther-xmm.md), a [wolf](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md), or a [giant weasel](/3-Mechanics/CLI/bestiary/beast/giant-weasel-xmm.md)) that sits on the giant's lap or shoulder. |
| 2 | The giant swats at a murmuration of starlings as if it were a cloud of gnats. |
| 3 | The giant uses a [dagger](/3-Mechanics/CLI/items/dagger-xphb.md) as a toothpick, a [greatsword](/3-Mechanics/CLI/items/greatsword-xphb.md) as a letter opener, or a pair of [javelins](/3-Mechanics/CLI/items/javelin-xphb.md) as knitting needles. |
