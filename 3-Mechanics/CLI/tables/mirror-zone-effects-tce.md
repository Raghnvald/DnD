...
| 25–34 | Reflections of `dice:1d4\|noform\|noparens\|avg` (`1d4`) creatures in the region emerge from mirrors and attack. The [reflections](/3-Mechanics/CLI/bestiary/fey/reflection-tce.md) are two-dimensional, shimmering versions of the creatures that cast them. Treat the reflections as [shadows](/3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) that are fey instead of undead and vulnerable to bludgeoning damage instead of radiant. |
