...
Having a Sacristy allows you to regain one expended spell slot of level 5 or lower after spending an entire [Short Rest](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md) in your Bastion. You can't gain this benefit again until you finish a [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).
