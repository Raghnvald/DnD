...
![Euryale and Asteria have had many adventures across the multiverse](3-Mechanics/CLI/books/the-book-of-many-things/img/134-21-002-adventure.webp#center)
...
- **Powerful Flowers.** [Euryale](3-Mechanics/CLI/bestiary/npc/euryale-bmt.md)'s garden contains many magical flowers, including some that allow an individual to cast the Wish spell. Characters might seek out [Euryale](3-Mechanics/CLI/bestiary/npc/euryale-bmt.md)'s flower garden if they need powerful magic dispelled, such as the effects of the more ruinous cards from a [Deck of Many Things](3-Mechanics/CLI/items/deck-of-many-things.md).  
