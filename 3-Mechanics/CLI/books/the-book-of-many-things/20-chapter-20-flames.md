...
[Aurnozci](3-Mechanics/CLI/bestiary/npc/aurnozci-bmt.md) relies on demonic proxies and mortal worshipers to enact its will beyond the Abyss. The exact nature of the curse that binds [Aurnozci](3-Mechanics/CLI/bestiary/npc/aurnozci-bmt.md) to Xulregg is its cult's most closely guarded secret, fully known only to the faith's enigmatic leader, a masked archmage called the Eye of [Aurnozci](3-Mechanics/CLI/bestiary/npc/aurnozci-bmt.md).
...
![Hulgaz's infernal gifts come with unexpected consequences](3-Mechanics/CLI/books/the-book-of-many-things/img/121-19-004-gift.webp#center)
...
While traveling through a remote area, the party comes across a knight beset by three bandits. The knight appears wounded. In fact, the knight and the bandits are four succubi in magical disguise, testing the party's integrity on behalf of [Hulgaz](3-Mechanics/CLI/bestiary/npc/hulgaz-bmt.md). The knight cries out for help, apparently assailed by the bandits.
...
[Malaxxix](3-Mechanics/CLI/bestiary/npc/malaxxix-bmt.md) can cast the Scrying spell on the cursed creature without material components or a spell slot. [Malaxxix](3-Mechanics/CLI/bestiary/npc/malaxxix-bmt.md) doesn't need to be on the same plane of existence as the creature to use this ability, and the creature automatically fails the saving throw against the spell.
...
The curse of [Malaxxix](3-Mechanics/CLI/bestiary/npc/malaxxix-bmt.md) lasts until ended with a Remove Curse spell, a Greater Restoration spell, or similar magic.
