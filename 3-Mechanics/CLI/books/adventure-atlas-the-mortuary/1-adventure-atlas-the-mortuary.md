...
![Crematory smoke wafts from the Mortuary's gloomy domes at all hours—evidence of the Duster's tireless work of processing Sigil's dead](3-Mechanics/CLI/books/adventure-atlas-the-mortuary/img/002-00-002-mortuary-scene.webp#center)
...
![The Dusters examine and sort freshly received bodies in the bowels of the Mortuary](3-Mechanics/CLI/books/adventure-atlas-the-mortuary/img/003-00-003-duster-examination.webp#center)
...
Three zombies process the dead under the supervision of two Duster morticians (each uses the cultist stat block). An [animated coffin](3-Mechanics/CLI/bestiary/construct/animated-coffin-aatm.md) (see the appendix) loiters nearby. Periodically, the workers load a corpse into the coffin, which ferries it to a chute in the east wall. The workers are hostile toward those who impede their work.
...
![A swirling pool of unruly apparitions stirs beneath the Spirit Sump](3-Mechanics/CLI/books/adventure-atlas-the-mortuary/img/006-00-004-beneath-the-spirit-pump.webp#center)
...
![The crypts of the Nevervault imprison deathless threats with a tenacious grip on the realms of the living](3-Mechanics/CLI/books/adventure-atlas-the-mortuary/img/009-00-005-crypts-of-nevervault.webp#center)
...
A malicious spirit (chaotic evil ghost) has tampered with one of the crypt's magical wards, releasing a necrichor (see the appendix) previously trapped inside. The hostile creatures threaten to overtake the [Heralds of Dust exorcist](3-Mechanics/CLI/bestiary/humanoid/heralds-of-dust-exorcist-aatm.md) (see the appendix) tasked with guarding this vault. If the characters don't intervene, the Undead might destabilize the vault's magic and release other creatures contained in the crypts (detailed below).
...
![Factol Skall uses his orrery of souls to unravel the mysteries of True Death](3-Mechanics/CLI/books/adventure-atlas-the-mortuary/img/012-00-006-orrery-of-souls.webp#center)
...
![Through its many planar portals, the Path of Graves connects the Mortuary to places of death across the multiverse](3-Mechanics/CLI/books/adventure-atlas-the-mortuary/img/014-00-007-path-of-graves.webp#center)
