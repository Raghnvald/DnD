...
A creature's alignment can help you determine the creature's attitude in an encounter. A Chaotic Evil monster is likely to be [Hostile](D&D/Regelvarianten/hostile-attitude-xphb.md), while a Lawful Good one is more likely to have a [Friendly](Freundlich-Gesinnung-xphb.md) attitude, ready to help those in need.
...
A chase requires at least one quarry and at least one pursuer. Any participants not already in [Initiative](D&D/Regelvarianten/Initiative-xphb.md) order must roll Initiative as the chase begins. As in combat, each participant in the chase can take one action and move on its turn.
...
A chase participant can take the [Dash](/3-Mechanics/CLI/actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion) level. A participant drops out of the chase if it has 5 [Exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion) levels. A creature can remove the [Exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion) levels it gained during the chase by finishing a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md).
...
You can give a creature any skill proficiencies you want and give it [Expertise](D&D/Regelvarianten/expertise-xphb.md) if you want it to be very skilled. If you want a creature to be good at hiding, give it Expertise in the [Stealth](/3-Mechanics/CLI/skills.md#Stealth) skill. If its keen senses make it an excellent tracker or otherwise adept at finding hidden foes, give it Expertise in the [Perception](/3-Mechanics/CLI/skills.md#Perception) skill. (You can also increase its Wisdom, as noted above.)
...
If a creature doesn't have [Resistance](3-Mechanics/CLI/variant-rules/resistance-xphb.md) or [Immunity](D&D/Regelvarianten/immunity-xphb.md) to one or more damage types, you can give it Resistance or Immunity to one or two damage types. You can also change the damage type of its existing Resistances and Immunities.
...
- **Battle Ready.** The creature has [Advantage](advantage-xphb.md) on [Initiative](D&D/Regelvarianten/Initiative-xphb.md) rolls.  
...
- **Dimensional Disruption.** Disruptive energy extends from the creature in a 30-foot [Emanation](D&D/Regelvarianten/emanation-area-of-effect-xphb.md). Other creatures can't teleport to or from a space in that area. Any attempt to do so is wasted.  
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile](D&D/Regelvarianten/hostile-attitude-xphb.md) [Imp](/3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) in the same space.  
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [Hostile](D&D/Regelvarianten/hostile-attitude-xphb.md) [Ochre Jelly](/3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) in the same space.  
...
- **Gloom Shroud.** Imperceptible energy channeled from the "Shadowfell" extends from the creature in a 20-foot [Emanation](D&D/Regelvarianten/emanation-area-of-effect-xphb.md). Other creatures in that area have [Disadvantage](disadvantage-xphb.md) on Charisma checks and Charisma saving throws.  
- **Light.** The creature sheds [Bright Light](D&D/Regelvarianten/bright-light-xphb.md) in a 10-foot radius and [Dim Light](D&D/Regelvarianten/dim-light-xphb.md) for an additional 10 feet. As a [Bonus Action](bonus-action-xphb.md), the creature can suppress this light or cause it to return. The light winks out if the creature dies.  
...
- **Slaad Host.** When the creature dies, a [Hostile](D&D/Regelvarianten/hostile-attitude-xphb.md) [Slaad Tadpole](/3-Mechanics/CLI/bestiary/aberration/slaad-tadpole-xmm.md) bursts from its innards in the same space.  
- **Steadfast.** The creature has [Immunity](D&D/Regelvarianten/immunity-xphb.md) to the [Frightened](/3-Mechanics/CLI/conditions.md#Frightened) condition while it can see an ally within 30 feet of itself.  
...
The area of the [Sphere](sphere-area-of-effect-xphb.md) is [Heavily Obscured](D&D/Regelvarianten/heavily-obscured-xphb.md) by smoke for 1 minute. A strong wind (such as the [Gust of Wind](/3-Mechanics/CLI/spells/gust-of-wind-xphb.md) spell) disperses the smoke.
...
Your judgment always outweighs these guidelines, and it's fine to err on the side of affecting more creatures. For example, if eight zombies are crowded around a Fighter when the Bard centers a [Shatter](/3-Mechanics/CLI/spells/shatter-xphb.md) spell on the Fighter's space, the spell's area should definitely engulf all eight zombies, even though according to the table, a 10-foot-radius [Sphere](sphere-area-of-effect-xphb.md) includes only three creatures.
