...
A creature's alignment can help you determine the creature's attitude in an encounter. A Chaotic Evil monster is likely to be [Hostile](3-Mechanics/CLI/rules/variant-rules/hostile-attitude-xphb.md), while a Lawful Good one is more likely to have a [Friendly](3-Mechanics/CLI/rules/variant-rules/friendly-attitude-xphb.md) attitude, ready to help those in need.
...
A chase participant can take the [Dash](3-Mechanics/CLI/rules/actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) level. A participant drops out of the chase if it has 5 [Exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) levels. A creature can remove the [Exhaustion](3-Mechanics/CLI/rules/conditions.md#Exhaustion) levels it gained during the chase by finishing a [Short](3-Mechanics/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](3-Mechanics/CLI/rules/variant-rules/long-rest-xphb.md).

#### Spells and Attacks

A chase participant can make attacks and cast spells against other creatures within range.

Chase participants can't normally make [Opportunity Attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack) against each other, since they are all assumed to be moving in the same direction at the same time. However, participants can still be the targets of [Opportunity Attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack) from creatures not participating in the chase. For example, adventurers who chase a thief past a gang of ruffians might provoke [Opportunity Attacks](3-Mechanics/CLI/rules/actions.md#Opportunity%20Attack) from the ruffians.
...
- **Dimensional Disruption.** Disruptive energy extends from the creature in a 30-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures can't teleport to or from a space in that area. Any attempt to do so is wasted.  
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile](3-Mechanics/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Imp](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) in the same space.  
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [Hostile](3-Mechanics/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Ochre Jelly](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) in the same space.  
...
- **Gloom Shroud.** Imperceptible energy channeled from the "Shadowfell" extends from the creature in a 20-foot [Emanation](3-Mechanics/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures in that area have [Disadvantage](3-Mechanics/CLI/rules/variant-rules/disadvantage-xphb.md) on Charisma checks and Charisma saving throws.  
...
- **Slaad Host.** When the creature dies, a [Hostile](3-Mechanics/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Slaad Tadpole](3-Mechanics/CLI/bestiary/aberration/slaad-tadpole-xmm.md) bursts from its innards in the same space.  
...
- **Warrior's Wrath.** The creature has Advantage on melee attack rolls against any [Bloodied](3-Mechanics/CLI/rules/conditions.md#Bloodied) creature.  
...
Winching a portcullis up or down requires the [Utilize](3-Mechanics/CLI/rules/actions.md#Utilize) action. If a creature can't reach the winch (usually because it's on the other side of the portcullis), lifting the portcullis requires the [Utilize](3-Mechanics/CLI/rules/actions.md#Utilize) action and a successful Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. The DC of the check depends on the type of portcullis, as shown in the Portcullises table.
...
Each creature in the [Sphere](3-Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) makes a DC 15 Dexterity saving throw, taking 17 (`5d6`) Piercing damage on a failed save or half as much damage on a successful one.
...
Whenever you would otherwise make a number of [D20 Tests](3-Mechanics/CLI/rules/variant-rules/d20-test-xphb.md) for identical monsters, the Mob Results table can help you determine the number of successful [D20 Tests](3-Mechanics/CLI/rules/variant-rules/d20-test-xphb.md) the monsters get without having to roll dice. Follow these steps:
...
Your judgment always outweighs these guidelines, and it's fine to err on the side of affecting more creatures. For example, if eight zombies are crowded around a Fighter when the Bard centers a [Shatter](3-Mechanics/CLI/spells/shatter-xphb.md) spell on the Fighter's space, the spell's area should definitely engulf all eight zombies, even though according to the table, a 10-foot-radius [Sphere](3-Mechanics/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) includes only three creatures.
...
- **Inhaled.** Poisonous powders and gases take effect when inhaled. Blowing the powder or releasing the gas subjects creatures in a 5-foot [Cube](3-Mechanics/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) to its effect. The resulting cloud dissipates immediately afterward. Holding one's breath is ineffective against inhaled poisons, as they affect nasal membranes, tear ducts, and other parts of the body.  
...
Some Charms can be used only once; others can be used a specific number of times before vanishing. If a Charm lets a character cast a spell, the character can do so without expending a spell slot or providing any spell components. Unless otherwise stated, the spell uses its normal casting time, range, and duration; if the spell requires [Concentration](3-Mechanics/CLI/rules/conditions.md#Concentration), the character must concentrate.
