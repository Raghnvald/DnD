...
> 
> You can also use [Heroic Inspiration](3-Mechanics/CLI/rules/variant-rules/heroic-inspiration-xphb.md) to reward roleplaying, immersion in the game, and heroism. Use it to incentivize the kind of behavior you want to see in your game, such as acting in character, taking risks, thinking strategically, cooperating well, or embracing the tropes of a particular genre. Make sure your use of [Heroic Inspiration](3-Mechanics/CLI/rules/variant-rules/heroic-inspiration-xphb.md) is aligned with the expectations you set out at the start of your game (see ""Ensuring Fun for All"" in "chapter 1").
...
- The monster starts its turn [Bloodied](3-Mechanics/CLI/rules/conditions.md#Bloodied) and more than half its allies are dead or have the [Incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) condition, while no one is dead or Incapacitated on the other side.  
- The monster starts its turn [Bloodied](3-Mechanics/CLI/rules/conditions.md#Bloodied) and has the [Frightened](3-Mechanics/CLI/rules/conditions.md#Frightened) condition.  
