...
**Challenge Rating.** The maximum [Challenge Rating](3-Mechanics/CLI/rules/variant-rules/challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
**Temporary Hit Points.** You gain a number of [Temporary Hit Points](3-Mechanics/CLI/rules/variant-rules/temporary-hit-points-xphb.md) equal to three times your Druid level.
