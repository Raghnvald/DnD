...
- ttrpg-cli/domain/knowledge-psa
- ttrpg-cli/subclass/cleric/knowledge-psa
aliases:
...
> </thead><tbody>
> <tr class="class-progression"><td class"level">1st</td><td class"pb">+2</td><td class"feature"><a href='#Knowledge Domain (PSA) (Level 1)' class='internal-link'>Knowledge Domain (PSA)</a></td></tr>
...
Kefnet's domain is identical to the [Knowledge domain in the Player's Handbook](3-Mechanics/CLI/classes/cleric-knowledge-domain.md).
