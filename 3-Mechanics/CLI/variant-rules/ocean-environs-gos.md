...
|-----------|-----------------------|
| 1 | `dice:2d10\|noform\|noparens\|avg` (`2d10`) [sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md) |
| 2 | 1 [giant octopus](/3-Mechanics/CLI/bestiary/beast/giant-octopus.md) |
| 3 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [chuuls](/3-Mechanics/CLI/bestiary/aberration/chuul.md) |
| 4 | 1 [sea hag](/3-Mechanics/CLI/bestiary/fey/sea-hag.md) and `dice:2d4\|noform\|noparens\|avg` (`2d4`) [merrow](/3-Mechanics/CLI/bestiary/monstrosity/merrow.md) |
| 5 | 1 [plesiosaurus](/3-Mechanics/CLI/bestiary/beast/plesiosaurus.md) |
| 6 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [swarms of quippers](/3-Mechanics/CLI/bestiary/beast/swarm-of-quippers.md) |
| 7 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [reef sharks](/3-Mechanics/CLI/bestiary/beast/reef-shark.md) |
...
![](/3-Mechanics/CLI/variant-rules/img/gos-096-za-06-ocean-environs-p203.webp#center)
...
When conjuration magic churns within a storm's heart, creatures of wind and rain emerge from distant realms to attack anything they encounter. The ship encounters `dice:1d3|noform|noparens|avg` (`1d3`) hostile [air elementals](/3-Mechanics/CLI/bestiary/elemental/air-elemental.md).
...
Ghosts howl and whirl in this storm's wind, while the remains of long-dead mariners stir in their watery graves. During the storm, `dice:1d4|noform|noparens|avg` (`1d4`) [specters](/3-Mechanics/CLI/bestiary/undead/specter.md), `dice:2d4|noform|noparens|avg` (`2d4`) [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul.md), and `dice:4d6|noform|noparens|avg` (`4d6`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie.md) emerge from the waves to attack the ship.
...
| dice: d10 | Creatures or Treasure |
|-----------|-----------------------|
| 1 | 1 [sahuagin priestess](/3-Mechanics/CLI/bestiary/humanoid/sahuagin-priestess.md) and `dice:2d10\|noform\|noparens\|avg` (`2d10`) [sahuagin](/3-Mechanics/CLI/bestiary/humanoid/sahuagin.md) |
| 2 | 1 [young bronze dragon](/3-Mechanics/CLI/bestiary/dragon/young-bronze-dragon.md) |
| 3 | `dice:4d10\|noform\|noparens\|avg` (`4d10`) [giant crabs](/3-Mechanics/CLI/bestiary/beast/giant-crab.md) |
| 4 | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [giant seahorses](/3-Mechanics/CLI/bestiary/beast/giant-sea-horse.md) |
| 5 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [hunter sharks](/3-Mechanics/CLI/bestiary/beast/hunter-shark.md) |
| 6 | 1 [giant octopus](/3-Mechanics/CLI/bestiary/beast/giant-octopus.md) |
| 7 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [merrow](/3-Mechanics/CLI/bestiary/monstrosity/merrow.md) |
| 8 | `dice:2d10\|noform\|noparens\|avg` (`2d10`) [merfolk](/3-Mechanics/CLI/bestiary/humanoid/merfolk.md) |
| 9 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) items from Magic Item Table B in chapter 7, ""Treasure"," of the "Dungeon Master's Guide" |
...
![](/3-Mechanics/CLI/variant-rules/img/gos-097-za-07-p206.webp#center)
