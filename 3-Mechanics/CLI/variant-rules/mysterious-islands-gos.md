...
These rules are used to generate islands with areas roughly `dice:1d6|noform|noparens|avg` (`1d6`) miles long and `dice:1d6|noform|noparens|avg` (`1d6`) miles wide. Most islands aren't perfect rectangles, and most coastlines aren't perfectly straight, so feel free to make areas of the island shorter, longer, thinner, or wider as you see fit.
...
| dice: d6 | Inhabitants |
|----------|-------------|
| 1 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker.md) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [tribal warriors](/3-Mechanics/CLI/bestiary/humanoid/tribal-warrior.md) |
| 2–3 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [cult fanatics](/3-Mechanics/CLI/bestiary/humanoid/cult-fanatic.md) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [cultists](/3-Mechanics/CLI/bestiary/humanoid/cultist.md) |
| 4 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [lizardfolk shamans](/3-Mechanics/CLI/bestiary/humanoid/lizardfolk-shaman.md) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [lizardfolk](/3-Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
| 5 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [bullywug croakers](/3-Mechanics/CLI/bestiary/humanoid/bullywug-croaker-gos.md) (see appendix C) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [bullywugs](/3-Mechanics/CLI/bestiary/humanoid/bullywug.md) |
| 6 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [locathah hunters](/3-Mechanics/CLI/bestiary/humanoid/locathah-hunter-gos.md) (see appendix C) and `dice:3d10\|noform\|noparens\|avg` (`3d10`) [locathah](/3-Mechanics/CLI/bestiary/humanoid/locathah-gos.md) (see appendix C) |
^alien-island-inhabitants
...
| dice: d6 | Curse |
|----------|-------|
| 1 | When a creature dies on the island, its spirit rises as a [specter](/3-Mechanics/CLI/bestiary/undead/specter.md) `dice:1d4\|noform\|noparens\|avg` (`1d4`) hours after death. The specter is obsessed with killing its former friends. |
...
| 3 | Each day at dawn, the island conjures `dice:2d10\|noform\|noparens\|avg` (`2d10`) [magma mephits](/3-Mechanics/CLI/bestiary/elemental/magma-mephit.md), which are hostile toward creatures that aren't inhabitants of the island. |
...
| dice: d6 | Inhabitants |
|----------|-------------|
| 1 | `dice:5d10\|noform\|noparens\|avg` (`5d10`) [specters](/3-Mechanics/CLI/bestiary/undead/specter.md) |
| 2 | `dice:10d10\|noform\|noparens\|avg` (`10d10`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie.md) |
| 3 | A coven of 3 [sea hags](/3-Mechanics/CLI/bestiary/fey/sea-hag.md) and `dice:1d4\|noform\|noparens\|avg` (`1d4`) [flameskulls](/3-Mechanics/CLI/bestiary/undead/flameskull.md) |
| 4 | 1 [medusa](/3-Mechanics/CLI/bestiary/monstrosity/medusa.md) and `dice:3d10\|noform\|noparens\|avg` (`3d10`) [skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton.md) |
| 5 | 1 [vampire](/3-Mechanics/CLI/bestiary/undead/vampire.md) and `dice:2d6\|noform\|noparens\|avg` (`2d6`) [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn.md) |
| 6 | 1 [demilich](/3-Mechanics/CLI/bestiary/undead/demilich.md) and `dice:2d10\|noform\|noparens\|avg` (`2d10`) [wraiths](/3-Mechanics/CLI/bestiary/undead/wraith.md) |
^cursed-island-inhabitants
...
| 3 | A keelboat carrying `dice:1d6\|noform\|noparens\|avg` (`1d6`) [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner.md) crashed on the island. The commoners are struggling to survive. |
...
| dice: d6 | Inhabitants |
|----------|-------------|
| 1 | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [winged kobolds](/3-Mechanics/CLI/bestiary/humanoid/winged-kobold.md) and `dice:10d10\|noform\|noparens\|avg` (`10d10`) [kobolds](/3-Mechanics/CLI/bestiary/humanoid/kobold.md) |
| 2 | 1 [goblin boss](/3-Mechanics/CLI/bestiary/humanoid/goblin-boss.md) and `dice:8d10\|noform\|noparens\|avg` (`8d10`) [goblins](/3-Mechanics/CLI/bestiary/humanoid/goblin.md) |
| 3 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker.md) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [tribal warriors](/3-Mechanics/CLI/bestiary/humanoid/tribal-warrior.md) |
| 4 | 1 [orc chieftain](/3-Mechanics/CLI/bestiary/humanoid/orc-war-chief.md), `dice:2d10\|noform\|noparens\|avg` (`2d10`) [orogs](/3-Mechanics/CLI/bestiary/humanoid/orog.md), and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [orcs](/3-Mechanics/CLI/bestiary/humanoid/orc.md) |
| 5 | `dice:4d10\|noform\|noparens\|avg` (`4d10`) [ogres](/3-Mechanics/CLI/bestiary/giant/ogre.md) |
| 6 | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [trolls](/3-Mechanics/CLI/bestiary/giant/troll.md) |
^hostile-inhabitants
...
| dice: d6 | Inhabitants |
|----------|-------------|
| 1 | `dice:5d10\|noform\|noparens\|avg` (`5d10`) [guards](/3-Mechanics/CLI/bestiary/humanoid/guard.md) and `dice:10d10\|noform\|noparens\|avg` (`10d10`) [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner.md) |
| 2 | 1 [pirate captain](/3-Mechanics/CLI/bestiary/humanoid/pirate-captain-gos.md) (see appendix C), 1 [pirate bosun](/3-Mechanics/CLI/bestiary/humanoid/pirate-bosun-gos.md) (see appendix C), `dice:2d4\|noform\|noparens\|avg` (`2d4`) [pirate deck wizards](/3-Mechanics/CLI/bestiary/humanoid/pirate-deck-wizard-gos.md) (see appendix C), and `dice:8d10\|noform\|noparens\|avg` (`8d10`) [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit.md) |
| 3 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [flesh golems](/3-Mechanics/CLI/bestiary/construct/flesh-golem.md), `dice:1d4\|noform\|noparens\|avg` (`1d4`) [priests](/3-Mechanics/CLI/bestiary/humanoid/priest.md), and `dice:2d10\|noform\|noparens\|avg` (`2d10`) [acolytes](/3-Mechanics/CLI/bestiary/humanoid/acolyte.md) |
| 4 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md), `dice:2d10\|noform\|noparens\|avg` (`2d10`) [scouts](/3-Mechanics/CLI/bestiary/humanoid/scout.md), `dice:4d10\|noform\|noparens\|avg` (`4d10`) [guards](/3-Mechanics/CLI/bestiary/humanoid/guard.md) |
| 5 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [stone golems](/3-Mechanics/CLI/bestiary/construct/stone-golem.md), `dice:1d4\|noform\|noparens\|avg` (`1d4`) [mages](/3-Mechanics/CLI/bestiary/humanoid/mage.md), and `dice:3d10\|noform\|noparens\|avg` (`3d10`) [guards](/3-Mechanics/CLI/bestiary/humanoid/guard.md) |
| 6 | 1 [shield guardian](/3-Mechanics/CLI/bestiary/construct/shield-guardian.md), `dice:2d4\|noform\|noparens\|avg` (`2d4`) [knights](/3-Mechanics/CLI/bestiary/humanoid/knight.md), `dice:2d6\|noform\|noparens\|avg` (`2d6`) [priests](/3-Mechanics/CLI/bestiary/humanoid/priest.md), and `dice:6d10\|noform\|noparens\|avg` (`6d10`) [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner.md) |
^sanctum-island-inhabitants
...
| dice: d6 | Leader |
|----------|--------|
| 1 | [Bard](/3-Mechanics/CLI/bestiary/humanoid/bard-vgm.md) (see appendix C) |
...
| dice: d6 | Inhabitants |
|----------|-------------|
| 1 | `dice:5d10\|noform\|noparens\|avg` (`5d10`) aarakocra |
| 2 | `dice:8d8\|noform\|noparens\|avg` (`8d8`) [pixies](/3-Mechanics/CLI/bestiary/fey/pixie.md) and `dice:8d8\|noform\|noparens\|avg` (`8d8`) [sprites](/3-Mechanics/CLI/bestiary/fey/sprite.md) |
| 3 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [lizardfolk shamans](/3-Mechanics/CLI/bestiary/humanoid/lizardfolk-shaman.md) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [lizardfolk](/3-Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
| 4 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [druids](/3-Mechanics/CLI/bestiary/humanoid/druid.md) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [tribal warriors](/3-Mechanics/CLI/bestiary/humanoid/tribal-warrior.md) |
| 5 | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [centaurs](/3-Mechanics/CLI/bestiary/monstrosity/centaur.md) |
| 6 | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [scouts](/3-Mechanics/CLI/bestiary/humanoid/scout.md) and `dice:5d10\|noform\|noparens\|avg` (`5d10`) [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner.md) |
^welcoming-island-inhabitants
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1 | `dice:2d8\|noform\|noparens\|avg` (`2d8`) baboons |
| 2 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [brown bears](/3-Mechanics/CLI/bestiary/beast/brown-bear.md) |
| 3 | 1 [owlbear](/3-Mechanics/CLI/bestiary/monstrosity/owlbear.md) |
| 4 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [giant toads](/3-Mechanics/CLI/bestiary/beast/giant-toad.md) |
| 5 | `dice:2d10\|noform\|noparens\|avg` (`2d10`) [giant wasps](/3-Mechanics/CLI/bestiary/beast/giant-wasp.md) |
| 6 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [giant spiders](/3-Mechanics/CLI/bestiary/beast/giant-spider.md) |
| 7 | `dice:4d4\|noform\|noparens\|avg` (`4d4`) [pixies](/3-Mechanics/CLI/bestiary/fey/pixie.md) or `dice:4d4\|noform\|noparens\|avg` (`4d4`) [sprites](/3-Mechanics/CLI/bestiary/fey/sprite.md) |
| 8 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [blink dogs](/3-Mechanics/CLI/bestiary/fey/blink-dog.md) |
| 9 | 1 [pirate captain](/3-Mechanics/CLI/bestiary/humanoid/pirate-captain-gos.md) (see appendix C) and `dice:3d10\|noform\|noparens\|avg` (`3d10`) [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit.md) digging up buried treasure |
| 10 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [tribal warriors](/3-Mechanics/CLI/bestiary/humanoid/tribal-warrior.md) |
| 11 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [druids](/3-Mechanics/CLI/bestiary/humanoid/druid.md) |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [dryads](/3-Mechanics/CLI/bestiary/fey/dryad.md) |
| 13 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [centaurs](/3-Mechanics/CLI/bestiary/monstrosity/centaur.md) |
| 14 | 1 [ankheg](/3-Mechanics/CLI/bestiary/monstrosity/ankheg.md) |
| 15 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [giant boars](/3-Mechanics/CLI/bestiary/beast/giant-boar.md) |
| 16 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [giant eagles](/3-Mechanics/CLI/bestiary/beast/giant-eagle.md) |
| 17 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [giant apes](/3-Mechanics/CLI/bestiary/beast/giant-ape.md) |
| 18 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [treants](/3-Mechanics/CLI/bestiary/plant/treant.md) |
| 19 | 1 [roc](/3-Mechanics/CLI/bestiary/monstrosity/roc.md) |
| 20 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [veteran](/3-Mechanics/CLI/bestiary/humanoid/veteran.md) explorers |
^wild-island-encounters
...
| 3 | [Pixies](/3-Mechanics/CLI/bestiary/fey/pixie.md) beg the characters to help them oust a group of `dice:3d10\|noform\|noparens\|avg` (`3d10`) trophy hunters ([scouts](/3-Mechanics/CLI/bestiary/humanoid/scout.md)) from the island. |
