...
After drinking [oloore tea](/3-Mechanics/CLI/items/oloore-root-teabag-tdcsr.md) as an action, you must succeed on a DC 19 Constitution saving throw or experience vivid hallucinations for `dice:1d4|noform|noparens|avg` (`1d4`) hours. During this time, you have disadvantage on attack rolls and ability checks. If you fail the saving throw by 10 or more, your hallucinations become horrific visions and you gain a level of [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion). On a success, you gain preternatural clarity, allowing you to cast the [scrying](/3-Mechanics/CLI/spells/scrying-xphb.md) spell once within the next `dice:1d4|noform|noparens|avg` (`1d4`) hours.
...
After slathering [zeal](/3-Mechanics/CLI/items/zeal-tdcsr.md) across your exposed skin as an action, you must make a DC 12 Constitution saving throw. On a failure, you become [paralyzed](/3-Mechanics/CLI/conditions.md#Paralyzed) for `dice:1d4|noform|noparens|avg` (`1d4`) rounds as your muscles lock up. On a success, your weapon attacks deal an additional `dice:1d6|noform|noparens|avg` (`1d6`) damage for the next minute. After this effect ends, you gain one level of [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion).
...
After burning [suude](/3-Mechanics/CLI/items/suude-tdcsr.md) within a vessel and inhaling its fumes as an action, you take `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) psychic damage and must make a DC 10 Constitution saving throw. On a failure, you become [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) for 1 hour and fall [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious) for 1 minute, or until you are shaken awake as an action. During this time, the world seems to move in slow motion, and your vision is twisted in kaleidoscopic colors—yet your focus is never distorted. If one dose of [suude](/3-Mechanics/CLI/items/suude-tdcsr.md), or more, is used within 1 hour of another, the DC of the Constitution saving throw is increased by 5 per additional dose. If you fail this save by 10 or more, you instantly drop to 0 hit points.
