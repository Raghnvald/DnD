...
- **Rune Magic.** You know a number of runes equal to half your proficiency bonus (rounded down), chosen from the Rune Spells table. Whenever you finish a long rest, you can inscribe each rune you know onto one nonmagical weapon, armor, piece of clothing, or other object you touch. You temporarily learn the 1st-level spells that correspond to the runes you inscribed, as specified on the Rune Spells table, and you know those spells until you finish a long rest, when the runes fade. While you are wearing or carrying any rune-marked object, you can cast the spells associated with those runes using any spell slots you have.  
    ...
    | Rune | Spell |  
    |------|-------|  
    | Cloud | [Fog cloud](/3-Mechanics/CLI/spells/fog-cloud-xphb.md) |  
    | Death | [Inflict wounds](/3-Mechanics/CLI/spells/inflict-wounds-xphb.md) |  
    | Dragon | [Chromatic orb](/3-Mechanics/CLI/spells/chromatic-orb-xphb.md) |  
    | Enemy | [Disguise self](/3-Mechanics/CLI/spells/disguise-self-xphb.md) |  
    | Fire | [Burning hands](/3-Mechanics/CLI/spells/burning-hands-xphb.md) |  
    | Friend | [Speak with animals](/3-Mechanics/CLI/spells/speak-with-animals-xphb.md) |  
    | Frost | [Armor of Agathys](/3-Mechanics/CLI/spells/armor-of-agathys-xphb.md) |  
    | Hill | [Goodberry](/3-Mechanics/CLI/spells/goodberry-xphb.md) |  
    | Journey | [Longstrider](/3-Mechanics/CLI/spells/longstrider-xphb.md) |  
    | King | [Command](/3-Mechanics/CLI/spells/command-xphb.md) |  
    | Mountain | [Entangle](/3-Mechanics/CLI/spells/entangle-xphb.md) |  
    | Stone | [Sanctuary](/3-Mechanics/CLI/spells/sanctuary-xphb.md) |  
    | Storm | [Thunderwave](/3-Mechanics/CLI/spells/thunderwave-xphb.md) |  
    ^rune-spell