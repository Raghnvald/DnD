...
The bats aren't harmless. They're not even bats; they're [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md). If the characters aren't, like, super well hidden, these non-bats notice them and attack immediately. Sounds like it's time to roll initiative!
...
Anyone who searches the room and succeeds on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check unearths 35 sp scattered around. Searching—whether the characters find anything or not—also makes their hands smell like stirge poo, which imposes disadvantage on their Charisma checks and Charisma saving throws until it's washed off.

### 2. Goblin Room

As the adventurers approach this room, have everyone make a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. Anyone who succeeds can hear two [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) talking in Goblin about how their friend Jerry is a useless jerk.
...
One of the goblins is wearing an eye patch. Her name is "Leg." The other goblin has a bad leg, and his name is "Eye." If the characters are sneaky, they might be able to surprise these losers. Otherwise, if the party attacks, these gobbo-slobbos fight back. But before they both die, at least one flees to their pals in area 5.
...
A careful search accompanied by a successful DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check reveals a hidden compartment in this statue that holds a scrap of paper. Inspecting the paper reveals a note written in Common:
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/010-intro-3.webp#center)
...
The four [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) are named Jerry, Jeri, Gerry, and Gerie. If Leg or Eye from area 2 fled here, all the goblins have grabbed their [scimitars](3-Mechanics/CLI/items/scimitar-xphb.md) and set up an ambush—but around the entrance opposite the one the party comes through. If Leg or Eye didn't make it here, the characters catch the goblins even more off guard.

If the adventurers are naked (most likely because of the mouth in area 4, but for any reason, really), the goblins have disadvantage on attack rolls in the first round of combat, as they giggle at the group's jiggly unmentionables.

#### G&G Nerds

At first glance, it might look like the goblins were gambling. But a successful DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check made to poke through the dice and parchments reveals that they were actually playing *Goblins & Gizzards* (G&G), their favorite tabletop roleplaying game, written in Goblin.
...
If the characters lost their clothes, armor, and other equipment when they failed to guess the wall-mouth's riddle in area 4 or flipped an unfortunate series of levers in area 31, this is where all their possessions ended up. If that happened, read this additional revelation:
...
If a character specifically asks to check for traps on and around the treasure chest, a successful DC 14 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check reveals a trap built into the chest's lid—and determines that the trap can't be disabled. If the chest is opened, the character opening it needs to make a DC 13 Dexterity saving throw as a screeching buzz-saw blade pops up out of the chest. On a failed save, the blade slices that character right in the gut for 7 (`2d6`) slashing damage.
...
Inside the chest is a glittery mound of treasure: 210 gp, 410 sp, 3 ep, two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), and a fake ruby that smells like fresh-baked cherry pie. The ruby has a permanent [prestidigitation](3-Mechanics/CLI/spells/prestidigitation-xphb.md) spell cast on it that creates the bakery scent. The jewel doesn't do anything else, but feel free to make it seem more important than it really is. That's the true path of Dungeon Mastery.

### 7. Third Goblin Room

As the party approaches this room, pick a character at random and demand a Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. If they get a 10 or higher, they hear voices arguing beyond the door in what sounds like Goblin. Because it is Goblin, and there are goblins in there.
...
All three of these little monsters (living and dead) have armor and weapons. Once they notice the characters, they drag them into the argument too. The two [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) speak only a little Common, so their speech is mostly Goblin chittering with Common words sprinkled in: "murder," "treasure," "a-hole," that kind of thing. Anyone who speaks Goblin understands that the two goblins are accusing each other of murdering the third. Classic.

#### Investigation Option

So your players are a bunch of spongy-spined Jerrys who want to play fantasy Sherlock Holmes instead of attacking? Fine. Let them try to interrogate the goblins and inspect the body. The goblins just chatter away angrily and blame each other for the murder. With a successful DC 10 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check, a character searching the body discovers coins scattered near its mouth. If they're gutsy enough to pry the dead gob's mouth open, they'll find it full of coins as well.

If these observations are pointed out to the living goblins, they both act shocked. A hearty and successful DC 10 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check reveals they're full of s***. A successful DC 12 Charisma ([Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation) or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check then pries a confession out of them.
...
The writer can also be persuaded to stop writing with three successful DC 15 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) checks. It doesn't matter how many checks the characters fail while they try to get the writer on their side. On the first success, the writer appears to hesitate before continuing to write, and the room shrinks a bit. The second success indicates more progress, and she looks almost won over. On the third success, the writer throws down her quill, declares that work-life balance is essential, and triumphantly exits the room, never to be seen again.
...
Magic orbs appear, buzzing around the room and flashing psychedelic patterns that freak people out. Each creature in the room must succeed on a DC 12 Wisdom saving throw or suffer the effect of a [spectator's](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) confusion eye ray.

##### Groovy Stirges Trap

A pipe descends from the ceiling, and `1d8` [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) fly out of it. The annoying creatures attack characters at random. Simultaneously, sick-ass beats fill the room. Any creature except the stirges that can hear the music must succeed on a DC 12 Wisdom saving throw or give in to the music and start dancing.
...
For `1d4` rounds, the whole floor heaves like when you're completely hammered. For as long as the floor pitches, each creature that starts its turn standing on the floor must succeed on a DC 18 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check or fall on its ass, [prone](3-Mechanics/CLI/rules/conditions.md#Prone).

##### Million Ants Trap

Five ants crawl out of cracks in the floor. Each round, a random character must succeed on a DC 12 Dexterity saving throw or accidentally crush one of these ants. If they do, 999,995 more ants come pouring up out of the floor, gathering into a massive, solid swarm that uses the [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) stat block and attacks.

##### Mocking Mouths Trap

Creepy mouths form on every surface of the room. They're jerks, and for `1d4` rounds, they berate random characters, choosing a new target at the start of each round. The mouths mock the size of the target's weapons, their spell selection, their dump stats, or whatever in-game, out-of-game, or metagame topic catches their middle-school-bully-like attention.
...
| dice: d4 | Effects |
|----------|---------|
| 1 | **Sleep**. The creature falls [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) for `1d4` rounds, as if under the effect of a [sleep](3-Mechanics/CLI/spells/sleep-xphb.md) spell. |
| 2 | **Retching**. The creature is [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) for `1d4` rounds. |
| 3 | **Laughter**. The creature is overcome by a fit of giggles (because farts are f***ing funny) and is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) for `1d4` rounds. |
| 4 | **Blindness**. Something spicy in that fart leaves the creature [blinded](3-Mechanics/CLI/rules/conditions.md#Blinded) for `1d4` rounds. |
^effects

##### Punch Trap

A [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) emerges from a trapdoor and punches a random character right in the groin. The character needs to dodge with a successful DC 15 Dexterity saving throw or take 2 (`1d4`) bludgeoning damage. The goblin attacks once and then disappears back through the trapdoor, which immediately vanishes to leave no opportunity for counterattacks.
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/011-intro-4.webp#center)

This room is hard to move through without touching at least one of the jars. Any Medium or larger creature that attempts to cross the pantry must succeed on a DC 15 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check or jostle a jar as it moves through the room. A creature that fails the check by 5 or more knocks a jar down, causing it to smash on the ground, shatter into a thousand vinegar-soaked pieces, and release its contents. See "Jostling Jars" below for the terrifying outcome.

#### Pickle Power

Most of the pickles in this room are [lycanthropickles](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) in hybrid form. These terrors use the [twig blight](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) stat block with the following adjusted ability:

##### False Appearance

While the [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) remains motionless, it is indistinguishable from a pickle.

Once free of its jar, a [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) grows pickle arms and pickle legs, and proceeds to chase and attack any nonpickles in the room. Characters who choose to battle the lycanthropickles must make additional Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) checks each round to avoid interacting with the jars, risking the release of more frenzied fruits. (Yeah, cucumbers are fruits—fight me.)

No more than six [lycanthropickles](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) can attack the characters at one time. If additional pickle jars are shattered while six [lycanthropickles](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) are at large, they release only slightly spicy but otherwise normal pickles.
...
Left to its own devices, the [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) in the jar sends the jar plummeting to the ground at the end of the next round. Upon doing so, the jar shatters, releasing the [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md). If a jar is knocked off the shelf with a really bad check, it automatically smashes to free the [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) within. Either way, the tiny terror immediately springs up and attacks the closest nonpickle.

This alerts `1d4` other [lycanthropickles](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md), which start head-butting their own jars, and which escape at the end of the following round unless thwarted. A character can use an action to pick up a jar with an agitated pickle and place it safely on the ground, preventing it from smashing.

> [!note] Curse of Lycanthropickling
> 
> A humanoid creature has a 20 percent chance to be afflicted with the curse of lycanthropickling after being wounded by a [lycanthropickles](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md). The curse lasts for 3 days. Each long rest the creature spends in a vat or jar of pickling brine prolongs the curse by 1 day.
> 
> A [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) can either resist its curse or embrace it. By resisting the curse, a [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) retains its normal alignment and personality while in humanoid form. It lives its boring life as it always has, burying deep its raging, murderous urges just like the rest of us.
> 
> Some individuals see little point in fighting the curse and accept what they are. They can assume pickle form or hybrid form at will. Most [lycanthropickles](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) that embrace their briny natures succumb to bloodlust, becoming evil, opportunistic creatures that prey on the weak. In hybrid form, a [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) has the same statistics as a [twig blight](3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) with the altered ability noted in area 9. In pickle form, a [lycanthropickle](3-Mechanics/CLI/bestiary/plant/lycanthropickle-rmbre.md) has no statistics and is indistinguishable from a pickle... because it's a pickle.
...
Each butt cheek is made of polished stone that gleams in any light. It takes a successful DC 12 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check to scramble up either cheek's baby-smooth surface to see what the shiny thing is.
...
The butt trap contains an extradimensional space full of stolen butts claimed by the trap. Some of the butts belong to the zombies in area 15, while others are tied to the Order of the Buttless in area 32. Some of them even look like they could be famous. Is that George Washington's butt? I'm not saying it is—butt I'm not saying it isn't.

The cache can be opened only by destroying the butt trap with a genius weapon called the churd cannon (see area 22). If the butt trap is destroyed, all the imprisoned butts within fly back to their owners like fleshy butterflies in a river of celestial light, and are automatically restored.
...
If anyone speaks Orc, a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check overhears one of the six [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) speak up to say, "Hurry it up, Grobblegob! We can't be late!"

The orcs then stand up and make their way to area 12—that is, unless the characters grab their attention. The orcs know this dungeon is crazy dangerous, so they defend themselves if attacked. However, they aren't otherwise inclined to fight as they hurry to area 12. Three of the orcs are armed with [greataxes](3-Mechanics/CLI/items/greataxe-xphb.md), but the other three carry only the large burlap sacks they have slung over their shoulders. Replace those orcs' [greataxe](3-Mechanics/CLI/items/greataxe-xphb.md) attack with the following attack:
...
A thick door made out of some sort of fantasy wood opens onto the hall leading to area 12. The door is locked but can be opened with the key that the orcs here are carrying (see "Treasure" below). The lock can also be picked with a successful DC 17 Dexterity check using [thieves' tools](3-Mechanics/CLI/items/thieves-tools-xphb.md), or the door can be kicked open with a successful DC 15 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check.
...
At least five adult [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) occupy this room, and as many as eleven if all the orcs from area 11 managed to make it home for supper.
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/012-intro-5.webp#center)

Remember, orcs are evil (whatever that means in a morally relativistic society), regardless of their healthy family relationships. Before the characters crashed the feast, the orcs were gathered around the table for a delicious meal of goblin meat. Lifting the cover of the silver platter at the center of the table reveals a bound and gagged (but still living) male [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md).
...
You can figure out how the characters can get Glizzlegus out of the pit. Even once that's done, though, she still needs medical assistance so that gigantic spike hole doesn't kill her. If magical healing isn't available, a successful DC 15 Wisdom ([Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check is required to suture her wounds. (If Beth is playing, encourage her not to use healing magic and give her advantage on the skill check.)

If she is healed, Gliz pretends to be nice until her sudden but inevitable betrayal. She doesn't know jack about the dungeon and wants all its treasure for herself. Any character who succeeds on a DC 10 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight)) check figures out she's Trouble with a capital T.
...
After the destruction of the tiny adventuring party, one of the miniature treasure chests pops open. Inside is an unbelievably tiny [wand of magic missiles](3-Mechanics/CLI/items/wand-of-magic-missiles-xdmg.md). It works normally, but a character has a 50 percent chance of losing it each time it is used or put away. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell can help find it again.
...
The figure tied to the chair is a [ghoul](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md), and the five [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) are accusing it of eating their butts, which it didn't. The butts in question were stolen by the butt trap in area 10, but the zombies have terrible memories.

![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/013-intro-6.webp#center)

Once any character makes their presence known, the [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) turn toward the party, and the [ghoul](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) in the chair calls out: "Help! I know I'm a ghoul, and this could easily be my thing, but it isn't! The zombies think I ate their butts, but I swear, I didn't! Help me, please!"
...
The characters can agree to help find the missing butts and return after they do. If they return to this room after the butt trap in area 10 is destroyed, the zombies' butts are restored. The ghoul has freed itself and fled, but the zombies present the room's treasure (see below) to the characters.
...
A small ring box is concealed beneath the cushion of the chair the ghoul was tied to, and can be found with a successful DC 13 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check. When the box is opened, it dissolves into dust... which then reforms into a [ring of protection](3-Mechanics/CLI/items/ring-of-protection-xdmg.md).
...
Once the characters find the exit door, they can walk through it into area 19. Once the characters leave the room, the light in the room goes out, all the extra doors disappear, and characters can now pass through this room without incident.
...
If the characters attempt to talk to the evil mage, he just gloats about his inability to be harmed. He can't be [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed), influenced, or reasoned with.
...
Any character who inspects the walls or floor and succeeds on a DC 12 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check notices that the patterns on the left wall make up huge runes representing the letters "R" and "A." The right wall contains an equally huge and equally hidden "U" and "N." Runes for "Y" and "G" are worked into the floor.
...
The phrase etched on the pedestal says "I'M MISTER [MEESEEKS](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) LOOK AT ME," but only a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) is able to read it.

#### Meeseeks to Be Helpful

![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/014-intro-7.webp#center)

The box is a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) box. Pressing the button on the top of the box summons—predictably—a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md). Every [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) appears in the same six-foot-tall, skinny blue humanoid form. Some have little tufts of orange hair on their heads. They use the [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) stat block but ignore hit points, since [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) are immune to damage.

Once materialized, these friendly entities exist solely to fulfill a purpose of your choosing. Pretty nifty, right? For example, you could tell a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) to read the phrase etched on the pedestal. Once it does that, the [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) vanishes, its purpose fulfilled.

Just a warning, though: if someone gives a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) a purpose it can't fulfill, or if a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) is prevented from fulfilling its purpose, it does go sort of insane, becoming hostile toward its summoner after `1d4` hours.

While the box is in the room, it can summon as many [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) as you like. It's also possible to take the box. If it's used outside the room, though, roll a `d20` and add the number of [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) that have already been summoned. If the total is higher than 20, the [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) box implodes and makes a sad whining sound, destroying it.

#### Roleplaying a Meeseeks

A word to the wise DM on this room: have fun with it. Think of yourself as the genie who takes your players' wishes extremely literally. Find ways to make a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) fulfill its purpose and vanish as quickly as you can. The goal isn't to *actually* make them turn against the party. If the players manage to stump you by giving a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) a purpose so carefully worded that even you can't figure out a way to subvert it, have that [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) summon another [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) to help out. This soon reveals itself to be a terrible cascading problem.

Generally, [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) are cheerful and eager to help, unless their existences last longer than a few hours. They're unwilling to fight and they're too stupid to solve puzzles. They'll cheer you on, though, even as they provide unhelpful pointers.

[Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) have a few distinct qualities you might employ for maximum immersion:

- Constantly speak in a screechy voice. This imposes disadvantage on any Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks the characters attempt while a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) is around.  
- Begin or end utterances with, "I'm Mister [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md), look at me!" or some variation thereof.  
- Talk about how a [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md) grows facial stubble as it gets closer to its homicidal break.  
...
The [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) is [Tommy Two-Butts](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md), a genius (adjust his Intelligence to 21) and a sworn enemy of the Order of the Buttless (see area 32). [Tommy](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md) has been hiding out here with his two [goblin](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) assistants, Greeble and Flerp, designing a weapon that can destroy the butt trap (see area 10). [Tommy](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md) has the design know-how to produce this weapon, called the churd cannon, but he doesn't have the magical knowledge to complete its design.

![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/015-intro-8.webp#center)

#### Churd Cannon

If the adventurers offer to help [Tommy](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md), he excitedly pulls them over to one of the tables, on which sit a bunch of incomprehensibly named parts and a long metal tube etched with magic symbols.

To help Tommy, a character must read his notes (taking 1 hour of study), then succeed on a DC 14 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check to determine the following facts:

- The flabulator (one of those incomprehensibly named parts) must be connected to the chronomiton (ditto). This requires the flabulator to be the target of a spell that causes a creature to regain hit points, such as [cure wounds](3-Mechanics/CLI/spells/cure-wounds-xphb.md). Drenching the flabulator in a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) also works.  
- The gleep-freeble mechanism must be calibrated by targeting it with a fire-based spell, such as the [fire bolt](3-Mechanics/CLI/spells/fire-bolt-xphb.md) cantrip.  
- The drockle-spreem tube needs to be carefully primed by being targeted by any ranged spell attack or the [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md) spell.  

Once these tasks are completed, the churd cannon is fully operational and has one charge.

#### Destroy the Butt Trap

With the churd cannon assembled, [Tommy](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md) asks the party to help him destroy the evil butt trap in area 10. Not only has the trap stolen countless butts, it's also brainwashed Tommy's friends, who joined the Order of the Buttless.
...
When the characters arrive at the butt room (area 10), there's a 75 percent chance that they encounter the Order of the Buttless there unless that group has been [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated) in some way (see area 32). The buttless have caught wind of [Tommy Two-Butts](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md)'s plan and intend to stop his blasphemy. The characters might well have to choose sides between [Tommy Two-Butts](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md) or the Buttless.

##### Firing the Churd Cannon

When a character fires the churd cannon in area 10, have the character's player roll a `d20`. On any roll other than a 1, the cannon destroys the Butt Trap in a blinding flash. See area 10 for details on what happens afterward.
...
If the butt trap in area 10 is destroyed, the buttless all regain their butts. They consider it a sign from their god and they rejoice, sure to mark this as a high holiday that they observe in perpetuity. [Tommy Two-Butts](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md) hails the party as heroes and reconnects with his former friends.

If the butt trap is not destroyed, the Order of the Buttless continue spreading their old-time religion, and [Tommy Two-Butts](3-Mechanics/CLI/bestiary/npc/tommy-two-butts-rmbre.md) goes back to the drawing board.
...
The [hobgoblin](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) continues to urge the characters to join her in the center of the spotlight. In Common, she bellows, "Welcome to the finest dungeon entertainment this side of the staircase that led you down into the dungeon: the Spawn Sword Ship Hour! Monsters love commercials, and this show is entirely that: commercials!" The crowd erupts into cheers. This sounds like a horrible premise for a show, to be honest, but monster life is probably pretty bleak.
...
- These monsters (twelve [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md), eight [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md), six [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), and five [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md)) are on break from guarding the dungeon, and they're unwinding by watching the show.  
...
The silent audience anticipates their commercial with bated breath. Each character is expected to contribute to the performance of this commercial by attempting a DC 14 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance) or [Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. If half or more of the group participates and succeeds on the check, the audience erupts into applause and appears genuinely impressed, pelting the group with coins. If half or more of the characters fail the check or don't attempt it, the characters are booed and pelted with monstrous detritus by the crowd—mostly goblin fingers, owlbear pellets, and orc snot.
...
This guy is Borkibok, and he's a [cultist](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md). If the characters give him a chance, he talks their ears off about midlife-crisis anxieties regarding choice, regret, broken dreams—you definitely know the script. Borkibok fell in with his cult twenty years ago, and he thinks now that he might have wasted his life.
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/016-intro-9.webp#center)

The goo is an [ochre jelly](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md), backed by five [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md). Once they notice the characters, they all attack. However, the cultists are still recovering from vomiting, so they're [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated). At the start of each of its turns, a cultist must succeed on a DC 12 Constitution saving throw or remain [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated).

If Borkibok is still alive, he attacks the party from behind. He's a cultist after all, and duping rubes is kind of his jam.

#### Turning a Blind Eye

If, instead of entering the room, the characters decide to walk away from Borkibok and his plight, the door bursts open, unleashing the [ochre jelly](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md)! The phlegmy mass pursues the party, indignant about being snubbed.

If Borkibok is still alive, he's so overcome with reverence for his goo god that he attacks the characters. The other five [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md) in the room follow the [ochre jelly](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) and join the fight after 2 rounds of combat.

#### Treasure

A half-empty cask sits on the balcony in the room, containing the oily, yellowish ipecac syrup that inspires the cultists to... make their offerings. A sticker portraying a green cartoon face smiles from the cask's side. There are ten full swigs of "medicine" remaining within. Anyone who drinks from the cask spends the next `1d4` rounds [prone](3-Mechanics/CLI/rules/conditions.md#Prone) and unable to stand as they heave up the contents of their stomachs. Why anyone would want to do this is beyond me, but if you're drinking the leftovers of a whole mob of ooze cultists, you sort of get what you deserve.
...
This room is illuminated only by dim light. The oily water fills the stream to a depth of 3 feet where it runs a winding course through this area. The stream is just wide enough to accommodate the [rowboat](3-Mechanics/CLI/items/rowboat-xphb.md).

#### Boat

The [rowboat](3-Mechanics/CLI/items/rowboat-xphb.md) is conveniently sized to fit the whole party. If the rope is unfastened, the boat floats down the dark, spooky stream at a rate of 10 feet per round. As the boat moves, the walls flash with bright images: a parrot, a doubloon, a treasure map! The dread is palpable.
...
The pirate captain is a nightmarishly well-programmed magical animatronic figure. [It's a Large object with](3-Mechanics/CLI/objects/captain-a-hole-rmbre.md) AC 17, 50 hit points, a speed of 0 feet, and immunity to poison and psychic damage. It has the following ability scores: Strength 14, Dexterity 10, Intelligence 3, Wisdom 3, and Charisma 1 (obviously). It has [blindsight](3-Mechanics/CLI/rules/senses.md#Blindsight) out to a range of 30 feet and is blind beyond this distance. As an action, the captain can make a ranged weapon attack (`+5` to hit, range 30 feet, one target) with the ship's fake (not really fake) cannon. On a hit, the cannon deals 3 (`1d6`) bludgeoning damage.

If the characters ask the animatronic pirate captain its name, it tells them, "[Captain A-Hole](3-Mechanics/CLI/objects/captain-a-hole-rmbre.md)" (emphasis on the A). After any other initial pleasantries or tea-and-crumpets crap, A-Hole rattles off its crappy riddle:
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/017-intro-10.webp#center)
...
If the characters tank the riddle and you get sick of waiting for the right answer, the construct captain shoots a cannon from the deck of its dumb ship and sinks the [rowboat](3-Mechanics/CLI/items/rowboat-xphb.md). Now the characters have to slog to the exit, and their pants and shoes are all wet.
...
The black thing tossed by the captain looks like a pocket extradimensional space called a [portable hole](3-Mechanics/CLI/items/portable-hole-xdmg.md)! It's not, though. It's just a crunchy fabric patch slathered with some newfangled ultra black paint—and it smells like pirate. Balled in it is 1 pp, though. The coin also smells like pirate, yet, somehow, that doesn't decrease the value.
...
A [flameskull](3-Mechanics/CLI/bestiary/undead/flameskull-xmm.md) is trapped in this room. The door here isn't locked—it's just very heavy, and the flameskull's a weak-ass floating skull. It has no hands, and the magic one it can conjure is pathetic. So the little guy's stuck.
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/018-intro-11.webp#center)

The flameskull wants out of this room. It can't open the door, but a character can open it with a successful DC 17 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. However, as soon as anyone enters the room, the heavy door slams shut behind them. Yeah! More slamming doors! It's still unlocked, but it's also still really heavy.

Once the door is open, the flameskull immediately casts [mage hand](3-Mechanics/CLI/spells/mage-hand-xphb.md), scoops up Andy the skull, and peaces out. As the skulls pass by the party, a glass vial drops out of Andy's empty eye socket. Anyone can try to catch it with a successful DC 15 Dexterity ([Acrobatics](3-Mechanics/CLI/rules/skills.md#Acrobatics)) check.

If nobody catches it, it smashes on the ground, and there goes your free potion (see "Treasure" below). If the characters leave the flameskull alone, it proceeds to the nearest room with goblins (probably area 20) and starts murdering everyone it can see. It's a flameskull. Evil is real in this world, and this fella's super evil.

#### Treasure

Andy was hiding a [potion of flying](3-Mechanics/CLI/items/potion-of-flying-xdmg.md) in his head because why not.
...
The monster, a [spectator](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md), doesn't attack. As soon as any of the characters tries to speak, rudely interrupt them with a telepathic communication from this budget beholder. It shouts directly into the minds of each of the characters in turn: "SHOW ME WHAT YOU GOT! I WANT TO SEE WHAT YOU GOT!"

Any further attempt to communicate with the [spectator](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) elicits the same message. It's here to see the show of a lifetime.

#### Get Schwifty

![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/019-intro-12.webp#center)
...
Anyway, half or more of the characters must succeed on a DC 15 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check, but they better be coordinated. None of that "I'll dance, you juggle, and Fantasy Carol can do card tricks" garbage. This ain't a middle school talent show.

If the group succeeds, the [spectator](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) grunts in approval and vanishes through a hole in the ceiling that promptly opens before it, promptly closes after it, and can't be found again. At the same time, a previously unseen trapdoor appears in the floor of the room. The trapdoor is unlocked and opens up to a small cubbyhole.

If the group fails to deliver dulcet tones and sick drops, the [spectator](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) tries to burn the sight of this hideous failure out of its multiple eyes. In other words, it attacks until destroyed.
...
Psych! It's a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md). It's *always* a mimic. As soon as a character moves within 5 feet of the pedestal, a big sticky purple tongue bursts out of the chest and it's go time.

This mimic has only 15 hit points when the fight starts, so it's not so bad. But wait! There's more!

#### Another Mimic

When the chest mimic is killed, the pedestal suddenly shoots an equally nasty tongue out of *its* mouth. Because—uh oh—it's a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md), too! This one has 18 hit points when the fight starts.

#### Ha Ha, Another Mimic

As the second mimic collapses in a heap and the characters think they're safe, wouldn't you know it! Part of the floor reveals itself to be another, [even bigger mimic](3-Mechanics/CLI/bestiary/monstrosity/large-mimic-rmbre.md)! This 10-foot-by-10-foot mimic appears beneath as many characters in the room as possible and gives them a big nasty lick across the toes. It has the statistics of a normal [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md), with these changes:
...
When the characters head back out of this room, ask everyone to make a Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check as they get close to the door—but don't explain why. There's no reason. It's just a door.

#### Treasure

Anyone brave enough to go fishing around in the mimic corpses finds two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md).
...
The four [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) were conveniently hidden in the flickering shadows. Or maybe they were [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible). Whatever. Sometimes you don't need the characters killing everything as soon as they see it.
...
The levers are made of fantasy metal. If some dweeb casts [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) on them, the levers radiate an aura of abjuration and conjuration.
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/020-intro-13.webp#center)

A number of regrettably pious creatures praise a divine derrière in this room, their congregation composed of two [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md), six [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md), and one [hobgoblin](3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md). The hobgoblin, Zorg, is the speaker for this group, known as the Order of the Buttless. These penitents have all lost their butts following ecstatic encounters with the butt trap in area 10.

When the characters make themselves known, Zorg takes great interest in them and the collective state of their butts.

#### A Party with Butts

If all the characters still have their butts, Zorg and the other buttless see this as an opportunity to introduce the party to a new reality free from butt bondage. They try to convince the characters to accompany them to the butt trap in area 10. Once there, the members of the order attempt to get the characters to trigger the trap.
...
A [nothic](3-Mechanics/CLI/bestiary/aberration/nothic-xmm.md) with a [concertina](3-Mechanics/CLI/items/concertina-rmbre.md) (a less charming kind of accordion) waits here, concealed behind an overturned torture chair. The creature has been drinking heavily and is already pretty wrecked. When the party interrupts its stupor by showing up, the unseen nothic plays a tune—something like, "Naaaa na na na na na na naaaa nana." I'm not Mozart, but you get the gist.

The [concertina](3-Mechanics/CLI/items/concertina-rmbre.md) is a rare magic item. In addition to knocking out a killer polka, a creature playing the concertina can use an action to cause an area of mist or water up to 30 feet in diameter and 6 inches deep to freeze solid. Once used, this feature of the concertina can't be used again until the next dawn.

At the end of the tune and before any characters move too close, the nothic uses the magic concertina to cause the mist on the floor to turn to solid ice. Any creatures touching the floor must succeed on a DC 20 Dexterity saving throw or be [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by the ice. (The nothic hops up at just the right time.) As an action, a character can attempt to free itself or another creature within its reach from the ice, doing so with a successful DC 20 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. A character freed from the ice is no longer [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) by it. The ice melts in an hour if everyone in the party turns out to be helpless baby birds.

#### The Weirdest Insights

After the mist freezes, the [nothic](3-Mechanics/CLI/bestiary/aberration/nothic-xmm.md) reveals itself. Lay down the following:
...
The tavern's patrons ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) are all either humanoids or alien-looking planar weirdos, huddling in varying states of shock and terror. Some stare off into space, others hide under tables, and some occupy makeshift forts. There are fifteen patrons here, ten of whom won't participate in any scuffles that break out, as they're too old, too young, or too catatonic.
...
[Billy Beaver](3-Mechanics/CLI/bestiary/npc/billy-beaver-rmbre.md) ([owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md)) is a goofy, owlbear-sized beaver with a raccoon-skin cap, playing a washboard and spoons. He has 34 hit points and has neither the Multiattack nor Claws action option.

[Buster the Bear](3-Mechanics/CLI/bestiary/npc/buster-the-bear-rmbre.md) ([bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md)) is a lovable, roly-poly teddy bear with a plaid shirt, torn jeans, and a banjo. Replace Buster's action options with the Bashin' Banjo action option described below.

##### Bashin' Banjo

*Melee Weapon Attack:* `+4` to hit, reach 5 ft., one target. *Hit*: 6 (`1d8 + 2`) bludgeoning damage.

[Layla the Lizard](3-Mechanics/CLI/bestiary/npc/layla-the-lizard-rmbre.md) ([ghoul](3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md)) has blue overalls, a guitar, and a straw hat. Layla's claws do not cause paralysis.

[Piggy Wiggle Butt](3-Mechanics/CLI/bestiary/npc/piggy-wiggle-butt-rmbre.md) ([orc](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)) is an anthropomorphic pig with no pants and no butt. (Nothing to do with any of the other buttless creatures in the dungeon. Total coincidence.) She plays a clay jug and dances. Replace Piggy Wiggle's action options with the Clay Jug action option described below.

##### Clay Jug

*Melee Weapon Attack:* `+5` to hit, reach 5 ft., one target. *Hit*: 7 (`1d8 + 3`) bludgeoning damage.

[Thomas T. Toad](3-Mechanics/CLI/bestiary/npc/thomas-t-toad-rmbre.md) ([ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md)) is a hulking, anthropomorphic toad wearing a tuxedo and spats. Thomas sings a throaty song about the moon falling in love with its reflection on a lake. Replace Thomas's action options with the Webby Hands action option described below.
...
| dice: d4 | Treasure |
|----------|----------|
| 1 | A crown constructed entirely out of multicolored gemstones, worth 800 gp. The crown functions as [winged boots](3-Mechanics/CLI/items/winged-boots-xdmg.md), except that when its wearer is flying, they feel as though they're being tugged by the head. |
| 2 | A tiara carved out of one giant sapphire, worth 900 gp. The wearer can cast the [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) spell (save DC 12) from the tiara. Once used, this feature can't be used again until the next dawn. |
...
As soon as the characters try to leave this room (whether they've taken any treasure or not), three 4-foot-tall orange people ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) burst through the door the characters were about to exit through, slam the door behind them, and attack. Why? Because they assume the characters are ripe for looting! The attackers drop even more gold that they've previously stolen from other hapless adventurers in the dungeon—1,000 gp each!
...
The five [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) in this room don't attack—because they're fun skeletons. Once the characters move closer, it's clear the skeletons are crowded around a xylophone made of bones—a xylobone! The skeletons can't play it, though, because each of them already has an instrument.

#### Bone Jam Session

Once a character picks up the xylobone mallets, the skeletons run to other nearby bone instruments: two guitars, a drum set, an upright bass, and a saxobone. The skeletons beckon to the other characters, encouraging them to play other instruments. Once everyone is in place, the bone jam session begins! Have each character playing an instrument make a DC 15 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check. If all the characters succeed, the jam session sounds amazing! If any of the characters fail, one of the skeletons comes over to wordlessly give advice on how to play better. Have that character make the check again. If they succeed, the skeleton rejoices. If they fail again, the skeleton gently takes the instrument, exchanging it for something the character can't f*** up—like bone maracas or a skull toot-jug.

#### Treasure

After everyone's done jamming, one of the skeletons approaches the character who had the highest Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check. Roll on the Bone Gifts table to see what instrument the skeleton grants the character. This gift functions as a regular instrument.
...
> [!readaloud] 
> 
> This odoriferous room is overflowing with piles of hay, long branches, and dozens of bones picked clean of meat. Feathers have formed downy beds where they've drifted into the dim corners of the room. A particularly large pile of hay emits the snuffling sound heard before.
^0f9

Once the characters move close enough to investigate the noises coming from the pile of hay, an enormous face emerges. It looks as though it belongs to a barn owl the size of a draft horse, so of course it's actually an [owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md). The head tilts to view the characters, then swivels over an impossibly wide arc from side to side. It slowly extracts itself from its pile of hay, revealing the rest of its snowy-white ursine body. A ruff of iridescent feathers marks it as a particularly majestic female. She snuffles the air in the characters' direction and gives a warm grunt.
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/022-intro-15.webp#center)
...
Once this is complete, the owlbear falls asleep contentedly in her nest. A successful DC 10 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check allows each character to escape through the exit without waking her up. If a character fails the check, the sleeping owlbear rolls over and traps the character under her considerable weight. A successful DC 15 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check is required to escape.
...
It isn't easy to search for treasure while the owlbear is awake. If the owlbear is distracted, a character who rolls a successful DC 14 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check turns up a [ring of protection](3-Mechanics/CLI/items/ring-of-protection-xdmg.md) and two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) concealed amid the bones scattered around the room.
...
Any character who succeeds on a DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check made to study the walls or floor realizes that the green stones take the shape of a green dragon, its wings climbing the walls and its torso tiled on the ground.
...
The table and the object on it aren't trapped, but a successful DC 15 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check reveals that wasn't always the case. The remains of a disabled pressure plate reveal a mechanism that would have released a boulder from the ceiling, obliterating anyone inside the room. Real original, Rick.
...
![](3-Mechanics/CLI/adventures/the-lost-dungeon-of-rickedness-big-rick-energy/img/023-intro-16.webp#center)

The green stones around the characters begin to shake, ripping themselves out of the floor and walls. Each creature in the room must succeed on a DC 13 Dexterity saving throw or be knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone). The stones regroup themselves into the form of a snarling [young green dragon](3-Mechanics/CLI/bestiary/dragon/young-green-dragon-xmm.md). It's initiative time, b**ches. Curiously, if Jerry is playing, his character is completely immune to the dragon's attacks.

#### Rousing Rick

As the stones fly up from the floor, they reveal a 20-foot-deep pit with a humanoid lying at the bottom. A successful DC 10 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check allows a character to recognize the form as Rick Sanchez himself, dressed in wizardly garb and clearly [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious).
...
Once Rick is conscious, the dragon focuses its attacks on him. Rick has AC 17 and 138 hit points. He automatically takes half damage from the dragon's attacks even without making saving throws. On each of his turns, Rick casts [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) or [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md). He'll be doing the heavy lifting for a few rounds, is what I'm saying.
