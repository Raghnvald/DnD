...
Some creatures, such as the [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md), can have any alignment. In other words, you choose the creature's alignment. Depending on the creature, its alignment entry might indicate a tendency or aversion toward law, chaos, good, or evil.
...
Skills in a creature's stat block are shown with the total modifier—the creature's ability modifier plus its proficiency bonus. If a creature's stat block says "Stealth +6," roll a `d20` and add 6 when the creature makes an ability check using [Stealth](3-Mechanics/CLI/rules/skills.md#Stealth).
...
A creature with [truesight](3-Mechanics/CLI/rules/senses.md#Truesight) can see in normal and magic darkness, see [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) creatures and objects, automatically detect visual illusions and succeed on saving throws against them, and perceive the original form of a shapechanger or a creature that is transformed by magic. Furthermore, the creature can see into the Ethereal Plane.
...
- [Meeseeks](3-Mechanics/CLI/bestiary/humanoid/meeseeks-rmbre.md)  
- [Piggy Wiggle Butt](3-Mechanics/CLI/bestiary/npc/piggy-wiggle-butt-rmbre.md)  
- [Thomas T. Toad](3-Mechanics/CLI/bestiary/npc/thomas-t-toad-rmbre.md)