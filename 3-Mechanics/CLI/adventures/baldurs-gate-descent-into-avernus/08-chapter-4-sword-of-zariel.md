...
If a character kills a guard, [Lulu](3-Mechanics/CLI/bestiary/npc/lulu-bgdia.md)'s mind attempts to punish the character. That character must succeed on a DC 15 Wisdom saving throw or gain 1 level of exhaustion as [Lulu](3-Mechanics/CLI/bestiary/npc/lulu-bgdia.md)'s mind saps the character's energy.
...
![Left to right: Charge of Zariel and the Hellriders, the war on Avernus, and Zariel's surrender to Asmodeus](3-Mechanics/CLI/adventures/baldurs-gate-descent-into-avernus/img/099-ivhcv-04-04.webp#center)
...
![Left to right: Haruman emerging from the Styx, Olanthius transformed into a death knight, and both by Zariel's side](3-Mechanics/CLI/adventures/baldurs-gate-descent-into-avernus/img/100-rkst9-04-05.webp#center)
