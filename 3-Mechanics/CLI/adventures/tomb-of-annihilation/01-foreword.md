...
|-----------|--------------------|-------------|
| [Acererak](3-Mechanics/CLI/bestiary/npc/acererak-toa.md) | ah-SAIR-ak | Archlich and evil creator of the Soulmonger |
| [Artus Cimber](3-Mechanics/CLI/bestiary/npc/artus-cimber-toa.md) | AR-tus SIM-ber | Human explorer wearing the Ring of Winter |
| [Asharra](3-Mechanics/CLI/bestiary/npc/asharra-toa.md) | ah-SHAR-ah | Aarakocra elder at Kir Sabal |
| [Azaka Stormfang](3-Mechanics/CLI/bestiary/npc/azaka-stormfang-toa.md) | ah-ZAH-kah | Weretiger guide in Port Nyanzaru |
| [Bag of Nails](3-Mechanics/CLI/bestiary/npc/bag-of-nails-toa.md) | — | Unhinged tabaxi hunter in Omu |
| [Dragonbait](3-Mechanics/CLI/bestiary/npc/dragonbait-toa.md) | — | Saurial paladin aiding Artus Cimber |
| [Drufi](3-Mechanics/CLI/bestiary/npc/drufi-toa.md) | DROO-fee | Frost giant searching for the Ring of Winter |
| [Ekene-Afa](3-Mechanics/CLI/bestiary/npc/ekene-afa-toa.md) | eh-KEE-nee AH-fah | Merchant prince in Port Nyanzaru (sells weapons, shields, canoes, rain catchers, and traveling gear) |
| [Eku](3-Mechanics/CLI/bestiary/npc/eku-toa.md) | EE-koo | Disguised couatl guide in Port Nyanzaru |
| [Elok Jaharwon](3-Mechanics/CLI/bestiary/npc/elok-jaharwon-toa.md) | EE-lok jah-HAR-wahn | Wereboar pirate captain of the Dragonfang |
| [Faroul](3-Mechanics/CLI/bestiary/npc/faroul-toa.md) | fah-ROOL | Human guide in Port Nyanzaru |
| [Fenthaza](3-Mechanics/CLI/bestiary/npc/fenthaza-toa.md) | fen-THAH-zah | Yuan-ti nightmare speaker in Omu |
| [Flask of Wine](3-Mechanics/CLI/bestiary/npc/flask-of-wine-toa.md) | — | Tabaxi guide in Port Nyanzaru |
| [Gondolo](3-Mechanics/CLI/bestiary/npc/gondolo-toa.md) | GON-doh-loh | Halfling guide in Port Nyanzaru |
| [Grabstab](3-Mechanics/CLI/bestiary/npc/grabstab-toa.md) | — | Queen of the Biting Ant goblin tribe and ruler of Yellyark |
| [Grandfather Zitembe](3-Mechanics/CLI/bestiary/npc/grandfather-zitembe-toa.md) | zeh-TEM-bay | Priest at the Temple of Savras in Port Nyanzaru |
| [Hew Hackinstone](3-Mechanics/CLI/bestiary/npc/hew-hackinstone-toa.md) | — | Shield dwarf guide in Port Nyanzaru |
| [Ifan Talro'a](3-Mechanics/CLI/bestiary/npc/ifan-talroa-toa.md) | EE-fawn tal-ROH-ah | Merchant prince in Port Nyanzaru (sells beasts) |
| [Jessamine](3-Mechanics/CLI/bestiary/npc/jessamine-toa.md) | JESS-ah-meen | Merchant prince in Port Nyanzaru (sells plants, poisons, and assassinations) |
| [Jobal](3-Mechanics/CLI/bestiary/npc/jobal-toa.md) | joh-BAWL | Merchant prince in Port Nyanzaru (hired out guides and mercenaries) |
| [Kupalué](3-Mechanics/CLI/bestiary/npc/kupalue-toa.md) | koo-pah-LOO-ay | Qawasha's vegepygmy companion |
| [Kwayothé](3-Mechanics/CLI/bestiary/npc/kwayothe-toa.md) | kway-OH-thay | Merchant prince in Port Nyanzaru (sells fruit, wine, oil, perfume, tej, and insect repellent) |
| [Laskilar](3-Mechanics/CLI/bestiary/npc/laskilar-toa.md) | LASS-kill-ar | Human pirate captain of the Stirge |
| [Liara Portyr](3-Mechanics/CLI/bestiary/npc/liara-portyr-toa.md) | lee-AR-ah por-TEER | Commander of Fort Beluarian |
| [Musharib](3-Mechanics/CLI/bestiary/npc/musharib-toa.md) | moo-shah-REEB | Albino dwarf guide in Port Nyanzaru |
| [Mwaxanaré](3-Mechanics/CLI/bestiary/npc/mwaxanare-toa.md) | muh-WOX-eh-nah-ray | Chultan princess living in Kir Sabal |
| [Na](3-Mechanics/CLI/bestiary/npc/na-toa.md) | NAH | Chultan prince and Mwaxanaré's baby brother |
| [Nanny Pu'pu](3-Mechanics/CLI/bestiary/npc/nanny-pupu-toa.md) | POO-poo | Green hag living in the village of Mbala |
| [Niles Breakbone](3-Mechanics/CLI/bestiary/npc/niles-breakbone-toa.md) | — | Commander of Camp Vengeance and Order of the Gauntlet member |
| [Ortimay](3-Mechanics/CLI/bestiary/npc/ortimay-swift-and-dark-toa.md) | OR-teh-may | Gnome captain of the Brazen Pegasus |
| [Orvex Ocrammas](3-Mechanics/CLI/bestiary/npc/orvex-ocrammas-toa.md) | OR-vex oh-KRAW-mus | Scribe working for the Red Wizards |
| [Qawasha](3-Mechanics/CLI/bestiary/npc/qawasha-toa.md) | kah-WASH-ah | Chultan druid guide in Fort Beluarian |
| [Ras Nsi](3-Mechanics/CLI/bestiary/npc/ras-nsi-toa.md) | RAZ nuh-SEE | Yuan-ti necromancer and warlord |
| [River Mist](3-Mechanics/CLI/bestiary/npc/river-mist-toa.md) | — | Tabaxi guide in Port Nyanzaru |
| Saja N'baza | SAWJ-ah nuh-BAH-zah | Guardian naga of Orolunga |
| [Salida](3-Mechanics/CLI/bestiary/npc/salida-toa.md) | sah-LEE-dah | Yuan-ti guide in Port Nyanzaru |
| [Shago](3-Mechanics/CLI/bestiary/npc/shago-toa.md) | SHAW-go | Human gladiator and guide in Fort Beluarian |
| [Syndra Silvane](3-Mechanics/CLI/bestiary/npc/syndra-silvane-toa.md) | SIN-draw sil-VAIN | Human archmage stricken by the death curse |
| [Valindra Shadowmantle](3-Mechanics/CLI/bestiary/npc/valindra-shadowmantle-toa.md) | vah-LIN-draw | Elf lich working for Szass Tam of Thay |
| [Volothamp "Volo" Geddarm](3-Mechanics/CLI/bestiary/npc/volothamp-volo-geddarm-toa.md) | VOH-loh-thamp geh-DARM | Famous human explorer on a book tour |
| [Wakanga O'tamu](3-Mechanics/CLI/bestiary/npc/wakanga-otamu-toa.md) | wah-KANG-gah oh-TAH-moo | Merchant prince in Port Nyanzaru (sells magic and lore) |
| [Withers](3-Mechanics/CLI/bestiary/npc/withers-toa.md) | — | Spellcasting wight working for Acererak |
| [Xandala](3-Mechanics/CLI/bestiary/npc/xandala-toa.md) | zon-DAH-lah | Half-elf sorcerer seeking the Ring of Winter |
| [Yorb](3-Mechanics/CLI/bestiary/npc/yorb-toa.md) | — | Grung chief in Omu |
| [Zalkoré](3-Mechanics/CLI/bestiary/npc/zalkore-toa.md) | zawl-KOR-ay | Medusa queen of Nangalore |
| [Zaroum Al-Saryak](3-Mechanics/CLI/bestiary/npc/zaroum-al-saryak-toa.md) | zah-ROOM al-SAR-yak | Human pirate captain of the Emerald Eye |
| [Zhanthi](3-Mechanics/CLI/bestiary/npc/zhanthi-toa.md) | JOHN-thee | Merchant prince in Port Nyanzaru (sells gems, jewelry, cloth, and armor) |
| [Zindar](3-Mechanics/CLI/bestiary/npc/zindar-toa.md) | ZIN-dar | Half-gold dragon harbormaster of Port Nyanzaru |
^major-npc-name-pronunciation-description
...
- Any spell that breathes life into the dead (including [revivify](3-Mechanics/CLI/spells/revivify-xphb.md), [raise dead](3-Mechanics/CLI/spells/raise-dead-xphb.md), [resurrection](3-Mechanics/CLI/spells/resurrection-xphb.md), and [true resurrection](3-Mechanics/CLI/spells/true-resurrection-xphb.md)) automatically fails if cast on a humanoid whose soul is either trapped in the Soulmonger or has been devoured by the atropal (see "Soul Devouring" below).  
- The Soulmonger does not affect the workings of [speak with dead](3-Mechanics/CLI/spells/speak-with-dead-xphb.md) spells or similar magic. The death curse has no effect on preexisting ghosts or spirits.  
...
Spells such as [commune](3-Mechanics/CLI/spells/commune-xphb.md) and [divination](3-Mechanics/CLI/spells/divination-xphb.md) can be used to determine whether a soul has been devoured or whether it's still trapped in the Soulmonger.
...
The masked speaker is [Syndra Silvane](3-Mechanics/CLI/bestiary/npc/syndra-silvane-toa.md). She is a Tethyrian human [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md), with these changes:
