...
![The spelljamming ship Lambent Zenith was carrying a piece of the rod before the ship crashed in the Astral Sea](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/046-03-001-the-lambent-zenith.webp#center)
...
![The Astral Sea is home to many terrifying predators, including star anglers](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/047-03-002-star-anglers.webp#center)
...
With its navy-blue hull and golden gossamer sails, the spelljamming galleon *Lambent Zenith* once cut an elegant silhouette through the Astral Sea's silver clouds. Its captain, the deva [Inda Malayuri](3-Mechanics/CLI/bestiary/npc/inda-malayuri-veor.md), was an arcanist and emissary tasked with guiding the lost and bringing peace to tumultuous worlds. During a voyage, Inda uncovered a piece of the [Rod of Seven Parts](3-Mechanics/CLI/items/rod-of-seven-parts-veor.md).
...
The security wards are powered by two magical runes: one in area Z8 and one in area Z13. The runes are invisible. If a creature can see invisible objects, each rune looks like a stylized carving of a crescent moon pulsing with silver light. Casting [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) (DC 17) on a rune destroys it. A rune can also be deactivated if a creature within 5 feet of it says, "The moon sings a song for the lost."
...
| 5–6 | One [cloaker](3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) |
| 7–10 | No encounter |
^random-wreck-encounters
...
A [death slaad](3-Mechanics/CLI/bestiary/aberration/death-slaad-xmm.md) recently infiltrated the camp, sowing chaos and magically manipulating Figaro's mind. This drove Figaro into a paranoid state, causing him to lock himself in his quarters, where one of the safe room's ward runes is located.
...
Two lawful neutral [githyanki knights](3-Mechanics/CLI/bestiary/aberration/githyanki-knight-xmm.md) named Lysan and Zastra, who served as bosuns on the *Lambent Zenith*, keep watch here. Characters who want to avoid the githyanki must succeed on a DC 15 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check. The knights notice characters who fail the check, beckoning them to approach and state their business.
...
Ilren appears as a boisterous giff—a bulky individual with a head similar to that of a hippopotamus—wearing a sleek red coat. But Ilren is a disguised [death slaad](3-Mechanics/CLI/bestiary/aberration/death-slaad-xmm.md) who can cast the spell [Modify Memory](3-Mechanics/CLI/spells/modify-memory-xphb.md) (spell save DC 15) once per day. Ilren is the reason the camp suffers Aberration attacks; the death slaad sneakily directs monsters toward the wreck's survivors and revels in the victims' suffering. Ilren also magically modified Figaro's memories and usurped power in the camp.
...
![Lysan and Zastra are wary of strangers but glad for friendly company](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/051-03-003-lysan-and-zastra.webp#center)
...
Five lawful good sailors from the Upper Planes (use the [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) stat block, but the sailors are Celestials instead of Humanoids) are lounging here. The sailors are indifferent to the characters but jump into combat to protect themselves and their fellows.
...
The elf is Daveras, a neutral [druid](3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md). Daveras joined the camp after his lifeboat crashed into Havock. The remains of his lifeboat rest on the starboard segment.
...
- **Personal History.** Daveras wasn't part of the Lambent Zenith's crew. When his spelljamming ship, the Verdant Branch, was attacked by space pirates, he escaped on a lifeboat with his best friend, a [blink dog](3-Mechanics/CLI/bestiary/fey/blink-dog-xmm.md) named Ikasa, as well as a treant named Redbud, who had grown into the lifeboat's hull. The lifeboat crashed into a different segment of the wreck, and Daveras outran the raiders to get to the camp on the stern segment. He believes no one else survived.  
...
The port door is locked and leads to a guest stateroom that now serves as Figaro's living quarters. Due to his paranoid state, Figaro uses a [Cube of Force](3-Mechanics/CLI/items/cube-of-force-xdmg.md) to deter any living matter from entering his room.
...
![The Lambent Zenith's first mate, Figaro, is experiencing the effects of a Modify Memory spell](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/054-03-004-figaro.webp#center)
...
The shouting is coming from a [couatl](3-Mechanics/CLI/bestiary/celestial/couatl-xmm.md) named Cirit, currently in the form of a halfling [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md). Cirit was one of the *Lambent Zenith*'s crew members and was present when Ilren infiltrated the survivors' camp.

Cirit saw Ilren's true aberrant form. But when Cirit confronted Ilren about the deception, the death slaad overpowered her. Believing Cirit to be an ordinary halfling spellcaster, Ilren hoped to use her to create a [green slaad](3-Mechanics/CLI/bestiary/aberration/green-slaad-xmm.md) and locked her in the brig instead of killing her. Cirit has been trying to escape since.
...
- **Ilren's Aberrant Nature.** Cirit saw through Ilren's disguise. She identifies Ilren as a [death slaad](3-Mechanics/CLI/bestiary/aberration/death-slaad-xmm.md), an Aberration that relishes the suffering of others.  
...
The tree atop the crashed lifeboat is a treant named Redbud (use the [treant](3-Mechanics/CLI/bestiary/plant/treant-xmm.md) stat block, but Redbud's movement speed is 0 feet) that joined the crew and grew into the lifeboat to strengthen its hull. The treant nearly died when the boat crashed, but Redbud survived by sending roots into the *Lambent Zenith*'s wreck to feed off Havock. Redbud's main purpose now is protecting the blink dog Ikasa (found in area Z11), who remains trapped aboard the lifeboat.
...
![A treant named Redbud lives in a lifeboat that crashed into the Lambent Zenith](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/056-03-005-redbud.webp#center)
...
Six [grells](3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) have made their home here, feeding off hapless raiders looking to pillage this wreck segment. The grells are hostile toward all other creatures.
...
Ikasa the [blink dog](3-Mechanics/CLI/bestiary/fey/blink-dog-xmm.md) is outfitted with a magical collar that allows him to speak Common. Afraid to use his teleportation ability due to the wreck's warped magic, Ikasa remained in the lifeboat, protected by Redbud.
...
![Captain Inda Malayuri survived the crash of the Lambent Zenith but now must fix her prosthetic wing](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/057-03-006-captain-inda-malayuri.webp#center)
...
The one-winged woman is the captain of the *Lambent Zenith*, [Inda Malayuri](3-Mechanics/CLI/bestiary/npc/inda-malayuri-veor.md). Inda uses the [deva](3-Mechanics/CLI/bestiary/celestial/deva-xmm.md) stat block, except she has a flying speed of 0 feet.
...
If the characters have no way to see the invisible ward runes, Inda lends the party a [Lantern of Revealing](3-Mechanics/CLI/items/lantern-of-revealing-xdmg.md).

##### Treasure

Inda has a [Flame Tongue shortsword](3-Mechanics/CLI/items/flame-tongue-xdmg.md) and a [Ring of Evasion](3-Mechanics/CLI/items/ring-of-evasion-xdmg.md) on her bedside table next to the [Lantern of Revealing](3-Mechanics/CLI/items/lantern-of-revealing-xdmg.md). If asked, Inda is reluctant to give away the shortsword or ring but can be convinced with a successful DC 22 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check. Inda has a key to the strongbox in area Z13 and knows where the secret compartment holding a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Flame Strike](3-Mechanics/CLI/spells/flame-strike-xphb.md) is in area Z17; she mentions these to the characters if they help her with her prosthetic wing in area Z16 or help her reach her crew in the stern segment.
...
A character who examines the captain's chair and succeeds on a DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check finds a secret compartment in the right armrest. The compartment holds a bronze tube containing a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Flame Strike](3-Mechanics/CLI/spells/flame-strike-xphb.md).
...
The door to the safe room is sealed by the ship's emergency security wards (see the "Accessing the Rod Piece" section earlier in this chapter). Inspecting the safe room via a [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or a similar effect reveals a strong aura of abjuration magic, as well as two tethers stretching toward the stern segment and the starboard segment, respectively. These tethers indicate the links between the wards and the runes in these respective locations.
...
![Deep in the heart of Havock lurks a creature called a hertilod, which has swallowed a piece of the Rod of Seven Parts](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/060-03-007-hertilod.webp#center)
