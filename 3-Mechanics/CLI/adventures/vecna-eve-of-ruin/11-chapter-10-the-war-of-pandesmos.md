...
![Kas has fled Sigil, intent on using the Rod of Seven Parts to free Miska, his ally against Vecna](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/141-10-001-miska-freed.webp#center)
...
This chapter begins where the previous chapter ended, after the characters followed Kas's trail to Carapace Ridge, a low dip in a cliff that provides access to a beach below. The characters' search for Kas takes them to several locations, from the Ruinous Citadel, where [Miska the Wolf-Spider](3-Mechanics/CLI/bestiary/npc/miska-the-wolf-spider-veor.md) is in the process of breaking free from his prison; to the Hurricane Tower, where the forces of Lolth marshal; and to the cliffside redoubt, where Kas retreated to plan. Along the way, they encounter Vaeve, a [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) who is loyal to neither Lolth nor Kas, and who offers the characters useful information.
...
- **General's Presence.** Lolth's general, a demon named [Camlash](3-Mechanics/CLI/bestiary/npc/camlash-veor.md), directs troops from the tottering tower. Lolth's forces include [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) and [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md). The tower looks ready to tip over because it is; only the webbing inside the tower's base keeps it from falling over.  
...
The characters can teleport directly to the redoubt's upper or lower entrances. The characters can't teleport into the redoubt directly, since it's warded with a [Forbiddance](3-Mechanics/CLI/spells/forbiddance-xphb.md) spell.
...
If the characters are careless or fail to fool Lolth's forces, they might face a squad of `1d4` [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md), `1d6` [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md), and `1d4` [assassins](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md). Characters who defeat the squad can try again to infiltrate the tower.
...
A drow [assassin](3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md) named Althein and a wood elf [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) named Vendrasha, both faithful of Lolth, pray to the Spider Queen at the altar. Of the apparent four driders, three [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) are what they appear to be; the fourth is a [phisarazu spyder-fiend](3-Mechanics/CLI/bestiary/fiend/phisarazu-spyder-fiend-veor.md) (see appendix A) named Rachazz, who is masquerading as a drider using its Change Shape ability.
...
When intruders enter the vestibule, the three [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) rush into melee while Althein and Vendrasha hang back to support the driders. The driders and elves fight to the death.
...
Lolth's forces receive regular instructions from Camlash. If the characters eliminate the general but otherwise keep their presence in Hurricane Tower secret, a squad of four [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) checks on Camlash in 10 minutes, and a squad of six [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) arrives a few minutes later.
...
![Miska is imprisoned in the Ruinous Citadel, which serves as the headquarters for the demon lord's forces](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/149-10-004-ruinous-citadel.webp#center)
...
The exterior door has an invisible glyph inscribed on it. Each time a creature other than a Fiend opens the door, the glyph glows for a split second, and the creature must make a DC 18 Wisdom saving throw, taking 21 (`6d6`) psychic damage on a failed save or half as much damage on a successful one. Casting [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) on the door removes the glyph, allowing the door to be opened safely.
...
The spyder-fiends dump their spoils of war here. The room's only occupant is a neutral [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) named Naxa, who is wearing a [Cloak of Arachnida](3-Mechanics/CLI/items/cloak-of-arachnida-xdmg.md) she found here. The cloak allows Naxa to climb on walls and ceilings, and she is currently on the vault's ceiling.
...
In addition to the [Cloak of Arachnida](3-Mechanics/CLI/items/cloak-of-arachnida-xdmg.md) that Naxa wears, this room contains four [+1 Longswords](3-Mechanics/CLI/items/1-weapon-xdmg.md), three [+1 Daggers](3-Mechanics/CLI/items/1-weapon-xdmg.md), a [+2 Longbow](3-Mechanics/CLI/items/2-weapon-xdmg.md), three [Potions of Poison](3-Mechanics/CLI/items/potion-of-poison-xdmg.md), and a [Potion of Giant Strength (stone)](3-Mechanics/CLI/items/potion-of-stone-giant-strength-xdmg.md). One banner bearing Lolth's symbol is bordered with a thick silk rope. This is a [Rope of Climbing](3-Mechanics/CLI/items/rope-of-climbing-xdmg.md) that functions normally once unstitched from the banner. A mahogany chest the spyder-fiends took from a drow quartermaster contains 750 flawless black opals, each worth 1,000 gp.
...
A platinum scroll tube worth 2,500 gp is hidden in webbing in the southwest corner of the room, near the ceiling. It contains two [Spell Scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Glyph of Warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md). Characters who search the room and succeed on a DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check find the scroll tube.
...
![Outside the Ruinous Citadel, battles between demonic forces loyal to Miska and Lolth still rage](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/152-10-005-battles.webp#center)
...
![The vampire Kas refuses to tolerate any interruptions to his plans to ruin Vecna and claim the multiverse for his own](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/153-10-006-kas.webp#center)
...
The redoubt's interior is warded by a permanent [Forbiddance](3-Mechanics/CLI/spells/forbiddance-xphb.md) spell. The ward deals necrotic damage to Celestials and Fey who enter the redoubt.
...
Lolth's forces batter at this bunker to reach Kas, who is lower in the redoubt. A [citadel spider](3-Mechanics/CLI/bestiary/monstrosity/citadel-spider-veor.md) (see appendix A) attacks the structure while four [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) direct its efforts. They expect retaliation from Miska's forces and are quick to attack unfamiliar creatures. If Lolth's forces were routed due to Camlash's defeat, the four driders are gone but the citadel spider remains to stubbornly bash at the bunker. It attacks anyone who comes near.

The dented metal door doesn't open with any amount of pulling or pushing, since it's anchored from the inside with metal bars driven into metal frames. The area beyond the door is included in the redoubt's [Forbiddance](3-Mechanics/CLI/spells/forbiddance-xphb.md) effect, so teleportation into the bunker fails. The door has AC 22, 75 hit points, and immunity to poison and psychic damage.
...
A human corpse bears a platinum medallion of Lolth's symbol with dazzling diamonds at the end of each spider's foot (worth 3,000 gp). A drider corpse wears a bandolier woven of solidified shadow worth 30,000 gp. The bandolier holds two [Potions of Healing (supreme)](3-Mechanics/CLI/items/potion-of-supreme-healing-xdmg.md) and a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Seeming](3-Mechanics/CLI/spells/seeming-xphb.md).
...
![At your discretion, the characters might have found the legendary Sword of Kas in this adventure](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/156-10-007-sword-of-kas.webp#center)
