...
![The next piece of the Rod of Seven Parts is inside an enormous war machine](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/061-04-001-the-colossus-warforged.webp#center)
...
![The Mount Ironrot region is a wasteland scattered with broken war machines](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/062-04-002-mount-ironrot-region.webp#center)
...
A [Detect Magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of conjuration magic emanating from the oval. This oval served as a conduit for powerful teleportation magic in Cyre, but the Day of Mourning rendered its magic unstable. The oval serves as a portal to Sigil while the characters carry the second piece of the rod.

If a creature tries to teleport to the Mournland using a [Teleport](3-Mechanics/CLI/spells/teleport-xphb.md) spell, a [Plane Shift](3-Mechanics/CLI/spells/plane-shift-xphb.md) spell, or similar magic, the spell's caster must make a DC 15 Constitution saving throw. On a failed save, the spell fails and has no effect. On a successful save, the spell works, but teleported creatures arrive in an empty space near this oval, regardless of their intended destination in the Mournland.
...
- **Magic Ring.** An iron ring etched with angelic feathers hangs from a silver chain on the wall. This is a [Ring of Feather Falling](3-Mechanics/CLI/items/ring-of-feather-falling-xdmg.md).  
...
![Warforged try to survive in the blasted wilderness around Mount Ironrot](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/069-04-003-mount-ironrot.webp#center)
...
The easiest way to enter the colossus is through the mountain caves that lead to area L5. The characters can also search higher up the mountain along outdoor paths for the entrances to caverns that lead to areas L11 and L16. Searching for area L11 takes `2d4` hours, and during the characters' search, a hungry [roc](3-Mechanics/CLI/bestiary/monstrosity/roc-xmm.md) ambushes them. Searching for area L16 takes `3d4` hours, and during the characters' search, they stumble on a nest with two [rocs](3-Mechanics/CLI/bestiary/monstrosity/roc-xmm.md) and one roc egg the height of a human. The angry roc parents attack the characters, though the rocs don't pursue if the characters flee.
...
- **Antigravity Wells.** Landro's ankles, legs, knees, hips, spine, and elbow are filled with magical energy meant to allow the colossus's body to bend and rotate freely. Creatures and objects can enter and exit these permeable "antigravity wells" like any normal space. While inside an antigravity well, a creature is affected by a [Levitate](3-Mechanics/CLI/spells/levitate-xphb.md) spell (no saving throw). Regular notches in the walls make it relatively easy for creatures to move up or down a well to reach other areas of the colossus.  
...
- **Psychic Damage.** For each ounce of graymatter fluid consumed, the creature takes 11 (`2d10`) psychic damage. A creature killed by this damage rises as a [zombie](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) `1d4` hours after dying.  

#### Invisible Barrier

The graymatter engine creates an invisible barrier around the intact parts of Landro. Nothing can penetrate the barrier, which is similar to the effect of a [Wall of Force](3-Mechanics/CLI/spells/wall-of-force-xphb.md) spell, though a [Disintegrate](3-Mechanics/CLI/spells/disintegrate-xphb.md) spell can't destroy it. The barrier is broken in compromised sections of Landro (areas L5, L11, and L16).
...
If a creature picks up the armor or weapons, two [flying swords](3-Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm.md) and two suits of [animated armor](3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md) rise from the scattered gear to reclaim the stolen treasure. They attack the thief and the thief's allies, but they don't pursue foes outside this area.
...
Within the mushroom patch are two [shriekers](3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md). The shriekers' high-pitched screams might attract the Brelish soldiers from area L3 or alert one of Glaive's scouts to the characters' location.
...
A weapon rack on the wall opposite Landro's spine contains two [halberds](3-Mechanics/CLI/items/halberd-xphb.md) and one [hand crossbow](3-Mechanics/CLI/items/hand-crossbow-xphb.md) with a case of 20 [bolts](3-Mechanics/CLI/items/bolts-20-xphb.md).
...
This 20-foot-high chamber is affected by a persistent [Silence](3-Mechanics/CLI/spells/silence-xphb.md) spell. A [Dispel Magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell ends the effect.
...
The ceiling here is 20 feet high. Any characters proficient in [tinker's tools](3-Mechanics/CLI/items/tinkers-tools-xphb.md) or [woodcarver's tools](3-Mechanics/CLI/items/woodcarvers-tools-xphb.md) can assemble a set of either tools from the items in this room with 1 minute of work.
...
The lawful good [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md), who says its name is Chandry, pleads with the characters to help it reunite with its comrades inside Landro.
...
![A strange pool found inside Landro has magical effects on items dipped into it](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/075-04-006-dragonshard-pool.webp#center)
...
A suit of [chain mail](3-Mechanics/CLI/items/chain-mail-xphb.md), two [shortswords](3-Mechanics/CLI/items/shortsword-xphb.md), and a [mace](3-Mechanics/CLI/items/mace-xphb.md) lie on the floor. All are twisted and malformed, as if they were affected by a roll of 3 or 4 on the Dragonshard Pool Effects table.
...
Three Cyran soldiers in full regalia stand diligently at the arrow slits in this 30-foot-tall gathering hall. When they become aware of the characters, the soldiers turn to the party, revealing ghostly, screaming skulls instead of faces. The soldiers are three hostile [wights](3-Mechanics/CLI/bestiary/undead/wight-xmm.md). Three [will-o'-wisps](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md), previously [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible), appear at the start of combat and fight alongside the wights.
...
The table is a magically animated servant (use the [stone golem](3-Mechanics/CLI/bestiary/construct/stone-golem-xmm.md) stat block). It is designed to defend Landro from enemy boarders. As soon as a creature disturbs the table's contents, the table reveals its true nature and attacks.
...
The chest is a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) in disguise. As soon as a creature touches it, the mimic attacks. Once it has grappled a creature, the mimic attempts to drag its victim outside so it can drop the victim off the edge of the walkway (area L22). Creatures that fall take 45 (`13d6`) bludgeoning damage.
...
![Glaive and her subordinates might confront the heroes inside Landro's weapons systems room](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/076-04-007-glaive-and-subordinates.webp#center)
...
![The graymatter engine serves as Landro's brain, though it can't control the colossus's mechanical systems](3-Mechanics/CLI/adventures/vecna-eve-of-ruin/img/077-04-008-graymatter-engine.webp#center)
...
The animated fluid takes the shape of a tall, lithe humanoid and introduces itself as Landro. This neutral-aligned being uses the [water elemental](3-Mechanics/CLI/bestiary/elemental/water-elemental-xmm.md) stat block, except it has telepathy out to 30 feet.
...
When an id crystal touches the graymatter engine, the graymatter engine's consciousness is transferred to the crystal, which becomes an [Elemental Gem (emerald)](3-Mechanics/CLI/items/elemental-gem-emerald-xdmg.md).
