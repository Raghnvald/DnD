...
A small room serves as a cloakroom, where visitors can hang their heavier overgarments. Past the cloakroom is the store proper, with wares on display. The room to the north is a storeroom or a workshop. The store owner ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) has keys to all doors.
...
The characters enter the alley followed by eight [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) disguised as children wearing troll masks. A [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) named Morga and an [intellect devourer](3-Mechanics/CLI/bestiary/aberration/intellect-devourer-xmm.md) hide in a doorway halfway down the alley and can be spotted with a successful DC 16 Wisdom (Perception) check.
...
Parked in the middle of the alley is a hire-coach pulled by two [draft horses](3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md). The driver, Haru Hamatori (LG male Kozakuran human commoner), wears a feathered cap and matching outfit.

Lord Cassalanter's [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) valet, in the guise of an elderly tiefling named [Willifort Crowelle](3-Mechanics/CLI/bestiary/npc/willifort-crowelle-wdh.md), sits in the passenger cab, which grants half cover. Standing next to the hire-coach is a [bearded devil](3-Mechanics/CLI/bestiary/fiend/bearded-devil-xmm.md) disguised as a cloaked human bodyguard wearing a wide-brimmed hat, and perched on the coach are three [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) [imps](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md). Any [spined devils](3-Mechanics/CLI/bestiary/fiend/spined-devil-xmm.md) that survived the previous encounter are also present, having just delivered the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md) to Willifort.
...
Before the characters leave the alley, [Jarlaxle Baenre](3-Mechanics/CLI/bestiary/npc/jarlaxle-baenre-wdh.md) (see appendix B) uses his [hat of disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md) to approach them in the guise of [Laeral Silverhand](3-Mechanics/CLI/bestiary/npc/laeral-silverhand-wdh.md), the Open Lord of Waterdeep:
...
Characters who speak to the proprietor of the meat shop, a portly middle-aged woman named Sora Cuttle (LG female Illuskan human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), learn that she received an unexpected delivery from Justyn Rassk of the Guild of Butchers. Given that fresh meat is in short supply in winter, Sora could hardly turn it down. If the characters see fit to tell her that the meat came from chopped-up humanoids, Sora falls ill. She has no knowledge of [Thrakkus](3-Mechanics/CLI/bestiary/npc/thrakkus-wdh.md)'s nasty handiwork and promises to bring the matter to the attention of the Guild of Butchers and the local magister. Until then, she won't use any of [Thrakkus](3-Mechanics/CLI/bestiary/npc/thrakkus-wdh.md)'s meat to make her famous meat pies.
...
This windowless house is occupied by two Zhents loyal to [Manshoon](3-Mechanics/CLI/bestiary/npc/manshoon-wdh.md)-the same individuals that Sora describes. Their names are Avareen Windrivver (LE female Illuskan human [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) and Zorbog Jyarkoth (NE male Turami human [thug](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)).
...
Mistshore is a riotous assemblage of ramshackle homes made of wood from old ships and inhabited by impoverished Waterdavians. Several buildings were reduced to ash by the fire last year. Although some were rebuilt, others were ruined beyond repair and are now used as roofless dens by homeless children and [rats](3-Mechanics/CLI/bestiary/beast/rat-xmm.md).
...
The Kraken's Folly is a beached pirate ship that some residents of Mistshore use as a tenement. At any given time, `4d6` [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) loiter on deck, hoping that someone who needs muscle will offer them work. These ruffians live in the rat-infested cabins belowdecks. They are willing to come to the aid of anyone who asks-for a price. Each demands 1 gp to get involved in a fight or create a distraction on behalf of their employer.

#### D2. Grinda's Residence

A mad treasure hunter named [Grinda Garloth](3-Mechanics/CLI/bestiary/npc/grinda-garloth-wdh.md) (CN female Illuskan human [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) who speaks Common, Dwarvish, Halfling, and Undercommon) lives here. Her ramshackle home contains an unmade bed, an alchemist's laboratory, a small stove, a coat rack, a table, a stool, a stuffed chair in poor condition, a wash basin, and a locked wooden sea chest with a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) spell cast on it. Grinda carries the key, and the glyph triggers an explosive runes effect (see the spell description in the "Player's Handbook") if anyone other than Grinda lifts the lid of the chest.
...
As the characters search the harbor for treasure, roll any die. If an even number is rolled, an awakened shark named [Obliteros](3-Mechanics/CLI/bestiary/npc/obliteros-wdh.md) attacks them. Grinda has had several close encounters with the shark recently, but fails to mention this to the characters for fear of scaring them off. [Obliteros](3-Mechanics/CLI/bestiary/npc/obliteros-wdh.md) is a [giant shark](3-Mechanics/CLI/bestiary/beast/giant-shark-xmm.md), with these changes:
...
When the characters arrive at her home, Grinda is holed up inside, having barricaded the doors with furniture. Trying to break down the doors are four members of the Xanathar Guild (CE male human [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)) under the command of a dwarf enforcer named [Noska Ur'gray](3-Mechanics/CLI/bestiary/npc/noska-urgray-wdh.md) (see appendix B). A [merrow](3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) also under Noska's command swims beneath the docks. It surfaces to attack when the characters arrive.

If the characters come to Grinda's defense, Noska orders his thugs to attack them while he takes potshots at the characters with his crossbow. Two rounds later, eight more [bandits](3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) leap down from the *Kraken's Folly* (D1) and join the fray. These hooligans were paid 1 gp each to watch Noska's back. The characters can turn them against Noska by offering a larger bribe (at least 5 gp each).
...
Waiting at the edge of the neighborhood is the hirecoach that bore Agorn Fuoco through the blizzard to Mistshore. Two [draft horses](3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md) stamp their hooves impatiently in the snow. The driver, Rowan Evenwood (LG female Chondathan human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), was paid extra to wait for Agorn to return. He left in a hurry, and she doesn't know how long she is expected to wait, but her patience has limits.

#### A Cold Reception

A blizzard is tearing through Mistshore, turning its rotten tenements into dark, looming shapes behind veils of blowing snow. The water around the docks is frozen solid, and impoverished [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) clad in tattered garments gather around sputtering campfires for warmth. These folk are suspicious of anyone they don't recognize and far from welcoming, even toward those who show them charity. These people would tear the clothes from the characters' backs given half a chance.
...
As the characters leave the Fuoco residence, with or without Agorn as their prisoner, they are surrounded by nine Zhentarim [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md). The thugs fight to the death while Agorn tries to escape. If he gets away, the characters might encounter him again in chapter 8.
...
A [kenku](3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md) in cahoots with the Xanathar Guild has the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md) and is running through the streets with it. The kenku is 60 feet away from the characters at the start of the chase.

If at any point the kenku is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated), another [kenku](3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md) previously hidden by the rain or fog joins the chase, acting next in the initiative count. It suddenly appears, snatches the stone, and flees with it.
...
Any creature in the crowd has half cover, and any attack that misses the creature because of the cover hits an innocent [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) instead.

If Willifort is [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated), a raven abruptly swoops down, acting next in the initiative count. It snatches the stone and flees with it. This raven is a shapechanged [imp](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) that works for Lady Cassalanter.
...
If she is caught, Vevette surrenders. She's counting on the law to protect her from serious harm, and she knows she has done nothing to warrant arrest. Vevette no longer has the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md), after parting with it back in the theater. She doesn't willingly divulge who has the stone, though the characters can pry the information from her using a [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md) spell or similar magic.
...
The City of the Dead is a public park dotted with mausoleums. The place is closed at night, with two City Guard soldiers ([guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md)) stationed at each entry gate. A character can slip over a wall undetected with a successful DC 15 Dexterity (Stealth) check.

At dusk, hundreds of [driftglobes](3-Mechanics/CLI/items/driftglobe-xdmg.md) make their way from the inhabited part of the city and congregate in the City of the Dead. They spend the night here, then disperse and return to the waking city at dawn-for a reason no one knows.

Sir Ambrose Everdawn (LG male human Tethyrian [knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md)), an aging servant of Kelemvor (god of the dead), patrols the cemetery from sunset to sunrise, chasing off grave robbers and making sure the dead stay buried. Characters who creep around the cemetery in the dark have a 30 percent chance of running into him. If that happens, he escorts them out and alerts the City Guard if they refuse to leave.
...
As the characters leave the mausoleum, they are jumped by four [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md), members of the Xanathar Guild, who slipped past the cemetery guards using their invisibility. The leader, Gorath, accosts the characters in Dwarvish, demands the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md), and refuses to believe that they don't have it. If the stone isn't turned over to them promptly, the duergar enlarge themselves and attack. [Xanathar](3-Mechanics/CLI/bestiary/npc/xanathar-wdh.md) watches the battle unfold through the eyes of a gazer (see appendix B), which stays out of the fight and tries to remain unseen.
...
The largest tree growing in front of the entrance is a [treant](3-Mechanics/CLI/bestiary/plant/treant-xmm.md). It awakens when one or more creatures approach the entrance and growls, "Only those of Brandath blood are welcome here! Begone!" The treant is particularly surly, it being winter and all.
...
A [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) spell has been cast on the first step leading down to the underground level, set to trigger when a humanoid creature passes over the step. The glyph can't be spotted unless the dust on the floor is cleared away by a [gust of wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md) spell or some other means. Once the dust is swept aside, a character who searches the stairs notices the glyph with a successful DC 15 Intelligence (Investigation) check.
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of transmutation that emanates from one of the stone coffins on the underground level. This crypt contains the shattered bones of Uld Brandath, a Waterdavian magister who died in a freak accident decades ago. (A gargoyle broke off the corner of a government building and fell on Uld, crushing him.) Guarding his remains are six [crawling claws](3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) made from the hands of murderers who were sentenced to death by Uld. These undead hands spring out and attack when the lid is lifted or shoved aside.

##### Treasure

Lying amid the bones is Uld's [headband of intellect](3-Mechanics/CLI/items/headband-of-intellect-xdmg.md), which the characters can retrieve once the crawling claws are dealt with.

#### Path to the Vault

The collapsed eastern end of the underground level is actually an illusion that conceals an intact, 10-foot-wide passageway that slopes down. The characters can walk right through the illusion, which has no substance, and a [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell destroys it. The tunnel wends downward for several hundred feet, gradually widening to 20 feet where it ends at the doors to the Vault of Dragons.
...
| 9 | You trigger a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) spell placed on the roof to discourage burglars. Make a DC 13 Wisdom saving throw. On a failed save, you are targeted by a [Tasha's hideous laughter](3-Mechanics/CLI/spells/tashas-hideous-laughter-xphb.md) spell, the effect of which lasts 1 minute. |
...
The characters are trying to catch up with three [spined devils](3-Mechanics/CLI/bestiary/fiend/spined-devil-xmm.md) that keep low above the rooftops, so as not to be seen by Waterdeep's Griffon Cavalry. The devils are 100 feet away from the characters at the start of the chase.
...
- The theater is lit by lanterns that have [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on them. Speaking a command word inside the theater causes the lights in the theater and backstage to dim; speaking another command word inside the theater restores them to full brightness. All the stage managers know the command words.  
...
A stack of torn tickets sits on a shelf beneath a counter inside the booth. Prior to a show, each booth holds a ticket seller ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). Admission to the theater is 1 sp per person.

#### P3. Ticket Offices

A desk near the far wall in each of these rooms contains notebooks, [papers](3-Mechanics/CLI/items/paper-xphb.md), and a lockbox.
...
During a performance, a stage manager ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) watches from the back of the seating area.
...
This room holds a desk covered in papers. The stage manager ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) stays here between performances.
...
This room contains clothes racks, tables lined with makeup, and long wall mirrors. During or immediately before a performance, each dressing room holds `1d3` actors ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)).
...
Westra Moltimmur (CG female Illuskan human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) with Insight +2 and Performance +6), the play's leading lady, is one of Waterdeep's great treasures, and the cast and crew are very protective of her. Now in her seventies and having been married no fewer than seven times, she has a brisk sense of humor and a zest for life. She's also insightful enough to know that "Rongquan Mystere" isn't what he appears to be. She has seen the dark elves who watch over Rongquan and observed him using subtle hand gestures (Drow Sign Language) to communicate with them.
...
The shivering audience includes thirty [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md). Also present is a Zhentarim spy named Agorn Fuoco (NE male Turami [bard](3-Mechanics/CLI/bestiary/humanoid/bard-mpmm.md); see appendix B) and his companion, Amath Sercent (LE female Mulan [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) of Bane). Agorn is swept up in the drama and fighting back tears while Amath pats his arm gently. Vevette takes a seat behind them and surreptitiously passes the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md) to Agorn. Looking on from the back row is [Remallia Haventree](3-Mechanics/CLI/bestiary/npc/remallia-haventree-wdh.md) (see appendix B), a member of the Harpers who suspects Agorn of being a high-ranking Zhent. She has been watching him for a while now, hoping to identify other Zhentarim leaders in Waterdeep. Although Remallia appears to be alone, the two violinists (LG male Illuskan human [spies](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) with Performance +5) are Harpers under her command. Agorn and Amath are unaware that they're under surveillance.
...
- The tower is brightly lit by [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on wall sconces.  
...
| dice: d4 | Result |
|----------|--------|
| 1 | A charred [wand of magic missiles](3-Mechanics/CLI/items/wand-of-magic-missiles-xdmg.md) (each time a charge is expended, there's a 50 percent chance that nothing happens and the charge is wasted) |
| 2 | A [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) mixed with a [potion of flying](3-Mechanics/CLI/items/potion-of-flying-xdmg.md) (if this mixture is imbibed, roll on the Potion Miscibility table in chapter 7 of the Dungeon Master's Guide to determine the effect) |
| 3 | A cracked [driftglobe](3-Mechanics/CLI/items/driftglobe-xdmg.md) that emits a flickering light but otherwise functions normally |
...
Arcane runes are inscribed in a circle on the floor of this otherwise empty chamber. The circle is a permanent teleportation circle (see the [teleportation circle](3-Mechanics/CLI/spells/teleportation-circle-xphb.md) spell description in the "Player's Handbook").

### Old Tower: Spring

The party's elusive quarry, a [kenku](3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md), has taken refuge in an old tower. By the time the characters reach the entrance to the tower, the kenku has taken a hostage and fled to the upper level.
...
The interior of the tower is subject to a permanent [antimagic field](3-Mechanics/CLI/spells/antimagic-field-xphb.md) spell. Consequently, no magic functions inside the tower. This effect was left behind by the tower's previous occupant, a wizard hermit who dabbled in "wild magic" and could no longer control it. Because of the antimagic field, the magic lights that normally illuminate the tower have been suppressed. Only a [wish](3-Mechanics/CLI/spells/wish-xphb.md) spell or similar magic can end this antimagic effect.

#### Tower Swords

Scattered on the floors throughout the tower are six longswords with no traces of rust or blood on them. These blades are [flying swords](3-Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm.md) rendered inert by the antimagic field. If a flying sword is taken from the tower, it animates and attacks.
...
Before the characters reach O3, three [drow gunslingers](3-Mechanics/CLI/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B) under the effect of [potions of invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md) use their [levitate](3-Mechanics/CLI/spells/levitate-xphb.md) spells to scale the outside of the tower and crawl through the arrow slits. While they are inside the tower, their [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md) spells are negated by the antimagic field. One of the drow quickly finds the stone and takes it before the characters show up.
...
- Two [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) stand outside each of the front and back doors (leading to areas H1 and H6) at all hours.  
...
- All areas are brightly lit by [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on wall sconces.  
...
- Two [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) stand outside the doors to the records rooms (H2) at all hours. Behind a desk sits a court clerk ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). Uncomfortable wood benches line the walls. A copper plaque mounted above each bench says, in Common, "Please have a seat. Someone will be with you shortly."  
...
Two desks pushed together in the middle of the room hold quills, ink, and sheets of paper. Two court clerks ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) work here, supporting the magister on duty. Each clerk holds a key to the records rooms (H2).
...
When not overseeing a trial, a magister on duty at the courthouse reviews cases and holds meetings here. If a magister is here, so is a [knight](3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) who serves as a bodyguard.

#### H5. Courtroom

This room has the following features:

- Two [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) are stationed here at all times.  
...
- Two [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) are on duty in this room at all times.  
...
Two [guards](3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) are stationed in this hall at all times.
...
- Two [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md), members of the City Watch, are here at all times.  
...
The arresting force consists of twelve [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md), a Watch [sergeant](3-Mechanics/CLI/bestiary/humanoid/sergeant-wdh.md) and eleven constables. They demand that the characters surrender their weapons and come along quietly. For guidance on how to handle character arrests, see "Breaking the Law,".
...
[Magister Umbero Zastro](3-Mechanics/CLI/bestiary/npc/magister-umbero-zastro-wdh.md) has the statistics of a [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md), with these changes:
...
- **Meeting with the Magister.** The courthouse magister is [Hester Barch](3-Mechanics/CLI/bestiary/npc/hester-barch-wdh.md) (LG female Turami human [acolyte](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) with Insight +4), a petite woman in her seventies. Magister Barch is slow to anger and fond of sharing lengthy educational anecdotes and parables. Unknown to all but her closest aides, the magister has the innate psionic ability to cast the [detect thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md) spell without somatic or material components. After using it once, the magister must finish a short or long rest before she can cast the spell again. Wisdom is her spellcasting ability (spell save DC 12).  
    ...
    The magister is disinclined to agree to any request for a private meeting with Fenerus, on the grounds that he's a shady, unrepentant person and a flight risk. The conditions under which she will permit a meeting are as follows:  
        ...
        - A character who is impersonating a noble or an official makes a good argument and succeeds on a DC 15 Charisma (Deception) check. If the check fails, Magister Barch sees through the ruse and uses her [detect thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md) spell to verify that the character is in fact disguised as a noble or an official-a crime that carries a punishment of flogging followed by imprisonment for up to a tenday, plus a fine of up to 500 gp.    
        - A character tells the magister about the hidden cache of dragons and Fenerus's role in finding it.    
- **Talking to Fenerus.** Fenerus Stormcastle (N male Tethyrian [bandit captain](3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md)) is confined to a cell in H8, waiting to stand trial. He is charged with multiple counts of theft (highway banditry) and assaults against Waterdavian citizens. Fenerus knew it was only a matter of time until someone tipped off the City Watch; he suspects that another member of the Blood Hawk Posse gave him up. The timing is unfortunate for him, since he was planning to earn a small fortune by turning over the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md) to his Luskanite contact. Now, he plans to use the stone to escape imprisonment and wipe his criminal record clean.  
...
A plain wooden door opens into a room containing dusty furnishings in storage. The furniture includes a scratched wooden desk, several wobbly chairs, a coat rack, two small tables, and an empty wooden trunk. There's a 25 percent chance that one piece of furniture (determined randomly) is a [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) that usually feeds on rats but never passes up a bigger meal.

**Mimic Present**

| dice: d100 | result |
|------------|--------|
| 1-25 | A [Mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) is present |
...
[Losser Mirklav](3-Mechanics/CLI/bestiary/npc/losser-mirklav-wdh.md) is a lightfoot halfling [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md), with these changes:
...
- He has the [animate dead](3-Mechanics/CLI/spells/animate-dead-xphb.md) and [blight](3-Mechanics/CLI/spells/blight-xphb.md) spells prepared, instead of [counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md) and [greater invisibility](3-Mechanics/CLI/spells/greater-invisibility-xphb.md). All his spell slots are currently expended.  
...
- B10 contains twelve [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) that attack anyone other than Losser and his apprentices.  
- B11 contains piles of human bones stolen from the City of the Dead. Losser hasn't gotten around to animating them yet.  

#### Where's the Stone?

Before the characters reach Losser, kenku members of the Xanathar Guild break down the door leading into the cellar complex via B8 and confront the necromancer. The characters find Losser cowering in one corner of B7. Two [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) stand between him and three [kenku](3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md). The kenku aim to kill the halfling. Lying on the floor around them are four dead kenku and the remains of two destroyed (and previously animated) skeletons.

If the characters demand the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md), Losser tells them the truth: he surrendered it to the kenku, two of which fled south with it. In B8, the characters see one [kenku](3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md) standing over the bodies of Losser's murdered human apprentices, Retchyn and Kreela. This kenku is joined by [Xanathar](3-Mechanics/CLI/bestiary/npc/xanathar-wdh.md)'s [gazer](3-Mechanics/CLI/bestiary/aberration/gazer-mpmm.md) (see appendix B). The kenku and the gazer try to hold off the characters for as long as possible, buying time for a second kenku to flee with the Stone of Golorr.
...
The rocking chair is the [mimic](3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) from B9b. It heard the urchins' screams and investigated, hoping to snare an easy meal. It attacks anyone who harms it or reaches for the stone.
...
| Area | Creature(s) |
|------|-------------|
| B5 | 2 [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) behind arrow slits |
| B6 | 1 [half-ogre](3-Mechanics/CLI/bestiary/giant/ogrillon-ogre-xmm.md) that became [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) after drinking six casks of cheap wine |
| B7 | 3 [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) and 1 [gazer](3-Mechanics/CLI/bestiary/aberration/gazer-mpmm.md) (see appendix B) standing guard while [Thorvin Twinbeard](3-Mechanics/CLI/bestiary/npc/thorvin-twinbeard-wdh.md) (see appendix B) works on a mechanical beholder (see "Mechanical Beholder" below) |
| B8 | Korgstrod Uxgulm, the [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) leader (40 hit points), seated in a stone chair and attended by 3 [kobolds](3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) (see "Stone of Deception" below) |
| B10 | 7 [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) lurking in the shadows |
| B11a | 1 [gibbering mouther](3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) guarding a treasure chest in B11b (see "Treasure Chest" below) |
^xanathar-guild-roster
...
During the spring, summer, and winter, each of these rooms is home to `1d6 + 1` squatters ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) who have made dens for themselves out of old furnishings and things salvaged from garbage piles. The squatters aren't looking for trouble.
...
The key that the characters found in the mausoleum leads them to an old windmill in the Southern Ward. Volkarr Kibbens and Urlaster Ghann (NE male Illuskan human [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) are hiding out in a secure apartment on the upper floor (W7). In combat, they wield shovels that deal damage as clubs. Each carries `3d6` gp in a pouch.
...
The characters head to a decrepit building in the Southern Ward that used to be a windmill. Therein, they expect to find the [Stone of Golorr](3-Mechanics/CLI/items/stone-of-golorr-wdh.md) in the clutches of two treacherous [cult fanatics](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) named Arn Xalrondar (LE male Tethyrian human) and Seffia Naelryke (LE female Tethyrian human).
...
The outside doors are always locked. A lock can be picked with a successful DC 15 Dexterity check by a character using thieves' tools, or a door can be smashed open with a successful DC 15 Strength (Athletics) check. Any attempt to break into the tower is 75 percent likely to be seen or heard by one of [Kalain](3-Mechanics/CLI/bestiary/npc/kalain-wdh.md)'s neighbors. Eight [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) of the City Watch arrive 10 minutes later to investigate the intrusion.
...
[Kalain](3-Mechanics/CLI/bestiary/npc/kalain-wdh.md) spends most of her time in W5, which serves as her studio. It contains moldy scraps of food, empty pots stained with colored paint, discarded brushes, and her easel, which is situated in front of a large, lead-paned window in the north wall. Upon the easel rests a fresh painting of a [displacer beast](3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md). If the characters confront her, [Kalain](3-Mechanics/CLI/bestiary/npc/kalain-wdh.md) accuses them of being assassins, brings the displacer beast to life, and commands it to attack them.
...
[Thrakkus](3-Mechanics/CLI/bestiary/npc/thrakkus-wdh.md) is a dragonborn [berserker](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) of red dragon ancestry, with these changes:
...
[Thrakkus](3-Mechanics/CLI/bestiary/npc/thrakkus-wdh.md) is belligerent and not eager to give up his Zhent friends. A [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md) spell or similar magic is needed to compel him to talk. His squatters are another matter; they roll over on [Thrakkus](3-Mechanics/CLI/bestiary/npc/thrakkus-wdh.md) quickly to save their own skins once the dragonborn butcher no longer becomes a factor in their well-being. Either approach yields the following information:
...
- [Xanathar](3-Mechanics/CLI/bestiary/npc/xanathar-wdh.md) sends either five [goblins](3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) dressed up as children wearing Trolltide masks and a [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) (70 percent chance), or four [wererats](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) in human form (30 percent chance).  
- The Cassalanters send two [imps](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) in raven form, three human [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md), and either a human [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) (70 percent chance), or four [spined devils](3-Mechanics/CLI/bestiary/fiend/spined-devil-xmm.md) (30 percent chance).  
- [Jarlaxle Baenre](3-Mechanics/CLI/bestiary/npc/jarlaxle-baenre-wdh.md) sends [Fel'rekt Lafeen](3-Mechanics/CLI/bestiary/npc/felrekt-lafeen-wdh.md) and [Krebbyg Masq'il'yr](3-Mechanics/CLI/bestiary/npc/krebbyg-masqilyr-wdh.md), or two other Bregan D'aerthe [drow gunslingers](3-Mechanics/CLI/bestiary/humanoid/drow-gunslinger-wdh.md) (see appendix B), and six [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md).  
...
Any creature under the effect of an [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md) spell counts as this key, as do naturally [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) creatures.
...
The Xanathar Guild employs [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md), and characters can chop the ears off any of them. A live bugbear also counts as this key.
...
Any living creature of the shapechanger subtype, such as a [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) or a [wererat](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md), serves as this key. [Bonnie](3-Mechanics/CLI/bestiary/npc/bonnie-wdh.md) the doppelganger (see "Familiar Faces") can be persuaded to accompany the characters if she is friendly toward one or more of them. The characters can also reach out to the Shard Shunners, a local gang of halfling wererats. For an up-front payment of 500 gp, the wererats happily oblige.

#### Silvered warhammer

The characters can buy a [silvered warhammer](3-Mechanics/CLI/items/silvered-weapon-xdmg.md) for 115 gp, or they can give a silver bar to [Embric](3-Mechanics/CLI/bestiary/npc/embric-wdh.md) and [Avi](3-Mechanics/CLI/bestiary/npc/avi-wdh.md) (see chapter 2, T3) and have the genasi smiths craft one.
...
Although conjuring up a real unicorn is likely beyond the abilities of the characters, they could ask [Laeral Silverhand](3-Mechanics/CLI/bestiary/npc/laeral-silverhand-wdh.md) or [Vajra Safahr](3-Mechanics/CLI/bestiary/npc/vajra-safahr-wdh.md) to cast the [conjure celestial](3-Mechanics/CLI/spells/conjure-celestial-xphb.md) spell. The characters can gain an audience with Laeral or Vajra through [Renaer Neverember](3-Mechanics/CLI/bestiary/npc/renaer-neverember-wdh.md) or another well-connected NPC. If the characters tell Laeral or Vajra the truth about the Vault of Dragons and promise to turn the gold over to the authorities, either one agrees to accompany the characters to the vault and cast the spell. The unicorn need not be a real unicorn to serve as this key. The Sea Maidens Faire (see chapter 7) uses a unicorn float in its parades, and a stuffed unicorn can be found in Cassalanter Villa (see chapter 6, C18).
...
- The west wall bears a cracked mosaic that depicts a dwarf smith at a forge, crafting dwarves out of black metal and [diamonds](3-Mechanics/CLI/items/diamond-xdmg.md). (In the south end of the wall is a secret door.)  
...
A little more than halfway down the hall, a section of the western mural has broken off, forming a heap of shattered tile on the floor. A crack in the wall conceals a [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) that gushes out and attacks characters who inspect the damage.

##### Secret Door

A character who searches the hall for secret doors and succeeds on a DC 17 Wisdom (Perception) check notices the outline of a secret door that leads to V5. The door opens automatically when a dwarf (or a creature transformed into a dwarf with an [alter self](3-Mechanics/CLI/spells/alter-self-xphb.md) spell or similar magic) touches it; otherwise, a successful DC 17 Strength (Athletics) check is needed to push open the heavy door.
...
This room holds five copper urns (worth 25 gp each). Urn 1 contains five tourmalines (worth 100 gp each) mixed in with 200 cp. Urn 2 contains a [ring of warmth](3-Mechanics/CLI/items/ring-of-warmth-xdmg.md) mixed in with ten ordinary gold rings (worth 25 gp each) and 650 sp. Urn 3 is piled high with 250 gp. Urn 4 holds 33 blue quartz gemstones (worth 10 gp each). Urn 5 holds a 9-inch-tall silver statuette of a dwarf priest of Moradin with amethyst eyes (worth 250 gp and weighing 10 pounds).

#### V6. Hammer and Anvil

The adamantine door to this room has an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell cast on it, but it swings open when a dwarf or a creature transformed into a dwarf touches it. Another creature can force it open with a successful DC 21 Strength (Athletics) check. A [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic also opens it. The door swings into the room on stiff adamantine hinges.
...
A successful DC 17 Intelligence (Religion) check enables a character to recognize the statue as a depiction of Gorm Gulthyn, the dwarven god of vigilance also known as Fire Eyes. The statue melds seamlessly with the floor and can't be toppled. It also seems impervious to damage. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of evocation magic on the statue.
...
- If [Xanathar](3-Mechanics/CLI/bestiary/npc/xanathar-wdh.md) is the main villain, [Noska Ur'gray](3-Mechanics/CLI/bestiary/npc/noska-urgray-wdh.md) (see appendix B) arrives with six [bugbears](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) and a [gazer](3-Mechanics/CLI/bestiary/aberration/gazer-mpmm.md) (see appendix B). If Noska is dead or otherwise indisposed, the beholder replaces him with [Nar'l Xibrindas](3-Mechanics/CLI/bestiary/npc/narl-xibrindas-wdh.md) (see appendix B) and his [grell](3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) bodyguard.  
- If the Cassalanters are the villains, they send three [cult fanatics](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) and three [cultists](3-Mechanics/CLI/bestiary/humanoid/cultist-xmm.md). Victoro's [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) manservant, [Willifort Crowelle](3-Mechanics/CLI/bestiary/npc/willifort-crowelle-wdh.md), leads the group in his tiefling guise unless the characters killed him or otherwise disposed of him earlier in this chapter or in chapter 6.  
...
Jeryth Phaulkon sends three [swarms of rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) to assist the characters. Once the characters are no longer in peril, the rats disperse throughout the vault.
...
Open Lord [Laeral Silverhand](3-Mechanics/CLI/bestiary/npc/laeral-silverhand-wdh.md) (see appendix B) arrives with [Jalester Silvermane](3-Mechanics/CLI/bestiary/npc/jalester-silvermane-wdh.md) (see appendix B) and six City Guard [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) to help characters secure the gold. Laeral's arrival forces Jarlaxle to be on his best behavior. After assuring Laeral of his good intentions, Jarlaxle cuts his losses and withdraws peacefully. If she is able to speak with [Aurinax](3-Mechanics/CLI/bestiary/npc/aurinax-wdh.md), Laeral convinces the dragon to relinquish the gold into her custody.
