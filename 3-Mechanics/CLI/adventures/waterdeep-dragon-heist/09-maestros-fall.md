...
Although Zardoz Zord ([Jarlaxle Baenre](3-Mechanics/CLI/bestiary/npc/jarlaxle-baenre-wdh.md)) commands the fleet, each ship has its own captain: a Bregan D'aerthe [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) disguised as a slender, well-dressed human. These captains know of Jarlaxle's plans. They communicate with each other and with Jarlaxle by way of [sending](3-Mechanics/CLI/spells/sending-xphb.md) spells, which they prepare instead of [fly](3-Mechanics/CLI/spells/fly-xphb.md).
...
Most of the carnival performers and workers are human [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) trained to perform a handful of tasks or stunts. (Performers have proficiency in the Performance skill.) They're kept in the dark about most things, but they're not oblivious. With a successful DC 10 Charisma check, a character can cajole or trick a carny into revealing one of the following pieces of information:
...
Three sailors ([drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) and a mate ([drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md)) are on deck at all times. If the characters board the ship and ask to speak with the captain, the mate asks their business before even thinking about disturbing him.
...
- Twin hammocks hang perpendicular to one another. Two off-duty mates ([drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md)) relax in the hammocks.  
- Three walnut chests sit under the hammocks. The chests are unlocked.  

##### Treasure

Each chest holds two sets of common clothes, a [waterskin](3-Mechanics/CLI/items/waterskin-xphb.md) filled with wine, and a pouch containing `3d6` gp and `4d10` sp.

#### J4. Crew Cabins

Each of these cabins holds four hammocks. One off-duty sailor ([drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) rests in each cabin.

#### J5. Galley

Heat and savory scents burst from this cramped cabin, which contains the following features:

- A busy cook ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) works a frying pan with one hand and stirs a pot with the other over a small stove.  
...
- Six sailors ([drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) are enjoying a meal.  
- Aboard the *Heartbreaker* or the *Hellraiser*, the sailors are joined by `1d4` carnies ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). Furnishings include a table, ten stools, and two oak cabinets containing dishes, tankards, and utensils.  
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of illusion magic around the figurehead-the effect that makes every drow aboard the ship appear as a human. A drow's gender, height, and weight are unchanged; the illusion affects only appearance, not voice or mannerisms. Casting [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) on a disguised drow causes the illusion around it to wink out only for a moment. An [antimagic field](3-Mechanics/CLI/spells/antimagic-field-xphb.md) suppresses the figurehead's magic within the field's area. Destroying the figurehead ends the effect throughout the ship. A figurehead has AC 15, 50 hit points, and immunity to poison and psychic damage.

#### J9. Aft Castle Lower Deck

This deck has the following features:

- Two sailors ([drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) are here at all times.  
...
Each ship's captain ([drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md)) can usually be found here, with a [nimblewright](3-Mechanics/CLI/bestiary/construct/nimblewright-wdh.md) (see appendix B) acting as an attendant and bodyguard.
...
Each captain keeps a modest collection of mundane books. Each hides his spellbook in a secret space under the bottom shelf, which can be found with a successful DC 14 Wisdom (Perception) check. The spellbook contains the following spells: [cone of cold](3-Mechanics/CLI/spells/cone-of-cold-xphb.md), [control water](3-Mechanics/CLI/spells/control-water-xphb.md), [counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md), [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [fireball](3-Mechanics/CLI/spells/fireball-xphb.md), [fly](3-Mechanics/CLI/spells/fly-xphb.md), [greater invisibility](3-Mechanics/CLI/spells/greater-invisibility-xphb.md), [ice storm](3-Mechanics/CLI/spells/ice-storm-xphb.md), [mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), [misty step](3-Mechanics/CLI/spells/misty-step-xphb.md), [Rary's telepathic bond](3-Mechanics/CLI/spells/rarys-telepathic-bond-xphb.md), [sending](3-Mechanics/CLI/spells/sending-xphb.md), [shield](3-Mechanics/CLI/spells/shield-xphb.md), [suggestion](3-Mechanics/CLI/spells/suggestion-xphb.md), [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md), [water breathing](3-Mechanics/CLI/spells/water-breathing-xphb.md), and [web](3-Mechanics/CLI/spells/web-xphb.md).

##### Locked Trunk

A successful DC 20 Dexterity check by a character using thieves' tools opens the padlock, or it can be broken off with a successful DC 20 Strength (Athletics) check. The trunk contains folded clothes, 250 gp in a sack, `1d6` pearls (worth 100 gp each) in a silk pouch, a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md), and a bottle of excellent wine (worth 25 gp), bearing a label in the shape of an eye patch and the name "One-Eyed Jax" in Common.
...
- Two sailors ([drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) are stationed here at all times.  
...
Eight narrow cabins are fitted with hammocks, each of which holds a resting carnival performer or worker ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). Carnies call for help when they are confronted by intruders and fight only in self-defense.
...
There's a 25 percent chance that a sailor ([drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) is being held in the brig after punching a crewmate during an argument.
...
- Glitter, feathers, fabric, [paper](3-Mechanics/CLI/items/paper-xphb.md), scissors, sewing needles, spools of colored thread, and flasks of glue are strewn over small tables.  
...
|    |    |
|----|----|
| Two [apes](3-Mechanics/CLI/bestiary/beast/ape-xmm.md) | Four [giant fire beetles](3-Mechanics/CLI/bestiary/beast/giant-fire-beetle-xmm.md) |
| One [rhinoceros](3-Mechanics/CLI/bestiary/beast/rhinoceros-xmm.md) | One [hippogriff](3-Mechanics/CLI/bestiary/monstrosity/hippogriff-xmm.md) |
| One [tiger](3-Mechanics/CLI/bestiary/beast/tiger-xmm.md) | One [axe beak](3-Mechanics/CLI/bestiary/monstrosity/axe-beak-xmm.md) |
| One [allosaurus](3-Mechanics/CLI/bestiary/beast/allosaurus-xmm.md) | Two [death dogs](3-Mechanics/CLI/bestiary/monstrosity/death-dog-xmm.md) |
| Two [panthers](3-Mechanics/CLI/bestiary/beast/panther-xmm.md) | One [giant vulture](3-Mechanics/CLI/bestiary/monstrosity/giant-vulture-xmm.md) |
| One [owlbear](3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md) | One [polar bear](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) |
...
- [Shovels](3-Mechanics/CLI/items/shovel-xphb.md), ropes, chains, [buckets](3-Mechanics/CLI/items/bucket-xphb.md), bales of hay, and several large crates are pushed against the walls.  
...
These closets hold mops, brushes, [buckets](3-Mechanics/CLI/items/bucket-xphb.md), and soap used for scrubbing the decks.
...
The doors to this cabin are locked. If anyone other than Jarlaxle turns the handle of either door, a [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spell activates and shouts, "By Lolth's teeth, have you no manners?" The sound is loud enough to be heard by Jarlaxle (if he is in J29), and he comes to investigate.
...
The trapdoor has an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell cast on it, but rapping on it three times suppresses the spell for 1 minute. Alternatively, the trapdoor can be forced open with a successful DC 25 Strength (Athletics) check.
...
As a bonus action, Jarlaxle can command the five magic mannequins to animate and attack a single target of his choice. Each mannequin has the statistics of [animated armor](3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md). Mannequins that take damage become inanimate until Jarlaxle uses another bonus action to reanimate them. A mannequin targeted by a [mending](3-Mechanics/CLI/spells/mending-xphb.md) cantrip regains 1 hit point.

##### Dagger

The dagger in the dartboard is a [+1 dagger](3-Mechanics/CLI/items/1-weapon-xdmg.md).
...
The engine is a quasi-magical machine that controls the submarine's propulsion and depth and powers the fins and rudder that control direction. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of transmutation magic throughout the area.
...
This experimental device consists of a pressure-resistant padded suit, made of canvas with iron fittings and iron gauntlets. A fishbowl helmet attaches to the suit's collar and functions as a [cap of water breathing](3-Mechanics/CLI/items/cap-of-water-breathing-xdmg.md).

##### Treasure

The shrine weighs 50 pounds and is worth 125 gp as an art object. The footlocker contains a pouch holding 50 gp and a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md). The potion's crystal flask, shaped like a spider, is worth 25 gp.
...
- A hammock is suspended in the starboard alcove. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar magic reveals that the wall behind the hammock radiates an aura of transmutation magic.  
...
Three rock gnome [engineers](3-Mechanics/CLI/bestiary/humanoid/engineer-wdh.md) named Lorella Middenpump, Tervaround Waggletop, and Anverth Leffery are on duty here, along with two [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) named Karabal L'enz and Marro Qaz'arrt. The drow guard the control room and keep the gnomes on task.
...
Each footlocker belongs to a particular gnome engineer stationed aboard the *Scarlet Marpenoth*. Both contain folded clothes sized for a gnome. One of them also holds a set of grease-stained overalls and a set of tinker's tools that belong to the gnome asleep in the bunk. There is a 25 percent chance that a footlocker also contains a clockwork toy, a fire starter, or a music box (as described in the "[Rock Gnome](3-Mechanics/CLI/races/gnome-xphb.md)" section in chapter 2 of the "Player's Handbook").
...
The quasi-magical machinery in this area generates and circulates fresh air throughout the submarine. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell or similar magic reveals an aura of conjuration magic throughout the area.
...
A secret compartment in the chest's lid can be found with a successful DC 11 Wisdom (Perception) check. It contains a stoppered wooden scroll tube that holds a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [revivify](3-Mechanics/CLI/spells/revivify-xphb.md).
...
![Nat, Jenks and Squiddly enjoy a windy autumn day on the docks](3-Mechanics/CLI/adventures/waterdeep-dragon-heist/img/autumn-scene.webp#center)
...
The Sea Maidens Faire parade ends where it started-at the docks. As the attractions are being loaded back onto their ships, the Faire's [polar bear](3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md) gets loose, fleeing into the Dock Ward before its handlers can corner it. News of the escaped bear spreads quickly, and sightings are frequent. If the characters impressed one of the drow ship captains, he contacts them by way of a [sending](3-Mechanics/CLI/spells/sending-xphb.md) spell and asks for help. He wants the bear retrieved before the City Guard finds and kills it, offering a reward of either 250 gp or a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md).
