...
As time goes on, the characters attract the attention of local factions hoping to recruit them while they settle into the city. Eventually, these relatively peaceful times are shattered when a fireball detonates near their new residence. The characters are swept up in the aftermath of this horrific event and can try to get to the bottom of it. Who cast the [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) spell and why? Who was the intended target? They can investigate the incident on behalf of a guild or a faction, or they can become involved for reasons of their own.
...
- If the adventurers are accosted and overwhelmed, one or more Harpers come to their rescue. A Harper rescue team usually consists of a [bard](3-Mechanics/CLI/bestiary/humanoid/bard-mpmm.md) (see appendix B) or a [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md), plus `1d4 + 3` [spies](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) or [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md).  
...
- Any member given an assignment might receive a monstrous bodyguard or assistant (such as a [bugbear](3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md), a [kenku](3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md), or a [wererat](3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md)), who has secret instructions to kill the guild member if they fail to complete the assignment as ordered.  
...
- Tashlyn offers affordable mercenaries, either [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) costing 2 sp per day each or [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) costing 2 gp per day each.  
...
![The Yawning Portal attracts adventurers from every corner of the Forgotten Realms and the D&D multiverse. Not sure who a numbered character is? See the answer key, below.](3-Mechanics/CLI/adventures/waterdeep-dragon-heist/img/the-yawning-portal.webp#center)
