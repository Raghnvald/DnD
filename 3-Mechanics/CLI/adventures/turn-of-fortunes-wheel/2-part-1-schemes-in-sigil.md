...
![The floating skull Morte welcomes some less-than-dead adventurers to the Mortuary](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/002-01-001-splash.webp#center)
...
The talking skull is [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) (see his stat block in area M1), a curmudgeonly interplanar traveler plucked from his eternal punishment in the Nine Hells. Tormented by the lies he told in life, [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) masks his pain with a morbid sense of humor and an insufferable dose of sarcasm.

#### Talking with Morte

[Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) is friendly toward the characters and does his best to answer their questions. In conversation, the skull addresses each character as "Chief" or some other inoffensive but still unflattering nickname.

As a result of the multiversal glitch affecting the characters (see this book's introduction), they don't remember much about themselves and don't know why they're in the Mortuary. [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) can answer the following questions or otherwise provide this information:

- **Who Are You?.** [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) describes himself as a debonair planes traveler who died too young. If asked about the whereabouts of his body, [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) quips he never really had a good head on his shoulders or claims to be the skull of the archlich Vecna.  
...
- **How Did We Get Here?.** To have wound up in the Mortuary, [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) reckons the characters must've died and been wheeled in, just like everyone else.  
- **How Do We Leave?.** [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) doesn't know the way out, but he does know the Heralds of Dust, who run the Mortuary, don't take kindly to "fleshies" poking around. He tells the characters to "shake a leg" and make their escape while they still can.  

If the characters ask [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) to accompany them, the skull declines, mentioning that he's waiting for someone else. He doesn't elaborate further.
...
The Mortuary is a dangerous place for 3rd-level characters. If a character dies, refer to the "Running Glitch Characters" section in this book's introduction. If all the characters die at once, they reappear back in the morgue. [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) heckles them on their return.
...
- **Lighting.** The basement is dimly lit by sputtering [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on wall sconces grasped by iron skeletal hands.  

### Mortuary Basement Locations

> [!gallery]
> ![Map 1.1: Mortuary Basement](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/003-map-1-01-mortuary-basement.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/004-map-1-01-mortuary-basement-player.webp#gallery)

The following locations are keyed to map 1.1.

#### M1: Morgue

The characters begin their adventure in the morgue, a sterile room where Heralds of Dust identify the dead. It is described in the "Hey, Chief!" section and contains no creatures other than the talking skull [Morte](3-Mechanics/CLI/bestiary/npc/morte-tofw.md) (see the accompanying stat block).
...
The shelf along the far wall contains a [healer's kit](3-Mechanics/CLI/items/healers-kit-xphb.md) with three uses remaining, several flasks of embalming chemicals, a polished scalpel that functions as a [dagger](3-Mechanics/CLI/items/dagger-xphb.md), and any equipment the characters begin play with.
...
Jex, a wispy-haired Heralds of Dust remnant (see "Morte's Planar Parade"), dissects a [flesh golem](3-Mechanics/CLI/bestiary/construct/flesh-golem-xmm.md) in the autopsy room. The cold-hearted mortician is trying to locate a key she accidentally dropped inside the golem during a routine grafting procedure.
...
This storage room houses objects confiscated from the dead. Two [poltergeists](3-Mechanics/CLI/bestiary/undead/poltergeist-xmm.md) (variant [specters](3-Mechanics/CLI/bestiary/undead/specter-xmm.md)) put on a macabre puppet show for an audience of three slack-jawed [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md). The spirits hover behind a makeshift curtain, using their unintelligible wails to give a pair of eerie dolls the impression of speech.
...
A character can make a DC 14 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check to act alongside the puppets. On a successful check, the skeletons applaud, and the poltergeists reward the character with a [potion of resistance (poison)](3-Mechanics/CLI/items/potion-of-poison-resistance-xdmg.md) from a music box on a high shelf.

##### Treasure

In addition to the [potion of resistance (poison)](3-Mechanics/CLI/items/potion-of-poison-resistance-xdmg.md), this room holds three faction uniforms (your choice), a purse containing 30 gp, and three trinkets (determined randomly by rolling on the [Trinkets table](3-Mechanics/CLI/items/trinket-xphb.md) in the "Player's Handbook").
...
- **Drawer 1.** This drawer is jammed shut. A human [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)—a pasty-faced Herald of Dust named Fruth who fell asleep on the job and was mistakenly pronounced dead—bangs on the door from the inside, begging to be freed. The door can be opened with a successful DC 15 Strength check. If released, the shivering Herald of Dust is friendly toward the characters. However, it's his first day, and he doesn't know the way out of the Mortuary other than the way corpses come in: the chute in area M6.  
- **Drawers 2–4.** Each of these drawers contains a [zombie](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) worker that groans and shields its eyes if exposed to the light. If a character disturbs an occupant further, all three of the drawers swing open, and the zombies attack.  
- **Drawer 5.** This drawer is empty.  
- **Drawer 6.** This drawer is locked. Opening it requires a successful DC 18 Dexterity check using thieves' tools or the key located in the autopsy room (area M2). Inside are a jeweled goblet worth 100 gp, a manifesto of the Heralds of Dust's philosophies, and a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [animate dead](3-Mechanics/CLI/spells/animate-dead-xphb.md).  

![The zombie Maurice dutifully attends one of the Mortuary's deluxe-sized crematoriums](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/006-01-002-zombie-mortuary.webp#center)
...
After the characters enter the crematorium for the first time, a human [zombie](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) wearing a name tag that reads "Maurice" appears in the window of the opposite door and triggers the safety mechanism, trapping any characters inside the crematorium for 1 minute.

Maurice then places its moldering hand on the red lever, preparing to trigger the furnace. The characters can try to distract the zombie from its task with magic or theatrics and by making DC 14 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check. On a successful check, the zombie gurgles contently and loses interest in the lever. It shuffles along when the doors unlock. On a failed check, the zombie pulls the furnace lever.
...
Shortly after the characters arrive, a corpse tumbles down the chute and lands with a splat, disgorging a hostile [black pudding](3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md). As the ooze accosts the party, bodies continue to spill from the chute.

##### Falling Corpses

On initiative count 20, creatures within 10 feet of the chute must succeed on a DC 14 Dexterity saving throw or take 7 (`2d6`) bludgeoning damage and have the [prone](3-Mechanics/CLI/rules/conditions.md#Prone) condition. The chute stops ejecting corpses after 3 rounds.

##### Escape

After dealing with the ooze, the characters can climb up a corpse chute to the surface. Doing so requires a successful DC 15 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check. The chute opens into Ragpicker's Square (see the "Surfacing in Sigil" section later in this chapter).
...
Kingsley, a lawful evil [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) butler, has prepared a meal, tailoring dishes to each character's tastes. If a character removes a platter's lid, it reveals their favorite food, masterfully prepared. Let each player describe what meal awaits their character.
...
Bodies undergo a slow, natural decay in this funereal thicket. Three spindly [dryads](3-Mechanics/CLI/bestiary/fey/dryad-xmm.md) oversee the decomposition, ensuring no one disturbs the process. The dryads allow the characters into the grove, mentioning that though the characters walk as the living do, they stink of death.
...
![Parisa the bariaur tout guides visitors wherever they want to go in Sigil](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/007-01-003-parisa-guides-visitors.webp#center)
...
A Society of Sensation muse (see "Morte's Planar Parade") in a flowery gown approaches the characters, eager to record a new sensation in their [sensory stone](3-Mechanics/CLI/items/sensory-stone-sato.md) (see "Sigil and the Outlands"). Roll on the Sensory Stone Sensations table and consult the entries below to determine the muse's desired sensation and how the characters can help them elicit it.
...
- **Fear.** A character can cause fear in a passing [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) with a successful DC 15 Charisma ([Intimidation](3-Mechanics/CLI/rules/skills.md#Intimidation)) check accompanied by a threatening gesture or ominous interaction. On a failed check, the characters record the citizen's contempt instead.  
- **Joy.** The Sensate points the characters to a sobbing child (noncombatant) holding a broken toy. A character can brighten the child's spirits with a successful DC 15 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check or by repairing their toy. On a failed check, the characters record despair instead.  
- **Serenity.** To record serenity, the Sensate directs the characters to a [satyr](3-Mechanics/CLI/bestiary/fey/satyr-xmm.md) musician nervously preparing for a street-side performance. A character can calm the satyr's nerves with a successful DC 15 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check or the [calm emotions](3-Mechanics/CLI/spells/calm-emotions-xphb.md) spell. On a failed check, the characters record anxiety instead.  

If the characters record the Sensate's desired sensation, the muse rewards them with a [sensory stone](3-Mechanics/CLI/items/sensory-stone-sato.md) of their own. Otherwise, the Sensate recommends the characters get better in touch with their emotions and departs.
...
The Harmonium officers attempt to detain the characters with their pincered polearms and walk them to the city courts. Failing that, they try to knock the characters [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious) and place them in shackles.

#### Development

Whether they evade the Harmonium pursuers or get caught, the characters eventually meet [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md), detailed below. The circumstance of this introduction depends on whether the characters escape or are captured, as detailed below:

- **Escape.** If the characters defeat or evade their pursuers, they quickly run into [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md), who helps them lie low in a nearby establishment as Harmonium backup arrives on the scene.  
- **Capture.** If the characters are bested, Harmonium officers detain them with manacles that function as [dimensional shackles](3-Mechanics/CLI/items/dimensional-shackles-xdmg.md). The manacles' magic fades if they are opened or destroyed. As the characters are taken to the city courts, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) arrives disguised as a Harmonium officer named [Josbert Plum](3-Mechanics/CLI/bestiary/npc/josbert-plum-tofw.md). After unlocking their manacles, "Josbert" helps the characters flee the guards to a safe place nearby.  

![Farrow and Their Alter Ego Josbert Plum](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/008-01-004-farrow-and-plum.webp#center)

#### Farrow, Shadar-kai Spy

[Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) was once a member of a covert network of shadar-kai—elves shaped by the magic of the Shadowfell—on a Material Plane world known as Mystara. Hurled into the Cage after a failed mission on their home world, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) has since acclimated to the City of Doors and put their talents to use. They have curly white hair, ashen skin, and a purplish birthmark on the right side of their face.

The shadar-kai serves the arcanaloth Shemeshka as one of her most reliable agents, using a magic ring that functions as a [hat of disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md) to infiltrate the many factions of Sigil. [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) has a disguise for each ascendant faction, along with a few others. When [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) dons a disguise, they become a new person entirely, losing themself in the role until the spell wears off. Each alter ego pledges fealty to Shemeshka, but only she knows [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md)'s many faces are one and the same. [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md)'s signature birthmark persists across their disguises.

##### Faces of Farrow

In addition to their true form (a neutral, elf [spy](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)), [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) regularly dons the following disguises, replacing their game statistics with those of a "Sigil faction agent" (detailed in "Morte's Planar Parade"):
...
If reduced to 0 hit points while disguised as an alter ego, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) reverts to their true form. Any excess damage carries over to that form.

##### Mysterious Patron

[Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) has been observing the characters from afar. The shadar-kai understands the characters' identity crisis and believes Shemeshka can help, but the spy doesn't disclose their employer's name due to Shemeshka's dire reputation; [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) hopes they've done enough to earn the characters' trust in the meantime.

[Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) offers to guide the characters through Undersigil, a maze of tunnels beneath the city, to their patron's safe house. It's too risky to travel the streets—before the characters know it, every Harmonium officer in Sigil will be looking for them.

If the characters accept [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md)'s guidance, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) leads them to the closest entrance to Undersigil, a boarded-up archway in the basement of a nearby building. If the characters decline, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) tells them it's their funeral; the Harmonium will continue to return in greater numbers until the enforcers succeed, and next time, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) might not be there to bail out the characters.

### Undersigil

[Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) knows a path through Undersigil to Fortune's Wheel, a casino owned by Shemeshka. Though the shortcut avoids the Harmonium officers, the tunneled realms beneath Sigil bring their own dangers, as detailed by the encounters in this section. For more information about "Undersigil", see "chapter 2" of "Sigil and the Outlands".

On entering Undersigil, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) cautions the characters to keep their wits about them.
...
[Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md)'s shortcut takes the characters through the territory of the Coterie of Cakes, a dwindling faction of bullies and bakers who believe the multiverse is a giant, multilayered cake. Forced into Undersigil when their faction didn't quite take, the Cakers aggressively knead nonbelievers into members of their cake-based contingent.

> [!gallery]
> ![Map 2.1: Caker Tea Party](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/009-map-1-02-caker-tea-party.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/010-map-1-02-caker-tea-party-player.webp#gallery)
...
Four Cakers—chaotic evil, human [thugs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) whose maces are rolling pins—prattle on about the "misguided" surface factions of Sigil over cake and tea. The Cakers are initially indifferent toward the characters. Normally, the Cakers don't take kindly to interruptions, but the struggling coterie is eager to recruit new members.

When the characters make themselves known, the troop's ringleader—a pink-haired Caker named [Gertrube](3-Mechanics/CLI/bestiary/npc/gertrube-tofw.md)—invites them to take a seat and join the absurd celebration. If the characters can endure 10 minutes of teatime without offending their hosts, the Cakers allow them to proceed unimpeded. However, if the characters decline their offer or otherwise insult the Cakers during the meal—to refuse a slice of cake is an unforgivable blunder—the Cakers politely ask to be excused, push in their chairs, and attack.

![Gertrube invites visitors to a Caker celebration in Undersigil](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/011-01-005-gertrube.webp#center)

#### Cursed Cake

Unable to secure fresh ingredients in Undersigil, the Cakers prepped this pastry with the blood of a vargouille. A successful DC 16 Intelligence ([Arcana](3-Mechanics/CLI/rules/skills.md#Arcana)) check reveals the wings have black blood; they don't belong to a bat or any other Beast.

Creatures other than Constructs, Fiends, or Undead that partake of the cake are cursed. Over `1d4` hours, a cursed creature's head takes on fiendish aspects. At the end of this time, the creature dies, and its head tears from its body as a hostile vargouille reflection (see "Morte's Planar Parade"). Casting [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md), [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md), or a similar spell on the target before this transformation completes ends the curse and undoes its effects.

#### Cursed Cakers

The Cakers have eaten the cursed cake. Makeup masks their languid complexions, but a character who succeeds on a DC 14 Wisdom ([Insight](3-Mechanics/CLI/rules/skills.md#Insight) or [Medicine](3-Mechanics/CLI/rules/skills.md#Medicine)) check determines the Cakers aren't well. If a Caker is reduced to 0 hit points, a hostile vargouille reflection sprouts from their corpse.
...
Among the Cakers are two stale baguettes, three mincemeat pies, and a lemon tart. Additionally, [Gertrube](3-Mechanics/CLI/bestiary/npc/gertrube-tofw.md) carries a [portal compass](3-Mechanics/CLI/items/portal-compass-sato.md) (see "Sigil and the Outlands").
...
> 
> [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) lets out a satisfied sigh. "This is the place."
^059
...
The door of Fortune's Wheel opens into the Dragon Bar. When the party enters, a polite, snappily dressed tiefling bellhop ([commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) named Valek delivers a letter to them that reads as follows:
...
With the characters in Valek's capable hands, [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md) wishes the characters good luck and departs the casino.
...
Shemeshka's reputation precedes her. Characters who question [Farrow](3-Mechanics/CLI/bestiary/npc/farrow-tofw.md), Valek, or other locals about her might learn the following details:
...
![Wealthy and daring gamblers from across the planes mingle at the Fortune's Wheel casino](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/012-01-006-fortunes-wheel.webp#center)
...
| dice: d4 | Gambler |
|----------|---------|
| 1 | Anisa (chaotic good, human [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) raises money for the poor. A member of the Ring-Givers, a philanthropic Sigil faction, she gives the characters a free casino chip in a charitable yet patronizing gesture. |
| 2 | "Lu," a kindly tiefling [archmage](3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) and secret "Incantifer" (detailed in "Sigil and the Outlands"), is celebrating her birthday. She never discloses her age. |
| 3 | Rule-of-Three, a cryptic [cambion](3-Mechanics/CLI/bestiary/fiend/cambion-xmm.md) disguised as a githzerai, always wagers three chips. |
| 4 | Ignatius Inkblot (lawful neutral [mind flayer](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md)), an undercover detective, investigates the casino for fraud. |
...
- **Security.** Six well-dressed [mezzoloth](3-Mechanics/CLI/bestiary/fiend/mezzoloth-xmm.md) bouncers patrol the casino. The bouncers investigate suspicious activity and respond to aggressive guests. At your discretion, they also investigate if the characters win too often at any one game.  
...
> [!gallery]
> ![Map 3.1: Fortune's Wheel](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/013-map-1-03-fortunes-wheel.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/014-map-1-03-fortunes-wheel-player.webp#gallery)

#### F1: Dragon Bar

The Dragon Bar is an extravagant reception area where gamblers gather before hitting the casino proper.

When the characters enter, the [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) of a washed-up stage magician known as the Great Stephen Amber is performing sleight-of-hand tricks for an audience of a few dozen low-stakes [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md) gamblers and three [gnoll](3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) hecklers.

At the southeast corner of the bar is a simple door minded by an [oni](3-Mechanics/CLI/bestiary/fiend/oni-xmm.md) bouncer named Vez. The oni ensures that only those who meet Shemeshka's thresholds for wealth and interest are admitted to area F3. He has orders to welcome the characters.

##### F1a: Bar

A sculpture of a red dragon head protrudes from the wall above this mirrored bar, which is tended by a dead-eyed, lawful neutral equinal guardinal (see "Morte's Planar Parade") named Brayson. He is taciturn but friendly.
...
Five [steam mephit](3-Mechanics/CLI/bestiary/elemental/steam-mephit-xmm.md) chefs prepare meals for guests in this hectic kitchen.
...
Here gamblers can cash out their winnings or purchase razorleaves for 10 gp apiece. An attentive [imp](3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) cashier sits behind each barred window, retrieving chips and funds from secure portals only they can access. There are two cages in Fortune's Wheel: one in the Dragon Bar with two cashiers and a slightly larger office in the casino proper with three.
...
This golden statue depicts the casino's owner, Shemeshka. The coins are an illusion. Physical inspection of the fountain, a [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell, or a successful DC 12 Intelligence ([Investigation](3-Mechanics/CLI/rules/skills.md#Investigation)) check reveals them as such.

##### Scrying Statue

Creatures in the security room (area F10) can see and hear through the statue as if they were standing in its place. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of divination magic around the statue.

##### Treasure

The statue is worth 5,000 gp, but damaging any part of it draws the immediate ire of two [mezzoloth](3-Mechanics/CLI/bestiary/fiend/mezzoloth-xmm.md) bouncers in the crowd nearby.
...
![Duodrone Slot Machine](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/015-01-08-slot-machine.webp#center)

Putrice, a friendly [night hag](3-Mechanics/CLI/bestiary/fiend/night-hag-xmm.md), just hit it big on the slots, a maze of gambling machines. Most of the slot machines are clockwork cabinets of gnomish construction, but four are stationary, indifferent [duodrones](3-Mechanics/CLI/bestiary/construct/modron-duodrone-xmm.md) that work for the casino. As she pockets the worms for use in dark rituals, Putrice is happy to explain how the luck-based machines work.
...
|----------|--------|-----------------------|---------|
| 1 | Worm | `1d3` wriggling, indifferent, Tiny [larvae](3-Mechanics/CLI/bestiary/fiend/larva-xmm.md) (see the "Dungeon Master's Guide") | [Dimensional shackles](3-Mechanics/CLI/items/dimensional-shackles-xdmg.md) |
| 2 | Tooth | `1d4 + 1` teeth from various animals and strangers | [Spell scroll](3-Mechanics/CLI/items/spell-scroll-level-4-xdmg.md) of [polymorph](3-Mechanics/CLI/spells/polymorph-xphb.md) |
| 3 | Ring | Gold ring worth 15 gp | [Ring of protection](3-Mechanics/CLI/items/ring-of-protection-xdmg.md) |
| 4 | Gear | Toothed copper gear worth 25 gp | [Mace of smiting](3-Mechanics/CLI/items/mace-of-smiting-xdmg.md) |
| 5 | Heart | `1d10` "temporary hit points" given to the participant | [Potion of healing (supreme)](3-Mechanics/CLI/items/potion-of-supreme-healing-xdmg.md) |
| 6 | Pitchfork | `1d6` fire damage dealt to the participant | [Necklace of fireballs](3-Mechanics/CLI/items/necklace-of-fireballs-xdmg.md) |
^slot-machine-results
...
The dealers at each table game are indifferent toward the characters. Dealers abstain from combat but defend themselves if threatened. A [mezzoloth](3-Mechanics/CLI/bestiary/fiend/mezzoloth-xmm.md) pit boss watches over each group of tables, keeping an eye out for cheaters and troublemakers.

![Dare to test your luck with a spin of fortune's wheel](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/016-01-09-spin-the-wheel.webp#center)

##### Dead Hand's Dice

A [vampire](3-Mechanics/CLI/bestiary/undead/vampire-xmm.md) croupier coalesces from a cloud of mist to conduct dead hand's dice, a dice game popular among spacefaring pirates in the Astral Sea. The rules are as follows:
...
Named after a god of revelry, this game is played on a long table embroidered with a flat pattern of an unfolded, twenty-sided die. The game's dealer is also its deciding piece: a [spectator](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) shaped like an icosahedron that rolls itself on the table once all bets have been placed to determine the outcome. The rules are as follows:
...
This area displays a gilded [apparatus of Kwalish](3-Mechanics/CLI/items/apparatus-of-kwalish-xdmg.md), a prize that can be won by spinning the fortune's wheel in area F7. If the characters take the apparatus for a joyride, two [mezzoloth](3-Mechanics/CLI/bestiary/fiend/mezzoloth-xmm.md) bouncers arrive in 3 rounds and demand the characters vacate the apparatus or be escorted to their room by force.
...
The participant wins a [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md).

##### Big-Ticket Prize

The participant wins the gilded [apparatus of Kwalish](3-Mechanics/CLI/items/apparatus-of-kwalish-xdmg.md) in area F6. The apparatus remains in Fortune's Wheel for the evening. At your discretion, Valek can arrange for the apparatus to be delivered to the characters in the Outlands during part 2 of the adventure.
...
The participant wins a [portal compass](3-Mechanics/CLI/items/portal-compass-sato.md) (see "Sigil and the Outlands").
...
The participant wins a [Quaal's feather token (bird)](3-Mechanics/CLI/items/quaals-feather-token-bird-xdmg.md).

##### Flask

The participant wins a [flask of holy water](3-Mechanics/CLI/items/holy-water-xphb.md).

##### Four-Leaf Clover

The participant wins a [stone of good luck](3-Mechanics/CLI/items/stone-of-good-luck-xdmg.md).

##### Fox

The participant wins a citrine [figurine of wondrous power (onyx dog)](3-Mechanics/CLI/items/figurine-of-wondrous-power-onyx-dog-xdmg.md) that becomes a Medium fox ([mastiff](3-Mechanics/CLI/bestiary/beast/mastiff-xmm.md)) when its command word is spoken.
...
The participant gains a boon of luck (see the "Dungeon Master's Guide").
...
The participant wins a [+1 weapon](3-Mechanics/CLI/items/1-weapon-xdmg.md) of their choice.
...
The participant wins one random trinket (roll on the [Trinkets table](3-Mechanics/CLI/items/trinket-xphb.md) in the "Player's Handbook").
...
Chilly fog emanates from the Ice Lounge, a bar chipped from a magic glacier. Its bartender is Phiwi, a warm-hearted [yeti](3-Mechanics/CLI/bestiary/monstrosity/yeti-xmm.md) who speaks Common. The mixologist's specialty is a face-numbing cocktail called the Abominable Yes Please.

![One of the Dubious Vecna Impersonators Who Perform at Fortune's Wheel](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/017-01-010-vecna-impersonator.webp#center)

##### Sulking Dragon

Winter's Bite, a piteous [young white dragon](3-Mechanics/CLI/bestiary/dragon/young-white-dragon-xmm.md), sits at the bar with his head hung, fidgeting with a single gold piece as he drowns his sorrow. The coin is all that remains of the dragon's hoard—he gambled the rest away in a single night. Worse yet, the foolhardy dragon has racked up a 100 gp bar tab he can no longer afford. If a character pays off the dragon's debt, Winter's Bite thanks the character, calling them a "friend of dragonkind" before he departs the casino, never to return.

#### F9: Stage

A lofty, curtained stage rises at one end of the hall. Each evening, it boasts an assortment of acts. Behind the stage, performers prepare for the next act. A high-strung [satyr](3-Mechanics/CLI/bestiary/fey/satyr-xmm.md) stage manager, Grigsby, roves between storage spaces and a dressing room strewn with makeup and bewitching costumes.

Three acts take place on the stage:

- **Beyond Reality with Bimdom Baffletrick.** A charming illusionist in glittery, purple robes, Bimdom Baffletrick (chaotic neutral, gnome [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md)) performs arcane feats. His assistant is a friendly, white-furred [weretiger](3-Mechanics/CLI/bestiary/monstrosity/weretiger-xmm.md) named Felix.  
- **Star Performer.** A silver-haired singer of great renown named Estrella (chaotic neutral, elf [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) brightens the stage each night in a shimmering sequined dress.  
- **Tombstone Troubadour.** An icon from the faraway land of San Citlán, Cecilia Tlapaya (chaotic good [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md)) takes the stage dressed in a sharp suit. The short-haired troubadour haunts a pearl-white guitar and is accompanied by a brassy band of ten lawful good [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md).  

#### F10: Security Room

Three [nothics](3-Mechanics/CLI/bestiary/aberration/nothic-xmm.md) sit in this dim room, staring at screens connected to invisible sensors spread throughout the casino. The nothics can hear and see through the sensors as if they were there, but they can't move them. In addition to their observation capabilities, the sensors extend the range of each nothic's Weird Insight action, allowing the Aberrations to probe the minds of suspicious patrons.
...
Three amicable Vecna impersonators—[doppelgangers](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) mirroring the archlich of the same name—walk the casino floor doing inaccurate but amusing impressions. The trio approaches one of the characters and begins to recite cheesy one-liners, asking the party to "give a lich a hand."

The impersonators are pickpockets who prey on the casino's patrons. While one [Vecna impersonator](3-Mechanics/CLI/bestiary/monstrosity/vecna-impersonator-tofw.md) distracts their target, another rummages through the mark's pocket for valuables.

A character who succeeds on a DC 16 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check catches the impersonator in the act. The doppelgangers attack if they equal or outnumber the characters present. Otherwise, they attempt to break line of sight with the characters and assume new identities. Characters have advantage on Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) checks made to notice the doppelgangers as long as the impersonators are still wearing their Vecna costumes.
...
The arcanaloth promises to dig up information on the characters' pasts in exchange for a favor. She asks the characters to locate [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md), a monodrone that vanished into the Outlands some time ago and hasn't returned. She's too busy with the casino to track him down herself.
