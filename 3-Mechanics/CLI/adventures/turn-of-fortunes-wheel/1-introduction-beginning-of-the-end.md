...
![Surreal wildernesses cover the Outlands, The realm at the hub of the Outer Planes](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/000-00-002-surreal-wildernesses.webp#center)
...
Part 2: Into the Outlands sees the characters journeying to the Outlands at Shemeshka's request to recover a modron fugitive called [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md). As the characters explore the Outlands, they'll visit surreal locations, lay claim to a walking castle, learn how to find [R04M](3-Mechanics/CLI/bestiary/npc/r04m-tofw.md) using a damaged magic item called a [mimir](3-Mechanics/CLI/items/mimir-sato.md), and witness unnatural events plaguing the plane.
...
![Wizard, paladin, and druid incarnations of the same glitch character share a distinctive sunburst nexus feature](3-Mechanics/CLI/adventures/turn-of-fortunes-wheel/img/001-00-001-glitch-character.webp#center)
...
A dead character's body doesn't vanish when another incarnation manifests. Glitch characters can be affected by spells such as [raise dead](3-Mechanics/CLI/spells/raise-dead-xphb.md) and [resurrection](3-Mechanics/CLI/spells/resurrection-xphb.md) until their next incarnation appears. Spells that permanently alter characters, such as [reincarnate](3-Mechanics/CLI/spells/reincarnate-xphb.md), continue to affect an incarnation even after they die and return.
