...
A patrol consists of five sahuagin, one [sahuagin coral smasher](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and one [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) drawn from the roster in area 24. If that area is depleted of sahuagin, no more patrols are sent out.
...
| Area | Occupants at Start | Notes |
|------|--------------------|-------|
| 23 | 2 [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 2 sahuagin priestesses | These sahuagin remain here until encountered. |
| 24 | 25 sahuagin, 5 [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*5 [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md)* | Guard patrols are drawn from this area until all the occupants are defeated. |
...
| 26 | 2 sahuagin priestesses, 2 [sahuagin hatchling swarms](3-Mechanics/CLI/bestiary/beast/sahuagin-hatchling-swarm-gos.md)* | The swarms emerge if the priestesses are alerted. The priestesses try to flee to 24; if one does so, it returns with 5 sahuagin and 1 coral smasher. |
| 27 | 1 [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 12 sahuagin,12 [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md)* | These sahuagin remain here until encountered. |
...
| 34 | 1 sahuagin priestess, 4 [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 37 | [Maw of Sekolah](3-Mechanics/CLI/bestiary/npc/maw-of-sekolah-gos.md),* 3 sahuagin priestesses | These creatures remain here until encountered. |
| 39 | 10 [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 42 | Kepmak (sahuagin baron), Thadrah ([sahuagin high priestess](3-Mechanics/CLI/bestiary/humanoid/sahuagin-high-priestess-gos.md)*), 2 [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md),* 1 sahuagin,2 [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 45 | Seklaz (sahuagin baron), 1 sahuagin,1 [sahuagin wave shaper](3-Mechanics/CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md)* | If combat occurs, the sahuagin tries to escape. If it does so, it returns with 5 sahuagin and 1 coral smasher in 5 rounds. |
^sahuagin-roster-level-2
...
| 53 | Makaht ([sahuagin blademaster](3-Mechanics/CLI/bestiary/humanoid/sahuagin-blademaster-gos.md)*), 49 sahuagin,5 [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md)* | These sahuagin remain here until encountered. |
...
| 56 | 2 [sahuagin wave shapers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md),* 6 sahuagin, 2 [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
...
Six sahuagin, two [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and one [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) guard the entrance. If the door is forced open, one of the sahuagin immediately moves toward the west wall to ring the gong, while the remaining guards defend the entrance. If this creature is slain or otherwise prevented from ringing the gong, no other defender takes its place.
...
If the gong in area 1 has not been rung and the fight at the entrance is going badly for the defenders, one of the sahuagin tries to flee to area 12 to summon reinforcements. It returns with the guards posted in area 12 (five sahuagin, two [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) [see appendix C], and two sahuagin priestesses) in 10 rounds.
...
The coffers are not locked. They contain seventy-five daggers with scabbards.
...
Unless they were called to help in areas 1 and 2, five sahuagin, two [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and two sahuagin priestesses occupy this room.
...
The leather cloak hanging here is a cloak of the manta ray. The armor is a suit of mithral armor (plate) and a suit of normal chain mail. The three shields, all usable, bear the insignia of Prince Monmurg—a spire rising against a blue ocean sky.
...
There are ten slaves in this area: four orcs, four hobgoblins, and two lizardfolk. See the "Slaves of the Sahuagin" sidebar for more information.

Four [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), one [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C), one sahuagin priestess, and two sahuagin oversee the work of the slaves. The sahuagin attack any intruders on sight.
...
Two **sahuagin champions** (see appendix C) and two sahuagin priestesses occupy this room. Their revelry grants them disadvantage on Perception checks to detect the characters as they approach the chamber.
...
Twenty-five sahuagin, five [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), and three [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) occupy this large common living quarters. Their weapons are close at hand.
...
A [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) prepares a squad of twelve sahuagin and twelve [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C) for patrol and guard duty. The sahuagin are armed and about to move out to relieve guards currently on active duty. They move to slay intruders the moment they notice them.
...
A [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) prepares a squad of six sahuagin, six [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), four [sahuagin deep divers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md), and four [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md) for patrol and guard duty (see appendix C for all but the sahuagin). The sahuagin are armed and about to move out to relieve guards currently on duty. They treat intruders as hostile.
...
A sahuagin priestess is tending to the armored plates of four [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) in this room. She is startled to discover intruders have made it this far. She and the sharks attack all intruders.
...
The hidden compartment contains four portions of rapture weed and a gold flask filled with three doses of a restorative draught (potions of healing).
...
Baron Kepmak (sahuagin baron) sits on his throne, while high priestess Thadrah ([sahuagin high priestess](3-Mechanics/CLI/bestiary/humanoid/sahuagin-high-priestess-gos.md); see appendix C) stands at his side. The complainant is a sahuagin, while the two floating at attention are [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C). Two [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) swim high above the throne; they are the pets of the baron and defend him if he is attacked.
...
- Six tridents, each with a pearl (10 gp) set into the grip end  
- Eight warhammers with a shark motif carved into the head  
...
[Kysh](3-Mechanics/CLI/bestiary/npc/kysh-gos.md) was unconscious when he was brought into the fortress, so he has no idea of its layout, nor does he know what has happened to his sea lion companion.
...
The sound of the slab being smashed rings through the nearby rooms, drawing the attention of the three [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 50, if they are still alive. They arrive 5 minutes later with twelve sahuagin and two [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C) drawn from area 60.
...
Noise of melee here will certainly be heard at the guard post (area 58), bringing two [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and six sahuagin to this area to investigate 3 rounds later. The two [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 55 also hear the combat and arrive on the round after it starts.
...
Though originally built to house more than twenty sahuagin, this area has recently been reserved for the sahuagin wave shapers. Currently, two [sahuagin wave shapers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C), six sahuagin, and two [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) occupy this area.
...
Two [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and six sahuagin keep watch in this area.
...
Most of the guards stationed here have slipped away to watch the fight in area 53. A [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and one sahuagin are left behind.
...
The occupants include forty-five sahuagin, ten [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), seven [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md), four [sahuagin deep divers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-deep-diver-gos.md), and two [sahuagin wave shapers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C for all but the sahuagin). The sahuagin in this area are socializing, performing drills, or resting in the seaweed beds. Six [shell sharks](3-Mechanics/CLI/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) also swim in the cavern, close to the roof of the natural area to the south. Shoals of tiny silver fish dart about here and there, obstructing vision in places.
...
|------|-----------|
| 1–4 | `2d6` sahuagin |
| 5–11 | `3d6` sahuagin and 1 [sahuagin champion](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md)* |
| 12–18 | `3d6` sahuagin, 2 [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md)*, and 1 [sahuagin coral smasher](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md)* |
^sahuagin-defenders
...
However the party gains access to the fortress, they find the north entrance under heavy guard. A sizable force of ten sahuagin, two [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md), and two [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md) hold ranks here, prepared to face whatever attack might come. Any conflict here that lasts for more than 5 rounds puts the entire fortress on alert.
...
The sahuagin are using these barracks as a forward command post. Thirty sahuagin, three [sahuagin champions](3-Mechanics/CLI/bestiary/humanoid/sahuagin-champion-gos.md), five [sahuagin coral smashers](3-Mechanics/CLI/bestiary/humanoid/sahuagin-coral-smasher-gos.md), and Blademaster Makaht ([sahuagin blademaster](3-Mechanics/CLI/bestiary/humanoid/sahuagin-blademaster-gos.md), see appendix C), if he survived, are now stationed here.
