...
Four tut-krogh caterpillars hide among the cluttered rooms, one each in areas H3, H4, H5, and H7. A character can determine whether there is a caterpillar in a room by spending an action and succeeding on a DC 13 Intelligence (Investigation) or Wisdom (Perception) check.
