...
The characters approach Milpazul at the same time as a group of bounty hunters searching for the outlaw [Paloma](/3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md). The man on horseback is the group's lookout; when he sees the characters, he assumes they're either a rival band of bounty hunters or [Paloma](/3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md)'s bandit allies. Characters who have a passive Wisdom (Perception) score of 12 or higher notice a trail of dust rising from the opposite side of the village, suggesting a group entering the community.
...
While no one is willing to discuss [Paloma](/3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md)'s whereabouts, a character who succeeds on a DC 14 Charisma (Persuasion) check can gather the following information about the so-called outlaw from Rufina or the other villagers:
...
As conversation dies down, [Paloma](/3-Mechanics/CLI/bestiary/npc/paloma-jttrc.md) emerges from a door leading to the cellar and approaches the characters. She is wrapped in a rebozo and suffers from sereno with 3 levels of exhaustion. If the characters threaten to take her for the bounty, the dwarf [veterans](/3-Mechanics/CLI/bestiary/humanoid/veteran.md) rush to protect her, and Rufina warns the characters that not just the villagers, but the folk of the entire region, will turn against them if they proceed.
...
A 5th-level glyph of warding holding a passwall spell is inscribed on the floor in front of the door. Characters can spot the glyph with a successful DC 15 Intelligence (Investigation) check. If someone opens the door while standing on the glyph, the glyph triggers and casts its spell on the floor around it, opening a pit into area H3. Each creature standing in the shaded spaces in front of the door on map 4.1 falls 30 feet into area H3 and takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) bludgeoning damage. The glyph's effects can be avoided by opening the door from a distance, which prevents the spell from being triggered.
...
The bookshelves hold a mix of fiction, histories, and more. A character who scans the shelves and succeeds on a DC 14 Intelligence (Investigation) check finds a spell scroll of lesser restoration and a book containing rituals for the alarm, find familiar, and illusory script spells.
...
- If the characters kept [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md)'s cityscape drawings, they can use it to find the vecindad with a successful DC 14 Wisdom (Survival) check.  
...
|-----------|--------------|
| 1 | A 20-foot-tall, papier-mâché skeleton puppet walks across the street. Make a DC 10 Dexterity saving throw to avoid being stepped on. On a failed check, you take `dice:2d4\|noform\|noparens\|avg\|text(5)` (`2d4`) bludgeoning damage and fall prone. |
...
If the characters catch Itzmin, he tells them where [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) is in exchange for his release. Should Itzmin escape, the character who has the highest passive Wisdom (Perception) score sees a spotted owl ([Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) in his owl form) overhead, watching Itzmin. They can follow the owl to the metalworks.
...
If [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) attacks the characters before they can speak with him, a character can use an action to try to calm [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) by making a DC 14 Charisma (Persuasion) check. Succeeding on this check once causes [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) to hesitate, but he keeps attacking. Succeeding twice causes [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) to regain control and transform back into a human (as noted above).
...
A character who has a passive Wisdom (Insight) score of 13 or higher can tell that the tlacatecolo's control of [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) is not absolute and deduces that magic might disrupt that control. If [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) is targeted by a lesser restoration or remove curse spell, the tlacatecolo is forced to leave his body for 5 minutes. During this time, the [tlacatecolo](/3-Mechanics/CLI/bestiary/fiend/tlacatecolo-jttrc.md) becomes a separate entity that continues fighting. [Serapio](/3-Mechanics/CLI/bestiary/npc/serapio-jttrc.md) uses the [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner.md) stat block and keeps out of battle.
