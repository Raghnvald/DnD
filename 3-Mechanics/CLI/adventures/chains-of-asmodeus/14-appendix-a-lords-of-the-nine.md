...
![Flying fortresses patrol Avernus.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/214-0.webp#center)
...
- **Cast a Spell.** The archdevil uses their Spellcasting feature to cast an available spell. If the spell normally requires concentration, it lasts for the full duration instead.  
...
- **Frenzy.** The archdevil casts Haste on themself. The effect ends at initiative count 20 of the next round.  
...
![Archdevil Lair Action List; Summoned Underlings](3-Mechanics/CLI/tables/archdevil-lair-action-list-summoned-underlings-coa.md)
...
Based on events in prior adventures, the current lord of Avernus might be either [Bel](3-Mechanics/CLI/bestiary/npc/bel-coa.md) or [Zariel](3-Mechanics/CLI/bestiary/npc/zariel-coa.md).
