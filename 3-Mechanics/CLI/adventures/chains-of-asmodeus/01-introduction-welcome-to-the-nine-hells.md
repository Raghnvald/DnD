...
This story takes place in the Nine Hells and sees the characters confront its ruler, [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). They venture into the Nine Hells to save the souls of their loved ones (or their own) and are aided by a powerful faction. This faction has its own reasons for wanting revenge on [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). With the help of the characters, the faction believes it can deal a devastating blow to him. In return for a favor, the faction provides characters with access to the Nine Hells and a means of traversing the different layers. The characters travel by barge down the River Styx, also known as the River of Blood, a cross-planar river that links the layers of the Nine Hells. Those who touch or drink from its waters risk forgetting their past lives permanently.

The characters try to avoid [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)'s attention, believing themselves unwanted infiltrators who are there to undermine the Lord of the Nine Hells. Little do they know, they're here by his design. They're integral to one of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)'s plots, and he aims to recruit them. But to get them under his control, he needs to corrupt them. It took years of careful planning, and now, finally, he has the characters exactly where he wants them. They will be tested, with temptations and traps set which only the pure of heart can resist. Each time a character gives in to sin, a link is added to the chains that bind them to the Nine Hells, to [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). Can they save their loved ones without losing themselves in the process?

## The Nine Hells

The Nine Hells is the ultimate plane of evil and the epitome of premeditated cruelty. The devils of the Nine Hells are bound to obey the laws of their superiors, and at the very top of the hierarchy is [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). The Nine Hells has nine layers. The first eight are ruled by archdevils who answer to [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). To reach the deepest layer of the Nine Hells, one must descend through all eight of the layers above it, in order. The most expeditious means of doing so is the River Styx, which plunges ever deeper as it flows from one layer to the next. Only the most courageous adventurers can withstand the torment and horror of that journey.
...
- **Anger.** The sin of anger fuels wrath, vengeance, and inner turmoil. It takes root in Avernus, the domain of the archdevil [Zariel](3-Mechanics/CLI/bestiary/npc/zariel-coa.md).  
- **Greed.** This sin leads to a life of accumulating wealth and sharing very little—a sin nurtured in Minauros, the domain of the archdevil [Mammon](3-Mechanics/CLI/bestiary/npc/mammon-coa.md).  
- **Jealousy.** The jealous are never satisfied with what they have. Phlegethos, the domain of the archdevils [Belial](3-Mechanics/CLI/bestiary/npc/belial-coa.md) and [Fierna](3-Mechanics/CLI/bestiary/npc/fierna-coa.md), is where jealousy thrives.  
- **Pride.** Some say that this is the original sin which led to all other sins and is the sin that led to the fall of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) and thus is his domain.  

### Sins to the Other

- **Betrayal.** Betraying a loved one, a god, or a sovereign can damn one's soul to Stygia, the domain of the archdevil [Levistus](3-Mechanics/CLI/bestiary/npc/levistus-coa.md).  
- **Deceit.** Lying that leads to harm is, like Maladomini, the domain of the archdevil [Baalzebul](3-Mechanics/CLI/bestiary/npc/baalzebul-coa.md).  
- **Harm.** Mutilating or torturing an enemy is wicked work that warms the ice-cold heart of [Mephistopheles](3-Mechanics/CLI/bestiary/npc/mephistopheles-coa.md), the archdevil who presides over Cania.  
- **Murder.** Killing an innocent or family member is evil business that comes home to roost in Dis, the domain of the archdevil [Dispater](3-Mechanics/CLI/bestiary/npc/dispater-coa.md).  
- **Oppression.** Unjustly imprisoning enemies and denying their freedom is the devil's work and reflective of Malbolge, the domain of the archdevil [Glasya](3-Mechanics/CLI/bestiary/npc/glasya-coa.md).  
...
> 
> Some players may be uncomfortable if a soul is consigned to the Nine Hells for a sin when the person so condemned lived a good life in aggregate. However, all the souls consigned to the Nine Hells in this adventure were deceived by [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). While they committed sins, that wasn't the reason they were consigned to the Nine Hells. However, [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) ensures that the soul is punished as if the sin was the one that defined it.
^an-unjust-universe

![The bitter smell of sulphur and the agonising screams of tormented souls fill the air of the Nine Hells](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/005-0.webp#center)
...
![Even the icy plains of Stygia can be beautiful.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/006-0.webp#center)
...
- **Souls.** Each player must choose a soul to save. It might be the soul of a loved one or their own soul. The soul, and the sins associated with it, determine where [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) has hidden it away to be tormented.  
...
- **Temptations and Corruptions.** [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) tries to lure the characters into his grasp. Each time the characters go back to the Nine Hells they may find different temptations. Some may be easy to resist, others not so much. Giving in to temptation corrupts them.  

## Story Overview

The Lord of the Nine Hells, [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md), is known to have countless plots, some that take centuries to come to fruition, while others he conceives of and executes within a few years. This is a story about one of the latter.

[Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) desires to corrupt and dominate some of the most powerful mortals in a generation. To further his designs, [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) wants to convert these powerful mortals to his cause. To this end, [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) has made pacts with many of the powerful and influential of the Forgotten Realms. This includes kings, queens, high priests, and powerful adventurers. The player characters are among those that he has targeted. When not able to convince such august personages, he has gone after their spouses, children, or friends. He comes to them when they're in need, providing a service with the understanding that if they die before they can return the favor, their soul is forfeit.

[Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) never intended to allow these infernal contracts to be fulfilled by their mortal signatories. Instead, he has given a list of names to the most skilled killers in the world.

These killers embark on a murder spree to kill all the people on the list, thus consigning their souls to the Nine Hells and to the corrupting influence of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) and his court of devils. Among the victims when the adventure begins are the spouses, children, or friends of the characters. One or more characters may also be among those who are murdered.
...
> This chapter provides the information needed to implement [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)'s plans throughout the campaign. It describes the random encounters found in the Nine Hells, the temptations [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) has put in place to ensnare the characters, and how to track their corruption as a result of these temptations.
%% %%
...
> The characters need to find a way out of their contracts. They may be able to gain entry to the Oasis of the Lethe to do so. If not, they must challenge [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) himself.
%% %%
...
- **Barachiel.** A Hellrider and one of the friends that [Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) seeks.  
...
- **Tiax.** [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md)'s sidekick and comedy relief.  
...
- **Ramius, Hellrider of Elturel (Good).** [Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) has a deep hatred for [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) because of what the archdevil did to his home city and its patron angel. [Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md)' lifelong friend was a victim of the recent murder spree. The paladin wants the characters to enter the Nine Hells to rescue his friend and other Celestials who have fallen victim to [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). [Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) and the Hellriders know the location of these beings trapped within the Nine Hells.  
- **Zythan, High Diviner of the Conclave of Halruaa (Neutral).** [Zythan](3-Mechanics/CLI/bestiary/npc/zythan-coa.md) has foreseen a dreadful consequence of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)'s plan. A dangerous soul known as the Unmaker has emerged and must be dealt with. [Zythan](3-Mechanics/CLI/bestiary/npc/zythan-coa.md) and the mages of Halruaa have divined the location of powerful magic items that can help the characters in this quest. He wants the characters to gather these, to defeat the threat he has foreseen. These include some of the most famed items in the "Dungeon Master's Guide".  
- **Sarevok, High Priest of the Deathstalkers of Bhaal (Evil).** The Deathstalkers of Bhaal feel uneasy about their alliance with [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). They fear he will betray Bhaal and that the divine power promised him will never be given. [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) will help the characters navigate the River Styx and rescue the souls of their loved ones, but only if they help Bhaal gain leverage against [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) by stealing some of the most infamous and powerful artifacts of the Nine Hells. He aims to keep one, the others are for the characters to decide what to do with.  

More information on the patrons can be found in the "Group Patron" section of this chapter.

![The shores of the River Styx are littered with grotesque landmarks.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/009-0.webp#center)

### Koh Tam

The group patron puts the characters in contact with [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) (see chapter 1), a priest serving the God of the Dead. [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) is an expert on the Nine Hells and knows how to navigate the River Styx. But first, he must learn where the souls that the characters seek might be found. To that end, he summons [Baalzebul](3-Mechanics/CLI/bestiary/npc/baalzebul-coa.md) and invites the archdevil to possess him. The characters must deal with the devil to learn the location of the souls. Afterwards, they must exorcise [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) of the devil's spirit.

### Through the Nine Hells

[Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md) knows how to navigate the River Styx and offers to guide the characters through the Nine Hells to help them find the souls they seek. He opens a portal to the first layer of the Nine Hells, Avernus.

The characters must descend through the layers of the Nine Hells along the treacherous River Styx. It is possible to move against the flow of the River Styx, but it is difficult. However, [Koh Tam](3-Mechanics/CLI/bestiary/npc/koh-tam-coa.md)'s barge has a magical addition that allows him to use the Plane Shift spell to travel to a layer of the Nine Hells above the current one.

The characters have two objectives if they're to save the souls of their loved ones or their own:

- **Finding the Lost Souls.** The main objective of the characters is to find the souls that have been trapped by [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md).  
- **Dealing with Asmodeus.** Once the characters have found their lost loved ones, they must convince [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) to allow them to be freed. They can do this by gaining leverage over him, by performing a service for him, or signing an infernal contract. Characters who are able to resist temptation within the Nine Hells might even find a loophole allowing them to escape, successfully avoiding all of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md)'s snares.  

### Finale: Asmodeus

[Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) is a lawful evil deity who is genuinely one of the most powerful creatures in the universe. He likes to appear respectful and well-mannered when speaking with others, and he hates being wrong. In fact, sometimes he even pretends to know more than he does, or that he can predict what actions creatures will take before they take them, even though he can't. He enjoys making contracts with others, especially when their end of the bargain is their soul.

At the climax of the adventure, the characters may need to make a contract with [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) to release the souls of their loved ones. The characters need as much leverage as possible when going into the contract. Without enough leverage, they may have to promise to do services for [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md).

![Discarded war machines are a source of income for many scavengers.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/010-0.webp#center)
...
The following sections describe the souls available for each player to pick from. The chosen soul is the soul their character seeks to save. The player can either choose a lost soul, a loved one whose soul is trapped in the Nine Hells, or they can decide it's their character's soul that is damned. [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) keeps these souls in phylacteries scattered around the Nine Hells. Phylacteries don't need to be in the layer associated with their sin, but usually are. When characters locate such a phylactery, they must bring it with them for the remainder of the adventure.

Only [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) can break the infernal contract that binds a soul to its phylactery. To convince him to do this, characters must gain leverage over him, as described in later sections.

![Demons, ancient gods, and titans... All beings find their way into the Nine Hells.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/011-0.webp#center)
...
![Business Partner (Betrayal) and Childhood Friend (Sinless)](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/013-0.webp#center)

### Father (Greed)

You loved your father. He helped shape you into the hero you're now. He supported your ambitions, gave you advice when you needed it, and was there for you when things looked darkest. Your mother loved him even more, for he was personable, funny, and kind. But everyone has a flaw, and your father's flaw was gambling. The risk-taking behavior that you inherited from him made you into a hero, but he didn't have your outlet. Instead, he took risks with money. His debts grew, as did his shame, but you never knew. Your mother didn't tell you about it until it was too late. [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) used his shame to convince him to sign an infernal contract.
...
![Spouse/True Love (Deceit) and Student (Harm)](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/016-0.webp#center)
...
> 
> When a character whose soul is trapped in the Nine Hells dies, resurrection magic can return that character to life no matter how much time has passed. For example, a Revivify spell works on the character even if a week has passed since the character died. However, if the character's body is completely destroyed, not even a Wish or True Resurrection spell can bring the character back.
^not-having-a-soul

#### The Chosen One (Pride)

![The Chosen One (Pride)](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/017-0.webp#center)
...
![The Furnace (Anger) and The Great Con (Deceit)](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/018-0.webp#center)
...
![The Heartless Master (Oppression) and The Infinite Treasure (Greed)](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/019-0.webp#center)
...
![The Merciless (Harm) and The Oathbreaker (Betrayal)](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/020-0.webp#center)
...
![Patricide (Murder) and The Queen (Jealousy)](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/021-0.webp#center)
...
This story is true, for a century ago a gateway to the Nine Hells opened in the Fields of the Dead north of the city of Elturel. The skilled knights of Elturel fought a losing battle against the Fiends that poured from this gate. The High Rider of Elturel implored his people to pray to the gods for help. Their prayers were answered when the angel [Zariel](3-Mechanics/CLI/bestiary/npc/zariel-coa.md) arrived in Elturel with a small host of allies. She rallied and trained an army of thousands and then led them into the gateway to the Nine Hells. While she was successful at destroying the gate, [Zariel](3-Mechanics/CLI/bestiary/npc/zariel-coa.md) herself was captured by [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) and corrupted into the archdevil who now rules over Avernus. The knights of Elturel were renamed to the Hellriders in dedication to [Zariel](3-Mechanics/CLI/bestiary/npc/zariel-coa.md) and the warriors who followed her into the Nine Hells.

The Hellriders have learned that some of [Zariel](3-Mechanics/CLI/bestiary/npc/zariel-coa.md)'s allies are still alive in the Nine Hells. They remain uncorrupted but suffer horrific tortures. The Hellriders feel duty bound to rescue them.
...
- **Barachiel.** He is a prisoner of the Brothers Adramalech and Morax and can be found on their infernal warship prowling the River Styx.  
...
The Hellriders know better than most the evils found in the Nine Hells and would never send anyone there without protection. After spending the entirety of a long rest in the Nine Hells, you gain the benefit of a Greater Restoration spell.

#### Celestial Cavalry

While much of the journey through the Nine Hells follows the River Styx, it is likely that you will occasionally leave on excursions or scouting missions. While you remain in the Nine Hells, you may cast the Phantom Steed spell at will, as a ritual.
...
![Ramius Dangremond](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/023-0.webp#center)

[Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) Dangremond is the commander of the Hellriders of Elturel. He never wanted the position, but because of the many deaths within the ranks of the order, he had to step up. His friend and fellow Hellrider, [Barachiel](3-Mechanics/CLI/bestiary/npc/barachiel-coa.md), was the main reason he was able to grow into a capable commander. The loss of his friend saddens [Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md), and the news of his imprisonment within the Nine Hells gnaws at his soul.

[Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) (see the accompanying stat block) is a natural horseman and a gifted athlete. The soldiers he leads often say that there isn't anything that [Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) can't mount or ride. He's ridden horses, mammoths, and machines into battle. Loyalty, honor, and duty are virtues that [Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) upholds. He fears nothing other than losing those he cares for.

#### Ramius as a Contact

[Ramius](3-Mechanics/CLI/bestiary/npc/ramius-coa.md) doesn't have the personal ability to cast Plane Shift—instead, he has been given a magic item that allows him to visit with the party every few days. When he arrives, he brings general supplies such as food and water, and treats any wounds, curses, or diseases the party has (to the best of his ability). Afterwards, he offers a selection of useful magic items for purchase, or, if the party already has excess magic items, he offers to purchase them for keeping or disposal.
...
| [Amulet of Health](3-Mechanics/CLI/items/amulet-of-health.md) | 12,000 gp |
| [Bracers of Defense](3-Mechanics/CLI/items/bracers-of-defense.md) | 12,000 gp |
| [Cloak of Protection](3-Mechanics/CLI/items/cloak-of-protection.md) | 600 gp |
| [Gauntlets of Ogre Power](3-Mechanics/CLI/items/gauntlets-of-ogre-power.md) | 550 gp |
| [Holy Avenger](3-Mechanics/CLI/items/holy-avenger.md) | 175,000 gp |
| [Horseshoes of a Zephyr](3-Mechanics/CLI/items/horseshoes-of-a-zephyr.md) | 18,000 gp |
| [Horseshoes of Speed](3-Mechanics/CLI/items/horseshoes-of-speed.md) | 6,500 gp |
| [Horn of Valhalla (silver)](3-Mechanics/CLI/items/horn-of-valhalla-silver.md) | 25,500 gp |
| [Javelin of Lightning](3-Mechanics/CLI/items/javelin-of-lightning.md) | 500 gp |
| [Mace of Smiting](3-Mechanics/CLI/items/mace-of-smiting.md) | 9,000 gp |
| [Mithral Armor](3-Mechanics/CLI/items/mithral-armor.md) | 700 gp |
| [Ring of Protection](3-Mechanics/CLI/items/ring-of-protection.md) | 12,000 gp |
| [Shield, +1](3-Mechanics/CLI/items/1-shield.md) | 450 gp |
| [Shield, +2](3-Mechanics/CLI/items/1-shield.md) | 12,000 gp |
| [Shield, +3](3-Mechanics/CLI/items/1-shield.md) | 40,000 gp |
| [Sun Blade](3-Mechanics/CLI/items/sun-blade.md) | 35,000 gp |
^purchasing-items-from-ramius
...
The Conclave has become interested in the events put into motion by [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) because their diviners have foreseen that the archdevil's scheme will result in a dangerous soul being unleashed.
...
- **Artificer.** The [Manual of Golems (iron)](3-Mechanics/CLI/items/manual-of-iron-golems.md), which can be found in Stygia at the Chasm of Found Things.  
- **Barbarian.** [Belt of Giant Strength (storm)](3-Mechanics/CLI/items/belt-of-storm-giant-strength.md), which can be found in Minauros at the Ineffable Trove.  
- **Bard.** [Instrument of the Bards (Ollamh Harp)](3-Mechanics/CLI/items/instrument-of-the-bards-ollamh-harp.md), which can be found in Dis at the Agora of Floating Knives.  
- **Cleric.** [Rod of Resurrection](3-Mechanics/CLI/items/rod-of-resurrection.md), which can be found in Stygia at the Chasm of Found Things.  
- **Druid.** [Staff of the Woodlands](3-Mechanics/CLI/items/staff-of-the-woodlands.md), which can be found in Maladomini at the Eye Market  
- **Fighter.** [Belt of Giant Strength (storm)](3-Mechanics/CLI/items/belt-of-storm-giant-strength.md) which can be found in Minauros at the Ineffable Trove.  
- **Monk/Rogue.** [Cloak of Invisibility](3-Mechanics/CLI/items/cloak-of-invisibility.md), which can be found in Dis at the Agora of Floating Knives.  
- **Paladin.** [Holy Avenger](3-Mechanics/CLI/items/holy-avenger.md), which can be found in Stygia at the Chasm of Found Things.  
- **Ranger.** [Iron Horn of Valhalla](3-Mechanics/CLI/items/horn-of-valhalla-iron.md), which can be found in Dis at the Agora of Floating Knives.  
- **Sorcerer/Warlock/Wizard.** [Staff of the Magi](3-Mechanics/CLI/items/staff-of-the-magi.md), which can be found in Cania at the Sorrow Mine.  
...
|-------|------|
| Blank scroll | 10 gp |
| [Broom of Flying](3-Mechanics/CLI/items/broom-of-flying.md) | 600 gp |
| [Crystal Ball](3-Mechanics/CLI/items/crystal-ball.md) | 30,000 gp |
| Divination [Spell Scroll (1st level)](3-Mechanics/CLI/items/spell-scroll-1st-level.md) | 100 gp |
| Divination [Spell Scroll](3-Mechanics/CLI/items/spell-scroll.md) ([2nd](3-Mechanics/CLI/items/spell-scroll-2nd-level.md) or [3rd](3-Mechanics/CLI/items/spell-scroll-3rd-level.md) level) | 500 gp |
| Divination [Spell Scroll](3-Mechanics/CLI/items/spell-scroll.md) ([4th](3-Mechanics/CLI/items/spell-scroll-4th-level.md) or [5th](3-Mechanics/CLI/items/spell-scroll-5th-level.md) level) | 2,000 gp |
| [Gem of Seeing](3-Mechanics/CLI/items/gem-of-seeing.md) | 10,000 gp |
| [Headband of Intellect](3-Mechanics/CLI/items/headband-of-intellect.md) | 400 gp |
| [Helm of Comprehending Languages](3-Mechanics/CLI/items/helm-of-comprehending-languages.md) | 600 gp |
| Material spell component costing up to 1,000 gp | 75% original cost |
| [Medallion of Thoughts](3-Mechanics/CLI/items/medallion-of-thoughts.md) | 350 gp |
| [Ring of Mind Shielding](3-Mechanics/CLI/items/ring-of-mind-shielding.md) | 500 gp |
| [Ring of Spell Storing](3-Mechanics/CLI/items/ring-of-spell-storing.md) | 12,000 gp |
| [Wand of Binding](3-Mechanics/CLI/items/wand-of-binding.md) | 8,000 gp |
| [Wand of Magic Detection](3-Mechanics/CLI/items/wand-of-magic-detection.md) | 500 gp |
| [Wand of Wonder](3-Mechanics/CLI/items/wand-of-wonder.md) | 9,500 gp |
^conclave-items

### Halruaan Contact: Zythan Avhoste

![Zythan Avhoste](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/027-0.webp#center)

[Zythan](3-Mechanics/CLI/bestiary/npc/zythan-coa.md), like many other Halruaans, spent his early years studying the arcane arts. His talent in Divination magic made him particularly useful to the Conclave, and they quickly sought him out. Under their tutelage, his skill flourished, and he became a powerful mage. Those that know him personally recount his matter-of-fact personality, his green hair, and his third eye that seems to open when he performs magic. He rarely speaks of himself, however, choosing instead to focus his attention on the future.

When he first received an official position within the Conclave, [Zythan](3-Mechanics/CLI/bestiary/npc/zythan-coa.md) wanted to prove himself. He spent countless hours peering into the future and examining potential outcomes. One fateful night, he just barely caught sight of a forbidden ritual being prepared—a ritual that could cost the lives of many Halruaans. Because of his sight, the Conclave was able to intervene in time, and he was quickly promoted and showered with praise.

For the past few months, [Zythan](3-Mechanics/CLI/bestiary/npc/zythan-coa.md) has felt like something was off: at first, he suspected another ritual within Halruaa. He requisitioned the help of the other diviners, as well as a powerful Crystal Ball, and together they were able to piece together a vision. The dark lord of the Nine Hells, [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md), will unleash a great evil very soon. Though the Conclave often stays out of non-Halruaan affairs, they had no choice but to act. It is for this reason that the adventurers were called to Halruaa.

[Zythan](3-Mechanics/CLI/bestiary/npc/zythan-coa.md)'s (see the accompanying stat block) skill in arcane magic, while particularly focused on Divination, extends to every school. While he lacks proficiency in martial combat, he can wield both offensive and defensive magic effectively. Outside of his magical talent, he is also known to be highly intelligent, though his social skills could use work. Much of his time is spent viewing alternate futures and preparing for potential dangers, leaving little for himself. He often goes without meals until he starts to feel weak, and if he had friends, they might be concerned about how much time he spends working.

#### Zythan as a Contact

Using his Divination magic, [Zythan](3-Mechanics/CLI/bestiary/npc/zythan-coa.md) keeps tabs on the party, occasionally checking in when he deems appropriate. When he checks in, he can provide access to some magic items. He will also purchase any excess Spell Scrolls or spellbooks found by the party, and can, upon request, attempt to hunt down specific magic items. If successful, he brings the desired magic items on his next visit.

**Purchasing Items from Zythan**

| Item | Cost |
|------|------|
| [Amulet of the Planes](3-Mechanics/CLI/items/amulet-of-the-planes.md) | 35,000 gp |
| [Carpet of Flying](3-Mechanics/CLI/items/carpet-of-flying.md) | 40,000 gp |
| [Ioun Stone (reserve)](3-Mechanics/CLI/items/ioun-stone-reserve.md) | 8,500 gp |
| [Mantle of Spell Resistance](3-Mechanics/CLI/items/mantle-of-spell-resistance.md) | 10,500 gp |
| [Ring of Resistance](3-Mechanics/CLI/items/ring-of-resistance.md) | 9,000 gp |
| [Staff of Power](3-Mechanics/CLI/items/staff-of-power.md) | 45,000 gp |
| [Wand of Fireballs](3-Mechanics/CLI/items/wand-of-fireballs.md) | 10,000 gp |
| [Wand of the War Mage, +1](3-Mechanics/CLI/items/1-wand-of-the-war-mage.md) | 500 gp |
| [Wand of the War Mage, +2](3-Mechanics/CLI/items/1-wand-of-the-war-mage.md) | 9,500 gp |
| [Wand of the War Mage, +3](3-Mechanics/CLI/items/1-wand-of-the-war-mage.md) | 32,000 gp |
^purchasing-items-from-zythan
...
During the time that he was dead, Bhaal had many scattered cults, the most infamous being the Deathstalkers of Bhaal, who were dedicated to bringing him back to life. With Bhaal now returned, the Deathstalkers are now focused on finding a way to return Bhaal to being a fully divine being. They've discovered a way by making a deal with [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). However, they believe the Lord of the Nine Hells intends to deceive them and now they seek a way to make sure [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) holds up to his end of the bargain.

> [!note] Uncomfortable Allies
> 
> The Deathstalkers of Bhaal are responsible for the murders that doomed the characters (or their loved ones) to the Nine Hells. The characters don't have much reason to want anything to do with them let alone align themselves with these murderers. However, the Deathstalkers are a powerful ally. Having begun to doubt their alliance with [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md), they now attempt to gain the cooperation of the characters. [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md), the Deathstalker that contacts the heroes, is quite convincing. And scary...
^uncomfortable-allies

### Deathstalker Quest

To force [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) to make good on his word, the Deathstalkers of Bhaal want to gain leverage. For this they need a powerful artifact. They ask the characters to steal some of the most infamous and powerful artifacts of the Nine Hells. They need only one, leaving any other artifacts for the characters to decide what to do with. For a detailed description of these artifacts, see the section "Infernal Artifacts" in appendix D.
...
Much like the archdevils of the Nine Hells, Bhaal desires souls. Specifically, he desires Soul Coins (see "[Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md)" in appendix D). When you're in possession of one or more Soul Coins, you can whisper to the coin what it is that you desire from the Deathstalker Items table. If you have the requisite number of coins, the Soul Coins vanish from your possession, and the item that you asked for appears within 5 feet of you.

**Deathstalker Items**

| Items | Cost |
|-------|------|
| [Dagger of Venom](3-Mechanics/CLI/items/dagger-of-venom.md) | 6 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Eyes of Charming](3-Mechanics/CLI/items/eyes-of-charming.md) | 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Goggles of Night](3-Mechanics/CLI/items/goggles-of-night.md) | 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Hat of Disguise](3-Mechanics/CLI/items/hat-of-disguise.md) | 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Iron Bands of Binding](3-Mechanics/CLI/items/iron-bands-of-bilarro.md) | 7 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Nine Lives Stealer](3-Mechanics/CLI/items/nine-lives-stealer.md) | 15 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Pipes of Haunting](3-Mechanics/CLI/items/pipes-of-haunting.md) | 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Potions of Poison](3-Mechanics/CLI/items/potion-of-poison.md) (2) | 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Slippers of Spider Climbing](3-Mechanics/CLI/items/slippers-of-spider-climbing.md) | 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Staff of Withering](3-Mechanics/CLI/items/staff-of-withering.md) | 5 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Sword of Life Stealing](3-Mechanics/CLI/items/sword-of-life-stealing.md) | 8 [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
| [Wand of Secrets](3-Mechanics/CLI/items/wand-of-secrets.md) | 1 [Soul Coin](3-Mechanics/CLI/items/soul-coin-bgdia.md) |
^deathstalker-items

### Deathstalker Contact: Sarevok

![Sarevok Anchev](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/031-0.webp#center)

[Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) Anchev is a powerful Deathstalker. He is also one of the Bhaalspawn, the mortal offspring of the dead god Bhaal. [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) attempted to reclaim the divine seat of the Lord of Murder vacated by his immortal father's demise, but his plans were thwarted when he was slain by his half-brother, Abdel Adrian, who rejected his heritage and fought against his Bhaalspawn siblings.

[Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md)'s spirit was sent to the Abyss as punishment. There he eventually crossed paths with Abdel a second time when his noble-hearted brother ventured into the lower realms on a dangerous quest to stop another Bhaalspawn named Melissan. [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) agreed to help Abdel kill Melissan, on the condition that Abdel helped him escape the eternal torments of the Abyss.

Abdel agreed, and [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) was reborn into the mortal world. After his rebirth, [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) was true to his word, and the two brothers fought side by side against their half-sister. Ultimately Melissan was defeated, and [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) was granted a second chance at life.

With his prodigious strength, his legendary skill in battle, and the Sword of Chaos—a life-stealing, enchanted blade—[Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) (see the accompanying stat block) became a famous (and feared) mercenary. Yet his many accomplishments brought him no joy. He felt no thrill at victory in battle, no delight in the routing of his enemies. The power he accumulated was bitter as ashes on his tongue, and he became a man haunted by his former life. The realization that no earthly achievements could ever compare to what he once almost had—immortality and godhood—left him broken and empty.

[Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) plunged into a deep despair. To numb his pain, he indulged in every vice imaginable, squandering his wealth and health on alcohol, drugs, and fleeting comforts. While his divine heritage slowed his aging, it did not stop it entirely, and after decades of self-abuse he was eventually reduced to an old man begging in the streets of Baldur's Gate.

This was how his father—Bhaal, the reborn god of murder—found him. Bhaal recognized his own divine spark in the pathetic old man, and he sensed [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) still had potential. Bhaal recruited him to become the high priest of his fledgling clergy, giving [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) new purpose... and another chance to become an agent of death and destruction.

#### Sarevok as a Contact

Though he lacks Divination magic, [Sarevok](3-Mechanics/CLI/bestiary/npc/sarevok-coa.md) keeps tabs on the party's progress and checks in whenever he feels like it. During his check-ins, he will offer a small assortment of magic items, as well as a large variety of potions. He also has a vast treasury and is willing to purchase Soul Coins for 1,000 gp per coin. In addition, for the price of 10,000 gp, he grants one character a blessing (see "Supernatural Gifts" in the "Dungeon Master's Guide") that allows them to become a host for his god, Bhaal.
...
| Items | Cost |
|-------|------|
| [Ammunition, +1 (20)](3-Mechanics/CLI/items/1-ammunition.md) | 150 gp |
| [Ammunition, +2 (20)](3-Mechanics/CLI/items/1-ammunition.md) | 2,500 gp |
| [Ammunition, +3 (20)](3-Mechanics/CLI/items/1-ammunition.md) | 10,000 gp |
| [Beads of Force](3-Mechanics/CLI/items/bead-of-force.md) | 3,000 gp |
| [Cape of the Mountebank](3-Mechanics/CLI/items/cape-of-the-mountebank.md) | 6,000 gp |
| [Robe of Eyes](3-Mechanics/CLI/items/robe-of-eyes.md) | 7,500 gp |
| [Vicious Weapon](3-Mechanics/CLI/items/vicious-weapon.md) | 8,000 gp |
| Uncommon potions |  |
| [Animal Friendship](3-Mechanics/CLI/items/potion-of-animal-friendship.md) | 250 gp |
| [Giant Strength (hill)](3-Mechanics/CLI/items/potion-of-hill-giant-strength.md) | 250 gp |
| [Growth](3-Mechanics/CLI/items/potion-of-growth.md) | 250 gp |
| [Resistance](3-Mechanics/CLI/items/potion-of-resistance.md) | 250 gp |
| [Water Breathing](3-Mechanics/CLI/items/potion-of-water-breathing.md) | 250 gp |
| Rare potions |  |
| [Clairvoyance](3-Mechanics/CLI/items/potion-of-clairvoyance.md) | 1,000 gp |
| [Diminution](3-Mechanics/CLI/items/potion-of-diminution.md) | 1,000 gp |
| [Gaseous Form](3-Mechanics/CLI/items/potion-of-gaseous-form.md) | 1,000 gp |
| Giant Strength ([frost](3-Mechanics/CLI/items/potion-of-frost-giant-strength.md)/[stone](3-Mechanics/CLI/items/potion-of-stone-giant-strength.md)) | 1,000 gp |
| [Heroism](3-Mechanics/CLI/items/potion-of-heroism.md) | 1,000 gp |
| [Mind Reading](3-Mechanics/CLI/items/potion-of-mind-reading.md) | 1,000 gp |
| Very rare potions |  |
| [Flying](3-Mechanics/CLI/items/potion-of-flying.md) | 5,000 gp |
| [Giant Strength (fire)](3-Mechanics/CLI/items/potion-of-fire-giant-strength.md) | 5,000 gp |
| [Invisibility](3-Mechanics/CLI/items/potion-of-invisibility.md) | 5,000 gp |
| [Speed](3-Mechanics/CLI/items/potion-of-speed.md) | 5,000 gp |
^purchasing-items-from-sarevok