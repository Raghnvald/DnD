...
![Powerful infernal items are found in dangerous places across all layers of the Nine Hells.](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/269-0.webp#center)

- [Amulet of Appearance](3-Mechanics/CLI/items/amulet-of-appearance-coa.md)  
- [Amulet of Betrayal](3-Mechanics/CLI/items/amulet-of-betrayal-coa.md)  
- [Amulet of Duplicity](3-Mechanics/CLI/items/amulet-of-duplicity-coa.md)  
- [Bracers of Asmodeus](3-Mechanics/CLI/items/bracers-of-asmodeus-coa.md)  
- [Canian Fork](3-Mechanics/CLI/items/canian-fork-coa.md)  
- [Condensed Order](3-Mechanics/CLI/items/condensed-order-coa.md)  
- [Demonbone Polearm](3-Mechanics/CLI/items/demonbone-polearm-coa.md)  
- [Gauntlets of Rage](3-Mechanics/CLI/items/gauntlets-of-rage-coa.md)  
- [Infernal Amulet](3-Mechanics/CLI/items/infernal-amulet-coa.md)  
- [Infernal Plate Armor](3-Mechanics/CLI/items/infernal-plate-armor-coa.md)  
- [Knife of Stolen Resistance](3-Mechanics/CLI/items/knife-of-stolen-resistance-coa.md)  
- [Ring of Collecting](3-Mechanics/CLI/items/ring-of-collecting-coa.md)  
- [Ring of the Copycat](3-Mechanics/CLI/items/ring-of-the-copycat-coa.md)  
- [Ring of Treachery](3-Mechanics/CLI/items/ring-of-treachery-coa.md)  
- [Sage's Mirror](3-Mechanics/CLI/items/sages-mirror-coa.md)  
- [Skull of Selfish Knowledge](3-Mechanics/CLI/items/skull-of-selfish-knowledge-coa.md)  
- [Soul Coins](3-Mechanics/CLI/items/soul-coin-bgdia.md)  
- [Stygian Spear](3-Mechanics/CLI/items/stygian-spear-coa.md)  
- [Sword of Retribution](3-Mechanics/CLI/items/sword-of-retribution-coa.md)  
- [Vial of Greed](3-Mechanics/CLI/items/vial-of-greed-coa.md)  
- [Weapon of Agonizing Paralysis](3-Mechanics/CLI/items/weapon-of-agonizing-paralysis-coa.md)  
...
Mortals that receive express permission from [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md), or that make an infernal contract to acquire a magic item, don't suffer the effects of infernal corruption.
...
After the complete devolution of a character's morals and will, they progress to Stage Four. When they finish their first long rest after reaching Stage Four, the character's alignment shifts to lawful evil. They're now bound by the devil's code, requiring them to honor any pact made and acquire souls in service of [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md). Lastly, their physical form changes, morphing to resemble a devil chosen by the DM.

Once the character reaches Stage Four, the only two cures are the Wish spell, which counts as beyond the scope of the spell, or by signing an infernal contract with [Asmodeus](3-Mechanics/CLI/bestiary/npc/asmodeus-coa.md) to reclaim their soul.
...
- [Accounting and Valuation of All Things](3-Mechanics/CLI/items/accounting-and-valuation-of-all-things-coa.md)  
- [Amulet of the Inferno](3-Mechanics/CLI/items/amulet-of-the-inferno-coa.md)  
- [Ranseur of Torture](3-Mechanics/CLI/items/ranseur-of-torture-coa.md)  
- [Ruby Rod of Asmodeus](3-Mechanics/CLI/items/ruby-rod-of-asmodeus-coa.md)  
- [Scourge of Shadow](3-Mechanics/CLI/items/scourge-of-shadow-coa.md)  
- [True-Ice Shards](3-Mechanics/CLI/items/true-ice-shards-coa.md)  
- [Wrought-Iron Tower](3-Mechanics/CLI/items/wrought-iron-tower-coa.md)  

![A battle erupts on the River Styx](3-Mechanics/CLI/adventures/chains-of-asmodeus/img/277-0.webp#center)