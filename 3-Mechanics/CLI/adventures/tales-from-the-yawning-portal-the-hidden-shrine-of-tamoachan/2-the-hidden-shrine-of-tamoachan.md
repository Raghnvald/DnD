...
- json5e-note
tags:
- ttrpg-cli/compendium/src/5e/tftyp-thsot
aliases:
...
In some places, the corbel arches that hold up the ceiling aren't structurally sound. As a result, some spells might have disastrous effects. A spell like [fireball](3-Mechanics/CLI/spells/fireball-xphb.md) (an explosion) or [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md) (an area of thunder damage) has a 25 percent chance to cause a ceiling collapse within the spell's area, dealing 16 (`3d10`) bludgeoning damage to creatures in the area. This collapse might block or bury objects or exits.
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | `1d3` [swarms of rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) (diseased, as giant rats) |
| 2 | `1d3` [swarms of bats](3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) |
| 3 | `2d4` [giant fire beetles](3-Mechanics/CLI/bestiary/beast/giant-fire-beetle-xmm.md) |
| 4 | `1d6` [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
| 5 | 1 [will-o'-wisp](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) |
| 6 | `2d4` [baboons](3-Mechanics/CLI/bestiary/beast/baboon-xmm.md) |
| 7 | 1 [swarm of poisonous snakes](3-Mechanics/CLI/bestiary/beast/swarm-of-venomous-snakes-xmm.md) |
| 8 | `1d4` [giant frogs](3-Mechanics/CLI/bestiary/beast/giant-frog-xmm.md) |
| 9 | `1d2` [panthers](3-Mechanics/CLI/bestiary/beast/panther-xmm.md) |
| 10 | `1d3` [giant wolf spiders](3-Mechanics/CLI/bestiary/beast/giant-wolf-spider-xmm.md) |
^encounter
...
The diorama in the alcove holds twelve [tribal warriors](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md), one [scout](3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md), a [mastiff](3-Mechanics/CLI/bestiary/beast/mastiff-xmm.md), and a [panther](3-Mechanics/CLI/bestiary/beast/panther-xmm.md). The deer don't animate.

#### Niche A

In a river scene, a dozen [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) gather rushes, fish with nets, and carve a dugout.

#### Niche B

Twelve [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) are engaged in farming, planting maize and harvesting wheat. Five [tribal warriors](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) stand guard, and a [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) (priest) in a bird costume is blessing the fields.

#### Niche C

The display portrays a temple upon a tiered pyramid. Seven [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) are bringing small offerings of gold and jade. Before the temple stands a [cult fanatic](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) handling a [constrictor snake](3-Mechanics/CLI/bestiary/beast/constrictor-snake-xmm.md). Around him stand three costumed [tribal warriors](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md). One, dressed as a winged serpent, holds a spear; another is dressed as a bear with razor claws; the third represents a coyote holding a torch. There are also several stone statues of the gods. The bits of gold and jade are worth 5 gp each, and there are fifteen such items.

#### Niche D

A scene of tribal warfare involves twenty [tribal warriors](3-Mechanics/CLI/bestiary/humanoid/warrior-infantry-xmm.md) in combat. The ten warriors of one side are painted black, while the ten others are done in red. Warriors that are animated will fight animated enemy warriors first, but once they vanquish their foes they turn on the characters.
...
In a scene that shows various forms of crafting, twelve [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) are busy weaving rugs and baskets, carving totems, making pots, grinding stones for weapons, and making clothes.
...
The boulder is in reality a huge shell inhabited by [Kalka-Kylla](3-Mechanics/CLI/bestiary/npc/kalka-kylla-tftyp.md) (see appendix B), a giant hermit crab. The bamboo staff is one of its legs; a successful DC 15 Intelligence ([Nature](3-Mechanics/CLI/rules/skills.md#Nature)) check enables a character to discern this fact and get a hint as to [Kalka-Kylla](3-Mechanics/CLI/bestiary/npc/kalka-kylla-tftyp.md)'s nature before the crab moves.

When the characters enter the room, [Kalka-Kylla](3-Mechanics/CLI/bestiary/npc/kalka-kylla-tftyp.md) is asleep and will not awaken unless the crayfish is attacked. Once it is awake, it may attack or bargain. It speaks Olman.
...
The ancient glyphs are scribed in Olman. If anyone in the party can read this language, or if the message can be understood by other means, the glyphs will translate as "Here lies [Tloques-Popolocas](3-Mechanics/CLI/bestiary/npc/tloques-popolocas-tftyp.md), master of the others, who is like the wind and the night!"
...
The carved block is the resting place of [Tloques-Popolocas](3-Mechanics/CLI/bestiary/npc/tloques-popolocas-tftyp.md), a servant of the shadow-loving Zotzilaha. The glyphs on the top of the slab give his name, and the date he died, 54–3–9, is written in the face-glyphs. One glyph is a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) (save DC 17), which casts [bestow curse](3-Mechanics/CLI/spells/bestow-curse-xphb.md) on everyone in the tomb if the crypt is opened by those who don't serve the god Zotzilaha. The curse lasts until it is dispelled, and `4d10` days after this tomb has been broken into, every cursed violator receives a visit from either Tloques or some other agent of Zotzilaha seeking retribution.
...
[Tloques](3-Mechanics/CLI/bestiary/npc/tloques-popolocas-tftyp.md) will not pursue fleeing grave robbers from his tomb immediately, but instead will seek to regain his bearings in the world of the living for several days. He can track down cursed thieves later, or invoke the power of Zotzilaha to locate any treasure stolen from this place. In the intervening time, he might regain some of his former power.
...
The weapon is a [berserker axe](3-Mechanics/CLI/items/berserker-axe-xdmg.md) that has a +2 bonus to attack and damage rolls instead of the normal +1. The axe can't be picked up by another as long as its current owner, Tloques, remains alive. Concealed beneath the wrappings around the handle is a parchment containing the spells [passwall](3-Mechanics/CLI/spells/passwall-xphb.md), [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md), and [gust of wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md). When the attuned wielder uses an action to say the correct words of power, which are engraved in Olman on the axe blade, one of these spells can be cast.

The axe has 12 charges and regains `1d6 + 4` expended charges daily at dawn. Casting a spell from it takes a number of charges equal to the level at which the spell is cast (5th for [passwall](3-Mechanics/CLI/spells/passwall-xphb.md), 2nd for [gust of wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md), and 1st or higher for [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md); spell save DC 15). If the parchment is removed from the axe, the axe loses the capability of casting these spells forever.
...
- About the wrists are wide jade bead bracelets ([bracers of defense](3-Mechanics/CLI/items/bracers-of-defense-xdmg.md)).  
- On the middle finger of each hand are carved jade rings, one in the form of a man holding the moon (a [ring of protection](3-Mechanics/CLI/items/ring-of-protection-xdmg.md)) and the other a panther ready to strike (a [ring of animal influence](3-Mechanics/CLI/items/ring-of-animal-influence-xdmg.md)).  
...
- At the feet of the skeleton lie two small containers, apparently of glazed clay, one fitted with flower-shaped plugs in both ends (it contains the dried remains of a [potion of invisibility](3-Mechanics/CLI/items/potion-of-invisibility-xdmg.md)), the other holding a 1-inch-diameter piece of mother-of-pearl (5 gp).  
- Lying among the hip bones is a 6-inch-long statue of a faceless man with large pointed ears. Plugged at the bottom, it is a bottle that contains an [elixir of health](3-Mechanics/CLI/items/elixir-of-health-xdmg.md).  
...
The eyes of the statue are pieces of polished obsidian worth 10 gp each. The sword is a [+1 longsword](3-Mechanics/CLI/items/1-weapon-xdmg.md) in fine condition, made of laminated wood, inset with jagged teeth of obsidian. It deals an extra `2d6` damage to any creature of the plant type. The sword comes free easily, if any character pulls it up and out.
...
The phosphorescent glow on the eastern wall is actually a giant slug named [Tecuziztecatl](3-Mechanics/CLI/bestiary/npc/tecuziztecatl-tftyp.md) (see appendix B), the Lord of Snails. [Tecuziztecatl](3-Mechanics/CLI/bestiary/npc/tecuziztecatl-tftyp.md) (Tay-COO-zeez-tay-COT-el) is highly intelligent and quite the boaster. In ancient lore it was considered to be related to the moon, a fact of which it is quite proud. During combat the slug will detail, in Olman, what it has in store for the characters and how hopeless their situation is.
...
The slug will lead the party toward the Tomb of Hurakan (area 12) and instruct them to open the door. Once the door is open, [Tecuziztecatl](3-Mechanics/CLI/bestiary/npc/tecuziztecatl-tftyp.md) will flee from the party and hide in the bottom of the moat.
...
In the southeast corner of the eastern alcove, a [swarm of rats](3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) nests in the rubbish. The swarm is made up of diseased giant rats.
...
The golden circlet is a [bracelet of rock magic](3-Mechanics/CLI/items/bracelet-of-rock-magic-tftyp.md) (see appendix A) that was originally a ring, an earring, or some other piece of stone giant jewelry.
...
When the slab finishes moving, it locks into place, so the floor remains steeply sloped and the passage north remains blocked. The locking mechanism is hidden by the northern (elevated) edge of the floor, and it's in a very narrow space. The stone around it can be chipped away over several hours of tedious labor until the edge of the slab no longer holds in place. A [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell can also defeat the locking mechanism.
...
The stuccoed dome is a cairn. It is a weak construction and can be broken into in 1 minute, using any bludgeoning instruments. If the characters work in concert, the time can be divided among multiple workers. Inside are six sets of worthless bones and six jade bead pectorals, worth 50 gp each. In a dusty corner is a pendant made of silver and turquoise, which is an [amulet of protection from turning](3-Mechanics/CLI/items/amulet-of-protection-from-turning-tftyp.md) (see appendix A). In the center of the floor of this cairn is a bronze and chrysoprase lamp set into the stucco, worth 15 gp.

### Creature

Lifting the lamp will open a hidden door in the floor, releasing a [wight](3-Mechanics/CLI/bestiary/undead/wight-xmm.md) called Ayocuan from the compartment in which he has been trapped. Ayocuan wears another [amulet of protection from turning](3-Mechanics/CLI/items/amulet-of-protection-from-turning-tftyp.md).
...
As soon as the sand begins flowing, the [will-o'-wisp](3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) that frequents this part of the ruins (see area 23), if it remains alive, moves through one of the doors into the trapped area. It harries those who are having the most success at escaping the trap.
...
A millstone, concealed in the wall behind a layer of stucco, lies at the top of the steps. No nonmagical means can detect the hidden stone. If the trap is triggered, the mechanism pushes the millstone through the wall and sends it rolling down the stairs. When this occurs, anyone who has a passive Perception score of 14 or lower is [surprised](3-Mechanics/CLI/rules/conditions.md#Surprised). Everyone rolls initiative, including the stone, which has a +10 bonus to the roll. On its turn, the stone moves 60 feet. Anyone in its path must succeed on a DC 15 Dexterity saving throw or take 27 (`5d10`) bludgeoning damage and have a 50 percent chance to drop anything carried in hand. A character whose saving throw fails by 5 or more takes maximum damage, is knocked [prone](3-Mechanics/CLI/rules/conditions.md#Prone), and drops anything held in hand. Dropped objects take damage from hitting the stone and end up somewhere on the stairs.
...
The spherical creature is a [gas spore](3-Mechanics/CLI/bestiary/plant/gas-spore-fungus-xmm.md) that represents Nanahuatcin, the "sun."
...
Once the ball is knocked into a goal, it sticks there for 1 round, impossible to remove without destroying it. If the ball enters the goal to the north, a number of [magic missiles](3-Mechanics/CLI/spells/magic-missile-xphb.md) erupt from the goal equal to the number of conscious characters in the corridor. Each missile strikes a different character for 3 (`1d4 + 1`) force damage.
...
The statue is a [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) [werejaguar](3-Mechanics/CLI/bestiary/humanoid/werejaguar-tftyp.md) (use the [weretiger](3-Mechanics/CLI/bestiary/monstrosity/weretiger-xmm.md) statistics). If the altar is molested or any of the room's contents are abused, the [werejaguar](3-Mechanics/CLI/bestiary/humanoid/werejaguar-tftyp.md) becomes aware and seizes the first opportunity to attack with surprise. It can turn to flesh as a bonus action and then transform into cat shape, dropping its spear. (The magic on the creature renders it strongly related to earth and stone with regard to the curse on the [bracelet of rock magic](3-Mechanics/CLI/items/bracelet-of-rock-magic-tftyp.md), described in appendix A). Its first choice of targets is always the weakest member of the party. If the [werejaguar](3-Mechanics/CLI/bestiary/humanoid/werejaguar-tftyp.md) is reduced to 0 hit points, it reverts to human form and becomes [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) again.

The [werejaguar](3-Mechanics/CLI/bestiary/humanoid/werejaguar-tftyp.md)'s heart has been removed by magical surgery and is hidden in the head of the stuffed tiger (hinted at by the scars on man and tiger). Therefore, the cat-man might take damage or even die, but unless its heart is destroyed, it is reborn again whole in one day's time. If the lycanthrope's heart (AC 10, 2 hit points) is destroyed, the creature dies and turns to dust.
...
The sacrificial knife on the table is a [+1 dagger](3-Mechanics/CLI/items/1-weapon-xdmg.md). The jade statue is worth 200 gp and weighs 9 pounds. In the tail of the stuffed cat is a [scroll of protection](3-Mechanics/CLI/items/scroll-of-protection-xdmg.md) (feline beasts and feline lycanthropes).
...
On the floor just inside the doorway is a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) (save DC 17). The first character to step through the door and onto the glyph causes a [wall of fire](3-Mechanics/CLI/spells/wall-of-fire-xphb.md) spell to spring up in the doorway, with the damaging side facing away from the character who entered. The wall remains in place for 1 minute.

#### Creature

Within the copper coffin is a [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md). The creature emerges from the coffin through a hole in the side facing away from the entrance as soon as the glyph is triggered. It assumes the form of any character trapped alone in the room and tries to attack with surprise. If it succeeds in slaying the character before the [wall of fire](3-Mechanics/CLI/spells/wall-of-fire-xphb.md) expires, then it hides the body in the coffin.
...
Cradled in the crook of the elbow of the corpse's right arm is a baton of granite. The baton is a scroll case with a cleverly fashioned plug. Within the case is a piece of faded parchment—a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [stone shape](3-Mechanics/CLI/spells/stone-shape-xphb.md), written in astrological symbols of the Olman.

Upon the skull is a ferret-faced, feathered mask that functions as a [hat of disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md).
...
The items at the corpse's feet include an agate carved in the shape of a heart (worth 15 gp) that is actually a [stone of ill luck](3-Mechanics/CLI/items/stone-of-ill-luck-tftyp.md) (see appendix A), a miniature gold llama (worth 50 gp), a ring of polished pink granite (worth 10 gp), and a silver plaque bearing the face of the sun (15 gp).
...
Almost all the weapons around the statue are useless, though the head of a [+1 mace](3-Mechanics/CLI/items/1-weapon-xdmg.md) attached to a broken haft can be found.
...
Beyond the hole in the ceiling is a chamber that measures 30 feet in each direction. It is the lair of Xipe, an [oni](3-Mechanics/CLI/bestiary/fiend/oni-xmm.md). Xipe can't cast [cone of cold](3-Mechanics/CLI/spells/cone-of-cold-xphb.md), but he can cast [sleet storm](3-Mechanics/CLI/spells/sleet-storm-xphb.md) and [fear](3-Mechanics/CLI/spells/fear-xphb.md) once per day each. When he casts [fear](3-Mechanics/CLI/spells/fear-xphb.md), he unleashes a great bellow that shakes the room.

#### Treasure

Xipe's treasure includes a wooden cylinder that holds a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md). Also in his lair are piles of rich cat furs, eight of the furs worth 5 gp each. Two leather bags beneath the furs hold 1,000 sp each.

Lastly, an intricately carved ivory cube about 1 foot tall stands on an ornamental table. The cube (worth 100 gp) is a trick box. To open it, two plugs on either side of the cube must be pushed in, and then its center slides out of a frame formed by the other four sides. This inner box opens like a chest. Within it is a silver and aquamarine necklace (worth 125 gp) and a parchment packet that holds three pinches of [dust of disappearance](3-Mechanics/CLI/items/dust-of-disappearance-xdmg.md).
...
The "tree" is [Xilonen](3-Mechanics/CLI/bestiary/npc/xilonen-tftyp.md), a semi-sentient (Int 2), gigantic variety of polyp, similar to a sea anemone, once revered as the hairy mother goddess of corn. The polyp, which functions similarly to a [roper](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md), is very hungry. Its mouth is concealed among a nest of flailing tentacles and protected by sharp spines.

#### Treasure

Within the polyp's gut are twelve pieces of blue jasper (worth 10 gp each) and a silvery rod, actually a copper-nickel alloy, which is a [wand of lightning bolts](3-Mechanics/CLI/items/wand-of-lightning-bolts-xdmg.md).
...
Hidden in a pile of rubble in the center of the room is an amphisbaena—a giant, two-headed snake. It fights as a [giant constrictor snake](3-Mechanics/CLI/bestiary/beast/giant-constrictor-snake-xmm.md) that can make two melee attacks on each of its turns, only one of which can be a Constrict attack. This ability increases its challenge rating to 3 (700 XP).

If the snake is slain, the four [baboons](3-Mechanics/CLI/bestiary/beast/baboon-xmm.md) leap through the hole in the ceiling and down upon the party. (They remained outside the room because of their fear of the snake.)
...
The second 10-foot square along these stairs is warded by magic like that of a [glyph of warding](3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) spell (save DC 17). If the glyph is triggered, nothing happens until a creature moves onto the uppermost 5 feet of the stairs. When that occurs, a stone statue of a dragon, hidden in the secret room at the top of the stairs (see the "Second Tier" portion of the map), pops out and rolls forward to the head of the steps. The statue has the statistics, defenses, and traits of a [stone golem](3-Mechanics/CLI/bestiary/construct/stone-golem-xmm.md), but it has no action options. As soon as it stops after emerging, it opens its mouth and breathes a gust of steam 30 feet long and 10 feet wide. Those in the area must make a DC 15 Constitution saving throw, taking 7 (`2d4 + 2`) fire damage on a failed save, or half as much damage on a successful one.
...
This apparent pile of gold is covered with a pale yellow dust. The entire pile of coins is actually yellow mold (see "[Dungeon Hazards](3-Mechanics/CLI/traps-hazards/yellow-mold-xdmg.md)" in chapter 5 of the "Dungeon Master's Guide") covered by a permanent [major image](3-Mechanics/CLI/spells/major-image-xphb.md) spell (save DC 15). The bones, spider, and sword hilt are real.
...
If any of the items on the shelves (worth a total of 450 gp) are touched, the exit door seals with an effect like that of an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell, requiring the use of magic or a successful DC 25 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to force the door open.

#### Creature

Coiled about the pillar, trapped within the magic walls of the crystal cylinder surrounding it, is a [couatl](3-Mechanics/CLI/bestiary/celestial/couatl-xmm.md). Because of its especially potent Shielded Mind trait, it is effectively [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible).
...
A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of evocation magic emanating from inside the crystal cylinder.

#### The Right Path

To reach the "cure," the characters must first face the challenge of ascending the northern steps, where the warrior stands. The warrior, a [helmed horror](3-Mechanics/CLI/bestiary/construct/helmed-horror-xmm.md), animates and attacks when it is approached. Once the construct is defeated, the characters can proceed to the center of the dais.
...
The top of the pillar is shielded by a wall of force that must be breached to reach the potion bottle. The wall can be destroyed by a [disintegrate](3-Mechanics/CLI/spells/disintegrate-xphb.md) spell or by damaging the glyph inscribed below it. If someone pours holy water on the glyph, touches it with a holy symbol, or casts a divine spell on it, the [wall of force](3-Mechanics/CLI/spells/wall-of-force-xphb.md) disappears.

#### Aftermath

When the characters claim the potion bottle, the [couatl](3-Mechanics/CLI/bestiary/celestial/couatl-xmm.md) becomes visible and flies out into the chamber. If the characters immediately attack it, the couatl calls them ingrates and fools, and then attacks back.

If the characters don't attack, the couatl smiles and thanks them for freeing it from its long imprisonment.

#### Treasure

Inside the bottle is a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md). The mask, if it is claimed, weighs 30 pounds and is worth 25 gp. Miscellaneous items on the shelves have a total value of 450 gp.

#### Special Treasure

If the couatl and the characters are on good terms at the end of the encounter, the couatl provides them with special treasures: a [balance of harmony](3-Mechanics/CLI/items/balance-of-harmony-tftyp.md) (see appendix A) and the gems needed to operate it, a [mirror of the past](3-Mechanics/CLI/items/mirror-of-the-past-tftyp.md) (see appendix A), and a [periapt of wound closure](3-Mechanics/CLI/items/periapt-of-wound-closure-xdmg.md).
...
Reflections in the white mirror are blurred by what looks like a fine mist. Any creature that steps before this mirror and looks into it must make a successful DC 13 Wisdom saving throw or be [stunned](3-Mechanics/CLI/rules/conditions.md#Stunned) until the end of the creature's next turn. If the saving throw fails, the mirror, which is really an [ochre jelly](3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) of unusual color, comes out of the frame and falls upon the character. Behind this false mirror is a door, which can be opened once the jelly is removed.
...
Each section of the diorama in this room has a magical aspect that affects any creatures that walk into the region. If the effect isn't instantaneous and isn't related to a spell, it can be dispelled with [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) cast as a 5th-level spell (or at a level stated in the effect). A creature on which a region's effect is dispelled is immune to the effect for 1 minute.
...
Creatures that enter this section are affected as if by a [heat metal](3-Mechanics/CLI/spells/heat-metal-xphb.md) spell cast at 3rd level (save DC 15).

#### Ice

Creatures that enter this area are affected as if by a 3rd-level [heat metal](3-Mechanics/CLI/spells/heat-metal-xphb.md) spell (save DC 15), but the damage is cold instead of fire, and the creature has no chance of dropping a chilled object.
...
Those who enter the river for the first time on a turn must succeed on a DC 15 Intelligence saving throw or forget how they came to be here and why they are here. A spellcaster also forgets how to cast one level of spells for each point by which the saving throw is failed, starting with the highest level the character knows. Forgotten spells can be prepared again. [Dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md) doesn't remove this effect, but [remove curse](3-Mechanics/CLI/spells/remove-curse-xphb.md) or [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md) can.

#### Pit of the Worms

Any character who enters this region must succeed on a DC 15 Wisdom saving throw or be affected as if by a [fear](3-Mechanics/CLI/spells/fear-xphb.md) spell.
...
When any character starts into this room the pile of earth, which is a [gibbering mouther](3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md), opens one eye, and then another and another, until many eyes of different shapes and sizes stare at the party. All about the eyes are fanged, drooling mouths that begin a cacophony of babbling. The creature attacks until destroyed but doesn't leave the room.

#### Treasure

The flask contains a dried [potion of hill giant strength](3-Mechanics/CLI/items/potion-of-hill-giant-strength-xdmg.md). The stone cylinder is a [+1 rod of the pact keeper](3-Mechanics/CLI/items/1-rod-of-the-pact-keeper-xdmg.md).

The urn holds the dried heart of a mighty yuan-ti that radiates transmutation magic if [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) is used on it. Any character who eats the entire thing gains the permanent ability to understand the speech of snakes and yuan-ti.

### 47. Spider in Hiding

#### Creature

In a web-covered opening in the wall of the steeply inclined chute, 30 feet above the where the lower end meets the ceiling of area 45, lurks a [giant spider](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md). The spider's lair is 10 feet long, 4 feet wide, and 4 feet tall. A character must succeed on a DC 17 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check to notice the tunnel or its occupant before the spider attacks. If the spider paralyzes its prey, it retreats into its lair with the prey to feed.
...
The fouled water in the fountain contains a neutral evil [water weird](3-Mechanics/CLI/bestiary/elemental/water-weird-xmm.md). It rises up and attacks characters who disturb the water.
...
The figure on the throne is a [nahual](3-Mechanics/CLI/bestiary/npc/nahual-tftyp.md), or alter-ego. It is essentially a [doppelganger](3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) of chaotic evil alignment that is also a fiend (demon). It possesses the memories of the [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) character and tries to convince the party that it has just merged with the spirit of one of the character's earlier incarnations. Given a chance, the [nahual](3-Mechanics/CLI/bestiary/npc/nahual-tftyp.md) leads the party to their deaths with false information gained from "memories" of its former life.

The [nahual](3-Mechanics/CLI/bestiary/npc/nahual-tftyp.md) must be slain and the scepter touched to the [nahual](3-Mechanics/CLI/bestiary/npc/nahual-tftyp.md)'s corpse to restore the [petrified](3-Mechanics/CLI/rules/conditions.md#Petrified) character. A [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell also works, before or after the [nahual](3-Mechanics/CLI/bestiary/npc/nahual-tftyp.md) has been slain.
...
The temple area is filled with debris that offers no obvious passage to the interior. In the center of the south edge is an area where rubble is heaped over an opening that seems to lead down deeper into the debris. It is shaky and can be collapsed easily—any force applied to the heap by a creature with Strength 15 or higher will bring the rocks down. This rubble can also be caused to collapse by hurting a weighty object at it or using a spell such as [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md) to create the needed force. Those within 10 feet of the collapse must succeed on a DC 10 Dexterity saving throw or take 5 (`2d4`) bludgeoning damage from falling debris.
...
After the secret door to the shrine is opened, a [giant hyena](3-Mechanics/CLI/bestiary/beast/giant-hyena-xmm.md) moves into this area. It makes a lair behind a fallen pillar to the east, waiting to ambush any who emerge back through the door.
...
It is very likely that if large portions of this treasure are taken, Zotzilaha finds out about it and sends a [vampire](3-Mechanics/CLI/bestiary/undead/vampire-xmm.md) or a [giant bat](3-Mechanics/CLI/bestiary/beast/giant-bat-xmm.md) to seek retribution.