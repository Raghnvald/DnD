...
Known as "devil's mushroom," a timmask is a 2-foot-tall toadstool with orange and red stripes across its beige cap. Uprooting or destroying a timmask causes it to expel a 15-foot-radius cloud of poisonous spores. Creatures in the area must succeed on a DC 14 Constitution saving throw or be [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned). While [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) in this way, a creature is under the effect of a [confusion](3-Mechanics/CLI/spells/confusion-xphb.md) spell with a duration of 1 minute. When the spell effect ends, the [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) condition also ends.
...
> [!note] 
> 
> **Ettin**. An [ettin](3-Mechanics/CLI/bestiary/giant/ettin-xmm.md) inhabits this dripping cave.
> 
...
> 
> **Piercers**. Stalactites cover the ceiling of the wide tunnel that leads south (to area 5). Eight [piercers](3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md) lurk among them.
^244
...
In this cavern, a [green slaad](3-Mechanics/CLI/bestiary/aberration/green-slaad-xmm.md) posing as a human alchemist makes its home. Its lair has the following features:
...
When you drink this potion, you gain the effect of a [comprehend languages](3-Mechanics/CLI/spells/comprehend-languages-xphb.md) spell for 1 hour. This liquid is a clear concoction with bits of salt and soot swirling in it.
...
> [!note] 
> 
> **Xorn**. Three [xorn](3-Mechanics/CLI/bestiary/elemental/xorn-xmm.md) feast on crystals near the western edge of the cavern, while harmless bats flutter below the 30-foot-high ceiling.
> 
...
> [!note] 
> 
> **Ropers**. This 30-foot-high cave holds a forest of stalagmites, some of which are broken. Two [ropers](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) lurk among them and ambush anyone who happens by.
> 
...
> 
> **Mage**. Near the north wall, a slight woman wearing tattered gray robes over black pants sits on a 2-foot-tall toadstool. Her long black hair is tied back with a swatch of gray cloth that matches her robe. A [quasit](3-Mechanics/CLI/bestiary/fiend/quasit-xmm.md) in toad form sits on her knee.
^251

#### Darribeth Meltimer

The woman is Darribeth Meltimer (CG female Chondathan human [mage](3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md), with the [darkvision](3-Mechanics/CLI/spells/darkvision-xphb.md) spell cast on herself and prepared instead of [suggestion](3-Mechanics/CLI/spells/suggestion-xphb.md)). A former adventurer, she was driven insane by contact with demons in the Underdark. A [greater restoration](3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell or similar magic is needed to restore her sanity, without which Darribeth suffers from hallucinations and paranoia. If the characters approach her in a calm manner, Darribeth smiles and says to the toad on her knee, "Look, Teeha! I told you they're not demons. I wonder if Urgala sent them."

Darribeth desperately wants to get back to her wife Urgala, whom she hasn't seen in a decade. When last they were together, Urgala and Darribeth were living in Amphail, a town north of Waterdeep. In the intervening years, Urgala moved farther north to the frontier town of Triboar, where she took over a modest inn called Northshield House. (See the adventure Storm King's Thunder for more information on [Urgala Meltimer](3-Mechanics/CLI/bestiary/npc/urgala-meltimer-skt.md) and her inn.)
...
Darribeth's spellbook contains the following spells: [cone of cold](3-Mechanics/CLI/spells/cone-of-cold-xphb.md), [counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md), [darkvision](3-Mechanics/CLI/spells/darkvision-xphb.md), [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [fireball](3-Mechanics/CLI/spells/fireball-xphb.md), [fly](3-Mechanics/CLI/spells/fly-xphb.md), [greater invisibility](3-Mechanics/CLI/spells/greater-invisibility-xphb.md), [ice storm](3-Mechanics/CLI/spells/ice-storm-xphb.md), [jump](3-Mechanics/CLI/spells/jump-xphb.md), [mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), [misty step](3-Mechanics/CLI/spells/misty-step-xphb.md), [shield](3-Mechanics/CLI/spells/shield-xphb.md), [suggestion](3-Mechanics/CLI/spells/suggestion-xphb.md), [tongues](3-Mechanics/CLI/spells/tongues-xphb.md), and [water breathing](3-Mechanics/CLI/spells/water-breathing-xphb.md).

In addition to her spellbook, Darribeth carries a backpack missing a strap, within which she keeps material components for her spells, a pouch containing 11 gp, a dagger, a canteen, and a worn blanket. Fastened to the backpack is a coiled [rope of climbing](3-Mechanics/CLI/items/rope-of-climbing-xdmg.md).
...
> [!note] 
> 
> **Driders and Spiders**. The northern half of the cave is home to two [driders](3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) and five [giant spiders](3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md). The driders hide in the natural alcove north of the entrance, while the spiders crawl amid thick webs that fill the top 10 feet beneath the 30-foot-high ceiling.
> 
...
A character entering the cave through the arch gate automatically becomes stuck in the [webs](3-Mechanics/CLI/traps-hazards/webs-xdmg.md) (see ""Dungeon Hazards"" in chapter 5 of the "Dungeon Master's Guide").
...
> [!note] 
> 
> **Drow**. Two male [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) (Altonrel and Rezz) and a female [drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) (Balryn) stand watch atop a ridge of natural rock in the middle of this 30-foot-high cave.
> 
...
If the characters enter in a nonthreatening manner, the guards are cautious but willing to summon their leaders to speak on their behalf. If greeted with hostility, the drow elite warrior sounds the alarm with a single whistle, bringing reinforcements from areas 11b and 11c. If the battle is not going their way, a second whistle brings the [quaggoths](3-Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md) from area 12b.
...
> [!note] 
> 
> **Drow**. Melith, a [drow priestess of Lolth](3-Mechanics/CLI/bestiary/humanoid/fiend-cultist-xmm.md) and the leader of this outpost, meditates and prays before a shrine of Lolth while her consort, the [drow mage](3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) Thirza, sits at a zurkhwood desk reading her spellbook.
> 
...
Though she has great affection for Melith, Thirza sees any alliance with the characters as an opportunity to elevate herself in the eyes of Melith's mother, Vlonwelv. After Melith concludes her business with the characters, Thirza prepares and casts a [sending](3-Mechanics/CLI/spells/sending-xphb.md) spell to contact Vlonwelv. She warns Vlonwelv that Melith has released a group of adventurers from her custody instead of killing them. After thanking Thirza for the information, Vlonwelv curses her daughter's foolishness and awaits the adventurers' arrival.

##### Treasure

The drow priestess wears two silver bracelets set with onyx (25 gp each). She carries a flask of wine and the key to the room's zurkhwood chest, which contains 500 gp. The lock on the chest can be picked with a successful DC 15 Dexterity check using thieves' tools, or opened with a [knock](3-Mechanics/CLI/spells/knock-xphb.md) spell or similar magic. Melith's shrine contains a 1-pound obsidian figurine of the demon goddess Lolth in spider form (25 gp) and eight sticks of incense (5 gp each). Each stick burns for up to 8 hours and emits a sickly odor.

Thirza carries a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [gaseous form](3-Mechanics/CLI/spells/gaseous-form-xphb.md) in a waterproof zurkhwood tube, 25 pp in a spider silk pouch, and her spellbook, which has black leather covers traced with webs of gold. The book contains the following spells: [alter self](3-Mechanics/CLI/spells/alter-self-xphb.md), [cloudkill](3-Mechanics/CLI/spells/cloudkill-xphb.md), [Evard's black tentacles](3-Mechanics/CLI/spells/evards-black-tentacles-xphb.md), [fly](3-Mechanics/CLI/spells/fly-xphb.md), [greater invisibility](3-Mechanics/CLI/spells/greater-invisibility-xphb.md), [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md), [mage armor](3-Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](3-Mechanics/CLI/spells/magic-missile-xphb.md), [misty step](3-Mechanics/CLI/spells/misty-step-xphb.md), [sending](3-Mechanics/CLI/spells/sending-xphb.md), [shield](3-Mechanics/CLI/spells/shield-xphb.md), [sleep](3-Mechanics/CLI/spells/sleep-xphb.md), [spider climb](3-Mechanics/CLI/spells/spider-climb-xphb.md), [web](3-Mechanics/CLI/spells/web-xphb.md), and [witch bolt](3-Mechanics/CLI/spells/witch-bolt-xphb.md).

#### 11c. Arch Gate to Level 2

> [!note] 
> 
> **Drow**. Two male [drow](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) (Kalanszar and Tsabalin) and a female [drow elite warrior](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) (Talafaere) rest here.
> 
...
> 
> **Drow**. Natural shelves and narrow ledges line the walls, ranging in height from 10 to 30 feet. Hiding in the shadows atop 10-foot-high ledges are two male [drow elite warriors](3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) (Ryld and Llauzdrar).
> 
...
> 
> **Quaggoths**. Living on natural stone shelves inside the crevasse are eight [quaggoths](3-Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md) that serve the drow.
^26c
...
A thorough search of the grove accompanied by a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception) or [Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check reveals the gnome druid's old hovel: an igloo-like mound of hardened bat guano. Inside, characters find a ratty old blanket hiding two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) in stoppered gourds. The awakened zurkhwoods attack characters who loot the druid's abandoned home.

### 14. Drow Rafts

> [!note] 
> 
> **Darkmantles**. Stalactites hang from the 30-foot-high ceiling. Two [darkmantles](3-Mechanics/CLI/bestiary/aberration/darkmantle-xmm.md) disguised as stalactites remain motionless until they attack.
> 
...
If the characters seem adamant about pressing deeper into the aboleth's lair, Illuun telepathically commands the eighteen [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) in area 24 to circle around behind the characters (using the passage that enters area 15 from the south) while it keeps the characters engaged in conversation. At the same time, it calls the three [chuuls](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) from area 16 to come at the characters from the west, trapping them in the tunnel. As soon as the chuuls and the troglodytes arrive and begin their attack, the aboleth projection disappears.
...
> [!note] 
> 
> **Chuul**. Circling the island's perimeter is a [chuul](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) that attacks anyone who sets foot on the island.
> 
...
The net draped over the otyugh is woven with worthless shells and bones. Tied to the net are two trinkets (roll twice on the [Trinkets](3-Mechanics/CLI/items/trinket-xphb.md) table in chapter 5 of the "Player's Handbook"), a rusty gauntlet, a leather boot, and an amulet made of composite wood and iron. The boot and the amulet are both magical:

- The boot is one of two [boots of elvenkind](3-Mechanics/CLI/items/boots-of-elvenkind-xdmg.md). A single boot is useless without its companion. The matching boot was swept downriver and eventually found by a goblin werebat named Vool (see level 5, area 17).  
...
> [!note] 
> 
> **Monsters**. Illuun the [aboleth](3-Mechanics/CLI/bestiary/aberration/aboleth-xmm.md) and two [chuuls](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) lurk in the water, which is dark, slimy, and fouled by the aboleth's presence.
> 
...
> 
> **Chuuls**. Two [chuuls](3-Mechanics/CLI/bestiary/aberration/chuul-xmm.md) hide in the murky water. If the chuuls are defeated, an aboleth enters the cavern from the northeast passage. This aboleth is a magical projection created by Illuun to frighten away invaders. (This projection is like the one in area 15.)
> 
...
> 
> **Damaged Rowboat**. At the back of the alcove is a rowboat with a 1-foot-diameter hole in its hull. (A [mending](3-Mechanics/CLI/spells/mending-xphb.md) cantrip can repair the boat, which is large enough to hold four characters and their gear. The boat's oars are missing, however.)
^27f
...
> 
> **Kuo-toa**. Two [kuo-toa whips](3-Mechanics/CLI/bestiary/aberration/kuo-toa-whip-xmm.md), twenty adult [kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md), and ten young kuo-toa (Small noncombatants) reside here. One whip stands watch by the river while the others rest on pallets. All the kuo-toa are [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) from eating bad fish.
> 
...
> [!note] 
> 
> **Kuo-toa**. Noolgaloop, a [kuo-toa archpriest](3-Mechanics/CLI/bestiary/aberration/kuo-toa-archpriest-xmm.md), is building a statue in the middle of this 30-foot-high cave while two [kuo-toa whips](3-Mechanics/CLI/bestiary/aberration/kuo-toa-whip-xmm.md) stand perplexed.
> 
> **Rotting Corpses**. Mutilated monster carcasses piled around the room's perimeter exude a putrid stench.
^285

Noolgaloop is unwaveringly committed to reclaiming its holy shrine (area 16), when the wiser course of action would be to lead its fellow kuo-toa to a new home far away from the aboleth and its servants. If the characters try to speak with the archpriest in a language other than Undercommon, Noolgaloop casts the [tongues](3-Mechanics/CLI/spells/tongues-xphb.md) spell so they can converse. It demands that the characters help it complete the statue by retrieving the following items:
...
> 
> **Kuo-toa**. Four [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) [kuo-toa](3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) guard this area. Two of them are using spears to cut the head and claws off a dead chuul. The other two are feasting on the corpse of a dead kuo-toa (a former companion).
> 
...
At the start of each turn, any creature not immune to the stench of troglodytes must succeed on a DC 12 Constitution saving throw or be [poisoned](3-Mechanics/CLI/rules/conditions.md#Poisoned) until the start of its next turn. A [gust of wind](3-Mechanics/CLI/spells/gust-of-wind-xphb.md) spell or similar magic can clear the air in the cave for 1 minute, while removing the troglodyte carcasses clears the air for good.
...
> 
> **Noise**. Eerie clicking sounds betray the presence of seven [hook horrors](3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md).
^28b
...
> [!note] 
> 
> **Ambush**. A [hook horror](3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) clings to a 15-foot high ledge, waiting to ambush any who enter. The ledge is set into the western wall, between the two tunnel entrances.
> 
...
Three enslaved [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) guard this 30-foot-high cave. Shattered shields, broken spears, and torn nets (trophies taken from the kuo-toa) lie heaped against the walls. None of this gear is salvageable.
...
> [!note] 
> 
> **Troglodytes**. Unless they've been drawn elsewhere, twelve enslaved [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) rest atop sawed-off stalagmites in the middle of this 40-foot-high cave.
> 
...
The underground river is loudest here. Three enslaved [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) guard this 30-foot-high cave.
