...
- He wields a giant-sized [trident of fish command](3-Mechanics/CLI/items/trident-of-fish-command-xdmg.md) instead of a greatsword. Uthor has a +14 bonus to hit with the weapon, which has a reach of 10 feet and deals 19 (`3d6 + 9`) piercing damage on a hit, or 22 (`3d8 + 9`) piercing damage if used with two hands.  
