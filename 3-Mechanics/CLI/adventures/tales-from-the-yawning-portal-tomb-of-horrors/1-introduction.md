...
| 3 | A mummified [troglodyte's](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) hand |
| 4 | Half of an iron symbol of [Bane](3-Mechanics/CLI/deities/faerunian-bane-scag.md) |
| 5 | A small burlap pouch filled with various teeth |
| 6 | Burnt fragments of a scroll |
| 7 | A [lute](3-Mechanics/CLI/items/lute-xphb.md) missing its strings |
| 8 | A bloodstained map |
| 9 | An iron gauntlet that is hot to the touch |
| 10 | A gold coin stamped with a worn, hawk-wing helm crest |
| 11 | A [troll](3-Mechanics/CLI/bestiary/giant/troll-xmm.md) finger, still wriggling |
...
| 17 | A piece of [parchment](3-Mechanics/CLI/items/parchment-xphb.md), listing fourteen magical pools and their effects when touched |
| 18 | A vial filled with a dark, fizzy liquid that is sealed and cannot be opened |
| 19 | A feeler taken from a slain [rust monster](3-Mechanics/CLI/bestiary/monstrosity/rust-monster-xmm.md) |
...
| 6 | Is the [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed) thrall of a [mind flayer](3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) |
| 7 | Is possessed by a [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) |
| 8 | Is a [solar](3-Mechanics/CLI/bestiary/celestial/solar-xmm.md) in disguise |
...
If you want sympathy, the Temple of [Ilmater](3-Mechanics/CLI/deities/faerunian-ilmater-scag.md) is in the Sea Ward. No matter how bad things are, you'll be gone in a blink of an eye.

![](3-Mechanics/CLI/adventures/tales-from-the-yawning-portal-dead-in-thay/img/durnan.webp#center)
...
| dice: d10 | Denizen |
|-----------|---------|
| 1 | Devotee of [Tymora](3-Mechanics/CLI/deities/faerunian-tymora-scag.md), encourages adventures to seek out quests, can cast bless |
