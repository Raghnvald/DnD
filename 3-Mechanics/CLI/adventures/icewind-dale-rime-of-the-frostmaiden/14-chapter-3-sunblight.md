...
![Adventurers race against time to stop Xardorok Sunblight from unleashing terror upon Ten-Towns](3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/147-03-000-chapter-splash.webp#center)
...
![A quaggoth convinces a myconid to yield more spores by tearing off its arm](3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/151-03-001-quaggoth-myconid.webp#center)
...
Prolonged contact with Xardorok's chardalyn throne can warp one's mind. A creature that remains in contact with the throne for 1 hour gains a random form of indefinite madness (see "Madness" in the "Dungeon Master's Guide"). If this madness isn't cured within 24 hours, it becomes permanent. Only a [wish](3-Mechanics/CLI/spells/wish.md) spell or divine intervention can end the permanent madness.
...
![Enlarged to ogre size, Xardorok Sunblight defends his forge](3-Mechanics/CLI/adventures/icewind-dale-rime-of-the-frostmaiden/img/152-03-002-xardorok.webp#center)
...
**Chest 5** contains a folded [piwafwi](3-Mechanics/CLI/items/piwafwi-cloak-of-elvenkind-oota.md)—a dark spider silk cloak made by drow. This item has the properties of a cloak of elvenkind but loses its magic if it's exposed to sunlight for 1 hour without interruption.
