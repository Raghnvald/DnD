...
[Greater zombies](3-Mechanics/CLI/bestiary/undead/greater-zombie-tftyp.md) (see appendix A) that escaped from Iniarv's Tower by smashing a hole through a tower wall are chased by Chimera Crew members Alevene Windcoat and Niri Bronzecrown, who are chaotic evil human [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md). There are two greater zombies plus one additional greater zombie for every two members of the party (rounded down), not including sidekicks. The zombies attack the characters, fighting until destroyed.
...
Any creature that steps on the tarp falls into the pit and pulls the tarp with it, taking 3 (`1d6`) bludgeoning damage and landing [prone](3-Mechanics/CLI/rules/conditions.md#Prone). The bottom of the pit contains a [swarm of poisonous snakes](3-Mechanics/CLI/bestiary/beast/swarm-of-venomous-snakes-xmm.md). Climbing the walls of the pit without equipment requires a successful DC 15 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check.
...
A small iron box in the northeast corner of the second story contains two [flasks of alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md), which the Chimera Crew can throw down the murder holes to set the oil on the first story ablaze.
...
The bottom floor of the tower contains [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) and [ogre zombies](3-Mechanics/CLI/bestiary/undead/ogre-zombie-xmm.md) covered in bird droppings thanks to the hole in the roof above (area I6). There are two [zombies](3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) and one [ogre zombie](3-Mechanics/CLI/bestiary/undead/ogre-zombie-xmm.md) for every member of the party, including sidekicks.
...
Ten [swarms of ravens](3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) live on what remains of the main tower's roof. They attack any creature that comes within 30 feet of the roof, fighting until the creature retreats.
...
The first floor of the north guard tower has a 30-foot-high ceiling. The floor is covered in straw, which services as a bed for Ashbreath, a [chimera](3-Mechanics/CLI/bestiary/monstrosity/chimera-xmm.md). Rega Swarn, a chaotic evil human [master thief](3-Mechanics/CLI/bestiary/humanoid/master-thief-mpmm.md) (see appendix A) is feeding the chimera chunks of humanoid flesh, unless they joined a fight in areas I1 or I4. See the "Chimera Crew" sidebar for more information about Rega and Ashbreath.
...
A character with a passive Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) score of 15 or higher spots a locked steel box hidden beneath the straw. Rega has the key to this box, which is trapped with a [poison needle](3-Mechanics/CLI/traps-hazards/poisoned-needle-xdmg.md) (see ""Sample Traps"" in chapter 5 of the "Dungeon Master's Guide").
...
The steel box contains a [potion of diminution](3-Mechanics/CLI/items/potion-of-diminution-xdmg.md), 36 pp, and 1,215 gp.
