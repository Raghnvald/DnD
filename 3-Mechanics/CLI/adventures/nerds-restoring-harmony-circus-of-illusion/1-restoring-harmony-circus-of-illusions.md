...
- After looking around and investigating all the characters in the circus, Green discovers that [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) the Magician has the Emerald Gem, which he's hidden in a magic mirror.  
...
The nervous man introduces himself as [Mr. Honeycutt](3-Mechanics/CLI/bestiary/npc/mr-honeycutt-nrh-tcmc.md) and says to Green that he needs their help in a matter of utmost importance. If Green is willing to hear Mr. Honeycutt out, he tells Green that he's the current Magister of the Lorekeeper Society—an ancient and secret group dedicated to the defense of Harmony. He believes he knows how to solve the mystery of the color outages and to do this, he needs to recover the Emerald Gem. He believes this gemstone is in the possession of a thief who's somewhere in the Circus of Illusions, an entertainment mainstay of Harmony. Mr. Honeycutt says a bard of Green's talent and charm could easily infiltrate the circus as a performer. If Green is amenable, Mr. Honeycutt gives Green a [potion of healing](3-Mechanics/CLI/items/potion-of-healing.md) and whispers "Watch out for the clowns." He awaits Green's return in the tavern.
...
Should anyone try to break into the circus or cause trouble, they run afoul of a couple of these clowns. Avoiding the clowns requires a successful DC 12 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check. On a failure, `1d4` [clowns](3-Mechanics/CLI/bestiary/humanoid/clown-nrh-coi.md) investigate, ready to pummel and eject any trespassers or ne'er-do-wells. If Green turns to run away, the clowns don't give chase, but shout taunts and honk horns at them.

Charming the clowns takes real skill and can only be done with a successful DC 15 Charisma ([Persuasion](3-Mechanics/CLI/rules/skills.md#Persuasion)) check.
...
Finster is the [imp](3-Mechanics/CLI/bestiary/fiend/imp.md) [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) made a deal with: two years' infernal service for the location of the Emerald Gem. Now the deal is complete, Finster is enjoying changing [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s show to feature them more, so they can live out their dream of being a star.

Finster spends most of their time in [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s tent, in rat form, primping their whiskers and waiting for their nightly show just before midnight. Rarely do they show their true form. Finster is a total narcissist and dreams of one day having [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) as their assistant in their own magic show.

If Finster feels they can use the Emerald Gem to advance their career or make another deal, they do. Finster has no loyalty to [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md), other than using him for their own gain. If attacked, Finster shrieks to alert any nearby clowns and turns [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible).
...
[Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) is a magician of some skill, but instead of honing his craft further, he craved the escape of easy money and fell into the diabolic clutches of Finster, an opportunistic imp. Finster answered [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s pleas for gold and fame and offered him a deal: two years' service for the location of the Emerald Gem.

[Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) heard of the Emerald Gem through some shady characters he knows. They told him that a Mr. Greystone was willing to pay handsomely for it and [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) saw this as his ticket out of the small-change circus life. With Finster's help, [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) found the gem and is now haggling a price with Mr. Greystone to make it worth his two years' infernal servitude.

[Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) isn't a spellcaster, his magic tricks are sleight of hand illusions. If attacked, he cowers and pleads for his life.

#### Mimes

Wandering the circus grounds are mimes ([commoners](3-Mechanics/CLI/bestiary/humanoid/commoner.md)) who do all kinds of silent performances such as walking downstairs, opening doors, pulling on ropes, and moving around [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) objects.
...
- The mime saw [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) holding a magical green gem in his tent.  
- [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) hid the gem in a magic mirror.  
...
Rubina (a [noble](3-Mechanics/CLI/bestiary/humanoid/noble.md)) is the Circus of Illusions' eccentric and charismatic ringmaster. She's a good-natured bundle of nervous energy and makes sure the circus runs without a hitch, organizing all the entertainment for each day.

##### What Rubina Knows

As of late, Rubina has grown concerned about her best magician, [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md). Rubina thinks it's probably just the color outages, which have everyone concerned, but she's heard him arguing with someone in his tent at night.

Rubina doesn't like [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s pet rat, Finster, who [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) is now featuring in his magic act. She thinks it's a horrid beast and she doesn't like its little smirk and beady eyes.

She doesn't know anything about an emerald, but [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) did say he was going to be rich and that he'd be leaving the circus in a year.
...
Rubina tells Green that Filippo Fleetfinger, her best musical act, suddenly canceled on account of melancholy over the color outages, and now Green must take his place and entertain the crowd gathered in the big tent. She offers Green up to 10 gp to do a show.
...
- **Play It Safe.** Green plays it safe and gives a solid, but uninspired, performance. If your player does some inspired roleplaying, give them advantage on the check. Green must make a DC 12 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check. On a failure, there are some frowning faces and maybe a couple of yawns. Clearly, they weren't expecting much. On a success, the crowd claps politely and then quickly forgets the performance as they wait for the next show.  
- **Go for It!.** Green attempts the performance of a lifetime with a DC 15 Charisma ([Performance](3-Mechanics/CLI/rules/skills.md#Performance)) check. If your player does some inspired roleplaying, they have advantage on the check, or you could even allow them to succeed outright. On a failure, there are audible groans from the crowd and Rubina manages to crack a supportive smile, but looks crestfallen. On a success, minds are blown, the crowd goes wild, and there are calls for encores. After the show, signatures are demanded. From now on, Green is a celebrity in the city of Harmony. At the end of all the hubbub, Rubina approaches Green with tears in her eyes and gives Green a doss lute. There's an audible gasp from the crowd. "It was sublime. A gift that has lifted my spirits forever," Rubina says.  

### Exploring the Circus

The following locations are keyed to the Circus of Illusions map:

![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-circus-of-illusion/img/008.webp#center)
...
At any given time, the stage hosts performances from sword-swallowers, fire-eaters, jugglers, acrobats, musicians, storytellers, and of course, [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s magic act.

#### C3. Magnifico's Tent

Outside this tent, a wooden sign reads "[Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) the Great" in florid, painted letters. Two unshaven [clowns](3-Mechanics/CLI/bestiary/humanoid/clown-nrh-coi.md) stand either side of the entrance, one picking his teeth with a broken chicken bone. The clowns stop anyone trying to enter the tent and aren't hesitant to escalate to blows.

##### Sneaking In

If Green wishes to enter stealthily, they must make a successful DC 12 Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check or alert the clowns or Finster (an [imp](3-Mechanics/CLI/bestiary/fiend/imp.md)), who's inside the tent in rat form.

##### Inside the Tent

Inside the tent is a small table with two chairs, surrounded by the tools of [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s trade: a top hat, silken handkerchiefs, a cabinet with a false back, a deck of playing cards, a crystal ball, a large mirror in an ornate frame, and a white dove in a cage. If Finster is alive, they're also in the tent in rat form. If Green successfully sneaked in, they surprise Finster, who pretends to be a simple magician's rat, but carefully observes what Green does. You can also throw a wrench in Finster's plans by having Green surprise them while in imp form.

If Finster heard Green coming, they hide and observe Green from the shadows. Spotting Finster while they're hidden requires a successful DC 15 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check.
...
[Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) has hidden the Emerald Gem inside the magic mirror in the ornate frame. The mirror is actually a portal to a small 5-foot square demiplane where the Emerald Gem is kept inside a locked box. If the mirror is touched, its surface ripples like water. Green can step through the mirror's surface into the demiplane where the locked box is. Inside the demiplane, it's totally dark.
...
The box's lock can be picked with a successful DC 14 Dexterity ([Sleight of Hand](3-Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check.

#### C4. Rubina's Tent

If Rubina (a [noble](3-Mechanics/CLI/bestiary/humanoid/noble.md)) is here, she's looking over the upcoming schedule of events for tonight and the next couple of days. There's a desk, two wooden chairs, a small table, and a sofa. So long as they're nice to her, Rubina treats anyone who enters her tent the way a kindly schoolmarm would.

#### C5. Filippo Fleetfinger's Tent

Inside this tent is the morose bard, Filippo (a [noble](3-Mechanics/CLI/bestiary/humanoid/noble.md)). Filippo knows nothing about the Emerald Gem, but he's sad about the color outages and is writing deeply emotional poems about them.

He's noticed that [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) seems odd lately and he's a bit revolted that [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s once tasteful show now seems dedicated to his awful rat.
...
If [Imelda](3-Mechanics/CLI/bestiary/npc/imelda-nrh-coi.md) is here, she's sipping tea and munching on cakes in between shows. She loves to chat and is always ready to provide a good workout routine to anyone who's interested. [Imelda](3-Mechanics/CLI/bestiary/npc/imelda-nrh-coi.md) knows nothing about the Emerald Gem, but she's fiercely loyal to the circus and Rubina, and will do anything to protect them. Her tent is filled with barbells, iron bars, and trophies from all her past feats of strength.

#### C7. Vendors

These tents are for vendors of tasty treats like kettle corn, caramel apples, and toad-in-the-holes. You can also put in a strength test game where you hit the lever with a hammer to ring the bell. Green must make a successful DC 14 Strength ([Athletics](3-Mechanics/CLI/rules/skills.md#Athletics)) check to ring the bell and win a prize (a stuffed monster of the player's choice).

### Getting the Gem

Once the mimes and Rubina point Green in the direction of [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md), there are many ways for Green to get the gem. Here are a few ideas:

- Have Green discover the exact whereabouts of the gem by spying on [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md), who obsessively checks on the gem to make sure his nest egg is safe.  
- Have Finster give up the location of the gem for a price.  
- Stage an attack by a couple of [clowns](3-Mechanics/CLI/bestiary/humanoid/clown-nrh-coi.md) who were hired by Mr. Greystone to steal the gem from [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s tent. If [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md) hears of this, he might come to Green in desperation. Green can enlist the help of [Imelda](3-Mechanics/CLI/bestiary/npc/imelda-nrh-coi.md) to tip the odds in their favor if it comes to a fight.  
- Have Green try to get the gem during one of [Magnifico](3-Mechanics/CLI/bestiary/npc/magnifico-nrh-coi.md)'s magic acts when he has the magic mirror on stage, resulting in a grand spectacle for the audience.  

By the end of it all, Green should get the Emerald Gem and the doss lute (if Rubina didn't already give it to them) as thanks for Green's heroics in such a dull and dreary time.
...
![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-circus-of-illusion/img/sheet007.webp#center)

![](3-Mechanics/CLI/adventures/nerds-restoring-harmony-circus-of-illusion/img/sheet008.webp#center)