...
![](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/000-00-001-iggwilv-cover.webp#center)
...
Appendix B contains a creature that dwells in the Lost Caverns, the [pech](3-Mechanics/CLI/bestiary/elemental/pech-ditlcot.md).
...
![](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/001-00-002-original-cover.webp#center)
...
> [!gallery]
> ![Map 1.1: Lesser Caverns](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/002-map-0-01-lesser-caverns.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/003-map-0-01-lesser-caverns-player.webp#gallery)
...
![A ghastly visage outside the entry caverns portends the dangers within](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/004-00-003-ghastly-visage.webp#center)
...
The figure is a clay golem created by Iggwilv to destroy intruders. The golem attacks any creature that enters the chamber. The golem fights to the death and pursues trespassers relentlessly, even chasing them out of the caverns.

##### Treasure

The weapon stuck in the clay golem is a slender-bladed [Giant Slayer (shortsword)](3-Mechanics/CLI/items/giant-slayer.md). The sword's name ("Longtooth") is engraved into the blade in Gnomish. Once the golem is destroyed, the sword can easily be freed from its chest.
...
![Four pechs diligently dig a staired tunnel up into the mountain, decorating its walls with carvings](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/005-00-004-diligent-pechs.webp#center)
...
Eight [pechs](3-Mechanics/CLI/bestiary/elemental/pech-ditlcot.md) (see appendix B) are diligently carving a tunnel from this grotto up into the mountain toward an enclosed cavern they can sense. For now, the tunnel leads only to a dead end. If the characters draw attention with light or noise, the pechs investigate.
...
The carvings on the walls depict cave-dwelling creatures, such as bats and crickets, as well as creatures from the Elemental Plane of Earth such as dao, [pechs](3-Mechanics/CLI/bestiary/elemental/pech-ditlcot.md), xorn, and earth elementals. Characters who inspect the carvings and succeed on a DC 16 Intelligence (Arcana) check identify the planar creatures.
...
Six patches of [green slime](3-Mechanics/CLI/traps-hazards/green-slime.md) (see the "Dungeon Master's Guide") cling to the ceiling near the fallen adventurer. A character who inspects the slime and succeeds on a DC 15 Intelligence (Nature) check recognizes the danger it poses. The slime falls on creatures that approach the corpse.
...
The elf corpse carries a silvered rapier and wears [Bracers of Defense](3-Mechanics/CLI/items/bracers-of-defense.md).

#### L8: Stinking Cave

![Three hungry trolls pass the time in their foul-smelling cave](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/006-00-005-hungry-trolls-splash.webp#center)
...
Gathered under the trolls' beds is their accumulated loot: 120 gp, 900 sp, four gems worth 50 gp each, gnome-sized wooden dentures set with mother-of-pearl teeth (worth 50 gp), a quiver with twenty silvered arrows, and a [Potion of Healing (greater)](3-Mechanics/CLI/items/potion-of-greater-healing.md).
...
Stashed beneath the fomorians' beds are two ivory mammoth tusks (each is worth 600 gp and weighs 100 pounds), a [Spell Scroll](3-Mechanics/CLI/items/spell-scroll.md) of Levitate, and a beaten copper bowl with lapis lazuli handles, which is worth 750 gp.
...
The vessel is a [Folding Boat](3-Mechanics/CLI/items/folding-boat.md) created to traverse the lake and the rivers that branch from it. In addition to its usual properties, the boat has an extra command word that functions only while the boat is within the Lost Caverns. A character who knows this additional command word ("Shrimpkin")—discovered by casting the Identify spell on the boat or by examining clues in the boat's intricate designs and succeeding on a DC 16 Intelligence (Arcana) check—can command the boat to row itself in a particular direction at a speed of 30 feet or to hold its position in defiance of the water's swiftest currents.
...
The head and shoulder of a petrified gnome lie near the basilisk nest at the back of the cave. The broken statue wears a pair of unpetrified goggles, which are [Eyes of Minute Seeing](3-Mechanics/CLI/items/eyes-of-minute-seeing.md).
...
![Adventurers clash with the behir Lludd in his lair within the Lost Caverns](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/007-00-006-behir-lludd-splash.webp#center)

The ceiling of this colorful cavern rises to a height of 50 feet. Careful examination of the floor reveals many cracked bone fragments among the stalagmites. Once the lair of a chimera, this cavern is now home to Lludd, a clever and long-lived behir who ousted the smaller, weaker creature that preceded him. Lludd speaks Common and Giant in addition to Draconic. The behir lurks on a rufous ledge near the entrance to the chamber, waiting for morsels worthy of his hunger.
...
Inside Lludd's stomach is a [Periapt of Proof against Poison](3-Mechanics/CLI/items/periapt-of-proof-against-poison.md) left over from an unlucky explorer the behir digested.
...
- [Demon Skin](3-Mechanics/CLI/items/demon-skin-ditlcot.md)  
- [Iggwilv's Horn](3-Mechanics/CLI/items/iggwilvs-horn-ditlcot.md)  
- [Potion of Polychromy](3-Mechanics/CLI/items/potion-of-polychromy-ditlcot.md)  
- [Tasha's Creeping Keelboat](3-Mechanics/CLI/items/tashas-creeping-keelboat-ditlcot.md)  
...
|  | Cast Control Water, Water Breathing, or Water Walk | +1 |
...
> [!gallery]
> ![Cathartic](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/013-00-012-cathartic.webp#gallery)
> ![Dunil](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/014-00-013-dunil.webp#gallery)
> ![Ethelrede](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/015-00-014-ethelrede.webp#gallery)
> ![Flemin](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/016-00-015-flemin.webp#gallery)
> ![Rustle Berrydust](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/017-00-016-rustle-berrydust.webp#gallery)
> ![Weslocke](3-Mechanics/CLI/adventures/descent-into-the-lost-caverns-of-tsojcanth/img/018-00-017-weslocke.webp#gallery)
