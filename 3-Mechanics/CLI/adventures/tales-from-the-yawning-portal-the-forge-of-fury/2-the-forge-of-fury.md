...
- json5e-note
tags:
- ttrpg-cli/compendium/src/5e/tftyp-tfof
aliases:
- "The Forge of Fury"
---
# The Forge of Fury
...
- **The Mountain Door..** The Mountain Door comprises the uppermost level of the cavern complex. It is currently inhabited by a tribe of fierce orcs, led by a brutal ogre known as [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md).  
...
In the mining town of Blasingdell, the characters learn that orc raiders have been pillaging isolated farmsteads and camps in the hills north of the town. The local militia captured an orc warrior left for dead by its comrades and brought it back for questioning. Under the influence of a [charm person](3-Mechanics/CLI/spells/charm-person-xphb.md) spell, the orc divulged the location of the monsters' lair, a lonely hill called the Stone Tooth. The mayor offers a bounty of 25 gp per orc, dead or alive, and the gratitude of the townsfolk to any who can permanently end the threat.
...
> 
> The town's mayor is **Sir Miles Berrick** (male human [noble](3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)).
> 
> **Sergeant Grendar Kuln** (male half-orc [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) is in charge of the town watch; **Constable Dara Whitewood** (female human [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) is the senior officer. The town watch consists of two full-time guards in addition to its officers. A militia force of around 100 commoners can be mustered in emergencies.
> 
> **Kheldegan Tolm** (male dwarf [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) owns Tolm's Superior Outfitting and Dry Goods.
> 
> **Sarel Bankdown** (female half-elf [commoner](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) is the proprietor of the Griffon's Nest inn and tavern.
> 
> **Sister Alonsa** (female human [priest](3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md)) heads up the town's small temple (its primary deity is left to you). Sister Alonsa is assisted in her duties by two [acolytes](3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md).
...
The path climbs to the Mountain Door, at the location marked A on the map. This is the route used by the orcs in [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s tribe to come and go from their lair.
...
The tunnel entrance is about 6 feet high and 4 feet wide. Anyone who succeeds on a DC 10 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check can spot old tracks passing in and out of the tunnel—reptilian footprints (from the [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) inhabiting the Glitterhame) and the paw prints of a very large [bear](3-Mechanics/CLI/bestiary/beast/brown-bear-xmm.md).
...
The characters might choose to observe the path for some time before braving the Stone Tooth. When they arrive, two foraging parties from [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s tribe are searching the nearby hills for loot. The first party of four [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) returns two days after the characters arrive, and the second group three days after that. These orcs sleep by day and travel by night, so they arrive in the party's vicinity just before dawn.
...
This former dwarven strongpoint is now occupied by a band of orc raiders, led by a fierce ogre who calls himself [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md). These raiders emerge from the Mountain Door to hunt and pillage in the surrounding area. To keep their lair secure, the orcs have blocked access to the lower levels of Khundrukar, and they rarely encounter the other denizens of the cave system.
...
> 
> **Round 12.** [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md) and the orcs from area 11 move to area 5 to ready a counterattack.
...
If the characters are repelled, they must deal with additional reinforcements if they try this approach again. Two orcs from area 11 stand watch at the doors on the west side of area 3, while the [orc Eye of Gruumsh](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) from area 9 backs up the orcs in area 4 or 4a.
...
If the orcs destroy the bridge but repel the invaders in doing so, [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s followers rebuild it within three days. Any orcs killed here are replaced by orcs from area 11.
...
Four [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), three in area 4 and one in area 4a, overlook the stairs leading up to area 2. These orcs aren't particularly vigilant, but they do start shooting if the sentries in area 1 call for help. The orcs are armed with longbows instead of javelins: `+3` to hit (range 150/600 ft.); 5 (`1d8 + 1`) piercing damage on a hit.
...
If the characters defeat these orcs but withdraw from the dungeon before overcoming the rest of them, the archers are replaced by orcs from area 14 and reinforced by the [orc eye of Gruumsh](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) from area 9.
...
When the second orc raiding party returns (five days after the characters arrive at the Stone Tooth), they take up residence here. Add four [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) to this room after their return.
...
The prisoners are a pair of human [commoners](3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) named Geradil and Courana. They hail from a small settlement a few miles from Blasingdell, and the orcs have held them captive for almost a month now. Neither one's family could raise the ransom demanded by their captors, so both await a terrible death at the orcs' hands.
...
The characters can free the prisoners and escort them back to their homes (about a day's travel away). The grateful families reward them with two [potions of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md). Taking the time to see Geradil and Courana to safety, however, gives the orcs a chance to prepare for the next assault.
...
Burdug the shaman, an [orc Eye of Gruumsh](3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md), has commandeered a chamber as her private domain. She lives here with her two followers, female [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md), separate from the rest of the tribe.
...
Burdug orders her two followers to engage intruders while she attempts to neutralize a dangerous-looking combatant with a [command](3-Mechanics/CLI/spells/command-xphb.md) spell. Then she casts [bless](3-Mechanics/CLI/spells/bless-xphb.md) on herself and the others, and finally casts [spiritual weapon](3-Mechanics/CLI/spells/spiritual-weapon-xphb.md) before joining battle.

If the fight goes poorly, Burdug throws [alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md) (she has three flasks) and opens the door to area 10, releasing the [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md). She takes advantage of the confusion, using more alchemist's fire if necessary, to escape and seek help.

#### Treasure

A character who makes a successful DC 10 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check finds two leather sacks among the clutter, each containing 160 sp. If Burdug is defeated, the characters can recover any of her three flasks of [alchemist's fire](3-Mechanics/CLI/items/alchemists-fire-xphb.md) that weren't used.
...
If the characters aren't trying to be quiet, four hungry [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) attack.
...
Four [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) live in an old guardroom. These orcs fight dirty. They team up into pairs, each focusing on one character. One orc in the pair attempts to shove the character, then the other attacks, hoping for a [prone](3-Mechanics/CLI/rules/conditions.md#Prone) target.
...
If the characters leave the complex before they have defeated [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md), two of these orcs move to reinforce area 2 (reducing the number in this room to two) before the characters return.
...
> [!readaloud] 
> 
> Beyond the door lies a small chamber covered in poorly cured animal hides and illuminated by smoking torches in bronze sconces. The smell is indescribable. A monstrous creature about ten feet in height steps forward, a massive axe in one hand. Two huge wolves strain at chains held closely in its other hand. "You think to challenge the [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)?" the creature booms. "Vak! Thrag! At them!"
> 
...
[Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md) is a fierce [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) who leads the orcs of the Mountain Door. The chamber he claims as his own once belonged to the dwarf watch-captain.

If the characters fail to open the door on the first attempt, [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md) is alerted to their presence. He releases his two [dire wolves](3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md), Vak and Thrag, and takes the [Ready](3-Mechanics/CLI/rules/actions.md#Ready) action to attack the first enemy who enters the room. He is armed with a greataxe instead of a greatclub: `+6` to hit; 17 (`2d12 + 4`) slashing damage on a hit.

[Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md) neither asks nor gives quarter, but if the ogre falls, the wolves attempt to flee.

#### Development

If the characters defeat [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md) but leave any orcs alive, one of the surviving orcs claims leadership of the tribe. If at least half the orcs in the tribe are slain in addition to Ulfe, any survivors abandon the dungeon after the party leaves. They become roving bands of raiders that the adventurers might have to deal with later.

#### Treasure

[Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md) keeps his hoard in two large wooden chests against the south wall: 440 gp, 1,600 sp, a [potion of climbing](3-Mechanics/CLI/items/potion-of-climbing-xdmg.md), and a [+1 rapier](3-Mechanics/CLI/items/1-weapon-xdmg.md). (The ogre would never stoop to wielding the delicate blade like some prancing bard.)
...
A large chamber, once the principal bunk room for dwarf guards posted in this part of the dungeon, has been appropriated by [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s orcs. Up to eleven of the creatures live here, but at the moment a group of them are out raiding the countryside nearby, and three others are on duty in area 4.
...
Only Old Yarrack the [orog](3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) and four [orcs](3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) are at home when the characters enter the chamber. They enter combat as soon as they're aware of intruders.

If the battle goes poorly for the orcs, Old Yarrack orders an orc to break off and summon help from area 9. If things get desperate, he sends for help from the orcs in area 11. If the orcs here fall, Yarrack attempts to join [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s forces in area 12. The orog carries a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and drinks it if his current hit points drop to one-fourth his hit point maximum or lower.
...
A successful DC 10 Wisdom check reveals a loose stone on the south wall, concealing a sack that holds 250 sp and 40 gp. Aside from his [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), Old Yarrack keeps his personal treasure in area 8.
...
The Glitterhame is now home to a band of [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md), dangerous reptilian savages that haunt underground places. The troglodytes and [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s tribe maintain an uneasy peace, although skirmishes occur. The troglodytes usually use the old orc tunnel (see area 21) to hunt on the surface and leave the orcs alone. In return, [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s followers rarely invade the troglodytes' domain.
...
Stirges have made their nest in a small cave overlooking the stream, about halfway down the passage. Fissures at the back of the cave run 150 feet to the surface, but nothing larger than a stirge can fit through. Six [stirges](3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) are sleeping in the nest, but any noise or light from a party descending the streambed wakes them. Each round after the characters enter the cave, `1d4` stirges wake and attack, until all are active.
...
Characters who are being stealthy might catch the troglodytes unawares. If the characters are carrying any light sources or making a lot of noise when they enter, the troglodytes in the west and southeast chambers are alerted. As soon as any fighting begins, one troglodyte attempts to escape to the north, toward area 19, and summon [Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md), the chieftain.

#### Northwest Chamber

Two [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) are sleeping in the small cave to the northwest when the characters enter area 18.

#### Southwest Chamber

The females tend the colony's eggs and raise hatchlings in the southwest cave. Six [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) defend the hatchery and fight to the death to defend their young.
...
Three [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) recently returned from the hunt are relaxing in the southeast cave. Unless they are alerted to the characters' presence, they are concentrating on devouring what's left of a small deer.
...
The chief of the troglodytes, [Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md), occupies the chamber along with his pet [giant lizard](3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md). [Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md) is a [troglodyte](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) with the following changes, which increase his challenge rating to 2 (450 XP):
...
[Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md) is a 4th-level spellcaster. His spellcasting ability is Charisma (spell save DC 12, `+4` to hit with spell attacks). He knows the following sorcerer spells:

Cantrips (at will): [fire bolt](3-Mechanics/CLI/spells/fire-bolt-xphb.md), [mage hand](3-Mechanics/CLI/spells/mage-hand-xphb.md), [poison spray](3-Mechanics/CLI/spells/poison-spray-xphb.md), [prestidigitation](3-Mechanics/CLI/spells/prestidigitation-xphb.md), [ray of frost](3-Mechanics/CLI/spells/ray-of-frost-xphb.md)

1st level (6 slots): [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md), [shield](3-Mechanics/CLI/spells/shield-xphb.md), [sleep](3-Mechanics/CLI/spells/sleep-xphb.md)

2nd level (3 slots): [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md), [scorching ray](3-Mechanics/CLI/spells/scorching-ray-xphb.md)

If the characters make a lot of noise or tip off their presence in some other way, [Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md) begins this encounter [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) (see below). Otherwise, read:
...
If [Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md) is alerted to the party's approach, he casts [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md) on himself before they enter. If he loses at least half his hit points, he tries to escape (using [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md) if possible). If his escape succeeds, he soon afterward rounds up a war party of surviving troglodytes from other areas to track down and ambush the party.

#### Negotiation

[Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md) starts out hostile and won't become friendly to the characters. Nevertheless, a character who speaks Draconic might be able to stave off combat by parleying with the chieftain. For example, the characters might have captured some of the hatchlings in the southwest chamber, intending to ransom them back to the troglodytes in exchange for treasure. Even if [Kaarghaz](3-Mechanics/CLI/bestiary/npc/kaarghaz-tftyp.md) can be convinced to give up some of his wealth, he doesn't let the matter rest—he forms a war party (as described above) and goes after the characters.
...
The cavern holds the troglodytes' secret weapon—a freshly captured [giant subterranean lizard](3-Mechanics/CLI/bestiary/beast/giant-subterranean-lizard-tftyp.md) (see appendix B). Although the lizard is chained, it can attack anyone who comes within its reach. It strikes with its tail first, hoping to knock a target [prone](3-Mechanics/CLI/rules/conditions.md#Prone), then snaps at it with its powerful jaws to gulp it down.

#### Treasure

The two chests contain a total of 2,200 sp. One holds a [potion of climbing](3-Mechanics/CLI/items/potion-of-climbing-xdmg.md), and the other a [potion of water breathing](3-Mechanics/CLI/items/potion-of-water-breathing-xdmg.md).
...
In the northern part of the cavern, near the passages that run east and west, two [troglodytes](3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) are hiding. From their Chameleon Skin trait, they have advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks to hide. The troglodyte on the west side waits for an opportune moment to attack intruders with surprise. The other moves east to the gate and opens it to release a [brown bear](3-Mechanics/CLI/bestiary/beast/brown-bear-xmm.md), which attacks any non-troglodyte in the next round (roll initiative for the bear when it is released).
...
The dwarf skeleton clutches a [+1 longsword](3-Mechanics/CLI/items/1-weapon-xdmg.md) that bears Durgeddin's smith-mark. The human skeleton wears a steel helmet chased with silver, worth 110 gp.
...
Two [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) lurk in the 20-foot-high rockfall that spills down from area 26, at the place where the path leading east comes closest to the slope. They are wedged into spaces between boulders, 6 to 8 feet above the cavern floor. Their Stone Camouflage trait gives them advantage on Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) checks made to hide, so they might surprise the party.
...
The two [gricks](3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) hidden in the rockfall (see area 24) make their lair at the end of a passage that winds north from the ledge. They are encountered here if they retreated to attack characters who got past them.

#### Treasure

The gricks discarded the inedible portions of their victims in the back of the cave. Rooting through the grisly remains uncovers a suit of [scale mail](3-Mechanics/CLI/items/scale-mail-xphb.md) and scattered coins totaling 200 cp, 180 sp, and 60 gp.
...
None of the supplies are salvageable. While searching, the characters might blunder into a [gray ooze](3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) that occupies the middle chamber of the three.
...
The southern ledge is the home of a ravenous [roper](3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) that has been feeding on fish from the stream. Unsatisfied with this diet, the roper is eager for larger prey.
...
Cutting open the roper's stony gizzard reveals a [ring of spell storing](3-Mechanics/CLI/items/ring-of-spell-storing-xdmg.md) and six gemstones: a ruby worth 1,000 gp, two emeralds worth 400 gp each, and three serpentines worth 60 gp apiece.
...
The stairs have been warded with a magical alarm. When a creature ascends past the halfway point of the staircase, a [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md) spell calls out in Dwarvish, "Alert! Alert! Intruders approach!" This sound warns the duergar guards in area 36.
...
Two [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) guards and Ghared, a [duergar spy](3-Mechanics/CLI/bestiary/humanoid/duergar-spy-tftyp.md) (see appendix B), stand watch here. Unless the party climbed the stairs from area 35 without triggering the [magic mouth](3-Mechanics/CLI/spells/magic-mouth-xphb.md), the duergar are [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible).
...
If combat occurs, the duergar guards first attack with their javelins. They use their Enlarge ability in the next round, taking cover behind two of the pillars before wading into melee.

Meanwhile, Ghared remains [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) and maneuvers to make a sneak attack, then enlarges herself after she becomes visible. She has a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), which she uses if her current hit points drop to half her hit point maximum or lower.
...
Two [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) smiths are forging a blade at the forge in the center of the south wall. The work is overseen by [Snurrevin](3-Mechanics/CLI/bestiary/npc/snurrevin-tftyp.md), a [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) with the following changes, which increase his challenge rating to 2 (450 XP):
...
> [!note] 
> 
> **Spellcasting.** [Snurrevin](3-Mechanics/CLI/bestiary/npc/snurrevin-tftyp.md) is a 3rd-level spellcaster. His spellcasting ability is Intelligence (spell save DC 12, `+4` to hit with spell attacks). He has the following wizard spells prepared:
> 
> Cantrips (at will): [fire bolt](3-Mechanics/CLI/spells/fire-bolt-xphb.md), [mage hand](3-Mechanics/CLI/spells/mage-hand-xphb.md), [minor illusion](3-Mechanics/CLI/spells/minor-illusion-xphb.md), [shocking grasp](3-Mechanics/CLI/spells/shocking-grasp-xphb.md)
> 
> 1st level (4 slots): [color spray](3-Mechanics/CLI/spells/color-spray-xphb.md), [shield](3-Mechanics/CLI/spells/shield-xphb.md), [silent image](3-Mechanics/CLI/spells/silent-image-xphb.md)
> 
> 2nd level (2 slots): [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md), [shatter](3-Mechanics/CLI/spells/shatter-xphb.md)
^10c

[Snurrevin](3-Mechanics/CLI/bestiary/npc/snurrevin-tftyp.md) has a familiar, a [rat](3-Mechanics/CLI/bestiary/beast/rat-xmm.md) named Browngnaw, that hides in the shadows near the unlit forge to the east. The duergar are preoccupied with their task and don't notice the party's entrance unless the characters make themselves known. They object violently to intruders who aren't escorted by duergar.
...
In combat, [Snurrevin](3-Mechanics/CLI/bestiary/npc/snurrevin-tftyp.md) might cast [shocking grasp](3-Mechanics/CLI/spells/shocking-grasp-xphb.md) through his hidden familiar, and he might use [silent image](3-Mechanics/CLI/spells/silent-image-xphb.md) to confound enemies with realistic-seeming threats.

#### Treasure

In the cold forge in the northwest corner of the room, [Snurrevin](3-Mechanics/CLI/bestiary/npc/snurrevin-tftyp.md) has stashed 320 gp, 1,100 sp, a gold necklace set with ruby stones worth 900 gp, and a [potion of hill giant strength](3-Mechanics/CLI/items/potion-of-hill-giant-strength-xdmg.md).
...
Unless the party is under Ghared's protection (see area 36), the lone [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) on duty fights to the death to protect his leader, who is in area 40.

If the characters engage the duergar guard, the sounds of battle alert the leader, [Nimira](3-Mechanics/CLI/bestiary/npc/nimira-tftyp.md). She is a [duergar](3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md) with the following changes, which increase her challenge rating to 3 (700 XP):
...
> [!note] 
> 
> **Multiattack.** [Nimira](3-Mechanics/CLI/bestiary/npc/nimira-tftyp.md) makes two greatsword attacks.
> 
...
[Nimira](3-Mechanics/CLI/bestiary/npc/nimira-tftyp.md) uses Enlarge and comes out to join the fight in the next round. If her guard falls or she faces at least three enemies, and negotiation isn't an option, she turns [invisible](3-Mechanics/CLI/rules/conditions.md#Invisible) and tries to escape into area 36 or through the secret door that leads east out of area 40.

#### Negotiation

[Nimira](3-Mechanics/CLI/bestiary/npc/nimira-tftyp.md) is an excellent fighter, but she is pragmatic and willing to negotiate in the right circumstances. She knows the same information as the duergar in area 36 and might be convinced to guide the party to the chasm that leads to the dragon's lair (area 38).
...
Durgeddin led a spartan lifestyle, eschewing rich decorations and treasures in his personal quarters. [Nimira](3-Mechanics/CLI/bestiary/npc/nimira-tftyp.md) has appropriated the room for her own use.
...
If the party enters the room through the secret door in the closet (see below), or if the characters avoided or quietly dealt with the guard in area 39, [Nimira](3-Mechanics/CLI/bestiary/npc/nimira-tftyp.md) is here, resting on the pallet. Otherwise, the room is empty. The satchels contain mundane supplies: extra clothes, food, lamp oil, and similar stuff.
...
The east wall of the closet conceals a secret door. The door isn't well hidden, requiring a successful DC 10 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check to find. [Nimira](3-Mechanics/CLI/bestiary/npc/nimira-tftyp.md) knows about the secret passage and escapes through it if pressed.
...
An [animated table](3-Mechanics/CLI/bestiary/construct/animated-table-tftyp.md) (see appendix B) activates when someone enters the main part of the room. It fights until destroyed but won't attack a dwarf. See the "Arundil's Animated Objects" sidebar.
...
The orcs looted the shrine after the fall of Khundrukar, but two members of the previous expedition fell to the undead defenders with valuables in their possession. Under a scattering of bones near the altar can be found a sack that holds 280 gp and a bone case that contains a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [web](3-Mechanics/CLI/spells/web-xphb.md) and a [spell scroll](3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [spider climb](3-Mechanics/CLI/spells/spider-climb-xphb.md).
...
Area 43, area 46, and all the rooms marked 44 are now the demesne of the dwarf mage Arundil, who lingers as an insane [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md).
...
The six [skeletons](3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) attack any non-undead creature that enters. They don't pursue anyone beyond this chamber.
...
If the characters approach this area from the secret door to the south before entering area 43, Arundil the [ghost](3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) confronts them here; refer to the encounter in area 43. Otherwise, there is nothing dangerous or valuable in the area.
...
The rug, 20 feet square, is actually a Gargantuan [rug of smothering](3-Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md) that activates when any non-dwarf sets foot on it. It fights until destroyed but doesn't attack a dwarf under any circumstances. See "Arundil's Animated Objects" above.
...
One of the armor stands is actually an animated object (use the [animated armor](3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md) stat block), which activates when a non-dwarf enters the room. It fights until destroyed. See "Arundil's Animated Objects" above.
...
Arundil summoned a [succubus](3-Mechanics/CLI/bestiary/fiend/succubus-xmm.md) and commanded it to guard the area that is now the domain of Arundil's ghost (see area 43). But the fiend easily overpowered Arundil's will, then toyed with him cruelly until it finally drained his life force.
...
The dwarf scholar amassed a small amount of treasure, which he kept in the secret compartment: 110 gp and a cat's-eye gem worth 70 gp. In the library, in addition to an extensive collection of dwarven lore, the characters can find four [spell scrolls](3-Mechanics/CLI/items/spell-scroll-xdmg.md) (of [alarm](3-Mechanics/CLI/spells/alarm-xphb.md), [disguise self](3-Mechanics/CLI/spells/disguise-self-xphb.md), [enlarge/reduce](3-Mechanics/CLI/spells/enlarge-reduce-xphb.md), and [shield](3-Mechanics/CLI/spells/shield-xphb.md)). The shelves might also include more scrolls, useful information tying in to future adventures, items of value to a collector, or other interesting lore, as you see fit.
...
When Nightscale becomes aware of intruders, the [young black dragon](3-Mechanics/CLI/bestiary/dragon/young-black-dragon-xmm.md) slips into the water, quietly swimming to a point near the three stepping stones shown on the map. Any character watching the lake can make a Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check contested by the dragon's Dexterity ([Stealth](3-Mechanics/CLI/rules/skills.md#Stealth)) check. On a successful check, the character catches a glimpse of a serpentine form moving in the darkness.
...
Nightscale has accumulated considerable wealth from her plunder of Khundrukar. Her hoard contains 6,200 sp, 1,430 gp, two garnets worth 20 gp each, a black pearl worth 50 gp, a [wand of magic missiles](3-Mechanics/CLI/items/wand-of-magic-missiles-xdmg.md), a [+2 greataxe](3-Mechanics/CLI/items/2-weapon-xdmg.md) bearing Durgeddin's smith-mark, a [+1 shield](3-Mechanics/CLI/items/1-shield-xdmg.md), a [potion of healing](3-Mechanics/CLI/items/potion-of-healing-xdmg.md), and a [potion of flying](3-Mechanics/CLI/items/potion-of-flying-xdmg.md).
...
If the characters were sent to retrieve weapons for Baron Althon, they can bring him the [+1 longsword](3-Mechanics/CLI/items/1-weapon-xdmg.md) from area 22, the [+2 greataxe](3-Mechanics/CLI/items/2-weapon-xdmg.md) in area 53, the [handaxe](3-Mechanics/CLI/items/handaxe-xphb.md) from area 14, and the [warhammer](3-Mechanics/CLI/items/warhammer-xphb.md) from area 23. All bear Durgeddin's smith-mark; Baron Althon pays 500 gp above the market price for each mundane weapon, 1,000 gp for the [+1 longsword](3-Mechanics/CLI/items/1-weapon-xdmg.md), and 6,000 gp for the [+2 greataxe](3-Mechanics/CLI/items/2-weapon-xdmg.md), if the characters are willing to sell.
...
You can also use this adventure to sow the seeds of the characters' next activity. Perhaps the party encounters a legend of a magical treasure from Khundrukar's fall, buried in the tomb of an evil knight. Maybe [Great Ulfe](3-Mechanics/CLI/bestiary/npc/great-ulfe-tftyp.md)'s ogre clan is terrorizing a nearby area, or an orc war chief wields a legendary weapon that was crafted by Durgeddin.
