...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/036-03-001-sja-04-splash.webp#center)
...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/037-03-002-bag-of-holdingh.webp#center)
...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/038-03-003-boatswain-tarto.webp#center)
...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/039-03-004-sarthe-abizjn.webp#center)
...
Characters can easily ascertain where the meteorite came to rest after tumbling down the mountainside. However, the meteorite is nowhere to be seen. Characters who search the area find a single set of tracks leading from the place where the meteorite came to rest to a 15-foot-wide, 20-foot-high cave mouth at the base of the Spindle, about 250 feet away. Any character who examines the tracks and succeeds on a DC 10 Wisdom ([Survival](3-Mechanics/CLI/rules/skills.md#Survival)) check identifies them as belonging to a Large Giant of some kind, possibly an [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md).
...
![Spindle Cavern Map](3-Mechanics/CLI/adventures/spelljammer-academy/img/040-03-009-spindle-cavern.webp#center)
...
- **Meteorite.** The meteorite looks like it was dropped in the middle of the floor. The 500-pound hunk of blackened metal takes on a dark-blue sheen when its surface is illuminated. The meteorite is 2 feet long, 18 inches wide, and 18 inches tall. It can fit inside the characters' [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md).  

#### Creatures

Two [spectators](3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) and six [gazers](3-Mechanics/CLI/bestiary/aberration/gazer-mpmm.md) gather around the meteorite. The spectators can't decide which of them should guard the meteorite, and they are anxious for someone to help resolve their dispute. The gazers were drawn to the cavern by the spectators' argument but lack the intelligence to be of assistance. The cyclopean [ogre](3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) is a simple-minded brute who found the meteorite and brought it here. The ogre serves a powerful beholder named Kurrzot who, fortunately, lives much deeper in the mountain and doesn't appear in this adventure.
...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/041-03-005-orlob-spectator.webp#center)
...
Once they've bagged the meteorite, the characters can use their [sending stone](3-Mechanics/CLI/items/sending-stones-xdmg.md) to contact Boatswain Tarto, or they can simply head back to the tyrant ship. If they use the stone, Tarto replies as follows:
...
The characters have no encounters on their way back to the tyrant ship. Once they climb the rope ladder and get back aboard, Boatswain Tarto takes back the characters' *sending stone* as well as the [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md).
...
Attempting to hide behind the asteroid is a damselfly ship crewed by githyanki. Characters who succeed on a DC 18 Wisdom ([Perception](3-Mechanics/CLI/rules/skills.md#Perception)) check can see a brief glint suggestive of a metallic vessel moments before it disappears behind the asteroid.
...
Qitru, a [githyanki warrior](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md), rides a star lancer. The star lancer used Invisibility Cloak to approach the tyrant ship unseen.
...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/042-03-006-star-lancer.webp#center)
...
If a character uses the [sending stone](3-Mechanics/CLI/items/sending-stones-xdmg.md) to request help from Boatswain Tarto, she says, "I'll be right there!" and heads to the Hollow Deck. Tarto is armed with a musket (`+7` to hit) that deals `1d12 + 3` piercing damage on a hit.
...
Characters who search Qitru or observe her closely notice a strange sigil tattooed on the back of her right hand. A [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals an aura of transmutation magic around the tattoo. The tattoo is Vocath's sigil, worn by those who are closest to the mercane.
...
The damselfly ship has a crew of four giff shipmates and four [githyanki warriors](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md) (not including Qitru). As the tyrant ship moves away from the asteroid, the damselfly's canny giff captain, Mustaf Shultz, instructs the ship's spelljammer, a githyanki named Nalvoor, to follow the tyrant ship to Toril while keeping a safe distance.
...
The characters aren't allowed to attend the senior staff briefing or see Miken, who is confined to his quarters. Two [veterans](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) stand guard outside Miken's room, the door to which has an [arcane lock](3-Mechanics/CLI/spells/arcane-lock-xphb.md) spell cast on it.
...
> [!gallery]
> ![Hammerhead Ship Map](3-Mechanics/CLI/adventures/spelljammer-academy/img/043-map-3-02-hammerhead.webp#gallery)
> ![Player Version](3-Mechanics/CLI/adventures/spelljammer-academy/img/044-map-3-02-hammerhead-player.webp#gallery)
...
This area is brightly lit by [continual flame](3-Mechanics/CLI/spells/continual-flame-xphb.md) spells cast on wall sconces.
...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/045-03-007-githyanki-warrior.webp#center)

#### Creatures

Two wounded [githyanki warriors](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md) (each with 30 hit points remaining) have Miken (an [apprentice wizard](3-Mechanics/CLI/bestiary/humanoid/apprentice-wizard-mpmm.md) with 2 hit points remaining and at-will spells only) in custody. The githyanki are heading toward the *Flighty Foundling* when the characters intercept them. The githyanki don't bother engaging in dialogue. One of them [grapples](3-Mechanics/CLI/rules/variant-rules/unarmed-strike-xphb.md) Miken while the other one attacks.
...
Wizpop is a noncombatant but has found his courage and wants to help in this dire situation. The characters might have him go to get additional help or cause a distraction. If he goes to find help, a few rounds later he returns with two guards (use the [veteran](3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) stat block) to aid in the fight.
...
The two [githyanki warriors](3-Mechanics/CLI/bestiary/aberration/githyanki-warrior-xmm.md) (each with 30 hit points remaining) have Miken (an [apprentice wizard](3-Mechanics/CLI/bestiary/humanoid/apprentice-wizard-mpmm.md) with 2 hit points remaining and at-will spells only) in custody. One of them grapples Miken while the other one uses [misty step](3-Mechanics/CLI/spells/misty-step-xphb.md) to board the ship and attack.
...
![](3-Mechanics/CLI/adventures/spelljammer-academy/img/046-03-008-star-moth-splash.webp#center)
...
> [!gallery]
> ![Spelljammer Academy Handout](3-Mechanics/CLI/adventures/spelljammer-academy/img/047-map-1-01-spelljammer-academy.webp#gallery)