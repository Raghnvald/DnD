...
Hiding behind the barrels is a wounded elf named [Savid](3-Mechanics/CLI/bestiary/npc/savid-cos.md) (N male dusk elf scout). He has 4 hit points remaining and is grateful for any healing the characters can provide.
...
> [!gallery]
> ![Map 7.2: Argynvostholt (Area Q) - Rooftop and Beacon](3-Mechanics/CLI/adventures/curse-of-strahd/img/079-021.webp#gallery)
...
A cart pulled by a draft horse and driven by a mad Vistana named Kolya (CN male human [bandit](3-Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos.md)) stops in front of the mansion. After relieving himself on the statue of Argynvost (area Q1), Kolya untethers the horse and rides back to the Vistani camp outside Vallaki (chapter 5, area N9), leaving the cart and its cargo: a plain wooden coffin.
...
Hot on Ezmerelda's trail are the Vistani leader [Arrigal](3-Mechanics/CLI/bestiary/npc/arrigal-cos.md) (NE male human assassin) and two Vistani bodyguards (CE female [bandits](3-Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos.md)). [Arrigal](3-Mechanics/CLI/bestiary/npc/arrigal-cos.md) rides a black riding horse, while the bandits ride two dire wolves. These dire wolves are servants of Strahd and can't be charmed or frightened.
