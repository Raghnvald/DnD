...
A cult haven contains `2d4` Vallakian adults (LE male and female cultists) and one cult fanatic (LE male or female) who leads them in prayer or orchestrates ritual sacrifices. These cultists worship devils and consider [Lady Fiona Wachter](3-Mechanics/CLI/bestiary/npc/lady-fiona-wachter-cos.md) (see area N4) to be their spiritual leader.
...
Father Lucian Petrovich (LG male human priest) oversees the church and does his best to raise spirits. Assisting him is an orphan and altar boy named Yeska (LG male human noncombatant). A brawny lad with a perpetually furrowed brow named [Milivoj](3-Mechanics/CLI/bestiary/npc/milivoj-cos.md) (see below) tends the grounds and digs graves.
...
[Milivoj](3-Mechanics/CLI/bestiary/npc/milivoj-cos.md) (N male human commoner) is rarely seen without a shovel, which he wields like a club. Modify his statistics as follows:
...
[Szoldar Szoldarovich](3-Mechanics/CLI/bestiary/npc/szoldar-szoldarovich-cos.md) and [Yevgeni Krushkin](3-Mechanics/CLI/bestiary/npc/yevgeni-krushkin-cos.md) (N male human scouts) are local hunters who frequent the Blue Water Inn. They kill wolves and sell the meat for a living, and their work is dangerous and bloody. Both men are grim and have haunted looks in their eyes.
...
Any character who has a horse can keep it here for 1 sp per night. The gray mare is a draft horse named Drusilla, and she likes apples. The horse belongs to [Rictavio](3-Mechanics/CLI/bestiary/npc/rictavio-cos.md) (see area N2c).
...
Characters who search the loft thoroughly find three pitchforks and a locked wooden chest buried under a pile of hay (see "Treasure" below), next to a secret door. If the characters tamper with the chest, the ravens gather into four swarms of ravens and attack. If two swarms are killed, the others flee. Otherwise, they cease their attacks if the characters leave the chest alone. If the fighting continues for more than 3 rounds, [Urwin Martikov](3-Mechanics/CLI/bestiary/npc/urwin-martikov-cos.md) and two other wereravens hear the ruckus and investigate (in human form).
...
The burgomaster, [Baron Vargas Vallakovich](3-Mechanics/CLI/bestiary/npc/baron-vargas-vallakovich-cos.md) (NE male human noble), is a ruthless heel who prides himself on his good breeding and finely honed leadership skills. He stages repeated celebrations to foster happiness, and his "All will be well!" catchphrase has become a sad and tiresome punchline. Baron Vallakovich has convinced himself that if he can make everyone in Vallaki happy, the town will slip free of Strahd's dark grasp.
...
The baron's miserable son, [Victor Vallakovich](3-Mechanics/CLI/bestiary/npc/victor-vallakovich-cos.md) (NE male human mage), has confined himself to the attic (area N3t), where he is content to avoid the unwanted attention of his mother and the disapproving glares of his father. Years ago, Victor found an old spellbook in the mansion's library and used it to teach himself magic. He has been busy constructing a teleportation circle in the hope of escaping Barovia and leaving his parents to their doom.
...
For practice and for fun, Victor dug up some old cat bones behind the Wachter estate (see area N4) and animated them, creating six [cat skeletons](3-Mechanics/CLI/bestiary/beast/cat-skeleton-cos.md) (use the cat stat block, but give them darkvision out to a range of 60 feet and immunity to poison damage, exhaustion, and the poisoned condition). The skeletons attack only when Victor commands them to.
...
The four people are town residents (LE male and female human cult fanatics) whom Lady Wachter has seduced with promises of power, wealth, and long life. They are members of her "book club," eagerly waiting for Lady Wachter to join them, read passages from her manifesto (see area N4q), and maybe conjure up a few coins. Resting on the fifth chair, quietly eavesdropping on the cultists, is the lady's invisible imp, [Majesto](3-Mechanics/CLI/bestiary/npc/majesto-cos.md).
...
[Henrik van der Voort](3-Mechanics/CLI/bestiary/npc/henrik-van-der-voort-cos.md) (LE male human commoner) is a mediocre carpenter and a troubled, lonely man. He profits from the deaths of others, and no one desires his company, because of the ghastly nature of his handiwork. One night several months ago, Strahd visited Henrik in the guise of an imposing, well-dressed nobleman named Vasili von Holtz and promised the coffin maker "good business" in exchange for his help. Since then, Henrik's workshop has become the lair of a pack of vampire spawn—former adventurers who were turned by Strahd. These vampires are lying low for the time being.
...
The Wolf's Head Jamboree has already occurred, making the square's proclamations out of date. If the characters linger, they see the burgomaster's henchman, [Izek Strazni](3-Mechanics/CLI/bestiary/npc/izek-strazni-cos.md) (see appendix D), arrive with two town guards. Izek orders one guard to tear down all of the old proclamations while the other posts the following new one:
...
The two men in studded leather armor are the leaders of the Vistani camp—the brothers [Luvash](3-Mechanics/CLI/bestiary/npc/luvash-cos.md) (CE male human [bandit captain](3-Mechanics/CLI/bestiary/humanoid/vistana-bandit-captain-cos.md)) and [Arrigal](3-Mechanics/CLI/bestiary/npc/arrigal-cos.md) (NE male human assassin). If you used the "Plea for Help" adventure hook, the characters have already met [Arrigal](3-Mechanics/CLI/bestiary/npc/arrigal-cos.md). [Luvash](3-Mechanics/CLI/bestiary/npc/luvash-cos.md) is the older of the two and the brother whom the other Vistani fear most. Each brother carries a key that unlocks one of the padlocks of the treasure wagon (area N9i).
...
In addition to [Luvash](3-Mechanics/CLI/bestiary/npc/luvash-cos.md), [Arrigal](3-Mechanics/CLI/bestiary/npc/arrigal-cos.md), and Alexei, there are six intoxicated Vistani (CN male and female human [bandits](3-Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos.md)) lying unconscious in the tent. A drunk Vistana awakens only if the Vistana takes 5 damage or more and has at least 1 hit point remaining afterward.
