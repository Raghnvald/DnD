...
Use the deva stat block in the "Monster Manual", but change [the Abbot's](3-Mechanics/CLI/bestiary/npc/the-abbot-cos.md) alignment to lawful evil.
...
[Vladimir Horngaard](3-Mechanics/CLI/bestiary/npc/vladimir-horngaard-cos.md) has the statistics of a revenant with the following modifications:
