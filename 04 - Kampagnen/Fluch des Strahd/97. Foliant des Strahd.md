...
Nach einem erfolgreichen Verteidigungsvorgang erhalten die Charaktere ein **Silberamulett**, das **einmal pro Dämmerung** den Ritualzauber **Magic Jar** (6. Stufe) wirken lässt – praktisch, um die eigene Seele zu schützen oder einen gefallenen Kameraden temporär zu beherbergen.
...
Bei erfolgreicher Beschaffung des **Ring of Winter** (oder zumindest des **Schlüssels zum Orator‑Haus**) erhalten die Helden ein **runenverziertes Medaillon**, das **einmal pro Dämmerung** den Ritualzauber **Forbiddance** (6. Stufe) wirken lässt – perfekt, um ein Gebiet vor untoten Eindringlingen zu schützen.
...
Strahd richtet seine Wut nun gegen die **Dämmerelfen**, ein Volk, das er für seine eigenen Zwecke benutzen will. Die Helden begleiten ihn zu einem abgelegenen Lager, wo die Elfen ein **Forcecage‑Ritual** vorbereiten, um ihre Feinde einzusperren.

Während das Ritual läuft, wird ein **großer, leuchtender Kristall** (das Herz von Strahd) sichtbar, und Strahd befiehlt den Elfen, sich zu ergeben. Rahadin steht ihm treu zur Seite.

### Schlüsselmomente

1. **Stealth‑Versuch** – Die Helden können versuchen, unbemerkt zu den gefangenen Elfen zu schleichen (Dexterity Stealth, DC 22).
...
- **Erfolg** – Die Elfen werden gerettet, Strahd verliert einen Teil seiner Macht und das **Herz der Trauer** wird geschwächt. Die Gruppe erhält ein **Kristallfragment**, das **einmal pro Dämmerung** den Ritualzauber **Forcecage** (7. Stufe) wirken lässt.
- **Scheitern** – Alle Elfen sterben, Strahd gewinnt an Ansehen und das Herz pulsiert stärker. Die Gruppe bleibt ohne zusätzliche Belohnung, muss aber mit den moralischen Folgen leben.
