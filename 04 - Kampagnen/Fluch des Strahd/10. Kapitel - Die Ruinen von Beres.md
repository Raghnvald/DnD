...
#### U3: Schätze
Die Holztruhe in der Hütte wird von einer [Glyphe des Schutzes](Glyphe-des-Schutzes.md) beschirmt. die einen gelungenen Wurf auf <font color="royalblue">**Intelligenz** (Nachforschung)</font> gegen <font color="yellow">SG 15</font> benötigt, um sie zu finden. Die Glyphe verursacht `5W8` <font color="orange">Schallschaden</font>, wenn sie ausgelöst wird. Den Deckel zu öffnen lässt vier [Krabbelnde Klauen](Krabbelnde%20Klaue.md) frei, die bis zur Vernichtung kämpfen. Ebenfalls in der Truhe enthalten sind verschiedene Gegenstände, die [Baba Lysaga](Baba%20Lysaga.md) über die Jahre verschiedenen toten Abenteurern abgenommen hat:
