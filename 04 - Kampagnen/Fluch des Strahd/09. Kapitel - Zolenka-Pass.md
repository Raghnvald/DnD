...
### T2: Dämonenstatuen
Diese Statuen sind tatsächlich zwei versteinerte [Vrocks](Vrock.md). Wenn sie angegriffen werden, oder wenn die Charaktere das Torhaus umgehen, verwandeln sich die [Vrocks](Vrock.md) zu Fleisch zurück und gehen in den Angriff über. Sie verfolgen flüchtende Beute und kämpfen, bis sie erschlagen werden.
.
```encounter-table
...
Die Gestalten sind sechs Schneejungfern. Nutze die Werte eines [Schreckgespensts](Schreckgespenst.md) mit den folgenden Modifikationen:
