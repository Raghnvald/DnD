...
| 5        | Grab                                                                                                                              |
| 6        | Falsche Fährte                                                                                                                    |
| 7        | `dice: 1d4 +1` Vistani-**[Banditen](Bandit.md)**                                                                                       |
| 8        | Skelettierter Reiter                                                                                                              |
| 9        | Tand                                                                                                                              |
| 10       | Verstecktes Bündel                                                                                                                |
| 11       | `dice: 1d6` **[Schwärme von Raben](Schwarm-von-Raben.md)** (50%) oder 1 **[Werrabe](Werrabe.md)** (siehe Anhang D) in Rabengestalt (50%) | 
| 12       | `dice: 1d6` **[Schreckenswölfe](Schreckenswolf.md)**                                                                                     |
| 13       | `dice: 3d6` **[Wölfe](Wolf.md)**                                                                                                         |
| 14       | `dice: 1d4` **[Berserker](Berserker.md)**                                                                                               |
| 15       | Leichnam                                                                                                                          |
| 16       | `dice: 1d6` **[Werwölfe](Werwolf.md)** in Menschengestalt                                                                               |
...
| 11       | `dice: 3d6` **[Wölfe](Wolf.md)                                             |
| 12       | `dice: 1d4` **[Berserker](Berserker.md)                                    |
| 13       | 1 **[Druiden](Druiden.md)*** mit `dice: 2d6`**[Zweigplagen](Zweigplage.md)** |
| 14       | `dice: 2d4` **[Nadelplagen](Nadelplage.md)**                               |
| 15       | `dice: 1d6` **[Werwölfe](Werwolf.md)** in Wolfsgestalt                     |
| 16       | `dice: 3d6` **[Zombies](Zombie.md)                                         |
...
$\quad$ Wenn die Charaktere die Truhe berühren, brechen `dice: 3d6` [Zombies](Zombie.md) aus dem Erdboden hervor und greifen an. Sobald die Zombies auftauchen, wird das [Irrlicht](Irrlicht.md) sichtbar und stürzt sich ebenfalls ins Getümmel.
...
`1-2` - Der Leichnam gehörte zu einem [Wolf](Wolf.md), der durch [Speere](../../05%20-%20Wikipedia/Gegenstände/Speer.md) und [Armbrustbolzen](../../05%20-%20Wikipedia/Gegenstände/Armbrustbolzen.md) getötet wurde.

`3-5` - Die Leiche gehört zu einem barovianischen Mann, einer Frau oder einem Kind, der/die offensichtlich von reißenden [Wölfen](Wolf.md) in Stücke gerissen wurde. Wenn die Gruppe von barovianischen Spähern begleitet wird (siehe oben), erkennen die Späher die Leiche als die Person, nach der sie gesucht haben.
...
Der Bereich ist durch den Nebel leicht verschleiert. Wenn mehr als ein [Schreckenswolf](Schreckenswolf.md) anwesend ist, lassen die anderen nicht lange auf sich warten und können als dunkle Schemen im Nebel ausgemacht werden. Die [Schreckenswölfe](Schreckenswolf.md) in Barovia sind grausame, übergroße [Wölfe](Wolf.md) und Strahds loyale Diener. Sie können nicht [[../../03 - Quellen/Quellbücher/01. Grundregelwerk 2014/Anhang PH-A#Bezaubert|bezaubert]] oder [[../../03 - Quellen/Quellbücher/01. Grundregelwerk 2014/Anhang PH-A#Verängstigt|verängstigt]] werden.
...
Diese Vistani dienen Strahd, marschieren durch die barovianische Wildnis, lachen und erzählen sich Geistergeschichten. Sie suchen nach Gräbern zum Plündern oder jagen Niederwild. Für den Preis von 100 Goldmünzen bieten sie an, als Führer zu dienen. Solange diese Vistani sich bei der Gruppe befinden würfle mit einem `W12` statt `W12` + `W8`, wenn du Zufallsbegegnungen in der Wildnis bestimmst. Zusätzlichen bedrohen [Wölfe](Wolf.md) und [Schreckenswölfe](Schreckenswolf.md) die Charaktere nicht, solange die Vistani mit ihnen reisen und nicht ihre Gefangenen sind.
...
Der Werrabe gehört zu einem geheimen Orden namens Hüter der Feder. Wenn die Charaktere ihn nicht bemerken, beschattet sie der [Werrabe](Werrabe.md) für `dice: 1d4`Stunden. Am Ende des Zeitraums, oder früher, wenn die Charaktere sie angreifen, fliegt die Kreatur nach Hause, um zu berichten was sie gesehen hat.
$\quad$ Wenn die gruppe eine zweite Zufallsbegegnung mit einem [Werraben](Werrabe.md) hat, stellt dieser sich den Charakteren als ein Verbündeter vor und bittet darum, dass sie zum Gasthaus Blauwasser in Vallaki reisen mögen, um „ein paar neue Freunde" kennenzulernen. Dann fliegt er in Richtung der Stadt davon.
...
Charaktere haben ein paar Minuten Zeit um sich zu stählen, bevor diese [Wölfe](Wolf.md) angreifen. Sie befolgen den Willen Strahds und können nicht [[../../03 - Quellen/Quellbücher/01. Grundregelwerk 2014/Anhang PH-A#Bezaubert|bezaubert]] oder [[../../03 - Quellen/Quellbücher/01. Grundregelwerk 2014/Anhang PH-A#Verängstigt|verängstigt]] werden.
