...
| 3 | `1d6` [gibbering mouthers](/3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) lie in wait for prey. |
...
| 6 | `1d4 + 1` [hook horrors](/3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) climb on the tunnel ceiling. |
...
| 9 | A patch of `2d4` [shriekers](/3-Mechanics/CLI/bestiary/plant/shrieker-fungus-xmm.md) blocks the way ahead; if they shriek, roll `1d8` on this table to see what creatures come to investigate. |
| 10–20 | No encounter. |
^tunnel-encounters
