...
|----------|--------------|-------|
| Upper City | `2d4` minutes | `2d4` Watch [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) |
| Lower City | `4d6` minutes | `2d4` Flaming Fist [veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| Outer City | `6d8` minutes | `2d6` Flaming Fist [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) |
^guard-arrival-times
...
| 3 | The guards already have `1d6` [thugs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) with them from a prior arrest and don't want to deal with another problem. |
...
| dice: d10 | Denizens |
|-----------|----------|
| 1 | `2d4` Watch [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) who demand to see strangers' passage tokens |
| 2 | `1d4` [acolytes](/3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md) of Gond or Tymora |
| 3 | `2d6` patriar servants ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) on errands |
...
| 5 | `1d4 + 1` entitled young patriars (human [nobles](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)), each with one personal bodyguard ([thug](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)) |
| 6 | `1d6` visiting dignitaries ([nobles](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) and `2d4` [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) |
| 7 | `1d4` High Hall messengers ([scouts](/3-Mechanics/CLI/bestiary/humanoid/scout-xmm.md)) |
| 8 | `2d4` entertainers ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 9 | 1 Flaming Fist officer ([knight](/3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md)) and `2d4` Flaming Fist soldiers ([veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) |
| 10 | `1d4` [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) who shouldn't be in the Upper City |
^table-b-upper-city-denizens
...
| dice: d10 | Threat |
|-----------|--------|
| 1 | `1d4` [imps](/3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) disguised as ravens |
| 2 | 1 [gargoyle](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) in the service of the Guild |
| 3 | `1d6` [giant centipedes](/3-Mechanics/CLI/bestiary/beast/giant-centipede-xmm.md) from the sewers |
| 4 | `1d4` suits of [animated armor](/3-Mechanics/CLI/bestiary/construct/animated-armor-xmm.md) that escaped from the High House of Wonders |
...
| 8 | `1d4` [doppelgangers](/3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) |
| 9 | 1 serial killer ([assassin](/3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)) wanted by the Watch |
| 10 | `2d4` [kenku](/3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md) muggers in league with the Guild |
^table-c-upper-city-threats
...
| dice: d10 | Denizens |
|-----------|----------|
| 1 | `2d6` gang members or pirates (both [thugs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)) |
| 2 | `1d4 + 1` crass merchants ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 3 | `1d6` [kenku](/3-Mechanics/CLI/bestiary/monstrosity/kenku-xmm.md) minding their own business |
| 4 | `3d6` angry crew members ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) protesting the Flaming Fist's brutality |
| 5 | `2d4` Flaming Fist soldiers ([veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) on patrol |
| 6 | `1d4` Guild pickpockets ([spies](/3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) |
| 7 | `1d8` beggars ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 8 | 1 Baldur's Mouth reporter ([commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 9 | `1d4` patriars ([nobles](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) and `3d6` bodyguards ([thugs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)) |
| 10 | 1 Guild kingpin ([bandit captain](/3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md)) and `2d6` operatives ([bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)) |
^table-e-lower-city-denizens
...
| dice: d10 | Threat |
|-----------|--------|
| 1 | `1d4` [swarms of rats](/3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) |
| 2 | `1d4` [invisible](/3-Mechanics/CLI/conditions.md#Invisible) [imps](/3-Mechanics/CLI/bestiary/fiend/imp-xmm.md) |
...
| 5 | Press gang of `1d4 + 1` [half-ogres](/3-Mechanics/CLI/bestiary/giant/ogrillon-ogre-xmm.md) |
| 6 | `1d6` Guild operatives ([spies](/3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) |
| 7 | `2d4` street brawlers ([thugs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)) |
| 8 | `1d6` Flaming Fist mercenaries ([veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) who don't like the look of adventurers |
| 9 | 1 [ghost](/3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) from Harborside Hospital |
| 10 | `1d4` [mimics](/3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) posing as cargo |
^table-f-lower-city-threats
...
|-----------|-------------|
| 1 | `2d4` Calishite [thugs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) and `2d4` Tethyrian [thugs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) curse at each other, ready to brawl |
| 2 | `1d6` gnome [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) from the Whitkeep Hostel throw tomatoes at passersby who flaunt their wealth |
| 3 | `1d4` [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) joyride on [riding horses](/3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md) stolen from a corral |
| 4 | `2d4` Flaming Fist [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md), off-duty or headed elsewhere, ignore obvious crimes |
| 5 | `1d4` patriars (human [nobles](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) and `2d8` [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) |
| 6 | `1d4` barkers ([spies](/3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) pass out handbills for the Oasis Theater |
| 7 | `1d4` [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) herding `2d8` [goats](/3-Mechanics/CLI/bestiary/beast/goat-xmm.md) and one [peacock](/3-Mechanics/CLI/bestiary/beast/peacock-bgdia.md) (use the [vulture](/3-Mechanics/CLI/bestiary/beast/vulture-xmm.md) stat block) |
| 8 | `2d6` beggars ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 9 | 1 Flaming Fist officer ([knight](/3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md)) and `2d4` Flaming Fist soldiers ([veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) heading to or from Wyrm's Rock |
| 10 | `2d6` members of the Crossers or Gravemakers crew ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) on street patrol |
^table-h-outer-city-denizens
...
| dice: d10 | Threat |
|-----------|--------|
| 1 | `2d4` [giant rats](/3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) |
| 2 | 1 [bandit captain](/3-Mechanics/CLI/bestiary/humanoid/bandit-captain-xmm.md) and `1d6` [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) demand a "street use" tax |
| 3 | `1d6` Guild pickpockets ([spies](/3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md)) |
| 4 | `1d4` [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) picking at corpses left in the street |
| 5 | `2d6` [skeletons](/3-Mechanics/CLI/bestiary/undead/skeleton-xmm.md) escaped from the Cliffside Cemetery |
...
| 8 | `1d6` [stirges](/3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) |
| 9 | `1d4` [jackalweres](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) that live in Little Calimshan |
...
| dice: d12 | Travelers |
|-----------|-----------|
| 1 | `3d4` local farmers or ranchers ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 2 | `1d4` foreign merchants ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) and `3d6` [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) traveling in a caravan |
| 3 | `1d6` scholars ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 4 | `3d6` migrants or refugees ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
| 5 | `2d4` Flaming Fist soldiers ([veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) |
| 6 | Family of `1d4` patriars ([nobles](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md)) in a coach pulled by two [draft horses](/3-Mechanics/CLI/bestiary/beast/draft-horse-xmm.md), with `2d6` [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) on [riding horses](/3-Mechanics/CLI/bestiary/beast/riding-horse-xmm.md) providing escort |
| 7 | `2d4` mercenaries for hire ([thugs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md)) |
| 8 | `1d6` religious pilgrims ([acolytes](/3-Mechanics/CLI/bestiary/humanoid/priest-acolyte-xmm.md)) |
| 9 | `1d6` Guild agents ([bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md)) |
...
| 11 | `1d6` entertainers ([commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) |
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1 | `1d6` [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) disguised as human beggars or a pack of wolves |
| 2 | `2d4` [stirges](/3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) |
| 3 | `1d4` [ettercaps](/3-Mechanics/CLI/bestiary/monstrosity/ettercap-xmm.md) and `1d4` [giant spiders](/3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) |
| 4 | `3d6` [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) |
| 5 | 1 [goblin boss](/3-Mechanics/CLI/bestiary/fey/goblin-boss-xmm.md) and `3d6` [goblins](/3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) |
| 6 | 1 [dryad](/3-Mechanics/CLI/bestiary/fey/dryad-xmm.md) and `1d4` [sprites](/3-Mechanics/CLI/bestiary/fey/sprite-xmm.md) lurking in a tree |
| 7 | `1d4` [ankhegs](/3-Mechanics/CLI/bestiary/monstrosity/ankheg-xmm.md) that burrow up from the ground |
| 8 | 1 [basilisk](/3-Mechanics/CLI/bestiary/monstrosity/basilisk-xmm.md) |
| 9 | `1d4` [jackalweres](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) disguised as human beggars, entertainers, or merchants |
| 10 | 1 [hobgoblin captain](/3-Mechanics/CLI/bestiary/fey/hobgoblin-captain-xmm.md) and `3d6` [hobgoblins](/3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) |
| 11 | 1 [gnoll pack lord](/3-Mechanics/CLI/bestiary/fiend/gnoll-pack-lord-xmm.md) and `3d6` [gnolls](/3-Mechanics/CLI/bestiary/fiend/gnoll-warrior-xmm.md) |
