...
You can end the spell early by using an action to dismiss it. A [remove curse](Fluch-brechen.md), [greater restoration](Vollständige-Genesung.md), or [Wunsch](Wunsch.md) spell also ends it.
