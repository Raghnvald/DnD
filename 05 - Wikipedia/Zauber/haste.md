...
- Zauber/subclass/circle-of-the-land/grassland
...
Choose a willing creature that you can see within range. Until the spell ends, the target's speed is doubled, it gains a +2 bonus to AC, it has advantage on Dexterity saving throws, and it gains an additional action on each of its turns. That action can be used only to take the [Attack](/3-Mechanics/CLI/actions.md#Attack) (one weapon attack only), [Dash](/3-Mechanics/CLI/actions.md#Dash), [Disengage](/3-Mechanics/CLI/actions.md#Disengage), [Hide](/3-Mechanics/CLI/actions.md#Hide), or [Use an Object](/3-Mechanics/CLI/actions.md#Use%20an%20Object) action.
