...
While holding the rod, you can use an action to cast one of the following spells from it: [detect evil and good](Gutes-und-Böses-entdecken.md), [detect magic](Magie%20entdecken.md), [detect poison and disease](Gift-und-Krankheit-entdecken.md), or [see invisibility](Unsichtbares-sehen.md).
