...
-   **Waffen**: Einfache Waffen, [[../../../Gegenstände/Handarmbrust]], [[../../../Gegenstände/Langschwert]], [[../../../Gegenstände/Rapier]], [[../../../Gegenstände/Kurzschwert]]
...
-   (_a_) ein [[../../../Gegenstände/Rapier]], (_b_) ein [[../../../Gegenstände/Langschwert]] oder (_c_) eine beliebige einfache Waffe
-   (_a_) eine [[../../../Gegenstände/Diplomatenausrüstung]] oder (_b_) eine [[../../../Gegenstände/Unterhaltungskünster-Ausrüstung]]
-   (_a_) eine [[../../../Gegenstände/Laute]] oder (_b_) ein beliebiges anderes Musikinstrument
-   eine [[../../../Gegenstände/Lederrüstung]] und ein [[../../../Gegenstände/Dolch]]
...
You can make a bard quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Dexterity. Second, choose the entertainer background. Third, choose the [[../../../Zauber/Tanzende Lichter]] and [[Gehässiger Spott]] cantrips, along with the following 1st-level spells: [charm person](../../../Zauber/Person-bezaubern.md), [detect magic](../../../Zauber/Magie-entdecken.md), [healing word](../../../Zauber/Heilendes-Wort.md), and [[../../../Zauber/Donnerwoge]].
...
Es ist auch die Aufgabe des Barden, über kleinere und zeitgenössische Ereignisse zu berichten - die Geschichten der Helden von heute, einschließlich ihrer Heldentaten und ihrer weniger beeindruckenden Misserfolge.
...
Ein Barde, der sich einer Muse verschreibt, tut das normalerweise, um besser verstehen zu können, wofür seine Muse steht, und um andere durch seine Darbietung an seinen Erkenntnissen teilhaben zu lassen.
...
Du kannst dieses Merkmal so oft einsetzen, wie es der Höhe deines Charisma-Modifikators entspricht (mindestens einmal). Nach einer Langen Rast erhältst du alle verbrauchten Anwendungen zurück.
...
Wenn du beispielsweise den Zauber [Wunden heilen](04.%20Kompendium/Zauber/Wunden-heilen.md) (1. Grad) kennst und einen Zauberplatz des 1. und 2. Grades zur Verfügung hast, kannst du [Wunden heilen](04.%20Kompendium/Zauber/Wunden-heilen.md) in einem der beiden Grade wirken.
...
### Bardische Inspiration (W12) (Stufe 15)
