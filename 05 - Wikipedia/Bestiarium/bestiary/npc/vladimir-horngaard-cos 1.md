...
"Vergeltung ist alles, was mir bleibt."

### Bindung

"Ich habe dem Orden des Silberdrachen Treueeide geschworen. So gebrochen der Orden auch sein mag, meine Treue stirbt nie.."

### Makel

"Strahd zu zerstören, würde die Qualen des Vampir beenden, und das ist etwas, das ich niemals gestatten werde"
...
```statblock
statblock: true
name: Wladimir Horngaard (CoS)
image: token/vladimir-horngaard-cos.webp
source: Fluch des Strahd
size: Mittelgroß
type: Untoter
alignment: Rechtschaffen Böse
ac: 17
ac_class: [[Plattenpanzer]]
hp: 192
speed: 9 Meter.
...
actions:
  ...
  - name: Zweihandschwert + 2
    desc: "_Nahkampf-Waffenangriff_: +9 zum Treffen, Reichweite 1,50 m, ein Ziel. Treffer: 20 (4d6 + 6) Hiebschaden. Wenn das Ziel Strahd ist, erleidet das Ziel zusätzlich 14 (4d6) Hiebschaden. Anstatt Schaden zuzufügen, kann der Wiedergänger das Ziel packen (SG 14 zum Entkommen), sofern es der Kategorie Groß oder kleiner angehört."
