...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +19 to hit, reach 10 ft., one target. *Hit:* 36\
      \ (4d12 + 10) piercing damage. If the target is a creature, it is [grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
  ...
  - "desc": "Each creature of the tarrasque's choice within 120 feet of it and aware\
      \ of it must succeed on a DC 17 Wisdom saving throw or become [frightened](/3-Mechanics/CLI/conditions.md#Frightened)\
  ...
  - "desc": "The tarrasque makes one bite attack against a Large or smaller creature\
      ...
      \ fall [prone](/3-Mechanics/CLI/conditions.md#Prone) in a space within 10 feet\
      \ of the tarrasque. If the tarrasque dies, a swallowed creature is no longer\
      \ [restrained](/3-Mechanics/CLI/conditions.md#Restrained) by it and can escape\
      \ from the corpse by using 30 feet of movement, exiting [prone](/3-Mechanics/CLI/conditions.md#Prone)."
    "name": "Swallow"
