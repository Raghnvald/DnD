...
"traits":
  ...
  - "desc": "When the orc is reduced to 0 hit points, it explodes, and any creature\
      ...
      \ save, the creature takes 14 (4d6) poison damage and becomes poisoned. On a\
      \ success, the creature takes half as much damage and isn't poisoned. A creature\
      \ poisoned by this effect can repeat the save at the end of each of its turn,\
      \ ending the effect on itself on a success. While poisoned by this effect, a\
