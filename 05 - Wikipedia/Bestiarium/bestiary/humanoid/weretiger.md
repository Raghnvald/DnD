...
"traits":
  - "desc": "The weretiger can use its action to polymorph into a tiger-humanoid hybrid\
    ...
    "name": "Shapechanger"
  - "desc": "The weretiger has advantage on Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception))\
  ...
  - "desc": "If the weretiger moves at least 15 feet straight toward a creature and\
      ...
      \ If the target is [prone](/3-Mechanics/CLI/conditions.md#Prone), the weretiger\
