...
"actions":
  ...
  - "desc": "A 10-foot radius of disgusting green gas extends out from the dretch.\
      ...
      \ be [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) until the start of\
      \ its next turn. While [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) in\
      \ this way, the target can take either an action or a bonus action on its turn,\
