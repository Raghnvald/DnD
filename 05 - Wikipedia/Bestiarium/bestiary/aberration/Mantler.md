...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one creature. *Hit:* 10\
      ...
      \ attaches to the target's head, and the target is [blinded](/3-Mechanics/CLI/conditions.md#Blinded)\
  ...
  - "desc": "Each creature within 60 feet of the cloaker that can hear its moan and\
      ...
      \ [frightened](/3-Mechanics/CLI/conditions.md#Frightened) until the end of the\
