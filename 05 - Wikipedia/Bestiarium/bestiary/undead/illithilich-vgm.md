...
"traits":
  - "desc": "The illithilich is an 18th-level spellcaster. Its spellcasting ability\
      ...
      \ invisibility, Melf's acid arrow, mirror image\n\n**3rd level (3 slots):**\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 5 ft., one creature. *Hit:*\
      \ 21 (3d10 + 5) psychic damage. If the target is Large or smaller, it is grappled\
  ...
  - "desc": "The illithilich magically emits psychic energy in a 60-foot cone. Each\
      ...
      \ take 27 (5d8 + 5) psychic damage and be stunned for 1 minute. A creature can\
